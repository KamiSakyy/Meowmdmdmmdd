...
# instance fields
.field final j:Lj$/util/function/ToLongFunction;

.field final k:Lj$/util/function/d0;
...
# direct methods
.method constructor <init>(Lj$/util/concurrent/b;III[Lj$/util/concurrent/F;Lj$/util/concurrent/w;Lj$/util/function/ToLongFunction;JLj$/util/function/d0;)V
    .locals 0
    ...
    iput-object p7, p0, Lj$/util/concurrent/w;->j:Lj$/util/function/ToLongFunction;

    iput-wide p8, p0, Lj$/util/concurrent/w;->l:J

    iput-object p10, p0, Lj$/util/concurrent/w;->k:Lj$/util/function/d0;
...
.method public final compute()V
    ...
    iget-object v12, v11, Lj$/util/concurrent/w;->j:Lj$/util/function/ToLongFunction;

    if-eqz v12, :cond_3

    iget-object v13, v11, Lj$/util/concurrent/w;->k:Lj$/util/function/d0;
    ...
    invoke-interface {v1, v0}, Lj$/util/function/ToLongFunction;->applyAsLong(Ljava/lang/Object;)J

    move-result-wide v2

    invoke-interface {v13, v14, v15, v2, v3}, Lj$/util/function/d0;->applyAsLong(JJ)J
    ...
    invoke-interface {v13, v3, v4, v5, v6}, Lj$/util/function/d0;->applyAsLong(JJ)J
