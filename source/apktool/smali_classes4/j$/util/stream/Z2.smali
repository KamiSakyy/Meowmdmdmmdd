.class public final synthetic Lj$/util/stream/Z2;
...
.method private synthetic constructor <init>(Lj$/util/stream/Stream;)V
    ...
    iput-object p1, p0, Lj$/util/stream/Z2;->a:Lj$/util/stream/Stream;

    return-void
.end method

.method public static synthetic x(Lj$/util/stream/Stream;)Ljava/util/stream/Stream;
    .locals 1
    ...
    invoke-direct {v0, p0}, Lj$/util/stream/Z2;-><init>(Lj$/util/stream/Stream;)V
...
.method public final synthetic allMatch(Ljava/util/function/Predicate;)Z
    ...
    iget-object v0, p0, Lj$/util/stream/Z2;->a:Lj$/util/stream/Stream;

    invoke-static {p1}, Lj$/util/function/H0;->a(Ljava/util/function/Predicate;)Lj$/util/function/Predicate;
...
.method public final synthetic collect(Ljava/util/function/Supplier;Ljava/util/function/BiConsumer;Ljava/util/function/BiConsumer;)Ljava/lang/Object;
    ...
    invoke-interface {v0, p1, p2, p3}, Lj$/util/stream/Stream;->G(Lj$/util/function/Supplier;Lj$/util/function/BiConsumer;Lj$/util/function/BiConsumer;)Ljava/lang/Object;
...
.method public final synthetic collect(Ljava/util/stream/Collector;)Ljava/lang/Object;
    ...
    invoke-static {p1}, Lj$/util/stream/j;->a(Ljava/util/stream/Collector;)Lj$/util/stream/Collector;
...
.method public final synthetic flatMapToDouble(Ljava/util/function/Function;)Ljava/util/stream/DoubleStream;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/Stream;->o(Lj$/util/function/Function;)Lj$/util/stream/F;
...
.method public final synthetic flatMapToLong(Ljava/util/function/Function;)Ljava/util/stream/LongStream;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/Stream;->Z(Lj$/util/function/Function;)Lj$/util/stream/o0;
...
.method public final synthetic mapToDouble(Ljava/util/function/ToDoubleFunction;)Ljava/util/stream/DoubleStream;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/Stream;->h0(Lj$/util/function/ToDoubleFunction;)Lj$/util/stream/F;
...
.method public final synthetic mapToInt(Ljava/util/function/ToIntFunction;)Ljava/util/stream/IntStream;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/Stream;->I(Lj$/util/function/ToIntFunction;)Lj$/util/stream/IntStream;
...
.method public final synthetic mapToLong(Ljava/util/function/ToLongFunction;)Ljava/util/stream/LongStream;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/Stream;->f0(Lj$/util/function/ToLongFunction;)Lj$/util/stream/o0;
...
.method public final synthetic noneMatch(Ljava/util/function/Predicate;)Z
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/Stream;->e0(Lj$/util/function/Predicate;)Z
...
.method public final synthetic reduce(Ljava/lang/Object;Ljava/util/function/BiFunction;Ljava/util/function/BinaryOperator;)Ljava/lang/Object;
    ...
    invoke-interface {v0, p1, p2, p3}, Lj$/util/stream/Stream;->m(Ljava/lang/Object;Lj$/util/function/BiFunction;Lj$/util/function/f;)Ljava/lang/Object;
...
.method public final synthetic reduce(Ljava/lang/Object;Ljava/util/function/BinaryOperator;)Ljava/lang/Object;
    ...
    invoke-interface {v0, p1, p2}, Lj$/util/stream/Stream;->k0(Ljava/lang/Object;Lj$/util/function/f;)Ljava/lang/Object;
...
.method public final synthetic reduce(Ljava/util/function/BinaryOperator;)Ljava/util/Optional;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/Stream;->L(Lj$/util/function/f;)Lj$/util/Optional;
...
.method public final synthetic toArray(Ljava/util/function/IntFunction;)[Ljava/lang/Object;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/Stream;->f(Lj$/util/function/N;)[Ljava/lang/Object;
