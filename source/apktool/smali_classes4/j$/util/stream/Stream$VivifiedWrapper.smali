...
.method public static synthetic convert(Ljava/util/stream/Stream;)Lj$/util/stream/Stream;
    ...
    :cond_0
    instance-of v0, p0, Lj$/util/stream/Z2;

    if-eqz v0, :cond_1

    check-cast p0, Lj$/util/stream/Z2;

    iget-object p0, p0, Lj$/util/stream/Z2;->a:Lj$/util/stream/Stream;
...
.method public final synthetic G(Lj$/util/function/Supplier;Lj$/util/function/BiConsumer;Lj$/util/function/BiConsumer;)Ljava/lang/Object;
    .locals 1

    iget-object v0, p0, Lj$/util/stream/Stream$VivifiedWrapper;->a:Ljava/util/stream/Stream;

    invoke-static {p1}, Lj$/util/function/K0;->a(Lj$/util/function/Supplier;)Ljava/util/function/Supplier;
...
.method public final synthetic I(Lj$/util/function/ToIntFunction;)Lj$/util/stream/IntStream;
    .locals 1

    iget-object v0, p0, Lj$/util/stream/Stream$VivifiedWrapper;->a:Ljava/util/stream/Stream;

    invoke-static {p1}, Lj$/util/function/O0;->a(Lj$/util/function/ToIntFunction;)Ljava/util/function/ToIntFunction;
...
.method public final synthetic L(Lj$/util/function/f;)Lj$/util/Optional;
    .locals 1
...
.method public final synthetic Z(Lj$/util/function/Function;)Lj$/util/stream/o0;
    .locals 1
    ...
    invoke-static {p1}, Lj$/util/stream/m0;->x(Ljava/util/stream/LongStream;)Lj$/util/stream/o0;
...
.method public final synthetic allMatch(Lj$/util/function/Predicate;)Z
    .locals 1
...
.method public final synthetic f(Lj$/util/function/N;)[Ljava/lang/Object;
    .locals 1
...
.method public final synthetic f0(Lj$/util/function/ToLongFunction;)Lj$/util/stream/o0;
    .locals 1

    iget-object v0, p0, Lj$/util/stream/Stream$VivifiedWrapper;->a:Ljava/util/stream/Stream;

    invoke-static {p1}, Lj$/util/function/Q0;->a(Lj$/util/function/ToLongFunction;)Ljava/util/function/ToLongFunction;
...
.method public final synthetic h0(Lj$/util/function/ToDoubleFunction;)Lj$/util/stream/F;
    .locals 1
...
.method public final synthetic k0(Ljava/lang/Object;Lj$/util/function/f;)Ljava/lang/Object;
    .locals 1
...
.method public final synthetic m(Ljava/lang/Object;Lj$/util/function/BiFunction;Lj$/util/function/f;)Ljava/lang/Object;
    .locals 1
...
.method public final synthetic o(Lj$/util/function/Function;)Lj$/util/stream/F;
    .locals 1
...
.method public final synthetic onClose(Ljava/lang/Runnable;)Lj$/util/stream/BaseStream;
    ...
    invoke-static {p1}, Lj$/util/stream/g;->x(Ljava/util/stream/BaseStream;)Lj$/util/stream/BaseStream;
...
.method public final synthetic parallel()Lj$/util/stream/BaseStream;
    ...
    invoke-static {v0}, Lj$/util/stream/g;->x(Ljava/util/stream/BaseStream;)Lj$/util/stream/BaseStream;
...
.method public final synthetic spliterator()Lj$/util/Spliterator;
    ...
    invoke-static {v0}, Lj$/util/P;->f(Ljava/util/Spliterator;)Lj$/util/Spliterator;
