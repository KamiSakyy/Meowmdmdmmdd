...
.method constructor <init>(Ljava/util/TimeZone;)V
    ...
    invoke-static {v1}, Lj$/time/zone/e;->j(I)Lj$/time/ZoneOffset;
...
.method private constructor <init>([J[Lj$/time/ZoneOffset;[J[Lj$/time/ZoneOffset;[Lj$/time/zone/d;)V
    ...
    invoke-virtual {v2}, Lj$/time/zone/b;->y()Z
...
.method private static a(Lj$/time/LocalDateTime;Lj$/time/zone/b;)Ljava/lang/Object;
    ...
    invoke-virtual {p1}, Lj$/time/zone/b;->y()Z

    move-result v1

    invoke-virtual {p0, v0}, Lj$/time/LocalDateTime;->J(Lj$/time/LocalDateTime;)Z
    ...
    :cond_1
    invoke-virtual {p1}, Lj$/time/zone/b;->n()Lj$/time/ZoneOffset;
...
.method private b(I)[Lj$/time/zone/b;
    ...
    invoke-static {v3}, Lj$/time/LocalDateTime;->K(I)Lj$/time/LocalDateTime;

    move-result-object v3

    iget-object v6, v0, Lj$/time/zone/e;->b:[Lj$/time/ZoneOffset;
    ...
    invoke-static {v14, v15, v5, v6}, Lj$/lang/a;->d(JJ)J
    ...
    :goto_3
    invoke-static {v10}, Lj$/time/zone/e;->j(I)Lj$/time/ZoneOffset;
    ...
    invoke-static {v6}, Lj$/time/zone/e;->j(I)Lj$/time/ZoneOffset;

    move-result-object v9

    invoke-static {v3, v4, v9}, Lj$/time/zone/e;->c(JLj$/time/ZoneOffset;)I
    ...
    invoke-direct {v12, v3, v4, v5, v9}, Lj$/time/zone/b;-><init>(JLj$/time/ZoneOffset;Lj$/time/ZoneOffset;)V
...
.method private static c(JLj$/time/ZoneOffset;)I
    ...
    invoke-virtual {p2}, Lj$/time/ZoneOffset;->K()I
    ...
    .line 0
    invoke-static {p0, p1, v0, v1}, Lj$/lang/a;->d(JJ)J

    move-result-wide p0

    .line 0
    invoke-static {p0, p1}, Lj$/time/i;->Q(J)Lj$/time/i;

    move-result-object p0

    invoke-virtual {p0}, Lj$/time/i;->K()I
...
.method private e(Lj$/time/LocalDateTime;)Ljava/lang/Object;
    ...
    .line 0
    invoke-static {p1, v1}, Lj$/time/chrono/b;->p(Lj$/time/chrono/f;Lj$/time/ZoneOffset;)J
    ...
    invoke-static {p1}, Lj$/time/zone/e;->j(I)Lj$/time/ZoneOffset;
    ...
    invoke-static {p1, v1}, Lj$/time/zone/e;->a(Lj$/time/LocalDateTime;Lj$/time/zone/b;)Ljava/lang/Object;
    ...
    invoke-virtual {v1}, Lj$/time/zone/b;->r()Lj$/time/ZoneOffset;
    ...
    iget-object v0, p0, Lj$/time/zone/e;->d:[Lj$/time/LocalDateTime;
    ...
    invoke-virtual {p1, v0}, Lj$/time/LocalDateTime;->I(Lj$/time/LocalDateTime;)Z
    ...
    iget-object p1, p0, Lj$/time/zone/e;->e:[Lj$/time/ZoneOffset;
    ...
    iget-object v2, p0, Lj$/time/zone/e;->e:[Lj$/time/ZoneOffset;
    ...
    invoke-virtual {v3}, Lj$/time/ZoneOffset;->K()I
...
.method public static i(Lj$/time/ZoneOffset;)Lj$/time/zone/e;
    .locals 1
...
.method static k(Ljava/io/DataInput;)Lj$/time/zone/e;
    ...
    invoke-direct/range {v2 .. v7}, Lj$/time/zone/e;-><init>([J[Lj$/time/ZoneOffset;[J[Lj$/time/ZoneOffset;[Lj$/time/zone/d;)V
...
.method public final d(Lj$/time/Instant;)Lj$/time/ZoneOffset;
    ...
    invoke-virtual {p1}, Lj$/time/Instant;->L()J
    ...
    invoke-static {v2, v3, p1}, Lj$/time/zone/e;->c(JLj$/time/ZoneOffset;)I
    ...
    :cond_3
    invoke-virtual {v0}, Lj$/time/zone/b;->n()Lj$/time/ZoneOffset;
...
.method public final g(Lj$/time/LocalDateTime;)Ljava/util/List;
    ...
    invoke-virtual {p1}, Lj$/time/zone/b;->v()Ljava/util/List;
...
.method public final h()Z
    ...
    :cond_0
    invoke-static {}, Lj$/time/Instant;->G()Lj$/time/Instant;
    ...
    invoke-virtual {v1}, Lj$/time/Instant;->E()J

    move-result-wide v10

    invoke-virtual {v1}, Lj$/time/Instant;->F()I
    ...
    invoke-static {v10, v11, v1}, Lj$/time/zone/e;->c(JLj$/time/ZoneOffset;)I
    ...
    invoke-static {v4, v2, v2}, Lj$/time/i;->O(III)Lj$/time/i;

    move-result-object v4

    invoke-virtual {v4}, Lj$/time/i;->w()J
    ...
    invoke-static {v4}, Lj$/time/zone/e;->j(I)Lj$/time/ZoneOffset;

    move-result-object v1

    invoke-static {v5, v6, v1}, Lj$/time/zone/e;->c(JLj$/time/ZoneOffset;)I
    ...
    iget-object v1, v0, Lj$/time/zone/e;->e:[Lj$/time/ZoneOffset;
    ...
    :cond_d
    invoke-static {v4, v5, v1}, Lj$/time/zone/e;->c(JLj$/time/ZoneOffset;)I
    ...
    iget-object v4, v0, Lj$/time/zone/e;->e:[Lj$/time/ZoneOffset;

    aget-object v5, v4, v5

    aget-object v1, v4, v1

    invoke-direct {v9, v6, v7, v5, v1}, Lj$/time/zone/b;-><init>(JLj$/time/ZoneOffset;Lj$/time/ZoneOffset;)V
