...
.method static constructor <clinit>()V
    ...
    sget-object v9, Lj$/time/chrono/u;->d:Lj$/time/chrono/u;

    const/4 v10, 0x1

    invoke-virtual {v0, v10, v9}, Lj$/time/format/p;->v(ILj$/time/chrono/u;)Lj$/time/format/DateTimeFormatter;
    ...
    invoke-virtual {v11, v10, v9}, Lj$/time/format/p;->v(ILj$/time/chrono/u;)Lj$/time/format/DateTimeFormatter;
    ...
    invoke-virtual {v11, v10, v13}, Lj$/time/format/p;->v(ILj$/time/chrono/u;)Lj$/time/format/DateTimeFormatter;
    ...
    invoke-virtual {v7, v10, v13}, Lj$/time/format/p;->v(ILj$/time/chrono/u;)Lj$/time/format/DateTimeFormatter;
    ...
    invoke-virtual {v7, v10, v9}, Lj$/time/format/p;->v(ILj$/time/chrono/u;)Lj$/time/format/DateTimeFormatter;
    ...
    invoke-virtual {v0, v7, v2, v3, v4}, Lj$/time/format/p;->l(Lj$/time/temporal/r;III)Lj$/time/format/p;

    const-string v3, "-W"

    invoke-virtual {v0, v3}, Lj$/time/format/p;->f(Ljava/lang/String;)V

    sget-object v3, Lj$/time/temporal/j;->b:Lj$/time/temporal/r;

    const/4 v4, 0x2

    invoke-virtual {v0, v3, v4}, Lj$/time/format/p;->k(Lj$/time/temporal/r;I)V

    invoke-virtual {v0, v5}, Lj$/time/format/p;->e(C)V

    sget-object v3, Lj$/time/temporal/a;->DAY_OF_WEEK:Lj$/time/temporal/a;

    invoke-virtual {v0, v3, v10}, Lj$/time/format/p;->k(Lj$/time/temporal/r;I)V
    ...
    invoke-virtual {v0, v10, v4}, Lj$/time/format/p;->v(ILj$/time/chrono/u;)Lj$/time/format/DateTimeFormatter;
    ...
    invoke-virtual {v0, v6, v4}, Lj$/time/format/p;->k(Lj$/time/temporal/r;I)V

    invoke-virtual {v0, v8, v4}, Lj$/time/format/p;->k(Lj$/time/temporal/r;I)V
    ...
    invoke-virtual {v0, v4, v5}, Lj$/time/format/p;->g(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v2}, Lj$/time/format/p;->p()V

    invoke-virtual {v2}, Lj$/time/format/p;->r()V

    invoke-virtual {v2}, Lj$/time/format/p;->o()V

    invoke-virtual {v2, v3, v0}, Lj$/time/format/p;->i(Lj$/time/temporal/a;Ljava/util/HashMap;)V

    const-string v0, ", "

    invoke-virtual {v2, v0}, Lj$/time/format/p;->f(Ljava/lang/String;)V

    invoke-virtual {v2}, Lj$/time/format/p;->n()V
    ...
    invoke-virtual {v2, v8, v0, v3, v4}, Lj$/time/format/p;->l(Lj$/time/temporal/r;III)Lj$/time/format/p;

    const/16 v0, 0x20

    invoke-virtual {v2, v0}, Lj$/time/format/p;->e(C)V

    invoke-virtual {v2, v6, v9}, Lj$/time/format/p;->i(Lj$/time/temporal/a;Ljava/util/HashMap;)V

    invoke-virtual {v2, v0}, Lj$/time/format/p;->e(C)V

    invoke-virtual {v2, v1, v4}, Lj$/time/format/p;->k(Lj$/time/temporal/r;I)V

    invoke-virtual {v2, v0}, Lj$/time/format/p;->e(C)V

    invoke-virtual {v2, v12, v3}, Lj$/time/format/p;->k(Lj$/time/temporal/r;I)V

    const/16 v1, 0x3a

    invoke-virtual {v2, v1}, Lj$/time/format/p;->e(C)V

    invoke-virtual {v2, v14, v3}, Lj$/time/format/p;->k(Lj$/time/temporal/r;I)V
    ...
    invoke-virtual {v2, v1, v3}, Lj$/time/format/p;->k(Lj$/time/temporal/r;I)V
    ...
    invoke-virtual {v2, v0, v1}, Lj$/time/format/p;->g(Ljava/lang/String;Ljava/lang/String;)V

    move-object/from16 v0, v18

    invoke-virtual {v2, v3, v0}, Lj$/time/format/p;->v(ILj$/time/chrono/u;)Lj$/time/format/DateTimeFormatter;

    return-void
.end method

.method constructor <init>(Lj$/time/format/f;Ljava/util/Locale;ILj$/time/chrono/u;)V
    .locals 1
    ...
    iput-object p4, p0, Lj$/time/format/DateTimeFormatter;->d:Lj$/time/chrono/n;
...
.method public final a(Lj$/time/temporal/n;)Ljava/lang/String;
    ...
    invoke-direct {v1, p1, p0}, Lj$/time/format/r;-><init>(Lj$/time/temporal/n;Lj$/time/format/DateTimeFormatter;)V

    iget-object p1, p0, Lj$/time/format/DateTimeFormatter;->a:Lj$/time/format/f;

    invoke-virtual {p1, v1, v0}, Lj$/time/format/f;->i(Lj$/time/format/r;Ljava/lang/StringBuilder;)Z
    :try_end_0
...
.method public final b()Lj$/time/chrono/n;
    ...
    iget-object v0, p0, Lj$/time/format/DateTimeFormatter;->d:Lj$/time/chrono/n;
