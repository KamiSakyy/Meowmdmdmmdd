...
.method constructor <init>(Lj$/time/temporal/n;Lj$/time/format/DateTimeFormatter;)V
    ...
    invoke-interface {p1, v2}, Lj$/time/temporal/n;->y(Lj$/time/temporal/t;)Ljava/lang/Object;
    ...
    invoke-interface {p1, v3}, Lj$/time/temporal/n;->y(Lj$/time/temporal/t;)Ljava/lang/Object;
    ...
    invoke-interface {p1, v6}, Lj$/time/temporal/n;->e(Lj$/time/temporal/r;)Z
    ...
    :cond_6
    :try_start_0
    invoke-interface {p1, v6}, Lj$/time/temporal/n;->v(Lj$/time/temporal/r;)J

    move-result-wide v2

    sget-object v0, Lj$/time/temporal/a;->NANO_OF_SECOND:Lj$/time/temporal/a;

    invoke-interface {p1, v0}, Lj$/time/temporal/n;->i(Lj$/time/temporal/r;)I

    move-result v0

    int-to-long v5, v0

    invoke-static {v2, v3, v5, v6}, Lj$/time/Instant;->I(JJ)Lj$/time/Instant;
    ...
    .line 0
    :goto_2
    invoke-interface {v4, p1, v1}, Lj$/time/chrono/n;->A(Lj$/time/Instant;Lj$/time/ZoneId;)Lj$/time/chrono/k;
    ...
    :cond_7
    :try_start_1
    invoke-virtual {v1}, Lj$/time/ZoneId;->D()Lj$/time/zone/e;
    ...
    invoke-interface {p1, v6}, Lj$/time/temporal/n;->i(Lj$/time/temporal/r;)I
    ...
    invoke-virtual {v7}, Lj$/time/ZoneOffset;->K()I
    ...
    invoke-interface {p1, v1}, Lj$/time/temporal/n;->e(Lj$/time/temporal/r;)Z

    move-result v1

    if-eqz v1, :cond_c

    invoke-interface {v4, p1}, Lj$/time/chrono/n;->s(Lj$/time/temporal/n;)Lj$/time/chrono/c;
    ...
    invoke-interface {p1, v7}, Lj$/time/temporal/n;->e(Lj$/time/temporal/r;)Z
    ...
    invoke-direct {v0, v5, p1, v4, v3}, Lj$/time/format/q;-><init>(Lj$/time/chrono/c;Lj$/time/temporal/n;Lj$/time/chrono/n;Lj$/time/ZoneId;)V
