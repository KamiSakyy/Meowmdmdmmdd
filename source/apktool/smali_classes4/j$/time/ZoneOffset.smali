...
.method public static L(Ljava/lang/String;)Lj$/time/ZoneOffset;
    ...
    invoke-static {p0, v2, v3}, Lj$/time/ZoneOffset;->O(Ljava/lang/CharSequence;IZ)I

    move-result v0

    invoke-static {p0, v6, v2}, Lj$/time/ZoneOffset;->O(Ljava/lang/CharSequence;IZ)I

    move-result v1

    invoke-static {p0, v5, v2}, Lj$/time/ZoneOffset;->O(Ljava/lang/CharSequence;IZ)I
    ...
    invoke-static {p0, v1, v3}, Lj$/time/ZoneOffset;->O(Ljava/lang/CharSequence;IZ)I

    move-result v1

    invoke-static {p0, v4, v3}, Lj$/time/ZoneOffset;->O(Ljava/lang/CharSequence;IZ)I
...
.method public static N(I)Lj$/time/ZoneOffset;
    .locals 3
...
.method private static O(Ljava/lang/CharSequence;IZ)I
    .locals 2
...
.method static P(Ljava/io/DataInput;)Lj$/time/ZoneOffset;
    .locals 2
...
.method final I(Ljava/io/DataOutput;)V
    ...
    invoke-virtual {p0, p1}, Lj$/time/ZoneOffset;->Q(Ljava/io/DataOutput;)V

    return-void
.end method

.method public final J(Lj$/time/ZoneOffset;)I
    .locals 1
