...
.method private n()V
    ...
    invoke-static {}, Lj$/time/chrono/q;->I()[[I
    ...
    .line 0
    :cond_1
    iget-object v1, p0, Lj$/time/chrono/q;->d:Ljava/lang/String;
    ...
    .line 0
    iget-object v1, p0, Lj$/time/chrono/q;->e:Ljava/lang/String;
    ...
    iput v1, p0, Lj$/time/chrono/q;->j:I

    iput v4, p0, Lj$/time/chrono/q;->h:I

    invoke-direct {p0, v4, v0}, Lj$/time/chrono/q;->r(ILjava/util/HashMap;)[I

    move-result-object v0

    iput-object v0, p0, Lj$/time/chrono/q;->g:[I

    const/16 v1, 0xe1c

    aget v0, v0, v1

    iput v0, p0, Lj$/time/chrono/q;->i:I

    :goto_1
    if-ge v3, v2, :cond_2

    invoke-virtual {p0, v3}, Lj$/time/chrono/q;->H(I)I
    ...
    iput v0, p0, Lj$/time/chrono/q;->n:I
    :try_end_0
    ...
    iget-object v2, p0, Lj$/time/chrono/q;->d:Ljava/lang/String;
    ...
    invoke-direct {v1, v2, v0}, Lj$/time/c;-><init>(Ljava/lang/String;Ljava/lang/Exception;)V
...
# virtual methods
.method public final A(Lj$/time/Instant;Lj$/time/ZoneId;)Lj$/time/chrono/k;
    .locals 0

    .line 0
    invoke-static {p0, p1, p2}, Lj$/time/chrono/m;->G(Lj$/time/chrono/n;Lj$/time/Instant;Lj$/time/ZoneId;)Lj$/time/chrono/m;
...
.method public final J(Lj$/time/temporal/a;)Lj$/time/temporal/w;
    ...
    invoke-virtual {p0}, Lj$/time/chrono/q;->E()I
...
.method public final p(I)Lj$/time/chrono/o;
    .locals 1
...
.method public final s(Lj$/time/temporal/n;)Lj$/time/chrono/c;
    .locals 2
    ...
    invoke-interface {p1, v0}, Lj$/time/temporal/n;->v(Lj$/time/temporal/r;)J
...
.method public final t(Lj$/time/LocalDateTime;)Lj$/time/chrono/f;
    .locals 0

    invoke-super {p0, p1}, Lj$/time/chrono/a;->t(Lj$/time/LocalDateTime;)Lj$/time/chrono/f;
...
.method final y(III)J
    ...
    invoke-virtual {p0, p1, p2}, Lj$/time/chrono/q;->G(II)I
