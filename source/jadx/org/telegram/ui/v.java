...
public class v extends org.telegram.ui.Components.o {
    ...
    public class a extends v1.s {
        ...
        public RecyclerView.d0 onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            if (i == 0) {
                ...
                nq1 nq1Var = new nq1(new ColorDrawable(org.telegram.ui.ActionBar.l.B1("windowBackgroundGray")), org.telegram.ui.ActionBar.l.u2(viewGroup.getContext(), g68.g2, "windowBackgroundGrayShadow"));
                nq1Var.e(true);
    ...
    public v(org.telegram.ui.e eVar, e.j jVar, final oa0 oa0Var, f fVar) {
        ...
        for (int i = 0; i < 7; i++) {
            if (i == 0) {
                B0 = org.telegram.messenger.u.B0("LocalPhotoCache", e78.oG);
                str = "statisticChartLine_lightblue";
            } else if (i == 1) {
                B0 = org.telegram.messenger.u.B0("LocalVideoCache", e78.rG);
                str = "statisticChartLine_blue";
            } else if (i == 2) {
                B0 = org.telegram.messenger.u.B0("LocalDocumentCache", e78.kG);
                str = "statisticChartLine_green";
            } else if (i == 3) {
                B0 = org.telegram.messenger.u.B0("LocalMusicCache", e78.mG);
                str = "statisticChartLine_red";
            } else if (i == 4) {
                B0 = org.telegram.messenger.u.B0("LocalAudioCache", e78.eG);
                str = "statisticChartLine_lightgreen";
            } else if (i == 5) {
                B0 = org.telegram.messenger.u.B0("LocalStickersCache", e78.qG);
                str = "statisticChartLine_orange";
            } else {
                B0 = org.telegram.messenger.u.B0("LocalMiscellaneousCache", e78.lG);
    ...
    public /* synthetic */ void Y1(View view) {
        ...
        kVar.n(org.telegram.messenger.u.B0("ClearCacheForChat", e78.Xj));
        kVar.p(org.telegram.messenger.u.B0("Cancel", e78.Le), new DialogInterface.OnClickListener() { // from class: ai2
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i) {
                v.this.W1(dialogInterface, i);
            }
        });
        kVar.v(org.telegram.messenger.u.B0("Clear", e78.Tj), new DialogInterface.OnClickListener() { // from class: bi2
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i) {
