...
public abstract class y0 extends FrameLayout implements a0.d {
    ...
    public class c0 extends FrameLayout {
        ...
        public c0(Context context) {
            ...
            this.search.setImageResource(g68.Oe);
            ...
            if (y0.this.type == 0) {
                this.input.setHint(org.telegram.messenger.u.z0(e78.l50));
            } else if (y0.this.type != 1 && y0.this.type != 2) {
                this.input.setHint(org.telegram.messenger.u.z0(e78.B50));
            } else {
                this.input.setHint(org.telegram.messenger.u.z0(e78.J50));
            }
    ...
    public class e0 extends Dialog {
        ...
        public e0(final Context context, Runnable runnable, View view, a0 a0Var, l.r rVar) {
            ...
            ActionBarPopupWindow.ActionBarPopupWindowLayout actionBarPopupWindowLayout = new ActionBarPopupWindow.ActionBarPopupWindowLayout(context, g68.Kd, rVar);
            this.menuView = actionBarPopupWindowLayout;
            this.linearLayoutView.addView(actionBarPopupWindowLayout, cn4.n(-2, -2, 17, 0, 0, 0, 0));
            org.telegram.ui.ActionBar.c.P(true, false, this.menuView, 0, org.telegram.messenger.u.B0("SetEmojiStatusUntil1Hour", e78.O70), false, rVar).setOnClickListener(new View.OnClickListener() { // from class: er8
                @Override // android.view.View.OnClickListener
                public final void onClick(View view2) {
                    y0.e0.this.T(view2);
                }
            });
            org.telegram.ui.ActionBar.c.P(false, false, this.menuView, 0, org.telegram.messenger.u.B0("SetEmojiStatusUntil2Hours", e78.Q70), false, rVar).setOnClickListener(new View.OnClickListener() { // from class: hr8
                @Override // android.view.View.OnClickListener
                public final void onClick(View view2) {
                    y0.e0.this.U(view2);
                }
            });
            org.telegram.ui.ActionBar.c.P(false, false, this.menuView, 0, org.telegram.messenger.u.B0("SetEmojiStatusUntil8Hours", e78.R70), false, rVar).setOnClickListener(new View.OnClickListener() { // from class: ir8
                @Override // android.view.View.OnClickListener
                public final void onClick(View view2) {
                    y0.e0.this.V(view2);
                }
            });
            org.telegram.ui.ActionBar.c.P(false, false, this.menuView, 0, org.telegram.messenger.u.B0("SetEmojiStatusUntil2Days", e78.P70), false, rVar).setOnClickListener(new View.OnClickListener() { // from class: jr8
                @Override // android.view.View.OnClickListener
                public final void onClick(View view2) {
                    y0.e0.this.W(view2);
                }
            });
            org.telegram.ui.ActionBar.c.P(false, true, this.menuView, 0, org.telegram.messenger.u.B0("SetEmojiStatusUntilOther", e78.T70), false, rVar).setOnClickListener(new View.OnClickListener() { // from class: kr8
                @Override // android.view.View.OnClickListener
                public final void onClick(View view2) {
        ...
        public RecyclerView.d0 onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            if (i == this.VIEW_TYPE_HEADER) {
                ...
                if (i == this.VIEW_TYPE_EXPAND) {
                    ...
                    if (y0.this.type == 3) {
                        aVar2.setText(org.telegram.messenger.u.B0("SelectTopicIconHint", e78.u60));
                    } else if (y0.this.type == 0) {
                        aVar2.setText(org.telegram.messenger.u.B0("EmojiLongtapHint", e78.rs));
                    } else {
                        aVar2.setText(org.telegram.messenger.u.B0("ReactionsLongtapHint", e78.i10));
                    }
                    aVar2.setGravity(17);
    ...
    public class x extends FrameLayout {
        ...
        public void e(String str, boolean z, boolean z2, View.OnClickListener onClickListener) {
            ...
            if (z) {
                ...
                this.premiumButtonView.h(org.telegram.messenger.u.d0("UnlockPremiumEmojiPack", e78.Ch0, str), onClickListener);
            } else {
        ...
        public void f(boolean z, boolean z2) {
            String d0;
            if (z) {
                d0 = org.telegram.messenger.u.B0("Added", e78.s5);
            } else {
                d0 = org.telegram.messenger.u.d0("AddStickersCount", e78.a5, this.lastTitle);
            }
    ...
    public Drawable getPremiumStar() {
        if (this.premiumStar == null) {
            Drawable mutate = org.telegram.messenger.b.f12514a.getResources().getDrawable(g68.Xa).mutate();
    ...
    public final void B1() {
        ...
        kVar.x(org.telegram.messenger.u.B0("ClearRecentEmojiStatusesTitle", e78.ok));
        kVar.n(org.telegram.messenger.u.B0("ClearRecentEmojiStatusesText", e78.nk));
        kVar.v(org.telegram.messenger.u.B0("Clear", e78.Tj), new DialogInterface.OnClickListener() { // from class: mq8
    ...
    */
    ...
    public y0(final org.telegram.ui.ActionBar.f fVar, Context context, boolean z2, Integer num, final int i2, l.r rVar, int i3) {
        ...
        if (valueOf != null) {
            ...
            Drawable mutate = getResources().getDrawable(g68.Ae).mutate();
        ...
        if (valueOf != null) {
            ...
            Drawable drawable = getResources().getDrawable(g68.Be);
        ...
        if (i2 == 0) {
            ...
            textView.setText(org.telegram.messenger.u.B0("NoIconsFound", e78.RK));
        } else {
            textView.setText(org.telegram.messenger.u.B0("NoReactionsFound", e78.mL));
        }
        ...
        Drawable drawable2 = getResources().getDrawable(g68.e2);
        ...
        Drawable drawable3 = getResources().getDrawable(g68.b2);
