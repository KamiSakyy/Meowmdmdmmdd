...
public class c1 extends org.telegram.ui.ActionBar.f implements h.d, a0.d {
    ...
    public static class h0 extends v1.s {
        ...
        public h0(Context context) {
            ...
            fVar.name = org.telegram.messenger.u.B0("ThemePreviewDialog1", e78.Me0);
            fVar.message = org.telegram.messenger.u.B0("ThemePreviewDialogMessage1", e78.Ue0);
            fVar.id = 0;
            fVar.unread_count = 0;
            fVar.pinned = true;
            fVar.muted = false;
            ...
            fVar2.name = org.telegram.messenger.u.B0("ThemePreviewDialog2", e78.Ne0);
            fVar2.message = org.telegram.messenger.u.B0("ThemePreviewDialogMessage2", e78.Ve0);
            fVar2.id = 1;
            ...
            fVar3.name = org.telegram.messenger.u.B0("ThemePreviewDialog3", e78.Oe0);
            fVar3.message = org.telegram.messenger.u.B0("ThemePreviewDialogMessage3", e78.We0);
            fVar3.id = 2;
            ...
            fVar4.name = org.telegram.messenger.u.B0("ThemePreviewDialog4", e78.Pe0);
            fVar4.message = org.telegram.messenger.u.B0("ThemePreviewDialogMessage4", e78.Xe0);
            fVar4.id = 3;
            ...
            fVar5.name = org.telegram.messenger.u.B0("ThemePreviewDialog5", e78.Qe0);
            fVar5.message = org.telegram.messenger.u.B0("ThemePreviewDialogMessage5", e78.Ye0);
            fVar5.id = 4;
            ...
            fVar6.name = org.telegram.messenger.u.B0("ThemePreviewDialog6", e78.Re0);
            fVar6.message = org.telegram.messenger.u.B0("ThemePreviewDialogMessage6", e78.Ze0);
            fVar6.id = 5;
            ...
            fVar7.name = org.telegram.messenger.u.B0("ThemePreviewDialog7", e78.Se0);
            fVar7.message = org.telegram.messenger.u.B0("ThemePreviewDialogMessage7", e78.af0);
            fVar7.id = 6;
            ...
            fVar8.name = org.telegram.messenger.u.B0("ThemePreviewDialog8", e78.Te0);
            fVar8.message = org.telegram.messenger.u.B0("ThemePreviewDialogMessage8", e78.bf0);
            fVar8.id = 0;
        ...
        public i0(Context context) {
            ...
            if (c1.this.screenType == 2) {
                ...
                if (c1.this.currentWallpaper instanceof g1.i) {
                    ((lo9) tLRPC$TL_message).f9686a = org.telegram.messenger.u.B0("BackgroundColorSinglePreviewLine2", e78.Eb);
                } else {
                    ((lo9) tLRPC$TL_message).f9686a = org.telegram.messenger.u.B0("BackgroundPreviewLine2", e78.Mb);
                }
                ...
                if (c1.this.currentWallpaper instanceof g1.i) {
                    ((lo9) tLRPC$TL_message2).f9686a = org.telegram.messenger.u.B0("BackgroundColorSinglePreviewLine1", e78.Db);
                } else {
                    ((lo9) tLRPC$TL_message2).f9686a = org.telegram.messenger.u.B0("BackgroundPreviewLine1", e78.Lb);
                }
                ...
                ((um9) tLRPC$TL_documentAttributeFilename).f20339b = org.telegram.messenger.u.B0("NewThemePreviewReply2", e78.qK) + ".mp3";
                ...
                String B0 = org.telegram.messenger.u.B0("NewThemePreviewLine3", e78.nK);
                ...
                ((lo9) tLRPC$TL_message6).f9686a = org.telegram.messenger.u.B0("NewThemePreviewLine1", e78.mK);
                ...
                xVar6.f13420g = org.telegram.messenger.u.B0("NewThemePreviewName", e78.oK);
                ...
                ((lo9) tLRPC$TL_message11).f9686a = org.telegram.messenger.u.B0("ThemePreviewLine1", e78.cf0);
                ...
                ((lo9) tLRPC$TL_message12).f9686a = org.telegram.messenger.u.B0("ThemePreviewLine2", e78.df0);
                ...
                ((um9) tLRPC$TL_documentAttributeAudio2).f20343d = org.telegram.messenger.u.B0("ThemePreviewSongPerformer", e78.hf0);
                ((um9) tLRPC$TL_documentAttributeAudio2).f20341c = org.telegram.messenger.u.B0("ThemePreviewSongTitle", e78.if0);
                ...
                ((lo9) tLRPC$TL_message14).f9686a = org.telegram.messenger.u.B0("ThemePreviewLine3", e78.ef0);
                ...
                xVar9.f13420g = org.telegram.messenger.u.B0("ThemePreviewLine3Reply", e78.ff0);
                xVar9.f13370a = xVar8;
                ...
                ((lo9) tLRPC$TL_message16).f9686a = org.telegram.messenger.u.B0("ThemePreviewLine4", e78.gf0);
    ...
    public class n implements ColorPicker.j {
        ...
        public void b() {
            ...
            kVar.v(org.telegram.messenger.u.B0("Delete", e78.Kn), new DialogInterface.OnClickListener() { // from class: e1a
    ...
    */
    ...
    public final void B5(boolean z2, boolean z3) {
        ...
        if (exists) {
            ...
            if (this.screenType == 2) {
                this.actionBar2.setSubtitle(org.telegram.messenger.u.B0("LoadingFullImage", e78.bG));
            }
            this.backgroundImage.invalidate();
        }
    ...
    public final void r5(int i2, boolean z2) {
        ...
        if (E0() != null && this.colorType != i2 && this.patternViewAnimation == null) {
            if (z2 && i2 == 2 && (org.telegram.ui.ActionBar.l.z2() || this.accent.f16013a == 4294967296L)) {
                e.k kVar = new e.k(E0());
                kVar.x(org.telegram.messenger.u.B0("ChangeChatBackground", e78.mf));
                if (org.telegram.ui.ActionBar.l.z2() && !org.telegram.ui.ActionBar.l.I2()) {
                    kVar.n(org.telegram.messenger.u.B0("ChangeWallpaperToColor", e78.Ff));
                    kVar.v(org.telegram.messenger.u.B0("Change", e78.lf), new DialogInterface.OnClickListener() { // from class: s0a
                        @Override // android.content.DialogInterface.OnClickListener
                    ...
                    kVar.n(org.telegram.messenger.u.B0("ChangeColorToColor", e78.nf));
                    kVar.v(org.telegram.messenger.u.B0("Reset", e78.g30), new DialogInterface.OnClickListener() { // from class: q0a
                        @Override // android.content.DialogInterface.OnClickListener
                        public final void onClick(DialogInterface dialogInterface, int i9) {
                            c1.this.j5(dialogInterface, i9);
                        }
                    });
                    kVar.p(org.telegram.messenger.u.B0("Continue", e78.Dl), new DialogInterface.OnClickListener() { // from class: r0a
                        @Override // android.content.DialogInterface.OnClickListener
                        public final void onClick(DialogInterface dialogInterface, int i9) {
            ...
            if (i2 != 1) {
                if (i2 != 2) {
                    if (i2 == 3) {
                        this.dropDown.setText(org.telegram.messenger.u.B0("ColorPickerMyMessages", e78.Sk));
                        l.t tVar = this.accent;
                        if (tVar.e != 0) {
                            if (tVar.g != 0) {
                                i8 = 4;
                    ...
                    this.dropDown.setText(org.telegram.messenger.u.B0("ColorPickerBackground", e78.Qk));
                ...
                this.dropDown.setText(org.telegram.messenger.u.B0("ColorPickerMainColor", e78.Rk));
                if (this.accent.c != 0) {
                    i3 = 2;
                } else {
                    i3 = 1;
            ...
            if (i3 == 2) {
                ...
                if (obj instanceof TLRPC$TL_wallPaper) {
                    ...
                    if (tLRPC$TL_wallPaper2 != null) {
                        ...
                        this.backgroundImage.setImageBitmap(org.telegram.messenger.f0.l(y68.S, min, max, k2));
                    }
    ...
    public final void y5() {
        if (this.page2 != null && this.messagesCheckBoxView != null && this.accent.f != 0) {
            ...
            if (this.animationHint == null) {
                ...
                this.animationHint.setText(org.telegram.messenger.u.B0("BackgroundAnimateInfo", e78.zb));
