...
public class g extends org.telegram.ui.ActionBar.f implements a0.d {
    ...
    public class e extends FrameLayout {
        ...
        public e(Context context) {
            ...
            this.imageView.setContentDescription(org.telegram.messenger.u.B0("Call", e78.de));
    ...
    public static class C0116g extends FrameLayout {
        ...
        public C0116g(Context context, View view) {
            ...
            e88Var.g(y68.j3, Constants.MEMORY_PAGE_DATA_OVERFLOW, Constants.MEMORY_PAGE_DATA_OVERFLOW);
            ...
            this.emptyTextView1.setText(org.telegram.messenger.u.B0("NoRecentCalls", e78.nL));
            ...
            String B0 = org.telegram.messenger.u.B0("NoRecentCallsInfo", e78.oL);
    ...
    public class h extends FrameLayout {
        ...
        public h(Context context) {
            ...
            int e0;
            setBackgroundColor(org.telegram.ui.ActionBar.l.B1("windowBackgroundWhite"));
            String B0 = org.telegram.messenger.u.B0("VoipChatJoin", e78.Sl0);
    ...
    public View W(Context context) {
        ...
        float f2;
        float f3;
        Drawable mutate = E0().getResources().getDrawable(g68.H2).mutate();
        ...
        Drawable mutate2 = E0().getResources().getDrawable(g68.I2).mutate();
        ...
        Drawable mutate3 = E0().getResources().getDrawable(g68.I2).mutate();
        ...
        org.telegram.ui.ActionBar.c b2 = this.actionBar.x().b(10, g68.v2);
        this.otherItem = b2;
        b2.setContentDescription(org.telegram.messenger.u.B0("AccDescrMoreOptions", e78.k0));
        this.otherItem.U(1, g68.D6, org.telegram.messenger.u.B0("DeleteAllCalls", e78.Qn));
        ...
        this.floatingButton.setImageResource(g68.F2);
        this.floatingButton.setContentDescription(org.telegram.messenger.u.B0("Call", e78.de));
    ...
    public final void X2() {
        ...
        this.actionModeViews.add(t.j(2, g68.D6, org.telegram.messenger.a.e0(54.0f), org.telegram.messenger.u.B0("Delete", e78.Kn)));
    }
    ...
    public final void o3(final boolean z) {
        ...
        e.k kVar = new e.k(E0());
        if (z) {
            kVar.x(org.telegram.messenger.u.B0("DeleteAllCalls", e78.Qn));
            kVar.n(org.telegram.messenger.u.B0("DeleteAllCallsText", e78.Rn));
        } else {
            kVar.x(org.telegram.messenger.u.B0("DeleteCalls", e78.ho));
            kVar.n(org.telegram.messenger.u.B0("DeleteSelectedCallsText", e78.Po));
        }
        ...
        dl1Var.h(org.telegram.messenger.u.B0("DeleteCallsForEveryone", e78.io), "", false, false);
        if (org.telegram.messenger.u.d) {
        ...
        kVar.E(frameLayout);
        kVar.v(org.telegram.messenger.u.B0("Delete", e78.Kn), new DialogInterface.OnClickListener() { // from class: jc0
        ...
        public void onBindViewHolder(RecyclerView.d0 d0Var, int i) {
            ...
            if (itemViewType != 0) {
                    ...
                    if (itemViewType == 4) {
                        ...
                        if (org.telegram.messenger.d.M(S7) && !S7.h) {
                            if (!org.telegram.messenger.d.a0(S7)) {
                                lowerCase = org.telegram.messenger.u.B0("ChannelPrivate", e78.hh).toLowerCase();
                            } else {
                                lowerCase = org.telegram.messenger.u.B0("ChannelPublic", e78.kh).toLowerCase();
                            }
                        } else if (S7.f5617e) {
                            lowerCase = org.telegram.messenger.u.B0("MegaLocation", e78.UH);
                        } else if (!org.telegram.messenger.d.a0(S7)) {
                            lowerCase = org.telegram.messenger.u.B0("MegaPrivate", e78.VH).toLowerCase();
                        } else {
                            lowerCase = org.telegram.messenger.u.B0("MegaPublic", e78.YH).toLowerCase();
                        }
                ...
                if (i == this.activeHeaderRow) {
                    nu3Var.setText(org.telegram.messenger.u.B0("VoipChatActiveChats", e78.Pl0));
                    return;
                } else if (i == this.callsHeaderRow) {
                    nu3Var.setText(org.telegram.messenger.u.B0("VoipChatRecentCalls", e78.Ul0));
                    return;
                } else {
                    return;
                }
            ...
            if (i != 0) {
                if (i != 1) {
                    if (i != 2) {
                        ...
                        eVar.setBackgroundDrawable(org.telegram.ui.ActionBar.l.u2(this.mContext, g68.g2, "windowBackgroundGrayShadow"));
                    }
                } else {
