...
public class y extends FrameLayout implements a0.d {
        ...
        public class a implements f29.c {
            ...
            public void b(final String str, boolean z) {
                if (z) {
                    ...
                    lVar.k(str);
                    lVar.h(new CharSequence[]{org.telegram.messenger.u.B0("Open", e78.JP), org.telegram.messenger.u.B0("Copy", e78.Fl)}, new DialogInterface.OnClickListener() { // from class: n73
    ...
    public /* synthetic */ void D(int i2, TLRPC$TL_error tLRPC$TL_error, org.telegram.tgnet.a aVar, int i3, boolean z, String str, ArrayList arrayList, g83.h hVar, long j2, long j3, ArrayList arrayList2, ArrayList arrayList3) {
        ...
        if (tLRPC$TL_error != null) {
            this.emptyView.title.setText(org.telegram.messenger.u.B0("SearchEmptyViewTitle2", e78.u50));
        ...
        if (this.messages.isEmpty()) {
            if (hVar != null) {
                if (TextUtils.isEmpty(this.currentDataQuery) && j2 == 0 && j3 == 0) {
                    this.emptyView.title.setText(org.telegram.messenger.u.B0("SearchEmptyViewTitle", e78.t50));
                    int i5 = hVar.b;
                    if (i5 == 1) {
                        B0 = org.telegram.messenger.u.B0("SearchEmptyViewFilteredSubtitleFiles", e78.o50);
                    } else if (i5 == 0) {
                        B0 = org.telegram.messenger.u.B0("SearchEmptyViewFilteredSubtitleMedia", e78.q50);
                    } else if (i5 == 2) {
                        B0 = org.telegram.messenger.u.B0("SearchEmptyViewFilteredSubtitleLinks", e78.p50);
                    } else if (i5 == 3) {
                        B0 = org.telegram.messenger.u.B0("SearchEmptyViewFilteredSubtitleMusic", e78.r50);
                    } else {
                        B0 = org.telegram.messenger.u.B0("SearchEmptyViewFilteredSubtitleVoice", e78.s50);
                    }
                    this.emptyView.subtitle.setVisibility(0);
        ...
        if (!z) {
            ...
            if (str != null && str.length() >= 3 && (org.telegram.messenger.u.B0("SavedMessages", e78.T40).toLowerCase().startsWith(str) || "saved messages".startsWith(str))) {
                int i7 = 0;
                while (true) {
            ...
            if (str != null && str.length() >= 3 && (org.telegram.messenger.u.B0("ArchiveSearchFilter", e78.U6).toLowerCase().startsWith(str) || "archive".startsWith(str))) {
    ...
    public static CharSequence z(org.telegram.messenger.x xVar) {
        ...
        if (arrowSpan == null) {
            ...
            spannableStringBuilder.setSpan(new kq1(sz1.e(org.telegram.messenger.b.f12514a, g68.ne).mutate()), 0, 1, 0);
        }
        ?? r0 = 0;
