...
public class i extends org.telegram.ui.ActionBar.f implements a0.d {
    ...
    public class w extends RecyclerView.g {
            ...
            public void r(qf1 qf1Var, CharacterStyle characterStyle, boolean z) {
                ...
                if (characterStyle instanceof b3) {
                    ...
                    if (org.telegram.messenger.a.L3()) {
                        Toast.makeText(i.this.E0(), org.telegram.messenger.u.B0("TextCopied", e78.te0), 0).show();
                    }
                    ...
                    if (z) {
                        ...
                        lVar.k(url2);
                        lVar.h(new CharSequence[]{org.telegram.messenger.u.B0("Open", e78.JP), org.telegram.messenger.u.B0("Copy", e78.Fl)}, new DialogInterface.OnClickListener() { // from class: bj0
        ...
        public class c implements jl0.b {
            ...
            public /* synthetic */ void p(TLRPC$TL_chatInviteExported tLRPC$TL_chatInviteExported, TLRPC$TL_messages_exportedChatInvite tLRPC$TL_messages_exportedChatInvite, boolean[] zArr, org.telegram.ui.ActionBar.e eVar) {
                ...
                org.telegram.ui.Components.q.p0(i.this).T(y68.V0, org.telegram.messenger.u.B0("LinkHashExpired", e78.AF)).T();
            }
    ...
    public /* synthetic */ void B4(org.telegram.tgnet.a aVar) {
        if (aVar instanceof TLRPC$TL_boolTrue) {
            org.telegram.ui.Components.q.p0(this).T(y68.a1, org.telegram.messenger.u.B0("ChannelAntiSpamFalsePositiveReported", e78.Vf)).T();
    ...
    public static /* synthetic */ void n4(ArrayList arrayList, ArrayList arrayList2, ArrayList arrayList3, Runnable runnable, boolean z, TLRPC$TL_chatAdminRights tLRPC$TL_chatAdminRights, String str) {
        if (z) {
            arrayList.add(org.telegram.messenger.u.B0("BanUser", e78.Xb));
            arrayList2.add(Integer.valueOf(g68.K5));
            arrayList3.add(33);
        }
    ...
    public /* synthetic */ void p4(final ArrayList arrayList, ArrayList arrayList2, ArrayList arrayList3, View view, float f2, float f3) {
        ...
        int i = 0;
        ActionBarPopupWindow.ActionBarPopupWindowLayout actionBarPopupWindowLayout = new ActionBarPopupWindow.ActionBarPopupWindowLayout(E0(), g68.Jd, j(), 0);
        actionBarPopupWindowLayout.setMinimumWidth(org.telegram.messenger.a.e0(200.0f));
        Rect rect = new Rect();
        E0().getResources().getDrawable(g68.Jd).mutate().getPadding(rect);
        ...
        this.scrimPopupWindow.setAnimationStyle(j78.g);
    ...
    public /* synthetic */ void r4(TLRPC$TL_channelAdminLogEventsFilter tLRPC$TL_channelAdminLogEventsFilter, j45 j45Var) {
        ...
        if (tLRPC$TL_channelAdminLogEventsFilter == null && j45Var == null) {
            this.avatarContainer.setSubtitle(org.telegram.messenger.u.B0("EventLogAllEvents", e78.Lt));
        } else {
            this.avatarContainer.setSubtitle(org.telegram.messenger.u.B0("EventLogSelectedEvents", e78.Gv));
        }
        G4(true);
    }
    ...
    public /* synthetic */ void t4(View view) {
        ...
        if (this.currentChat.h) {
            kVar.n(org.telegram.messenger.a.b3(org.telegram.messenger.u.B0("EventLogInfoDetail", e78.Mu)));
        } else {
            kVar.n(org.telegram.messenger.a.b3(org.telegram.messenger.u.B0("EventLogInfoDetailChannel", e78.Nu)));
        }
        kVar.v(org.telegram.messenger.u.B0("OK", e78.zP), null);
        kVar.x(org.telegram.messenger.u.B0("EventLogInfoTitle", e78.Ou));
        f2(kVar.a());
    }
    ...
    */
    ...
    public void L4(final String str, boolean z) {
        if (!f60.m(str, null) && z) {
            e.k kVar = new e.k(E0());
            kVar.x(org.telegram.messenger.u.B0("OpenUrlTitle", e78.dQ));
            kVar.n(org.telegram.messenger.u.d0("OpenUrlAlert2", e78.aQ, str));
            kVar.v(org.telegram.messenger.u.B0("Open", e78.JP), new DialogInterface.OnClickListener() { // from class: ni0
                @Override // android.content.DialogInterface.OnClickListener
                public final void onClick(DialogInterface dialogInterface, int i) {
    ...
    public final void N4() {
        ...
        if (!TextUtils.isEmpty(this.searchQuery)) {
            ...
            this.emptyView.setText(org.telegram.messenger.a.b3(org.telegram.messenger.u.d0("EventLogEmptyTextSearch", e78.vu, this.searchQuery)));
            ...
            if (this.currentChat.h) {
                this.emptyView.setText(org.telegram.messenger.a.b3(org.telegram.messenger.u.B0("EventLogEmpty", e78.su)));
            } else {
                this.emptyView.setText(org.telegram.messenger.a.b3(org.telegram.messenger.u.B0("EventLogEmptyChannel", e78.tu)));
            }
        } else {
            this.emptyView.setPadding(org.telegram.messenger.a.e0(8.0f), org.telegram.messenger.a.e0(5.0f), org.telegram.messenger.a.e0(8.0f), org.telegram.messenger.a.e0(5.0f));
            this.emptyView.setText(org.telegram.messenger.a.b3(org.telegram.messenger.u.B0("EventLogEmptySearch", e78.uu)));
        }
    }
    ...
    public View W(Context context) {
        ...
        org.telegram.ui.ActionBar.c P0 = this.actionBar.x().b(0, g68.x2).R0(true).P0(new q());
        this.searchItem = P0;
        ...
        this.bottomOverlayChatText.setText(org.telegram.messenger.u.B0("SETTINGS", e78.y40).toUpperCase());
        this.bottomOverlayChat.addView(this.bottomOverlayChatText, cn4.d(-2, -2, 17));
        ImageView imageView = new ImageView(context);
        this.bottomOverlayImage = imageView;
        imageView.setImageResource(g68.F7);
        ...
        this.bottomOverlayImage.setContentDescription(org.telegram.messenger.u.B0("BotHelp", e78.Kc));
        ...
        this.searchCalendarButton.setImageResource(g68.R5);
    ...
    public final void e4(org.telegram.messenger.x xVar) {
        ...
        kVar.v(org.telegram.messenger.u.B0("OK", e78.zP), null);
        if (xVar.f13381b == 3) {
            kVar.n(org.telegram.messenger.u.B0("NoPlayerInstalled", e78.iL));
        } else {
            kVar.n(org.telegram.messenger.u.d0("NoHandleAppInstalled", e78.QK, xVar.o0().f19570b));
        }
        f2(kVar.a());
    }
