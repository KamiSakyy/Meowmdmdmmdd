...
public class p extends org.telegram.ui.ActionBar.f implements a0.d, t0.f {
    ...
    public /* synthetic */ void U2(Context context, final mq9 mq9Var, View view) {
        org.telegram.ui.Components.b.H2(context, org.telegram.messenger.u.B0("ResetToOriginalPhotoTitle", e78.L30), org.telegram.messenger.u.d0("ResetToOriginalPhotoMessage", e78.K30, mq9Var.f10558a), org.telegram.messenger.u.B0("Reset", e78.g30), new Runnable() { // from class: rv1
    ...
    public /* synthetic */ void h3(en9 en9Var, on9 on9Var, org.telegram.tgnet.a aVar, en9 en9Var2, int i) {
        ...
        if ((en9Var != null || on9Var != null) && aVar != null) {
            ...
            if (R8 != null) {
                ...
                if (E0() != null) {
                    if (i == 2) {
                        org.telegram.ui.Components.q.p0(this).f0(arrayList2, org.telegram.messenger.a.b3(org.telegram.messenger.u.d0("UserCustomPhotoSeted", e78.Ni0, R8.f10558a))).T();
                    } else {
                        org.telegram.ui.Components.q.p0(this).f0(arrayList2, org.telegram.messenger.a.b3(org.telegram.messenger.u.d0("UserCustomPhotoSeted", e78.Ni0, R8.f10558a))).T();
                    }
                }
    ...
    public View W(final Context context) {
        ...
        if (this.addContact) {
            this.actionBar.setTitle(org.telegram.messenger.u.B0("NewContact", e78.WJ));
        } else {
            this.actionBar.setTitle(org.telegram.messenger.u.B0("EditContact", e78.vr));
        }
        this.actionBar.setActionBarMenuOnItemClick(new a());
        this.doneButton = this.actionBar.x().h(1, org.telegram.messenger.u.B0("Done", e78.vq).toUpperCase());
        ...
        this.firstNameField.setHint(org.telegram.messenger.u.B0("FirstName", e78.Sx));
        ...
        this.lastNameField.setHint(org.telegram.messenger.u.B0("LastName", e78.nE));
        ...
        if (this.addContact) {
            ...
            if (this.needAddException) {
                ...
                this.checkBoxCell.h(org.telegram.messenger.a.X2("%1$s", org.telegram.messenger.a.b3(org.telegram.messenger.u.B0("SharePhoneNumberWith", e78.S80)), org.telegram.messenger.i.z(xla.a(R8), this.infoTextView.getPaint().getFontMetricsInt(), org.telegram.messenger.a.e0(12.0f), false)), "", true, false);
            ...
            pu9Var.i(org.telegram.messenger.u.d0("SuggestUserPhoto", e78.Ec0, R8.f10558a), g68.q5, true);
            ...
            int i13 = y68.I1;
            final RLottieDrawable rLottieDrawable = new RLottieDrawable(i13, "" + y68.I1, org.telegram.messenger.a.e0(50.0f), org.telegram.messenger.a.e0(50.0f), false, null);
            ...
            pu9Var2.i(org.telegram.messenger.u.d0("UserSetPhoto", e78.uj0, R8.f10558a), g68.q5, false);
            ...
            int i14 = y68.v;
            final RLottieDrawable rLottieDrawable2 = new RLottieDrawable(i14, "" + y68.v, org.telegram.messenger.a.e0(50.0f), org.telegram.messenger.a.e0(50.0f), false, null);
            ...
            this.oldPhotoCell.f(org.telegram.messenger.u.B0("ResetToOriginalPhoto", e78.J30), false);
    ...
    public final void m3() {
        ...
        if (TextUtils.isEmpty(Q2())) {
            this.nameTextView.setText(org.telegram.messenger.u.B0("MobileHidden", e78.kJ));
            this.infoTextView.setText(org.telegram.messenger.a.X2("%1$s", org.telegram.messenger.a.b3(org.telegram.messenger.u.B0("MobileHiddenExceptionInfo", e78.lJ)), org.telegram.messenger.i.z(xla.a(R8), this.infoTextView.getPaint().getFontMetricsInt(), org.telegram.messenger.a.e0(12.0f), false)));
        } else {
            TextView textView = this.nameTextView;
            z77 d2 = z77.d();
            textView.setText(d2.c("+" + Q2()));
            if (this.needAddException) {
                this.infoTextView.setText(org.telegram.messenger.a.b3(org.telegram.messenger.u.d0("MobileVisibleInfo", e78.mJ, xla.a(R8))));
            }
        }
