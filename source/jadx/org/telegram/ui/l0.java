...
public class l0 extends org.telegram.ui.ActionBar.f implements a0.d, v.c {
    ...
    public class k extends FrameLayout {
        ...
        public k(Context context) {
            ...
            this.titleTextView.setText(org.telegram.messenger.a.b3(org.telegram.messenger.u.d0("PeopleNearby", e78.pV, new Object[0])));
            ...
            this.messageTextView.setText(org.telegram.messenger.a.b3(org.telegram.messenger.u.d0("PeopleNearbyInfo2", e78.vV, new Object[0])));
            ...
            if (itemViewType != 0) {
                if (itemViewType != 1) {
                    if (itemViewType != 2) {
                        if (itemViewType == 3) {
                            ...
                            if (i == l0.this.usersHeaderRow) {
                                jVar.setText(org.telegram.messenger.u.B0("PeopleNearbyHeader", e78.uV));
                                return;
                            } else if (i == l0.this.chatsHeaderRow) {
                                jVar.setText(org.telegram.messenger.u.B0("ChatsNearbyHeader", e78.dj));
                                return;
                            } else {
                                return;
                            }
                    ...
                    if (i == l0.this.chatsCreateRow) {
                        String B0 = org.telegram.messenger.u.B0("NearbyCreateGroup", e78.CJ);
                        int i2 = g68.z7;
                        ...
                        l0Var.showingMe = z;
                        if (z) {
                            String B02 = org.telegram.messenger.u.B0("StopShowingMe", e78.Wb0);
                            int i3 = g68.U8;
                        ...
                        String B03 = org.telegram.messenger.u.B0("MakeMyselfVisible", e78.jH);
                        int i4 = g68.S8;
                        if (l0.this.usersStartRow != -1) {
                            z2 = true;
                        }
                        ...
                        u65Var.c(org.telegram.messenger.u.U("ShowVotes", l0.this.users.size() - 5, new Object[0]), null, g68.g, false);
                        return;
                    } else {
                        return;
                    }
    ...
    public /* synthetic */ void e3(View view, int i2) {
        ...
        if (i2 >= i4 && i2 < this.chatsEndRow) {
            ...
            if (this.showingMe) {
                ...
                e.k kVar = new e.k(E0());
                kVar.x(org.telegram.messenger.u.B0("MakeMyselfVisibleTitle", e78.lH));
                kVar.n(org.telegram.messenger.u.B0("MakeMyselfVisibleInfo", e78.kH));
                kVar.v(org.telegram.messenger.u.B0("OK", e78.zP), new DialogInterface.OnClickListener() { // from class: y67
    ...
    public View W(Context context) {
        ...
        this.actionBar.setTitle(org.telegram.messenger.u.B0("PeopleNearby", e78.pV));
    ...
    */
    ...
    public final void k3() {
        if (!this.canCreateGroup) {
            org.telegram.ui.Components.b.U5(this, org.telegram.messenger.u.B0("YourLocatedChannelsTooMuch", e78.Bq0));
            return;
        }
