...
public class SecretMediaViewer implements a0.d, GestureDetector.OnGestureListener, GestureDetector.OnDoubleTapListener {
    ...
    public class k extends FrameLayout {
        ...
        public k(Context context) {
            ...
            this.drawable = context.getResources().getDrawable(g68.J1);
        }
    ...
    public void p0(org.telegram.messenger.x xVar, PhotoViewer.o2 o2Var, final Runnable runnable) {
        ...
        if (o0 != null) {
            if (org.telegram.messenger.x.v2(o0)) {
                this.actionBar.setTitle(org.telegram.messenger.u.B0("DisappearingGif", e78.Gp));
                ...
                this.actionBar.setTitle(org.telegram.messenger.u.B0("DisappearingVideo", e78.Ip));
            ...
            i4 = 2;
            c2 = 4;
            this.actionBar.setTitle(org.telegram.messenger.u.B0("DisappearingPhoto", e78.Hp));
