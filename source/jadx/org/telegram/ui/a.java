...
public class a extends org.telegram.ui.ActionBar.f implements v.c {
    ...
    public /* synthetic */ void K2(View view) {
        ...
        switch (this.currentType) {
            ...
            case 3:
                e.k kVar = new e.k(E0());
                kVar.x(org.telegram.messenger.u.B0("PhoneNumberChangeTitle", e78.XV));
                kVar.n(org.telegram.messenger.u.B0("PhoneNumberAlert", e78.VV));
                kVar.v(org.telegram.messenger.u.B0("Change", e78.lf), new DialogInterface.OnClickListener() { // from class: p4
    ...
    public View W(Context context) {
        ...
        if (this.currentType == 5) {
            ...
            while (i12 < i9) {
                ...
                if (i12 == 0) {
                    ...
                    String B0 = org.telegram.messenger.u.B0("AuthAnotherClientInfo1", e78.a9);
                    ...
                    if (indexOf != -1 && lastIndexOf != -1 && indexOf != lastIndexOf) {
                        ...
                        spannableStringBuilder.setSpan(new c3(org.telegram.messenger.u.B0("AuthAnotherClientDownloadClientUrl", e78.Z8)), indexOf, lastIndexOf - 1, 33);
                    }
                    this.desctiptionLines[i15].setText(spannableStringBuilder);
                } else if (i12 == 1) {
                    this.desctiptionLines[i15].setText(org.telegram.messenger.u.B0("AuthAnotherClientInfo2", e78.b9));
                } else {
                    this.desctiptionLines[i15].setText(org.telegram.messenger.u.B0("AuthAnotherClientInfo3", e78.c9));
                }
                if (org.telegram.messenger.u.d) {
        ...
        switch (this.currentType) {
            case 0:
                ...
                this.imageView.g(y68.y, 200, 200);
                this.titleTextView.setText(org.telegram.messenger.u.B0("ChannelAlertTitle", e78.Tf));
                this.descriptionText.setText(org.telegram.messenger.u.B0("ChannelAlertText", e78.Sf));
                this.buttonTextView.setText(org.telegram.messenger.u.B0("ChannelAlertCreate2", e78.Rf));
                this.imageView.e();
            ...
            case 1:
                ...
                this.titleTextView.setText(org.telegram.messenger.u.B0("PeopleNearby", e78.pV));
                this.descriptionText.setText(org.telegram.messenger.u.B0("PeopleNearbyAccessInfo", e78.qV));
                this.buttonTextView.setText(org.telegram.messenger.u.B0("PeopleNearbyAllowAccess", e78.rV));
                this.flickerButton = true;
                break;
            case 2:
                ...
                this.titleTextView.setText(org.telegram.messenger.u.B0("NearbyCreateGroup", e78.CJ));
                this.descriptionText.setText(org.telegram.messenger.u.B0("NearbyCreateGroupInfo", e78.DJ));
                this.descriptionText2.setText(org.telegram.messenger.u.B0("NearbyCreateGroupInfo2", e78.EJ));
                this.buttonTextView.setText(org.telegram.messenger.u.B0("NearbyStartGroup", e78.HJ));
                break;
            case 3:
                this.subtitleTextView.setVisibility(0);
                this.imageView.setScaleType(ImageView.ScaleType.FIT_CENTER);
                this.imageView.g(y68.k3, 200, 200);
                ...
                this.titleTextView.setText(org.telegram.messenger.u.B0("PhoneNumberChange2", e78.WV));
                this.descriptionText.setText(org.telegram.messenger.a.b3(org.telegram.messenger.u.B0("PhoneNumberHelp", e78.ZV)));
                this.buttonTextView.setText(org.telegram.messenger.u.B0("PhoneNumberChange2", e78.WV));
                this.imageView.e();
                this.flickerButton = true;
                break;
            case 4:
                ...
                this.imageView.setScaleType(ImageView.ScaleType.CENTER);
                this.titleTextView.setText(org.telegram.messenger.u.B0("PeopleNearby", e78.pV));
                this.descriptionText.setText(org.telegram.messenger.u.B0("PeopleNearbyGpsInfo", e78.tV));
                this.buttonTextView.setText(org.telegram.messenger.u.B0("PeopleNearbyGps", e78.sV));
                break;
            case 5:
                this.colors = new int[8];
                T2();
                this.imageView.h(y68.d2, 334, 334, this.colors);
                this.imageView.setScaleType(ImageView.ScaleType.CENTER);
                this.titleTextView.setText(org.telegram.messenger.u.B0("AuthAnotherClient", e78.Y8));
                this.buttonTextView.setText(org.telegram.messenger.u.B0("AuthAnotherClientScan", e78.h9));
                this.imageView.e();
                break;
            case 6:
                this.imageView.setScaleType(ImageView.ScaleType.FIT_CENTER);
                this.imageView.g(y68.n3, 200, 200);
                ...
                this.titleTextView.setText(org.telegram.messenger.u.B0("Passcode", e78.bR));
                this.descriptionText.setText(org.telegram.messenger.u.B0("ChangePasscodeInfoShort", e78.tf));
                this.buttonTextView.setText(org.telegram.messenger.u.B0("EnablePasscode", e78.Gs));
                this.imageView.e();
                this.flickerButton = true;
                break;
        }
    ...
    public void q1(int i, String[] strArr, int[] iArr) {
        ...
        if (i == 2) {
            ...
            if (iArr.length > 0 && iArr[0] == 0) {
                ...
                new e.k(E0()).n(org.telegram.messenger.a.b3(org.telegram.messenger.u.B0("QRCodePermissionNoCameraWithHint", e78.E00))).v(org.telegram.messenger.u.B0("PermissionOpenSettings", e78.MV), new DialogInterface.OnClickListener() { // from class: n4
                    @Override // android.content.DialogInterface.OnClickListener
