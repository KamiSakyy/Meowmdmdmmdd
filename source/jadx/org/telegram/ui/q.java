...
public class q extends org.telegram.ui.ActionBar.f implements a0.d {
    ...
    public class c extends AnimatorListenerAdapter {
        ...
        public void onAnimationEnd(Animator animator) {
            if (q.this.floatingButtonContainer != null) {
                ...
                if (!this.val$isOpen) {
                    this.val$previousFab.setImageResource(g68.O1);
                }
            }
    ...
    public /* synthetic */ void c3(int i2, View view, int i3) {
        ...
        if (t >= 0 && v >= 0) {
            ...
            if (r instanceof mq9) {
                ...
                if (str != null && E0() != null) {
                    e.k kVar = new e.k(E0());
                    kVar.n(org.telegram.messenger.u.B0("InviteUser", e78.jD));
                    kVar.x(org.telegram.messenger.u.B0("AppName", e78.p6));
                    kVar.v(org.telegram.messenger.u.B0("OK", e78.zP), new DialogInterface.OnClickListener() { // from class: yv1
    ...
    public /* synthetic */ void i3(AnimatorSet animatorSet, boolean z, View view) {
        ...
        animatorSet.start();
        if (z) {
            this.floatingButton.g(y68.V3, 52, 52);
            this.floatingButton.e();
        } else {
            this.floatingButton.g(y68.W3, 52, 52);
            this.floatingButton.e();
        }
    ...
    public final void X2(final mq9 mq9Var, boolean z, final String str) {
        ...
        if (z && this.selectAlertString != null) {
            ...
            if (mq9Var.f10571e) {
                if (mq9Var.g) {
                    ...
                    if (org.telegram.messenger.d.a(S7)) {
                        kVar.x(org.telegram.messenger.u.B0("AppName", e78.p6));
                        kVar.n(org.telegram.messenger.u.B0("AddBotAsAdmin", e78.w4));
                        kVar.v(org.telegram.messenger.u.B0("MakeAdmin", e78.iH), new DialogInterface.OnClickListener() { // from class: aw1
                            @Override // android.content.DialogInterface.OnClickListener
                        ...
                        kVar.n(org.telegram.messenger.u.B0("CantAddBotAsAdmin", e78.ff));
            ...
            if (!mq9Var.f10571e && this.needForwardCount) {
                f0 = String.format("%s\n\n%s", f0, org.telegram.messenger.u.B0("AddToTheGroupForwardCount", e78.q5));
            ...
            kVar2.n(f0);
            kVar2.v(org.telegram.messenger.u.B0("OK", e78.zP), new DialogInterface.OnClickListener() { // from class: bw1
                @Override // android.content.DialogInterface.OnClickListener
                public final void onClick(DialogInterface dialogInterface, int i2) {
