...
public class a0 extends org.telegram.ui.ActionBar.f implements a0.d, t0.f {
    ...
    public class m extends v1.s {
        ...
        public void notifyDataSetChanged() {
            ...
            this.items.add(new a(5, org.telegram.messenger.u.B0("GroupCreateAutodeleteDescription", e78.Xz)));
        ...
        public void onBindViewHolder(RecyclerView.d0 d0Var, int i) {
                ...
                if (itemViewType != 2) {
                    if (itemViewType != 3) {
                        ...
                        if (a0.this.ttlPeriod == 0) {
                            g0 = org.telegram.messenger.u.B0("PasswordOff", e78.ST);
                        } else {
                            g0 = org.telegram.messenger.u.g0(a0.this.ttlPeriod);
                        }
                        pu9Var.m(org.telegram.messenger.u.B0("AutoDeleteMessages", e78.O9), g0, a0.this.fragmentBeginToShow, g68.D5, false);
                        return;
                    }
            ...
            if (a0.this.currentGroupCreateAddress != null && i == 1) {
                nu3Var.setText(org.telegram.messenger.u.B0("AttachLocation", e78.A8));
            } else {
        ...
        public RecyclerView.d0 onCreateViewHolder(ViewGroup viewGroup, int i) {
                    ...
                    if (i != 2) {
                        if (i != 4) {
                            if (i != 5) {
                                ...
                                nq1 nq1Var = new nq1(new ColorDrawable(org.telegram.ui.ActionBar.l.B1("windowBackgroundGray")), org.telegram.ui.ActionBar.l.u2(this.context, g68.f2, "windowBackgroundGrayShadow"));
                                nq1Var.e(true);
            ...
            nq1 nq1Var2 = new nq1(new ColorDrawable(org.telegram.ui.ActionBar.l.B1("windowBackgroundGray")), org.telegram.ui.ActionBar.l.u2(this.context, g68.h2, "windowBackgroundGrayShadow"));
            nq1Var2.e(true);
    ...
    public View W(Context context) {
        ...
        this.actionBar.setTitle(org.telegram.messenger.u.B0("NewGroup", e78.dK));
        ...
        this.shadowDrawable = context.getResources().getDrawable(g68.h2).mutate();
        ...
        this.avatarImage.setContentDescription(org.telegram.messenger.u.B0("ChoosePhoto", e78.Dj));
        ...
        int i11 = y68.t;
        this.cameraDrawable = new RLottieDrawable(i11, "" + y68.t, org.telegram.messenger.a.e0(60.0f), org.telegram.messenger.a.e0(60.0f), false, null);
        ...
        this.floatingButtonIcon.setImageResource(g68.x0);
