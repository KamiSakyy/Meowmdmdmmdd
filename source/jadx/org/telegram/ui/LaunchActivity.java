...
public class LaunchActivity extends kx implements k.b, a0.d, u.w0 {
            ...
            if (R8 != null) {
                ...
                for (int i2 = 0; i2 < LaunchActivity.this.sideMenu.getChildCount(); i2++) {
                    ...
                    if (childAt instanceof cl2) {
                        ...
                        if (z) {
                            B0 = org.telegram.messenger.u.B0("ChangeEmojiStatus", e78.qf);
                        } else {
                            B0 = org.telegram.messenger.u.B0("SetEmojiStatus", e78.N70);
                        }
                        nk2Var.e(B0);
                        if (z) {
                            i = y68.d0;
    ...
    public class n implements y.h {
        ...
        public /* synthetic */ void h(String str, final long j, final org.telegram.ui.ActionBar.f fVar) {
            if (str != null) {
                ...
                if (T7 != null) {
                    if (T7.f6244a == null) {
                        if (fVar.E0() != null) {
                            org.telegram.ui.Components.q.p0(fVar).T(y68.V0, org.telegram.messenger.u.B0("InviteExpired", e78.PC)).T();
                            return;
                        }
                        return;
                    }
        ...
        public void b() {
            if (!LaunchActivity.this.isFinishing()) {
                org.telegram.ui.Components.b.U5((org.telegram.ui.ActionBar.f) LaunchActivity.mainFragmentsStack.get(LaunchActivity.mainFragmentsStack.size() - 1), org.telegram.messenger.u.B0("JoinToGroupErrorNotExist", e78.KD));
            }
            try {
                this.val$dismissLoading.run();
            } catch (Exception e) {
    ...
    public /* synthetic */ void B4(Runnable runnable, TLRPC$TL_error tLRPC$TL_error) {
        try {
            ...
            if ("APP_VERSION_OUTDATED".equals(tLRPC$TL_error.f14225a)) {
                org.telegram.ui.Components.b.Y5(this, org.telegram.messenger.u.B0("UpdateAppAlert", e78.Yh0), true);
            } else {
                E5(org.telegram.ui.Components.b.F2(this, org.telegram.messenger.u.B0("ErrorOccurred", e78.vt) + "\n" + tLRPC$TL_error.f14225a));
            }
        } catch (Exception e2) {
    ...
    public /* synthetic */ void F4(Runnable runnable, org.telegram.tgnet.a aVar, TLRPC$TL_error tLRPC$TL_error) {
        ...
        if (aVar instanceof TLRPC$TL_langPackLanguage) {
            ...
            if ("LANG_CODE_NOT_SUPPORTED".equals(tLRPC$TL_error.f14225a)) {
                E5(org.telegram.ui.Components.b.F2(this, org.telegram.messenger.u.B0("LanguageUnsupportedError", e78.jE)));
                return;
            }
            E5(org.telegram.ui.Components.b.F2(this, org.telegram.messenger.u.B0("ErrorOccurred", e78.vt) + "\n" + tLRPC$TL_error.f14225a));
        }
    ...
    public /* synthetic */ void H3(View view, int i2, float f2, float f3) {
        ...
        if (i2 == 0) {
            ...
            if (j2 == 2) {
                ...
                f60.y(this, org.telegram.messenger.u.B0("TelegramFaqUrl", e78.Hd0));
                this.drawerLayoutContainer.f(false);
            } else if (j2 == 10) {
                ...
                f60.y(this, org.telegram.messenger.u.B0("TelegramFeaturesUrl", e78.Jd0));
                this.drawerLayoutContainer.f(false);
            } else if (j2 == 14) {
    ...
    public /* synthetic */ void L4(org.telegram.tgnet.a aVar, org.telegram.ui.ActionBar.e eVar, Runnable runnable, TLRPC$TL_error tLRPC$TL_error) {
        ...
        if (c2 != 0) {
            ...
            if (c2 == 1) {
                E5(org.telegram.ui.Components.b.G2(this, org.telegram.messenger.u.B0("Theme", e78.we0), org.telegram.messenger.u.B0("ThemeNotSupported", e78.Ke0)));
            } else {
                E5(org.telegram.ui.Components.b.G2(this, org.telegram.messenger.u.B0("Theme", e78.we0), org.telegram.messenger.u.B0("ThemeNotFound", e78.Je0)));
            }
        }
    }
    ...
    */
    ...
    public /* synthetic */ void Q4(Runnable runnable, org.telegram.tgnet.a aVar, Integer num, Long l2, Integer num2, org.telegram.ui.ActionBar.f fVar, int i2, Bundle bundle) {
        ...
        if (z2) {
            E5(org.telegram.ui.Components.b.t2(this, org.telegram.messenger.u.z0(e78.jp), org.telegram.messenger.u.z0(e78.QF), null));
        }
    }
        ...
        if (!z2) {
            try {
                if (!mainFragmentsStack.isEmpty()) {
                    ...
                    org.telegram.ui.Components.q.p0(arrayList2.get(arrayList2.size() - 1)).C(org.telegram.messenger.u.B0("ChannelPostDeleted", e78.gh)).T();
                }
            } catch (Exception e2) {
                org.telegram.messenger.l.p(e2);
            }
        ...
        if (eVar != null) {
            if (eVar == this.localeDialog) {
                try {
                    ...
                    Toast.makeText(this, O2(hashMap, "ChangeLanguageLater", e78.rf), 1).show();
                } catch (Exception e2) {
                    org.telegram.messenger.l.p(e2);
                }
    ...
    public /* synthetic */ void Y3(org.telegram.tgnet.a aVar, int i2, String str, TLRPC$TL_error tLRPC$TL_error, Runnable runnable) {
        ...
        if (aVar instanceof mq9) {
            ...
            org.telegram.ui.Components.q.p0(arrayList.get(arrayList.size() - 1)).C(org.telegram.messenger.u.z0(e78.ML)).T();
        }
        try {
            runnable.run();
        } catch (Exception e2) {
    ...
    public /* synthetic */ void b4(TLRPC$TL_error tLRPC$TL_error, org.telegram.tgnet.a aVar, int i2, String str, Runnable runnable) {
        ...
        if (tLRPC$TL_error != null) {
            org.telegram.ui.Components.q.p0(mainFragmentsStack.get(arrayList.size() - 1)).C(org.telegram.messenger.u.z0(e78.AU)).T();
        } else if (!isFinishing()) {
    ...
    public /* synthetic */ void i4(org.telegram.tgnet.a aVar, final int i2, String str, final mq9 mq9Var, final String str2, final TLRPC$TL_contacts_resolvedPeer tLRPC$TL_contacts_resolvedPeer) {
        ...
        if (aVar instanceof TLRPC$TL_attachMenuBotsBot) {
            ...
            if (!tLRPC$TL_attachMenuBot.f13887a) {
                if (uVar != null) {
                    ...
                    if (!org.telegram.messenger.w.I3(tLRPC$TL_attachMenuBot, d2)) {
                        org.telegram.ui.Components.q.p0(fVar).C(org.telegram.messenger.u.z0(e78.Cc)).T();
                        return;
                    } else {
            ...
            e.k p2 = new e.k(this).C(ioVar).n(org.telegram.messenger.a.b3(org.telegram.messenger.u.d0("BotRequestAttachPermission", e78.Wc, xla.e(mq9Var)))).v(org.telegram.messenger.u.z0(e78.Bc), new DialogInterface.OnClickListener() { // from class: vi4
            ...
            }).p(org.telegram.messenger.u.z0(e78.Le), null);
            if (tLRPC$TL_attachMenuBot.c) {
                ...
                dl1Var.h(org.telegram.messenger.a.b3(org.telegram.messenger.u.d0("OpenUrlOption2", e78.cQ, xla.e(mq9Var))), "", true, false);
        ...
        org.telegram.ui.Components.q.p0(arrayList3.get(arrayList3.size() - 1)).C(org.telegram.messenger.u.z0(e78.Dc)).T();
    }
    ...
    public /* synthetic */ void p4(final int i2, final mq9 mq9Var, final String str, final String str2, final org.telegram.ui.u uVar, org.telegram.ui.u uVar2, ArrayList arrayList, CharSequence charSequence, boolean z2) {
        ...
        kVar.n(org.telegram.messenger.a.b3(org.telegram.messenger.u.d0("AddMembersAlertNamesText", e78.S4, xla.e(mq9Var), str3)));
        kVar.p(org.telegram.messenger.u.B0("Cancel", e78.Le), null);
        kVar.v(org.telegram.messenger.u.B0("AddBot", e78.u4), new DialogInterface.OnClickListener() { // from class: ri4
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i3) {
            ...
            if (str4 != null && str5 == null) {
                ...
                if (R8 != null && R8.f10571e) {
                    if (R8.s) {
                        ...
                        ArrayList<org.telegram.ui.ActionBar.f> arrayList = mainFragmentsStack;
                        org.telegram.ui.Components.q.p0(arrayList.get(arrayList.size() - 1)).C(org.telegram.messenger.u.z0(e78.Dc)).T();
                    }
                } else {
                    ArrayList<org.telegram.ui.ActionBar.f> arrayList2 = mainFragmentsStack;
                    org.telegram.ui.Components.q.p0(arrayList2.get(arrayList2.size() - 1)).C(org.telegram.messenger.u.z0(e78.Zc)).T();
                }
                ...
                bundle.putString("selectAlertString", org.telegram.messenger.u.B0("SendGameToText", e78.I60));
                bundle.putString("selectAlertStringGroup", org.telegram.messenger.u.B0("SendGameToGroupText", e78.H60));
                org.telegram.ui.u uVar = new org.telegram.ui.u(bundle);
                ...
                if (mq9Var != null && (!mq9Var.f10571e || !mq9Var.g)) {
                    ...
                    try {
                        ...
                        org.telegram.ui.Components.q.p0(arrayList4.get(arrayList4.size() - 1)).C(org.telegram.messenger.u.B0("BotCantJoinGroups", e78.Ec)).T();
                        return;
                    } catch (Exception e3) {
                        org.telegram.messenger.l.p(e3);
                        return;
            ...
            try {
                if (!mainFragmentsStack.isEmpty()) {
                    ...
                    if (tLRPC$TL_error != null && (str12 = tLRPC$TL_error.f14225a) != null && str12.startsWith("FLOOD_WAIT")) {
                        org.telegram.ui.Components.q.p0(fVar).C(org.telegram.messenger.u.B0("FloodWait", e78.Zx)).T();
                    } else if (org.telegram.messenger.a.T1(str11)) {
                        org.telegram.ui.Components.q.p0(fVar).C(org.telegram.messenger.u.B0("NoPhoneFound", e78.eL)).T();
                    } else {
                        org.telegram.ui.Components.q.p0(fVar).C(org.telegram.messenger.u.B0("NoUsernameFound", e78.ML)).T();
                    }
                }
            } catch (Exception e4) {
    ...
    */
    ...
    public /* synthetic */ void w4(Runnable runnable, TLRPC$TL_error tLRPC$TL_error, org.telegram.tgnet.a aVar, int i2) {
        if (!isFinishing()) {
            ...
            if (tLRPC$TL_error.f14225a.startsWith("FLOOD_WAIT")) {
                kVar.n(org.telegram.messenger.u.B0("FloodWait", e78.Zx));
            } else if (tLRPC$TL_error.f14225a.equals("USERS_TOO_MUCH")) {
                kVar.n(org.telegram.messenger.u.B0("JoinToGroupErrorFull", e78.JD));
            } else {
                kVar.n(org.telegram.messenger.u.B0("JoinToGroupErrorNotExist", e78.KD));
            }
    ...
    public static /* synthetic */ void z3(org.telegram.ui.a aVar, TLRPC$TL_error tLRPC$TL_error) {
        String B0 = org.telegram.messenger.u.B0("AuthAnotherClient", e78.Y8);
        org.telegram.ui.Components.b.V5(aVar, B0, org.telegram.messenger.u.B0("ErrorOccurred", e78.vt) + "\n" + tLRPC$TL_error.f14225a);
    }
    ...
    */
    ...
    public final void D5() {
        ...
        if (org.telegram.messenger.a.Y1()) {
            ...
            view2.setBackgroundResource(g68.Ld);
            if (!layerFragmentsStack.isEmpty()) {
                i3 = 0;
            }
    ...
    public final void E2() {
        ...
        this.updateTextView.i(org.telegram.messenger.u.B0("AppUpdate", e78.q6));
    ...
    */
    ...
    public void onCreate(Bundle bundle) {
        ...
        getWindow().setBackgroundDrawableResource(g68.Ef);
    ...
    public final void p5(boolean z2) {
        ...
        if (arrayList != null) {
            if (arrayList.size() != 1) {
                bundle.putString("selectAlertString", org.telegram.messenger.u.B0("SendContactToText", e78.Z60));
                bundle.putString("selectAlertStringGroup", org.telegram.messenger.u.B0("SendContactToGroupText", e78.C60));
            }
        } else {
            bundle.putString("selectAlertString", org.telegram.messenger.u.B0("SendMessagesToText", e78.Z60));
            bundle.putString("selectAlertStringGroup", org.telegram.messenger.u.B0("SendMessagesToGroupText", e78.Y60));
        }
        j jVar = new j(bundle);
