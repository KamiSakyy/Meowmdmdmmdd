...
public abstract class ThemesHorizontalListCell extends v1 implements a0.d {
    ...
    public class InnerThemeView extends FrameLayout {
        ...
        public InnerThemeView(Context context) {
            ...
            this.inDrawable = context.getResources().getDrawable(g68.g5).mutate();
            this.outDrawable = context.getResources().getDrawable(g68.h5).mutate();
        ...
        public final void f() {
            ...
            if (this.themeInfo.f16039b == null) {
                ...
                this.optionsDrawable = getResources().getDrawable(g68.Pd).mutate();
            ...
            if (uVar3.f16039b != null && !uVar3.f16049f) {
                ...
                if ((!z3 || !exists) && (tLRPC$TL_theme = (uVar2 = this.themeInfo).f16035a) != null) {
                    if (tLRPC$TL_theme.f15258a != null) {
                        ...
                        Drawable mutate = getResources().getDrawable(g68.vb).mutate();
                        ...
                        Drawable mutate2 = getResources().getDrawable(g68.Od).mutate();
        ...
        public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
            ...
            accessibilityNodeInfo.addAction(new AccessibilityNodeInfo.AccessibilityAction(32, u.B0("AccDescrMoreOptions", e78.k0)));
        }
