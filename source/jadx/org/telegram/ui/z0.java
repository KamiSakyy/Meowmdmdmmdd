...
public class z0 extends org.telegram.ui.ActionBar.g {
    ...
    public class h implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            kVar.n(org.telegram.messenger.u.B0("TerminateSessionText", e78.je0));
            kVar.x(org.telegram.messenger.u.B0("AreYouSureSessionTitle", e78.X7));
            String B0 = org.telegram.messenger.u.B0("Terminate", e78.ee0);
    ...
    public z0(org.telegram.ui.ActionBar.f fVar, TLRPC$TL_authorization tLRPC$TL_authorization, boolean z, i iVar) {
        ...
        if ((tLRPC$TL_authorization.a & 1) != 0) {
            M = org.telegram.messenger.u.B0("Online", e78.EP);
        } else {
        ...
        Drawable mutate = sz1.e(E0, g68.b5).mutate();
        ...
        jVar.descriptionText.setText(org.telegram.messenger.u.B0("Application", e78.x6));
        linearLayout.addView(jVar);
        if (tLRPC$TL_authorization.g.length() != 0) {
            j jVar2 = new j(E0, false);
            jVar2.valueText.setText(tLRPC$TL_authorization.g);
            Drawable mutate2 = sz1.e(E0, g68.g8).mutate();
            ...
            jVar2.descriptionText.setText(org.telegram.messenger.u.B0("Location", e78.tG));
        ...
        if (tLRPC$TL_authorization.f.length() != 0) {
            ...
            Drawable mutate3 = sz1.e(E0, g68.T7).mutate();
            ...
            jVar3.descriptionText.setText(org.telegram.messenger.u.B0("IpAddress", e78.nD));
        ...
        if (z1(tLRPC$TL_authorization)) {
            ...
            jVar4.valueText.setText(org.telegram.messenger.u.B0("AcceptSecretChats", e78.N1));
            Drawable mutate4 = sz1.e(E0, g68.Ka).mutate();
            ...
            jVar.needDivider = true;
            jVar4.descriptionText.setText(org.telegram.messenger.u.B0("AcceptSecretChatsDescription", e78.O1));
            linearLayout.addView(jVar4);
            jVar = jVar4;
        }
        j jVar5 = new j(E0, true);
        jVar5.valueText.setText(org.telegram.messenger.u.B0("AcceptCalls", e78.L1));
        Drawable mutate5 = sz1.e(E0, g68.U5).mutate();
        ...
        jVar.needDivider = true;
        jVar5.descriptionText.setText(org.telegram.messenger.u.B0("AcceptCallsChatsDescription", e78.M1));
        ...
        if (!z) {
            ...
            textView3.setText(org.telegram.messenger.u.B0("TerminateSession", e78.ie0));
    ...
    public /* synthetic */ void x1(String str, DialogInterface dialogInterface, int i2) {
        ...
        org.telegram.ui.Components.q.o0(l0(), null).n(org.telegram.messenger.u.B0("TextCopied", e78.te0)).T();
    }
    ...
    */
    ...
    public final void w1(final String str) {
        ...
        kVar.l(new CharSequence[]{org.telegram.messenger.u.B0("Copy", e78.Fl)}, new DialogInterface.OnClickListener() { // from class: vx8
            @Override // android.content.DialogInterface.OnClickListener
