...
public class g1 extends org.telegram.ui.ActionBar.f implements a0.d {
    ...
    private static final int[] searchColorsNamesR = {e78.sc, e78.A10, e78.iQ, e78.cq0, e78.Tz, e78.Ed0, e78.UZ, e78.FW, e78.Id, e78.cc, e78.Sz, e78.Lp0};
    ...
    public class b extends a.j {
        ...
        public void b(int i) {
            if (i == -1) {
                ...
                kVar.n(org.telegram.messenger.u.d0("DeleteChatBackgroundsAlert", e78.ko, new Object[0]));
                kVar.v(org.telegram.messenger.u.B0("Delete", e78.Kn), new DialogInterface.OnClickListener() { // from class: z2b
    ...
    public class c extends c.q {
        ...
        public void e() {
            ...
            g1.this.searchItem.setSearchFieldHint(org.telegram.messenger.u.B0("SearchBackgrounds", e78.j50));
        }
    ...
    public class k extends v1.s {
        ...
        public void onBindViewHolder(RecyclerView.d0 d0Var, int i) {
            ...
            if (itemViewType != 0) {
                if (itemViewType != 2) {
                    if (itemViewType == 3) {
                        ...
                        if (i == g1.this.resetInfoRow) {
                            bv9Var.setText(org.telegram.messenger.u.B0("ResetChatBackgroundsInfo", e78.s30));
                            return;
                        }
                        return;
                    }
            ...
            if (i == g1.this.uploadImageRow) {
                pu9Var.i(org.telegram.messenger.u.B0("SelectFromGallery", e78.o60), g68.u9, true);
            } else if (i == g1.this.setColorRow) {
                pu9Var.i(org.telegram.messenger.u.B0("SetColor", e78.K70), g68.c9, true);
            } else if (i == g1.this.resetRow) {
                pu9Var.f(org.telegram.messenger.u.B0("ResetChatBackgrounds", e78.p30), false);
            }
        }
            ...
            if (i != 0) {
                if (i != 1) {
                    if (i != 3) {
                        ...
                        nq1 nq1Var = new nq1(new ColorDrawable(org.telegram.ui.ActionBar.l.B1("windowBackgroundGray")), org.telegram.ui.ActionBar.l.u2(this.mContext, g68.g2, "windowBackgroundGrayShadow"));
                        nq1Var.e(true);
    ...
    public class l extends v1.s {
        ...
        public /* synthetic */ void p(View view, int i) {
            String B0 = org.telegram.messenger.u.B0("BackgroundSearchColor", e78.Nb);
        ...
        public void onBindViewHolder(RecyclerView.d0 d0Var, int i) {
            ...
            if (itemViewType != 0) {
                if (itemViewType == 2) {
                    ((fl3) d0Var.itemView).setText(org.telegram.messenger.u.B0("SearchByColor", e78.k50));
                    return;
                }
                return;
            }
    ...
    public /* synthetic */ void R3(View view, int i2) {
        if (E0() != null && this.listView.getAdapter() != this.searchAdapter) {
            if (i2 == this.uploadImageRow) {
                ...
                e.k kVar = new e.k(E0());
                kVar.x(org.telegram.messenger.u.B0("ResetChatBackgroundsAlertTitle", e78.r30));
                kVar.n(org.telegram.messenger.u.B0("ResetChatBackgroundsAlert", e78.q30));
                kVar.v(org.telegram.messenger.u.B0("Reset", e78.g30), new DialogInterface.OnClickListener() { // from class: t2b
                    @Override // android.content.DialogInterface.OnClickListener
    ...
    public View W(Context context) {
        ...
        if (i2 == 0) {
            this.actionBar.setTitle(org.telegram.messenger.u.B0("ChatBackground", e78.ai));
        } else if (i2 == 1) {
            this.actionBar.setTitle(org.telegram.messenger.u.B0("SelectColorTitle", e78.j60));
        }
        this.actionBar.setActionBarMenuOnItemClick(new b());
        if (this.currentType == 0) {
            org.telegram.ui.ActionBar.c P0 = this.actionBar.x().b(0, g68.x2).R0(true).P0(new c());
            this.searchItem = P0;
            P0.setSearchFieldHint(org.telegram.messenger.u.B0("SearchBackgrounds", e78.j50));
            ...
            this.actionModeViews.add(u.j(3, g68.p7, org.telegram.messenger.a.e0(54.0f), org.telegram.messenger.u.B0("Forward", e78.Cy)));
            this.actionModeViews.add(u.j(4, g68.D6, org.telegram.messenger.a.e0(54.0f), org.telegram.messenger.u.B0("Delete", e78.Kn)));
            this.selectedWallPapers.clear();
        }
        ...
        this.searchEmptyView.setText(org.telegram.messenger.u.B0("NoResult", e78.rL));
