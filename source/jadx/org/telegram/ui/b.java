...
public class b extends org.telegram.ui.ActionBar.f implements a0.d {
    ...
    public class RunnableC0111b implements Runnable {
        ...
        public /* synthetic */ void c(ArrayList arrayList) {
            if (!arrayList.isEmpty()) {
                ...
                if (b.this.o2() > 0) {
                    org.telegram.ui.Components.q.p0(b.this).T(y68.l0, org.telegram.messenger.a.b3(org.telegram.messenger.u.d0("AutodeleteTimerEnabledForChats", e78.hb, org.telegram.messenger.u.g0(b.this.o2() * 60), org.telegram.messenger.u.U("Chats", arrayList.size(), Integer.valueOf(arrayList.size()))))).T();
                } else {
                    org.telegram.ui.Components.q.p0(b.this).T(y68.k0, org.telegram.messenger.u.d0("AutodeleteTimerDisabledForChats", e78.gb, org.telegram.messenger.u.U("Chats", arrayList.size(), Integer.valueOf(arrayList.size())))).T();
                }
            }
        }
    ...
    public /* synthetic */ void r2(final View view) {
        ...
        if (o2() == 0 && i > 0) {
            ...
            kVar.n(org.telegram.messenger.u.d0("AutoDeleteConfirmMessage", e78.A9, org.telegram.messenger.u.g0(i * 60)));
            kVar.p(org.telegram.messenger.u.B0("Cancel", e78.Le), new DialogInterface.OnClickListener() { // from class: xq
                @Override // android.content.DialogInterface.OnClickListener
                public final void onClick(DialogInterface dialogInterface, int i2) {
                    dialogInterface.dismiss();
                }
            });
            kVar.v(org.telegram.messenger.u.B0("Enable", e78.Bs), new DialogInterface.OnClickListener() { // from class: yq
                @Override // android.content.DialogInterface.OnClickListener
                public final void onClick(DialogInterface dialogInterface, int i2) {
    ...
    public View W(Context context) {
        ...
        this.actionBar.setTitle(org.telegram.messenger.u.B0("AutoDeleteMessages", e78.O9));
        ...
        nu3Var.setText(org.telegram.messenger.u.B0("MessageLifetime", e78.oI));
        this.checkBoxContainer.addView(nu3Var);
        e eVar = new e(k0());
        this.offCell = eVar;
        eVar.e(org.telegram.messenger.u.B0("ShortMessageLifetimeForever", e78.t90), false, true);
        e eVar2 = this.offCell;
        eVar2.time = 0;
        this.checkBoxContainer.addView(eVar2);
        e eVar3 = new e(k0());
        this.afterOneDay = eVar3;
        eVar3.e(org.telegram.messenger.u.B0("AutoDeleteAfter1Day", e78.q9), false, true);
        e eVar4 = this.afterOneDay;
        eVar4.time = 1440;
        this.checkBoxContainer.addView(eVar4);
        e eVar5 = new e(k0());
        this.afterOneWeek = eVar5;
        eVar5.e(org.telegram.messenger.u.B0("AutoDeleteAfter1Week", e78.s9), false, true);
        e eVar6 = this.afterOneWeek;
        eVar6.time = 10080;
        this.checkBoxContainer.addView(eVar6);
        e eVar7 = new e(k0());
        this.afterOneMonth = eVar7;
        eVar7.e(org.telegram.messenger.u.B0("AutoDeleteAfter1Month", e78.r9), false, true);
        e eVar8 = this.afterOneMonth;
        eVar8.time = 44640;
        this.checkBoxContainer.addView(eVar8);
        e eVar9 = new e(k0());
        this.customTimeButton = eVar9;
        eVar9.e(org.telegram.messenger.u.B0("SetCustomTime", e78.M70), false, false);
        ...
        bv9Var.setText(org.telegram.messenger.a.Z2(org.telegram.messenger.u.B0("GlobalAutoDeleteInfo", e78.Lz), new RunnableC0111b()));
    ...
    public final void s2(int i, boolean z) {
        ...
        eVar.custom = true;
        eVar.time = i;
        eVar.e(org.telegram.messenger.u.d0("AutoDeleteAfterShort", e78.t9, org.telegram.messenger.u.g0(i * 60)), false, true);
    ...
    public final void t2(View view, boolean z) {
        ...
        if (z && (i = ((e) view).time) > 0) {
            org.telegram.ui.Components.q.p0(this).T(y68.l0, org.telegram.messenger.a.b3(org.telegram.messenger.u.d0("AutoDeleteGlobalTimerEnabled", e78.H9, org.telegram.messenger.u.g0(i * 60)))).T();
        }
    }
