...
public abstract class f extends FrameLayout implements cj6.a {
    ...
    public class a extends k3.f {
        ...
        public /* synthetic */ boolean s(final v1 v1Var, final org.telegram.ui.ActionBar.f fVar, final View view, int i, float f, float f2) {
            ...
            if (view instanceof x39) {
                org.telegram.ui.ActionBar.c.O(actionBarPopupWindowLayout, g68.Qb, org.telegram.messenger.u.B0("CacheOpenFile", e78.Rd), false, null).setOnClickListener(new View.OnClickListener() { // from class: va0
                ...
                org.telegram.ui.ActionBar.c.O(actionBarPopupWindowLayout, g68.A9, org.telegram.messenger.u.B0("PlayFile", e78.LW), false, null).setOnClickListener(new View.OnClickListener() { // from class: wa0
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view2) {
                ...
                org.telegram.ui.ActionBar.c.O(actionBarPopupWindowLayout, g68.Qb, org.telegram.messenger.u.B0("CacheOpenFile", e78.Rd), false, null).setOnClickListener(new View.OnClickListener() { // from class: xa0
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view2) {
            ...
            if (aVar.f11860a != 0 && aVar.b != 0) {
                org.telegram.ui.ActionBar.c.O(actionBarPopupWindowLayout, g68.Sb, org.telegram.messenger.u.B0("ViewInChat", e78.Ck0), false, null).setOnClickListener(new View.OnClickListener() { // from class: ya0
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view2) {
        ...
        public void onBindViewHolder(RecyclerView.d0 d0Var, int i) {
            ...
            if (d0Var.getItemViewType() == 1) {
                ...
                if (jVar.dialogId == Long.MAX_VALUE) {
                    n = org.telegram.messenger.u.B0("CacheOtherChats", e78.Sd);
    ...
    public class h extends c {
        ...
        public void onBindViewHolder(RecyclerView.d0 d0Var, int i) {
            ...
            if (aVar.c == 5) {
                name = org.telegram.messenger.u.B0("AttachRound", e78.M8);
            } else {
    ...
    public f(Context context, org.telegram.ui.ActionBar.f fVar) {
        ...
        lVarArr[0] = new l(org.telegram.messenger.u.B0("Chats", e78.Yi), 0, new g());
        this.allPages[1] = new l(org.telegram.messenger.u.B0("Media", e78.LH), 1, new j());
        this.allPages[2] = new l(org.telegram.messenger.u.B0("Files", e78.yw), 2, new h());
        this.allPages[3] = new l(org.telegram.messenger.u.B0("Music", e78.pJ), 3, new k());
        int i2 = 0;
        while (true) {
            ...
            if (i2 < lVarArr2.length) {
                ...
                imageView.setContentDescription(org.telegram.messenger.u.B0("Close", e78.Gk));
                ...
                this.clearItem = cVar;
                cVar.setIcon(g68.j6);
                cVar.setContentDescription(org.telegram.messenger.u.B0("Delete", e78.Kn));
