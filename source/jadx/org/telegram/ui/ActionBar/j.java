...
public final class j {
    ...
    public final class b {
        ...
        public b(Context context, View view) {
            ...
            Drawable mutate = context.getDrawable(g68.V1).mutate();
            this.f15689a = mutate;
            mutate.setAutoMirrored(true);
            Drawable mutate2 = context.getDrawable(g68.T1).mutate();
            this.f15707b = mutate2;
            mutate2.setAutoMirrored(true);
            AnimatedVectorDrawable animatedVectorDrawable = (AnimatedVectorDrawable) context.getDrawable(g68.U1).mutate();
            this.f15688a = animatedVectorDrawable;
            animatedVectorDrawable.setAutoMirrored(true);
            AnimatedVectorDrawable animatedVectorDrawable2 = (AnimatedVectorDrawable) context.getDrawable(g68.W1).mutate();
        ...
        public final void f0() {
            ...
            if (this.f15718d) {
                ...
                this.f15697a.setContentDescription(u.B0("AccDescrMoreOptions", e78.k0));
                if (K()) {
