...
public class ActionBarPopupWindow extends PopupWindow {
                ...
                if (ActionBarPopupWindowLayout.this.fitItems) {
                    ...
                    for (int i5 = 0; i5 < childCount; i5++) {
                        ...
                        if (childAt.getVisibility() != 8) {
                            Object tag = childAt.getTag(i68.o2);
                            Object tag2 = childAt.getTag(i68.V0);
                            Object tag3 = childAt.getTag(i68.S);
                            if (tag != null) {
        ...
        public void r() {
            ...
            for (int i2 = 0; i2 < childCount; i2++) {
                ...
                if (childAt2.getVisibility() == 0) {
                    Object tag = childAt2.getTag(i68.V0);
    ...
    public static class d extends FrameLayout {
        ...
        public d(Context context, l.r rVar, String str) {
            ...
            this.f15535a = rVar;
            this.f15534a = str;
            this.a = l.v2(getContext(), g68.f2, "windowBackgroundGrayShadow", rVar);
