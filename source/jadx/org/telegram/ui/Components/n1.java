...
public class n1 extends FrameLayout implements m0.c {
    ...
    public class d extends v1.s {
        ...
        public void onBindViewHolder(RecyclerView.d0 d0Var, int i) {
            ...
            if (itemViewType != 0) {
                if (itemViewType == 1) {
                    ...
                    if (i == n1.this.tintShadowsTool) {
                        c97Var.c(org.telegram.messenger.u.B0("TintShadows", e78.wf0), 0, n1.this.tintShadowsColor);
                        return;
                    } else if (i == n1.this.tintHighlightsTool) {
                        c97Var.c(org.telegram.messenger.u.B0("TintHighlights", e78.vf0), 0, n1.this.tintHighlightsColor);
                        return;
                    } else {
                        return;
                    }
            ...
            if (i == n1.this.enhanceTool) {
                e97Var.i(org.telegram.messenger.u.B0("Enhance", e78.ft), n1.this.enhanceValue, 0, 100);
            } else if (i == n1.this.highlightsTool) {
                e97Var.i(org.telegram.messenger.u.B0("Highlights", e78.UA), n1.this.highlightsValue, -100, 100);
            } else if (i == n1.this.contrastTool) {
                e97Var.i(org.telegram.messenger.u.B0("Contrast", e78.El), n1.this.contrastValue, -100, 100);
            } else if (i == n1.this.exposureTool) {
                e97Var.i(org.telegram.messenger.u.B0("Exposure", e78.gw), n1.this.exposureValue, -100, 100);
            } else if (i == n1.this.warmthTool) {
                e97Var.i(org.telegram.messenger.u.B0("Warmth", e78.Fp0), n1.this.warmthValue, -100, 100);
            } else if (i == n1.this.saturationTool) {
                e97Var.i(org.telegram.messenger.u.B0("Saturation", e78.A40), n1.this.saturationValue, -100, 100);
            } else if (i == n1.this.vignetteTool) {
                e97Var.i(org.telegram.messenger.u.B0("Vignette", e78.Pk0), n1.this.vignetteValue, 0, 100);
            } else if (i == n1.this.shadowsTool) {
                e97Var.i(org.telegram.messenger.u.B0("Shadows", e78.F80), n1.this.shadowsValue, -100, 100);
            } else if (i == n1.this.grainTool) {
                e97Var.i(org.telegram.messenger.u.B0("Grain", e78.Rz), n1.this.grainValue, 0, 100);
            } else if (i == n1.this.sharpenTool) {
                e97Var.i(org.telegram.messenger.u.B0("Sharpen", e78.r90), n1.this.sharpenValue, 0, 100);
            } else if (i == n1.this.fadeTool) {
                e97Var.i(org.telegram.messenger.u.B0("Fade", e78.jw), n1.this.fadeValue, 0, 100);
            } else if (i == n1.this.softenSkinTool) {
                e97Var.i(org.telegram.messenger.u.B0("SoftenSkin", e78.la0), n1.this.softenSkinValue, 0, 100);
            }
        }
    ...
    */
    ...
    public final void C0() {
        int i = this.blurType;
        if (i == 0) {
            Drawable mutate = this.blurOffButton.getContext().getResources().getDrawable(g68.M5).mutate();
            ...
            this.blurRadialButton.setCompoundDrawablesWithIntrinsicBounds(0, g68.N5, 0, 0);
            this.blurRadialButton.setTextColor(-1);
            this.blurLinearButton.setCompoundDrawablesWithIntrinsicBounds(0, g68.L5, 0, 0);
            this.blurLinearButton.setTextColor(-1);
        } else if (i == 1) {
            this.blurOffButton.setCompoundDrawablesWithIntrinsicBounds(0, g68.M5, 0, 0);
            this.blurOffButton.setTextColor(-1);
            Drawable mutate2 = this.blurOffButton.getContext().getResources().getDrawable(g68.N5).mutate();
            ...
            this.blurRadialButton.setCompoundDrawablesWithIntrinsicBounds(0, g68.N5, 0, 0);
            this.blurRadialButton.setTextColor(-1);
            Drawable mutate3 = this.blurOffButton.getContext().getResources().getDrawable(g68.L5).mutate();
