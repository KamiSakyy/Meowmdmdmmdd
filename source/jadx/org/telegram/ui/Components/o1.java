...
public abstract class o1 extends FrameLayout implements a0.d, m2.a {
    ...
    public o1(final PhotoViewer photoViewer, Context context, final m2 m2Var, View view, l.r rVar) {
        ...
        this.emojiButton.setContentDescription(org.telegram.messenger.u.B0("Emoji", e78.fs));
        ...
        this.emojiIconDrawable.d(g68.E3, false);
        ...
        this.messageEditText.setHint(org.telegram.messenger.u.B0("AddCaption", e78.C4));
        ...
        this.checkDrawable = context.getResources().getDrawable(g68.v3).mutate();
        ...
        imageView3.setContentDescription(org.telegram.messenger.u.B0("Done", e78.vq));
    ...
    public final void i0(int i, boolean z) {
        ...
        if (i == 1) {
            ...
            if (m2Var != null) {
                ...
                m2Var.requestLayout();
                this.emojiIconDrawable.d(g68.x3, true);
                e0();
                return;
            }
            return;
        ...
        if (this.emojiButton != null) {
            this.emojiIconDrawable.d(g68.E3, true);
        }
