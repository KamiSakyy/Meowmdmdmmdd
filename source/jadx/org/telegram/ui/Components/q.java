...
public final class q {
    ...
    */
    public static org.telegram.ui.Components.p G(android.content.Context r3, android.widget.FrameLayout r4, int r5, long r6, int r8, int r9, int r10) {
        ...
        L57:
            ...
            android.text.SpannableStringBuilder r5 = org.telegram.messenger.a.b3(r5)
        L79:
            int r6 = defpackage.y68.o0
            java.lang.String[] r7 = new java.lang.String[r0]
            r8.z(r6, r10, r10, r7)
            goto La0
        L81:
            int r6 = defpackage.e78.CC
            java.lang.Object[] r7 = new java.lang.Object[r9]
    ...
    */
    public static org.telegram.ui.Components.p I(org.telegram.ui.ActionBar.f r6, int r7, int r8, org.telegram.ui.ActionBar.l.r r9) {
        ...
        L80:
            if (r3 == 0) goto L8a
            int r8 = defpackage.y68.j1
            java.lang.String[] r9 = new java.lang.String[r2]
            r0.A(r8, r9)
            goto Lb1
        L8a:
            if (r8 == 0) goto La0
            int r8 = defpackage.y68.C0
    ...
    public static p M(org.telegram.ui.ActionBar.f fVar, String str) {
        ...
        lVar.A(y68.y0, "Shield");
        lVar.textView.setText(org.telegram.messenger.a.b3(org.telegram.messenger.u.d0("UserSetAsAdminHint", e78.tj0, str)));
    ...
    public static p N(org.telegram.ui.ActionBar.f fVar, mq9 mq9Var, String str) {
        ...
        lVar.A(y68.z0, "Hand");
        if (mq9Var.f10570d) {
            str2 = org.telegram.messenger.u.d0("HiddenName", e78.EA, new Object[0]);
        } else {
            str2 = mq9Var.f10558a;
        }
        lVar.textView.setText(org.telegram.messenger.a.b3(org.telegram.messenger.u.d0("UserRemovedFromChatHint", e78.Pi0, str2, str)));
        return p.N(fVar, lVar, 1500);
    }
    ...
    public static p Y(org.telegram.ui.ActionBar.f fVar, int i, l.r rVar) {
        ...
        if (i != 0) {
            if (i == 1) {
                B0 = org.telegram.messenger.u.B0("SoundOffHint", e78.za0);
                z = false;
            } else {
                throw new IllegalArgumentException();
            }
        } else {
            B0 = org.telegram.messenger.u.B0("SoundOnHint", e78.Ba0);
        }
        if (z) {
            lVar.A(y68.x2, new String[0]);
        } else {
            lVar.A(y68.w2, new String[0]);
        }
    ...
    public static p c0(org.telegram.ui.ActionBar.f fVar, int i, boolean z, Runnable runnable, Runnable runnable2, l.r rVar) {
        ...
        if (z) {
            ...
            rVar2.z(y68.J0, 28, 28, "Pin", "Line");
            rVar2.titleTextView.setText(org.telegram.messenger.u.B0("PinnedMessagesHidden", e78.IW));
            rVar2.subtitleTextView.setText(org.telegram.messenger.u.B0("PinnedMessagesHiddenInfo", e78.JW));
            lVar = rVar2;
        } else {
            p.l lVar2 = new p.l(fVar.E0(), rVar);
            lVar2.z(y68.J0, 28, 28, "Pin", "Line");
    ...
    public static p j(org.telegram.ui.ActionBar.f fVar, String str) {
        p.l lVar = new p.l(fVar.E0(), fVar.j());
        lVar.A(y68.y0, "Shield");
        lVar.textView.setText(org.telegram.messenger.a.b3(org.telegram.messenger.u.d0("UserAddedAsAdminHint", e78.Hi0, str)));
        return p.N(fVar, lVar, 1500);
    }
    ...
    public static p k(org.telegram.ui.ActionBar.f fVar, boolean z) {
        ...
        if (z) {
            lVar.A(y68.z0, "Hand");
            B0 = org.telegram.messenger.u.B0("UserBlocked", e78.Li0);
        } else {
            lVar.A(y68.H0, "Main", "Finger 1", "Finger 2", "Finger 3", "Finger 4");
            B0 = org.telegram.messenger.u.B0("UserUnblocked", e78.vj0);
        }
    ...
    public static /* synthetic */ void k0(boolean z, final p pVar, long j, TLRPC$TL_messages_stickerSet tLRPC$TL_messages_stickerSet) {
        ...
        if (tLRPC$TL_messages_stickerSet != null && (eq9Var = ((hs9) tLRPC$TL_messages_stickerSet).a) != null) {
            if (z) {
                B0 = org.telegram.messenger.a.b3(org.telegram.messenger.u.d0("TopicContainsEmojiPackSingle", e78.Rf0, eq9Var.f5054a));
            } else {
                B0 = org.telegram.messenger.a.b3(org.telegram.messenger.u.d0("MessageContainsEmojiPackSingle", e78.kI, eq9Var.f5054a));
            }
        } else {
            B0 = org.telegram.messenger.u.B0("AddEmojiNotFound", e78.N4);
        }
    ...
    public p O(l.r rVar) {
        p.l lVar = new p.l(h0(), rVar);
        lVar.A(y68.F, new String[0]);
        lVar.textView.setText(org.telegram.messenger.u.B0("ReportChatSent", e78.n20));
        return i(lVar, 1500);
    }

    public p P() {
        p.l lVar = new p.l(h0(), null);
        lVar.A(y68.J3, new String[0]);
        String z0 = org.telegram.messenger.u.z0(e78.iZ);
    ...
    public p b0(CharSequence charSequence, Runnable runnable, Runnable runnable2) {
        ...
        lVar.textView.setMaxLines(2);
        lVar.y();
        lVar.setButton(new p.s(h0(), true, this.resourcesProvider).o(org.telegram.messenger.u.B0("Undo", e78.rh0)).p(runnable).n(runnable2));
        return i(lVar, 5000);
    }
    ...
    public p m(tm9 tm9Var, final boolean z, final Utilities.b bVar) {
        ...
        if (m5 != null && (eq9Var = ((hs9) m5).a) != null) {
            if (z) {
                b3 = org.telegram.messenger.a.b3(org.telegram.messenger.u.d0("TopicContainsEmojiPackSingle", e78.Rf0, eq9Var.f5054a));
            } else {
                b3 = org.telegram.messenger.a.b3(org.telegram.messenger.u.d0("MessageContainsEmojiPackSingle", e78.kI, eq9Var.f5054a));
            }
            return A(tm9Var, b3, org.telegram.messenger.u.B0("ViewAction", e78.wk0), new Runnable() { // from class: z70
                @Override // java.lang.Runnable
                public final void run() {
        ...
        if (z) {
            spannableStringBuilder = new SpannableStringBuilder(org.telegram.messenger.a.b3(org.telegram.messenger.u.d0("TopicContainsEmojiPackSingle", e78.Rf0, "<{LOADING}>")));
        } else {
            spannableStringBuilder = new SpannableStringBuilder(org.telegram.messenger.a.b3(org.telegram.messenger.u.d0("MessageContainsEmojiPackSingle", e78.kI, "<{LOADING}>")));
        }
        ...
        final p T = B(tm9Var, spannableStringBuilder, org.telegram.messenger.u.B0("ViewAction", e78.wk0), new Runnable() { // from class: x70
            @Override // java.lang.Runnable
            public final void run() {
                Utilities.b.this.a(H0);
            }
    ...
    public p o(String str, int i, int i2) {
        ...
        lVar.z(y68.O, 36, 36, "NULL ROTATION", "Back", "Front");
    ...
    public p s(String str, l.r rVar) {
        ...
        p.l lVar = new p.l(h0(), rVar);
        lVar.z(y68.I3, 36, 36, "Wibe", "Circle");
        lVar.textView.setText(str);
        return i(lVar, 1500);
    }
    ...
    public p u(boolean z, l.r rVar) {
        ...
        if (z) {
            p.r rVar2 = new p.r(h0(), rVar);
            rVar2.z(y68.I3, 36, 36, "Wibe", "Circle");
            rVar2.titleTextView.setText(org.telegram.messenger.u.B0("LinkCopied", e78.uF));
            rVar2.subtitleTextView.setText(org.telegram.messenger.u.B0("LinkCopiedPrivateInfo", e78.vF));
            return i(rVar2, 2750);
        }
        p.l lVar = new p.l(h0(), rVar);
        lVar.z(y68.I3, 36, 36, "Wibe", "Circle");
        lVar.textView.setText(org.telegram.messenger.u.B0("LinkCopied", e78.uF));
        return i(lVar, 1500);
    }
    ...
    public static final class c {
        ...
        /* loaded from: classes3.dex */
        public enum a {
            SAVED_TO_DOWNLOADS(y68.B0, 2, "Box", "Arrow"),
            SAVED_TO_GALLERY(y68.E0, 0, "Box", "Arrow", "Mask", "Arrow 2", "Splash"),
            SAVED_TO_MUSIC(y68.G0, 2, "Box", "Arrow"),
            SAVED_TO_GIFS(y68.F0, 0, "gif");
        ...
        static {
            ...
            PHOTOS = cVar2;
            c cVar3 = new c("VIDEO", 2, "VideoSavedHint", e78.uk0, aVar);
            VIDEO = cVar3;
            ...
            c cVar7 = new c("VIDEO_TO_DOWNLOADS", 6, "VideoSavedToDownloadsHint", e78.vk0, aVar2);
            VIDEO_TO_DOWNLOADS = cVar7;
            c cVar8 = new c("GIF", 7, "GifSavedHint", e78.lz, a.SAVED_TO_GIFS);
            GIF = cVar8;
            c cVar9 = new c("GIF_TO_DOWNLOADS", 8, "GifSavedToDownloadsHint", e78.mz, aVar2);
            ...
            AUDIOS = cVar11;
            c cVar12 = new c("UNKNOWN", 11, "FileSavedHint", e78.ww, aVar2);
            UNKNOWN = cVar12;
