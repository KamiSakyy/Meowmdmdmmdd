...
public class x extends ChatAttachAlert.y implements a0.d {
    ...
    public class j extends du4 {
        ...
        public void notifyDataSetChanged() {
            ...
            if (x.this.emptySubtitleTextView != null) {
                x.this.emptySubtitleTextView.setText(org.telegram.messenger.a.b3(org.telegram.messenger.u.d0("NoPlacesFoundInfo", e78.hL, x.this.searchAdapter.m())));
            }
    ...
    public class l extends FrameLayout {
        ...
        public void c(sx3.l lVar) {
            ...
            x.this.lastPressedMarkerView.setBackgroundResource(g68.Ff);
    ...
    */
    ...
    public void B(ChatAttachAlert.y yVar) {
        long j2;
        this.parentAlert.actionBar.setTitle(org.telegram.messenger.u.B0("ShareLocation", e78.M80));
        ...
        if (this.checkGpsEnabled && getParentActivity() != null) {
            ...
            try {
                if (!((LocationManager) org.telegram.messenger.b.f12514a.getSystemService("location")).isProviderEnabled("gps")) {
                    ...
                    kVar.v(org.telegram.messenger.u.B0("ConnectingToProxyEnable", e78.ml), new DialogInterface.OnClickListener() { // from class: f81
