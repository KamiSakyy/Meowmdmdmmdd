...
public abstract class e0 extends EditTextBoldCursor {
    ...
    public void i0() {
        ...
        kVar.x(org.telegram.messenger.u.B0("CreateLink", e78.Sl));
        final b bVar = new b(getContext());
        bVar.setTextSize(1, 18.0f);
        bVar.setText("http://");
        bVar.setTextColor(Y("dialogTextBlack"));
        bVar.setHintText(org.telegram.messenger.u.B0("URL", e78.lh0));
        ...
        kVar.v(org.telegram.messenger.u.B0("OK", e78.zP), new DialogInterface.OnClickListener() { // from class: bn2
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        if (hasSelection()) {
            B0.b(new l2.a(i68.R0, org.telegram.messenger.u.B0("Spoiler", e78.Ka0)));
            B0.b(new l2.a(i68.H0, org.telegram.messenger.u.B0("Bold", e78.yc)));
            B0.b(new l2.a(i68.K0, org.telegram.messenger.u.B0("Italic", e78.BD)));
            B0.b(new l2.a(i68.M0, org.telegram.messenger.u.B0("Mono", e78.nJ)));
            B0.b(new l2.a(i68.S0, org.telegram.messenger.u.B0("Strike", e78.hc0)));
            B0.b(new l2.a(i68.T0, org.telegram.messenger.u.B0("Underline", e78.qh0)));
            B0.b(new l2.a(i68.L0, org.telegram.messenger.u.B0("CreateLink", e78.Sl)));
            B0.b(new l2.a(i68.O0, org.telegram.messenger.u.B0("Regular", e78.D10)));
        }
    }
