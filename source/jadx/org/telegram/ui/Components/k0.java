...
public class k0 extends FrameLayout implements a0.d {
            ...
            if (i != 0) {
                if (i != 1) {
                    if (i != 2) {
                        ...
                        ne9Var2.c(org.telegram.messenger.u.B0("FeaturedGifs", e78.rw), 0);
    ...
    public class d1 extends FrameLayout {
        ...
        public d1(Context context) {
            ...
            imageView.setImageResource(g68.Y1);
            ...
            textView.setText(org.telegram.messenger.u.B0("NoGIFsFound", e78.OK));
                ...
                if (k0.this.delegate != null) {
                    ...
                    if (!org.telegram.messenger.x.o2(tm9Var2) && !tla.p(k0.this.currentAccount).x() && ((k0.this.delegate == null || !k0.this.delegate.u()) && !k0.this.allowEmojisForNonPremium)) {
                        ...
                        if (!k0.this.premiumBulletin && k0.this.fragment != null) {
                            o0.W(y68.m2, org.telegram.messenger.a.b3(org.telegram.messenger.u.B0("UnlockPremiumEmojiHint2", e78.Bh0)), org.telegram.messenger.u.B0("Open", e78.JP), new Runnable() { // from class: us2
                                @Override // java.lang.Runnable
                                public final void run() {
                                    k0.f1.this.k();
                                }
                            ...
                            SpannableStringBuilder b3 = org.telegram.messenger.a.b3(org.telegram.messenger.u.B0("UnlockPremiumEmojiHint", e78.Ah0));
                            String B0 = org.telegram.messenger.u.B0("PremiumMore", e78.nX);
    ...
    public class g1 extends FrameLayout {
        ...
        public g1(Context context, int i) {
            ...
            if (i == 0) {
                this.searchEditText.setHint(org.telegram.messenger.u.B0("SearchStickersHint", e78.K50));
            } else if (i == 1) {
                this.searchEditText.setHint(org.telegram.messenger.u.B0("SearchEmojiHint", e78.l50));
            } else if (i == 2) {
                this.searchEditText.setHint(org.telegram.messenger.u.B0("SearchGifsTitle", e78.A50));
            }
        ...
        public /* synthetic */ void r(ne9 ne9Var, View view) {
            ...
            if (k0.this.stickersGridView.indexOfChild(ne9Var) != -1 && (m0 = k0.this.stickersGridView.m0(ne9Var)) != null) {
                if (m0.getAdapterPosition() == k0.this.groupStickerPackPosition) {
                    ...
                    org.telegram.ui.ActionBar.e a2 = new e.k(this.context).x(org.telegram.messenger.u.z0(e78.vk)).n(org.telegram.messenger.u.z0(e78.uk)).v(org.telegram.messenger.u.z0(e78.Uj), new DialogInterface.OnClickListener() { // from class: ct2
            ...
            if (itemViewType != 0) {
                ...
                if (itemViewType != 1) {
                    if (itemViewType != 2) {
                        if (itemViewType != 3) {
                            if (itemViewType == 5) {
                                ...
                                ne9Var.c(org.telegram.messenger.u.B0(str2, i3), g68.n6);
                                return;
                            }
                            return;
                        }
                    ...
                    if (obj instanceof TLRPC$TL_messages_stickerSet) {
                        ...
                        ne9Var2.e(org.telegram.messenger.u.B0("RecentStickers", e78.q10), g68.n6, org.telegram.messenger.u.z0(e78.vk));
                        return;
                    } else if (obj == k0.this.favouriteStickers) {
                        ne9Var2.c(org.telegram.messenger.u.B0("FavoriteStickers", e78.mw), 0);
                        return;
                    } else if (obj == k0.this.premiumStickers) {
                        ne9Var2.c(org.telegram.messenger.u.B0("PremiumStickers", e78.XX), 0);
                        return;
                    } else {
                        return;
                    }
                        ...
                        if (i != 3) {
                            if (i != 4) {
                                if (i != 5) {
                                    ...
                                    imageView.setScaleType(ImageView.ScaleType.CENTER);
                                    imageView.setImageResource(g68.ef);
                                    imageView.setColorFilter(new PorterDuffColorFilter(k0.this.U2("chat_emojiPanelEmptyText"), PorterDuff.Mode.MULTIPLY));
                                    bVar.addView(imageView, cn4.c(-2, -2.0f, 17, 0.0f, 0.0f, 0.0f, 59.0f));
                                    TextView textView = new TextView(this.context);
                                    textView.setText(org.telegram.messenger.u.B0("NoStickersFound", e78.GL));
                                    textView.setTextSize(1, 16.0f);
                                    textView.setTextColor(k0.this.U2("chat_emojiPanelEmptyText"));
    ...
    public class p0 extends View {
        ...
        public p0(Context context) {
            ...
            this.backgroundDrawable = getResources().getDrawable(g68.cf);
            this.arrowDrawable = getResources().getDrawable(g68.df);
    ...
    public class q0 extends v1.s {
        ...
        public void onBindViewHolder(RecyclerView.d0 d0Var, int i) {
            ...
            if (itemViewType != 0) {
                ...
                if (i == this.trendingHeaderRow) {
                    str5 = org.telegram.messenger.u.B0("FeaturedEmojiPacks", e78.qw);
    ...
    public class w0 extends FrameLayout implements a0.d {
        ...
        public w0(Context context) {
            ...
            this.premiumButtonView = rm7Var;
            rm7Var.setIcon(y68.i3);
            this.premiumButtonView.h(org.telegram.messenger.u.B0("Unlock", e78.xh0), new View.OnClickListener() { // from class: zr2
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    k0.w0.this.q(view);
                }
        ...
        public void u(t0 t0Var, boolean z) {
            ...
            if (t0Var.installed && !t0Var.set.f5061c) {
                this.premiumButtonView.h(org.telegram.messenger.u.B0("Restore", e78.Q30), new View.OnClickListener() { // from class: as2
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view) {
                        k0.w0.this.r(view);
                    }
                ...
                this.premiumButtonView.h(org.telegram.messenger.u.B0("Unlock", e78.xh0), new View.OnClickListener() { // from class: bs2
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view) {
                        k0.w0.this.s(view);
                    }
        ...
        public CharSequence getPageTitle(int i) {
            if (i != 0) {
                if (i != 1) {
                    ...
                    return org.telegram.messenger.u.B0("AccDescrStickers", e78.g1);
                }
                return org.telegram.messenger.u.B0("AccDescrGIFs", e78.Y);
            }
            return org.telegram.messenger.u.B0("Emoji", e78.fs);
        }
    ...
    public class z0 extends v1.s {
        ...
        public class b implements View.OnClickListener {
            ...
            public void onClick(View view) {
                ...
                textView.setText(org.telegram.messenger.u.B0("EmojiSuggestions", e78.vs));
                ...
                textView2.setText(org.telegram.messenger.a.b3(org.telegram.messenger.u.B0("EmojiSuggestionsInfo", e78.ws)));
        ...
        public RecyclerView.d0 onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            if (i != 0) {
                if (i != 1) {
                    ...
                    TextView textView = new TextView(k0.this.getContext());
                    textView.setText(org.telegram.messenger.u.B0("NoEmojiFound", e78.LK));
                    textView.setTextSize(1, 16.0f);
                    textView.setTextColor(k0.this.U2("chat_emojiPanelEmptyText"));
                    aVar.addView(textView, cn4.c(-2, -2.0f, 49, 0.0f, 10.0f, 0.0f, 0.0f));
                    ImageView imageView = new ImageView(k0.this.getContext());
                    imageView.setScaleType(ImageView.ScaleType.CENTER);
                    imageView.setImageResource(g68.T6);
                    imageView.setColorFilter(new PorterDuffColorFilter(k0.this.U2("chat_emojiPanelEmptyText"), PorterDuff.Mode.MULTIPLY));
    ...
    public k0(org.telegram.ui.ActionBar.f fVar, boolean z2, boolean z3, boolean z4, Context context, boolean z5, gm9 gm9Var, ViewGroup viewGroup, l.r rVar) {
        ...
        this.tabIcons = new Drawable[]{org.telegram.ui.ActionBar.l.V0(context, g68.Ue, U2("chat_emojiPanelBackspace"), U2("chat_emojiPanelIconSelected")), org.telegram.ui.ActionBar.l.V0(context, g68.Re, U2("chat_emojiPanelBackspace"), U2("chat_emojiPanelIconSelected")), org.telegram.ui.ActionBar.l.V0(context, g68.Ve, U2("chat_emojiPanelBackspace"), U2("chat_emojiPanelIconSelected"))};
        Drawable V0 = org.telegram.ui.ActionBar.l.V0(context, g68.T0, U2("chat_emojiPanelIcon"), U2("chat_emojiPanelIconSelected"));
        this.searchIconDrawable = V0;
        Drawable V02 = org.telegram.ui.ActionBar.l.V0(context, g68.U0, U2("chat_emojiPanelStickerPackSelectorLine"), U2("chat_emojiPanelStickerPackSelectorLine"));
        this.searchIconDotDrawable = V02;
        this.stickerIcons = new Drawable[]{org.telegram.ui.ActionBar.l.V0(context, g68.U6, U2("chat_emojiPanelIcon"), U2("chat_emojiPanelIconSelected")), org.telegram.ui.ActionBar.l.V0(context, g68.S0, U2("chat_emojiPanelIcon"), U2("chat_emojiPanelIconSelected")), org.telegram.ui.ActionBar.l.V0(context, g68.V0, U2("chat_emojiPanelIcon"), U2("chat_emojiPanelIconSelected")), new LayerDrawable(new Drawable[]{V0, V02})};
        this.gifIcons = new Drawable[]{org.telegram.ui.ActionBar.l.V0(context, g68.U6, U2("chat_emojiPanelIcon"), U2("chat_emojiPanelIconSelected")), org.telegram.ui.ActionBar.l.V0(context, g68.gf, U2("chat_emojiPanelIcon"), U2("chat_emojiPanelIconSelected"))};
        this.emojiTitles = new String[]{org.telegram.messenger.u.B0("Emoji1", e78.gs), org.telegram.messenger.u.B0("Emoji2", e78.hs), org.telegram.messenger.u.B0("Emoji3", e78.is), org.telegram.messenger.u.B0("Emoji4", e78.js), org.telegram.messenger.u.B0("Emoji5", e78.ks), org.telegram.messenger.u.B0("Emoji6", e78.ls), org.telegram.messenger.u.B0("Emoji7", e78.ms), org.telegram.messenger.u.B0("Emoji8", e78.ns)};
        this.showGifs = z4;
        this.info = gm9Var;
        Paint paint = new Paint(1);
        this.dotPaint = paint;
        ...
        this.backspaceButton.setImageResource(g68.Qe);
        ...
        this.backspaceButton.setContentDescription(org.telegram.messenger.u.B0("AccDescrBackspace", e78.z));
        ...
        if (z5) {
            ...
            imageView.setImageResource(g68.Te);
            ...
            this.stickerSettingsButton.setContentDescription(org.telegram.messenger.u.B0("Settings", e78.u80));
            ...
            imageView2.setImageResource(g68.Se);
            ...
            this.searchButton.setContentDescription(org.telegram.messenger.u.B0("Search", e78.h50));
    ...
    public void H3(boolean z2) {
        ...
        if (!org.telegram.messenger.d.E(S7) && (tLRPC$TL_chatBannedRights = S7.f5613b) != null && tLRPC$TL_chatBannedRights.d) {
            if (z2) {
                this.mediaBanTooltip.setText(org.telegram.messenger.u.B0("GlobalAttachGifRestricted", e78.Hz));
            } else {
                this.mediaBanTooltip.setText(org.telegram.messenger.u.B0("GlobalAttachStickersRestricted", e78.Kz));
            }
        } else {
            ...
            if (org.telegram.messenger.a.J1(tLRPC$TL_chatBannedRights2)) {
                if (z2) {
                    this.mediaBanTooltip.setText(org.telegram.messenger.u.B0("AttachGifRestrictedForever", e78.t8));
                } else {
                    this.mediaBanTooltip.setText(org.telegram.messenger.u.B0("AttachStickersRestrictedForever", e78.P8));
                }
            } else if (z2) {
                this.mediaBanTooltip.setText(org.telegram.messenger.u.d0("AttachGifRestricted", e78.s8, org.telegram.messenger.u.K(S7.f5608a.b)));
            } else {
                this.mediaBanTooltip.setText(org.telegram.messenger.u.d0("AttachStickersRestricted", e78.O8, org.telegram.messenger.u.K(S7.f5608a.b)));
            }
        }
    ...
    public final void R3() {
        ...
        if (z4) {
            ...
            this.gifTabs.q(0, this.gifIcons[0]).setContentDescription(org.telegram.messenger.u.B0("RecentStickers", e78.q10));
            i2 = 1;
        } else {
            i2 = 0;
        }
        this.gifTrendingTabNum = i2;
        this.gifTabs.q(1, this.gifIcons[1]).setContentDescription(org.telegram.messenger.u.B0("FeaturedGifs", e78.rw));
    ...
    public final void T3(boolean z2) {
        ...
        if (y1Var != null && !y1Var.E()) {
            ...
            if (!K4.isEmpty() && (this.featuredStickerSets.isEmpty() || a8.getLong("featured_hidden", 0L) == ((fq9) K4.get(0)).a.f5053a)) {
                ...
                r2.textView.setText(org.telegram.messenger.u.B0("FeaturedStickersShort", e78.uw));
                r2.setContentDescription(org.telegram.messenger.u.B0("FeaturedStickers", e78.sw));
            ...
            if (!this.favouriteStickers.isEmpty()) {
                ...
                r3.textView.setText(org.telegram.messenger.u.B0("FavoriteStickersShort", e78.pw));
                r3.setContentDescription(org.telegram.messenger.u.B0("FavoriteStickers", e78.mw));
            }
            if (!this.recentStickers.isEmpty()) {
                ...
                r4.textView.setText(org.telegram.messenger.u.B0("RecentStickersShort", e78.r10));
                r4.setContentDescription(org.telegram.messenger.u.B0("RecentStickers", e78.q10));
            }
            ...
            if (!this.premiumStickers.isEmpty()) {
                ...
                r5.textView.setText(org.telegram.messenger.u.B0("PremiumStickersShort", e78.YX));
                r5.setContentDescription(org.telegram.messenger.u.B0("PremiumStickers", e78.XX));
            }
            if (this.info != null) {
            ...
            while (i10 < this.stickerSets.size()) {
                if (i10 == this.groupStickerPackNum) {
                    ...
                    this.stickersTab.s(e02, tm9Var2, tLRPC$TL_messages_stickerSet6).setContentDescription(((hs9) tLRPC$TL_messages_stickerSet6).a.f5054a + ", " + org.telegram.messenger.u.B0("AccDescrStickerSet", e78.f1));
                }
                i10++;
            }
            this.stickersTab.y();
