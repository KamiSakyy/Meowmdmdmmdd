...
public class w0 extends f3 implements a0.d {
                ...
                if (i != 3) {
                    if (i != 4) {
                        if (i != 5) {
                            ...
                            u65Var2.b(org.telegram.messenger.u.B0("VoipGroupCopyInviteLink", e78.Dm0), null, g68.b8, 7, true);
                            ...
                            if (w0.this.dialogsDelegate != null) {
                                bVar.title.setText(org.telegram.messenger.u.B0("FilterNoChats", e78.tx));
                            } else {
    ...
    public w0(final Context context, int i2, final j45 j45Var, final long j2, final org.telegram.ui.ActionBar.f fVar, l.r rVar) {
        ...
        this.chatId = j2;
        d0();
        this.searchView.searchEditText.setHint(org.telegram.messenger.u.B0("SearchForChats", e78.v50));
        ...
        imageView.setImageResource(g68.N1);
        ...
        imageView.setContentDescription(org.telegram.messenger.u.B0("Next", e78.tK));
    ...
    */
    ...
    public /* synthetic */ void b3(Context context, long j2, View view) {
        ...
        if (this.selectedContacts.u() > 5) {
            ...
            kVar.n(org.telegram.messenger.a.b3(org.telegram.messenger.u.d0("AddMembersAlertNamesText", e78.S4, sb, S7.f5602a)));
        }
        kVar.v(org.telegram.messenger.u.B0("Add", e78.g4), new DialogInterface.OnClickListener() { // from class: z54
