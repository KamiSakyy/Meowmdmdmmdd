...
public abstract class p0 extends FrameLayout {
    ...
    public p0(Context context, final org.telegram.messenger.p pVar, mq9 mq9Var, fm9 fm9Var, int i2, o oVar) {
        ...
        Drawable mutate = getContext().getResources().getDrawable(g68.Jd).mutate();
        ...
        if (this.forwardingMessagesParams.f13086c) {
            ...
            this.showCaptionView.f(org.telegram.messenger.u.B0("ShowCaption", e78.B90), 0);
            ...
            this.hideCaptionView.f(org.telegram.messenger.u.B0("HideCaption", e78.KA), 0);
            this.hideCaptionView.setChecked(false);
        }
        LinearLayout linearLayout3 = new LinearLayout(context);
        this.buttonsLayout2 = linearLayout3;
        linearLayout3.setOrientation(1);
        Drawable mutate2 = getContext().getResources().getDrawable(g68.Jd).mutate();
        ...
        this.changeRecipientView.f(org.telegram.messenger.u.B0("ChangeRecipient", e78.Df), g68.q7);
        ...
        this.sendMessagesView.f(org.telegram.messenger.u.B0("ForwardSendMessages", e78.Ly), g68.Qa);
        if (this.forwardingMessagesParams.d) {
    ...
    public final void J() {
        ...
        if (!pVar.d) {
            if (pVar.f) {
                ...
                if (mq9Var != null) {
                    this.actionBar.setSubtitle(org.telegram.messenger.u.d0("ForwardPreviewSendersNameVisible", e78.Iy, org.telegram.messenger.e.E0(mq9Var.f10558a, mq9Var.f10565b)));
                    return;
                } else if (org.telegram.messenger.d.M(this.currentChat) && !this.currentChat.h) {
                    this.actionBar.setSubtitle(org.telegram.messenger.u.B0("ForwardPreviewSendersNameVisibleChannel", e78.Jy));
                    return;
                } else {
                    this.actionBar.setSubtitle(org.telegram.messenger.u.B0("ForwardPreviewSendersNameVisibleGroup", e78.Ky));
                    return;
                }
            }
            mq9 mq9Var2 = this.currentUser;
            if (mq9Var2 != null) {
                this.actionBar.setSubtitle(org.telegram.messenger.u.d0("ForwardPreviewSendersNameVisible", e78.Iy, org.telegram.messenger.e.E0(mq9Var2.f10558a, mq9Var2.f10565b)));
            } else if (org.telegram.messenger.d.M(this.currentChat) && !this.currentChat.h) {
                this.actionBar.setSubtitle(org.telegram.messenger.u.B0("ForwardPreviewSendersNameHiddenChannel", e78.Gy));
            } else {
                this.actionBar.setSubtitle(org.telegram.messenger.u.B0("ForwardPreviewSendersNameHiddenGroup", e78.Hy));
            }
        } else if (!pVar.f13084a) {
            mq9 mq9Var3 = this.currentUser;
            if (mq9Var3 != null) {
                this.actionBar.setSubtitle(org.telegram.messenger.u.d0("ForwardPreviewSendersNameVisible", e78.Iy, org.telegram.messenger.e.E0(mq9Var3.f10558a, mq9Var3.f10565b)));
            } else if (org.telegram.messenger.d.M(this.currentChat) && !this.currentChat.h) {
                this.actionBar.setSubtitle(org.telegram.messenger.u.B0("ForwardPreviewSendersNameVisibleChannel", e78.Jy));
            } else {
                this.actionBar.setSubtitle(org.telegram.messenger.u.B0("ForwardPreviewSendersNameVisibleGroup", e78.Ky));
            ...
            if (mq9Var4 != null) {
                this.actionBar.setSubtitle(org.telegram.messenger.u.d0("ForwardPreviewSendersNameHidden", e78.Fy, org.telegram.messenger.e.E0(mq9Var4.f10558a, mq9Var4.f10565b)));
            } else if (org.telegram.messenger.d.M(this.currentChat) && !this.currentChat.h) {
                this.actionBar.setSubtitle(org.telegram.messenger.u.B0("ForwardPreviewSendersNameHiddenChannel", e78.Gy));
            } else {
                this.actionBar.setSubtitle(org.telegram.messenger.u.B0("ForwardPreviewSendersNameHiddenGroup", e78.Hy));
