...
public class p1 {
    ...
    public final boolean o1(final boolean z, Activity activity, View view, mh7 mh7Var, int i2, int i3, boolean z2) {
        ...
        imageView.setImageResource(g68.td);
        ...
        imageView2.setImageResource(g68.ud);
        ...
        if (photoViewer != null && this.playPauseButton != null) {
            ...
            if (!q0) {
                if (this.isVideoCompleted) {
                    this.playPauseButton.setImageResource(g68.sd);
                    return;
                } else {
                    this.playPauseButton.setImageResource(g68.rd);
                    return;
                }
            }
            this.playPauseButton.setImageResource(g68.qd);
            org.telegram.messenger.a.n3(this.progressRunnable, 500L);
        }
    }
