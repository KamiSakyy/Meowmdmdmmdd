...
public class v0 extends org.telegram.ui.ActionBar.g {
    ...
    public class f extends v1.s {
        ...
        public void onBindViewHolder(RecyclerView.d0 d0Var, int i) {
                ...
                if (itemViewType != 1) {
                    if (itemViewType != 3) {
                        ...
                        if (tLRPC$TL_chatInviteExported.f14128a) {
                            iVar.setText(org.telegram.messenger.u.B0("LinkIsNoActive", e78.MF));
                            return;
                        } else if (tLRPC$TL_chatInviteExported.f14132d) {
                            int i6 = tLRPC$TL_chatInviteExported.e;
                            if (i6 > 0 && i6 == tLRPC$TL_chatInviteExported.f) {
                                iVar.setText(org.telegram.messenger.u.B0("LinkIsExpiredLimitReached", e78.LF));
                                return;
                            }
                            iVar.setText(org.telegram.messenger.u.B0("LinkIsExpired", e78.KF));
                            ...
                            if (j > 86400000) {
                                iVar.setText(org.telegram.messenger.u.d0("LinkExpiresIn", e78.yF, org.telegram.messenger.u.G(i7, false)));
                                return;
                            }
                            long j2 = j / 1000;
                            int i8 = (int) (j2 % 60);
                            ...
                            iVar.timer = true;
                            iVar.g();
                            iVar.setText(org.telegram.messenger.u.d0("LinkExpiresInTime", e78.zF, sb2));
                            return;
                        } else {
                            ...
                            if (i4 >= v0.this.info.f6240a.f8256a.size()) {
                                ...
                                if (im9Var instanceof TLRPC$TL_chatChannelParticipant) {
                                    ...
                                    if (!TextUtils.isEmpty(dm9Var.rank)) {
                                        ...
                                        str3 = org.telegram.messenger.u.B0("ChannelCreator", e78.kg);
                                    } else if (dm9Var instanceof TLRPC$TL_channelParticipantAdmin) {
                                        str3 = org.telegram.messenger.u.B0("ChannelAdmin", e78.Nf);
                                    }
                                } else {
            ...
            if (i == v0Var2.creatorHeaderRow) {
                nu3Var.setText(org.telegram.messenger.u.B0("LinkCreatedeBy", e78.wF));
                ...
                if (i12 > 0) {
                    ...
                    nu3Var.setText(org.telegram.messenger.u.B0("NoOneJoined", e78.cL));
                }
        ...
        public RecyclerView.d0 onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            switch (i) {
                ...
                case 4:
                    iVar = new i(context);
                    nq1 nq1Var = new nq1(new ColorDrawable(org.telegram.ui.ActionBar.l.B1("windowBackgroundGray")), org.telegram.ui.ActionBar.l.u2(context, g68.f2, "windowBackgroundGrayShadow"));
                    nq1Var.e(true);
                ...
                case 7:
                    ...
                    nq1 nq1Var2 = new nq1(new ColorDrawable(org.telegram.ui.ActionBar.l.B1("windowBackgroundGray")), org.telegram.ui.ActionBar.l.u2(context, g68.g2, "windowBackgroundGrayShadow"), 0, 0);
                    nq1Var2.e(true);
    ...
    public v0(Context context, final TLRPC$TL_chatInviteExported tLRPC$TL_chatInviteExported, gm9 gm9Var, final HashMap hashMap, final org.telegram.ui.ActionBar.f fVar, long j, boolean z, boolean z2) {
        ...
        if (!z) {
            if (tLRPC$TL_chatInviteExported.f14132d) {
                this.titleTextView.setText(org.telegram.messenger.u.B0("ExpiredLink", e78.ew));
            } else if (tLRPC$TL_chatInviteExported.f14128a) {
                this.titleTextView.setText(org.telegram.messenger.u.B0("RevokedLink", e78.w40));
            } else {
                this.titleTextView.setText(org.telegram.messenger.u.B0("InviteLink", e78.SC));
            }
    ...
    public final void s2(View view) {
        if (view instanceof nu3) {
            ...
            nq1 nq1Var = new nq1(new ColorDrawable(org.telegram.ui.ActionBar.l.B1("windowBackgroundGray")), org.telegram.ui.ActionBar.l.u2(view.getContext(), g68.f2, "windowBackgroundGrayShadow"));
            nq1Var.e(true);
        ...
        if (m0 != null) {
            if (m0.getItemViewType() == 7) {
                nq1 nq1Var2 = new nq1(new ColorDrawable(org.telegram.ui.ActionBar.l.B1("windowBackgroundGray")), org.telegram.ui.ActionBar.l.u2(view.getContext(), g68.g2, "windowBackgroundGrayShadow"), 0, 0);
                nq1Var2.e(true);
                view.setBackgroundDrawable(nq1Var2);
            } else if (m0.getItemViewType() == 2) {
                nq1 nq1Var3 = new nq1(new ColorDrawable(org.telegram.ui.ActionBar.l.B1("windowBackgroundGray")), org.telegram.ui.ActionBar.l.u2(view.getContext(), g68.f2, "windowBackgroundGrayShadow"), 0, 0);
                nq1Var3.e(true);
