...
public abstract class y1 extends HorizontalScrollView {
    ...
    public /* synthetic */ void F(View view) {
        this.delegate.onPageSelected(((Integer) view.getTag(i68.Y)).intValue());
    }
    ...
    public void P() {
        ...
        while (true) {
            ...
            if (childAt instanceof qe9) {
                ...
                if (qe9Var.type == 2) {
                    Object tag = qe9Var.getTag(i68.W0);
                    Object tag2 = qe9Var.getTag(i68.V0);
                    ...
                    Object tag4 = childAt.getTag(i68.W0);
                    tm9 tm9Var = (tm9) childAt.getTag(i68.V0);
    ...
    public View p(int i2, i.b bVar, tm9 tm9Var) {
        ...
        qe9Var.setTag(i68.Y, Integer.valueOf(i3));
        qe9Var.setTag(i68.W0, bVar);
        qe9Var.setTag(i68.V0, tm9Var);
    ...
    public FrameLayout q(int i2, Drawable drawable) {
        ...
        frameLayout.setTag(i68.Y, Integer.valueOf(i3));
        if (i3 != this.currentPosition) {
            z = false;
        }
    ...
    public View s(org.telegram.tgnet.a aVar, tm9 tm9Var, TLRPC$TL_messages_stickerSet tLRPC$TL_messages_stickerSet) {
        ...
        qe9Var.isChatSticker = false;
        qe9Var.setTag(aVar);
        qe9Var.setTag(i68.Y, Integer.valueOf(i2));
        qe9Var.setTag(i68.W0, tLRPC$TL_messages_stickerSet);
        qe9Var.setTag(i68.V0, tm9Var);
            ...
            if (this.draggingView != null) {
                ...
                if (i4 != i5) {
                    ...
                    for (int i6 = 0; i6 < this.tabsContainer.getChildCount(); i6++) {
                        this.tabsContainer.getChildAt(i6).setTag(i68.Y, Integer.valueOf(i6));
                    }
                }
                ValueAnimator ofFloat = ValueAnimator.ofFloat(0.0f, 1.0f);
