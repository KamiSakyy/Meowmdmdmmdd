...
public class ShutterButton extends View {
    ...
    public ShutterButton(Context context) {
        ...
        this.shadowDrawable = getResources().getDrawable(g68.e0);
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        accessibilityNodeInfo.addAction(new AccessibilityNodeInfo.AccessibilityAction(AccessibilityNodeInfo.AccessibilityAction.ACTION_CLICK.getId(), org.telegram.messenger.u.B0("AccActionTakePicture", e78.v)));
        accessibilityNodeInfo.addAction(new AccessibilityNodeInfo.AccessibilityAction(AccessibilityNodeInfo.AccessibilityAction.ACTION_LONG_CLICK.getId(), org.telegram.messenger.u.B0("AccActionRecordVideo", e78.u)));
    }
