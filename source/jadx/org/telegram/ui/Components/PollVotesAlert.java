...
public class PollVotesAlert extends org.telegram.ui.ActionBar.g {
        ...
        public void B(int i, int i2, RecyclerView.d0 d0Var) {
            ...
            if (itemViewType != 2) {
                if (itemViewType == 3) {
                    ...
                    ((pu9) d0Var.itemView).i(org.telegram.messenger.u.U("ShowVotes", mVar.count - mVar.b(), new Object[0]), g68.g, false);
                    return;
                }
                return;
            }
    ...
    public class l extends FrameLayout {
        ...
        public void d(String str, int i, int i2, int i3, boolean z) {
            ...
            if (i3 == 0) {
                ...
                this.righTextView.f(org.telegram.messenger.u.B0("PollExpand", e78.ZW), z);
            } else {
                this.righTextView.f(org.telegram.messenger.u.B0("PollCollapse", e78.YW), z);
            }
        }
    ...
    public PollVotesAlert(final org.telegram.ui.j jVar, org.telegram.messenger.x xVar) {
        ...
        this.actionBar.setTitle(org.telegram.messenger.u.B0("PollResults", e78.dX));
        if (this.poll.d) {
    ...
    public void r2(View view) {
        ...
        for (int i2 = -2; i2 < this.listView.getChildCount(); i2++) {
            ...
            if ((childAt instanceof l) && (childAt.getTag(i68.V0) instanceof m)) {
                l lVar = (l) childAt;
                m mVar = (m) childAt.getTag(i68.V0);
                int i3 = 0;
