...
public class c0 extends org.telegram.ui.ActionBar.g implements a0.d {
    ...
    public class a extends e88 {
        ...
        public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
            ...
            if (c0.this.forceDark) {
                accessibilityNodeInfo.setText(org.telegram.messenger.u.B0("AccDescrSwitchToDayTheme", e78.j1));
            } else {
                accessibilityNodeInfo.setText(org.telegram.messenger.u.B0("AccDescrSwitchToNightTheme", e78.k1));
            }
        }
    }
    ...
    public c0(org.telegram.ui.j jVar, final j.m4 m4Var) {
        ...
        textView.setText(org.telegram.messenger.u.B0("SelectTheme", e78.r60));
        ...
        int i3 = y68.G2;
        RLottieDrawable rLottieDrawable = new RLottieDrawable(i3, "" + y68.G2, e0, e0, false, null);
        ...
        this.applyTextView.setText(org.telegram.messenger.u.B0("ChatApplyTheme", e78.Xh));
    ...
    public final void W1() {
        ...
        if (jVar != null && iVar != this.originalTheme) {
            ...
            if (l != null && !l.f10563a) {
                ...
                if (z) {
                    o2Var.titleTextView.setText(org.telegram.messenger.a.b3(org.telegram.messenger.u.d0("ThemeAlsoDisabledForHint", e78.ye0, l.f10558a)));
                } else {
                    o2Var.titleTextView.setText(org.telegram.messenger.a.b3(org.telegram.messenger.u.d0("ThemeAlsoAppliedForHint", e78.xe0, l.f10558a)));
                }
    ...
    public void X1() {
        if (Y1()) {
            ...
            kVar.x(org.telegram.messenger.u.B0("ChatThemeSaveDialogTitle", e78.Ki));
            kVar.w(org.telegram.messenger.u.B0("ChatThemeSaveDialogText", e78.Ji));
            kVar.v(org.telegram.messenger.u.B0("ChatThemeSaveDialogApply", e78.Hi), new DialogInterface.OnClickListener() { // from class: wi1
                @Override // android.content.DialogInterface.OnClickListener
                public final void onClick(DialogInterface dialogInterface, int i2) {
                    c0.this.Z1(dialogInterface, i2);
                }
            });
            kVar.p(org.telegram.messenger.u.B0("ChatThemeSaveDialogDiscard", e78.Ii), new DialogInterface.OnClickListener() { // from class: xi1
                @Override // android.content.DialogInterface.OnClickListener
                public final void onClick(DialogInterface dialogInterface, int i2) {
    ...
    public void onCreate(Bundle bundle) {
        ...
        if (this.chatActivity.l() != null && org.telegram.messenger.e0.x > 0 && !this.chatActivity.l().f10563a) {
            ...
            this.hintView.setText(org.telegram.messenger.a.b3(org.telegram.messenger.u.d0("ChatThemeDayNightSwitchTooltip", e78.Ei, this.chatActivity.l().f10558a)));
