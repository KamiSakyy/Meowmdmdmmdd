...
public class n3 {
    ...
    */
    ...
    public void k(final boolean z) {
        ...
        if (z) {
            charSequenceArr = new CharSequence[]{org.telegram.messenger.u.B0("ChooseTakePhoto", e78.Mj), org.telegram.messenger.u.B0("SelectFromGallery", e78.o60), org.telegram.messenger.u.B0("SelectColor", e78.i60), org.telegram.messenger.u.B0("Default", e78.In)};
            iArr = null;
        } else {
            charSequenceArr = new CharSequence[]{org.telegram.messenger.u.B0("ChooseTakePhoto", e78.Mj), org.telegram.messenger.u.B0("SelectFromGallery", e78.o60)};
            iArr = new int[]{g68.a6, g68.u9};
        }
