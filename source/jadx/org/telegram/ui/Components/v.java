...
public class v extends ChatAttachAlert.y implements a0.d {
        ...
        public void k(String str) {
            if (str.length() != 0) {
                if (v.this.emptyView != null) {
                    v.this.emptyView.setText(org.telegram.messenger.u.B0("NoResult", e78.rL));
                }
            } else if (v.this.listView.getAdapter() != v.this.listAdapter) {
                int currentTop = v.this.getCurrentTop();
                v.this.emptyView.setText(org.telegram.messenger.u.B0("NoContacts", e78.GK));
                v.this.emptyView.g();
        ...
        public void f(CharSequence charSequence) {
            ...
            if (mq9Var != null) {
                if (TextUtils.isEmpty(mq9Var.d)) {
                    this.statusTextView.i(org.telegram.messenger.u.B0("NumberUnknown", e78.yP));
    ...
    public v(ChatAttachAlert chatAttachAlert, Context context, final l.r rVar) {
        ...
        aVar.setHint(org.telegram.messenger.u.B0("SearchFriends", e78.y50));
