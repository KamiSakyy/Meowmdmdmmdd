...
public class s0 extends org.telegram.ui.ActionBar.f implements a0.d, t0.f {
    ...
    public class c extends v1.s {
        ...
        public class b extends ClickableSpan {
            ...
            public void onClick(View view) {
                ...
                org.telegram.ui.Components.q.p0(s0.this).s(org.telegram.messenger.u.B0("LinkCopied", e78.uF), s0.this.j()).T();
            }
        }
        ...
        public void onBindViewHolder(RecyclerView.d0 d0Var, int i) {
            ...
            if (itemViewType != 0) {
                if (itemViewType != 1) {
                        ...
                        if (itemViewType == 3) {
                            ...
                            if (i != s0.this.everybodyRow && i != s0.this.myContactsRow && i != s0.this.nobodyRow) {
                                if (i == s0.this.phoneContactsRow) {
                                    String B03 = org.telegram.messenger.u.B0("LastSeenContacts", e78.pE);
                                    ...
                                    String B04 = org.telegram.messenger.u.B0("LastSeenEverybody", e78.uE);
                                ...
                                if (s0.this.rulesType == 3) {
                                    String B05 = org.telegram.messenger.u.B0("P2PEverybody", e78.uQ);
                                ...
                                String B06 = org.telegram.messenger.u.B0("LastSeenEverybody", e78.uE);
                                if (s0.this.currentType == 0) {
                                    z7 = true;
                                }
                                ...
                                if (s0.this.rulesType == 3) {
                                    String B07 = org.telegram.messenger.u.B0("P2PContacts", e78.pQ);
                                ...
                                String B08 = org.telegram.messenger.u.B0("LastSeenContacts", e78.pE);
                                if (s0.this.currentType == 2) {
                                    z2 = true;
                                } else {
                                    z2 = false;
                                ...
                                String B09 = org.telegram.messenger.u.B0("P2PNobody", e78.wQ);
                                ...
                                String B010 = org.telegram.messenger.u.B0("LastSeenNobody", e78.xE);
                                if (s0.this.currentType != 1) {
                                    z11 = false;
                                }
                    ...
                    if (i == s0.this.sectionRow) {
                        if (s0.this.rulesType == 6) {
                            nu3Var.setText(org.telegram.messenger.u.B0("PrivacyPhoneTitle", e78.RY));
                            return;
                        } else if (s0.this.rulesType == 5) {
                            nu3Var.setText(org.telegram.messenger.u.B0("PrivacyForwardsTitle", e78.AY));
                            return;
                        } else if (s0.this.rulesType == 4) {
                            nu3Var.setText(org.telegram.messenger.u.B0("PrivacyProfilePhotoTitle", e78.bZ));
                            return;
                        } else if (s0.this.rulesType == 3) {
                            nu3Var.setText(org.telegram.messenger.u.B0("P2PEnabledWith", e78.tQ));
                            return;
                        } else if (s0.this.rulesType == 2) {
                            nu3Var.setText(org.telegram.messenger.u.B0("WhoCanCallMe", e78.Op0));
                            return;
                        } else if (s0.this.rulesType == 1) {
                            nu3Var.setText(org.telegram.messenger.u.B0("WhoCanAddMe", e78.Mp0));
                            return;
                        } else if (s0.this.rulesType == 8) {
                            nu3Var.setText(org.telegram.messenger.u.B0("PrivacyVoiceMessagesTitle", e78.jZ));
                            return;
                        } else {
                            nu3Var.setText(org.telegram.messenger.u.B0("LastSeenTitle", e78.zE));
                            return;
                        }
                    } else if (i == s0.this.shareSectionRow) {
                        nu3Var.setText(org.telegram.messenger.u.B0("AddExceptions", e78.O4));
                        return;
                    } else if (i == s0.this.p2pSectionRow) {
                        nu3Var.setText(org.telegram.messenger.u.B0("PrivacyP2PHeader", e78.EY));
                        return;
                    } else if (i == s0.this.phoneSectionRow) {
                        nu3Var.setText(org.telegram.messenger.u.B0("PrivacyPhoneTitle2", e78.SY));
                        return;
                    } else {
                        return;
                    }
                ...
                if (i == s0.this.detailRow) {
                    if (s0.this.rulesType == 6) {
                        ...
                        if (z) {
                            bv9Var.setText(org.telegram.messenger.u.B0("PrivacyPhoneInfo3", e78.PY));
                        } else {
                            ...
                            spannableStringBuilder.append((CharSequence) org.telegram.messenger.u.B0("PrivacyPhoneInfo", e78.NY)).append((CharSequence) "\n\n").append((CharSequence) org.telegram.messenger.u.B0("PrivacyPhoneInfo4", e78.QY)).append((CharSequence) "\n").append((CharSequence) spannableString);
                            bv9Var.setText(spannableStringBuilder);
                        }
                    } else if (s0.this.rulesType == 5) {
                        bv9Var.setText(org.telegram.messenger.u.B0("PrivacyForwardsInfo", e78.wY));
                    } else if (s0.this.rulesType == 4) {
                        bv9Var.setText(org.telegram.messenger.u.B0("PrivacyProfilePhotoInfo", e78.XY));
                    } else if (s0.this.rulesType == 3) {
                        bv9Var.setText(org.telegram.messenger.u.B0("PrivacyCallsP2PHelp", e78.nY));
                    } else if (s0.this.rulesType == 2) {
                        bv9Var.setText(org.telegram.messenger.u.B0("WhoCanCallMeInfo", e78.Pp0));
                    } else if (s0.this.rulesType == 1) {
                        bv9Var.setText(org.telegram.messenger.u.B0("WhoCanAddMeInfo", e78.Np0));
                    } else if (s0.this.rulesType == 8) {
                        bv9Var.setText(org.telegram.messenger.u.B0("PrivacyVoiceMessagesInfo", e78.gZ));
                    } else {
                        bv9Var.setText(org.telegram.messenger.u.B0("CustomHelp", e78.Am));
                    }
                    i2 = g68.f2;
                } else if (i == s0.this.shareDetailRow) {
                    if (s0.this.rulesType == 6) {
                        bv9Var.setText(org.telegram.messenger.u.B0("PrivacyPhoneInfo2", e78.OY));
                    } else if (s0.this.rulesType == 5) {
                        bv9Var.setText(org.telegram.messenger.u.B0("PrivacyForwardsInfo2", e78.xY));
                    } else if (s0.this.rulesType == 4) {
                        if (s0.this.currentType == 2) {
                            bv9Var.setText(org.telegram.messenger.a.b3(org.telegram.messenger.u.B0("PrivacyProfilePhotoInfo5", e78.aZ)));
                        } else if (s0.this.currentType == 0) {
                            bv9Var.setText(org.telegram.messenger.a.b3(org.telegram.messenger.u.B0("PrivacyProfilePhotoInfo3", e78.YY)));
                        } else {
                            bv9Var.setText(org.telegram.messenger.u.B0("PrivacyProfilePhotoInfo4", e78.ZY));
                        }
                    } else if (s0.this.rulesType == 3) {
                        bv9Var.setText(org.telegram.messenger.u.B0("CustomP2PInfo", e78.Cm));
                    } else if (s0.this.rulesType == 2) {
                        bv9Var.setText(org.telegram.messenger.u.B0("CustomCallInfo", e78.ym));
                    } else if (s0.this.rulesType == 1) {
                        bv9Var.setText(org.telegram.messenger.u.B0("CustomShareInfo", e78.Dm));
                    } else if (s0.this.rulesType == 8) {
                        bv9Var.setText(org.telegram.messenger.u.B0("PrivacyVoiceMessagesInfo2", e78.hZ));
                    } else {
                        bv9Var.setText(org.telegram.messenger.u.B0("CustomShareSettingsHelp", e78.Em));
                    }
                    i2 = s0.this.rulesType == 2 ? g68.f2 : g68.g2;
                } else if (i == s0.this.p2pDetailRow) {
                    i2 = g68.g2;
                } else if (i == s0.this.photoForRestDescriptionRow) {
                    bv9Var.setText(org.telegram.messenger.u.B0("PhotoForRestDescription", e78.mW));
                }
                if (i2 != 0) {
            ...
            if (i == s0.this.alwaysShareRow) {
                if (s0.this.currentPlus.size() != 0) {
                    ...
                    B02 = org.telegram.messenger.u.B0("EmpryUsersPlaceholder", e78.zs);
                }
                if (s0.this.rulesType != 0 && s0.this.rulesType != 4) {
                    String B011 = org.telegram.messenger.u.B0("AlwaysAllow", e78.W5);
                ...
                String B012 = org.telegram.messenger.u.B0("AlwaysShareWith", e78.X5);
                if (s0.this.neverShareRow != -1) {
                    z4 = true;
                }
                ...
                if (s0.this.currentMinus.size() != 0) {
                    ...
                    B0 = org.telegram.messenger.u.B0("EmpryUsersPlaceholder", e78.zs);
                }
                if (s0.this.rulesType != 0 && s0.this.rulesType != 4) {
                    uw9Var.d(org.telegram.messenger.u.B0("NeverAllow", e78.PJ), B0, false);
                } else {
                    uw9Var.d(org.telegram.messenger.u.B0("NeverShareWith", e78.QJ), B0, false);
                }
            } else if (i == s0.this.p2pRow) {
                if (org.telegram.messenger.e.K0(s0.this.currentAccount).O0(3)) {
                    R3 = org.telegram.messenger.u.B0("Loading", e78.aG);
                } else {
                    R3 = t0.R3(s0.this.e0(), 3);
                }
                uw9Var.d(org.telegram.messenger.u.B0("PrivacyP2P2", e78.DY), R3, false);
            }
        }
                            ...
                            if (i != 4) {
                                if (i != 6) {
                                    if (i != 7) {
                                        ...
                                        s0.this.oldPhotoCell.f(org.telegram.messenger.u.B0("RemovePublicPhoto", e78.P10), false);
                                    ...
                                    if (s0.this.avatarForRest == null) {
                                        s0.this.setAvatarCell.i(org.telegram.messenger.u.d0("SetPhotoForRest", e78.a80, new Object[0]), g68.q5, false);
                                    } else {
                                        s0.this.setAvatarCell.i(org.telegram.messenger.u.d0("UpdatePhotoForRest", e78.bi0, new Object[0]), g68.q5, true);
                                    }
                                    ...
                                    s0 s0Var = s0.this;
                                    int i2 = y68.v;
                                    s0Var.cameraDrawable = new RLottieDrawable(i2, "" + y68.v, org.telegram.messenger.a.e0(50.0f), org.telegram.messenger.a.e0(50.0f), false, null);
    ...
    public class d extends FrameLayout {
        ...
        public d(Context context) {
            ...
            this.shadowDrawable = org.telegram.ui.ActionBar.l.u2(context, g68.g2, "windowBackgroundGrayShadow");
            ...
            ((lo9) tLRPC$TL_message).f9686a = org.telegram.messenger.u.B0("PrivacyForwardsMessageLine", e78.yY);
    ...
    public /* synthetic */ void K3(View view, final int i) {
        ...
        if (i == this.currentPhotoForRestRow) {
            org.telegram.ui.ActionBar.e a2 = org.telegram.ui.Components.b.H2(k0(), org.telegram.messenger.u.B0("RemovePublicPhoto", e78.P10), org.telegram.messenger.u.B0("RemovePhotoForRestDescription", e78.O10), org.telegram.messenger.u.B0("Remove", e78.L10), new Runnable() { // from class: mp7
                @Override // java.lang.Runnable
                public final void run() {
                    s0.this.F3();
                }
    ...
    public /* synthetic */ void N3(lp9 lp9Var, on9 on9Var, on9 on9Var2, double d2, lp9 lp9Var2) {
        ...
        if (on9Var != null || on9Var2 != null) {
            ...
            org.telegram.ui.Components.q.p0(this).f0(Collections.singletonList(tLRPC$TL_user), org.telegram.messenger.u.B0("PhotoForRestTooltip", e78.nW)).T();
        }
        U3(false);
    }
    ...
    public final void P3() {
        ...
        if (this.currentType != 0 && this.rulesType == 0) {
            ...
            if (!g8.getBoolean("privacyAlertShowed", false)) {
                e.k kVar = new e.k(E0());
                if (this.rulesType == 1) {
                    kVar.n(org.telegram.messenger.u.B0("WhoCanAddMeInfo", e78.Np0));
                } else {
                    kVar.n(org.telegram.messenger.u.B0("CustomHelp", e78.Am));
                }
                kVar.x(org.telegram.messenger.u.B0("AppName", e78.p6));
                kVar.v(org.telegram.messenger.u.B0("OK", e78.zP), new DialogInterface.OnClickListener() { // from class: cp7
    ...
    public final void Q3() {
        ...
        if (dVar != null) {
            ...
            if (i == 0) {
                this.messageCell.hintView.setOverrideText(org.telegram.messenger.u.B0("PrivacyForwardsEverybody", e78.vY));
                this.messageCell.messageObject.f13365a.f9693a.f16732a.a = 1L;
            } else if (i == 1) {
                this.messageCell.hintView.setOverrideText(org.telegram.messenger.u.B0("PrivacyForwardsNobody", e78.zY));
                this.messageCell.messageObject.f13365a.f9693a.f16732a.a = 0L;
            } else {
                this.messageCell.hintView.setOverrideText(org.telegram.messenger.u.B0("PrivacyForwardsContacts", e78.uY));
                this.messageCell.messageObject.f13365a.f9693a.f16732a.a = 1L;
            }
    ...
    public final void R3() {
        ...
        e.k kVar = new e.k(E0());
        kVar.x(org.telegram.messenger.u.B0("AppName", e78.p6));
        kVar.n(org.telegram.messenger.u.B0("PrivacyFloodControlError", e78.sY));
    ...
    public final void S3() {
        ...
        if (pu9Var != null) {
            if (this.avatarForRest == null) {
                pu9Var.getTextView().i(org.telegram.messenger.u.d0("SetPhotoForRest", e78.a80, new Object[0]));
                this.setAvatarCell.setNeedDivider(false);
            } else {
                pu9Var.getTextView().i(org.telegram.messenger.u.d0("UpdatePhotoForRest", e78.bi0, new Object[0]));
    ...
    public View W(Context context) {
        ...
        if (i == 6) {
            this.actionBar.setTitle(org.telegram.messenger.u.B0("PrivacyPhone", e78.MY));
        } else if (i == 5) {
            this.actionBar.setTitle(org.telegram.messenger.u.B0("PrivacyForwards", e78.tY));
        } else if (i == 4) {
            this.actionBar.setTitle(org.telegram.messenger.u.B0("PrivacyProfilePhoto", e78.WY));
        } else if (i == 3) {
            this.actionBar.setTitle(org.telegram.messenger.u.B0("PrivacyP2P", e78.CY));
        } else if (i == 2) {
            this.actionBar.setTitle(org.telegram.messenger.u.B0("Calls", e78.He));
        } else if (i == 1) {
            this.actionBar.setTitle(org.telegram.messenger.u.B0("GroupsAndChannels", e78.tA));
        } else if (i == 8) {
            this.actionBar.setTitle(org.telegram.messenger.u.B0("PrivacyVoiceMessages", e78.fZ));
        } else {
            this.actionBar.setTitle(org.telegram.messenger.u.B0("PrivacyLastSeen", e78.BY));
        }
        this.actionBar.setActionBarMenuOnItemClick(new a());
        this.doneButton = this.actionBar.x().j(1, g68.s2, org.telegram.messenger.a.e0(56.0f), org.telegram.messenger.u.B0("Done", e78.vq));
        boolean y3 = y3();
    ...
    public final boolean w3() {
        if (this.doneButton.getAlpha() == 1.0f) {
            ...
            kVar.n(org.telegram.messenger.u.B0("PrivacySettingsChangedAlert", e78.dZ));
            kVar.v(org.telegram.messenger.u.B0("ApplyTheme", e78.C6), new DialogInterface.OnClickListener() { // from class: kp7
                @Override // android.content.DialogInterface.OnClickListener
                public final void onClick(DialogInterface dialogInterface, int i) {
                    s0.this.D3(dialogInterface, i);
                }
            });
            kVar.p(org.telegram.messenger.u.B0("PassportDiscard", e78.cS), new DialogInterface.OnClickListener() { // from class: lp7
                @Override // android.content.DialogInterface.OnClickListener
                public final void onClick(DialogInterface dialogInterface, int i) {
