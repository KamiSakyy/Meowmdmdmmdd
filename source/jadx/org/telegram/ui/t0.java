...
public class t0 extends org.telegram.ui.ActionBar.f implements a0.d {
        ...
        public void onBindViewHolder(RecyclerView.d0 d0Var, int i) {
            ...
            if (itemViewType != 0) {
                if (itemViewType != 1) {
                    if (itemViewType != 2) {
                                ...
                                if (i == t0.this.autoDeleteMesages) {
                                    ...
                                    if (o != -1) {
                                        if (o > 0) {
                                            ...
                                            str = org.telegram.messenger.u.B0("PasswordOff", e78.ST);
                                        }
                                        z4 = false;
                                    }
                                    pu9Var.l(org.telegram.messenger.u.B0("AutoDeleteMessages", e78.O9), str, g68.D5, false);
                                    z3 = z4;
                                } else {
                                    String str2 = "";
                                    if (i == t0.this.sessionsRow) {
                                        ...
                                        pu9Var.l(org.telegram.messenger.u.B0("SessionsTitle", e78.A70), str2, g68.G6, true);
                                    } else if (i == t0.this.emailLoginRow) {
                                        pu9Var.l(org.telegram.messenger.u.z0(e78.as), "", g68.M6, true);
                                    } else if (i == t0.this.passwordRow) {
                                        if (t0.this.currentPassword == null) {
                                            z3 = true;
                                        } else if (t0.this.currentPassword.f23149c) {
                                            str2 = org.telegram.messenger.u.B0("PasswordOn", e78.TT);
                                        } else {
                                            str2 = org.telegram.messenger.u.B0("PasswordOff", e78.ST);
                                        }
                                        pu9Var.l(org.telegram.messenger.u.B0("TwoStepVerification", e78.Tg0), str2, g68.Ka, true);
                                    } else if (i == t0.this.passcodeRow) {
                                        if (org.telegram.messenger.e0.f12729d.length() != 0) {
                                            B02 = org.telegram.messenger.u.B0("PasswordOn", e78.TT);
                                        } else {
                                            B02 = org.telegram.messenger.u.B0("PasswordOff", e78.ST);
                                        }
                                        pu9Var.l(org.telegram.messenger.u.B0("Passcode", e78.bR), B02, g68.k9, true);
                                    } else if (i == t0.this.blockedRow) {
                                        int i3 = t0.this.x0().f;
                                        if (i3 == 0) {
                                            pu9Var.l(org.telegram.messenger.u.B0("BlockedUsers", e78.qc), org.telegram.messenger.u.B0("BlockedEmpty", e78.pc), g68.K5, true);
                                        } else if (i3 > 0) {
                                            pu9Var.l(org.telegram.messenger.u.B0("BlockedUsers", e78.qc), String.format("%d", Integer.valueOf(i3)), g68.K5, true);
                                        } else {
                                            pu9Var.l(org.telegram.messenger.u.B0("BlockedUsers", e78.qc), "", g68.K5, true);
                                            z3 = true;
                                        }
                                    }
                                }
                        ...
                        if (i == t0.this.secretWebpageRow) {
                            String B03 = org.telegram.messenger.u.B0("SecretWebPage", e78.Z50);
                            if (t0.this.x0().o != 1) {
                                z4 = false;
                            }
                            ...
                            ru9Var.i(org.telegram.messenger.u.B0("SyncContacts", e78.dd0), t0.this.newSync, true);
                            return;
                        } else if (i == t0.this.contactsSuggestRow) {
                            ru9Var.i(org.telegram.messenger.u.B0("SuggestContacts", e78.sc0), t0.this.newSuggest, false);
                            return;
                        } else if (i == t0.this.newChatsRow) {
                            ru9Var.i(org.telegram.messenger.u.B0("ArchiveAndMute", e78.I6), t0.this.archiveChats, false);
                            return;
                        } else {
                            return;
                        }
                    ...
                    if (i == t0.this.privacySectionRow) {
                        nu3Var.setText(org.telegram.messenger.u.B0("PrivacyTitle", e78.eZ));
                        return;
                    } else if (i == t0.this.securitySectionRow) {
                        nu3Var.setText(org.telegram.messenger.u.B0("SecurityTitle", e78.b60));
                        return;
                    } else if (i == t0.this.advancedSectionRow) {
                        nu3Var.setText(org.telegram.messenger.u.B0("DeleteMyAccount", e78.Jo));
                        return;
                    } else if (i == t0.this.secretSectionRow) {
                        nu3Var.setText(org.telegram.messenger.u.B0("SecretChat", e78.O50));
                        return;
                    } else if (i == t0.this.botsSectionRow) {
                        nu3Var.setText(org.telegram.messenger.u.B0("PrivacyBots", e78.lY));
                        return;
                    } else if (i == t0.this.contactsSectionRow) {
                        nu3Var.setText(org.telegram.messenger.u.B0("Contacts", e78.zl));
                        return;
                    } else if (i == t0.this.newChatsHeaderRow) {
                        nu3Var.setText(org.telegram.messenger.u.B0("NewChatsFromNonContacts", e78.VJ));
                        return;
                    } else {
                        return;
                    }
                ...
                if (i == t0.this.deleteAccountDetailRow) {
                    bv9Var.setText(org.telegram.messenger.u.B0("DeleteAccountHelp", e78.Ln));
                    ...
                    bv9Var.setText(org.telegram.messenger.u.B0("GroupsAndChannelsHelp", e78.uA));
                    bv9Var.setBackgroundDrawable(org.telegram.ui.ActionBar.l.u2(this.mContext, g68.f2, "windowBackgroundGrayShadow"));
                    return;
                } else if (i == t0.this.autoDeleteDetailRow) {
                    bv9Var.setText(org.telegram.messenger.u.B0("AutoDeleteSettingsInfo", e78.V9));
                    bv9Var.setBackgroundDrawable(org.telegram.ui.ActionBar.l.u2(this.mContext, g68.f2, "windowBackgroundGrayShadow"));
                    return;
                } else if (i == t0.this.secretDetailRow) {
                    bv9Var.setText(org.telegram.messenger.u.B0("SecretWebPageInfo", e78.a60));
                    bv9Var.setBackgroundDrawable(org.telegram.ui.ActionBar.l.u2(this.mContext, g68.f2, "windowBackgroundGrayShadow"));
                    return;
                } else if (i == t0.this.botsDetailRow) {
                    bv9Var.setText(org.telegram.messenger.u.B0("PrivacyBotsInfo", e78.mY));
                    bv9Var.setBackgroundDrawable(org.telegram.ui.ActionBar.l.u2(this.mContext, g68.f2, "windowBackgroundGrayShadow"));
                    return;
                } else if (i == t0.this.contactsDetailRow) {
                    bv9Var.setText(org.telegram.messenger.u.B0("SuggestContactsInfo", e78.uc0));
                    bv9Var.setBackgroundDrawable(org.telegram.ui.ActionBar.l.u2(this.mContext, g68.f2, "windowBackgroundGrayShadow"));
                    return;
                } else if (i == t0.this.newChatsSectionRow) {
                    bv9Var.setText(org.telegram.messenger.u.B0("ArchiveAndMuteInfo", e78.J6));
                    bv9Var.setBackgroundDrawable(org.telegram.ui.ActionBar.l.u2(this.mContext, g68.f2, "windowBackgroundGrayShadow"));
                    return;
                } else {
                    return;
            ...
            if (i == t0.this.webSessionsRow) {
                uw9Var.c(org.telegram.messenger.u.B0("WebSessionsTitle", e78.Hp0), false);
                ...
                uw9Var.d(org.telegram.messenger.u.B0("PrivacyPhone", e78.MY), str, true);
                ...
                uw9Var.d(org.telegram.messenger.u.B0("PrivacyLastSeen", e78.BY), str, true);
                ...
                uw9Var.d(org.telegram.messenger.u.B0("GroupsAndChannels", e78.tA), str, true);
                ...
                uw9Var.d(org.telegram.messenger.u.B0("Calls", e78.He), str, true);
                ...
                uw9Var.d(org.telegram.messenger.u.B0("PrivacyProfilePhoto", e78.WY), str, true);
                ...
                uw9Var.d(org.telegram.messenger.u.B0("PrivacyForwards", e78.tY), str, true);
            } else {
                if (i == t0.this.voicesRow) {
                    if (t0.this.j0().O0(8)) {
                        ...
                        if (!t0.this.M0().x()) {
                            str = org.telegram.messenger.u.z0(e78.uQ);
                        } else {
                            str = t0.R3(t0.this.e0(), 8);
                        }
                        z4 = false;
                    }
                    uw9Var.d(org.telegram.messenger.u.z0(e78.fZ), str, false);
                    ImageView valueImageView = uw9Var.getValueImageView();
                    if (!t0.this.M0().x()) {
                        valueImageView.setVisibility(0);
                        valueImageView.setImageResource(g68.D8);
                    ...
                    uw9Var.c(org.telegram.messenger.u.B0("TelegramPassport", e78.Kd0), true);
                    ...
                    uw9Var.e(org.telegram.messenger.u.B0("DeleteAccountIfAwayFor3", e78.Nn), str, t0.this.deleteAccountUpdate, false);
                    t0.this.deleteAccountUpdate = false;
                } else if (i == t0.this.paymentsClearRow) {
                    uw9Var.c(org.telegram.messenger.u.B0("PrivacyPaymentsClear", e78.FY), true);
                } else if (i == t0.this.secretMapRow) {
                    int i4 = org.telegram.messenger.e0.q;
                    if (i4 != 0) {
                        if (i4 != 1) {
                            if (i4 != 2) {
                                B0 = org.telegram.messenger.u.B0("MapPreviewProviderYandex", e78.xH);
                            } else {
                                B0 = org.telegram.messenger.u.B0("MapPreviewProviderNobody", e78.uH);
                            }
                        } else {
                            B0 = org.telegram.messenger.u.B0("MapPreviewProviderGoogle", e78.tH);
                        }
                    } else {
                        B0 = org.telegram.messenger.u.B0("MapPreviewProviderTelegram", e78.vH);
                    }
                    uw9Var.e(org.telegram.messenger.u.B0("MapPreviewProvider", e78.sH), B0, t0.this.secretMapUpdate, true);
                    t0.this.secretMapUpdate = false;
                } else if (i == t0.this.contactsDeleteRow) {
                    uw9Var.c(org.telegram.messenger.u.B0("SyncContactsDelete", e78.fd0), true);
                }
                z3 = z4;
            }
            uw9Var.a(z3, i2, z);
        ...
        if (P0 != null && P0.size() != 0) {
            ...
            if (c2 != 0 && (c2 != 65535 || i2 <= 0)) {
                if (c2 != 2 && (c2 != 65535 || i2 <= 0 || i3 <= 0)) {
                    ...
                    if (i == 3) {
                        if (i3 == 0) {
                            return org.telegram.messenger.u.B0("P2PNobody", e78.wQ);
                        }
                        return org.telegram.messenger.u.d0("P2PNobodyPlus", e78.xQ, Integer.valueOf(i3));
                    } else if (i3 == 0) {
                        return org.telegram.messenger.u.B0("LastSeenNobody", e78.xE);
                    } else {
                        return org.telegram.messenger.u.d0("LastSeenNobodyPlus", e78.yE, Integer.valueOf(i3));
                    }
                } else if (i == 3) {
                    if (i3 == 0 && i2 == 0) {
                        return org.telegram.messenger.u.B0("P2PContacts", e78.pQ);
                    }
                    if (i3 != 0 && i2 != 0) {
                        return org.telegram.messenger.u.d0("P2PContactsMinusPlus", e78.rQ, Integer.valueOf(i2), Integer.valueOf(i3));
                    }
                    if (i2 != 0) {
                        return org.telegram.messenger.u.d0("P2PContactsMinus", e78.qQ, Integer.valueOf(i2));
                    }
                    return org.telegram.messenger.u.d0("P2PContactsPlus", e78.sQ, Integer.valueOf(i3));
                } else if (i3 == 0 && i2 == 0) {
                    return org.telegram.messenger.u.B0("LastSeenContacts", e78.pE);
                } else {
                    if (i3 != 0 && i2 != 0) {
                        return org.telegram.messenger.u.d0("LastSeenContactsMinusPlus", e78.rE, Integer.valueOf(i2), Integer.valueOf(i3));
                    }
                    if (i2 != 0) {
                        return org.telegram.messenger.u.d0("LastSeenContactsMinus", e78.qE, Integer.valueOf(i2));
                    }
                    return org.telegram.messenger.u.d0("LastSeenContactsPlus", e78.sE, Integer.valueOf(i3));
                }
            } else if (i == 3) {
                if (i2 == 0) {
                    return org.telegram.messenger.u.B0("P2PEverybody", e78.uQ);
                }
                return org.telegram.messenger.u.d0("P2PEverybodyMinus", e78.vQ, Integer.valueOf(i2));
            } else if (i2 == 0) {
                return org.telegram.messenger.u.B0("LastSeenEverybody", e78.uE);
            } else {
                return org.telegram.messenger.u.d0("LastSeenEverybodyMinus", e78.vE, Integer.valueOf(i2));
            }
        } else if (i == 3) {
            return org.telegram.messenger.u.B0("P2PNobody", e78.wQ);
        } else {
    ...
    public /* synthetic */ void Z3(DialogInterface dialogInterface, int i) {
        ...
        boolean z = zArr2[0];
        if (z && zArr2[1]) {
            B0 = org.telegram.messenger.u.B0("PrivacyPaymentsPaymentShippingCleared", e78.KY);
        } else if (z) {
            B0 = org.telegram.messenger.u.B0("PrivacyPaymentsShippingInfoCleared", e78.LY);
        } else if (zArr2[1]) {
            B0 = org.telegram.messenger.u.B0("PrivacyPaymentsPaymentInfoCleared", e78.JY);
        } else {
            return;
        }
        org.telegram.ui.Components.q.p0(this).T(y68.F, B0).T();
    }
    ...
    public /* synthetic */ void a4(DialogInterface dialogInterface, int i) {
        ...
        e.k kVar = new e.k(E0());
        kVar.x(org.telegram.messenger.u.B0("PrivacyPaymentsClearAlertTitle", e78.IY));
        kVar.n(org.telegram.messenger.u.B0("PrivacyPaymentsClearAlert", e78.GY));
        kVar.v(org.telegram.messenger.u.B0("ClearButton", e78.Uj), new DialogInterface.OnClickListener() { // from class: aq7
    ...
    public /* synthetic */ void b4(Context context, View view, int i) {
        ...
        if (i == this.blockedRow) {
            ...
            if (i == this.deleteAccountRow) {
                ...
                kVar.x(org.telegram.messenger.u.B0("DeleteAccountTitle", e78.On));
                ...
                if (yq9Var != null && (str = yq9Var.c) != null) {
                    ...
                    new e.k(context).x(valueOf).n(org.telegram.messenger.u.z0(e78.bs)).v(org.telegram.messenger.u.z0(e78.pf), new DialogInterface.OnClickListener() { // from class: kq7
                        @Override // android.content.DialogInterface.OnClickListener
                ...
                kVar2.x(org.telegram.messenger.u.B0("SyncContactsDeleteTitle", e78.hd0));
                kVar2.n(org.telegram.messenger.a.b3(org.telegram.messenger.u.B0("SyncContactsDeleteText", e78.gd0)));
                kVar2.p(org.telegram.messenger.u.B0("Cancel", e78.Le), null);
                kVar2.v(org.telegram.messenger.u.B0("Delete", e78.Kn), new DialogInterface.OnClickListener() { // from class: lq7
                    @Override // android.content.DialogInterface.OnClickListener
                    public final void onClick(DialogInterface dialogInterface, int i6) {
                ...
                if (this.newSuggest) {
                    ...
                    kVar3.x(org.telegram.messenger.u.B0("SuggestContactsTitle", e78.vc0));
                    kVar3.n(org.telegram.messenger.u.B0("SuggestContactsAlert", e78.tc0));
                    kVar3.v(org.telegram.messenger.u.B0("MuteDisable", e78.sJ), new DialogInterface.OnClickListener() { // from class: mq7
                        @Override // android.content.DialogInterface.OnClickListener
                        public final void onClick(DialogInterface dialogInterface, int i6) {
                ...
                kVar4.x(org.telegram.messenger.u.B0("PrivacyPaymentsClearAlertTitle", e78.IY));
                kVar4.n(org.telegram.messenger.u.B0("PrivacyPaymentsClearAlertText", e78.HY));
                LinearLayout linearLayout2 = new LinearLayout(E0());
                linearLayout2.setOrientation(1);
                kVar4.E(linearLayout2);
                for (int i6 = 0; i6 < 2; i6++) {
                    if (i6 == 0) {
                        B0 = org.telegram.messenger.u.B0("PrivacyClearShipping", e78.pY);
                    } else {
                        B0 = org.telegram.messenger.u.B0("PrivacyClearPayment", e78.oY);
                    }
                    this.clear[i6] = true;
                ...
                kVar4.v(org.telegram.messenger.u.B0("ClearButton", e78.Uj), new DialogInterface.OnClickListener() { // from class: vp7
                    @Override // android.content.DialogInterface.OnClickListener
                    public final void onClick(DialogInterface dialogInterface, int i7) {
                        t0.this.a4(dialogInterface, i7);
                    }
                });
                kVar4.p(org.telegram.messenger.u.B0("Cancel", e78.Le), null);
                f2(kVar4.a());
    ...
    public /* synthetic */ void f4() {
        ...
        lVar.A(y68.b0, new String[0]);
        lVar.textView.setText(org.telegram.messenger.u.z0(e78.Cq0));
    ...
    public View W(final Context context) {
        ...
        this.actionBar.setTitle(org.telegram.messenger.u.B0("PrivacySettings", e78.cZ));
