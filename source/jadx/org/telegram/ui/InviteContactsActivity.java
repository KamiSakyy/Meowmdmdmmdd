...
public class InviteContactsActivity extends org.telegram.ui.ActionBar.f implements a0.d, View.OnClickListener {
    ...
    public class g implements TextWatcher {
        ...
        public void afterTextChanged(Editable editable) {
            if (InviteContactsActivity.this.editText.length() != 0) {
                ...
                InviteContactsActivity.this.emptyView.setText(org.telegram.messenger.u.B0("NoResult", e78.rL));
                return;
            }
    ...
    public class i extends v1.s {
        ...
        public RecyclerView.d0 onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            if (i != 1) {
                ...
                p64Var.a(org.telegram.messenger.u.B0("ShareTelegram", e78.V80), g68.Ce);
                frameLayout = p64Var;
            }
    ...
    public View W(Context context) {
        ...
        this.actionBar.setTitle(org.telegram.messenger.u.B0("InviteFriends", e78.QC));
        ...
        this.editText.setHintText(org.telegram.messenger.u.B0("SearchFriends", e78.y50));
        ...
        this.infoTextView.setText(org.telegram.messenger.u.B0("InviteFriendsHelp", e78.RC));
        ...
        this.textView.setText(org.telegram.messenger.u.B0("InviteToTelegram", e78.hD).toUpperCase());
