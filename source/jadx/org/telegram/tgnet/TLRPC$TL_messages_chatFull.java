...
public class TLRPC$TL_messages_chatFull extends a {
    public static int a = -438840932;

    /* renamed from: a  reason: collision with other field name */
    public gm9 f14474a;

    /* renamed from: a  reason: collision with other field name */
    public ArrayList f14475a = new ArrayList();
    public ArrayList b = new ArrayList();

    public static TLRPC$TL_messages_chatFull f(b1 b1Var, int i, boolean z) {
        if (a != i) {
            if (!z) {
                return null;
            }
        ...
        tLRPC$TL_messages_chatFull.d(b1Var, z);
        return tLRPC$TL_messages_chatFull;
    }

    @Override // org.telegram.tgnet.a
    public void d(b1 b1Var, boolean z) {
        this.f14474a = gm9.f(b1Var, b1Var.readInt32(z), z);
    ...
    public void e(b1 b1Var) {
        b1Var.writeInt32(a);
        this.f14474a.e(b1Var);
        b1Var.writeInt32(481674261);
        int size = this.f14475a.size();
        b1Var.writeInt32(size);
        for (int i = 0; i < size; i++) {
            ((fm9) this.f14475a.get(i)).e(b1Var);
        }
        b1Var.writeInt32(481674261);
