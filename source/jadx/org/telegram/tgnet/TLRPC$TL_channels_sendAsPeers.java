...
public class TLRPC$TL_channels_sendAsPeers extends a {
    public static int a = -191450938;

    /* renamed from: a  reason: collision with other field name */
    public ArrayList f14091a = new ArrayList();
    public ArrayList b = new ArrayList();
    public ArrayList c = new ArrayList();

    public static TLRPC$TL_channels_sendAsPeers f(b1 b1Var, int i, boolean z) {
        if (a != i) {
            if (!z) {
                return null;
            }
        ...
        tLRPC$TL_channels_sendAsPeers.d(b1Var, z);
    ...
    public void d(b1 b1Var, boolean z) {
        ...
        for (int i = 0; i < readInt322; i++) {
            TLRPC$TL_sendAsPeer f = TLRPC$TL_sendAsPeer.f(b1Var, b1Var.readInt32(z), z);
            if (f == null) {
                return;
            }
            this.f14091a.add(f);
    ...
    public void e(b1 b1Var) {
        ...
        for (int i = 0; i < size; i++) {
            ((TLRPC$TL_sendAsPeer) this.f14091a.get(i)).e(b1Var);
        }
        b1Var.writeInt32(481674261);
