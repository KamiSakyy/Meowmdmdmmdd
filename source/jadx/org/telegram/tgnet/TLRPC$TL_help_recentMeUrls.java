...
public class TLRPC$TL_help_recentMeUrls extends a {
    public static int a = 235081943;

    /* renamed from: a  reason: collision with other field name */
    public ArrayList f14326a = new ArrayList();
    public ArrayList b = new ArrayList();
    public ArrayList c = new ArrayList();

    public static TLRPC$TL_help_recentMeUrls f(b1 b1Var, int i, boolean z) {
        if (a != i) {
            if (!z) {
                return null;
            }
        ...
        tLRPC$TL_help_recentMeUrls.d(b1Var, z);
    ...
    public void d(b1 b1Var, boolean z) {
        ...
        for (int i = 0; i < readInt322; i++) {
            sp9 f = sp9.f(b1Var, b1Var.readInt32(z), z);
            if (f == null) {
                return;
            }
            this.f14326a.add(f);
    ...
    public void e(b1 b1Var) {
        ...
        for (int i = 0; i < size; i++) {
            ((sp9) this.f14326a.get(i)).e(b1Var);
        }
        b1Var.writeInt32(481674261);
