...
public class TLRPC$TL_defaultHistoryTTL extends a {
    public static int b = 1135897376;
    public int a;

    public static TLRPC$TL_defaultHistoryTTL f(b1 b1Var, int i, boolean z) {
        if (b != i) {
            if (!z) {
                return null;
            }
        ...
        tLRPC$TL_defaultHistoryTTL.d(b1Var, z);
