...
public class TLRPC$TL_users_userFull extends a {
    public static int a = 997004590;

    /* renamed from: a  reason: collision with other field name */
    public nq9 f15450a;

    /* renamed from: a  reason: collision with other field name */
    public ArrayList f15449a = new ArrayList();
    public ArrayList b = new ArrayList();

    public static TLRPC$TL_users_userFull f(b1 b1Var, int i, boolean z) {
        if (a != i) {
            if (!z) {
                return null;
            }
        ...
        tLRPC$TL_users_userFull.d(b1Var, z);
        return tLRPC$TL_users_userFull;
    }

    @Override // org.telegram.tgnet.a
    public void d(b1 b1Var, boolean z) {
        this.f15450a = nq9.f(b1Var, b1Var.readInt32(z), z);
    ...
    public void e(b1 b1Var) {
        b1Var.writeInt32(a);
        this.f15450a.e(b1Var);
        b1Var.writeInt32(481674261);
        int size = this.f15449a.size();
        b1Var.writeInt32(size);
        for (int i = 0; i < size; i++) {
            ((fm9) this.f15449a.get(i)).e(b1Var);
        }
        b1Var.writeInt32(481674261);
