...
public class MusicPlayerService extends Service implements a0.d {
    ...
    public final void d(x xVar, boolean z) {
        ...
        Notification.Builder contentText = builder.setSmallIcon(g68.wd).setOngoing(z2).setContentTitle(U0).setContentText(S0);
        if (D1 != null) {
            str2 = D1.a();
        } else {
            str2 = null;
        ...
        String B0 = u.B0("Next", e78.tK);
        String B02 = u.B0("AccDescrPrevious", e78.I0);
        if (MediaController.H1().S1()) {
            this.f12433a.setState(6, 0L, 1.0f).setActions(0L);
            builder.addAction(new Notification.Action.Builder(g68.B2, B02, broadcast).build()).addAction(new Notification.Action.Builder(g68.t4, u.B0("Loading", e78.aG), (PendingIntent) null).build()).addAction(new Notification.Action.Builder(g68.y2, B0, broadcast3).build());
            str3 = U0;
            str4 = S0;
        } else {
            ...
            Notification.Builder addAction = builder.addAction(new Notification.Action.Builder(g68.B2, B02, broadcast).build());
            if (z2) {
                i3 = g68.z2;
            } else {
                i3 = g68.A2;
            }
            addAction.addAction(new Notification.Action.Builder(i3, B03, broadcast2).build()).addAction(new Notification.Action.Builder(g68.y2, B0, broadcast3).build());
        }
    ...
    public void onCreate() {
        ...
        Drawable drawable = getResources().getDrawable(g68.tc);
