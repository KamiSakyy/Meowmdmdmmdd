    ...
    public CharSequence A1() {
        ...
        if (lo9Var != null && (str = lo9Var.f9710e) != null) {
            if (TextUtils.isEmpty(str)) {
                SpannableString spannableString = new SpannableString(u.B0("NoWordsRecognized", e78.PL));
        ...
        if (!(lo9Var instanceof TLRPC$TL_message) && !(lo9Var instanceof TLRPC$TL_messageForwarded_old2)) {
            ...
            if (!d2() && this.p >= 1 && !this.N) {
                ...
                if (TextUtils.isEmpty(this.f13359a) && this.f13407e == 0) {
                    this.f13359a = u.B0("EventLogOriginalCaptionEmpty", e78.Su);
                }
            } else if (I1()) {
                this.f13381b = 20;
                ...
                if (um9Var instanceof TLRPC$TL_documentAttributeAudio) {
                    ...
                    if (str == null || str.length() == 0) {
                        ...
                        if (TextUtils.isEmpty(k0) && z) {
                            return u.B0("AudioUnknownTitle", e78.W8);
                        }
                        return k0;
                    }
                    return str;
    ...
    public void X(mq9 mq9Var) {
        ...
        if (tLRPC$TL_game == null) {
            if (mq9Var != null && mq9Var.f10557a == tla.p(this.k).k()) {
                this.f13359a = u.d0("ActionYouScored", e78.d4, u.U("Points", this.f13365a.f9690a.d, new Object[0]));
                return;
            } else {
                this.f13359a = v4(u.d0("ActionUserScored", e78.P3, u.U("Points", this.f13365a.f9690a.d, new Object[0])), "un1", mq9Var);
                return;
            }
        }
        if (mq9Var != null && mq9Var.f10557a == tla.p(this.k).k()) {
            this.f13359a = u.d0("ActionYouScoredInGame", e78.e4, u.U("Points", this.f13365a.f9690a.d, new Object[0]));
        } else {
            this.f13359a = v4(u.d0("ActionUserScoredInGame", e78.Q3, u.U("Points", this.f13365a.f9690a.d, new Object[0])), "un1", mq9Var);
        }
    ...
    public void a0(mq9 mq9Var) {
        ...
        if (xVar != null && (L0(xVar) instanceof TLRPC$TL_messageMediaInvoice)) {
            if (this.f13365a.f9690a.f10509a) {
                this.f13359a = u.c0(e78.gV, str2, str, L0(this.f13370a).f17417d);
            } else {
                this.f13359a = u.d0("PaymentSuccessfullyPaid", e78.dV, str2, str, L0(this.f13370a).f17417d);
            }
        } else if (this.f13365a.f9690a.f10509a) {
            this.f13359a = u.c0(e78.fV, str2, str);
        } else {
            this.f13359a = u.d0("PaymentSuccessfullyPaidNoItem", e78.eV, str2, str);
        }
    }
    ...
    public void b0(mq9 mq9Var, fm9 fm9Var) {
        ...
        if (xVar != null) {
            ...
            if (!(lo9Var instanceof TLRPC$TL_messageEmpty) && !(lo9Var.f9690a instanceof TLRPC$TL_messageActionHistoryClear)) {
                if (xVar.P2()) {
                    String B0 = u.B0("ActionPinnedMusic", e78.m3);
                    fm9 fm9Var2 = mq9Var;
                    if (mq9Var == null) {
                        fm9Var2 = fm9Var;
                    }
                    ...
                    String B02 = u.B0("ActionPinnedVideo", e78.u3);
                    fm9 fm9Var3 = mq9Var;
                    if (mq9Var == null) {
                        fm9Var3 = fm9Var;
                    }
                    ...
                    String B03 = u.B0("ActionPinnedGif", e78.l3);
                    fm9 fm9Var4 = mq9Var;
                    if (mq9Var == null) {
                        fm9Var4 = fm9Var;
                    }
                    ...
                    String B04 = u.B0("ActionPinnedVoice", e78.v3);
                    fm9 fm9Var5 = mq9Var;
                    if (mq9Var == null) {
                        fm9Var5 = fm9Var;
                    }
                    ...
                    String B05 = u.B0("ActionPinnedRound", e78.r3);
                    fm9 fm9Var6 = mq9Var;
                    if (mq9Var == null) {
                        fm9Var6 = fm9Var;
                    }
                    ...
                    String B06 = u.B0("ActionPinnedSticker", e78.s3);
                    fm9 fm9Var7 = mq9Var;
                    if (mq9Var == null) {
                        fm9Var7 = fm9Var;
                    }
                    ...
                    String B07 = u.B0("ActionPinnedFile", e78.h3);
                    fm9 fm9Var8 = mq9Var;
                    if (mq9Var == null) {
                        fm9Var8 = fm9Var;
                    }
                    ...
                    String B08 = u.B0("ActionPinnedGeo", e78.j3);
                    fm9 fm9Var9 = mq9Var;
                    if (mq9Var == null) {
                        fm9Var9 = fm9Var;
                    }
                    ...
                    String B09 = u.B0("ActionPinnedGeoLive", e78.k3);
                    fm9 fm9Var10 = mq9Var;
                    if (mq9Var == null) {
                        fm9Var10 = fm9Var;
                    }
                    ...
                    String B010 = u.B0("ActionPinnedContact", e78.g3);
                    fm9 fm9Var11 = mq9Var;
                    if (mq9Var == null) {
                        fm9Var11 = fm9Var;
                    }
                    ...
                    if (((TLRPC$TL_messageMediaPoll) L0(this.f13370a)).a.d) {
                        String B011 = u.B0("ActionPinnedQuiz", e78.q3);
                        fm9 fm9Var12 = mq9Var;
                        if (mq9Var == null) {
                            fm9Var12 = fm9Var;
                        }
                    ...
                    String B012 = u.B0("ActionPinnedPoll", e78.p3);
                    fm9 fm9Var13 = mq9Var;
                    if (mq9Var == null) {
                        fm9Var13 = fm9Var;
                    }
                    ...
                    String B013 = u.B0("ActionPinnedPhoto", e78.o3);
                    fm9 fm9Var14 = mq9Var;
                    if (mq9Var == null) {
                        fm9Var14 = fm9Var;
                    }
                    ...
                    if (charSequence != null && charSequence.length() > 0) {
                        ...
                        SpannableStringBuilder A0 = org.telegram.messenger.a.A0(u.B0("ActionPinnedText", e78.t3), spannableStringBuilder);
                        fm9 fm9Var16 = mq9Var;
                        if (mq9Var == null) {
                            fm9Var16 = fm9Var;
                        }
                    ...
                    String B014 = u.B0("ActionPinnedNoText", e78.n3);
                    fm9 fm9Var17 = mq9Var;
                    if (mq9Var == null) {
                        fm9Var17 = fm9Var;
                    }
        ...
        String B015 = u.B0("ActionPinnedNoText", e78.n3);
        fm9 fm9Var18 = mq9Var;
        if (mq9Var == null) {
            fm9Var18 = fm9Var;
        }
    ...
    */
    ...
    public final CharSequence t1(lm9 lm9Var) {
        if (lm9Var instanceof TLRPC$TL_chatReactionsAll) {
            return u.B0("AllReactions", e78.F5);
        }
        ...
        return u.B0("NoReactions", e78.lL);
    }
    ...
    public final String z1(ArrayList arrayList) {
        ...
        return u.B0("UsernameEmpty", e78.Jj0).toLowerCase();
    }
