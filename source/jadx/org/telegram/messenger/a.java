...
public abstract class a {
    ...
    static {
        ...
        f12470a = new int[]{g68.Q4, g68.S4, g68.U4, g68.W4};
        f12479b = new int[]{g68.R4, g68.T4, g68.V4, g68.X4};
    ...
    */
    ...
    public static void J3(final View view, float f2, final Runnable runnable) {
        int e0 = e0(f2);
        if (view.getTag(i68.v1) != null) {
            ((x99) view.getTag(i68.v1)).d();
        }
        Float f3 = (Float) view.getTag(i68.w1);
        if (f3 != null) {
            view.setTranslationX(f3.floatValue());
        }
        view.setTag(i68.w1, Float.valueOf(view.getTranslationX()));
    ...
    public static void M2(x xVar, Activity activity, org.telegram.ui.ActionBar.f fVar) {
        ...
        if (file != null && file.exists()) {
            if (fVar != null && file.getName().toLowerCase().endsWith("attheme")) {
                ...
                kVar.A(true);
                kVar.n(u.B0("IncorrectTheme", e78.sC));
            ...
            try {
                ...
                kVar2.z(y68.k1, 52, false, fVar.K0("dialogTopBackground"), hashMap2);
                kVar2.A(true);
                kVar2.v(u.B0("OK", e78.zP), null);
                kVar2.n(u.d0("NoHandleAppInstalled", e78.QK, xVar.o0().f19570b));
                fVar.f2(kVar2.a());
            }
        }
    }
    ...
    */
    ...
    public static void O3(final Activity activity, final String str, final String str2, final String str3, final String str4, final String str5) {
        ...
        if (!TextUtils.isEmpty(str5)) {
            ...
            textView.setText(u.B0("UseProxyTelegramInfo2", e78.Ci0));
        ...
        for (int i3 = 0; i3 < 5; i3++) {
            String str7 = null;
            if (i3 == 0) {
                str6 = u.B0("UseProxyAddress", e78.oi0);
                str7 = str;
            } else if (i3 == 1) {
                str7 = "" + str2;
                str6 = u.B0("UseProxyPort", e78.ti0);
            } else if (i3 == 2) {
                str6 = u.B0("UseProxySecret", e78.ui0);
                str7 = str5;
            } else if (i3 == 3) {
                str6 = u.B0("UseProxyUsername", e78.Di0);
                str7 = str3;
            } else if (i3 == 4) {
                str6 = u.B0("UseProxyPassword", e78.si0);
                str7 = str4;
            } else {
                str6 = null;
            }
        ...
        uh7Var.cancelButton.setText(u.B0("Cancel", e78.Le).toUpperCase());
        ...
        uh7Var.doneButtonTextView.setText(u.B0("ConnectingConnectProxy", e78.kl).toUpperCase());
    ...
    */
    ...
    public static boolean R1(final org.telegram.ui.ActionBar.f fVar) {
        ...
        try {
            ...
            kVar.v(u.B0("OK", e78.zP), new DialogInterface.OnClickListener() { // from class: id
    ...
    */
    ...
    public static boolean Z1() {
        return org.telegram.messenger.b.f12514a != null && org.telegram.messenger.b.f12514a.getResources().getBoolean(w58.a);
    }
    ...
    */
    ...
    public static /* synthetic */ void r2(Runnable runnable, View view, float f2, hm2 hm2Var, boolean z, float f3, float f4) {
        ...
        view.setTag(i68.v1, null);
        view.setTag(i68.w1, null);
    }
