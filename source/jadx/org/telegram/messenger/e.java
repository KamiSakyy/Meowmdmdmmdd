...
public class e extends ow {
    ...
    */
    ...
    public /* synthetic */ void j1(ArrayList arrayList, boolean z, String str) {
        ...
        getNotificationCenter().s(a0.A, new Object[0]);
        if (z) {
            a0.j().s(a0.Y2, 1, u.d0("DeletedFromYourContacts", e78.cp, str));
        }
    }
    ...
    public String L0(int i) {
        ...
        if (i <= 1) {
            return u.d0("InviteText2", e78.VC, str);
        }
        try {
    ...
    public long p0(mq9 mq9Var, boolean z) {
        ...
        newInsert3.withValue("data3", u.d0("ContactShortcutMessage", e78.ul, str2));
        ...
        newInsert4.withValue("data3", u.d0("ContactShortcutVoiceCall", e78.wl, str2));
        ...
        newInsert5.withValue("data3", u.d0("ContactShortcutVideoCall", e78.vl, str2));
