...
public class ContactsWidgetProvider extends AppWidgetProvider {
    ...
    public static void b(Context context, AppWidgetManager appWidgetManager, int i) {
        ...
        if (!sharedPreferences.getBoolean("deleted" + i, false)) {
            ...
            if (i3 >= 0) {
                q2.h(i3).m().V4(i, 1, arrayList, null, null, false);
            }
        ...
        remoteViews.setRemoteAdapter(i, i68.c0, intent);
        remoteViews.setEmptyView(i68.c0, i68.R);
        ...
        remoteViews.setPendingIntentTemplate(i68.c0, PendingIntent.getActivity(b.f12514a, 0, intent2, 167772160));
        appWidgetManager.updateAppWidget(i, remoteViews);
        appWidgetManager.notifyAppWidgetViewDataChanged(i, i68.c0);
    }
