    ...
    */
    ...
    public boolean xb(final tm9 tm9Var) {
        ...
        if (tm9Var.f19577d > y.u8(((ow) this).a).V) {
            a0.j().s(a0.Y2, 4, u.d0("TooLargeError", e78.Af0, new Object[0]), u.d0("ErrorRingtoneSizeTooBig", e78.yt, Integer.valueOf(y.u8(tla.o).V / 1024)));
            return false;
        }
        for (int i = 0; i < tm9Var.f19575c.size(); i++) {
            um9 um9Var = (um9) tm9Var.f19575c.get(i);
            if ((um9Var instanceof TLRPC$TL_documentAttributeAudio) && um9Var.a > y.u8(((ow) this).a).U) {
                a0.j().s(a0.Y2, 4, u.d0("TooLongError", e78.Bf0, new Object[0]), u.d0("ErrorRingtoneDurationTooLong", e78.wt, Integer.valueOf(y.u8(tla.o).U)));
                return false;
            }
        }
