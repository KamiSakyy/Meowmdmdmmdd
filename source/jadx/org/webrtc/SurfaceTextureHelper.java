...
public class SurfaceTextureHelper {
    ...
    private SurfaceTextureHelper(EglBase.Context context, Handler handler, boolean z, YuvConverter yuvConverter, FrameRefMonitor frameRefMonitor) {
        ...
        if (handler.getLooper().getThread() == Thread.currentThread()) {
            ...
            try {
                ...
                setOnFrameAvailableListener(surfaceTexture, new SurfaceTexture.OnFrameAvailableListener() { // from class: rk9
    ...
    public void returnTextureFrame() {
        this.handler.post(new Runnable() { // from class: sk9
            @Override // java.lang.Runnable
    ...
    public void dispose() {
        ...
        ThreadUtils.invokeAtFrontUninterruptibly(this.handler, new Runnable() { // from class: nk9
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public void forceFrame() {
        this.handler.post(new Runnable() { // from class: mk9
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public void setFrameRotation(final int i) {
        this.handler.post(new Runnable() { // from class: qk9
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public void setTextureSize(final int i, final int i2) {
        if (i > 0) {
            if (i2 > 0) {
                ...
                this.handler.post(new Runnable() { // from class: ok9
                    @Override // java.lang.Runnable
                    public final void run() {
    ...
    public void stopListening() {
        ...
        ThreadUtils.invokeAtFrontUninterruptibly(this.handler, new Runnable() { // from class: pk9
            @Override // java.lang.Runnable
            public final void run() {
