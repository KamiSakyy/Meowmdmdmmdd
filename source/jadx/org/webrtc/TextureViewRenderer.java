...
public class TextureViewRenderer extends TextureView implements TextureView.SurfaceTextureListener, VideoSink, RendererCommon.RendererEvents {
    ...
    public Runnable updateScreenRunnable;
    public boolean useCameraRotation;
    ...
    private void onRotationChanged() {
        ...
        if (this.useCameraRotation) {
            i = OrientationHelper.cameraOrientation;
        } else {
            i = 0;
        }
    ...
    private void updateVideoSizes() {
        ...
        final int i3;
        int i4;
        final int i5 = this.videoHeight;
        if (i5 != 0 && (i = this.videoWidth) != 0) {
            if (this.rotateTextureWithScreen) {
                ...
                int i8 = this.textureRotation - OrientationHelper.cameraOrientation;
            ...
            if (this.rotatedFrameWidth != i3 || this.rotatedFrameHeight != i5) {
                synchronized (this.eglRenderer.layoutLock) {
                    Runnable runnable = this.updateScreenRunnable;
                    if (runnable != null) {
                        org.telegram.messenger.a.H(runnable);
                    }
                    Runnable runnable2 = new Runnable() { // from class: qx9
                        @Override // java.lang.Runnable
                        public final void run() {
                            TextureViewRenderer.this.lambda$updateVideoSizes$1(i3, i5);
                        }
                    };
    ...
    */
    public void onFrameResolutionChanged(final int r8, final int r9, int r10) {
        ...
        L5c:
            ...
            if (r0 == 0) goto L6c
            org.telegram.messenger.a.H(r0)     // Catch: java.lang.Throwable -> L7c
        L6c:
            px9 r0 = new px9     // Catch: java.lang.Throwable -> L7c
            r1 = r0
            r2 = r7
            r3 = r8
            r4 = r9
    ...
    public static class TextureEglRenderer extends EglRenderer implements TextureView.SurfaceTextureListener {
        ...
        @Override // org.webrtc.EglRenderer
        public void onFirstFrameRendered() {
            org.telegram.messenger.a.m3(new Runnable() { // from class: rx9
                @Override // java.lang.Runnable
                public final void run() {
        ...
        public boolean onSurfaceTextureDestroyed(SurfaceTexture surfaceTexture) {
            ...
            releaseEglSurface(new cy9(countDownLatch), false);
