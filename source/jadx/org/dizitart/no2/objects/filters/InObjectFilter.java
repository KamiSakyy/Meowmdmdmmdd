...
class InObjectFilter extends BaseObjectFilter {
    ...
    public InObjectFilter(String str, Object... objArr) {
        this.field = str;
        this.values = objArr;
    }
    ...
    public Set<NitriteId> apply(NitriteMap<NitriteId, Document> nitriteMap) {
        ...
        while (true) {
            ...
            if (i < objArr2.length) {
                ...
                Filter in = Filters.in(this.field, objArr);
                in.setNitriteService(this.nitriteService);
                return in.apply(nitriteMap);
            }
        }
        throw new FilterException(ErrorMessage.errorMessage("search term " + this.values[i] + " is not a comparable", ErrorCodes.FE_IN_SEARCH_TERM_NOT_COMPARABLE));
    }
    ...
    public String toString() {
        return "InObjectFilter(field=" + getField() + ", values=" + Arrays.deepToString(getValues()) + ")";
    }
}
