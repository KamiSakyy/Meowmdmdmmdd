...
public class WordUtils {
    public static String abbreviate(String str, int i, int i2, String str2) {
        ...
        zma.c(z, "upper value cannot be less than -1", new Object[0]);
        if (i2 < i && i2 != -1) {
            z2 = false;
        }
        zma.c(z2, "upper value is less than lower value", new Object[0]);
        if (ii9.j(str)) {
            return str;
        }
        if (i > str.length()) {
    ...
    public static boolean containsAllWords(CharSequence charSequence, CharSequence... charSequenceArr) {
        if (ii9.j(charSequence) || mk.e(charSequenceArr)) {
            return false;
        }
        for (CharSequence charSequence2 : charSequenceArr) {
            if (ii9.i(charSequence2)) {
                return false;
            }
    ...
    public static String capitalizeFully(String str, char... cArr) {
        return ii9.j(str) ? str : capitalize(str.toLowerCase(), cArr);
    }
