...
public class TextStringBuilder implements CharSequence, Appendable, Serializable, Builder<String> {
    ...
    public char[] toCharArray() {
        int i = this.size;
        return i == 0 ? mk.f10334a : Arrays.copyOf(this.buffer, i);
    }
    ...
    public char[] toCharArray(int i, int i2) {
        int validateRange = validateRange(i, i2);
        return validateRange - i == 0 ? mk.f10334a : Arrays.copyOfRange(this.buffer, i, validateRange);
    }
    ...
    */
    ...
    public int readFrom(Reader reader, int i) {
        if (i <= 0) {
            return 0;
        }
        int i2 = this.size;
    ...
    public TextStringBuilder append(CharBuffer charBuffer) {
        return append(charBuffer, 0, ii9.m(charBuffer));
    }
    ...
    public TextStringBuilder append(StringBuffer stringBuffer) {
        return append(stringBuffer, 0, ii9.m(stringBuffer));
    }
    ...
    public TextStringBuilder append(TextStringBuilder textStringBuilder) {
        return append(textStringBuilder, 0, ii9.m(textStringBuilder));
    }
