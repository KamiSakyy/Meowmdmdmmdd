...
public class c {
    ...
    public static class b {
        ...
        static {
            ...
            a = sparseIntArray;
            sparseIntArray.append(m78.j3, 24);
            a.append(m78.k3, 25);
            a.append(m78.m3, 28);
            a.append(m78.n3, 29);
            a.append(m78.s3, 35);
    ...
    public static class C0008c {
        ...
        static {
            SparseIntArray sparseIntArray = new SparseIntArray();
            a = sparseIntArray;
            sparseIntArray.append(m78.H3, 1);
            a.append(m78.J3, 2);
            a.append(m78.K3, 3);
            a.append(m78.G3, 4);
            a.append(m78.F3, 5);
    ...
    public static class e {
        ...
        static {
            SparseIntArray sparseIntArray = new SparseIntArray();
            a = sparseIntArray;
            sparseIntArray.append(m78.X3, 1);
            a.append(m78.Y3, 2);
            a.append(m78.Z3, 3);
            a.append(m78.V3, 4);
            a.append(m78.W3, 5);
    ...
    static {
        SparseIntArray sparseIntArray = new SparseIntArray();
        a = sparseIntArray;
        sparseIntArray.append(m78.c0, 25);
        a.append(m78.d0, 26);
        a.append(m78.f0, 29);
        a.append(m78.g0, 30);
        a.append(m78.m0, 36);
    ...
    */
    ...
    public final void n(Context context, a aVar, TypedArray typedArray) {
        ...
        for (int i = 0; i < indexCount; i++) {
            ...
            if (index != m78.b && m78.t != index && m78.u != index) {
