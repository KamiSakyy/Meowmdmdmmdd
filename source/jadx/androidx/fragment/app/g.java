    ...
    public View onCreateView(View view, String str, Context context, AttributeSet attributeSet) {
        ...
        if ("fragment".equals(str)) {
            ...
            if (attributeValue == null) {
                attributeValue = obtainStyledAttributes.getString(p78.a);
            }
            int resourceId = obtainStyledAttributes.getResourceId(p78.b, -1);
            String string = obtainStyledAttributes.getString(p78.c);
