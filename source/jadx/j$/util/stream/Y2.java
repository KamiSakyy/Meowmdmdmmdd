...
class Y2 extends AbstractC0274e implements Consumer, Iterable, Iterable {
    ...
    public final void s(long j) {
        ...
        int i;
        int i2 = this.c;
        long length = i2 == 0 ? this.e.length : this.f[i2].length + this.d[i2];
        if (j <= length) {
            return;
        }
        if (this.f == null) {
    ...
    public final String toString() {
        ...
        forEach(new C0254a(arrayList, 8));
