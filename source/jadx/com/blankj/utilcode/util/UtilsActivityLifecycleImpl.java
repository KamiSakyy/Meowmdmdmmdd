...
public final class UtilsActivityLifecycleImpl implements Application.ActivityLifecycleCallbacks {
    ...
    private void consumeActivityLifecycleCallbacks(Activity activity, c.b bVar) {
    ...
    private void consumeLifecycle(Activity activity, c.b bVar, List<Utils.ActivityLifecycleCallbacks> list) {
        if (list == null) {
            return;
        }
        for (Utils.ActivityLifecycleCallbacks activityLifecycleCallbacks : list) {
            ...
            if (bVar.equals(c.b.ON_CREATE)) {
                activityLifecycleCallbacks.onActivityCreated(activity);
            } else if (bVar.equals(c.b.ON_START)) {
                activityLifecycleCallbacks.onActivityStarted(activity);
            } else if (bVar.equals(c.b.ON_RESUME)) {
                activityLifecycleCallbacks.onActivityResumed(activity);
            } else if (bVar.equals(c.b.ON_PAUSE)) {
                activityLifecycleCallbacks.onActivityPaused(activity);
            } else if (bVar.equals(c.b.ON_STOP)) {
                activityLifecycleCallbacks.onActivityStopped(activity);
            } else if (bVar.equals(c.b.ON_DESTROY)) {
                activityLifecycleCallbacks.onActivityDestroyed(activity);
            }
        }
        if (bVar.equals(c.b.ON_DESTROY)) {
    ...
    public void onActivityCreated(Activity activity, Bundle bundle) {
        ...
        consumeActivityLifecycleCallbacks(activity, c.b.ON_CREATE);
    }
    ...
    public void onActivityDestroyed(Activity activity) {
        ...
        consumeActivityLifecycleCallbacks(activity, c.b.ON_DESTROY);
    }

    @Override // android.app.Application.ActivityLifecycleCallbacks
    public void onActivityPaused(Activity activity) {
        consumeActivityLifecycleCallbacks(activity, c.b.ON_PAUSE);
    }
    ...
    public void onActivityResumed(Activity activity) {
        ...
        consumeActivityLifecycleCallbacks(activity, c.b.ON_RESUME);
    }
    ...
    public void onActivityStarted(Activity activity) {
        ...
        consumeActivityLifecycleCallbacks(activity, c.b.ON_START);
    }
    ...
    public void onActivityStopped(Activity activity) {
        ...
        consumeActivityLifecycleCallbacks(activity, c.b.ON_STOP);
    }
