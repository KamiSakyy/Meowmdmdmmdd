...
public final class ObjectUtils {
    ...
    public static boolean isEmpty(Object obj) {
        ...
        if ((obj instanceof l59) && ((l59) obj).isEmpty()) {
            return true;
        }
        ...
        if ((obj instanceof j45) && ((j45) obj).u() == 0) {
            return true;
        }
    ...
    public static boolean isNotEmpty(l59 l59Var) {
        return !isEmpty(l59Var);
    }
    ...
    public static boolean isNotEmpty(j45 j45Var) {
        return !isEmpty(j45Var);
    }
    ...
    public static boolean isEmpty(l59 l59Var) {
        return l59Var == null || l59Var.isEmpty();
    }
    ...
    public static boolean isEmpty(j45 j45Var) {
