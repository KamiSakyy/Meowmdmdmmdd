...
public final class SnackbarUtils {
    ...
    public Snackbar show(boolean z) {
        ...
        if (this.messageColor != COLOR_DEFAULT) {
            ...
            sWeakSnackbar = new WeakReference<>(Snackbar.m0(view, spannableString, this.duration));
        } else {
            sWeakSnackbar = new WeakReference<>(Snackbar.m0(view, this.message, this.duration));
        }
        Snackbar snackbar = sWeakSnackbar.get();
        ...
        if (this.actionText.length() > 0 && this.actionListener != null) {
            ...
            snackbar.o0(this.actionText, this.actionListener);
        }
        snackbar.X();
        return snackbar;
    }
