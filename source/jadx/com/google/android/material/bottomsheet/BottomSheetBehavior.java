...
public class BottomSheetBehavior<V extends View> extends CoordinatorLayout.b {
    public static final int w = i78.d;
    public float a;
    ...
    */
    ...
    public final void Z0(View view, int i) {
        ...
        int i2 = 6;
        if (!this.f3119a && this.o != 6) {
            this.f3109a.put(i, X(view, c78.a, 6));
        }
    ...
    public boolean l(CoordinatorLayout coordinatorLayout, View view, int i) {
        ...
        if (this.f3112a == null) {
            this.f3126d = coordinatorLayout.getResources().getDimensionPixelSize(b68.a);
            R0(view);
    ...
    public BottomSheetBehavior(Context context, AttributeSet attributeSet) {
        ...
        this.f3109a = new SparseIntArray();
        this.f3117a = new d();
        this.e = context.getResources().getDimensionPixelSize(b68.J);
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, r78.f17883x);
        if (obtainStyledAttributes.hasValue(r78.d)) {
            this.f3108a = j95.b(context, obtainStyledAttributes, r78.d);
        }
        if (obtainStyledAttributes.hasValue(r78.v)) {
            this.f3116a = uz8.e(context, attributeSet, u58.c, w).m();
        }
        g0(context);
        h0();
        this.c = obtainStyledAttributes.getDimension(r78.c, -1.0f);
        if (obtainStyledAttributes.hasValue(r78.a)) {
            J0(obtainStyledAttributes.getDimensionPixelSize(r78.a, -1));
        }
        if (obtainStyledAttributes.hasValue(r78.b)) {
            I0(obtainStyledAttributes.getDimensionPixelSize(r78.b, -1));
        }
        TypedValue peekValue = obtainStyledAttributes.peekValue(r78.j);
        if (peekValue != null && (i = peekValue.data) == -1) {
            K0(i);
        } else {
            K0(obtainStyledAttributes.getDimensionPixelSize(r78.j, -1));
        }
        H0(obtainStyledAttributes.getBoolean(r78.i, false));
        F0(obtainStyledAttributes.getBoolean(r78.n, false));
        E0(obtainStyledAttributes.getBoolean(r78.g, true));
        O0(obtainStyledAttributes.getBoolean(r78.m, false));
        C0(obtainStyledAttributes.getBoolean(r78.e, true));
        M0(obtainStyledAttributes.getInt(r78.k, 0));
        G0(obtainStyledAttributes.getFloat(r78.h, 0.5f));
        TypedValue peekValue2 = obtainStyledAttributes.peekValue(r78.f);
        if (peekValue2 != null && peekValue2.type == 16) {
            D0(peekValue2.data);
        } else {
            D0(obtainStyledAttributes.getDimensionPixelOffset(r78.f, 0));
        }
        N0(obtainStyledAttributes.getInt(r78.l, Constants.DEFAULT_WRITE_DELAY));
        this.f3128e = obtainStyledAttributes.getBoolean(r78.r, false);
        this.f3129f = obtainStyledAttributes.getBoolean(r78.s, false);
        this.f3130g = obtainStyledAttributes.getBoolean(r78.t, false);
        this.f3131h = obtainStyledAttributes.getBoolean(r78.u, true);
        this.f3132i = obtainStyledAttributes.getBoolean(r78.o, false);
        this.f3133j = obtainStyledAttributes.getBoolean(r78.p, false);
        this.f3134k = obtainStyledAttributes.getBoolean(r78.q, false);
        this.f3135l = obtainStyledAttributes.getBoolean(r78.w, true);
