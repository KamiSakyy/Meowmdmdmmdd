...
public class a extends androidx.appcompat.app.c {
    ...
    public a(Context context, int i) {
        ...
        this.edgeToEdgeEnabled = getContext().getTheme().obtainStyledAttributes(new int[]{u58.q}).getBoolean(0, false);
    }

    public static int d(Context context, int i) {
        if (i == 0) {
            TypedValue typedValue = new TypedValue();
            if (context.getTheme().resolveAttribute(u58.b, typedValue, true)) {
    ...
    public final FrameLayout e() {
        if (this.container == null) {
            FrameLayout frameLayout = (FrameLayout) View.inflate(getContext(), u68.a, null);
            this.container = frameLayout;
            this.coordinator = (CoordinatorLayout) frameLayout.findViewById(r68.e);
            FrameLayout frameLayout2 = (FrameLayout) this.container.findViewById(r68.f);
    ...
    public final View f(int i, View view, ViewGroup.LayoutParams layoutParams) {
        e();
        CoordinatorLayout coordinatorLayout = (CoordinatorLayout) this.container.findViewById(r68.e);
        if (i != 0 && view == null) {
        ...
        coordinatorLayout.findViewById(r68.U).setOnClickListener(new b());
