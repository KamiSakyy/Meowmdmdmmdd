...
public class TextInputEditText extends sg {
    ...
    public TextInputEditText(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, u58.m);
    }
    ...
    public TextInputEditText(Context context, AttributeSet attributeSet, int i) {
        ...
        this.a = new Rect();
        TypedArray i2 = c0a.i(context, attributeSet, r78.f17891z1, i, i78.e, new int[0]);
        setTextInputLayoutFocusedRectEnabled(i2.getBoolean(r78.G2, false));
        i2.recycle();
    }
}
