...
public class NavigationMenuItemView extends id3 implements j.a {
    ...
    private void setActionView(View view) {
        if (view != null) {
            if (this.f3299a == null) {
                this.f3299a = (FrameLayout) ((ViewStub) findViewById(r68.g)).inflate();
            }
    ...
    public void setIcon(Drawable drawable) {
        if (drawable != null) {
            ...
            if (this.f3301c == null) {
                Drawable e = lf8.e(getResources(), f68.j, getContext().getTheme());
                this.f3301c = e;
                if (e != null) {
                    int i2 = this.k;
    ...
    public NavigationMenuItemView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.a = aVar;
        setOrientation(0);
        LayoutInflater.from(context).inflate(u68.d, (ViewGroup) this, true);
        setIconSize(context.getResources().getDimensionPixelSize(b68.b));
        CheckedTextView checkedTextView = (CheckedTextView) findViewById(r68.h);
