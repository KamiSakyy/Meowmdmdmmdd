...
class ClockFaceView extends w88 implements ClockHandView.c {
    ...
    public class b extends a2 {
        ...
        public void g(View view, l2 l2Var) {
            super.g(view, l2Var);
            int intValue = ((Integer) view.getTag(r68.s)).intValue();
            if (intValue > 0) {
    ...
    public final void x(int i) {
        ...
        for (int i2 = 0; i2 < Math.max(this.f3450a.length, size); i2++) {
            ...
            if (i2 >= this.f3450a.length) {
                ...
                if (textView == null) {
                    textView = (TextView) from.inflate(u68.g, (ViewGroup) this, false);
                    this.f3446a.put(i2, textView);
                    addView(textView);
                }
                textView.setText(this.f3450a[i2]);
                textView.setTag(r68.s, Integer.valueOf(i2));
                int i3 = (i2 / 12) + 1;
                textView.setTag(r68.m, Integer.valueOf(i3));
                if (i3 > 1) {
                    z = true;
                }
    ...
    public ClockFaceView(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, r78.f17766F, i, i78.o);
        Resources resources = getResources();
        ColorStateList b2 = j95.b(context, obtainStyledAttributes, r78.n0);
        this.f3443a = b2;
        LayoutInflater.from(context).inflate(u68.h, (ViewGroup) this, true);
        ClockHandView clockHandView = (ClockHandView) findViewById(r68.l);
        this.f3447a = clockHandView;
        this.b = resources.getDimensionPixelSize(b68.h);
        ...
        int defaultColor = yh.a(context, x58.b).getDefaultColor();
        ColorStateList b3 = j95.b(context, obtainStyledAttributes, r78.m0);
        ...
        Arrays.fill(strArr, "");
        w(strArr, 0);
        this.c = resources.getDimensionPixelSize(b68.u);
        this.d = resources.getDimensionPixelSize(b68.v);
        this.e = resources.getDimensionPixelSize(b68.j);
    }
}
