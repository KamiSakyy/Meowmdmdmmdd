...
public class TimePickerView extends ConstraintLayout {
    ...
    public class a implements View.OnClickListener {
        ...
        public void onClick(View view) {
            if (TimePickerView.this.f3473a != null) {
                TimePickerView.this.f3473a.a(((Integer) view.getTag(r68.J)).intValue());
            }
        }
    }
    ...
    public final void k() {
        this.f3468a.setTag(r68.J, 12);
        this.b.setTag(r68.J, 10);
    ...
    public TimePickerView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.a = new a();
        LayoutInflater.from(context).inflate(u68.l, this);
        this.f3469a = (ClockFaceView) findViewById(r68.k);
        MaterialButtonToggleGroup materialButtonToggleGroup = (MaterialButtonToggleGroup) findViewById(r68.o);
        ...
        this.f3468a = (Chip) findViewById(r68.r);
        this.b = (Chip) findViewById(r68.p);
        this.f3470a = (ClockHandView) findViewById(r68.l);
        l();
        k();
    }
}
