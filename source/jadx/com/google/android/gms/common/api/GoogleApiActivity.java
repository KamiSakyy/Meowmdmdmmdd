        ...
        if (pendingIntent == null && num == null) {
            ...
            try {
                ...
                if (extras.getBoolean("notify_manager", true)) {
                    sj3.y(this).J(new et1(22, null), getIntent().getIntExtra("failing_client_id", -1));
                } else {
            ...
            pj3.p().q(this, ((Integer) lm7.k(num)).intValue(), 2, this);
            this.a = 1;
        }
    }
    ...
    public final void onActivityResult(int i, int i2, Intent intent) {
        ...
        if (i == 1) {
            ...
            if (booleanExtra) {
                ...
                if (i2 != -1) {
                    if (i2 == 0) {
                        y.J(new et1(13, null), getIntent().getIntExtra("failing_client_id", -1));
                    }
                } else {
                    y.b();
                }
