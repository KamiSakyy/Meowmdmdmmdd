...
public abstract class SimpleClickListener implements RecyclerView.s {
        ...
        */
        public void onLongPress(android.view.MotionEvent r10) {
            ...
            L9:
                ...
                androidx.recyclerview.widget.RecyclerView$d0 r0 = r0.m0(r2)
        ...
        public boolean onSingleTapUp(MotionEvent motionEvent) {
            if (SimpleClickListener.this.mIsPrepressed && SimpleClickListener.this.mPressedView != null) {
                ...
                BaseViewHolder baseViewHolder = (BaseViewHolder) this.recyclerView.m0(view);
                ...
                if (childClickViewIds != null && childClickViewIds.size() > 0) {
                    for (Integer num : childClickViewIds) {
                        ...
                        if (findViewById != null) {
                            if (SimpleClickListener.this.inRangeOfView(findViewById, motionEvent) && findViewById.isEnabled()) {
                                ...
                                simpleClickListener.onItemChildClick(simpleClickListener.baseQuickAdapter, findViewById, baseViewHolder.getLayoutPosition() - SimpleClickListener.this.baseQuickAdapter.getHeaderLayoutCount());
                    ...
                    simpleClickListener2.onItemClick(simpleClickListener2.baseQuickAdapter, view, baseViewHolder.getLayoutPosition() - SimpleClickListener.this.baseQuickAdapter.getHeaderLayoutCount());
                } else {
                    SimpleClickListener.this.setPressViewHotSpot(motionEvent, view);
                    SimpleClickListener.this.mPressedView.setPressed(true);
                    if (childClickViewIds != null && childClickViewIds.size() > 0) {
    ...
    public boolean onInterceptTouchEvent(RecyclerView recyclerView, MotionEvent motionEvent) {
        ...
        if (recyclerView2 == null) {
            this.recyclerView = recyclerView;
            this.baseQuickAdapter = (BaseQuickAdapter) recyclerView.getAdapter();
            this.mGestureDetector = new ei3(this.recyclerView.getContext(), new ItemTouchHelperGestureListener(this.recyclerView));
        ...
        if (!this.mGestureDetector.a(motionEvent) && motionEvent.getActionMasked() == 1 && this.mIsShowPress) {
            ...
            if (view != null && ((baseViewHolder = (BaseViewHolder) this.recyclerView.m0(view)) == null || !isHeaderOrFooterView(baseViewHolder.getItemViewType()))) {
