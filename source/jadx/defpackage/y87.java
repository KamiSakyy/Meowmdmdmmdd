...
public class y87 extends FrameLayout {
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        if (wVar != null && wVar.f12387d) {
            accessibilityNodeInfo.setText(u.B0("AttachVideo", e78.Q8) + ", " + u.P(this.photoEntry.d));
        } else {
        ...
        accessibilityNodeInfo.addAction(new AccessibilityNodeInfo.AccessibilityAction(i68.q, u.B0("Open", e78.JP)));
    }
    ...
    */
    ...
    public void y(MediaController.z zVar, boolean z, boolean z2) {
        ...
        if (this.zoomOnSelect) {
            ...
            drawable = getResources().getDrawable(g68.uc);
        }
