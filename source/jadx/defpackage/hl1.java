...
public class hl1 extends FrameLayout {
    ...
    public hl1(Context context, l.r rVar) {
        ...
        for (int i = 0; i < 2; i++) {
            ...
            if (i == 0) {
                this.imageView[i].g(y68.Q2, 24, 24);
                this.textView[i].setText(u.B0("HintSent", e78.WA));
            } else {
                this.imageView[i].g(y68.P2, 24, 24);
                this.textView[i].setText(u.B0("HintRead", e78.VA));
            }
            this.imageView[i].e();
        }
        ImageView imageView = new ImageView(context);
        this.arrowImageView = imageView;
        imageView.setImageResource(g68.Bf);
