...
public class md1 extends LinearLayout {
    ...
    public md1(Context context, mq9 mq9Var, int i, int i2, tm9 tm9Var, l.r rVar) {
        ...
        f();
        if (i <= 0) {
            this.titleView.setText(u.B0("NoMessages", e78.ZK));
            this.descriptionView.setText(u.B0("NoMessagesGreetingsDescription", e78.bL));
        } else {
            this.titleView.setText(u.d0("NearbyPeopleGreetingsMessage", e78.GJ, mq9Var.f10558a, u.N(i, 1)));
            this.descriptionView.setText(u.B0("NearbyPeopleGreetingsDescription", e78.FJ));
        }
