...
public class zz1 extends FrameLayout implements h.d {
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        switch (this.documentAttachType) {
            case 1:
                sb.append(u.B0("AttachDocument", e78.p8));
                break;
            case 2:
                sb.append(u.B0("AttachGif", e78.r8));
                break;
            case 3:
                sb.append(u.B0("AttachAudio", e78.l8));
                break;
            case 4:
                sb.append(u.B0("AttachVideo", e78.Q8));
                break;
            case 5:
                sb.append(u.B0("AttachMusic", e78.J8));
                break;
            case 6:
                sb.append(u.B0("AttachSticker", e78.N8));
                break;
            case 7:
                sb.append(u.B0("AttachPhoto", e78.K8));
                break;
            case 8:
                sb.append(u.B0("AttachLocation", e78.A8));
                break;
        }
        ...
        if (this.documentAttachType == 5 && z && z2) {
            sb.append(", ");
            sb.append(u.d0("AccDescrMusicInfo", e78.r0, this.descriptionLayout.getText(), this.titleLayout.getText()));
        } else {
            if (z) {
                if (sb.length() > 0) {
                    sb.append(", ");
