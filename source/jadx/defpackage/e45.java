...
public class e45 extends f {
    ...
    public class b extends v1.s {
        ...
        public void onBindViewHolder(RecyclerView.d0 d0Var, int i) {
            ...
            if (itemViewType != 0) {
                if (itemViewType != 1) {
                    if (itemViewType != 3) {
                        if (itemViewType == 4) {
                            ...
                            if (i == e45.this.logoutSectionRow) {
                                bv9Var.setText(u.B0("LogOutInfo", e78.BG));
                                return;
                            }
                            return;
                        }
                    ...
                    if (i == e45.this.logoutRow) {
                        ...
                        uw9Var.c(u.B0("LogOutTitle", e78.CG), false);
                        return;
                    }
                    return;
                }
                ...
                if (i == e45.this.addAccountRow) {
                    xu9Var.b(u.B0("AddAnotherAccount", e78.q4), u.B0("AddAnotherAccountInfo", e78.r4), g68.q6, true);
                    return;
                } else if (i == e45.this.passcodeRow) {
                    xu9Var.b(u.B0("SetPasscode", e78.W70), u.B0("SetPasscodeInfo", e78.X70), g68.k9, true);
                    return;
                } else if (i == e45.this.cacheRow) {
                    xu9Var.b(u.B0("ClearCache", e78.Vj), u.B0("ClearCacheInfo", e78.Zj), g68.m6, true);
                    return;
                } else if (i == e45.this.phoneRow) {
                    xu9Var.b(u.B0("ChangePhoneNumber", e78.yf), u.B0("ChangePhoneNumberInfo", e78.zf), g68.V8, true);
                    return;
                } else if (i == e45.this.supportRow) {
                    xu9Var.b(u.B0("ContactSupport", e78.xl), u.B0("ContactSupportInfo", e78.yl), g68.F7, false);
                    return;
                } else {
                    return;
                }
            ...
            if (i == e45.this.alternativeHeaderRow) {
                nu3Var.setText(u.B0("AlternativeOptions", e78.V5));
            }
        }
                ...
                if (i != 1) {
                    if (i != 2) {
                        if (i != 3) {
                            ...
                            view.setBackgroundDrawable(l.u2(this.mContext, g68.f2, "windowBackgroundGrayShadow"));
                        } else {
    ...
    public static org.telegram.ui.ActionBar.e x2(Context context, final int i) {
        ...
        kVar.n(u.B0("AreYouSureLogout", e78.T7));
        kVar.x(u.B0("LogOut", e78.AG));
        kVar.v(u.B0("LogOut", e78.AG), new DialogInterface.OnClickListener() { // from class: d45
    ...
    public View W(Context context) {
        ...
        this.actionBar.setTitle(u.B0("LogOutTitle", e78.CG));
