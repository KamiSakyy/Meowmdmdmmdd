...
public abstract class ca5 extends FrameLayout {
    ...
    public class b implements c2.b {
        ...
        public void b(boolean z, float f) {
            ...
            if (f <= 0.25f) {
                ...
                if (f < 0.25f) {
                    ...
                    if (f <= 0.25f) {
                        ...
                        long j = i;
                        ca5.this.sizeTextView.setText(u.d0("AutodownloadSizeLimitUpTo", e78.mb, org.telegram.messenger.a.t0(j)));
            ...
            i = (int) (f2 + ((f / 0.25f) * f3));
            long j2 = i;
            ca5.this.sizeTextView.setText(u.d0("AutodownloadSizeLimitUpTo", e78.mb, org.telegram.messenger.a.t0(j2)));
    ...
    public void setSize(long j) {
        ...
        float f;
        this.currentSize = j;
        this.sizeTextView.setText(u.d0("AutodownloadSizeLimitUpTo", e78.mb, org.telegram.messenger.a.t0(j)));
        long j2 = j - 512000;
        if (j2 < 536576) {
