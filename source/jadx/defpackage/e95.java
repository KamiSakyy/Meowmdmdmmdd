...
public class e95 extends gg {
    ...
    public static final int b = i78.k;

    /* renamed from: b  reason: collision with other field name */
    public static final int[] f4738b = {u58.N};
    ...
    public e95(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, u58.d);
    }

    private String getButtonStateDescription() {
        int i = this.f4740a;
        if (i == 1) {
            return getResources().getString(c78.h);
        }
        if (i == 0) {
            return getResources().getString(c78.j);
        }
        return getResources().getString(c78.i);
    }
    ...
    private ColorStateList getMaterialThemeColorsTintList() {
        if (this.f4741a == null) {
            ...
            int d2 = g95.d(this, u58.f);
            int d3 = g95.d(this, u58.h);
            int d4 = g95.d(this, u58.l);
            int d5 = g95.d(this, u58.i);
    ...
    public final boolean c(p3a p3aVar) {
        int n = p3aVar.n(r78.t1, 0);
        int n2 = p3aVar.n(r78.u1, 0);
        if (n != c || n2 != 0) {
            return false;
        }
        return true;
    ...
    public final void g() {
        ...
        if (Build.VERSION.SDK_INT >= 24) {
            ...
            if ((drawable instanceof AnimatedStateListDrawable) && (weVar = this.f4748a) != null) {
                ((AnimatedStateListDrawable) drawable).addTransition(r68.b, r68.V, weVar, false);
                ((AnimatedStateListDrawable) this.f4743a).addTransition(r68.j, r68.V, this.f4748a, false);
            }
        }
    }
