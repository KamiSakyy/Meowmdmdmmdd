...
public class t44 extends org.telegram.ui.ActionBar.f implements a0.d {
            ...
            if (!this.egl10.eglChooseConfig(this.eglDisplay, iArr, eGLConfigArr, 1, iArr2)) {
                ...
                if (surfaceTexture instanceof SurfaceTexture) {
                    ...
                    if (eglCreateWindowSurface != null && eglCreateWindowSurface != EGL10.EGL_NO_SURFACE) {
                        ...
                        I(g68.Y3, 15);
                        I(g68.X3, 16);
                        J(g68.Z3, 17, org.telegram.ui.ActionBar.l.B1("windowBackgroundWhite"), false);
                        I(g68.a4, 18);
                        I(g68.b4, 19);
                        I(g68.c4, 20);
                        I(g68.a, 21);
    ...
    public /* synthetic */ void Q2(e88 e88Var, View view) {
        ...
        e88Var.setContentDescription(u.z0(e78.j1));
    }
    ...
    public /* synthetic */ void U2() {
        this.eglThread.J(g68.Z3, 17, org.telegram.ui.ActionBar.l.B1("windowBackgroundWhite"), true);
        this.eglThread.O();
    ...
    public View W(Context context) {
        ...
        dVar.setText(u.B0("StartMessaging", e78.Xa0));
    ...
    public boolean k1() {
        ...
        this.titles = new String[]{"MDGram", u.B0("Page2Title", e78.AQ), u.B0("Page3Title", e78.CQ), u.B0("Page5Title", e78.GQ), u.B0("Page4Title", e78.EQ), u.B0("Page6Title", e78.IQ)};
        this.messages = new String[]{u.B0("Page1Message", e78.yQ), u.B0("Page2Message", e78.zQ), u.B0("Page3Message", e78.BQ), u.B0("Page5Message", e78.FQ), u.B0("Page4Message", e78.DQ), u.B0("Page6Message", e78.HQ)};
        return true;
    }
