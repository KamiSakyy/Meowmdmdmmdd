...
public class oh1 extends f implements a0.d {
    ...
    public class b extends RecyclerView.g {
        ...
        public void onBindViewHolder(RecyclerView.d0 d0Var, int i) {
            ...
            if (itemViewType != 0) {
                ...
                nu3Var.setText(u.B0("OnlyAllowThisReactions", e78.FP));
            ...
            if (oh1Var.isChannel) {
                if (d.O(oh1Var.currentChat)) {
                    B0 = u.B0("EnableReactionsChannelInfo", e78.Js);
                } else {
                    B0 = u.B0("EnableReactionsGroupInfo", e78.Ks);
                }
                bv9Var.setText(B0);
                return;
            }
            ...
            if (i3 == 1) {
                bv9Var.setText(u.B0("EnableSomeReactionsInfo", e78.Ls));
            } else if (i3 == 0) {
                bv9Var.setText(u.B0("EnableAllReactionsInfo", e78.Cs));
            } else if (i3 == 2) {
                bv9Var.setText(u.B0("DisableReactionsInfo", e78.Fp));
            }
        }
    ...
    public View W(Context context) {
        ...
        this.actionBar.setTitle(u.B0("Reactions", e78.f10));
        ...
        if (this.isChannel) {
            ...
            ru9Var.setHeight(56);
            this.enableReactionsCell.i(u.B0("EnableReactions", e78.Is), !this.chatReactions.isEmpty(), false);
