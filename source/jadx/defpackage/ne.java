...
public class ne extends eb9 implements l3a {
    ...
    public void m(Context context, Resources resources, XmlPullParser xmlPullParser, AttributeSet attributeSet, Resources.Theme theme) {
        ...
        setVisible(k.getBoolean(s78.b, true), true);
        s(k);
        i(resources);
        k.recycle();
    ...
    public final int p(Context context, Resources resources, XmlPullParser xmlPullParser, AttributeSet attributeSet, Resources.Theme theme) {
        ...
        int resourceId = k.getResourceId(s78.g, 0);
        int resourceId2 = k.getResourceId(s78.h, -1);
        if (resourceId2 > 0) {
    ...
    public final int q(Context context, Resources resources, XmlPullParser xmlPullParser, AttributeSet attributeSet, Resources.Theme theme) {
        ...
        int resourceId = k.getResourceId(s78.k, -1);
        int resourceId2 = k.getResourceId(s78.j, -1);
        int resourceId3 = k.getResourceId(s78.i, -1);
        if (resourceId3 > 0) {
            drawable = jf8.h().j(context, resourceId3);
        } else {
            drawable = null;
        }
        boolean z = k.getBoolean(s78.l, false);
        k.recycle();
        if (drawable == null) {
            do {
                next = xmlPullParser.next();
    ...
    public final void s(TypedArray typedArray) {
        ...
        cVar.x(typedArray.getBoolean(s78.c, ((fk2.d) cVar).f5557a));
        cVar.t(typedArray.getBoolean(s78.d, ((fk2.d) cVar).f5560c));
        cVar.u(typedArray.getInt(s78.e, ((fk2.d) cVar).k));
        cVar.v(typedArray.getInt(s78.f, ((fk2.d) cVar).l));
        setDither(typedArray.getBoolean(s78.a, ((fk2.d) cVar).f5567j));
    }
