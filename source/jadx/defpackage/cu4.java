    ...
    public final void N() {
        ...
        if (tr8Var != null) {
            ...
            if (this.locationType != 4 && this.customLocation == null) {
                if (this.gpsLocation != null) {
                    tr8Var.f(u.B0("SendLocation", e78.Q60), u.d0("AccurateTo", e78.T1, u.U("Meters", (int) this.gpsLocation.getAccuracy(), new Object[0])));
                    this.sendLocationCell.setHasLocation(true);
                    return;
                }
                String B0 = u.B0("SendLocation", e78.Q60);
                if (!this.myLocationDenied) {
                    str = u.B0("Loading", e78.aG);
                }
                tr8Var.f(B0, str);
            ...
            if (this.locationType == 4) {
                this.sendLocationCell.f(u.B0("ChatSetThisLocation", e78.Ai), str);
            } else {
                this.sendLocationCell.f(u.B0("SendSelectedLocation", e78.a70), str);
            }
            this.sendLocationCell.setHasLocation(true);
        }
    }
    ...
    public void onBindViewHolder(RecyclerView.d0 d0Var, int i) {
        ...
        if (itemViewType != 0) {
            ...
            if (itemViewType != 1) {
                ...
                if (this.currentMessageObject != null) {
                    nu3Var.setText(u.B0("LiveLocations", e78.ZF));
                    return;
                } else {
                    nu3Var.setText(u.B0("NearbyVenue", e78.IJ));
                    return;
                }
            }
    ...
    public RecyclerView.d0 onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        switch (i) {
            ...
            case 9:
                ...
                nq1 nq1Var = new nq1(new ColorDrawable(C("windowBackgroundGray")), l.u2(this.mContext, g68.g2, "windowBackgroundGrayShadow"));
                nq1Var.e(true);
