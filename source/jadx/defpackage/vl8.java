...
public abstract class vl8 extends IntentService {
    ...
    public final void b() {
        ...
        NotificationChannel notificationChannel = new NotificationChannel("Assistant_verifier", getApplicationContext().getResources().getString(d78.a), 2);
    ...
    */
    ...
    public void k() {
        b();
        startForeground(10000, new mk6.f(getApplicationContext(), "Assistant_verifier").u("Assistant_verifier").q(getApplicationContext().getResources().getString(d78.b)).F(17301545).B(-2).N(1).d());
    }
