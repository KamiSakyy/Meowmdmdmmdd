...
public class i50 extends LinearLayout implements a0.d {
    ...
    public class e extends FrameLayout {
        ...
        public e(Context context, int i, String str, int i2, boolean z, View.OnTouchListener onTouchListener, View.OnClickListener onClickListener, View.OnLongClickListener onLongClickListener) {
            ...
            View inflate = LayoutInflater.from(context).inflate(v68.b, (ViewGroup) null);
            this.a = i;
            this.f7270a = z;
            TextView textView = (TextView) inflate.findViewById(i68.K1);
            this.f7268a = textView;
            this.f7267a = (ImageView) inflate.findViewById(i68.X);
            ...
            TextView textView2 = (TextView) inflate.findViewById(i68.O);
    ...
    public void h() {
        ...
        while (i2 < 4) {
            e eVar = (e) getChildAt(i2);
            if (i2 == 0) {
                eVar.f7268a.setText(u.B0("Contacts", e78.zl));
                if (MDConfig.ismdBottomBarIos) {
                    i = g68.pf;
                } else if (z) {
                    i = g68.qf;
                ...
                eVar.f7268a.setText(u.B0("Calls", e78.He));
                if (MDConfig.ismdBottomBarIos) {
                    i = g68.jf;
                } else if (z) {
                    i = g68.kf;
                ...
                eVar.f7268a.setText(u.B0("Chats_md", e78.fj));
                if (MDConfig.ismdBottomBarIos) {
                    i = g68.mf;
                } else {
                    i = g68.nf;
                ...
                eVar.f7268a.setText(u.B0("Settings", e78.u80));
                if (MDConfig.ismdBottomBarIos) {
                    i = g68.uf;
                } else if (z) {
                    i = g68.sf;
