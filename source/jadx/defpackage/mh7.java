    ...
    public class d {
        ...
        public /* synthetic */ void g(int i) {
            ...
            if (i != 2) {
                if (i != 5) {
                    if (i != 150) {
                        if (i != 100) {
                            ...
                            mh7.this.errorMessage.setText(u.z0(e78.lq0));
                            return;
                        }
                    }
                    mh7.this.errorMessage.setText(u.z0(e78.kq0));
                    mh7.this.errorButton.setText(u.z0(e78.mq0));
                ...
                mh7.this.errorMessage.setText(u.z0(e78.iq0));
                return;
            }
            mh7.this.errorMessage.setText(u.z0(e78.jq0));
        }
