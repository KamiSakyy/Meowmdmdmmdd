...
public class x1a extends org.telegram.ui.ActionBar.f implements a0.d {
    ...
    public class c implements TextWatcher {
        ...
        public void afterTextChanged(Editable editable) {
            ...
            if (x1a.this.linkField.length() > 0) {
                ...
                String d0 = u.d0("ThemeHelpLink", e78.Fe0, str);
    ...
    public /* synthetic */ void F2(String str, TLRPC$TL_error tLRPC$TL_error) {
        ...
        if (str2 != null && str2.equals(str)) {
            if (tLRPC$TL_error != null && ("THEME_SLUG_INVALID".equals(tLRPC$TL_error.f14225a) || "THEME_SLUG_OCCUPIED".equals(tLRPC$TL_error.f14225a))) {
                U2(u.B0("SetUrlInUse", e78.k80), "windowBackgroundWhiteRedText4");
                this.lastNameAvailable = false;
                return;
            }
            U2(u.d0("SetUrlAvailable", e78.i80, str), "windowBackgroundWhiteGreenText");
    ...
    public /* synthetic */ void L2(View view, boolean z) {
        if (z) {
            this.helpInfoCell.setText(org.telegram.messenger.a.b3(u.B0("ThemeCreateHelp2", e78.Ce0)));
        } else {
            this.helpInfoCell.setText(org.telegram.messenger.a.b3(u.B0("ThemeCreateHelp", e78.Be0)));
        }
    }
    ...
    public /* synthetic */ void N2(Context context, View view) {
        ...
        textView.setText(u.B0("ChooseTheme", e78.Nj));
    ...
    public final boolean E2(final String str, boolean z) {
            ...
            if (!str.startsWith("_") && !str.endsWith("_")) {
                for (int i = 0; i < str.length(); i++) {
                    ...
                    if (i == 0 && charAt >= '0' && charAt <= '9') {
                        if (z) {
                            org.telegram.ui.Components.b.V5(this, u.B0("Theme", e78.we0), u.B0("SetUrlInvalidStartNumber", e78.o80));
                        } else {
                            U2(u.B0("SetUrlInvalidStartNumber", e78.o80), "windowBackgroundWhiteRedText4");
                        }
                        return false;
                    } else if ((charAt < '0' || charAt > '9') && ((charAt < 'a' || charAt > 'z') && ((charAt < 'A' || charAt > 'Z') && charAt != '_'))) {
                        if (z) {
                            org.telegram.ui.Components.b.V5(this, u.B0("Theme", e78.we0), u.B0("SetUrlInvalid", e78.l80));
                        } else {
                            U2(u.B0("SetUrlInvalid", e78.l80), "windowBackgroundWhiteRedText4");
                        }
                        return false;
                    }
                }
        ...
        if (str != null && str.length() >= 5) {
            if (str.length() > 64) {
                if (z) {
                    org.telegram.ui.Components.b.V5(this, u.B0("Theme", e78.we0), u.B0("SetUrlInvalidLong", e78.m80));
                } else {
                    U2(u.B0("SetUrlInvalidLong", e78.m80), "windowBackgroundWhiteRedText4");
                }
                return false;
            }
            if (!z) {
                ...
                U2(u.B0("SetUrlChecking", e78.j80), "windowBackgroundWhiteGrayText8");
        ...
        if (z) {
            org.telegram.ui.Components.b.V5(this, u.B0("Theme", e78.we0), u.B0("SetUrlInvalidShort", e78.n80));
        } else {
            U2(u.B0("SetUrlInvalidShort", e78.n80), "windowBackgroundWhiteRedText4");
        }
        return false;
    }
    ...
    public final void T2() {
        ...
        if (this.nameField.length() == 0) {
            org.telegram.ui.Components.b.V5(this, u.B0("Theme", e78.we0), u.B0("ThemeNameInvalid", e78.Ge0));
    ...
    public final void U2(String str, String str2) {
        if (TextUtils.isEmpty(str)) {
            ...
            if (this.creatingNewTheme) {
                this.helpInfoCell.setBackgroundDrawable(l.u2(E0(), g68.f2, "windowBackgroundGrayShadow"));
                return;
            } else {
                this.helpInfoCell.setBackgroundDrawable(l.u2(E0(), g68.g2, "windowBackgroundGrayShadow"));
                return;
            }
        }
        ...
        if (this.creatingNewTheme) {
            this.helpInfoCell.setBackgroundDrawable(l.u2(E0(), g68.h2, "windowBackgroundGrayShadow"));
        } else {
    ...
    public View W(final Context context) {
        ...
        if (this.creatingNewTheme) {
            this.actionBar.setTitle(u.B0("NewThemeTitle", e78.rK));
        } else {
            this.actionBar.setTitle(u.B0("EditThemeTitle", e78.Qr));
        }
        this.actionBar.setActionBarMenuOnItemClick(new a());
        this.doneButton = this.actionBar.x().h(1, u.B0("Done", e78.vq).toUpperCase());
        LinearLayout linearLayout = new LinearLayout(context);
        ...
        nu3Var.setText(u.B0("Info", e78.uC));
        ...
        this.nameField.setHint(u.B0("ThemeNamePlaceholder", e78.He0));
        ...
        this.linkField.setHint(u.B0("SetUrlPlaceholder", e78.p80));
        ...
        if (this.creatingNewTheme) {
            ...
            SpannableStringBuilder b3 = org.telegram.messenger.a.b3(u.B0("ThemeSetUrlHelp", e78.nf0));
            this.infoText = b3;
            bv9Var3.setText(b3);
        }
        linearLayout2.addView(this.helpInfoCell, cn4.g(-1, -2));
        if (this.creatingNewTheme) {
            this.helpInfoCell.setBackgroundDrawable(l.u2(context, g68.f2, "windowBackgroundGrayShadow"));
            ...
            this.createCell.c(u.B0("UseDifferentTheme", e78.hi0), false);
            ...
            bv9Var4.setText(org.telegram.messenger.a.b3(u.B0("UseDifferentThemeInfo", e78.ii0)));
            this.createInfoCell.setBackgroundDrawable(l.u2(context, g68.g2, "windowBackgroundGrayShadow"));
            linearLayout2.addView(this.createInfoCell, cn4.g(-1, -2));
        } else {
            this.helpInfoCell.setBackgroundDrawable(l.u2(context, g68.g2, "windowBackgroundGrayShadow"));
        }
        TLRPC$TL_theme tLRPC$TL_theme = this.info;
