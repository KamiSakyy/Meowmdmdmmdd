...
public final class e0c implements kq6 {
    public static final e0c a = new e0c();

    /* renamed from: a  reason: collision with other field name */
    public static final s03 f4581a;
    ...
    static {
        ...
        dlb dlbVar = new dlb();
        dlbVar.a(1);
        f4581a = a2.b(dlbVar.b()).a();
        s03.b a3 = s03.a("options");
        dlb dlbVar2 = new dlb();
        dlbVar2.a(2);
        b = a3.b(dlbVar2.b()).a();
        s03.b a4 = s03.a("modelInitializationMs");
        dlb dlbVar3 = new dlb();
        dlbVar3.a(3);
        c = a4.b(dlbVar3.b()).a();
        s03.b a5 = s03.a("confidenceThreshold");
        dlb dlbVar4 = new dlb();
        dlbVar4.a(4);
        d = a5.b(dlbVar4.b()).a();
