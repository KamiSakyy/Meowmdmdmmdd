        ...
        if (itemViewType != 0) {
            if (itemViewType != 1) {
                if (itemViewType == 2) {
                    ...
                    if (i5 == 0) {
                        fl3Var.setText(u.B0("Contacts", e78.zl));
                        return;
                    } else if (i5 == 1) {
                        fl3Var.setText(u.B0("SortedByName", e78.ra0));
                        return;
                    } else {
                        fl3Var.setText(u.B0("SortedByLastSeen", e78.qa0));
                        return;
                    }
                }
                return;
            ...
            if (i == 0) {
                if (this.needPhonebook) {
                    if (i2 == 0) {
                        pu9Var.i(u.B0("InviteFriends", e78.QC), g68.O7, false);
                        return;
                    } else if (i2 == 1) {
                        pu9Var.i(u.B0("AddPeopleNearby", e78.W4), g68.g8, false);
                        return;
                    } else {
                        return;
                    }
                    ...
                    if (this.isChannel) {
                        pu9Var.i(u.B0("ChannelInviteViaLink", e78.vg), g68.c8, false);
                        return;
                    } else {
                        pu9Var.i(u.B0("InviteToGroupByLink", e78.XC), g68.c8, false);
                        return;
                    }
                } else if (i2 == 0) {
                    pu9Var.i(u.B0("NewGroup", e78.dK), g68.x7, false);
                    return;
                } else if (i2 == 1) {
                    pu9Var.i(u.B0("NewSecretChat", e78.kK), g68.Ka, false);
                    return;
                } else if (i2 == 2) {
                    pu9Var.i(u.B0("NewChannel", e78.UJ), g68.c6, false);
                    return;
                } else {
                    return;
                }
