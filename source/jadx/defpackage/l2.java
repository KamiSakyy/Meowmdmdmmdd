...
public class l2 {
    ...
    public void e(CharSequence charSequence, View view) {
        if (Build.VERSION.SDK_INT < 26) {
            ...
            if (p != null && p.length > 0) {
                s().putInt("androidx.view.accessibility.AccessibilityNodeInfoCompat.SPANS_ACTION_ID_KEY", k68.a);
    ...
    public final SparseArray v(View view) {
        return (SparseArray) view.getTag(k68.I);
    }
