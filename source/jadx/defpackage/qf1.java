...
public class qf1 extends fw implements b2.a, ImageReceiver.c, h.d, dw9.p, a0.d {
    ...
    public class p extends AccessibilityNodeProvider {
        ...
        public AccessibilityNodeInfo createAccessibilityNodeInfo(int i) {
            ...
            if (i == -1) {
                ...
                if (qf1.this.accessibilityText == null) {
                    ...
                    if (qf1.this.documentAttach != null && ((qf1.this.documentAttachType == 1 || qf1.this.documentAttachType == 2 || qf1.this.documentAttachType == 4) && qf1.this.buttonState == 1 && qf1.this.loadingProgressLayout != null)) {
                        ...
                        spannableStringBuilder.append((CharSequence) u.d0(t3 ? "AccDescrUploadProgress" : "AccDescrDownloadProgress", t3 ? e78.n1 : e78.S, org.telegram.messenger.a.t0(qf1.this.currentMessageObject.f13418g), org.telegram.messenger.a.t0(qf1.this.lastLoadingSizeTotal)));
                    }
                    if (qf1.this.currentMessageObject.P2()) {
                        spannableStringBuilder.append((CharSequence) "\n");
                        spannableStringBuilder.append((CharSequence) u.d0("AccDescrMusicInfo", e78.r0, qf1.this.currentMessageObject.S0(), qf1.this.currentMessageObject.U0()));
                        spannableStringBuilder.append((CharSequence) ", ");
                        ...
                        if (qf1.this.currentMessageObject.c2()) {
                            spannableStringBuilder.append((CharSequence) u.B0("AccDescrMsgNotPlayed", e78.l0));
                        } else {
                            spannableStringBuilder.append((CharSequence) u.B0("AccDescrMsgPlayed", e78.m0));
                        }
                    }
                    if (qf1.this.lastPoll != null) {
                        ...
                        if (qf1.this.pollClosed) {
                            B02 = u.B0("FinalResults", e78.Ox);
                        } else if (qf1.this.lastPoll.d) {
                            if (qf1.this.lastPoll.f10540b) {
                                B02 = u.B0("QuizPoll", e78.N00);
                            } else {
                                B02 = u.B0("AnonymousQuizPoll", e78.e6);
                            }
                        } else if (qf1.this.lastPoll.f10540b) {
                            B02 = u.B0("PublicPoll", e78.RZ);
                        } else {
                            B02 = u.B0("AnonymousPoll", e78.d6);
                        }
                    ...
                    if (qf1.this.currentMessageObject.W2()) {
                        if (qf1.this.currentMessageObject.u3()) {
                            ...
                            if (qf1.this.currentMessageObject.H) {
                                spannableStringBuilder.append((CharSequence) u.d0("AccDescrScheduledDate", e78.V0, qf1.this.currentTimeString));
                            } else {
                                spannableStringBuilder.append((CharSequence) u.d0("AccDescrSentDate", e78.c1, u.B0("TodayAt", e78.xf0) + " " + ((Object) qf1.this.currentTimeString)));
                                spannableStringBuilder.append((CharSequence) ", ");
                            ...
                            spannableStringBuilder.append((CharSequence) "\n");
                            spannableStringBuilder.append((CharSequence) u.B0("AccDescrMsgSending", e78.o0));
                            ...
                            spannableStringBuilder.append((CharSequence) "\n");
                            spannableStringBuilder.append((CharSequence) u.B0("AccDescrMsgSendingError", e78.p0));
                        }
                    } else {
                        spannableStringBuilder.append((CharSequence) "\n");
                        spannableStringBuilder.append((CharSequence) u.d0("AccDescrReceivedDate", e78.P0, u.B0("TodayAt", e78.xf0) + " " + ((Object) qf1.this.currentTimeString)));
                    }
                    ...
                    if (qf1.this.currentMessageObject.f13365a.f9691a != null && ((so9) qf1.this.currentMessageObject.f13365a.f9691a).f18947a != null) {
                        ...
                        if (((so9) qf1.this.currentMessageObject.f13365a.f9691a).f18947a.size() == 1) {
                            ...
                            if (i6 == 1) {
                                ...
                                if (z) {
                                    spannableStringBuilder.append((CharSequence) u.d0("AccDescrYouReactedWith", e78.B1, str5));
                                } else {
                                    spannableStringBuilder.append((CharSequence) u.d0("AccDescrReactedWith", e78.N0, str4, str5));
                                }
                            } else if (i6 > 1) {
                                spannableStringBuilder.append((CharSequence) "\n");
                            ...
                            spannableStringBuilder.append((CharSequence) u.B0("Reactions", e78.f10)).append((CharSequence) ": ");
                ...
                obtain.addAction(new AccessibilityNodeInfo.AccessibilityAction(i68.o, u.B0("AccActionMessageOptions", e78.o)));
                int iconForCurrentState = qf1.this.getIconForCurrentState();
                if (iconForCurrentState == 0) {
                    B0 = u.B0("AccActionPlay", e78.t);
                } else if (iconForCurrentState == 1) {
                    B0 = u.B0("AccActionPause", e78.s);
                } else if (iconForCurrentState == 2) {
                    B0 = u.B0("AccActionDownload", e78.m);
                } else if (iconForCurrentState == 3) {
                    B0 = u.B0("AccActionCancelDownload", e78.j);
                } else if (iconForCurrentState != 5) {
                    B0 = qf1.this.currentMessageObject.f13381b == 16 ? u.B0("CallAgain", e78.ee) : null;
                } else {
                    B0 = u.B0("AccActionOpenFile", e78.p);
                }
                obtain.addAction(new AccessibilityNodeInfo.AccessibilityAction(16, B0));
                obtain.addAction(new AccessibilityNodeInfo.AccessibilityAction(32, u.B0("AccActionEnterSelectionMode", e78.n)));
                if (qf1.this.getMiniIconForCurrentState() == 2) {
                    obtain.addAction(new AccessibilityNodeInfo.AccessibilityAction(i68.r, u.B0("AccActionDownload", e78.m)));
                }
                ...
                if (qf1.this.forwardedNameLayout[0] != null && qf1.this.forwardedNameLayout[1] != null) {
                    obtain.addAction(new AccessibilityNodeInfo.AccessibilityAction(i68.p, u.B0("AccActionOpenForwardedOrigin", e78.q)));
                }
            ...
            if (i == 5000) {
                ...
                obtain2.setClassName("android.widget.Button");
                obtain2.setEnabled(true);
                obtain2.setText(u.B0("AccDescrQuizExplanation", e78.L0));
                obtain2.addAction(16);
                ...
                if (qf1Var4.e4(qf1Var4.currentMessageObject)) {
                    obtain2.setContentDescription(u.B0("AccDescrOpenChat", e78.t0));
                } else {
                    obtain2.setContentDescription(u.B0("ShareFile", e78.J80));
                }
                obtain2.addAction(16);
                ...
                if (qf1.this.currentMessageObject != null && !qf1.this.currentMessageObject.G4() && !qf1.this.currentMessageObject.U1()) {
                    if (qf1.this.isRepliesChat) {
                        Y = u.B0("ViewInChat", e78.Ck0);
                    } else {
                        Y = repliesCount == 0 ? u.B0("LeaveAComment", e78.BE) : u.U("CommentsCount", repliesCount, new Object[0]);
                    }
                } else {
    ...
    private Object getAuthorStatus() {
        ...
        if (mq9Var != null) {
            ...
            if (mq9Var2.p) {
                return sz1.e(org.telegram.messenger.b.f12514a, g68.J9).mutate();
            }
            return null;
        }
        return null;
    ...
    */
    ...
    public final int D2(int i2, x xVar) {
        ...
        if (x.R3(tm9Var)) {
            ...
            if (!xVar.l4()) {
                String B0 = u.B0("AttachGif", e78.r8);
    ...
    public final void E2() {
        ...
        if (this.drawInstantView && this.instantViewLayout == null) {
            ...
            if (i3 == 12) {
                B0 = u.B0("OpenChannelPost", e78.PP);
            } else if (i3 == 1) {
                B0 = u.B0("OpenChannel", e78.NP);
            } else if (i3 == 13) {
                B0 = u.B0("SendMessage", e78.R60).toUpperCase();
            } else if (i3 == 10) {
                B0 = u.B0("OpenBot", e78.MP);
            } else if (i3 == 2) {
                B0 = u.B0("OpenGroup", e78.SP);
            } else if (i3 == 3) {
                B0 = u.B0("OpenMessage", e78.XP);
            } else if (i3 == 5) {
                B0 = u.B0("ViewContact", e78.yk0);
            } else if (i3 == 6) {
                B0 = u.B0("OpenBackground", e78.LP);
            } else if (i3 == 7) {
                B0 = u.B0("OpenTheme", e78.ZP);
            } else if (i3 == 8) {
                if (!this.pollVoted && !this.pollClosed) {
                    B0 = u.B0("PollSubmitVotes", e78.fX);
                } else {
                    B0 = u.B0("PollViewResults", e78.hX);
                }
            } else if (i3 != 9 && i3 != 11) {
                B0 = u.B0("InstantView", e78.xC);
            } else {
                ...
                if (tLRPC$TL_webPage != null && ((vq9) tLRPC$TL_webPage).f21111a.contains("voicechat=")) {
                    B0 = u.B0("VoipGroupJoinAsSpeaker", e78.Zm0);
                } else {
                    B0 = u.B0("VoipGroupJoinAsLinstener", e78.Ym0);
                }
            }
    ...
    public final boolean f2(MotionEvent motionEvent) {
        ...
        if (motionEvent.getAction() == 0) {
            ...
            if (this.currentMessageObject.H) {
                Toast.makeText(getContext(), u.B0("MessageScheduledBotAction", e78.CI), 1).show();
            ...
            if (this.instantPressed) {
                ...
                if (nVar != null) {
                    if (this.lastPoll != null) {
                        x xVar = this.currentMessageObject;
                        if (xVar.H) {
                            Toast.makeText(getContext(), u.B0("MessageScheduledVoteResults", e78.II), 1).show();
    ...
    public final void n2() {
        ...
        if (xVar != null && (U3 = U3(xVar)) != this.locationExpired) {
            ...
            if (!U3) {
                ...
                this.docTitleLayout = new StaticLayout(TextUtils.ellipsize(u.B0("AttachLiveLocation", e78.w8), org.telegram.ui.ActionBar.l.f15982x, e0, TextUtils.TruncateAt.END), org.telegram.ui.ActionBar.l.f15982x, e0, Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
                return;
            }
            x xVar2 = this.currentMessageObject;
    ...
    */
    ...
    public void p3(Canvas canvas, ImageReceiver imageReceiver, int i2) {
        ...
        mq9 mq9Var2 = this.currentUser;
        if (mq9Var2 != null && !mq9Var2.f10571e && str.equals(u.B0("Online", e78.EP))) {
            canvas.save();
            Path path = new Path();
    ...
    public boolean performAccessibilityAction(int i2, Bundle bundle) {
        ...
        } else if (i2 == i68.p && (nVar = this.delegate) != null) {
    ...
    public final boolean s2(MotionEvent motionEvent) {
        ...
        if (motionEvent.getAction() == 0) {
            ...
            if (this.pollHintPressed) {
                ...
                if (this.currentMessageObject.H) {
                    Toast.makeText(getContext(), u.B0("MessageScheduledVote", e78.HI), 1).show();
                } else {
    ...
    */
    ...
    public final String x3(x xVar) {
        if (this.hasPsaHint) {
            ...
            if (A0 == null) {
                return u.B0("PsaMessageDefault", e78.KZ);
            }
            return A0;
        }
        return u.B0("ForwardedMessage", e78.Ny);
    }
