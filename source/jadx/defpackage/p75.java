        ...
        public /* synthetic */ void i(ArrayList arrayList, DialogInterface dialogInterface, int i) {
            ...
            if (intValue != 0) {
                    ...
                    if (intValue != 2) {
                        if (intValue != 3) {
                            if (intValue == 4) {
                                ...
                                kVar.x(u.B0("DeleteLink", e78.wo));
                                kVar.n(u.B0("DeleteLinkHelp", e78.xo));
                                kVar.v(u.B0("Delete", e78.Kn), new DialogInterface.OnClickListener() { // from class: v75
                        ...
                        kVar2.n(u.B0("RevokeAlert", e78.n40));
                        kVar2.x(u.B0("RevokeLink", e78.q40));
                        kVar2.v(u.B0("RevokeButton", e78.p40), new DialogInterface.OnClickListener() { // from class: u75
                            @Override // android.content.DialogInterface.OnClickListener
                            public final void onClick(DialogInterface dialogInterface2, int i2) {
                ...
                try {
                    ...
                    p75.this.i2(Intent.createChooser(intent, u.B0("InviteToGroupByLink", e78.XC)), Constants.DEFAULT_WRITE_DELAY);
                    return;
                } catch (Exception e) {
        ...
        */
        ...
        public void k(TLRPC$TL_chatInviteExported tLRPC$TL_chatInviteExported, int i) {
            ...
            if (i4 == 0 && tLRPC$TL_chatInviteExported.e == 0 && tLRPC$TL_chatInviteExported.g == 0) {
                str = u.B0("NoOneJoinedYet", e78.dL);
            } else {
            ...
            if (tLRPC$TL_chatInviteExported.f14130b && !tLRPC$TL_chatInviteExported.f14128a) {
                ...
                spannableStringBuilder2.append((CharSequence) u.B0("Permanent", e78.wV));
                ...
                if (!z && (i3 = tLRPC$TL_chatInviteExported.e) > 0 && tLRPC$TL_chatInviteExported.f >= i3) {
                    spannableStringBuilder4.append((CharSequence) u.B0("LinkLimitReached", e78.NF));
                } else {
                    if (z) {
                        i2 = e78.v40;
                        str2 = "Revoked";
        ...
        public RecyclerView.d0 onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            switch (i) {
                ...
                case 7:
                    ...
                    sz8Var.setBackground(l.u2(this.mContext, g68.g2, "windowBackgroundGrayShadow"));
                    bv9Var = sz8Var;
                    z0Var = bv9Var;
                    break;
                case 8:
                    ...
                    uw9Var.c(u.B0("DeleteAllRevokedLinks", e78.f4705do), false);
                    uw9Var.setTextColor(l.B1("windowBackgroundWhiteRedText5"));
                    z0Var = uw9Var;
                    break;
                case 9:
                    bv9 bv9Var2 = new bv9(this.mContext);
                    bv9Var2.setText(u.B0("CreateNewLinkHelp", e78.Yl));
                    bv9Var2.setBackground(l.u2(this.mContext, g68.g2, "windowBackgroundGrayShadow"));
                    bv9Var = bv9Var2;
                    z0Var = bv9Var;
                    break;
                case 10:
                ...
                default:
                    ...
                    iVar.setBackgroundDrawable(l.u2(this.mContext, g68.g2, "windowBackgroundWhite"));
                    z0Var = iVar;
                    break;
            }
    ...
    public /* synthetic */ void C3(Context context, View view, int i2) {
        if (i2 == this.creatorRow) {
            ...
            if (i2 >= i4 && i2 < this.revokedLinksEndRow) {
                ...
                e.k kVar = new e.k(E0());
                kVar.x(u.B0("DeleteAllRevokedLinks", e78.f4705do));
                kVar.n(u.B0("DeleteAllRevokedLinkHelp", e78.co));
                kVar.v(u.B0("Delete", e78.Kn), new DialogInterface.OnClickListener() { // from class: l75
                    @Override // android.content.DialogInterface.OnClickListener
    ...
    */
    ...
    public /* synthetic */ void M3(TLRPC$TL_error tLRPC$TL_error, org.telegram.tgnet.a aVar, TLRPC$TL_chatInviteExported tLRPC$TL_chatInviteExported) {
        if (tLRPC$TL_error == null) {
            ...
            if (E0() != null) {
                q.p0(this).T(y68.V0, u.B0("InviteRevokedHint", e78.UC)).T();
            }
        }
    }
    ...
    public View W(final Context context) {
        ...
        this.actionBar.setTitle(u.B0("InviteLinks", e78.TC));
        ...
        this.linkIcon = sz1.e(context, g68.d8);
        this.linkIconRevoked = sz1.e(context, g68.e8);
