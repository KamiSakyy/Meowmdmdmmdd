...
public class r28 extends f {
    ...
    public /* synthetic */ void D2(Context context, View view) {
        ...
        try {
            ...
            b48 b48Var = new b48(context, u.B0("ShareQrCode", e78.T80), str + sb.toString(), u.B0("QRCodeLinkHelpProxy", e78.D00), true);
            b48Var.y1(f0.o(RLottieDrawable.j0(null, y68.c2), org.telegram.messenger.a.e0(60.0f), org.telegram.messenger.a.e0(60.0f), false));
            f2(b48Var);
    ...
    */
    ...
    public View W(final Context context) {
        ...
        boolean z;
        boolean z2;
        this.actionBar.setTitle(u.B0("ProxyDetails", e78.EZ));
        ...
        org.telegram.ui.ActionBar.c i2 = this.actionBar.x().i(1, g68.s2, org.telegram.messenger.a.e0(56.0f));
        this.doneItem = i2;
        i2.setContentDescription(u.B0("Done", e78.vq));
        ...
        for (int i3 = 0; i3 < 2; i3++) {
            ...
            if (i3 == 0) {
                ...
                String B0 = u.B0("UseProxySocks5", e78.wi0);
                ...
                String B02 = u.B0("UseProxyTelegram", e78.zi0);
                if (i3 == this.currentType) {
                    z = true;
                } else {
                    z = false;
            ...
            if (i4 != 0) {
                if (i4 != 1) {
                    if (i4 != 2) {
                        if (i4 != 3) {
                            if (i4 == 4) {
                                this.inputFields[i4].setHintText(u.B0("UseProxySecret", e78.ui0));
                                this.inputFields[i4].setText(this.currentProxyInfo.d);
                            }
                        } else {
                            this.inputFields[i4].setHintText(u.B0("UseProxyPassword", e78.si0));
                            this.inputFields[i4].setText(this.currentProxyInfo.f12763c);
                        }
                    } else {
                        this.inputFields[i4].setHintText(u.B0("UseProxyUsername", e78.Di0));
                        this.inputFields[i4].setText(this.currentProxyInfo.f12761b);
                    }
                } else {
                    this.inputFields[i4].setHintText(u.B0("UseProxyPort", e78.ti0));
                    EditTextBoldCursor editTextBoldCursor2 = this.inputFields[i4];
                    editTextBoldCursor2.setText("" + this.currentProxyInfo.a);
                }
            } else {
                this.inputFields[i4].setHintText(u.B0("UseProxyAddress", e78.oi0));
        ...
        for (int i6 = 0; i6 < 2; i6++) {
            ...
            this.bottomCells[i6].setBackground(l.u2(context, g68.g2, "windowBackgroundGrayShadow"));
            if (i6 == 0) {
                this.bottomCells[i6].setText(u.B0("UseProxyInfo", e78.ri0));
            } else {
                bv9 bv9Var = this.bottomCells[i6];
                bv9Var.setText(u.B0("UseProxyTelegramInfo", e78.Bi0) + "\n\n" + u.B0("UseProxyTelegramInfo2", e78.Ci0));
        ...
        this.pasteCell.c(u.B0("PasteFromClipboard", e78.WT), false);
        ...
        this.sectionCell[2].setBackground(l.u2(this.fragmentView.getContext(), g68.g2, "windowBackgroundGrayShadow"));
        ...
        this.shareCell.c(u.B0("ShareFile", e78.J80), false);
        ...
        this.sectionCell[1].setBackgroundDrawable(l.u2(context, g68.g2, "windowBackgroundGrayShadow"));
