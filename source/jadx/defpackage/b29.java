...
public class b29 extends FrameLayout implements h.d {
        ...
        if (o0 != null) {
            ...
            if (TextUtils.isEmpty(str) && (str2 = o0.f19570b) != null) {
                if (str2.startsWith(MediaStreamTrack.VIDEO_TRACK_KIND)) {
                    if (x.v2(o0)) {
                        str = u.B0("AttachGif", e78.r8);
                    } else {
                        str = u.B0("AttachVideo", e78.Q8);
                    }
                } else if (o0.f19570b.startsWith("image")) {
                    if (x.v2(o0)) {
                        str = u.B0("AttachGif", e78.r8);
                    } else {
                        str = u.B0("AttachPhoto", e78.K8);
                    }
                } else if (o0.f19570b.startsWith(MediaStreamTrack.AUDIO_TRACK_KIND)) {
                    str = u.B0("AttachAudio", e78.l8);
                } else {
                    str = u.B0("AttachDocument", e78.p8);
                }
            }
            if (str6 == null) {
                str6 = str;
    ...
    public final void n() {
        ...
        if (xVar != null && xVar.o0() != null) {
            ...
            this.dateTextView.setText(String.format("%s, %s", format, u.d0("formatDateAtTime", e78.cr0, u.p0().f13211f.b(new Date(j)), u.p0().f13195a.b(new Date(j)))));
        }
    }
    ...
    public b29(Context context, int i, l.r rVar) {
        ...
        this.statusDrawable = new RLottieDrawable(y68.W, "download_arrow", org.telegram.messenger.a.e0(14.0f), org.telegram.messenger.a.e0(14.0f), true, null);
