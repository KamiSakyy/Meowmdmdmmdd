...
public class zz7 extends fw implements a0.d {
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        if (this.drawCheck) {
            sb.append(", ");
            sb.append(u.B0("AccDescrVerified", e78.p1));
            sb.append("\n");
        }
        if (this.statusLayout != null) {
            if (sb.length() > 0) {
    ...
    public void z() {
        ...
        if (this.contact != null) {
            int measureText = (int) (l.f15886e.measureText(u.z0(e78.NC)) + 1.0f);
            this.actionLayout = new StaticLayout(u.z0(e78.NC), l.f15886e, measureText, Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
            if (!u.d) {
        ...
        if (fm9Var3 != null && this.subLabel == null) {
            if (d.M(fm9Var3)) {
                ...
                if (!fm9Var4.h) {
                    ...
                    if (i != 0) {
                        ...
                        str = u.B0("ChannelPrivate", e78.hh).toLowerCase();
                    } else {
                        str = u.B0("ChannelPublic", e78.kh).toLowerCase();
                    }
            ...
            if (i2 != 0) {
                ...
                str = u.B0("MegaLocation", e78.UH);
            } else if (!d.a0(fm9Var5)) {
                str = u.B0("MegaPrivate", e78.VH).toLowerCase();
            } else {
                str = u.B0("MegaPublic", e78.YH).toLowerCase();
            }
            this.nameTop = a.e0(19.0f);
        } else {
            ...
            if (charSequence != null) {
                ...
                if (mq9Var5 != null) {
                    if (y.r9(mq9Var5)) {
                        str = u.B0("SupportStatus", e78.Jc0);
                    } else {
                        ...
                        if (mq9Var6.f10571e) {
                            ...
                            if (j != 333000 && j != 777000) {
                                ...
                                if (mq9Var7 != null && (mq9Var7.f10557a == tla.p(this.currentAccount).k() || ((pq9Var = this.user.f10561a) != null && pq9Var.a > ConnectionsManager.getInstance(this.currentAccount).getCurrentTime()))) {
                                    mv9Var3 = l.f15912h;
                                    str = u.B0("Online", e78.EP);
                                }
                            } else {
                                str = u.B0("ServiceNotifications", e78.x70);
                            }
                        }
                    }
                } else {
