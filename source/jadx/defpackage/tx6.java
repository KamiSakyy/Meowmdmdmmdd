...
public class tx6 extends FrameLayout implements a0.d {
    private static final int[] ids = {i68.X0, i68.Y0, i68.Z0, i68.a1, i68.b1, i68.c1, i68.d1, i68.e1, i68.f1, i68.g1, i68.h1, i68.i1};
    ...
    public class h extends r83.b {
        ...
        @Override // defpackage.r83.b
        public void b() {
            tx6.this.k0(u.B0("FingerprintNotRecognized", e78.Rx));
        }
    ...
    public tx6(Context context) {
        ...
        this.checkImage.setBackgroundResource(g68.q);
        this.passwordFrameLayout.addView(this.checkImage, cn4.c(60, 60.0f, 85, 0.0f, 0.0f, 10.0f, 4.0f));
        this.checkImage.setContentDescription(u.B0("Done", e78.vq));
        ...
        imageView2.setImageResource(g68.I1);
        this.fingerprintImage.setScaleType(ImageView.ScaleType.CENTER);
        this.fingerprintImage.setBackgroundResource(g68.q);
        this.passwordFrameLayout.addView(this.fingerprintImage, cn4.c(60, 60.0f, 83, 10.0f, 0.0f, 0.0f, 4.0f));
        this.fingerprintImage.setContentDescription(u.B0("AccDescrFingerprint", e78.W));
        ...
        while (true) {
            if (i4 < 12) {
                ...
                dVar.setBackgroundResource(g68.q);
                dVar.setTag(Integer.valueOf(i4));
                if (i4 == 11) {
                    dVar.setContentDescription(u.B0("AccDescrFingerprint", e78.W));
                    i0(dVar, i68.X0);
                } else if (i4 == 10) {
                    ...
                    dVar.setContentDescription(u.B0("AccDescrBackspace", e78.z));
                    i0(dVar, i68.Y0);
                } else {
        ...
        if (Build.VERSION.SDK_INT >= 23 && ((Activity) getContext()) != null && this.fingerprintView.getVisibility() == 0 && !org.telegram.messenger.b.f12525c) {
            ...
            try {
                ...
                if (b2.d() && b2.c() && q83.j() && !q83.c()) {
                    ...
                    textView.setText(u.B0("FingerprintInfo", e78.Qx));
                    ...
                    imageView.setImageResource(g68.N2);
                    ...
                    this.fingerprintStatusTextView.setText(u.B0("FingerprintHelp", e78.Px));
    ...
    public final void N() {
        ...
        if (j3 > 0) {
            ...
            if (max != this.lastValue) {
                this.retryTextView.setText(u.d0("TooManyTries", e78.Gf0, u.U("Seconds", max, new Object[0])));
                this.lastValue = max;
            }
    ...
    public void g0(boolean z, boolean z2, int i2, int i3, Runnable runnable, Runnable runnable2) {
        ...
        this.passcodeTextView.setText(u.B0("EnterYourTelegramPasscode", e78.ut));
        int i4 = e0.b;
        if (i4 == 0) {
            if (this.retryTextView.getVisibility() != 0) {
                this.numbersFrameLayout.setVisibility(0);
    ...
    public final void k0(CharSequence charSequence) {
        this.fingerprintImageView.setImageResource(g68.M2);
