...
public abstract class bab {
    ...
    public static String b(Context context) {
        return context.getResources().getString(a78.g);
    }
    ...
    public static String c(Context context, int i) {
        ...
        if (i != 1) {
            if (i != 2) {
                ...
                return resources.getString(a78.a);
            }
            return resources.getString(a78.j);
        }
        return resources.getString(a78.d);
    }
    ...
    public static String d(Context context, int i) {
        ...
        if (i != 1) {
            if (i != 2) {
                            ...
                            if (i != 9) {
                                if (i != 20) {
                                    switch (i) {
                                        ...
                                        case 18:
                                            return resources.getString(a78.m, a2);
                                        default:
                                            return resources.getString(b78.a, a2);
                                    }
                                }
                                return h(context, "common_google_play_services_restricted_profile_text", a2);
                            }
                            return resources.getString(a78.i, a2);
                        }
                ...
                return resources.getString(a78.b, a2);
            } else if (ub2.d(context)) {
                return resources.getString(a78.n);
            } else {
                return resources.getString(a78.k, a2);
            }
        }
        return resources.getString(a78.e, a2);
    }
    ...
    public static String f(Context context, int i) {
        ...
        if (g == null) {
            return context.getResources().getString(a78.h);
        }
        return g;
    }
    ...
    public static String g(Context context, int i) {
        ...
        switch (i) {
            case 1:
                return resources.getString(a78.f);
            case 2:
                return resources.getString(a78.l);
            case 3:
                return resources.getString(a78.c);
            case 4:
            case 6:
            case 18:
                return null;
