...
public class gz3 extends Drawable {
    private byte[] data;
    ...
    public void b(an9 an9Var) {
        byte[] bArr = an9Var.f441f;
        this.data = bArr;
        if (bArr == null) {
            byte[] E = a.E(an9Var.f439e);
            this.data = E;
            an9Var.f441f = E;
        }
        invalidateSelf();
    ...
    public void draw(Canvas canvas) {
        ...
        if (bArr.length == 16) {
            ...
            for (int i2 = 0; i2 < 8; i2++) {
                for (int i3 = 0; i3 < 8; i3++) {
                    int a = a(i);
                    i += 2;
                    this.paint.setColor(this.colors[Math.abs(a) % 4]);
        ...
        for (int i5 = 0; i5 < 12; i5++) {
            for (int i6 = 0; i6 < 12; i6++) {
                this.paint.setColor(this.colors[Math.abs(a(i4)) % 4]);
