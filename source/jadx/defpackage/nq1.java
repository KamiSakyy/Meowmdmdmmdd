...
public class nq1 extends Drawable implements Drawable.Callback {
    ...
    public nq1(Drawable drawable, Drawable drawable2, int i, int i2) {
    ...
    public nq1(Drawable drawable, Drawable drawable2) {
        this.background = drawable;
        this.icon = drawable2;
        if (drawable2 != null) {
            drawable2.setCallback(this);
