...
public final class t14 {
    ...
    public t14(TextInputLayout textInputLayout) {
        ...
        this.a = context.getResources().getDimensionPixelSize(b68.e);
        this.f19113a = hh6.f(context, u58.D, 217);
        this.b = hh6.f(context, u58.A, 167);
        this.c = hh6.f(context, u58.D, 167);
        this.f19115a = hh6.g(context, u58.E, ye.d);
        int i = u58.E;
        TimeInterpolator timeInterpolator = ye.a;
        this.f19125b = hh6.g(context, i, timeInterpolator);
        this.f19130c = hh6.g(context, u58.G, timeInterpolator);
    }
    ...
    public void f() {
        if (g()) {
            ...
            gqa.G0(this.f19120a, v(g, b68.r, gqa.J(editText)), v(g, b68.s, this.f19116a.getResources().getDimensionPixelSize(b68.q)), v(g, b68.r, gqa.I(editText)), 0);
        }
    }
