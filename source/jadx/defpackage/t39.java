...
public class t39 extends FrameLayout {
    ...
    public class a extends FrameLayout {
        ...
        public a(Context context) {
            ...
            imageView.setImageResource(g68.vd);
        ...
        public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
            ...
            if (this.currentMessageObject.H3()) {
                accessibilityNodeInfo.setText(u.B0("AttachVideo", e78.Q8) + ", " + u.P(this.currentMessageObject.t0()));
            } else {
                accessibilityNodeInfo.setText(u.B0("AttachPhoto", e78.K8));
            }
            if (this.checkBox.a()) {
        ...
        public void setMessageObject(x xVar) {
            ...
            if (!TextUtils.isEmpty(y.E8(xVar.f13365a.f9701b))) {
                ...
                this.imageView.setImageResource(g68.Yc);
                return;
            }
            lp9 lp9Var = null;
            if (xVar.H3()) {
                ...
                if (e0 != null) {
                    if (xVar.f13353a != null) {
                        ...
                        this.imageView.q(t.c(lp9Var, o0), "100_100", t.c(e0, o0), "b", org.telegram.messenger.b.f12514a.getResources().getDrawable(g68.Yc), null, null, 0, xVar);
                        return;
                    }
                }
                this.imageView.setImageResource(g68.Yc);
            ...
            if ((qo9Var instanceof TLRPC$TL_messageMediaPhoto) && qo9Var.f17403a != null && !xVar.f13364a.isEmpty()) {
                ...
                if (!xVar.f13441r && !h.K(t39.this.currentAccount).t(xVar)) {
                    ...
                    if (bitmapDrawable != null) {
                        ...
                        this.imageView.q(null, null, t.g(e03, xVar.f13373a), "b", org.telegram.messenger.b.f12514a.getResources().getDrawable(g68.Yc), null, null, 0, xVar);
                        return;
                    }
                }
                if (g0 != e03) {
