...
public abstract class al2 extends FrameLayout implements a0.d {
    ...
    public al2(Context context, final DrawerLayoutContainer drawerLayoutContainer) {
        ...
        this.shadowView.setImageResource(g68.J);
        ...
        this.arrowView.setImageResource(g68.Y6);
        ...
        if (z) {
            int i = y68.F2;
            RLottieDrawable rLottieDrawable = new RLottieDrawable(i, "" + y68.F2, org.telegram.messenger.a.e0(28.0f), org.telegram.messenger.a.e0(28.0f), true, null);
    ...
    public void w(mq9 mq9Var, boolean z) {
        ...
        if ((zm9Var instanceof TLRPC$TL_emojiStatusUntil) && ((TLRPC$TL_emojiStatusUntil) zm9Var).a > ((int) (System.currentTimeMillis() / 1000))) {
            ...
            if (this.premiumStar == null) {
                this.premiumStar = getResources().getDrawable(g68.J9).mutate();
            }
        ...
        if (!MDConfig.hidePhone) {
            ...
            this.phoneTextView.setText(u.B0("MobileHidden", e78.kJ));
        }
