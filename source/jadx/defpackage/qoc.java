...
public enum qoc implements slb {
    UNKNOWN_EVENT(0),
    ...
    CLOUD_SAFE_SEARCH_CLOSE(Page.PAGE_LEAF_MEMORY),
    CLOUD_TEXT_CREATE(Page.PAGE_NODE_MEMORY),
    ...
    CUSTOM_MODEL_RUN(DataUtils.ERROR_TOO_MANY_OPEN_TRANSACTIONS),
    CUSTOM_MODEL_CREATE(DataUtils.ERROR_TRANSACTION_ILLEGAL_STATE),
    CUSTOM_MODEL_CLOSE(104),
    CUSTOM_MODEL_LOAD(DataUtils.ERROR_TRANSACTIONS_DEADLOCK),
    AUTOML_IMAGE_LABELING_RUN(181),
    AUTOML_IMAGE_LABELING_CREATE(182),
    AUTOML_IMAGE_LABELING_CLOSE(183),
    AUTOML_IMAGE_LABELING_LOAD(Constants.MEMORY_PAGE_BTREE),
    MODEL_DOWNLOAD(100),
    MODEL_UPDATE(DataUtils.ERROR_TRANSACTION_LOCKED),
    ...
    REMOTE_CONFIG_LOAD(BaseQuickAdapter.HEADER_VIEW),
