...
public class lp3 extends FrameLayout implements vq3.a {
    ...
    public lp3(qq3 qq3Var, ArrayList arrayList, d.a aVar, z zVar) {
        ...
        this.f9749a = aVar;
        this.f9757b = zVar.o0();
        g22 g22Var = new g22(qq3Var.getContext(), g68.d0, null);
        this.f9743a = g22Var;
        g22Var.b(true, false);
        ...
        this.f9737a = qq3Var.getContext().getResources().getDrawable(g68.me).mutate();
        ...
        String B0 = u.B0("VoipVideoOnPause", e78.vp0);
        StaticLayout staticLayout = new StaticLayout(u.B0("VoipVideoScreenSharingTwoLines", e78.yp0), textPaint, org.telegram.messenger.a.e0(400.0f), Layout.Alignment.ALIGN_CENTER, 1.0f, 0.0f, false);
        fm9 S7 = y.u8(this.f9757b).S7(Long.valueOf(aVar.f12539a));
        StaticLayout staticLayout2 = new StaticLayout(u.d0("VoipVideoNotAvailable", e78.tp0, u.U("Participants", y.u8(this.f9757b).T, new Object[0])), textPaint, org.telegram.messenger.a.e0(400.0f), Layout.Alignment.ALIGN_CENTER, 1.0f, 0.0f, false);
        String B02 = u.B0("VoipVideoScreenSharing", e78.xp0);
        ...
        imageView.setImageDrawable(sz1.e(qq3Var.getContext(), g68.cg));
        imageView.setColorFilter(new PorterDuffColorFilter(-1, PorterDuff.Mode.MULTIPLY));
        Drawable k1 = l.k1(org.telegram.messenger.a.e0(19.0f), 0, jq1.p(-1, 100));
        c cVar = new c(qq3Var.getContext());
        this.f9740a = cVar;
        cVar.setText(u.B0("VoipVideoScreenStopSharing", e78.zp0));
        ...
        if (org.telegram.messenger.d.i(S7)) {
            this.f9761b.setText(org.telegram.messenger.a.b3(u.z0(e78.tL)));
        } else {
            this.f9761b.setText(org.telegram.messenger.a.b3(u.d0("NoRtmpStreamFromAppViewer", e78.uL, S7.f5602a)));
        }
