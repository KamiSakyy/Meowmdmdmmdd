...
public class g3a extends Drawable {
    ...
    public void e(int i) {
        ...
        if (this.time != i) {
            this.time = i;
            if (this.isDialog) {
                this.currentTtlIcon = sz1.e(this.context, g68.H5).mutate();
            } else {
            ...
            if (i3 >= 1 && i3 < 60) {
                str = "" + i;
                if (str.length() < 2) {
                    str = str + u.B0("SecretChatTimerSeconds", e78.V50);
                }
            } else if (i3 >= 60 && i3 < 3600) {
                str = "" + (i / 60);
                if (str.length() < 2) {
                    str = str + u.B0("SecretChatTimerMinutes", e78.T50);
                }
            } else if (i3 >= 3600 && i3 < 86400) {
                str = "" + ((i / 60) / 60);
                if (str.length() < 2) {
                    str = str + u.B0("SecretChatTimerHours", e78.S50);
                }
            } else if (i3 >= 86400 && i3 < 604800) {
                str = "" + (((i / 60) / 60) / 24);
                if (str.length() < 2) {
                    str = str + u.B0("SecretChatTimerDays", e78.R50);
                }
            } else if (i3 < 2678400) {
                str = "" + ((((i / 60) / 60) / 24) / 7);
                if (str.length() < 2) {
                    str = str + u.B0("SecretChatTimerWeeks", e78.W50);
                ...
                str = "" + ((((i / 60) / 60) / 24) / 30);
                if (str.length() < 2) {
                    str = str + u.B0("SecretChatTimerMonths", e78.U50);
                }
            } else {
                str = "" + ((((i / 60) / 60) / 24) / 364);
                if (str.length() < 2) {
                    str = str + u.B0("SecretChatTimerYears", e78.X50);
                }
            }
            String str2 = str;
