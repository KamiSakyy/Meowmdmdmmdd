...
public final class yta {
    public static final yta a = k(xc0.a, (float) ((xc0.h(50.0f) * 63.66197723675813d) / 100.0d), 50.0f, 2.0f, false);
    ...
    public yta(float f, float f2, float f3, float f4, float f5, float f6, float[] fArr, float f7, float f8, float f9) {
        this.f = f;
        this.f23204a = f2;
        this.b = f3;
        this.c = f4;
    ...
    public static yta k(float[] fArr, float f, float f2, float f3, boolean z) {
        float d;
        float exp;
        float[][] fArr2 = xc0.f22182a;
        float f4 = fArr[0];
        float[] fArr3 = fArr2[0];
        float f5 = fArr[1];
        float f6 = fArr[2];
        ...
        if (f10 >= 0.9d) {
            d = xc0.d(0.59f, 0.69f, (f10 - 0.9f) * 10.0f);
        } else {
            d = xc0.d(0.525f, 0.59f, (f10 - 0.8f) * 10.0f);
        }
        float f11 = d;
        if (z) {
            exp = 1.0f;
        ...
        float f17 = fArr7[1];
        return new yta(h, ((f16 * 2.0f) + ((f17 * 400.0f) / (f17 + 27.13f)) + (((400.0f * pow2) / (pow2 + 27.13f)) * 0.05f)) * pow, pow, pow, f11, f10, fArr6, cbrt, (float) Math.pow(cbrt, 0.25d), sqrt);
    }
