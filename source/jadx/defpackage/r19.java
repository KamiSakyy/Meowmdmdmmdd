...
public class r19 extends Drawable {
    ...
    public r19(Context context, int i) {
        this.currentType = i;
        if (i == 4) {
            this.drawable = context.getResources().getDrawable(g68.nd);
            this.drawableLeft = context.getResources().getDrawable(g68.Le);
            this.drawableRight = context.getResources().getDrawable(g68.Me);
        } else if (i == 3) {
            this.drawable = context.getResources().getDrawable(g68.nc);
            this.drawableLeft = context.getResources().getDrawable(g68.e);
            this.drawableRight = context.getResources().getDrawable(g68.f);
        } else if (i == 2) {
            this.drawable = context.getResources().getDrawable(g68.oc);
            this.drawableLeft = context.getResources().getDrawable(g68.e);
            this.drawableRight = context.getResources().getDrawable(g68.f);
        } else if (i == 1) {
            this.drawable = context.getResources().getDrawable(g68.Ke);
            this.drawableLeft = context.getResources().getDrawable(g68.Le);
            this.drawableRight = context.getResources().getDrawable(g68.Me);
        } else {
            this.drawable = context.getResources().getDrawable(g68.d);
            this.drawableLeft = context.getResources().getDrawable(g68.e);
            this.drawableRight = context.getResources().getDrawable(g68.f);
        }
    }
