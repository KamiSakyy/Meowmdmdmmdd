...
public class iv3 extends FrameLayout {
    ...
    public boolean k(qf1 qf1Var, Object obj, int i, int i2, boolean z) {
        ...
        if (i6 == 0) {
            ...
            this.shownY = i2;
            if (num.intValue() == -1) {
                this.textView.setText(u.B0("PollSelectOption", e78.eX));
            } else if (qf1Var.getMessageObject().j3()) {
                if (num.intValue() == 0) {
                    this.textView.setText(u.B0("NoVotesQuiz", e78.OL));
                } else {
                    this.textView.setText(u.U("Answer", num.intValue(), new Object[0]));
                }
            } else if (num.intValue() == 0) {
                this.textView.setText(u.B0("NoVotes", e78.NL));
            } else {
            ...
            if (str == null) {
                this.textView.setText(u.B0("HidAccount", e78.DA));
            } else {
    ...
    */
    ...
    public iv3(Context context, int i, boolean z, l.r rVar) {
        ...
        if (i == 0) {
            this.textView.setText(u.B0("AutoplayVideoInfo", e78.sb));
            ImageView imageView = new ImageView(context);
            this.imageView = imageView;
            imageView.setImageResource(g68.Df);
        ...
        imageView2.setImageResource(z ? g68.Cf : g68.Bf);
