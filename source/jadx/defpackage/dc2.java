...
public class dc2 extends fw {
    ...
    */
    ...
    public String getMessageNameString() {
        ...
        if (this.message.Y2()) {
            return org.telegram.messenger.u.B0("FromYou", e78.Vy);
        }
        x xVar2 = this.message;
        ...
        if (mq9Var != null) {
            ...
            if (xla.i(mq9Var)) {
                return org.telegram.messenger.u.B0("HiddenName", e78.EA);
            }
    ...
    */
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        if (u0() && (h38Var = this.archivedChatsDrawable) != null && e0.V && h38Var.pullProgress == 0.0f) {
            ...
            if (!u0() && this.parentFragment != null) {
                accessibilityNodeInfo.addAction(new AccessibilityNodeInfo.AccessibilityAction(i68.n, org.telegram.messenger.u.B0("AccActionChatPreview", e78.k)));
            }
        }
        d0 d0Var = this.checkBox;
    ...
    public void onPopulateAccessibilityEvent(AccessibilityEvent accessibilityEvent) {
        ...
        if (this.currentDialogFolderId == 1) {
            sb.append(org.telegram.messenger.u.B0("ArchivedChats", e78.X6));
            sb.append(". ");
        } else {
            if (this.encryptedChat != null) {
                sb.append(org.telegram.messenger.u.B0("AccDescrSecretChat", e78.Z0));
                sb.append(". ");
            }
            if (this.isTopic && this.forumTopic != null) {
                sb.append(org.telegram.messenger.u.B0("AccDescrTopic", e78.m1));
                sb.append(". ");
                ...
                if (mq9Var != null) {
                    if (xla.k(mq9Var)) {
                        sb.append(org.telegram.messenger.u.B0("RepliesTitle", e78.a20));
                    } else {
                        if (this.user.f10571e) {
                            sb.append(org.telegram.messenger.u.B0("Bot", e78.zc));
                            sb.append(". ");
                        }
                        mq9 mq9Var2 = this.user;
                        if (mq9Var2.f10563a) {
                            sb.append(org.telegram.messenger.u.B0("SavedMessages", e78.T40));
                        } else {
                    ...
                    if (fm9Var != null) {
                        if (fm9Var.g) {
                            sb.append(org.telegram.messenger.u.B0("AccDescrChannel", e78.M));
                        } else {
                            sb.append(org.telegram.messenger.u.B0("AccDescrGroup", e78.b0));
                        }
                        sb.append(". ");
        ...
        if (this.drawVerified) {
            sb.append(org.telegram.messenger.u.B0("AccDescrVerified", e78.p1));
            sb.append(". ");
        }
        ...
        if (this.reactionMentionCount > 0) {
            sb.append(org.telegram.messenger.u.B0("AccDescrMentionReaction", e78.i0));
            sb.append(". ");
        }
        x xVar = this.message;
        if (xVar != null && this.currentDialogFolderId == 0) {
            ...
            if (this.message.W2()) {
                sb.append(org.telegram.messenger.u.d0("AccDescrSentDate", e78.c1, G));
            } else {
                sb.append(org.telegram.messenger.u.d0("AccDescrReceivedDate", e78.P0, G));
            }
            sb.append(". ");
    ...
    public boolean performAccessibilityAction(int i2, Bundle bundle) {
        u uVar;
        if (i2 == i68.n && (uVar = this.parentFragment) != null) {
            uVar.wc(this);
            return true;
        }
    ...
    public final CharSequence q0() {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            ...
            if (fm9Var != null) {
                ...
                if (xla.i(mq9Var)) {
                    replace = org.telegram.messenger.u.B0("HiddenName", e78.EA);
                } else {
