...
public class ty1 implements RemoteViewsService.RemoteViewsFactory {
    ...
    public RemoteViews getViewAt(int i) {
        ...
        int i10;
        if (this.f19858a) {
            RemoteViews remoteViews = new RemoteViews(this.f19852a.getPackageName(), v68.F);
            remoteViews.setTextViewText(i68.l2, u.B0("WidgetLoggedOff", e78.Rp0));
            return remoteViews;
        } else if (i >= getCount() - 1) {
            RemoteViews remoteViews2 = new RemoteViews(this.f19852a.getPackageName(), v68.G);
            remoteViews2.setTextViewText(i68.n2, u.B0("TapToEditWidgetShort", e78.Ad0));
            ...
            remoteViews2.setOnClickFillInIntent(i68.m2, intent);
            return remoteViews2;
        } else {
            RemoteViews remoteViews3 = new RemoteViews(this.f19852a.getPackageName(), v68.e);
            for (int i11 = 0; i11 < 2; i11++) {
                ...
                if (i12 >= this.f19856a.size()) {
                    ...
                    if (ic2.k(l.longValue())) {
                        ...
                        if (xla.l(mq9Var)) {
                            str = u.B0("SavedMessages", e78.T40);
                        } else if (xla.k(mq9Var)) {
                            str = u.B0("RepliesTitle", e78.a20);
                        } else if (xla.i(mq9Var)) {
                            str = u.B0("HiddenName", e78.EA);
                        } else {
                            str = xla.a(mq9Var);
                        }
