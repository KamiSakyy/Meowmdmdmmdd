...
public class tr8 extends FrameLayout {
    ...
    public tr8(Context context, boolean z, l.r rVar) {
        ...
        if (z) {
            ...
            Drawable drawable = getResources().getDrawable(g68.nd);
    ...
    public final void d() {
        ...
        if (Z != null) {
            String B0 = u.B0("StopLiveLocation", e78.Jb0);
        ...
        f(u.B0("SendLiveLocation", e78.K60), u.B0("SendLiveLocationInfo", e78.O60));
    }
