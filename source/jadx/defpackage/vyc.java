...
public abstract class vyc {
    ...
    public static long c(byte[] bArr) {
        ...
        if (length <= 32) {
            ...
            return b(Long.rotateRight(e9 + e10, 43) + Long.rotateRight(e11, 30) + ((b + e(bArr, i3 - 24)) * j4), e9 + Long.rotateRight(e10 + e6, 18) + e11, j4);
        } else {
            ...
            while (true) {
                ...
                if (i11 == i10) {
                    ...
                    d(bArr, i7 + 32, jArr2[1] + rotateRight7, e(bArr, i7 + 16) + rotateRight6, jArr2);
