...
public class q19 extends FrameLayout {
    ...
    public /* synthetic */ void g(hm2 hm2Var, boolean z, float f, float f2) {
        this.topicTextView.setTag(i68.v1, null);
    }
    ...
    public void i(long j, boolean z, CharSequence charSequence) {
        ...
        if (ic2.k(j)) {
            ...
            if (this.currentType != 2 && xla.k(this.user)) {
                this.nameTextView.setText(u.B0("RepliesTitle", e78.a20));
                ...
                this.nameTextView.setText(u.B0("SavedMessages", e78.T40));
    ...
    public void j(TLRPC$TL_forumTopic tLRPC$TL_forumTopic, boolean z) {
        ...
        if (z3 != z2 || !z) {
            x99 x99Var = (x99) this.topicTextView.getTag(i68.v1);
            if (x99Var != null) {
                x99Var.d();
            }
            if (z2) {
            ...
            if (z) {
                ...
                this.topicTextView.setTag(i68.v1, x99Var3);
                x99Var3.s();
            } else if (z2) {
