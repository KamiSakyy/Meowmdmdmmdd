...
public abstract class dq3 extends g {
    ...
    public class d extends vt6 {
        ...
        public Object instantiateItem(ViewGroup viewGroup, final int i) {
            ...
            if (i == 0) {
                aVar.setContentDescription(u.B0("VoipRecordAudio", e78.Yo0));
            } else if (i == 1) {
                aVar.setContentDescription(u.B0("VoipRecordPortrait", e78.ap0));
            } else {
                aVar.setContentDescription(u.B0("VoipRecordLandscape", e78.Zo0));
            }
            if (i == 0) {
                i2 = y68.g2;
            } else if (i == 1) {
    ...
    public dq3(Context context, fm9 fm9Var, boolean z) {
        ...
        if (org.telegram.messenger.d.P(fm9Var)) {
            textView.setText(u.B0("VoipChannelRecordVoiceChat", e78.wl0));
        } else {
            textView.setText(u.B0("VoipRecordVoiceChat", e78.cp0));
        }
        ...
        textView2.setText(u.B0("VoipRecordVoiceChatInfo", e78.dp0));
        ...
        this.positiveButton.setText(u.B0("VoipRecordStart", e78.bp0));
        ...
        while (true) {
            ...
            if (i5 == 0) {
                this.titles[i5].setText(u.B0("VoipRecordAudio", e78.Yo0));
            } else if (i5 == 1) {
                this.titles[i5].setText(u.B0("VoipRecordPortrait", e78.ap0));
            } else {
                this.titles[i5].setText(u.B0("VoipRecordLandscape", e78.Zo0));
            }
