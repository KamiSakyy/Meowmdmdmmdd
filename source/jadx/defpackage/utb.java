...
public enum utb {
    ...
    static {
        utb[] values;
        for (utb utbVar : values()) {
            a.put(Integer.valueOf(utbVar.f20497a), utbVar);
        }
    }
    ...
    public static utb a(int i) {
        return (utb) a.get(Integer.valueOf(i));
    }

    public final Integer b() {
        return Integer.valueOf(this.f20497a);
    }

    @Override // java.lang.Enum
    public final String toString() {
        return Integer.valueOf(this.f20497a).toString();
    }
}
