...
public class eh8 implements a0.d {
    ...
    public /* synthetic */ void h(TLRPC$TL_error tLRPC$TL_error) {
        if (tLRPC$TL_error.f14225a.equals("RINGTONE_DURATION_TOO_LONG")) {
            a0.j().s(a0.Y2, 4, u.d0("TooLongError", e78.Bf0, new Object[0]), u.d0("ErrorRingtoneDurationTooLong", e78.wt, Integer.valueOf(y.u8(this.a).U)));
        } else if (tLRPC$TL_error.f14225a.equals("RINGTONE_SIZE_TOO_BIG")) {
            a0.j().s(a0.Y2, 4, u.d0("TooLargeError", e78.Af0, new Object[0]), u.d0("ErrorRingtoneSizeTooBig", e78.yt, Integer.valueOf(y.u8(this.a).V / 1024)));
        } else {
            a0.j().s(a0.Y2, 4, u.d0("InvalidFormatError", e78.JC, new Object[0]), u.d0("ErrorRingtoneInvalidFormat", e78.xt, new Object[0]));
        }
    }
