...
public class dw8 extends LinearLayout {
    ...
    public dw8(final Context context, wd3 wd3Var, boolean z, boolean z2, boolean z3, final e eVar, final l.r rVar) {
        ...
        if (wd3Var.s() != null) {
            ...
            dVar.f(u.B0("ShowSendersName", e78.L90), 0);
            ...
            dVar2.f(u.B0("HideSendersName", e78.TA), 0);
            ...
            if (z4) {
                ...
                this.f4471a.f(u.B0("ShowCaption", e78.B90), 0);
                ...
                this.b.f(u.B0("HideCaption", e78.KA), 0);
        ...
        if (!z) {
            ...
            dVar5.f(u.B0("ScheduleMessage", e78.Y40), g68.Ga);
        ...
        if (z2) {
            ...
            dVar6.f(u.B0("SendWithoutSound", e78.g70), g68.A3);
        ...
        dVar7.f(u.B0("SendMessage", e78.R60), g68.Qa);
