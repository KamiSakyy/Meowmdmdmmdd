...
public abstract class a95 {
    public static int a(n80 n80Var) {
        return b(n80Var, true) + b(n80Var, false);
    }

    public static int b(n80 n80Var, boolean z) {
        int e;
        int d;
        byte b;
        if (z) {
    ...
    public static int c(n80 n80Var) {
        byte[][] c = n80Var.c();
        int e = n80Var.e();
        int d = n80Var.d();
        int i = 0;
    ...
    public static int d(n80 n80Var) {
        byte[][] c = n80Var.c();
        int e = n80Var.e();
        int d = n80Var.d();
        int i = 0;
    ...
    public static int e(n80 n80Var) {
        byte[][] c = n80Var.c();
        int e = n80Var.e();
        int d = n80Var.d();
        int i = 0;
