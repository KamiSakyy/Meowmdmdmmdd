...
public abstract class qba {
    ...
    public static sv6 j() {
        ...
        arrayList.add(u.B0("ProviderDeepLTranslate", e78.qZ));
        arrayList2.add(5);
        arrayList.add(u.B0("ProviderGoogleTranslate", e78.sZ));
        arrayList2.add(1);
        arrayList.add(u.B0("ProviderDuckDuckGo", e78.rZ));
        arrayList2.add(13);
        arrayList.add(u.B0("ProviderYandex", e78.uZ));
        arrayList2.add(4);
        arrayList.add(u.B0("ProviderTelegram", e78.tZ));
        arrayList2.add(14);
    ...
    public static void l(final Context context, Exception exc, final Runnable runnable, final l.r rVar) {
        ...
        if (exc instanceof b) {
            kVar.n(u.B0("TranslateApiUnsupported", e78.Bg0));
            kVar.v(u.B0("TranslationProviderShort", e78.Lg0), new DialogInterface.OnClickListener() { // from class: kba
            ...
            if (exc != null && exc.getLocalizedMessage() != null) {
                kVar.x(u.B0("TranslationFailed", e78.Fg0));
                kVar.n(exc.getLocalizedMessage());
            } else {
                kVar.n(u.B0("TranslationFailed", e78.Fg0));
            }
            if (runnable != null) {
                kVar.v(u.B0("Retry", e78.j40), new DialogInterface.OnClickListener() { // from class: lba
                    @Override // android.content.DialogInterface.OnClickListener
                    public final void onClick(DialogInterface dialogInterface, int i) {
                        runnable.run();
                    }
            ...
            kVar.q(u.B0("TranslationProviderShort", e78.Lg0), new DialogInterface.OnClickListener() { // from class: mba
                @Override // android.content.DialogInterface.OnClickListener
                public final void onClick(DialogInterface dialogInterface, int i) {
                    qba.w(context, null, rVar);
                }
    ...
    public static /* synthetic */ void s(final ArrayList arrayList, final z.a aVar, Context context, l.r rVar, final int i) {
        ...
        e.k n = new e.k(context, rVar).n(u.B0("TranslateApiUnsupported", e78.Bg0));
        if ("app".equals(MDConfig.translationTarget)) {
            n.v(u.B0("UseGoogleTranslate", e78.ji0), new DialogInterface.OnClickListener() { // from class: oba
                @Override // android.content.DialogInterface.OnClickListener
                public final void onClick(DialogInterface dialogInterface, int i2) {
                    qba.q(z.a.this, dialogInterface, i2);
                }
            });
            n.p(u.B0("Cancel", e78.Le), null);
        } else if (k.k(k.d())) {
            n.v(u.B0("ResetLanguage", e78.w30), new DialogInterface.OnClickListener() { // from class: pba
                @Override // android.content.DialogInterface.OnClickListener
                public final void onClick(DialogInterface dialogInterface, int i2) {
    ...
    public static void w(final Context context, final z.a aVar, final l.r rVar) {
        ...
        if (arrayList != null && arrayList2 != null) {
            ...
            ll7.d(arrayList, u.B0("TranslationProvider", e78.Jg0), indexOf, context, new ll7.a() { // from class: nba
    ...
    public static void y(Context context, final boolean z, final Runnable runnable, l.r rVar) {
        ...
        arrayList.add(0, "app");
        arrayList2.add(0, u.B0("Default", e78.In));
        String B0 = u.B0("TranslationLanguage", e78.Ig0);
        if (z) {
