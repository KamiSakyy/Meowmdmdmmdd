...
public class yp3 extends LinearLayout implements VoIPService.StateListener, a0.d {
    ...
    public class a extends FrameLayout {
        ...
        public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
            ...
            if (sharedInstance != null && d.P(sharedInstance.getChat())) {
                accessibilityNodeInfo.addAction(new AccessibilityNodeInfo.AccessibilityAction(16, u.B0("VoipChannelOpenVoiceChat", e78.vl0)));
            } else {
                accessibilityNodeInfo.addAction(new AccessibilityNodeInfo.AccessibilityAction(16, u.B0("VoipGroupOpenVoiceChat", e78.pn0)));
            }
        }
    }
    ...
    public yp3(final Context context, int i) {
        ...
        this.leaveButton.n(g68.R, -1, -3257782, 0.3f, false, u.B0("VoipGroupLeave", e78.bn0), false, false);
    ...
    public final void l(boolean z) {
        ...
        if (isBluetoothOn) {
            this.soundButton.n(g68.P, -1, 0, 0.1f, true, u.B0("VoipAudioRoutingBluetooth", e78.Yk0), false, z);
        } else if (z2) {
            this.soundButton.n(g68.b0, -1, 0, 0.3f, true, u.B0("VoipSpeaker", e78.lp0), false, z);
        } else if (sharedInstance.isHeadsetPlugged()) {
            this.soundButton.n(g68.T, -1, 0, 0.1f, true, u.B0("VoipAudioRoutingHeadset", e78.al0), false, z);
        } else {
            this.soundButton.n(g68.b0, -1, 0, 0.1f, true, u.B0("VoipSpeaker", e78.lp0), false, z);
        }
        if (sharedInstance.mutedByAdmin()) {
            this.muteButton.n(g68.c0, -1, jq1.p(-1, 76), 0.1f, true, u.B0("VoipMutedByAdminShort", e78.ro0), true, z);
        } else {
    ...
    public final void m() {
        ...
        if (sharedInstance != null && sharedInstance.groupCall != null) {
            ...
            if (!sharedInstance.isSwitchingStream() && (callState == 1 || callState == 2 || callState == 6 || callState == 5)) {
                this.subtitleView.setText(u.B0("VoipGroupConnecting", e78.Bm0));
                return;
            }
