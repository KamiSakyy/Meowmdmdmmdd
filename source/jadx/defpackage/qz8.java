...
public abstract class qz8 {
    ...
    public static Map a() {
        ...
        hashMap9.put("uniforms", new String[]{"mvpMatrix", "texture", "mask", "color"});
        ...
        hashMap14.put("uniforms", new String[]{"mvpMatrix", "texture", "mask", "clear", "color", Constants.TAG_TYPE, "color", "resolution", "center", "radius", "thickness", "rounding", "fill", "rotation", "middle", "arrowTriangleLength", "composite"});
    ...
    public static Map b() {
        ...
        for (Map.Entry entry : a.entrySet()) {
            ...
            hashMap.put((String) entry.getKey(), new pz8((String) map.get("vertex"), (String) map.get("fragment"), (String[]) map.get("attributes"), (String[]) map.get("uniforms")));
        }
        return Collections.unmodifiableMap(hashMap);
    }
}
