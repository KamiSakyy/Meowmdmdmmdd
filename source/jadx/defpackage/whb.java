...
public final class whb extends d0d {
    public Long a;
    ...
    /* JADX WARN: Code restructure failed: missing block: B:86:0x022b, code lost:
        r18 = "audience_id";
        r19 = org.dizitart.no2.Constants.TAG_DATA;
        r4 = null;
     */
    ...
    */
    public final java.util.List m(java.lang.String r65, java.util.List r66, java.util.List r67, java.lang.Long r68, java.lang.Long r69) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.whb.m(java.lang.String, java.util.List, java.util.List, java.lang.Long, java.lang.Long):java.util.List");
    }

    public final hgd n(Integer num) {
        if (this.f21695a.containsKey(num)) {
            return (hgd) this.f21695a.get(num);
        }
        hgd hgdVar = new hgd(this, this.f21694a, null);
        this.f21695a.put(num, hgdVar);
        return hgdVar;
    }

    public final boolean o(int i, int i2) {
        hgd hgdVar = (hgd) this.f21695a.get(Integer.valueOf(i));
        if (hgdVar == null) {
            return false;
        }
        return hgd.b(hgdVar).get(i2);
    }
}
