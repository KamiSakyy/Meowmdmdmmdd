...
public class t42 extends f {
    ...
    public class c extends ca5 {
        ...
        public void d(int i) {
            if (this.val$position == t42.this.videosRow) {
                boolean z = true;
                this.val$infoCell.setText(u.d0("AutoDownloadPreloadVideoInfo", e78.Ca, org.telegram.messenger.a.t0(i)));
                if (i <= 2097152) {
                    z = false;
                }
        ...
        public void onBindViewHolder(RecyclerView.d0 d0Var, int i) {
            ...
            if (itemViewType != 0) {
                if (itemViewType != 2) {
                    if (itemViewType != 3) {
                        if (itemViewType != 4) {
                            if (itemViewType == 5) {
                                ...
                                if (i == t42.this.typeSectionRow) {
                                    bv9Var.setText(u.B0("AutoDownloadAudioInfo", e78.W9));
                                    ...
                                    if (t42.this.usageHeaderRow == -1) {
                                        ...
                                        if (t42.this.currentType == 0) {
                                            bv9Var.setText(u.B0("AutoDownloadOnMobileDataInfo", e78.pa));
                                        } else if (t42.this.currentType == 1) {
                                            bv9Var.setText(u.B0("AutoDownloadOnWiFiDataInfo", e78.ua));
                                        } else if (t42.this.currentType == 2) {
                                            bv9Var.setText(u.B0("AutoDownloadOnRoamingDataInfo", e78.ra));
                                        }
                                        bv9Var.setImportantForAccessibility(1);
                                        return;
                                    }
                        ...
                        if (i == t42.this.photosRow) {
                            B0 = u.B0("AutoDownloadPhotos", e78.va);
                            i2 = 1;
                        } else if (i == t42.this.videosRow) {
                            B0 = u.B0("AutoDownloadVideos", e78.Fa);
                            i2 = 4;
                        } else {
                            i2 = 8;
                            B0 = u.B0("AutoDownloadFiles", e78.ba);
                        }
                        if (t42.this.currentType == 0) {
                            ...
                            if ((iArr[i3] & i2) != 0) {
                                ...
                                if (i3 != 0) {
                                    if (i3 != 1) {
                                        if (i3 != 2) {
                                            if (i3 == 3) {
                                                sb2.append(u.B0("AutoDownloadChannels", e78.X9));
                                            }
                                        } else {
                                            sb2.append(u.B0("AutoDownloadGroups", e78.ea));
                                        }
                                    } else {
                                        sb2.append(u.B0("AutoDownloadPm", e78.ya));
                                    }
                                } else {
                                    sb2.append(u.B0("AutoDownloadContacts", e78.Y9));
                                }
                                i4++;
                            }
                            i3++;
                        ...
                        if (i4 == 4) {
                            sb2.setLength(0);
                            if (i == t42.this.photosRow) {
                                sb2.append(u.B0("AutoDownloadOnAllChats", e78.ma));
                            } else {
                                sb2.append(u.d0("AutoDownloadUpToOnAllChats", e78.Ea, org.telegram.messenger.a.t0(j)));
                            }
                        } else if (i4 == 0) {
                            sb2.append(u.B0("AutoDownloadOff", e78.la));
                        } else {
                            if (i == t42.this.photosRow) {
                                sb = new StringBuilder(u.d0("AutoDownloadOnFor", e78.na, sb2.toString()));
                            } else {
                                sb = new StringBuilder(u.d0("AutoDownloadOnUpToFor", e78.sa, org.telegram.messenger.a.t0(j), sb2.toString()));
                            }
                            sb2 = sb;
                        }
                ...
                if (i == t42.this.usageHeaderRow) {
                    nu3Var.setText(u.B0("AutoDownloadDataUsage", e78.aa));
                    return;
                } else if (i == t42.this.typeHeaderRow) {
                    nu3Var.setText(u.B0("AutoDownloadTypes", e78.Da));
                    return;
                } else {
                    return;
                }
            ...
            if (i == t42.this.autoDownloadRow) {
                ...
                ru9Var.i(u.B0("AutoDownloadMedia", e78.ja), t42.this.typePreset.d, false);
    ...
    */
    ...
    public View W(Context context) {
        ...
        if (i == 0) {
            this.actionBar.setTitle(u.B0("AutoDownloadOnMobileData", e78.oa));
        } else if (i == 1) {
            this.actionBar.setTitle(u.B0("AutoDownloadOnWiFiData", e78.ta));
        } else if (i == 2) {
            this.actionBar.setTitle(u.B0("AutoDownloadOnRoamingData", e78.qa));
        }
    ...
    public final void d3(h79 h79Var) {
        ...
        for (int i = 0; i < this.presets.size(); i++) {
            ...
            if (eVar == this.lowPreset) {
                strArr[i] = u.B0("AutoDownloadLow", e78.ga);
            } else if (eVar == this.mediumPreset) {
                strArr[i] = u.B0("AutoDownloadMedium", e78.ka);
            } else if (eVar == this.highPreset) {
                strArr[i] = u.B0("AutoDownloadHigh", e78.fa);
            } else {
                strArr[i] = u.B0("AutoDownloadCustom", e78.Z9);
            }
        }
