...
public class e69 extends PopupWindow {
    ...
    public e69(Context context) {
        ...
        this.d = i;
        Drawable mutate = context.getResources().getDrawable(g68.He).mutate();
        ...
        RecyclerView recyclerView = (RecyclerView) LayoutInflater.from(context).inflate(v68.D, (ViewGroup) null);
    ...
    public final int o(int i, CharSequence[] charSequenceArr) {
        ...
        Rect rect = new Rect();
        TextView textView = (TextView) LayoutInflater.from(context).inflate(v68.C, (ViewGroup) null, false).findViewById(16908308);
