...
public class fr5 extends ow {
    ...
    public static /* synthetic */ void H(f fVar, TLRPC$TL_error tLRPC$TL_error) {
        org.telegram.ui.Components.b.U5(fVar, u.B0("ErrorOccurred", e78.vt) + "\n" + tLRPC$TL_error.f14225a);
    }
    ...
    public static void M(f fVar, int i, boolean z, Runnable runnable, l.r rVar) {
        ...
        if (z) {
            ...
            rVar2.titleTextView.setText(u.B0("DeleteAllFromSelfDone", e78.Wn));
            rVar2.subtitleTextView.setText(u.U("MessagesDeletedHint", i, new Object[0]));
            rVar2.y();
            lVar = rVar2;
        } else {
            p.l lVar2 = new p.l(fVar.E0(), rVar);
            lVar2.textView.setText(u.B0("DeleteAllFromSelfDone", e78.Wn));
            lVar2.y();
            lVar = lVar2;
        }
    ...
    public static CharSequence o(x xVar) {
        if (xVar.Q) {
            return u.B0("MessageTranslateProgress", e78.KI) + " " + u.p0().f13195a.a(xVar.f13365a.b * 1000);
        }
        sv6 sv6Var = xVar.f13375a;
        if (sv6Var != null && !TextUtils.isEmpty((CharSequence) sv6Var.a) && !TextUtils.isEmpty((CharSequence) sv6Var.b)) {
            if (a == null) {
                Drawable e = sz1.e(org.telegram.messenger.b.f12514a, g68.ne);
        ...
        return u.B0("MessageTranslated", e78.LI) + " " + u.p0().f13195a.a(xVar.f13365a.b * 1000);
    }
    ...
    public void n(final f fVar, final fm9 fm9Var, final TLRPC$TL_forumTopic tLRPC$TL_forumTopic, final long j, final l.r rVar) {
        ...
        if (fVar != null && fVar.E0() != null && fm9Var != null) {
            ...
            textView2.setText(u.B0("DeleteAllFromSelf", e78.Tn));
            boolean z3 = u.d;
            if (z3) {
                i4 = 5;
            } else {
            ...
            if (dl1Var != null) {
                ...
                dl1Var.h(u.B0("DeleteAllFromSelfAdmin", e78.Un), "", (org.telegram.messenger.d.c0(fm9Var) || z) ? false : false, false);
                if (u.d) {
            ...
            textView.setText(org.telegram.messenger.a.b3(u.B0("DeleteAllFromSelfAlert", e78.Vn)));
            kVar.v(u.B0("DeleteAll", e78.Pn), new DialogInterface.OnClickListener() { // from class: yq5
