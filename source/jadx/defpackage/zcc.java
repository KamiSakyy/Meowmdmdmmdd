...
public final class zcc extends ucc {
    ...
    */
    public final int b(java.lang.CharSequence r8, byte[] r9, int r10, int r11) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.zcc.b(java.lang.CharSequence, byte[], int, int):int");
    }

    @Override // defpackage.ucc
    public final void c(CharSequence charSequence, ByteBuffer byteBuffer) {
        ucc.d(charSequence, byteBuffer);
    }
}
