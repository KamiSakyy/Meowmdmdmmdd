...
public abstract class pwa {
        ...
        if (activity != null) {
            if (mq9Var != null || fm9Var != null) {
                ...
                if (sharedInstance != null) {
                    ...
                    kVar.x(u.B0(str5, i2)).n(org.telegram.messenger.a.b3(u.d0(str3, i, str2, str4))).v(u.B0("OK", e78.zP), new DialogInterface.OnClickListener() { // from class: kwa
                        @Override // android.content.DialogInterface.OnClickListener
                        public final void onClick(DialogInterface dialogInterface, int i4) {
                            pwa.J(mq9.this, fm9Var, str, z, z2, z3, activity, fVar, q2Var, dialogInterface, i4);
                        }
                    }).p(u.B0("Cancel", e78.Le), null).G();
    ...
    public static /* synthetic */ void W(int i, boolean[] zArr, File file, TLRPC$TL_phone_setCallRating tLRPC$TL_phone_setCallRating, ArrayList arrayList, Context context, org.telegram.tgnet.a aVar, TLRPC$TL_error tLRPC$TL_error) {
        ...
        if (zArr[0] && file.exists() && tLRPC$TL_phone_setCallRating.b < 4) {
            ...
            Toast.makeText(context, u.B0("CallReportSent", e78.Ae), 1).show();
        }
    }
    ...
    public static /* synthetic */ void X(jz jzVar, int[] iArr, LinearLayout linearLayout, EditTextBoldCursor editTextBoldCursor, final boolean[] zArr, long j, long j2, boolean z, int i, final File file, final Context context, org.telegram.ui.ActionBar.e eVar, TextView textView, dl1 dl1Var, TextView textView2, View view, View view2) {
        ...
        if (jzVar.getRating() < 4 && iArr[0] != 1) {
            ...
            eVar.setTitle(u.B0("CallReportHint", e78.xe));
            ...
            ((TextView) view).setText(u.B0("Send", e78.x60).toUpperCase());
            return;
        }
        final int i2 = tla.o;
    ...
    public static void b0(final Activity activity, final Runnable runnable, int i) {
        ...
        e.k t = kVar.n(org.telegram.messenger.a.b3(u.B0(str, i2))).v(u.B0("Settings", e78.u80), new DialogInterface.OnClickListener() { // from class: tva
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i4) {
                pwa.K(activity, dialogInterface, i4);
            }
        }).p(u.B0("ContactsPermissionAlertNotNow", e78.Cl), null).t(new DialogInterface.OnDismissListener() { // from class: ewa
    ...
    public static void c0(Context context) {
        ...
        new e.k(context).x(u.B0("DebugMenuCallSettings", e78.Rm)).E(linearLayout).G();
    }
    ...
    public static void e0(final Context context, final Runnable runnable, boolean z, final long j, final long j2, final int i, final boolean z2) {
        ...
        textView.setText(u.B0("VoipRateCallAlert", e78.Wo0));
        ...
        for (int i4 = 9; i3 < i4; i4 = 9) {
            if (strArr[i3] != null) {
                ...
                switch (i3) {
                    case 0:
                        B0 = u.B0("RateCallVideoDistorted", e78.a10);
                        break;
                    case 1:
                        B0 = u.B0("RateCallVideoPixelated", e78.b10);
                        break;
                    case 2:
                        B0 = u.B0("RateCallEcho", e78.V00);
                        break;
                    case 3:
                        B0 = u.B0("RateCallNoise", e78.X00);
                        break;
                    case 4:
                        B0 = u.B0("RateCallInterruptions", e78.W00);
                        break;
                    case 5:
                        B0 = u.B0("RateCallDistorted", e78.T00);
                        break;
                    case 6:
                        B0 = u.B0("RateCallSilentLocal", e78.Y00);
                        break;
                    case 7:
                        B0 = u.B0("RateCallSilentRemote", e78.Z00);
                        break;
                    case 8:
                        B0 = u.B0("RateCallDropped", e78.U00);
                        break;
                    default:
                        B0 = null;
                        break;
        ...
        editTextBoldCursor.setHint(u.B0("VoipFeedbackCommentHint", e78.mm0));
        ...
        dl1Var2.h(u.B0("CallReportIncludeLogs", e78.ye), null, true, false);
        ...
        textView2.setText(u.B0("CallReportLogsExplain", e78.ze));
        ...
        final org.telegram.ui.ActionBar.e a2 = new e.k(context).x(u.B0("CallMessageReportProblem", e78.pe)).E(linearLayout).v(u.B0("Send", e78.x60), new DialogInterface.OnClickListener() { // from class: nwa
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i5) {
                pwa.S(dialogInterface, i5);
            }
        }).p(u.B0("Cancel", e78.Le), null).t(new DialogInterface.OnDismissListener() { // from class: owa
            @Override // android.content.DialogInterface.OnDismissListener
            public final void onDismiss(DialogInterface dialogInterface) {
    ...
    public static void h0(fm9 fm9Var, wn9 wn9Var, String str, boolean z, Boolean bool, final Activity activity, f fVar, q2 q2Var) {
        ...
        if (ConnectionsManager.getInstance(tla.o).getConnectionState() != 3) {
            ...
            e.k v = x.n(u.B0(str3, i2)).v(u.B0("OK", e78.zP), null);
            if (z2) {
                final Intent intent = new Intent("android.settings.AIRPLANE_MODE_SETTINGS");
                if (intent.resolveActivity(activity.getPackageManager()) != null) {
                    v.q(u.B0("VoipOfflineOpenSettings", e78.Fo0), new DialogInterface.OnClickListener() { // from class: jwa
                        @Override // android.content.DialogInterface.OnClickListener
    ...
    public static void j0(final mq9 mq9Var, final boolean z, final boolean z2, final Activity activity, final nq9 nq9Var, final q2 q2Var, boolean z3) {
        ...
        if (nq9Var != null && nq9Var.f11239c) {
            new e.k(activity).x(u.B0("VoipFailed", e78.lm0)).n(org.telegram.messenger.a.b3(u.d0("CallNotAvailable", e78.we, org.telegram.messenger.e.E0(mq9Var.f10558a, mq9Var.f10565b)))).v(u.B0("OK", e78.zP), null).G();
            ...
            e.k v = x.n(u.B0(str2, i3)).v(u.B0("OK", e78.zP), null);
            if (z4) {
                final Intent intent = new Intent("android.settings.AIRPLANE_MODE_SETTINGS");
                if (intent.resolveActivity(activity.getPackageManager()) != null) {
                    v.q(u.B0("VoipOfflineOpenSettings", e78.Fo0), new DialogInterface.OnClickListener() { // from class: hwa
                        @Override // android.content.DialogInterface.OnClickListener
                        public final void onClick(DialogInterface dialogInterface, int i4) {
                            activity.startActivity(intent);
                        }
            ...
            new e.k(activity).x(u.B0("ConfirmCall", e78.dl)).n(org.telegram.messenger.a.b3(u.d0("CallTo", e78.Ce, org.telegram.messenger.e.E0(mq9Var.f10558a, mq9Var.f10565b)))).v(u.B0("OK", e78.zP), new DialogInterface.OnClickListener() { // from class: iwa
                @Override // android.content.DialogInterface.OnClickListener
                public final void onClick(DialogInterface dialogInterface, int i4) {
    ...
    public static void y(final mq9 mq9Var, final fm9 fm9Var, final String str, final wn9 wn9Var, boolean z, final boolean z2, final boolean z3, final boolean z4, final Activity activity, final f fVar, final q2 q2Var, boolean z5, boolean z6) {
        ...
        if (activity != null) {
            ...
            if (z5 && fm9Var != null && !z4 && (T72 = q2Var.l().T7(fm9Var.f5600a)) != null && (dp9Var = T72.f6235a) != null) {
                ...
                x.n(u.B0(str3, i2)).v(u.B0("VoipChatJoin", e78.Sl0), new DialogInterface.OnClickListener() { // from class: bwa
                    @Override // android.content.DialogInterface.OnClickListener
                    public final void onClick(DialogInterface dialogInterface, int i3) {
