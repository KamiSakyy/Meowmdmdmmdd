...
public class g22 extends Drawable {
    public int color;
    ...
    public g22(Context context, int i, String str) {
        Paint paint = new Paint(1);
        this.xRefPaint = paint;
        this.iconDrawable = sz1.e(context, i);
        this.colorKey = str;
        this.paint.setStyle(Paint.Style.STROKE);
        this.paint.setStrokeWidth(a.g0(1.7f));
        this.paint.setStrokeCap(Paint.Cap.ROUND);
        paint.setColor(-16777216);
        paint.setXfermode(new PorterDuffXfermode(PorterDuff.Mode.CLEAR));
        paint.setStyle(Paint.Style.STROKE);
        paint.setStrokeWidth(a.g0(2.5f));
    }
    ...
    */
    public void draw(android.graphics.Canvas r13) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.g22.draw(android.graphics.Canvas):void");
    }
