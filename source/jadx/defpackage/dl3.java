...
public abstract class dl3 {
    ...
    public static Shader b(Resources resources, XmlPullParser xmlPullParser, AttributeSet attributeSet, Resources.Theme theme) {
        ...
        if (name.equals("gradient")) {
            ...
            float f = yha.f(k, xmlPullParser, "startX", o78.E, 0.0f);
            float f2 = yha.f(k, xmlPullParser, "startY", o78.F, 0.0f);
            float f3 = yha.f(k, xmlPullParser, "endX", o78.G, 0.0f);
            float f4 = yha.f(k, xmlPullParser, "endY", o78.H, 0.0f);
            float f5 = yha.f(k, xmlPullParser, "centerX", o78.z, 0.0f);
            float f6 = yha.f(k, xmlPullParser, "centerY", o78.A, 0.0f);
            int g = yha.g(k, xmlPullParser, Constants.TAG_TYPE, o78.y, 0);
            int b = yha.b(k, xmlPullParser, "startColor", o78.w, 0);
            boolean j = yha.j(xmlPullParser, "centerColor");
            int b2 = yha.b(k, xmlPullParser, "centerColor", o78.D, 0);
            int b3 = yha.b(k, xmlPullParser, "endColor", o78.x, 0);
            int g2 = yha.g(k, xmlPullParser, "tileMode", o78.C, 0);
            float f7 = yha.f(k, xmlPullParser, "gradientRadius", o78.B, 0.0f);
            k.recycle();
    ...
    */
    public static defpackage.dl3.a c(android.content.res.Resources r8, org.xmlpull.v1.XmlPullParser r9, android.util.AttributeSet r10, android.content.res.Resources.Theme r11) {
        ...
        L34:
            ...
            int r5 = defpackage.o78.I
            boolean r5 = r3.hasValue(r5)
            int r6 = defpackage.o78.J
