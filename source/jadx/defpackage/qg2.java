...
public class qg2 extends LinearLayout {
    ...
    public qg2(final Context context) {
        ...
        this.subtitleView.setInAnimation(context, p58.a);
        this.subtitleView.setOutAnimation(context, p58.b);
    ...
    public void p(boolean z) {
        ...
        if (z) {
            String B0 = u.B0("NoChatsContactsHelp", e78.DK);
    ...
    public void setType(int i) {
        ...
        if (i != 0 && i != 1) {
            if (i != 2) {
                ...
                i2 = y68.g0;
                B0 = u.B0("FilterAddingChatsInfo", e78.Fw);
                this.titleView.setText(u.B0("FilterAddingChats", e78.Ew));
            } else {
                this.imageView.setAutoRepeat(false);
                i2 = y68.h0;
                B0 = u.B0("FilterNoChatsToDisplayInfo", e78.vx);
                this.titleView.setText(u.B0("FilterNoChatsToDisplay", e78.ux));
            }
        } else {
            i2 = y68.m3;
            B0 = u.B0("NoChatsHelp", e78.EK);
            this.titleView.setText(u.B0("NoChats", e78.CK));
        }
        if (i2 != 0) {
            ...
            if (this.currentType == 1) {
                if (i()) {
                    ...
                    String B02 = u.B0("NoChatsContactsHelp", e78.DK);
                    if (org.telegram.messenger.a.Y1() && !org.telegram.messenger.a.X1()) {
                        B02 = B02.replace('\n', ' ');
                    }
