...
public class ss extends qx implements a0.d {
        ...
        public void h(RecyclerView.d0 d0Var, int i, boolean z) {
            switch (a.a[ita.a(d0Var.getItemViewType()).ordinal()]) {
                ...
                case 2:
                    ...
                    if (i == ss.this.d) {
                        nu3Var.setText(u.B0("EditExceptionTitle", e78.zr));
                        return;
                    }
                    return;
                case 3:
                ...
                case 4:
                    ...
                    if (i == ss.this.h) {
                        bv9Var.setText(u.B0("EditExceptionHint", e78.yr));
                        return;
                    }
                    return;
                case 5:
                    ...
                    if (i == ss.this.i) {
                        ...
                        uw9Var.c(u.B0("EditDeleteException", e78.xr), false);
                        return;
                    }
                    return;
                case 6:
    ...
    @Override // defpackage.qx
    public String l2() {
        return u.B0("ChannelEdit", e78.qg);
    }
    ...
    public void p2(View view, int i, float f, float f2) {
        ...
        if (i >= i2 && i < this.f) {
            ...
            kVar.n(u.d0("EditRemoveExceptionText", e78.Or, this.a.f5602a));
            kVar.v(u.B0("Delete", e78.Kn), new DialogInterface.OnClickListener() { // from class: os
