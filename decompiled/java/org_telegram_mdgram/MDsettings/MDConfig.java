...
public abstract class MDConfig {
    ...
    public static boolean useSystemEmoji = e0.R;
    public static SharedPreferences preferences = b.f12514a.getSharedPreferences("mainconfig", 0);
    ...
    public static void A() {
        ...
        SharedPreferences.Editor edit = b.f12514a.getSharedPreferences("mdconfig", 0).edit();
        ...
        if (!loadSystemEmojiFailed && systemEmojiTypeface == null) {
            try {
                ...
                while (true) {
                    ...
                    if (matcher.find()) {
                        ...
                        l.k("emoji font file fonts.xml = " + matcher.group(1));
                        break;
                    }
                }
            ...
            if (systemEmojiTypeface == null) {
                try {
                    ...
                    l.k("emoji font file = NotoColorEmoji.ttf");
                } catch (Exception e2) {
                    l.p(e2);
    ...
    public static void c() {
        synchronized (sync) {
            if (!configLoaded && b.f12514a != null) {
                ...
                useSystemEmoji = sharedPreferences.getBoolean("useSystemEmoji", e0.R);
