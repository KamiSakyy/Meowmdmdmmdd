...
public class m55 extends f {
        ...
        public void onBindViewHolder(RecyclerView.d0 d0Var, int i) {
            ...
            if (itemViewType != 1) {
                ...
                if (itemViewType != 2) {
                    if (itemViewType != 3) {
                        if (itemViewType != 4) {
                            ...
                            if (i == m55.this.v) {
                                ...
                                bv9Var.setText(u.B0("TranslateMessagesInfo1", e78.Eg0));
                                return;
                                ...
                                if (arrayList != null && arrayList2 != null) {
                                    ...
                                    bv9Var.setTopPadding(0);
                                    bv9Var.setText(u.d0("TranslationProviderInfo", e78.Kg0, arrayList.get(indexOf)));
                                    return;
                                }
                                return;
                            } else if (i == m55.this.B) {
                                bv9Var.setBackground(l.u2(this.a, g68.g2, "windowBackgroundGrayShadow"));
                                bv9Var.setText(u.B0("IdTypeAbout", e78.lB));
                                return;
                            } else {
                                return;
                            }
                        ...
                        if (i == m55.this.y) {
                            nu3Var.setText(u.B0("General", e78.gz));
                            return;
                        } else if (i == m55.this.h) {
                            nu3Var.setText(u.B0("MD_iconLauncher", e78.aH));
                            return;
                        } else if (i == m55.this.j) {
                            nu3Var.setText(u.B0("MD_fontS", e78.WG));
                            return;
                        } else if (i == m55.this.n) {
                            nu3Var.setText(u.B0("TranslateMessages", e78.Dg0));
                            return;
                        } else {
                            return;
                        }
                    ...
                    ru9Var.h(true, null);
                    if (i == m55.this.g) {
                        ru9Var.i(u.B0("HidePhone", e78.OA), MDConfig.hidePhone, false);
                        return;
                    } else if (i == m55.this.c) {
                        ru9Var.i(u.B0("AvatarAsBackground", e78.vb), MDConfig.avatarAsDrawerBackground, true);
                        return;
                    } else if (i == m55.this.d) {
                        ru9Var.i(u.B0("BlurAvatarBackground", e78.tc), MDConfig.avatarBackgroundBlur, true);
                        return;
                    } else if (i == m55.this.e) {
                        ru9Var.i(u.B0("DarkenAvatarBackground", e78.Gm), MDConfig.avatarBackgroundDarken, true);
                        return;
                    } else if (i == m55.this.A) {
                        ru9Var.i(u.B0("AskBeforeCalling", e78.j8), MDConfig.askBeforeCall, true);
                        return;
                    } else if (i == m55.this.k) {
                        ru9Var.i(u.B0("UseSystemFont", e78.Ei0), MDConfig.useSystemFont, true);
                        return;
                    } else if (i == m55.this.t) {
                        ru9Var.j(u.B0("KeepMarkdown", e78.UD), u.B0("KeepMarkdownDesc", e78.VD), MDConfig.keepTranslationMarkdown, true, false);
                        return;
                    } else if (i == m55.this.m) {
                        ru9Var.j(u.B0("NumberRounding", e78.wP), u.B0("NumberRoundingDesc", e78.xP), MDConfig.roundedNumbers, true, true);
                        return;
                    } else {
                        return;
                    }
                ...
                if (i == m55.this.p) {
                    ...
                    if (arrayList3 != null && arrayList4 != null) {
                        ...
                        if (indexOf2 < 0) {
                            uw9Var.d(u.B0("TranslationProviderShort", e78.Lg0), (CharSequence) arrayList3.get(1), true);
                            return;
                        } else {
                            uw9Var.d(u.B0("TranslationProviderShort", e78.Lg0), (CharSequence) arrayList3.get(indexOf2), true);
                            return;
                        }
                    }
                    return;
                    ...
                    uw9Var.d(u.B0("TranslationLanguage", e78.Ig0), I2, true);
                    return;
                    ...
                    if (A2.size() == 1) {
                        ...
                        str = u.B0("EmptyExceptions", e78.As);
                    }
                    if (str == null) {
                    ...
                    uw9Var.d(u.B0("DoNotTranslate", e78.uq), str, true);
                    return;
                } else if (i == m55.this.x) {
                    int i3 = MDConfig.deepLFormality;
                    if (i3 != 0) {
                        if (i3 != 1) {
                            B04 = u.B0("DeepLFormalityLess", e78.Gn);
                        } else {
                            B04 = u.B0("DeepLFormalityMore", e78.Hn);
                        }
                    } else {
                        B04 = u.B0("DeepLFormalityDefault", e78.Fn);
                    }
                    uw9Var.d(u.B0("DeepLFormality", e78.En), B04, true);
                    return;
                } else if (i == m55.this.o) {
                    if (MDConfig.translatorStyle != 0) {
                        B03 = u.B0("TranslatorTypeTG", e78.Og0);
                    } else {
                        B03 = u.B0("TranslatorTypeOwl", e78.Ng0);
                    }
                    uw9Var.d(u.B0("TranslatorType", e78.Mg0), B03, true);
                    return;
                } else if (i == m55.this.z) {
                    int i4 = MDConfig.idType;
                    if (i4 != 0) {
                        if (i4 != 2) {
                            B02 = u.B0("IdTypeAPI", e78.kB);
                        } else {
                            B02 = u.B0("IdTypeBOTAPI", e78.mB);
                        }
                    } else {
                        B02 = u.B0("IdTypeHidden", e78.nB);
                    }
                    uw9Var.d(u.B0("IdType", e78.jB), B02, false);
                    return;
                } else if (i == m55.this.l) {
                    uw9Var.c(u.B0("MD_fontS", e78.WG), true);
                    return;
                    ...
                    if (m55.this.f10008a) {
                        ...
                        B0 = u.B0("UseLessDataNever", e78.li0);
                    }
                    String B05 = u.B0("AutoTranslate", e78.cb);
                    if (m55.this.t == -1) {
                        z = false;
                    }
                    uw9Var.d(B05, B0, z);
        ...
        public RecyclerView.d0 onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            switch (i) {
                ...
                case 8:
                    ...
                    bl2Var.setBackground(l.u2(this.a, g68.f2, "windowBackgroundGrayShadow"));
                    sz8Var = bl2Var;
                    break;
                case 9:
    ...
    public /* synthetic */ void X2(Context context, View view, int i, float f, float f2) {
        if (i == this.g) {
            ...
            arrayList.add(u.B0("IdTypeHidden", e78.nB));
            arrayList2.add(0);
            arrayList.add(u.B0("IdTypeAPI", e78.kB));
            arrayList2.add(1);
            arrayList.add(u.B0("IdTypeBOTAPI", e78.mB));
            arrayList2.add(2);
            ll7.c(arrayList, u.B0("IdType", e78.jB), arrayList2.indexOf(Integer.valueOf(MDConfig.idType)), context, new ll7.a() { // from class: h55
            ...
            arrayList3.add(u.B0("TranslatorTypeOwl", e78.Ng0));
            arrayList4.add(0);
            arrayList3.add(u.B0("TranslatorTypeTG", e78.Og0));
            arrayList4.add(1);
            ll7.c(arrayList3, u.B0("TranslatorType", e78.Mg0), arrayList4.indexOf(Integer.valueOf(MDConfig.translatorStyle)), context, new ll7.a() { // from class: i55
                @Override // defpackage.ll7.a
                public final void a(int i2) {
            ...
            if (i == this.r) {
                if (!this.f10008a) {
                    q.p0(this).E(u.B0("BrokenMLKit", e78.Gd), u.B0("BrokenMLKitDetail", e78.Hd), null).T();
                } else {
                    z1(new xi2());
                }
            } else if (i == this.x) {
                ...
                arrayList5.add(u.B0("DeepLFormalityDefault", e78.Fn));
                arrayList6.add(0);
                arrayList5.add(u.B0("DeepLFormalityMore", e78.Hn));
                arrayList6.add(1);
                arrayList5.add(u.B0("DeepLFormalityLess", e78.Gn));
                arrayList6.add(2);
                ll7.c(arrayList5, u.B0("DeepLFormality", e78.En), arrayList6.indexOf(Integer.valueOf(MDConfig.deepLFormality)), context, new ll7.a() { // from class: k55
                    @Override // defpackage.ll7.a
    ...
    public View W(final Context context) {
        ...
        this.actionBar.setTitle(u.B0("General", e78.gz));
