...
public class k {
    ...
    public void f() {
        ...
        if (view != null) {
            ...
            Fragment fragment5 = this.f1208a;
            fragment5.f1058a.setTag(org.telegram.mdgram.R.id.fragment_container_view_tag, fragment5);
            if (viewGroup != null) {
                b();
            }
    ...
    public void j() {
        ...
        if (fragment.f1084c && fragment.f1085d && !fragment.f1087f) {
            ...
            if (view != null) {
                view.setSaveFromParentEnabled(false);
                Fragment fragment3 = this.f1208a;
                fragment3.f1058a.setTag(org.telegram.mdgram.R.id.fragment_container_view_tag, fragment3);
                Fragment fragment4 = this.f1208a;
                if (fragment4.g) {
