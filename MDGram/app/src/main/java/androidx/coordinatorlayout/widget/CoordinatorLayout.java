...
public class CoordinatorLayout extends ViewGroup implements zi6, aj6 {
    ...
    */
    ...
    public CoordinatorLayout(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, org.telegram.mdgram.R.attr.coordinatorLayoutStyle);
    }
    ...
    public CoordinatorLayout(Context context, AttributeSet attributeSet, int i) {
        ...
        if (i == 0) {
            obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, n78.f10854b, 0, org.telegram.mdgram.R.style.Widget.Support.CoordinatorLayout);
        } else {
            obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, n78.f10854b, i, 0);
        }
        if (Build.VERSION.SDK_INT >= 29) {
            if (i == 0) {
                saveAttributeDataForStyleable(context, n78.f10854b, attributeSet, obtainStyledAttributes, 0, org.telegram.mdgram.R.style.Widget.Support.CoordinatorLayout);
            } else {
        ...
        this.f965a = obtainStyledAttributes.getDrawable(1);
    ...
    public static class e extends ViewGroup.MarginLayoutParams {
        ...
        public e(Context context, AttributeSet attributeSet) {
            ...
            this.f985a = hasValue;
            if (hasValue) {
                this.f983a = CoordinatorLayout.I(context, attributeSet, obtainStyledAttributes.getString(3));
            }
            obtainStyledAttributes.recycle();
            b bVar = this.f983a;
            if (bVar != null) {
