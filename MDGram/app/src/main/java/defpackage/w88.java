...
public abstract class w88 extends ConstraintLayout {
    ...
    public w88(Context context, AttributeSet attributeSet, int i) {
        ...
        LayoutInflater.from(context).inflate(org.telegram.mdgram.R.layout.material_radial_view_group, this);
        gqa.v0(this, h());
    ...
    public final void g(List list, c cVar, int i) {
        ...
        float f = 0.0f;
        while (it.hasNext()) {
            cVar.g(((View) it.next()).getId(), org.telegram.mdgram.R.id.circle_center, i, f);
            f += 360.0f / list.size();
        }
    }
    ...
    public void m() {
        ...
        for (int i = 0; i < getChildCount(); i++) {
            ...
            if (childAt.getId() != org.telegram.mdgram.R.id.circle_center && !l(childAt)) {
                int i2 = (Integer) childAt.getTag(org.telegram.mdgram.R.id.material_clock_level);
                if (i2 == null) {
                    i2 = 1;
                }
