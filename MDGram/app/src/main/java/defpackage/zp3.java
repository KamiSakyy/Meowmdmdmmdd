...
public class zp3 extends FrameLayout implements a0.d, VoIPService.StateListener {
    ...
    public zp3(Context context, int i, boolean z) {
        ...
        int i3 = org.telegram.mdgram.R.raw.voice_outlined;
        this.bigMicDrawable = new RLottieDrawable(i3, "" + org.telegram.mdgram.R.raw.voice_outlined, org.telegram.messenger.a.e0(22.0f), org.telegram.messenger.a.e0(30.0f), true, null);
    ...
    */
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        if (qp3.u() != null) {
            if (qp3.u().showAlert) {
                i = org.telegram.mdgram.R.string.AccDescrCloseMenu;
                str = "AccDescrCloseMenu";
            } else {
                i = org.telegram.mdgram.R.string.AccDescrOpenMenu2;
    ...
    public void setState(int i) {
        ...
        if (sharedInstance != null && d.P(sharedInstance.getChat())) {
            B0 = u.B0("VoipChannelVoiceChat", org.telegram.mdgram.R.string.VoipChannelVoiceChat);
        } else {
            B0 = u.B0("VoipGroupVoiceChat", org.telegram.mdgram.R.string.VoipGroupVoiceChat);
        }
        if (i == 0) {
            B0 = B0 + ", " + u.B0("VoipTapToMute", org.telegram.mdgram.R.string.VoipTapToMute);
        } else if (i == 2) {
            B0 = B0 + ", " + u.B0("Connecting", org.telegram.mdgram.R.string.Connecting);
        } else if (i == 3) {
            B0 = B0 + ", " + u.B0("VoipMutedByAdmin", org.telegram.mdgram.R.string.VoipMutedByAdmin);
        }
