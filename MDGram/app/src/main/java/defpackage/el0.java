...
public abstract class el0 extends LinearLayout {
    ...
    public class a extends FrameLayout {
        ...
        public a(Context context, boolean z) {
            ...
            this.f4950a = z;
            if (z) {
                i = org.telegram.mdgram.R.string.ActMatStyle;
                str = "ActMatStyle";
            } else {
                i = org.telegram.mdgram.R.string.ActIosStyle;
                str = "ActIosStyle";
            }
            ...
            if (this.f4950a) {
                View inflate = LayoutInflater.from(el0.this.getContext()).inflate(org.telegram.mdgram.R.layout.md_action, (ViewGroup) null);
                addView(inflate, cn4.c(-1, -1.0f, 19, 5.0f, 0.0f, 5.0f, 0.0f));
                ((ImageView) inflate.findViewById(org.telegram.mdgram.R.id.mdSction)).setColorFilter(new PorterDuffColorFilter(l.B1("switchTrack"), PorterDuff.Mode.SRC_IN));
                return;
            }
            View inflate2 = LayoutInflater.from(el0.this.getContext()).inflate(org.telegram.mdgram.R.layout.ios_action, (ViewGroup) null);
            addView(inflate2, cn4.c(-1, -1.0f, 19, 5.0f, 0.0f, 5.0f, 0.0f));
            ((ImageView) inflate2.findViewById(org.telegram.mdgram.R.id.iosSction)).setColorFilter(new PorterDuffColorFilter(l.B1("switchTrack"), PorterDuff.Mode.SRC_IN));
        }
