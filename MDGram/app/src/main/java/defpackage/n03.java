...
public class n03 extends FrameLayout implements a0.d {
    ...
    public n03(Context context, l.r rVar) {
        ...
        textView3.setText(u.B0("StickersRemove", org.telegram.mdgram.R.string.StickersRemove));
        ...
        rm7Var.h(u.B0("Unlock", org.telegram.mdgram.R.string.Unlock), new View.OnClickListener() { // from class: m03
