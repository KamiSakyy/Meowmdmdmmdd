        ...
        if (z) {
            ...
            for (int i = 0; i < strArr.length; i++) {
                if (i != 0) {
                    ...
                    Drawable mutate = getContext().getResources().getDrawable(org.telegram.mdgram.R.drawable.settings_arrow).mutate();
            ...
            if (strArr != null) {
                ...
                for (int i2 = 0; i2 < strArr.length; i2++) {
                    if (i2 != 0) {
                        ...
                        Drawable mutate2 = getContext().getResources().getDrawable(org.telegram.mdgram.R.drawable.settings_arrow).mutate();
