...
public class qy1 extends LinearLayout implements a0.d {
    ...
    public qy1(Context context) {
        ...
        this.titleTextView.setText(u.B0("NoContactsYet", org.telegram.mdgram.R.string.NoContactsYet));
        ...
        while (true) {
            if (i2 < 3) {
                ...
                if (i2 != 0) {
                    if (i2 != 1) {
                        if (i2 == 2) {
                            textView2.setText(u.B0("NoContactsYetLine3", org.telegram.mdgram.R.string.NoContactsYetLine3));
                        }
                    } else {
                        textView2.setText(u.B0("NoContactsYetLine2", org.telegram.mdgram.R.string.NoContactsYetLine2));
                    }
                } else {
                    textView2.setText(u.B0("NoContactsYetLine1", org.telegram.mdgram.R.string.NoContactsYetLine1));
                }
                if (u.d) {
