...
public class qo4 extends o {
    ...
    public class b extends v1.s {
        ...
        public void onBindViewHolder(RecyclerView.d0 d0Var, int i) {
            ...
            if (d0Var.getItemViewType() == 4) {
                ...
                if (qo4.this.a == 2) {
                    nu3Var.setText(u.B0("YourPublicCommunities", org.telegram.mdgram.R.string.YourPublicCommunities));
                } else {
                    nu3Var.setText(u.B0("LastActiveCommunities", org.telegram.mdgram.R.string.LastActiveCommunities));
                }
            }
        }
    ...
    public class c extends LinearLayout {
        public c(Context context) {
            ...
            if (qo4.this.a == 6) {
                textView.setText(u.B0("FileTooLarge", org.telegram.mdgram.R.string.FileTooLarge));
            } else {
                textView.setText(u.B0("LimitReached", org.telegram.mdgram.R.string.LimitReached));
            }
    ...
    public static d i2(int i, int i2) {
        ...
        if (i == 0) {
            dVar.b = y.u8(i2).g0;
            dVar.c = y.u8(i2).h0;
            dVar.a = org.telegram.mdgram.R.drawable.msg_limit_pin;
            dVar.f17393a = u.d0("LimitReachedPinDialogs", org.telegram.mdgram.R.string.LimitReachedPinDialogs, Integer.valueOf(dVar.b), Integer.valueOf(dVar.c));
            dVar.f17394b = u.d0("LimitReachedPinDialogsPremium", org.telegram.mdgram.R.string.LimitReachedPinDialogsPremium, Integer.valueOf(dVar.c));
            dVar.f17395c = u.d0("LimitReachedPinDialogsLocked", org.telegram.mdgram.R.string.LimitReachedPinDialogsLocked, Integer.valueOf(dVar.b));
        } else if (i == 2) {
            dVar.b = y.u8(i2).i0;
            dVar.c = y.u8(i2).j0;
            dVar.a = org.telegram.mdgram.R.drawable.msg_limit_links;
            dVar.f17393a = u.d0("LimitReachedPublicLinks", org.telegram.mdgram.R.string.LimitReachedPublicLinks, Integer.valueOf(dVar.b), Integer.valueOf(dVar.c));
            dVar.f17394b = u.d0("LimitReachedPublicLinksPremium", org.telegram.mdgram.R.string.LimitReachedPublicLinksPremium, Integer.valueOf(dVar.c));
            dVar.f17395c = u.d0("LimitReachedPublicLinksLocked", org.telegram.mdgram.R.string.LimitReachedPublicLinksLocked, Integer.valueOf(dVar.b));
        } else if (i == 3) {
            dVar.b = y.u8(i2).c0;
            dVar.c = y.u8(i2).d0;
            dVar.a = org.telegram.mdgram.R.drawable.msg_limit_folder;
            dVar.f17393a = u.d0("LimitReachedFolders", org.telegram.mdgram.R.string.LimitReachedFolders, Integer.valueOf(dVar.b), Integer.valueOf(dVar.c));
            dVar.f17394b = u.d0("LimitReachedFoldersPremium", org.telegram.mdgram.R.string.LimitReachedFoldersPremium, Integer.valueOf(dVar.c));
            dVar.f17395c = u.d0("LimitReachedFoldersLocked", org.telegram.mdgram.R.string.LimitReachedFoldersLocked, Integer.valueOf(dVar.b));
        } else if (i == 4) {
            dVar.b = y.u8(i2).e0;
            dVar.c = y.u8(i2).f0;
            dVar.a = org.telegram.mdgram.R.drawable.msg_limit_chats;
            dVar.f17393a = u.d0("LimitReachedChatInFolders", org.telegram.mdgram.R.string.LimitReachedChatInFolders, Integer.valueOf(dVar.b), Integer.valueOf(dVar.c));
            dVar.f17394b = u.d0("LimitReachedChatInFoldersPremium", org.telegram.mdgram.R.string.LimitReachedChatInFoldersPremium, Integer.valueOf(dVar.c));
            dVar.f17395c = u.d0("LimitReachedChatInFoldersLocked", org.telegram.mdgram.R.string.LimitReachedChatInFoldersLocked, Integer.valueOf(dVar.b));
        } else if (i == 5) {
            dVar.b = y.u8(i2).W;
            dVar.c = y.u8(i2).X;
            dVar.a = org.telegram.mdgram.R.drawable.msg_limit_groups;
            dVar.f17393a = u.d0("LimitReachedCommunities", org.telegram.mdgram.R.string.LimitReachedCommunities, Integer.valueOf(dVar.b), Integer.valueOf(dVar.c));
            dVar.f17394b = u.d0("LimitReachedCommunitiesPremium", org.telegram.mdgram.R.string.LimitReachedCommunitiesPremium, Integer.valueOf(dVar.c));
            dVar.f17395c = u.d0("LimitReachedCommunitiesLocked", org.telegram.mdgram.R.string.LimitReachedCommunitiesLocked, Integer.valueOf(dVar.b));
        } else if (i == 6) {
            dVar.b = 100;
            dVar.c = 200;
            dVar.a = org.telegram.mdgram.R.drawable.msg_limit_folder;
            dVar.f17393a = u.d0("LimitReachedFileSize", org.telegram.mdgram.R.string.LimitReachedFileSize, "2 GB", "4 GB");
            dVar.f17394b = u.d0("LimitReachedFileSizePremium", org.telegram.mdgram.R.string.LimitReachedFileSizePremium, "4 GB");
            dVar.f17395c = u.d0("LimitReachedFileSizeLocked", org.telegram.mdgram.R.string.LimitReachedFileSizeLocked, "2 GB");
        } else if (i == 7) {
            dVar.b = 3;
            dVar.c = 10;
            dVar.a = org.telegram.mdgram.R.drawable.msg_limit_accounts;
            dVar.f17393a = u.d0("LimitReachedAccounts", org.telegram.mdgram.R.string.LimitReachedAccounts, 3, Integer.valueOf(dVar.c));
            dVar.f17394b = u.d0("LimitReachedAccountsPremium", org.telegram.mdgram.R.string.LimitReachedAccountsPremium, Integer.valueOf(dVar.c));
            dVar.f17395c = u.d0("LimitReachedAccountsPremium", org.telegram.mdgram.R.string.LimitReachedAccountsPremium, Integer.valueOf(dVar.b));
        }
        return dVar;
    }
        ...
        if (tLRPC$TL_error == null) {
            ...
            for (int i = 0; i < tLRPC$TL_messages_inactiveChats.b.size(); i++) {
                ...
                if (org.telegram.messenger.d.V(fm9Var)) {
                    arrayList.add(u.d0("InactiveChatSignature", org.telegram.mdgram.R.string.InactiveChatSignature, u.U("Members", fm9Var.d, new Object[0]), U));
                } else if (org.telegram.messenger.d.M(fm9Var)) {
                    arrayList.add(u.d0("InactiveChannelSignature", org.telegram.mdgram.R.string.InactiveChannelSignature, U));
                } else {
                    arrayList.add(u.d0("InactiveChatSignature", org.telegram.mdgram.R.string.InactiveChatSignature, u.U("Members", fm9Var.d, new Object[0]), U));
                }
            }
    ...
    public void E2() {
        int i;
        if (!tla.p(this.currentAccount).x() && !y.u8(this.currentAccount).f13499M && !this.f17391c) {
            this.f17384a.f18166a.setText(u.B0("IncreaseLimit", org.telegram.mdgram.R.string.IncreaseLimit));
            rm7 rm7Var = this.f17384a;
            if (this.a == 7) {
                i = org.telegram.mdgram.R.raw.addone_icon;
            } else {
                i = org.telegram.mdgram.R.raw.double_icon;
            }
            rm7Var.setIcon(i);
            return;
        }
        this.f17384a.f18166a.setText(u.z0(org.telegram.mdgram.R.string.OK));
        this.f17384a.f();
    }
    ...
    public final void v2() {
        ...
        if (arrayList.size() == 1) {
            kVar.n(org.telegram.messenger.a.b3(u.d0("ChannelLeaveAlertWithName", org.telegram.mdgram.R.string.ChannelLeaveAlertWithName, ((fm9) arrayList.get(0)).f5602a)));
        } else {
            kVar.n(org.telegram.messenger.a.b3(u.d0("ChatsLeaveAlert", org.telegram.mdgram.R.string.ChatsLeaveAlert, new Object[0])));
        }
        kVar.p(u.B0("Cancel", org.telegram.mdgram.R.string.Cancel), null);
        kVar.v(u.B0("RevokeButton", org.telegram.mdgram.R.string.RevokeButton), new DialogInterface.OnClickListener() { // from class: po4
    ...
    public CharSequence z1() {
        return u.B0("LimitReached", org.telegram.mdgram.R.string.LimitReached);
    }
    ...
    public final void z2(final ArrayList arrayList) {
        ...
        if (arrayList.size() == 1) {
            ...
            kVar.n(org.telegram.messenger.a.b3(u.d0("RevokeLinksAlertChannel", org.telegram.mdgram.R.string.RevokeLinksAlertChannel, new Object[0])));
        } else {
            kVar.n(org.telegram.messenger.a.b3(u.d0("RevokeLinksAlert", org.telegram.mdgram.R.string.RevokeLinksAlert, new Object[0])));
        }
        kVar.p(u.B0("Cancel", org.telegram.mdgram.R.string.Cancel), null);
        kVar.v(u.B0("RevokeButton", org.telegram.mdgram.R.string.RevokeButton), new DialogInterface.OnClickListener() { // from class: oo4
            @Override // android.content.DialogInterface.OnClickListener
