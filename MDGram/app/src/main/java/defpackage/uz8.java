...
public class uz8 {
    ...
    public static b d(Context context, int i, int i2, r02 r02Var) {
        ...
        try {
            ...
            r02 m = m(obtainStyledAttributes, 5, r02Var);
            r02 m2 = m(obtainStyledAttributes, 8, m);
            r02 m3 = m(obtainStyledAttributes, 9, m);
            r02 m4 = m(obtainStyledAttributes, 7, m);
            return new b().y(i4, m2).C(i5, m3).u(i6, m4).q(i7, m(obtainStyledAttributes, 6, m));
        } finally {
