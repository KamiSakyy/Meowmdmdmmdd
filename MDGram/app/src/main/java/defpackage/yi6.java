...
public class yi6 {
    ...
    public ViewParent f22964a;

    /* renamed from: a  reason: collision with other field name */
    public boolean f22965a;
    ...
    public final boolean g(int i, int i2, int i3, int i4, int[] iArr, int i5, int[] iArr2) {
        ...
        xsa.d(h, this.a, i, i2, i3, i4, i5, iArr3);
        if (iArr != null) {
            this.a.getLocationInWindow(iArr);
            iArr[0] = iArr[0] - i6;
            iArr[1] = iArr[1] - i7;
    ...
    public boolean p(int i, int i2) {
        ...
        if (l()) {
            ...
            for (ViewParent parent = this.a.getParent(); parent != null; parent = parent.getParent()) {
                if (xsa.f(parent, view, this.a, i, i2)) {
                    n(i2, parent);
                    xsa.e(parent, view, this.a, i, i2);
                    return true;
                }
