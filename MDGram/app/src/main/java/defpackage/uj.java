...
public class uj extends f implements a0.d {
        ...
        public void onBindViewHolder(RecyclerView.d0 d0Var, int i) {
            ...
            if (getItemViewType(i) == 0) {
                ...
                if (i == uj.this.archiveInfoRow) {
                    ...
                    bv9Var.setText(u.B0("ArchivedStickersInfo", org.telegram.mdgram.R.string.ArchivedStickersInfo));
                    return;
                }
            ...
            if (i != 0) {
                if (i != 1) {
                    if (i != 2) {
                        ...
                        view.setBackgroundDrawable(l.u2(this.mContext, org.telegram.mdgram.R.drawable.greydivider_bottom, "windowBackgroundGrayShadow"));
                    }
                } else {
    ...
    public View W(Context context) {
        ...
        if (this.currentType == 0) {
            this.actionBar.setTitle(u.B0("ArchivedStickers", org.telegram.mdgram.R.string.ArchivedStickers));
        } else {
            this.actionBar.setTitle(u.B0("ArchivedMasks", org.telegram.mdgram.R.string.ArchivedMasks));
        }
        ...
        if (this.currentType == 0) {
            tt2Var.setText(u.B0("ArchivedStickersEmpty", org.telegram.mdgram.R.string.ArchivedStickersEmpty));
        } else {
            tt2Var.setText(u.B0("ArchivedMasksEmpty", org.telegram.mdgram.R.string.ArchivedMasksEmpty));
        }
