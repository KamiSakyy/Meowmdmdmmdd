...
public class fr3 extends FrameLayout {
    ...
    public static class f extends Drawable {
        ...
        public f(Context context) {
            ...
            drawableArr[0] = context.getResources().getDrawable(org.telegram.mdgram.R.drawable.verified_area).mutate();
            this.drawables[0].setColorFilter(new PorterDuffColorFilter(-9063442, PorterDuff.Mode.MULTIPLY));
            this.drawables[1] = context.getResources().getDrawable(org.telegram.mdgram.R.drawable.verified_check).mutate();
        }
    ...
    public fr3(Context context) {
        ...
        Drawable drawable = context.getResources().getDrawable(org.telegram.mdgram.R.drawable.voice_volume_mini);
        ...
        while (true) {
            ...
            if (i12 == 4) {
                ...
                if (i12 == 0) {
                    ...
                    this.statusTextView[i12].i(u.B0("Listening", org.telegram.mdgram.R.string.Listening));
                } else if (i12 == 1) {
                    this.statusTextView[i12].setTextColor(l.B1("voipgroup_speakingText"));
                    this.statusTextView[i12].i(u.B0("Speaking", org.telegram.mdgram.R.string.Speaking));
                    ...
                    this.statusTextView[i12].i(u.B0("VoipGroupMutedForMe", org.telegram.mdgram.R.string.VoipGroupMutedForMe));
                } else if (i12 == 3) {
                    this.statusTextView[i12].setTextColor(l.B1("voipgroup_listeningText"));
                    this.statusTextView[i12].i(u.B0("WantsToSpeak", org.telegram.mdgram.R.string.WantsToSpeak));
                }
        ...
        int i15 = org.telegram.mdgram.R.raw.voice_outlined2;
        this.muteDrawable = new RLottieDrawable(i15, "" + org.telegram.mdgram.R.raw.voice_outlined2, org.telegram.messenger.a.e0(34.0f), org.telegram.messenger.a.e0(32.0f), true, null);
        int i16 = org.telegram.mdgram.R.raw.hand_1;
        this.shakeHandDrawable = new RLottieDrawable(i16, "" + org.telegram.mdgram.R.raw.hand_1, org.telegram.messenger.a.e0(34.0f), org.telegram.messenger.a.e0(32.0f), true, null);
            ...
            if (mq9Var != null && mq9Var.h) {
                ...
                if (mq9Var2 != null && mq9Var2.p) {
                    if (this.premiumDrawable == null) {
                        this.premiumDrawable = getContext().getResources().getDrawable(org.telegram.mdgram.R.drawable.msg_premium_liststar).mutate();
