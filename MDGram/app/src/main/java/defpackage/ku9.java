...
public class ku9 {
    ...
    public ku9(Context context, int i) {
        ...
        k(j95.b(context, obtainStyledAttributes, 3));
        this.f9116a = j95.b(context, obtainStyledAttributes, 4);
        this.f9121b = j95.b(context, obtainStyledAttributes, 5);
        this.f9115a = obtainStyledAttributes.getInt(2, 0);
        this.f9120b = obtainStyledAttributes.getInt(1, 1);
        int e = j95.e(obtainStyledAttributes, 12, 10);
        this.f9123c = obtainStyledAttributes.getResourceId(e, 0);
        this.f9118a = obtainStyledAttributes.getString(e);
        this.f9119a = obtainStyledAttributes.getBoolean(14, false);
        this.f9124c = j95.b(context, obtainStyledAttributes, 6);
        ...
        this.f9122b = obtainStyledAttributes2.hasValue(0);
