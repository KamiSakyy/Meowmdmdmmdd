    ...
    public void a(vi3.b bVar) {
        ...
        if (!z) {
            if (bVar.c() <= 0) {
                ...
                this.f23063d.setText(u.c0(org.telegram.mdgram.R.string.GiftPremiumOptionDiscount, Integer.valueOf(bVar.c())));
                this.f23063d.setVisibility(0);
            }
            this.f23062c.setText(u.c0(org.telegram.mdgram.R.string.PricePerMonth, bVar.e()));
            this.f23060b.setText(bVar.d());
        } else {
            this.f23063d.setText(u.c0(org.telegram.mdgram.R.string.GiftPremiumOptionDiscount, 10));
            this.f23063d.setVisibility(0);
            this.f23062c.setText(u.c0(org.telegram.mdgram.R.string.PricePerMonth, 100));
