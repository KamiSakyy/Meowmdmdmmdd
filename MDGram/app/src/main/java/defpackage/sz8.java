...
public class sz8 extends View {
    ...
    public sz8(Context context, int i, l.r rVar) {
        super(context);
        setBackgroundDrawable(l.t2(context, org.telegram.mdgram.R.drawable.greydivider, l.C1("windowBackgroundGrayShadow", rVar)));
        this.size = i;
    }
    ...
    public sz8(Context context, int i, int i2, l.r rVar) {
        super(context);
        nq1 nq1Var = new nq1(new ColorDrawable(i2), l.t2(context, org.telegram.mdgram.R.drawable.greydivider, l.C1("windowBackgroundGrayShadow", rVar)), 0, 0);
        nq1Var.e(true);
