...
public class z87 extends f {
    ...
    public View W(Context context) {
        ...
        this.actionBar.setTitle(u.B0("CropImage", org.telegram.mdgram.R.string.CropImage));
        this.actionBar.setActionBarMenuOnItemClick(new a());
        this.actionBar.x().j(1, org.telegram.mdgram.R.drawable.ic_ab_done, org.telegram.messenger.a.e0(56.0f), u.B0("Done", org.telegram.mdgram.R.string.Done));
