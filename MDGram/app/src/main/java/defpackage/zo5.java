        ...
        if (mq9Var != null && mq9Var.f10571e && mq9Var.e != null) {
            ...
            if (this.f23851a.k) {
                ...
                if (!A8.getBoolean("inlinegeo_" + this.f23851a.f10557a, false) && (jVar = this.f23856a) != null && jVar.E0() != null) {
                    ...
                    kVar.x(u.B0("ShareYouLocationTitle", org.telegram.mdgram.R.string.ShareYouLocationTitle));
                    kVar.n(u.B0("ShareYouLocationInline", org.telegram.mdgram.R.string.ShareYouLocationInline));
                    final boolean[] zArr = new boolean[1];
                    kVar.v(u.B0("OK", org.telegram.mdgram.R.string.OK), new DialogInterface.OnClickListener() { // from class: so5
                        @Override // android.content.DialogInterface.OnClickListener
                        public final void onClick(DialogInterface dialogInterface, int i2) {
                            zo5.this.w0(zArr, mq9Var2, dialogInterface, i2);
                        }
                    });
                    kVar.p(u.B0("Cancel", org.telegram.mdgram.R.string.Cancel), new DialogInterface.OnClickListener() { // from class: to5
                        @Override // android.content.DialogInterface.OnClickListener
                        public final void onClick(DialogInterface dialogInterface, int i2) {
        ...
        if (itemViewType == 4) {
            ...
            if (d2 != null) {
                if (!org.telegram.messenger.d.E(d2) && (tLRPC$TL_chatBannedRights = d2.f5613b) != null && tLRPC$TL_chatBannedRights.g) {
                    textView.setText(u.B0("GlobalAttachInlineRestricted", org.telegram.mdgram.R.string.GlobalAttachInlineRestricted));
                } else if (org.telegram.messenger.a.J1(d2.f5608a)) {
                    textView.setText(u.B0("AttachInlineRestrictedForever", org.telegram.mdgram.R.string.AttachInlineRestrictedForever));
                } else {
                    textView.setText(u.d0("AttachInlineRestricted", org.telegram.mdgram.R.string.AttachInlineRestricted, u.K(d2.f5608a.b)));
                }
            }
