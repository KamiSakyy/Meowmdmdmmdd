...
public class pka {
    ...
    public void p(final String str, String str2, final String str3, int i) {
        try {
            View inflate = ((LayoutInflater) this.f16622a.getSystemService("layout_inflater")).inflate(org.telegram.mdgram.R.layout.md_content_updater, (ViewGroup) null);
            final com.google.android.material.bottomsheet.a aVar = new com.google.android.material.bottomsheet.a(this.f16622a, org.telegram.mdgram.R.style.BottomDialog);
            Drawable e = sz1.e(this.f16622a, org.telegram.mdgram.R.drawable.rounded_background);
            ...
            Drawable e2 = sz1.e(this.f16622a, org.telegram.mdgram.R.drawable.rounded_card_button);
            ...
            ((TextView) inflate.findViewById(org.telegram.mdgram.R.id.mVersion)).setText(str);
            ((TextView) inflate.findViewById(org.telegram.mdgram.R.id.mChangelog)).setText(str2.replace(" - ", "\n"));
