...
public class ys6 extends wb8 implements h.d {
    ...
    public void draw(Canvas canvas) {
        ...
        if (this.loaded) {
            B0 = u.B0("OpenFile", org.telegram.mdgram.R.string.OpenFile);
            textPaint = openPaint;
            e0 = 0;
        } else {
            if (this.loading) {
                B0 = u.B0("Cancel", org.telegram.mdgram.R.string.Cancel).toUpperCase();
            } else {
                B0 = u.B0("TapToDownload", org.telegram.mdgram.R.string.TapToDownload);
            }
            e0 = a.e0(28.0f);
