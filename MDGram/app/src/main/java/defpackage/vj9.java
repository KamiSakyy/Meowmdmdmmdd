...
public class vj9 extends g {
    ...
    public vj9(final f fVar) {
        ...
        textView.setText(u.B0("SuggestClearDatabaseTitle", org.telegram.mdgram.R.string.SuggestClearDatabaseTitle));
        ...
        textView2.setText(a.b3(u.d0("SuggestClearDatabaseMessage", org.telegram.mdgram.R.string.SuggestClearDatabaseMessage, a.t0(fVar.y0().m4()))));
        ...
        textView3.setText(u.B0("ClearLocalDatabase", org.telegram.mdgram.R.string.ClearLocalDatabase));
    ...
    public /* synthetic */ void w1(final f fVar, View view) {
        ...
        kVar.x(u.B0("LocalDatabaseClearTextTitle", org.telegram.mdgram.R.string.LocalDatabaseClearTextTitle));
        kVar.n(u.B0("LocalDatabaseClearText", org.telegram.mdgram.R.string.LocalDatabaseClearText));
        kVar.p(u.B0("Cancel", org.telegram.mdgram.R.string.Cancel), null);
        kVar.v(u.B0("CacheClear", org.telegram.mdgram.R.string.CacheClear), new DialogInterface.OnClickListener() { // from class: uj9
