...
public abstract class rc8 {
    ...
    public static void k(AccessibleObject accessibleObject) {
        try {
            ...
            String f = f(accessibleObject, false);
            throw new ab4("Failed making " + f + " accessible; either increase its visibility or write a custom TypeAdapter for its declaring type.", e);
        }
    }
