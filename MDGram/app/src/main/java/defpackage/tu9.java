...
public class tu9 extends FrameLayout {
    public static final Property<tu9, Float> ANIMATION_PROGRESS = new a("animationProgress");
    ...
    public class a extends f.h {
        ...
        /* renamed from: c */
        public Float get(tu9 tu9Var) {
            return Float.valueOf(tu9Var.animationProgress);
        }

        @Override // org.telegram.ui.Components.f.h
        /* renamed from: d */
        public void b(tu9 tu9Var, float f) {
            tu9Var.setAnimationProgress(f);
            tu9Var.invalidate();
        }
    }
    ...
    public tu9(Context context, int i) {
        this(context, i, false);
    }

    public tu9(Context context, int i, boolean z) {
        super(context);
        this.height = 50;
        ...
        this.checkbox.d("radioBackgroundChecked", "checkboxDisabled", "checkboxCheck");
        addView(this.checkbox, cn4.c(20, 20.0f, (u.d ? 5 : 3) | 16, 22.0f, 0.0f, 22.0f, 0.0f));
