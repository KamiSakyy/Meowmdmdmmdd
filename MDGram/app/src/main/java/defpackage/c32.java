...
public class c32 {
    ...
    public class b extends y0 {
        ...
        public void y1(View view, Long l, tm9 tm9Var, Integer num) {
            if (!tla.p(this.f2445a.l0()).x()) {
                ...
                q.o0(c32.this.f2430a, null).A(tm9Var, org.telegram.messenger.a.b3(u.B0("UnlockPremiumEmojiReaction", org.telegram.mdgram.R.string.UnlockPremiumEmojiReaction)), u.B0("PremiumMore", org.telegram.mdgram.R.string.PremiumMore), new Runnable() { // from class: d32
    ...
    public class h extends FrameLayout {
        ...
        public h(Context context) {
            ...
            this.f2453a = sz1.e(context, org.telegram.mdgram.R.drawable.reactions_bubble_shadow).mutate();
