...
public abstract class y extends FrameLayout {
    ...
    public class b implements Runnable {
        ...
        public /* synthetic */ void c(ClickableSpan clickableSpan, Layout layout, float f, String str, DialogInterface dialogInterface, int i) {
            if (i == 0) {
                ...
                if (org.telegram.messenger.a.L3()) {
                    if (str.startsWith("@")) {
                        q.p0(y.this.parentFragment).T(org.telegram.mdgram.R.raw.copy, u.B0("UsernameCopied", org.telegram.mdgram.R.string.UsernameCopied)).T();
                    } else if (!str.startsWith("#") && !str.startsWith("$")) {
                        q.p0(y.this.parentFragment).T(org.telegram.mdgram.R.raw.copy, u.B0("LinkCopied", org.telegram.mdgram.R.string.LinkCopied)).T();
                    } else {
                        q.p0(y.this.parentFragment).T(org.telegram.mdgram.R.raw.copy, u.B0("HashtagCopied", org.telegram.mdgram.R.string.HashtagCopied)).T();
                    }
                }
            }
        }
        ...
        public void run() {
            ...
            if (y.this.pressedLink != null) {
                ...
                lVar.k(str);
                lVar.h(new CharSequence[]{u.B0("Open", org.telegram.mdgram.R.string.Open), u.B0("Copy", org.telegram.mdgram.R.string.Copy)}, new DialogInterface.OnClickListener() { // from class: z
    ...
    public y(Context context, f fVar, l.r rVar) {
        ...
        Drawable mutate = context.getResources().getDrawable(org.telegram.mdgram.R.drawable.gradient_bottom).mutate();
        ...
        this.showMoreTextView.setText(u.B0("DescriptionMore", org.telegram.mdgram.R.string.DescriptionMore));
        ...
        Drawable mutate2 = context.getResources().getDrawable(org.telegram.mdgram.R.drawable.gradient_left).mutate();
