...
public class qv4 extends FrameLayout {
    ...
    public qv4(Context context, l.r rVar) {
        ...
        this.buttonTextView.i(u.B0("Directions", org.telegram.mdgram.R.string.Directions));
        this.buttonTextView.setLeftDrawable(org.telegram.mdgram.R.drawable.navigate);
