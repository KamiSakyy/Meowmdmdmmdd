...
public class kh9 extends FrameLayout {
    ...
    public kh9(Context context) {
        ...
        String B0 = u.B0("CalculatingSize", org.telegram.mdgram.R.string.CalculatingSize);
    ...
    public void j(boolean z, long j, long j2, long j3, long j4) {
        ...
        this.freeSizeTextView.setText(u.d0("TotalDeviceFreeSize", org.telegram.mdgram.R.string.TotalDeviceFreeSize, org.telegram.messenger.a.t0(j3)));
        long j5 = j4 - j3;
        this.totlaSizeTextView.setText(u.d0("TotalDeviceSize", org.telegram.mdgram.R.string.TotalDeviceSize, org.telegram.messenger.a.t0(j5)));
        if (z) {
            ...
            if (j2 > 0) {
                ...
                this.telegramDatabaseTextView.setVisibility(8);
                this.textSettingsCell.d(u.B0("ClearTelegramCache", org.telegram.mdgram.R.string.ClearTelegramCache), org.telegram.messenger.a.t0(j2), true);
                this.telegramCacheTextView.setText(u.d0("TelegramCacheSize", org.telegram.mdgram.R.string.TelegramCacheSize, org.telegram.messenger.a.t0(j2 + j)));
            } else {
                this.telegramCacheTextView.setVisibility(8);
                this.telegramDatabaseTextView.setVisibility(0);
                this.telegramDatabaseTextView.setText(u.d0("LocalDatabaseSize", org.telegram.mdgram.R.string.LocalDatabaseSize, org.telegram.messenger.a.t0(j)));
                this.divider.setVisibility(8);
                this.textSettingsCell.setVisibility(8);
            }
