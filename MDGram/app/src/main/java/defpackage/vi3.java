...
public class vi3 extends o {
    ...
    public class a extends v1.s {
        ...
        public RecyclerView.d0 onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            if (i != 1) {
                ...
                String z0 = u.z0(org.telegram.mdgram.R.string.GiftPremiumListFeaturesAndTerms);
    ...
    public final void v2(boolean z) {
        if (!s60.e() && (!zz.o().p() || ((b) this.f20925a.get(this.a)).f20933a == null)) {
            this.f20927a.i(u.z0(org.telegram.mdgram.R.string.Loading), new View.OnClickListener() { // from class: mi3
        ...
        this.f20927a.i(u.c0(org.telegram.mdgram.R.string.GiftSubscriptionFor, ((b) this.f20925a.get(this.a)).d()), new View.OnClickListener() { // from class: ni3
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                vi3.this.r2(view);
            }
    ...
    public CharSequence z1() {
        return u.z0(org.telegram.mdgram.R.string.GiftTelegramPremiumTitle);
    }
}
