...
public class ca2 extends LinearLayout {
    ...
    public class a implements View.OnClickListener {
        ...
        public /* synthetic */ void c(int i, Context context, int i2, boolean z) {
            ...
            if (l.F2()) {
                ca2.this.dayNightCell.j(u.B0("SettingsSwitchToNightMode", org.telegram.mdgram.R.string.SettingsSwitchToNightMode), ca2.this.darkThemeDrawable, true);
            } else {
                ca2.this.dayNightCell.j(u.B0("SettingsSwitchToDayMode", org.telegram.mdgram.R.string.SettingsSwitchToDayMode), ca2.this.darkThemeDrawable, true);
            }
        }
    ...
    public ca2(Context context, final f fVar, int i) {
        ...
        if (this.currentType == 0) {
            ...
            RLottieDrawable rLottieDrawable = new RLottieDrawable(i3, "" + org.telegram.mdgram.R.raw.sun_outline, org.telegram.messenger.a.e0(28.0f), org.telegram.messenger.a.e0(28.0f), true, null);
            ...
            pu9Var3.i(u.B0("SettingsBrowseThemes", org.telegram.mdgram.R.string.SettingsBrowseThemes), org.telegram.mdgram.R.drawable.msg_colors, false);
            ...
            if (!l.F2()) {
                ...
                this.dayNightCell.j(u.B0("SettingsSwitchToDayMode", org.telegram.mdgram.R.string.SettingsSwitchToDayMode), this.darkThemeDrawable, true);
            } else {
                this.dayNightCell.j(u.B0("SettingsSwitchToNightMode", org.telegram.mdgram.R.string.SettingsSwitchToNightMode), this.darkThemeDrawable, true);
            }
        }
