...
public class cn7 extends g {
    public cn7(f fVar) {
        ...
        textView3.setText(u.z0(org.telegram.mdgram.R.string.InstallOfficialApp));
        ...
        textView.setText(a.b3(u.z0(org.telegram.mdgram.R.string.SubscribeToPremiumOfficialAppNeeded)));
        textView2.setText(a.b3(u.z0(org.telegram.mdgram.R.string.SubscribeToPremiumOfficialAppNeededDescription)));
