...
public abstract class oz8 extends LinearLayout {
    ...
    public void setType(int i) {
        ...
        if (i == 0) {
            ...
            int i2 = org.telegram.mdgram.R.string.CheckPhoneNumber;
            z77 d = z77.d();
            textView.setText(u.d0("CheckPhoneNumber", i2, d.c("+" + R8.d)));
            String B0 = u.B0("CheckPhoneNumberInfo", org.telegram.mdgram.R.string.CheckPhoneNumberInfo);
            ...
            if (indexOf >= 0 && lastIndexOf >= 0 && indexOf != lastIndexOf) {
                ...
                try {
                    spannableStringBuilder.setSpan(new c3(u.B0("CheckPhoneNumberLearnMoreUrl", org.telegram.mdgram.R.string.CheckPhoneNumberLearnMoreUrl)), indexOf, lastIndexOf - 2, 33);
                } catch (Exception e) {
                    org.telegram.messenger.l.p(e);
                }
            }
            this.detailTextView.setText(spannableStringBuilder);
            this.yesButton.setText(u.B0("CheckPhoneNumberYes", org.telegram.mdgram.R.string.CheckPhoneNumberYes));
            this.noButton.setText(u.B0("CheckPhoneNumberNo", org.telegram.mdgram.R.string.CheckPhoneNumberNo));
        } else if (i == 1) {
            this.textView.setText(u.B0("YourPasswordHeader", org.telegram.mdgram.R.string.YourPasswordHeader));
            this.detailTextView.setText(u.B0("YourPasswordRemember", org.telegram.mdgram.R.string.YourPasswordRemember));
            this.yesButton.setText(u.B0("YourPasswordRememberYes", org.telegram.mdgram.R.string.YourPasswordRememberYes));
            this.noButton.setText(u.B0("YourPasswordRememberNo", org.telegram.mdgram.R.string.YourPasswordRememberNo));
        }
    }
}
