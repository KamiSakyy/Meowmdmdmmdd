...
public abstract class dqa extends View {
    ...
    public dqa(Context context) {
        ...
        Drawable drawable = context.getResources().getDrawable(org.telegram.mdgram.R.drawable.video_cropleft);
        this.drawableLeft = drawable;
        drawable.setColorFilter(new PorterDuffColorFilter(-16777216, PorterDuff.Mode.MULTIPLY));
        Drawable drawable2 = context.getResources().getDrawable(org.telegram.mdgram.R.drawable.video_cropright);
