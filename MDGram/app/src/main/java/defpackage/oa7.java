...
public class oa7 extends FrameLayout {
    ...
    public oa7(Context context) {
        ...
        imageView.setImageResource(org.telegram.mdgram.R.drawable.ic_video);
    ...
    public void setImage(MediaController.w wVar) {
        Drawable drawable = getResources().getDrawable(org.telegram.mdgram.R.drawable.nophotos);
        ...
        if (str != null) {
            ...
            if (wVar.f12387d) {
                ...
                setContentDescription(u.B0("AttachVideo", org.telegram.mdgram.R.string.AttachVideo) + ", " + u.P(wVar.d));
                sv svVar = this.imageView;
                svVar.i("vthumb://" + wVar.c + Constants.OBJECT_STORE_NAME_SEPARATOR + wVar.f12390g, null, drawable);
                return;
            }
            this.videoInfoContainer.setVisibility(4);
            setContentDescription(u.B0("AttachPhoto", org.telegram.mdgram.R.string.AttachPhoto));
