...
public class an7 extends ImageView {
    ...
    public void setLocked(boolean z) {
        ...
        if (this.f412a != e) {
            if (z) {
                i = org.telegram.mdgram.R.drawable.msg_mini_premiumlock;
            } else {
                i = org.telegram.mdgram.R.drawable.msg_mini_stickerstar;
            }
            setImageResource(i);
        }
    }
    ...
    public an7(Context context, int i, l.r rVar) {
        ...
        this.f412a = i;
        this.f418a = rVar;
        setImageResource(i == e ? org.telegram.mdgram.R.drawable.msg_premium_lock2 : org.telegram.mdgram.R.drawable.msg_mini_premiumlock);
        if (i == e) {
