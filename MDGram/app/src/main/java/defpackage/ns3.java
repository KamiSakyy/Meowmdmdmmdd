...
public class ns3 extends f implements a0.d {
        ...
        public void onBindViewHolder(RecyclerView.d0 d0Var, int i) {
            ...
            if (itemViewType != 0) {
                ...
                if (i == ns3.this.shadowRow) {
                    ...
                    if (d.M(S7) && !S7.h) {
                        bv9Var.setText(u.B0("ChannelLinkInfo", org.telegram.mdgram.R.string.ChannelLinkInfo));
                    } else {
                        bv9Var.setText(u.B0("LinkInfo", org.telegram.mdgram.R.string.LinkInfo));
                    }
            ...
            if (i == ns3.this.copyLinkRow) {
                uw9Var.c(u.B0("CopyLink", org.telegram.mdgram.R.string.CopyLink), true);
            } else if (i == ns3.this.shareLinkRow) {
                uw9Var.c(u.B0("ShareLink", org.telegram.mdgram.R.string.ShareLink), false);
            } else if (i == ns3.this.revokeLinkRow) {
                uw9Var.c(u.B0("RevokeLink", org.telegram.mdgram.R.string.RevokeLink), true);
            }
        }
        ...
        if (i != this.copyLinkRow && i != this.linkRow) {
            if (i == this.shareLinkRow) {
                ...
                try {
                    ...
                    E0().startActivityForResult(Intent.createChooser(intent, u.B0("InviteToGroupByLink", org.telegram.mdgram.R.string.InviteToGroupByLink)), Constants.DEFAULT_WRITE_DELAY);
                } catch (Exception e) {
                ...
                kVar.x(u.B0("RevokeLink", org.telegram.mdgram.R.string.RevokeLink));
                kVar.v(u.B0("RevokeButton", org.telegram.mdgram.R.string.RevokeButton), new DialogInterface.OnClickListener() { // from class: ks3
    ...
    public View W(Context context) {
        ...
        this.actionBar.setTitle(u.B0("InviteLink", org.telegram.mdgram.R.string.InviteLink));
