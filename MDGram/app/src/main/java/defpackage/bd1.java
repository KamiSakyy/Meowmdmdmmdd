...
public class bd1 extends org.telegram.ui.ActionBar.f implements a0.d {
    ...
    public class g extends v1 {
        ...
        public class a implements v1.m {
            ...
            public /* synthetic */ void i(final TLRPC$TL_username tLRPC$TL_username, final boolean z) {
                new e.k(g.this.getContext(), g.this.resourcesProvider).x(u.B0("UsernameActivateErrorTitle", org.telegram.mdgram.R.string.UsernameActivateErrorTitle)).n(u.B0("UsernameActivateErrorMessage", org.telegram.mdgram.R.string.UsernameActivateErrorMessage)).v(u.B0("OK", org.telegram.mdgram.R.string.OK), new DialogInterface.OnClickListener() { // from class: ed1
            ...
            public void a(final View view, int i) {
                ...
                if (tLRPC$TL_username.f15446b) {
                    i2 = org.telegram.mdgram.R.string.UsernameDeactivateLink;
                    str = "UsernameDeactivateLink";
                } else {
                    i2 = org.telegram.mdgram.R.string.UsernameActivateLink;
                    str = "UsernameActivateLink";
                }
                e.k x = kVar.x(u.B0(str, i2));
                if (tLRPC$TL_username.f15446b) {
                    i3 = org.telegram.mdgram.R.string.UsernameDeactivateLinkChannelMessage;
                    str2 = "UsernameDeactivateLinkChannelMessage";
                } else {
                    i3 = org.telegram.mdgram.R.string.UsernameActivateLinkChannelMessage;
                    str2 = "UsernameActivateLinkChannelMessage";
                }
                e.k n = x.n(u.B0(str2, i3));
                if (tLRPC$TL_username.f15446b) {
                    i4 = org.telegram.mdgram.R.string.Hide;
                    str3 = "Hide";
                } else {
                    i4 = org.telegram.mdgram.R.string.Show;
                    str3 = "Show";
                }
                ...
                }).p(u.B0("Cancel", org.telegram.mdgram.R.string.Cancel), new DialogInterface.OnClickListener() { // from class: gd1
                    @Override // android.content.DialogInterface.OnClickListener
                    public final void onClick(DialogInterface dialogInterface, int i5) {
        ...
        public class b extends v1.s {
            ...
            public void onBindViewHolder(RecyclerView.d0 d0Var, int i) {
                ...
                if (itemViewType != 0) {
                    ...
                    if (itemViewType != 1) {
                        if (itemViewType == 2) {
                            ((bv9) d0Var.itemView).setText(u.B0("UsernamesChannelHelp", org.telegram.mdgram.R.string.UsernamesChannelHelp));
                            ((bv9) d0Var.itemView).setBackgroundDrawable(l.u2(g.this.getContext(), org.telegram.mdgram.R.drawable.greydivider_bottom, "windowBackgroundGrayShadow"));
                            return;
                        }
                        return;
                    }
                ...
                ((nu3) d0Var.itemView).setText(u.B0("UsernamesChannelHeader", org.telegram.mdgram.R.string.UsernamesChannelHeader));
            }
    ...
    public /* synthetic */ void C3(View view) {
        ...
        if (this.isChannel) {
            int i = org.telegram.mdgram.R.string.RevokeLinkAlertChannel;
            ...
            int i2 = org.telegram.mdgram.R.string.RevokeLinkAlert;
        ...
        kVar.v(u.B0("RevokeButton", org.telegram.mdgram.R.string.RevokeButton), new DialogInterface.OnClickListener() { // from class: ac1
            @Override // android.content.DialogInterface.OnClickListener
    ...
    public /* synthetic */ void p3(String str, TLRPC$TL_error tLRPC$TL_error, org.telegram.tgnet.a aVar, TLRPC$TL_channels_checkUsername tLRPC$TL_channels_checkUsername) {
        ...
        if (str2 != null && str2.equals(str)) {
            if (tLRPC$TL_error == null && (aVar instanceof TLRPC$TL_boolTrue)) {
                this.checkTextView.setText(u.d0("LinkAvailable", org.telegram.mdgram.R.string.LinkAvailable, str));
            ...
            if (tLRPC$TL_error != null && "USERNAME_INVALID".equals(tLRPC$TL_error.f14225a) && tLRPC$TL_channels_checkUsername.f14005a.length() == 4) {
                this.checkTextView.setText(u.B0("UsernameInvalidShort", org.telegram.mdgram.R.string.UsernameInvalidShort));
                ...
                if (tLRPC$TL_channels_checkUsername.f14005a.length() == 4) {
                    this.checkTextView.setText(u.B0("UsernameInvalidShortPurchase", org.telegram.mdgram.R.string.UsernameInvalidShortPurchase));
                } else {
                    this.checkTextView.setText(u.B0("UsernameInUsePurchase", org.telegram.mdgram.R.string.UsernameInUsePurchase));
                }
                ...
                this.checkTextView.setText(u.B0("LinkInUse", org.telegram.mdgram.R.string.LinkInUse));
    ...
    public /* synthetic */ void w3(TLRPC$TL_error tLRPC$TL_error, org.telegram.tgnet.a aVar, boolean z) {
        ...
        if (tLRPC$TL_error == null) {
            ...
            if (z) {
                ...
                e.k kVar = new e.k(E0());
                kVar.n(u.B0("RevokeAlertNewLink", org.telegram.mdgram.R.string.RevokeAlertNewLink));
                kVar.x(u.B0("RevokeLink", org.telegram.mdgram.R.string.RevokeLink));
                kVar.p(u.B0("OK", org.telegram.mdgram.R.string.OK), null);
                f2(kVar.a());
            }
        }
    ...
    */
    ...
    public View W(Context context) {
        ...
        this.doneButton = x.k(1, i22Var, org.telegram.messenger.a.e0(56.0f), u.B0("Done", org.telegram.mdgram.R.string.Done));
        ...
        if (this.isForcePublic) {
            this.actionBar.setTitle(u.B0("TypeLocationGroup", org.telegram.mdgram.R.string.TypeLocationGroup));
        } else if (this.isChannel) {
            this.actionBar.setTitle(u.B0("ChannelSettingsTitle", org.telegram.mdgram.R.string.ChannelSettingsTitle));
        } else {
            this.actionBar.setTitle(u.B0("GroupSettingsTitle", org.telegram.mdgram.R.string.GroupSettingsTitle));
        }
        ...
        nu3Var.setHeight(46);
        if (this.isChannel) {
            this.headerCell2.setText(u.B0("ChannelTypeHeader", org.telegram.mdgram.R.string.ChannelTypeHeader));
        } else {
            this.headerCell2.setText(u.B0("GroupTypeHeader", org.telegram.mdgram.R.string.GroupTypeHeader));
        }
        ...
        if (this.isChannel) {
            this.radioButtonCell2.b(u.B0("ChannelPrivate", org.telegram.mdgram.R.string.ChannelPrivate), u.B0("ChannelPrivateInfo", org.telegram.mdgram.R.string.ChannelPrivateInfo), false, this.isPrivate);
        } else {
            this.radioButtonCell2.b(u.B0("MegaPrivate", org.telegram.mdgram.R.string.MegaPrivate), u.B0("MegaPrivateInfo", org.telegram.mdgram.R.string.MegaPrivateInfo), false, this.isPrivate);
        }
        ...
        if (this.isChannel) {
            this.radioButtonCell1.b(u.B0("ChannelPublic", org.telegram.mdgram.R.string.ChannelPublic), u.B0("ChannelPublicInfo", org.telegram.mdgram.R.string.ChannelPublicInfo), false, !this.isPrivate);
        } else {
            this.radioButtonCell1.b(u.B0("MegaPublic", org.telegram.mdgram.R.string.MegaPublic), u.B0("MegaPublicInfo", org.telegram.mdgram.R.string.MegaPublicInfo), false, !this.isPrivate);
        }
        ...
        this.usernameTextView.setHint(u.B0("ChannelUsernamePlaceholder", org.telegram.mdgram.R.string.ChannelUsernamePlaceholder));
        ...
        fVar.setBackgroundDrawable(l.u2(context, org.telegram.mdgram.R.drawable.greydivider_bottom, "windowBackgroundGrayShadow"));
        ...
        this.manageLinksTextView.i(u.B0("ManageInviteLinks", org.telegram.mdgram.R.string.ManageInviteLinks), org.telegram.mdgram.R.drawable.msg_link2, false);
        ...
        this.saveHeaderCell.setText(u.B0("SavingContentTitle", org.telegram.mdgram.R.string.SavingContentTitle));
        ...
        this.saveRestrictCell.i(u.B0("RestrictSavingContent", org.telegram.mdgram.R.string.RestrictSavingContent), this.isSaveRestricted, false);
        ...
        if (this.isChannel && !org.telegram.messenger.d.V(this.currentChat)) {
            this.saveRestrictInfoCell.setText(u.B0("RestrictSavingContentInfoChannel", org.telegram.mdgram.R.string.RestrictSavingContentInfoChannel));
        } else {
            this.saveRestrictInfoCell.setText(u.B0("RestrictSavingContentInfoGroup", org.telegram.mdgram.R.string.RestrictSavingContentInfoGroup));
        }
    ...
    public final void X3() {
        ...
        if (!this.isPrivate && !this.canCreatePublic && M0().x()) {
            this.typeInfoCell.setText(u.B0("ChangePublicLimitReached", org.telegram.mdgram.R.string.ChangePublicLimitReached));
            ...
            if (this.loadingAdminedChannels) {
                ...
                if (this.checkTextView.getVisibility() == 0) {
                    ...
                    u2 = l.u2(this.typeInfoCell.getContext(), org.telegram.mdgram.R.drawable.greydivider_bottom, "windowBackgroundGrayShadow");
                }
                bv9Var.setBackgroundDrawable(u2);
                this.adminedInfoCell.setBackgroundDrawable(null);
            } else {
                sz8 sz8Var = this.adminedInfoCell;
                sz8Var.setBackgroundDrawable(l.u2(sz8Var.getContext(), org.telegram.mdgram.R.drawable.greydivider_bottom, "windowBackgroundGrayShadow"));
                bv9 bv9Var2 = this.typeInfoCell;
                bv9Var2.setBackgroundDrawable(l.u2(bv9Var2.getContext(), org.telegram.mdgram.R.drawable.greydivider_top, "windowBackgroundGrayShadow"));
            ...
            bv9Var3.setBackgroundDrawable(l.u2(bv9Var3.getContext(), org.telegram.mdgram.R.drawable.greydivider_bottom, "windowBackgroundGrayShadow"));
            this.adminnedChannelsLayout.setVisibility(8);
            ...
            if (this.isChannel) {
                ...
                if (this.isPrivate) {
                    i5 = org.telegram.mdgram.R.string.ChannelPrivateLinkHelp;
                    str3 = "ChannelPrivateLinkHelp";
                } else {
                    i5 = org.telegram.mdgram.R.string.ChannelUsernameHelp;
                    str3 = "ChannelUsernameHelp";
                }
                bv9Var4.setText(u.B0(str3, i5));
                nu3 nu3Var = this.headerCell;
                if (this.isPrivate) {
                    B02 = u.B0("ChannelInviteLinkTitle", org.telegram.mdgram.R.string.ChannelInviteLinkTitle);
                } else {
                    B02 = u.B0("ChannelLinkTitle", org.telegram.mdgram.R.string.ChannelLinkTitle);
                }
                nu3Var.setText(B02);
            } else {
                bv9 bv9Var5 = this.typeInfoCell;
                if (this.isPrivate) {
                    i = org.telegram.mdgram.R.string.MegaPrivateLinkHelp;
                    str = "MegaPrivateLinkHelp";
                } else {
                    i = org.telegram.mdgram.R.string.MegaUsernameHelp;
                    str = "MegaUsernameHelp";
                }
                bv9Var5.setText(u.B0(str, i));
                nu3 nu3Var2 = this.headerCell;
                if (this.isPrivate) {
                    B0 = u.B0("ChannelInviteLinkTitle", org.telegram.mdgram.R.string.ChannelInviteLinkTitle);
                } else {
                    B0 = u.B0("ChannelLinkTitle", org.telegram.mdgram.R.string.ChannelLinkTitle);
                }
                nu3Var2.setText(B0);
            }
            ...
            this.manageLinksInfoCell.setText(u.B0("ManageLinksInfoHelp", org.telegram.mdgram.R.string.ManageLinksInfoHelp));
            if (this.isPrivate) {
                bv9 bv9Var7 = this.typeInfoCell;
                bv9Var7.setBackgroundDrawable(l.u2(bv9Var7.getContext(), org.telegram.mdgram.R.drawable.greydivider, "windowBackgroundGrayShadow"));
                this.manageLinksInfoCell.setBackground(l.u2(this.typeInfoCell.getContext(), org.telegram.mdgram.R.drawable.greydivider_bottom, "windowBackgroundGrayShadow"));
            } else {
                bv9 bv9Var8 = this.typeInfoCell;
                if (this.checkTextView.getVisibility() != 0) {
                    drawable = l.u2(this.typeInfoCell.getContext(), org.telegram.mdgram.R.drawable.greydivider_bottom, "windowBackgroundGrayShadow");
                }
    ...
    */
    ...
    public final boolean m3(final String str) {
            ...
            if (!str.startsWith("_") && !str.endsWith("_")) {
                for (int i = 0; i < str.length(); i++) {
                    ...
                    if (i == 0 && charAt >= '0' && charAt <= '9') {
                        if (this.isChannel) {
                            this.checkTextView.setText(u.B0("LinkInvalidStartNumber", org.telegram.mdgram.R.string.LinkInvalidStartNumber));
                        } else {
                            this.checkTextView.setText(u.B0("LinkInvalidStartNumberMega", org.telegram.mdgram.R.string.LinkInvalidStartNumberMega));
                        }
                        this.checkTextView.setTextColor("windowBackgroundWhiteRedText4");
                        return false;
                    } else if ((charAt < '0' || charAt > '9') && ((charAt < 'a' || charAt > 'z') && ((charAt < 'A' || charAt > 'Z') && charAt != '_'))) {
                        this.checkTextView.setText(u.B0("LinkInvalid", org.telegram.mdgram.R.string.LinkInvalid));
                        this.checkTextView.setTextColor("windowBackgroundWhiteRedText4");
                        return false;
                    }
                }
        ...
        if (str != null && str.length() >= 4) {
            if (str.length() > 32) {
                this.checkTextView.setText(u.B0("LinkInvalidLong", org.telegram.mdgram.R.string.LinkInvalidLong));
                this.checkTextView.setTextColor("windowBackgroundWhiteRedText4");
                return false;
            }
            this.checkTextView.setText(u.B0("LinkChecking", org.telegram.mdgram.R.string.LinkChecking));
        ...
        if (this.isChannel) {
            this.checkTextView.setText(u.B0("LinkInvalidShort", org.telegram.mdgram.R.string.LinkInvalidShort));
        } else {
            this.checkTextView.setText(u.B0("LinkInvalidShortMega", org.telegram.mdgram.R.string.LinkInvalidShortMega));
        }
        this.checkTextView.setTextColor("windowBackgroundWhiteRedText4");
        return false;
    }
    ...
    public void r1() {
        ...
        if (uw9Var != null && (gm9Var = this.info) != null) {
            if (gm9Var.f6236a != null) {
                uw9Var.d(u.B0("GroupStickers", org.telegram.mdgram.R.string.GroupStickers), this.info.f6236a.f5054a, false);
            } else {
                uw9Var.c(u.B0("GroupStickers", org.telegram.mdgram.R.string.GroupStickers), false);
            }
        }
