...
public class i62 extends org.telegram.ui.ActionBar.f {
        ...
        public void onBindViewHolder(RecyclerView.d0 d0Var, int i) {
            ...
            if (itemViewType != 0) {
                ...
                if (itemViewType != 1) {
                    if (itemViewType != 2) {
                        if (itemViewType == 3) {
                            ...
                            bv9Var.setText(u.d0("NetworkUsageSince", org.telegram.mdgram.R.string.NetworkUsageSince, u.p0().h.a(nc9.p(i62.this.currentAccount).s(this.currentType))));
                            return;
                        }
                        return;
                    }
                    ...
                    if (i == this.totalSectionRow) {
                        nu3Var.setText(u.B0("TotalDataUsage", org.telegram.mdgram.R.string.TotalDataUsage));
                        return;
                    } else if (i == this.callsSectionRow) {
                        nu3Var.setText(u.B0("CallsDataUsage", org.telegram.mdgram.R.string.CallsDataUsage));
                        return;
                    } else if (i == this.filesSectionRow) {
                        nu3Var.setText(u.B0("FilesDataUsage", org.telegram.mdgram.R.string.FilesDataUsage));
                        return;
                    } else if (i == this.audiosSectionRow) {
                        nu3Var.setText(u.B0("LocalAudioCache", org.telegram.mdgram.R.string.LocalAudioCache));
                        return;
                    } else if (i == this.videosSectionRow) {
                        nu3Var.setText(u.B0("LocalVideoCache", org.telegram.mdgram.R.string.LocalVideoCache));
                        return;
                    } else if (i == this.photosSectionRow) {
                        nu3Var.setText(u.B0("LocalPhotoCache", org.telegram.mdgram.R.string.LocalPhotoCache));
                        return;
                    } else if (i == this.messagesSectionRow) {
                        nu3Var.setText(u.B0("MessagesDataUsage", org.telegram.mdgram.R.string.MessagesDataUsage));
                        return;
                    } else {
                        return;
                    }
                ...
                if (i == this.resetRow) {
                    ...
                    uw9Var.c(u.B0("ResetStatistics", org.telegram.mdgram.R.string.ResetStatistics), false);
                ...
                if (i == i3) {
                    uw9Var.d(u.B0("OutgoingCalls", org.telegram.mdgram.R.string.OutgoingCalls), String.format("%d", Integer.valueOf(nc9.p(i62.this.currentAccount).u(this.currentType, i2))), true);
                } else if (i == this.callsReceivedRow) {
                    uw9Var.d(u.B0("IncomingCalls", org.telegram.mdgram.R.string.IncomingCalls), String.format("%d", Integer.valueOf(nc9.p(i62.this.currentAccount).r(this.currentType, i2))), true);
                } else if (i == this.callsTotalTimeRow) {
                    uw9Var.d(u.B0("CallsTotalTime", org.telegram.mdgram.R.string.CallsTotalTime), org.telegram.messenger.a.x0(nc9.p(i62.this.currentAccount).o(this.currentType)), false);
                    ...
                    if (i != this.messagesReceivedRow && i != this.photosReceivedRow && i != this.videosReceivedRow && i != this.audiosReceivedRow && i != this.filesReceivedRow) {
                        if (i != this.messagesBytesSentRow && i != this.photosBytesSentRow && i != this.videosBytesSentRow && i != this.audiosBytesSentRow && i != this.filesBytesSentRow && i != this.callsBytesSentRow && i != this.totalBytesSentRow) {
                            if (i == this.messagesBytesReceivedRow || i == this.photosBytesReceivedRow || i == this.videosBytesReceivedRow || i == this.audiosBytesReceivedRow || i == this.filesBytesReceivedRow || i == this.callsBytesReceivedRow || i == this.totalBytesReceivedRow) {
                                String B0 = u.B0("BytesReceived", org.telegram.mdgram.R.string.BytesReceived);
                        ...
                        uw9Var.d(u.B0("BytesSent", org.telegram.mdgram.R.string.BytesSent), org.telegram.messenger.a.t0(nc9.p(i62.this.currentAccount).t(this.currentType, i2)), true);
                        return;
                    }
                    uw9Var.d(u.B0("CountReceived", org.telegram.mdgram.R.string.CountReceived), String.format("%d", Integer.valueOf(nc9.p(i62.this.currentAccount).r(this.currentType, i2))), true);
                } else {
                    uw9Var.d(u.B0("CountSent", org.telegram.mdgram.R.string.CountSent), String.format("%d", Integer.valueOf(nc9.p(i62.this.currentAccount).u(this.currentType, i2))), true);
                }
    ...
    public /* synthetic */ void X2(v1 v1Var, View view, int i) {
        ...
        if (i == gVar.resetRow) {
            e.k kVar = new e.k(E0());
            kVar.x(u.B0("ResetStatisticsAlertTitle", org.telegram.mdgram.R.string.ResetStatisticsAlertTitle));
            kVar.n(u.B0("ResetStatisticsAlert", org.telegram.mdgram.R.string.ResetStatisticsAlert));
            kVar.v(u.B0("Reset", org.telegram.mdgram.R.string.Reset), new DialogInterface.OnClickListener() { // from class: h62
    ...
    public View W(Context context) {
        ...
        this.actionBar.setTitle(u.B0("NetworkUsage", org.telegram.mdgram.R.string.NetworkUsage));
        boolean z = false;
    ...
    public final void b3() {
        ...
        scrollSlidingTextTabStrip.l(0, u.B0("NetworkUsageMobileTab", org.telegram.mdgram.R.string.NetworkUsageMobileTab));
        this.scrollSlidingTextTabStrip.l(1, u.B0("NetworkUsageWiFiTab", org.telegram.mdgram.R.string.NetworkUsageWiFiTab));
        this.scrollSlidingTextTabStrip.l(2, u.B0("NetworkUsageRoamingTab", org.telegram.mdgram.R.string.NetworkUsageRoamingTab));
