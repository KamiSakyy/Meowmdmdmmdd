...
public abstract class i1d {
    ...
    public static String b(o0d o0dVar, String str) {
        StringBuilder sb = new StringBuilder();
        sb.append("# ");
        sb.append(str);
        d(o0dVar, sb, 0);
    ...
    public static final void c(StringBuilder sb, int i, String str, Object obj) {
        if (obj instanceof List) {
            ...
            if (obj instanceof String) {
                sb.append(": \"");
                sb.append(j5d.a(koc.k((String) obj)));
                sb.append('\"');
            } else if (obj instanceof koc) {
                sb.append(": \"");
                sb.append(j5d.a((koc) obj));
                sb.append('\"');
            } else if (obj instanceof uuc) {
                sb.append(" {");
                d((uuc) obj, sb, i + 2);
                sb.append("\n");
                while (i2 < i) {
                ...
                int i4 = i + 2;
                c(sb, i4, Constants.TAG_KEY, entry2.getKey());
                c(sb, i4, Constants.TAG_VALUE, entry2.getValue());
                sb.append("\n");
                while (i2 < i) {
                    sb.append(' ');
                    i2++;
    ...
    */
    public static void d(defpackage.o0d r13, java.lang.StringBuilder r14, int r15) {
        /*
            Method dump skipped, instructions count: 630
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.i1d.d(o0d, java.lang.StringBuilder, int):void");
    }
}
