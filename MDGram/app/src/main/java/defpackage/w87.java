...
public class w87 extends FrameLayout {
    ...
    public w87(Context context, l.r rVar) {
        ...
        this.imageView.setImageResource(org.telegram.mdgram.R.drawable.instant_camera);
    ...
    public void b() {
        ...
        if (bitmap != null) {
            ...
            this.backgroundView.setImageResource(org.telegram.mdgram.R.drawable.icplaceholder);
        }
    }
