    ...
    public static /* synthetic */ void i(a aVar, final int i, lp9 lp9Var, lp9 lp9Var2, Runnable runnable, final org.telegram.ui.ActionBar.k kVar) {
        if (aVar instanceof TLRPC$TL_photos_photo) {
            ...
            if ((kp9Var instanceof TLRPC$TL_photo) && R8 != null) {
                ...
                q.p0(kVar.getLastFragment()).g0(Collections.singletonList(R8), org.telegram.messenger.a.b3(u.B0("ApplyAvatarHint", org.telegram.mdgram.R.string.ApplyAvatarHintTitle)), org.telegram.messenger.a.Z2(u.B0("ApplyAvatarHint", org.telegram.mdgram.R.string.ApplyAvatarHint), new Runnable() { // from class: qa7
