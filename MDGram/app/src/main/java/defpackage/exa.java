...
public class exa implements VoIPService.StateListener, a0.d {
    ...
    public exa(final Context context, int i, int i2, boolean z) {
        ...
        d dVar = new d(context, sz1.e(context, org.telegram.mdgram.R.drawable.calls_pip_outershadow));
        this.f5152a = dVar;
        ...
        if (z) {
            ...
            imageView.setImageResource(org.telegram.mdgram.R.drawable.pip_close);
            ...
            this.f5153a.setContentDescription(u.B0("Close", org.telegram.mdgram.R.string.Close));
            this.f5154a.addView(this.f5153a, cn4.c(40, 40.0f, 53, 4.0f, 4.0f, 4.0f, 0.0f));
            ImageView imageView2 = new ImageView(context);
            this.f5163b = imageView2;
            imageView2.setImageResource(org.telegram.mdgram.R.drawable.pip_enlarge);
            ...
            this.f5163b.setContentDescription(u.B0("Open", org.telegram.mdgram.R.string.Open));
