        ...
        if (itemViewType != 0) {
            if (itemViewType != 14) {
                            ...
                            if (itemViewType != 7) {
                                if (itemViewType != 11) {
                                    if (itemViewType == 12) {
                                        ...
                                        String B0 = org.telegram.messenger.u.B0("CreateGroupForImport", org.telegram.mdgram.R.string.CreateGroupForImport);
                                        int i3 = org.telegram.mdgram.R.drawable.msg_groups_create;
                                    ...
                                    bv9Var.setText(org.telegram.messenger.u.B0("TapOnThePencil", org.telegram.mdgram.R.string.TapOnThePencil));
                                    if (this.arrowDrawable == null) {
                                        Drawable drawable = this.mContext.getResources().getDrawable(org.telegram.mdgram.R.drawable.arrow_newchat);
                                ...
                                if (i4 != 11 && i4 != 12 && i4 != 13) {
                                    if (this.dialogsCount == 0 && this.forceUpdatingContacts) {
                                        i2 = org.telegram.mdgram.R.string.ConnectingYourContacts;
                                    } else {
                                        i2 = org.telegram.mdgram.R.string.YourContacts;
                                    }
                                    nu3Var.setText(org.telegram.messenger.u.z0(i2));
                                } else if (i == 0) {
                                    nu3Var.setText(org.telegram.messenger.u.B0("ImportHeader", org.telegram.mdgram.R.string.ImportHeader));
                                } else {
                                    nu3Var.setText(org.telegram.messenger.u.B0("ImportHeaderContacts", org.telegram.mdgram.R.string.ImportHeaderContacts));
                                }
                            }
                        } else {
                ...
                if (i7 != 0) {
                    if (i7 != 1) {
                        if (i7 == 2) {
                            nu3Var2.setText(org.telegram.messenger.u.B0("FilterGroups", org.telegram.mdgram.R.string.FilterGroups));
                        }
                    } else {
                        nu3Var2.setText(org.telegram.messenger.u.B0("MyGroups", org.telegram.mdgram.R.string.MyGroups));
                    }
                } else {
                    nu3Var2.setText(org.telegram.messenger.u.B0("MyChannels", org.telegram.mdgram.R.string.MyChannels));
                }
            }
        } else {
            qm9 qm9Var = (qm9) z(i);
                ...
                if (fm9Var != null) {
                    ...
                    if (org.telegram.messenger.d.M(fm9Var) && !fm9Var.h) {
                        ...
                        if (i9 != 0) {
                            ...
                            str = org.telegram.messenger.u.B0("ChannelPrivate", org.telegram.mdgram.R.string.ChannelPrivate).toLowerCase();
                        } else {
                            str = org.telegram.messenger.u.B0("ChannelPublic", org.telegram.mdgram.R.string.ChannelPublic).toLowerCase();
                        }
                    } else {
                        int i10 = fm9Var.d;
                        if (i10 != 0) {
                            ...
                            str = org.telegram.messenger.u.B0("MegaLocation", org.telegram.mdgram.R.string.MegaLocation);
                        } else if (!org.telegram.messenger.d.a0(fm9Var)) {
                            str = org.telegram.messenger.u.B0("MegaPrivate", org.telegram.mdgram.R.string.MegaPrivate).toLowerCase();
                        } else {
                            str = org.telegram.messenger.u.B0("MegaPublic", org.telegram.mdgram.R.string.MegaPublic).toLowerCase();
                        }
                    }
                } else {
                    str = "";
    ...
    public RecyclerView.d0 onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        switch (i) {
            ...
            case 2:
                ...
                dc2Var.setText(org.telegram.messenger.u.B0("RecentlyViewed", org.telegram.mdgram.R.string.RecentlyViewed));
                ...
                textView.setText(org.telegram.messenger.u.B0("RecentlyViewedHide", org.telegram.mdgram.R.string.RecentlyViewedHide));
                int i5 = 3;
            ...
            case 3:
                ...
                view.setBackgroundDrawable(org.telegram.ui.ActionBar.l.u2(this.mContext, org.telegram.mdgram.R.drawable.greydivider, "windowBackgroundGrayShadow"));
            ...
            case 11:
                ...
                nq1 nq1Var2 = new nq1(new ColorDrawable(org.telegram.ui.ActionBar.l.B1("windowBackgroundGray")), org.telegram.ui.ActionBar.l.u2(this.mContext, org.telegram.mdgram.R.drawable.greydivider, "windowBackgroundGrayShadow"));
                nq1Var2.e(true);
