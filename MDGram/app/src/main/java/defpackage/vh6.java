...
public abstract class vh6 {
    ...
    public static final boolean f20921a = n(System.getProperty("java.vm.version"));
    ...
    public static final class a {
        public static void a(ClassLoader classLoader, List list, File file) {
            ...
            Object obj = vh6.g(classLoader, "pathList").get(classLoader);
            ArrayList arrayList = new ArrayList();
            vh6.f(obj, "dexElements", b(obj, new ArrayList(list), file, arrayList));
            if (arrayList.size() > 0) {
                Iterator it = arrayList.iterator();
                while (it.hasNext()) {
                    Log.w("MultiDex", "Exception in makeDexElement", (IOException) it.next());
                }
                Field g = vh6.g(obj, "dexElementsSuppressedExceptions");
        ...
        public static Object[] b(Object obj, ArrayList arrayList, File file, ArrayList arrayList2) {
            return (Object[]) vh6.h(obj, "makeDexElements", ArrayList.class, File.class, ArrayList.class).invoke(obj, arrayList, file, arrayList2);
        }
    }
