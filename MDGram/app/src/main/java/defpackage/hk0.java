...
public class hk0 extends org.telegram.ui.ActionBar.f implements a0.d, t0.f {
                ...
                if (hk0.this.currentStep == 0) {
                    ...
                    if (!hk0.this.isPrivate) {
                        if (hk0.this.descriptionTextView.length() == 0) {
                            ...
                            kVar.x(u.B0("ChannelPublicEmptyUsernameTitle", org.telegram.mdgram.R.string.ChannelPublicEmptyUsernameTitle));
                            kVar.n(u.B0("ChannelPublicEmptyUsername", org.telegram.mdgram.R.string.ChannelPublicEmptyUsername));
                            kVar.v(u.B0("Close", org.telegram.mdgram.R.string.Close), null);
                            hk0.this.f2(kVar.a());
                            return;
    ...
    public /* synthetic */ void E3(View view) {
        ...
        if (currentChannel.h) {
            ...
            int i3 = org.telegram.mdgram.R.string.RevokeLinkAlertChannel;
        ...
        kVar.v(u.B0("RevokeButton", org.telegram.mdgram.R.string.RevokeButton), new DialogInterface.OnClickListener() { // from class: wj0
    ...
    public final void Q3() {
        ...
        e.k kVar = new e.k(E0());
        kVar.x(u.B0("StopLoadingTitle", org.telegram.mdgram.R.string.StopLoadingTitle));
        kVar.n(u.B0("StopLoading", org.telegram.mdgram.R.string.StopLoading));
        kVar.v(u.B0("WaitMore", org.telegram.mdgram.R.string.WaitMore), null);
        kVar.p(u.B0("Stop", org.telegram.mdgram.R.string.Stop), new DialogInterface.OnClickListener() { // from class: pj0
            @Override // android.content.DialogInterface.OnClickListener
    ...
    public final void T3() {
        ...
        if (!this.isPrivate && !this.canCreatePublic) {
            ...
            if (this.loadingAdminedChannels) {
                ...
                bv9Var.setBackgroundDrawable(l.u2(bv9Var.getContext(), org.telegram.mdgram.R.drawable.greydivider_bottom, "windowBackgroundGrayShadow"));
                this.adminedInfoCell.setVisibility(8);
            } else {
                bv9 bv9Var2 = this.typeInfoCell;
                bv9Var2.setBackgroundDrawable(l.u2(bv9Var2.getContext(), org.telegram.mdgram.R.drawable.greydivider, "windowBackgroundGrayShadow"));
            ...
            if (this.isPrivate) {
                i2 = org.telegram.mdgram.R.string.ChannelPrivateLinkHelp;
                str = "ChannelPrivateLinkHelp";
            } else {
                i2 = org.telegram.mdgram.R.string.ChannelUsernameHelp;
                str = "ChannelUsernameHelp";
            }
            bv9Var4.setText(u.B0(str, i2));
            nu3 nu3Var = this.headerCell;
            if (this.isPrivate) {
                i3 = org.telegram.mdgram.R.string.ChannelInviteLinkTitle;
                str2 = "ChannelInviteLinkTitle";
            } else {
                i3 = org.telegram.mdgram.R.string.ChannelLinkTitle;
    ...
    public View W(Context context) {
        ...
        if (i11 == 0) {
            this.actionBar.setTitle(u.B0("NewChannel", org.telegram.mdgram.R.string.NewChannel));
            ...
            dVar.setContentDescription(u.B0("ChatSetPhotoOrVideo", org.telegram.mdgram.R.string.ChatSetPhotoOrVideo));
            ...
            int i14 = org.telegram.mdgram.R.raw.camera;
            this.cameraDrawable = new RLottieDrawable(i14, "" + org.telegram.mdgram.R.raw.camera, org.telegram.messenger.a.e0(60.0f), org.telegram.messenger.a.e0(60.0f), false, null);
            ...
            g0Var2.setHint(u.B0("EnterChannelName", org.telegram.mdgram.R.string.EnterChannelName));
            ...
            this.descriptionTextView.setHint(u.B0("DescriptionPlaceholder", org.telegram.mdgram.R.string.DescriptionPlaceholder));
            ...
            this.helpTextView.setText(u.B0("DescriptionInfo", org.telegram.mdgram.R.string.DescriptionInfo));
            ...
            this.descriptionTextView.setImeOptions(6);
            this.descriptionTextView.setHint(u.B0("ChannelUsernamePlaceholder", org.telegram.mdgram.R.string.ChannelUsernamePlaceholder));
            this.descriptionTextView.setCursorColor(l.B1("windowBackgroundWhiteBlackText"));
            this.descriptionTextView.setCursorSize(org.telegram.messenger.a.e0(20.0f));
            this.descriptionTextView.setCursorWidth(1.5f);
            ...
            bv9Var2.setBackgroundDrawable(l.u2(context, org.telegram.mdgram.R.drawable.greydivider_bottom, "windowBackgroundGrayShadow"));
