...
public class mka extends g {
    ...
    public mka(Context context, TLRPC$TL_help_appUpdate tLRPC$TL_help_appUpdate, int i) {
        ...
        textView.setText(u.B0("AppUpdate", org.telegram.mdgram.R.string.AppUpdate));
        ...
        int i2 = org.telegram.mdgram.R.string.AppUpdateVersionAndSize;
        ...
        if (TextUtils.isEmpty(this.appUpdate.f14292b)) {
            textView3.setText(org.telegram.messenger.a.b3(u.B0("AppUpdateChangelogEmpty", org.telegram.mdgram.R.string.AppUpdateChangelogEmpty)));
        } else {
        ...
        dVar.c(u.d0("AppUpdateDownloadNow", org.telegram.mdgram.R.string.AppUpdateDownloadNow, new Object[0]), false);
        ...
        dVar2.c(u.B0("AppUpdateRemindMeLater", org.telegram.mdgram.R.string.AppUpdateRemindMeLater), false);
