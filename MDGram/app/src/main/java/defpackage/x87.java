...
public class x87 extends FrameLayout {
    ...
    public void setType(int i) {
        if (i == 0) {
            this.imageView.setImageResource(org.telegram.mdgram.R.drawable.permissions_camera1);
            this.imageView2.setImageResource(org.telegram.mdgram.R.drawable.permissions_camera2);
            this.textView.setText(u.B0("CameraPermissionText", org.telegram.mdgram.R.string.CameraPermissionText));
        ...
        this.imageView.setImageResource(org.telegram.mdgram.R.drawable.permissions_gallery1);
        this.imageView2.setImageResource(org.telegram.mdgram.R.drawable.permissions_gallery2);
        this.textView.setText(u.B0("GalleryPermissionText", org.telegram.mdgram.R.string.GalleryPermissionText));
