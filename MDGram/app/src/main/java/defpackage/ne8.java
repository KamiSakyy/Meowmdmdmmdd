...
public abstract class ne8 extends g {
    ...
    public ne8(Context context, final int i) {
        ...
        e88Var.g(org.telegram.mdgram.R.raw.report_police, Constants.MEMORY_PAGE_DATA_OVERFLOW, Constants.MEMORY_PAGE_DATA_OVERFLOW);
        e88Var.e();
        ...
        if (i == 0) {
            textView.setText(u.B0("ReportTitleSpam", org.telegram.mdgram.R.string.ReportTitleSpam));
        } else if (i == 6) {
            textView.setText(u.B0("ReportTitleFake", org.telegram.mdgram.R.string.ReportTitleFake));
        } else if (i == 1) {
            textView.setText(u.B0("ReportTitleViolence", org.telegram.mdgram.R.string.ReportTitleViolence));
        } else if (i == 2) {
            textView.setText(u.B0("ReportTitleChild", org.telegram.mdgram.R.string.ReportTitleChild));
        } else if (i == 5) {
            textView.setText(u.B0("ReportTitlePornography", org.telegram.mdgram.R.string.ReportTitlePornography));
        } else if (i == 100) {
            textView.setText(u.B0("ReportChat", org.telegram.mdgram.R.string.ReportChat));
        }
        ...
        textView2.setText(u.B0("ReportInfo", org.telegram.mdgram.R.string.ReportInfo));
        ...
        this.editText.setHint(u.B0("ReportHint", org.telegram.mdgram.R.string.ReportHint));
        ...
        this.clearButton.setText(u.B0("ReportSend", org.telegram.mdgram.R.string.ReportSend));
