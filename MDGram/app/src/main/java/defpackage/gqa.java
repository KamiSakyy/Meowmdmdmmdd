...
public abstract class gqa {
    ...
    /* renamed from: a  reason: collision with other field name */
    public static final int[] f6369a = {org.telegram.mdgram.R.id.accessibility_custom_action_0, org.telegram.mdgram.R.id.accessibility_custom_action_1, org.telegram.mdgram.R.id.accessibility_custom_action_2, org.telegram.mdgram.R.id.accessibility_custom_action_3, org.telegram.mdgram.R.id.accessibility_custom_action_4, org.telegram.mdgram.R.id.accessibility_custom_action_5, org.telegram.mdgram.R.id.accessibility_custom_action_6, org.telegram.mdgram.R.id.accessibility_custom_action_7, org.telegram.mdgram.R.id.accessibility_custom_action_8, org.telegram.mdgram.R.id.accessibility_custom_action_9, org.telegram.mdgram.R.id.accessibility_custom_action_10, org.telegram.mdgram.R.id.accessibility_custom_action_11, org.telegram.mdgram.R.id.accessibility_custom_action_12, org.telegram.mdgram.R.id.accessibility_custom_action_13, org.telegram.mdgram.R.id.accessibility_custom_action_14, org.telegram.mdgram.R.id.accessibility_custom_action_15, org.telegram.mdgram.R.id.accessibility_custom_action_16, org.telegram.mdgram.R.id.accessibility_custom_action_17, org.telegram.mdgram.R.id.accessibility_custom_action_18, org.telegram.mdgram.R.id.accessibility_custom_action_19, org.telegram.mdgram.R.id.accessibility_custom_action_20, org.telegram.mdgram.R.id.accessibility_custom_action_21, org.telegram.mdgram.R.id.accessibility_custom_action_22, org.telegram.mdgram.R.id.accessibility_custom_action_23, org.telegram.mdgram.R.id.accessibility_custom_action_24, org.telegram.mdgram.R.id.accessibility_custom_action_25, org.telegram.mdgram.R.id.accessibility_custom_action_26, org.telegram.mdgram.R.id.accessibility_custom_action_27, org.telegram.mdgram.R.id.accessibility_custom_action_28, org.telegram.mdgram.R.id.accessibility_custom_action_29, org.telegram.mdgram.R.id.accessibility_custom_action_30, org.telegram.mdgram.R.id.accessibility_custom_action_31};
    ...
    public static class m {
        ...
        public static void a(WindowInsets windowInsets, View view) {
            View.OnApplyWindowInsetsListener onApplyWindowInsetsListener = (View.OnApplyWindowInsetsListener) view.getTag(org.telegram.mdgram.R.id.tag_window_insets_animation_callback);
        ...
        public static void u(View view, rr6 rr6Var) {
            if (Build.VERSION.SDK_INT < 30) {
                view.setTag(org.telegram.mdgram.R.id.tag_on_apply_window_listener, rr6Var);
            }
            if (rr6Var == null) {
                view.setOnApplyWindowInsetsListener((View.OnApplyWindowInsetsListener) view.getTag(org.telegram.mdgram.R.id.tag_window_insets_animation_callback));
            } else {
    ...
    public static class p {
        public static void a(View view, final u uVar) {
            l59 l59Var = (l59) view.getTag(org.telegram.mdgram.R.id.tag_unhandled_key_listeners);
            if (l59Var == null) {
                l59Var = new l59();
                view.setTag(org.telegram.mdgram.R.id.tag_unhandled_key_listeners, l59Var);
            }
    ...
    public static class v {
        ...
        public static v a(View view) {
            v vVar = (v) view.getTag(org.telegram.mdgram.R.id.tag_unhandled_key_event_manager);
            if (vVar == null) {
                v vVar2 = new v();
                view.setTag(org.telegram.mdgram.R.id.tag_unhandled_key_event_manager, vVar2);
                return vVar2;
            }
            return vVar;
        }
        ...
        public final boolean e(View view, KeyEvent keyEvent) {
            ArrayList arrayList = (ArrayList) view.getTag(org.telegram.mdgram.R.id.tag_unhandled_key_listeners);
            if (arrayList != null) {
    ...
    public static String[] H(View view) {
        ...
        return (String[]) view.getTag(org.telegram.mdgram.R.id.tag_on_receive_content_mime_types);
    }
    ...
    public static f N0() {
        return new c(org.telegram.mdgram.R.id.tag_state_description, CharSequence.class, 64, 30);
    }
    ...
    public static f b() {
        return new d(org.telegram.mdgram.R.id.tag_accessibility_heading, Boolean.class, 28);
    }
    ...
    public static f f0() {
        return new b(org.telegram.mdgram.R.id.tag_accessibility_pane_title, CharSequence.class, 8, 28);
    }
    ...
    public static cz1 h0(View view, cz1 cz1Var) {
        ...
        hs6 hs6Var = (hs6) view.getTag(org.telegram.mdgram.R.id.tag_on_receive_content_listener);
        if (hs6Var != null) {
    ...
    public static f q0() {
        return new a(org.telegram.mdgram.R.id.tag_screen_reader_focusable, Boolean.class, 28);
    }
    ...
    public static List s(View view) {
        ArrayList arrayList = (ArrayList) view.getTag(org.telegram.mdgram.R.id.tag_accessibility_actions);
        if (arrayList == null) {
            ArrayList arrayList2 = new ArrayList();
            view.setTag(org.telegram.mdgram.R.id.tag_accessibility_actions, arrayList2);
            return arrayList2;
        }
        return arrayList;
    }
