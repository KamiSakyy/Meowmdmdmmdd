    ...
    public /* synthetic */ void n(String str, int i, ArrayList arrayList, int i2) {
        ...
        while (i6 < arrayList.size()) {
            ...
            if ((!this.allowSelf && R8.f10563a) || ((this.onlyMutual && !R8.f10569c) || ((j45Var = this.ignoreUsers) != null && j45Var.k(tLRPC$TL_contact.f14161a) >= 0))) {
                ...
                if (xla.k(R8)) {
                    strArr4[2] = u.B0("RepliesTitle", org.telegram.mdgram.R.string.RepliesTitle).toLowerCase();
                } else if (R8.f10563a) {
                    strArr4[2] = u.B0("SavedMessages", org.telegram.mdgram.R.string.SavedMessages).toLowerCase();
                }
                int i8 = i7;
                int i9 = 0;
                char c2 = 0;
    ...
    public void onBindViewHolder(RecyclerView.d0 d0Var, int i) {
        ...
        if (itemViewType != 0) {
            if (itemViewType != 1) {
                ...
                pu9Var.f(u.d0("AddContactByPhone", org.telegram.mdgram.R.string.AddContactByPhone, z77.d().c("+" + ((String) getItem(i)))), false);
                return;
            }
            fl3 fl3Var = (fl3) d0Var.itemView;
            if (i == this.unregistredContactsHeaderRow) {
                fl3Var.setText(u.B0("InviteToTelegramShort", org.telegram.mdgram.R.string.InviteToTelegramShort));
                return;
            } else if (getItem(i) == null) {
                fl3Var.setText(u.B0("GlobalSearch", org.telegram.mdgram.R.string.GlobalSearch));
                return;
            } else {
                fl3Var.setText(u.B0("PhoneNumberSearch", org.telegram.mdgram.R.string.PhoneNumberSearch));
                return;
            }
        }
        ...
        if (aVar2 != null) {
            ...
            if (z) {
                str2 = u.B0("SavedMessages", org.telegram.mdgram.R.string.SavedMessages);
            } else {
                str2 = str3;
            }
