...
public class v4b extends f {
    ...
    public View W(Context context) {
        ...
        this.progressItem = x.i(1, org.telegram.mdgram.R.drawable.share, org.telegram.messenger.a.e0(54.0f));
        int i = this.type;
        if (i == 0) {
            x.b(0, org.telegram.mdgram.R.drawable.ic_ab_other).U(2, org.telegram.mdgram.R.drawable.msg_openin, u.B0("OpenInExternalApp", org.telegram.mdgram.R.string.OpenInExternalApp));
            ...
            this.actionBar.setTitle(u.B0("Statistics", org.telegram.mdgram.R.string.Statistics));
