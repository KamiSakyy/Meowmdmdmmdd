...
public class le9 extends FrameLayout {
    ...
    public void G(int i, boolean z) {
        ...
        if (i == 1) {
            this.premiumButtonView.h(u.B0("Unlock", org.telegram.mdgram.R.string.Unlock), new View.OnClickListener() { // from class: je9
            ...
            this.premiumButtonView.h(u.B0("Restore", org.telegram.mdgram.R.string.Restore), new View.OnClickListener() { // from class: ke9
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    le9.this.x(view);
                }
    ...
    public le9(Context context, l.r rVar, int i) {
        ...
        if (i == 2) {
            ...
            if (i == 1) {
                ...
                this.optionsButton.setImageResource(org.telegram.mdgram.R.drawable.msg_actions);
                this.optionsButton.setContentDescription(u.B0("AccDescrMoreOptions", org.telegram.mdgram.R.string.AccDescrMoreOptions));
                ...
                this.reorderButton.setImageResource(org.telegram.mdgram.R.drawable.list_reorder);
                ...
                this.optionsButton.setImageResource(org.telegram.mdgram.R.drawable.floating_check);
        ...
        this.addButtonView.setText(u.B0("Add", org.telegram.mdgram.R.string.Add));
        ...
        this.removeButtonView.setText(u.B0("StickersRemove", org.telegram.mdgram.R.string.StickersRemove));
        ...
        this.premiumButtonView.h(u.B0("Unlock", org.telegram.mdgram.R.string.Unlock), new View.OnClickListener() { // from class: he9
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                le9.this.r(view);
            }
