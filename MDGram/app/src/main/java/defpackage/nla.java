...
public class nla extends FrameLayout implements a0.d {
    ...
    public void e(i0.d dVar, CharSequence charSequence, boolean z) {
        ...
        if (i == 3 && i2 != Integer.MAX_VALUE) {
            ...
            if (currentTime <= 0) {
                if (z2) {
                    B0 = u.B0("NotificationsCustom", org.telegram.mdgram.R.string.NotificationsCustom);
                } else {
                    B0 = u.B0("NotificationsUnmuted", org.telegram.mdgram.R.string.NotificationsUnmuted);
                }
            } else if (currentTime < 3600) {
                B0 = u.d0("WillUnmuteIn", org.telegram.mdgram.R.string.WillUnmuteIn, u.U("Minutes", currentTime / 60, new Object[0]));
            } else if (currentTime < 86400) {
                B0 = u.d0("WillUnmuteIn", org.telegram.mdgram.R.string.WillUnmuteIn, u.U("Hours", (int) Math.ceil((currentTime / 60.0f) / 60.0f), new Object[0]));
            } else if (currentTime < 31536000) {
                B0 = u.d0("WillUnmuteIn", org.telegram.mdgram.R.string.WillUnmuteIn, u.U("Days", (int) Math.ceil(((currentTime / 60.0f) / 60.0f) / 24.0f), new Object[0]));
            } else {
                B0 = null;
            }
        } else {
            ...
            if (z3 && z2) {
                ...
                B0 = u.B0("NotificationsMuted", org.telegram.mdgram.R.string.NotificationsMuted);
            }
        }
        if (B0 == null) {
            B0 = u.B0("NotificationsOff", org.telegram.mdgram.R.string.NotificationsOff);
        }
        String str = B0;
        if (ic2.i(dVar.did)) {
