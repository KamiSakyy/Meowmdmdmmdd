...
public class oe9 extends LinearLayout {
    ...
    public oe9(Context context, k kVar) {
        ...
        this.c = l.u2(context, org.telegram.mdgram.R.drawable.greydivider_bottom, "windowBackgroundGrayShadow");
        ...
        ((lo9) tLRPC$TL_message2).f9686a = u.B0("StickerSizeDialogMessageReplyTo", org.telegram.mdgram.R.string.StickerSizeDialogMessageReplyTo);
        ...
        if (MDConfig.stickerSize < 9.0f) {
            i = org.telegram.mdgram.R.string.StickerSizeDialogMessageSmallOne;
            str = "StickerSizeDialogMessageSmallOne";
        } else {
            i = org.telegram.mdgram.R.string.StickerSizeDialogMessageBigOne;
