...
public class bt extends qx {
    ...
    public class b extends qx.d {
        ...
        public void h(RecyclerView.d0 d0Var, int i, boolean z) {
            ...
            if (i2 != 1) {
                if (i2 != 2) {
                    if (i2 != 3) {
                        if (i2 == 4) {
                            ...
                            if (i == bt.this.g) {
                                uw9Var.e(u.B0("AlwaysAllow", org.telegram.mdgram.R.string.AlwaysAllow), j(ns.u(true).size()), z, true);
                                return;
                            } else if (i == bt.this.h) {
                                uw9Var.e(u.B0("NeverAllow", org.telegram.mdgram.R.string.NeverAllow), j(ns.u(false).size()), z, false);
                                return;
                            } else if (i == bt.this.j) {
                                uw9Var.setTag("dialogTextRed");
                                uw9Var.setTextColor(l.B1("dialogTextRed"));
                                uw9Var.setCanDisable(true);
                                uw9Var.c(u.B0("NotificationsDeleteAllException", org.telegram.mdgram.R.string.NotificationsDeleteAllException), false);
                                return;
                            } else {
                                return;
                            }
                    ...
                    if (i == bt.this.c) {
                        if (z) {
                            ...
                            y88Var.e(u.B0("AlwaysTranslate", org.telegram.mdgram.R.string.AlwaysTranslate), MDConfig.autoTranslate, true);
                            return;
                        }
                    } else if (i == bt.this.d) {
                        if (z) {
                            ...
                            y88Var.e(u.B0("NeverTranslate", org.telegram.mdgram.R.string.NeverTranslate), !MDConfig.autoTranslate, true);
                            return;
                        }
                    } else {
                        return;
                ...
                if (i == bt.this.b) {
                    nu3Var.setText(u.B0("AutoTranslateTitle", org.telegram.mdgram.R.string.AutoTranslateTitle));
                    return;
                } else if (i == bt.this.f) {
                    nu3Var.setText(u.B0("AddExceptions", org.telegram.mdgram.R.string.AddExceptions));
                    return;
                } else {
                    return;
                }
            ...
            if (i == bt.this.e) {
                bv9Var.setText(u.B0("AutoTranslateDesc", org.telegram.mdgram.R.string.AutoTranslateDesc));
            } else if (i == bt.this.i) {
                bv9Var.setText(u.B0("AutoTranslateDesc2", org.telegram.mdgram.R.string.AutoTranslateDesc2));
            }
        }
        ...
        public final String j(int i) {
            ...
            if (i <= 0) {
                return u.B0("FilterAddChats", org.telegram.mdgram.R.string.FilterAddChats);
            }
            return U;
        }
    }
    ...
    @Override // defpackage.qx
    public String l2() {
        return u.B0("AutoTranslate", org.telegram.mdgram.R.string.AutoTranslate);
    }
        ...
        if (i != i2 && i != this.d) {
            ...
            if (i != i3 && i != this.h) {
                if (i == this.j && ns.t().size() > 0) {
                    e.k kVar = new e.k(E0());
                    kVar.x(u.B0("NotificationsDeleteAllExceptionTitle", org.telegram.mdgram.R.string.NotificationsDeleteAllExceptionTitle));
                    kVar.n(u.B0("NotificationsDeleteAllExceptionAlert", org.telegram.mdgram.R.string.NotificationsDeleteAllExceptionAlert));
                    kVar.v(u.B0("Delete", org.telegram.mdgram.R.string.Delete), new DialogInterface.OnClickListener() { // from class: at
