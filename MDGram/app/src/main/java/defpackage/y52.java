...
public class y52 extends f {
        ...
        public void onBindViewHolder(RecyclerView.d0 d0Var, int i) {
            ...
            if (itemViewType != 0) {
                ...
                if (itemViewType != 1) {
                    if (itemViewType != 2) {
                        if (itemViewType != 3) {
                            if (itemViewType != 4) {
                                if (itemViewType == 5) {
                                    ...
                                    if (i == y52.this.mobileRow) {
                                        B0 = u.B0("WhenUsingMobileData", org.telegram.mdgram.R.string.WhenUsingMobileData);
                                        z = h.K(y52.this.currentAccount).f12844d.d;
                                        I = h.K(y52.this.currentAccount).H();
                                    } else if (i == y52.this.wifiRow) {
                                        B0 = u.B0("WhenConnectedOnWiFi", org.telegram.mdgram.R.string.WhenConnectedOnWiFi);
                                        z = h.K(y52.this.currentAccount).f12847e.d;
                                        I = h.K(y52.this.currentAccount).J();
                                    } else {
                                        B0 = u.B0("WhenRoaming", org.telegram.mdgram.R.string.WhenRoaming);
                                    ...
                                    if (I.d && i3 != 0) {
                                        if (z5) {
                                            sb.append(u.B0("AutoDownloadPhotosOn", org.telegram.mdgram.R.string.AutoDownloadPhotosOn));
                                        }
                                        if (z6) {
                                            if (sb.length() > 0) {
                                                sb.append(", ");
                                            }
                                            sb.append(u.B0("AutoDownloadVideosOn", org.telegram.mdgram.R.string.AutoDownloadVideosOn));
                                            tl6Var = tl6Var2;
                                        ...
                                        if (z7) {
                                            ...
                                            sb.append(u.B0("AutoDownloadFilesOn", org.telegram.mdgram.R.string.AutoDownloadFilesOn));
                                            sb.append(String.format(" (%1$s)", org.telegram.messenger.a.u0(I.f12854a[h.p0(8)], true)));
                                        }
                                    } else {
                                        tl6Var = tl6Var2;
                                        sb.append(u.B0("NoMediaAutoDownload", org.telegram.mdgram.R.string.NoMediaAutoDownload));
                                    }
                                    if ((z5 || z6 || z7) && z) {
                                        z2 = true;
                                    } else {
                            ...
                            if (i == y52.this.enableAllStreamInfoRow) {
                                bv9Var.setText(u.B0("EnableAllStreamingInfo", org.telegram.mdgram.R.string.EnableAllStreamingInfo));
                                return;
                            }
                            return;
                        }
                        ...
                        if (i == y52.this.enableStreamRow) {
                            String B02 = u.B0("EnableStreaming", org.telegram.mdgram.R.string.EnableStreaming);
                            ...
                            if (i == y52.this.enableMkvRow) {
                                ...
                                ru9Var.i(u.B0("AutoplayGIF", org.telegram.mdgram.R.string.AutoplayGIF), e0.f12747q, true);
                                return;
                            } else if (i == y52.this.autoplayVideoRow) {
                                ru9Var.i(u.B0("AutoplayVideo", org.telegram.mdgram.R.string.AutoplayVideo), e0.f12748r, false);
                                return;
                            } else if (i == y52.this.saveToGalleryPeerRow) {
                                String B03 = u.B0("SaveToGalleryPrivate", org.telegram.mdgram.R.string.SaveToGalleryPrivate);
                                if ((e0.p & 1) != 0) {
                                    z3 = true;
                                }
                                ...
                                String B04 = u.B0("SaveToGalleryGroups", org.telegram.mdgram.R.string.SaveToGalleryGroups);
                                if ((e0.p & 2) != 0) {
                                    z3 = true;
                                }
                                ...
                                String B05 = u.B0("SaveToGalleryChannels", org.telegram.mdgram.R.string.SaveToGalleryChannels);
                                if ((e0.p & 4) == 0) {
                                    z4 = false;
                                }
                    ...
                    if (i == y52.this.mediaDownloadSectionRow) {
                        nu3Var.setText(u.B0("AutomaticMediaDownload", org.telegram.mdgram.R.string.AutomaticMediaDownload));
                        return;
                    } else if (i == y52.this.usageSectionRow) {
                        nu3Var.setText(u.B0("DataUsage", org.telegram.mdgram.R.string.DataUsage));
                        return;
                    } else if (i == y52.this.callsSectionRow) {
                        nu3Var.setText(u.B0("Calls", org.telegram.mdgram.R.string.Calls));
                        return;
                    } else if (i == y52.this.proxySectionRow) {
                        nu3Var.setText(u.B0("Proxy", org.telegram.mdgram.R.string.Proxy));
                        return;
                    } else if (i == y52.this.streamSectionRow) {
                        nu3Var.setText(u.B0("Streaming", org.telegram.mdgram.R.string.Streaming));
                        return;
                    } else if (i == y52.this.autoplayHeaderRow) {
                        nu3Var.setText(u.B0("AutoplayMedia", org.telegram.mdgram.R.string.AutoplayMedia));
                        return;
                    } else if (i == y52.this.saveToGallerySectionRow) {
                        nu3Var.setText(u.B0("SaveToGallery", org.telegram.mdgram.R.string.SaveToGallery));
                        return;
                    } else {
                        return;
                    }
                ...
                if (i == y52.this.storageUsageRow) {
                    uw9Var.setIcon(org.telegram.mdgram.R.drawable.msg_storage_usage);
                    uw9Var.c(u.B0("StorageUsage", org.telegram.mdgram.R.string.StorageUsage), true);
                    ...
                    if (i4 != 0) {
                        if (i4 != 1) {
                            if (i4 != 2) {
                                if (i4 == 3) {
                                    str2 = u.B0("UseLessDataOnRoaming", org.telegram.mdgram.R.string.UseLessDataOnRoaming);
                                }
                            } else {
                                str2 = u.B0("UseLessDataAlways", org.telegram.mdgram.R.string.UseLessDataAlways);
                            }
                        } else {
                            str2 = u.B0("UseLessDataOnMobile", org.telegram.mdgram.R.string.UseLessDataOnMobile);
                        }
                    } else {
                        str2 = u.B0("UseLessDataNever", org.telegram.mdgram.R.string.UseLessDataNever);
                    }
                    uw9Var.e(u.B0("VoipUseLessData", org.telegram.mdgram.R.string.VoipUseLessData), str2, y52.this.updateVoipUseLessData, true);
                    y52.this.updateVoipUseLessData = false;
                } else if (i == y52.this.dataUsageRow) {
                    uw9Var.setIcon(org.telegram.mdgram.R.drawable.msg_data_usage);
                    String B06 = u.B0("NetworkUsage", org.telegram.mdgram.R.string.NetworkUsage);
                    if (y52.this.storageNumRow != -1) {
                        z3 = true;
                    }
                    uw9Var.c(B06, z3);
                } else if (i == y52.this.storageNumRow) {
                    uw9Var.setIcon(org.telegram.mdgram.R.drawable.msg_storage_path);
                    uw9Var.c(u.B0("StoragePath", org.telegram.mdgram.R.string.StoragePath), false);
                } else if (i == y52.this.proxyRow) {
                    uw9Var.setIcon(0);
                    uw9Var.c(u.B0("ProxySettings", org.telegram.mdgram.R.string.ProxySettings), false);
                } else if (i == y52.this.resetDownloadRow) {
                    uw9Var.setIcon(0);
                    uw9Var.setCanDisable(true);
                    uw9Var.setTextColor(l.B1("windowBackgroundWhiteRedText"));
                    uw9Var.c(u.B0("ResetAutomaticMediaDownload", org.telegram.mdgram.R.string.ResetAutomaticMediaDownload), false);
                } else if (i == y52.this.quickRepliesRow) {
                    uw9Var.setIcon(0);
                    uw9Var.c(u.B0("VoipQuickReplies", org.telegram.mdgram.R.string.VoipQuickReplies), false);
                } else if (i == y52.this.clearDraftsRow) {
                    uw9Var.setIcon(0);
                    uw9Var.c(u.B0("PrivacyDeleteCloudDrafts", org.telegram.mdgram.R.string.PrivacyDeleteCloudDrafts), false);
                }
            } else if (i == y52.this.clearDraftsSectionRow) {
                d0Var.itemView.setBackgroundDrawable(l.u2(this.mContext, org.telegram.mdgram.R.drawable.greydivider_bottom, "windowBackgroundGrayShadow"));
            } else {
                d0Var.itemView.setBackgroundDrawable(l.u2(this.mContext, org.telegram.mdgram.R.drawable.greydivider, "windowBackgroundGrayShadow"));
            }
        }
                    ...
                    if (i != 2) {
                        if (i != 3) {
                            if (i != 4) {
                                ...
                                sz8Var.setBackgroundDrawable(l.u2(this.mContext, org.telegram.mdgram.R.drawable.greydivider, "windowBackgroundGrayShadow"));
                            }
                        } else {
            ...
            if (i != this.mobileRow && i != this.roamingRow && i != this.wifiRow) {
                if (i == this.resetDownloadRow) {
                    if (E0() != null && view.isEnabled()) {
                        e.k kVar = new e.k(E0());
                        kVar.x(u.B0("ResetAutomaticMediaDownloadAlertTitle", org.telegram.mdgram.R.string.ResetAutomaticMediaDownloadAlertTitle));
                        kVar.n(u.B0("ResetAutomaticMediaDownloadAlert", org.telegram.mdgram.R.string.ResetAutomaticMediaDownloadAlert));
                        kVar.v(u.B0("Reset", org.telegram.mdgram.R.string.Reset), new DialogInterface.OnClickListener() { // from class: s52
                    ...
                    if (i7 != 0) {
                        ...
                        Dialog K2 = org.telegram.ui.Components.b.K2(E0(), new String[]{u.B0("UseLessDataNever", org.telegram.mdgram.R.string.UseLessDataNever), u.B0("UseLessDataOnRoaming", org.telegram.mdgram.R.string.UseLessDataOnRoaming), u.B0("UseLessDataOnMobile", org.telegram.mdgram.R.string.UseLessDataOnMobile), u.B0("UseLessDataAlways", org.telegram.mdgram.R.string.UseLessDataAlways)}, u.B0("VoipUseLessData", org.telegram.mdgram.R.string.VoipUseLessData), i2, new DialogInterface.OnClickListener() { // from class: t52
                            @Override // android.content.DialogInterface.OnClickListener
                    ...
                    i2 = 0;
                    Dialog K22 = org.telegram.ui.Components.b.K2(E0(), new String[]{u.B0("UseLessDataNever", org.telegram.mdgram.R.string.UseLessDataNever), u.B0("UseLessDataOnRoaming", org.telegram.mdgram.R.string.UseLessDataOnRoaming), u.B0("UseLessDataOnMobile", org.telegram.mdgram.R.string.UseLessDataOnMobile), u.B0("UseLessDataAlways", org.telegram.mdgram.R.string.UseLessDataAlways)}, u.B0("VoipUseLessData", org.telegram.mdgram.R.string.VoipUseLessData), i2, new DialogInterface.OnClickListener() { // from class: t52
                        @Override // android.content.DialogInterface.OnClickListener
                        public final void onClick(DialogInterface dialogInterface, int i8) {
                            y52.this.k3(g8, i, dialogInterface, i8);
                        }
                    ...
                    kVar2.x(u.B0("StoragePath", org.telegram.mdgram.R.string.StoragePath));
                    ...
                    kVar3.x(u.B0("AreYouSureClearDraftsTitle", org.telegram.mdgram.R.string.AreYouSureClearDraftsTitle));
                    kVar3.n(u.B0("AreYouSureClearDrafts", org.telegram.mdgram.R.string.AreYouSureClearDrafts));
                    kVar3.v(u.B0("Delete", org.telegram.mdgram.R.string.Delete), new DialogInterface.OnClickListener() { // from class: v52
                        @Override // android.content.DialogInterface.OnClickListener
                        public final void onClick(DialogInterface dialogInterface, int i10) {
                            y52.this.o3(dialogInterface, i10);
                        }
                    });
                    kVar3.p(u.B0("Cancel", org.telegram.mdgram.R.string.Cancel), null);
                    e a3 = kVar3.a();
                    f2(a3);
    ...
    public View W(final Context context) {
        ...
        this.actionBar.setTitle(u.B0("DataSettings", org.telegram.mdgram.R.string.DataSettings));
