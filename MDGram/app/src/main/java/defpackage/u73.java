...
public class u73 extends org.telegram.ui.ActionBar.f implements a0.d {
    ...
    public static class c extends FrameLayout {
        ...
        public c(Context context) {
            ...
            this.moveImageView.setImageResource(org.telegram.mdgram.R.drawable.list_reorder);
            this.moveImageView.setColorFilter(new PorterDuffColorFilter(l.B1("stickers_menu"), PorterDuff.Mode.MULTIPLY));
            this.moveImageView.setContentDescription(u.B0("FilterReorder", org.telegram.mdgram.R.string.FilterReorder));
            ...
            this.optionsImageView.setImageResource(org.telegram.mdgram.R.drawable.msg_actions);
            this.optionsImageView.setContentDescription(u.B0("AccDescrMoreOptions", org.telegram.mdgram.R.string.AccDescrMoreOptions));
    ...
    public static class d extends FrameLayout {
        ...
        public d(Context context) {
            ...
            e88Var.g(org.telegram.mdgram.R.raw.filters, 90, 90);
            ...
            this.messageTextView.setText(org.telegram.messenger.a.b3(u.d0("CreateNewFilterInfo", org.telegram.mdgram.R.string.CreateNewFilterInfo, new Object[0])));
    ...
    public class e extends v1.s {
        ...
        public /* synthetic */ void s(final y.b bVar, DialogInterface dialogInterface, int i) {
            if (i == 0) {
                ...
                kVar.x(u.B0("FilterDelete", org.telegram.mdgram.R.string.FilterDelete));
                kVar.n(u.B0("FilterDeleteAlert", org.telegram.mdgram.R.string.FilterDeleteAlert));
                kVar.p(u.B0("Cancel", org.telegram.mdgram.R.string.Cancel), null);
                kVar.v(u.B0("Delete", org.telegram.mdgram.R.string.Delete), new DialogInterface.OnClickListener() { // from class: c83
        ...
        public /* synthetic */ void t(View view) {
            ...
            kVar.m(new CharSequence[]{u.B0("FilterEditItem", org.telegram.mdgram.R.string.FilterEditItem), u.B0("FilterDeleteItem", org.telegram.mdgram.R.string.FilterDeleteItem)}, new int[]{org.telegram.mdgram.R.drawable.msg_edit, org.telegram.mdgram.R.drawable.msg_delete}, new DialogInterface.OnClickListener() { // from class: b83
                @Override // android.content.DialogInterface.OnClickListener
        ...
        public void onBindViewHolder(RecyclerView.d0 d0Var, int i) {
                ...
                switch (itemViewType) {
                    ...
                    case 4:
                        ...
                        if (i == u73.this.createFilterRow) {
                            ...
                            gVar.a(u.B0("CreateNewFilter", org.telegram.mdgram.R.string.CreateNewFilter), new nq1(drawable, drawable2), false);
                            return;
                        }
                        return;
                    case 5:
                    ...
                    case 6:
                        ...
                        if (i == u73.this.folderStyleTitlesRow) {
                            String B0 = u.B0("FoldersTypeTitles", org.telegram.mdgram.R.string.FoldersTypeTitles);
                            ...
                            String B02 = u.B0("FoldersTypeIcons", org.telegram.mdgram.R.string.FoldersTypeIcons);
                            ...
                            String B03 = u.B0("FoldersTypeIconsTitles", org.telegram.mdgram.R.string.FoldersTypeIconsTitles);
                    ...
                    case 7:
                        ...
                        ru9Var.h(true, null);
                        if (i == u73.this.hideAllTabRow) {
                            ru9Var.j(u.B0("HideAllTab", org.telegram.mdgram.R.string.HideAllTab), null, MDConfig.hideAllTab, true, true);
                            return;
                        }
                        return;
                    default:
            ...
            if (i == u73.this.filtersHeaderRow) {
                nu3Var.setText(u.B0("Filters", org.telegram.mdgram.R.string.Filters));
            } else if (i == u73.this.recommendedHeaderRow) {
                nu3Var.setText(u.B0("FilterRecommended", org.telegram.mdgram.R.string.FilterRecommended));
            } else if (i == u73.this.folderStyleHeaderRow) {
                nu3Var.setText(u.B0("FoldersType", org.telegram.mdgram.R.string.FoldersType));
            }
        }
        ...
        public RecyclerView.d0 onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            if (i != 0) {
                if (i != 1) {
                    ...
                    dVar.setBackgroundDrawable(l.u2(this.mContext, org.telegram.mdgram.R.drawable.greydivider_top, "windowBackgroundGrayShadow"));
                    fVar = dVar;
                }
            } else {
    ...
    public void Q2() {
        ...
        q.p0(this).V(org.telegram.mdgram.R.raw.filter_reorder, org.telegram.messenger.a.b3(u.d0("LimitReachedReorderFolder", org.telegram.mdgram.R.string.LimitReachedReorderFolder, u.z0(org.telegram.mdgram.R.string.FilterAllChats))), u.B0("PremiumMore", org.telegram.mdgram.R.string.PremiumMore), 5000, new Runnable() { // from class: t73
            @Override // java.lang.Runnable
            public final void run() {
                u73.this.O2();
            }
    ...
    public View W(final Context context) {
        ...
        this.actionBar.setTitle(u.B0("Filters", org.telegram.mdgram.R.string.Filters));
