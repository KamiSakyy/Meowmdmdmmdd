...
public class c95 extends cg {
    ...
    public c95(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, org.telegram.mdgram.R.attr.autoCompleteTextViewStyle);
    }
    ...
    public c95(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray i2 = c0a.i(context2, attributeSet, r78.f17875u0, i, org.telegram.mdgram.R.style.Widget.AppCompat.AutoCompleteTextView, new int[0]);
        if (i2.hasValue(0) && i2.getInt(0, 0) == 0) {
            setKeyListener(null);
        }
        this.f2507a = i2.getResourceId(2, org.telegram.mdgram.R.layout.mtrl_auto_complete_simple_item);
        this.a = i2.getDimensionPixelOffset(1, org.telegram.mdgram.R.dimen.mtrl_exposed_dropdown_menu_popup_elevation);
        this.b = i2.getColor(3, 0);
        this.f2508a = j95.b(context2, i2, 4);
        ...
        kq4Var.L(new a());
        if (i2.hasValue(5)) {
            setSimpleItems(i2.getResourceId(5, 0));
        }
        i2.recycle();
    }
