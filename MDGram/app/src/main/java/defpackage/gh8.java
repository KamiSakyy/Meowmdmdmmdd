...
public abstract class gh8 {
    ...
    public static class a {
        ...
        public static Drawable b(Context context, int i) {
            ...
            return new RippleDrawable(g95.f(context, org.telegram.mdgram.R.attr.colorControlHighlight, ColorStateList.valueOf(0)), null, new InsetDrawable((Drawable) gradientDrawable, i, i, i, i));
        }
    }
