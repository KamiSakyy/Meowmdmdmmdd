...
public class i95 extends uh {
    public static final int a = org.telegram.mdgram.R.style.Widget.MaterialComponents.CompoundButton.RadioButton;
    ...
    public i95(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, org.telegram.mdgram.R.attr.radioButtonStyle);
    }

    private ColorStateList getMaterialThemeColorsTintList() {
        if (this.f7348a == null) {
            int d = g95.d(this, org.telegram.mdgram.R.attr.colorControlActivated);
            int d2 = g95.d(this, org.telegram.mdgram.R.attr.colorOnSurface);
            int d3 = g95.d(this, org.telegram.mdgram.R.attr.colorSurface);
            int[][] iArr = f7347a;
