...
public class ok2 extends FrameLayout {
    ...
    public void onAttachedToWindow() {
        ...
        this.textView.setText(u.B0("AddAccount", org.telegram.mdgram.R.string.AddAccount));
        Drawable drawable = getResources().getDrawable(org.telegram.mdgram.R.drawable.msg_add);
        if (drawable != null) {
