    ...
    public void F(int i) {
        ...
        if (i != this.lastWidth) {
            ...
            if (fm9Var != null) {
                ...
                B0 = u.B0("SwipeToGoNextChannelEnd", org.telegram.mdgram.R.string.SwipeToGoNextChannelEnd);
            }
            String str = B0;
            ...
            if (z && (i2 = this.dialogFolderId) != this.folderId && i2 != 0) {
                B02 = u.B0("SwipeToGoNextArchive", org.telegram.mdgram.R.string.SwipeToGoNextArchive);
                B03 = u.B0("ReleaseToGoNextArchive", org.telegram.mdgram.R.string.ReleaseToGoNextArchive);
            } else if (z) {
                B02 = u.B0("SwipeToGoNextFolder", org.telegram.mdgram.R.string.SwipeToGoNextFolder);
                B03 = u.B0("ReleaseToGoNextFolder", org.telegram.mdgram.R.string.ReleaseToGoNextFolder);
            } else {
                B02 = u.B0("SwipeToGoNextChannel", org.telegram.mdgram.R.string.SwipeToGoNextChannel);
                B03 = u.B0("ReleaseToGoNextChannel", org.telegram.mdgram.R.string.ReleaseToGoNextChannel);
            }
            String str2 = B02;
            String str3 = B03;
