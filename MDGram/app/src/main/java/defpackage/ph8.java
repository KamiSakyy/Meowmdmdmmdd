...
public class ph8 {
    public int lastSizesHash;
    public RadialGradient radialGradient = new RadialGradient(0.0f, 0.0f, 100.0f, new int[]{0, 0, jq1.p(-16777216, 40)}, new float[]{0.0f, 0.7f, 1.0f}, Shader.TileMode.CLAMP);
    public Paint shaderPaint = new Paint();
