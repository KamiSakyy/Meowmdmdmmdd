...
public class ju9 extends FrameLayout {
    ...
    public ju9(Context context) {
        ...
        imageView.setImageResource(org.telegram.mdgram.R.drawable.logo_middle);
        ...
        this.titleTextView.setText(u.B0("PrivacyPolicyAndTerms", org.telegram.mdgram.R.string.PrivacyPolicyAndTerms));
        ...
        textView3.setText(u.B0("Decline", org.telegram.mdgram.R.string.Decline).toUpperCase());
        ...
        textView4.setText(u.B0("Accept", org.telegram.mdgram.R.string.Accept));
    ...
    public /* synthetic */ void l(e eVar, org.telegram.tgnet.a aVar, TLRPC$TL_error tLRPC$TL_error) {
        ...
        if (aVar instanceof TLRPC$TL_boolTrue) {
            ...
            String B0 = u.B0("ErrorOccurred", org.telegram.mdgram.R.string.ErrorOccurred);
    ...
    public /* synthetic */ void o(DialogInterface dialogInterface, int i) {
        e.k kVar = new e.k(getContext());
        kVar.n(u.B0("TosDeclineDeleteAccount", org.telegram.mdgram.R.string.TosDeclineDeleteAccount));
        kVar.x(u.B0("AppName", org.telegram.mdgram.R.string.AppName));
        kVar.v(u.B0("Deactivate", org.telegram.mdgram.R.string.Deactivate), new DialogInterface.OnClickListener() { // from class: fu9
    ...
    public /* synthetic */ void p(View view) {
        ...
        kVar.x(u.B0("TermsOfService", org.telegram.mdgram.R.string.TermsOfService));
        kVar.v(u.B0("DeclineDeactivate", org.telegram.mdgram.R.string.DeclineDeactivate), new DialogInterface.OnClickListener() { // from class: eu9
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i) {
                ju9.this.o(dialogInterface, i);
            }
        });
        kVar.p(u.B0("Back", org.telegram.mdgram.R.string.Back), null);
        kVar.n(u.B0("TosUpdateDecline", org.telegram.mdgram.R.string.TosUpdateDecline));
        kVar.G();
    }
    ...
    public /* synthetic */ void r(View view) {
        if (this.currentTos.b != 0) {
            e.k kVar = new e.k(view.getContext());
            kVar.x(u.B0("TosAgeTitle", org.telegram.mdgram.R.string.TosAgeTitle));
            kVar.v(u.B0("Agree", org.telegram.mdgram.R.string.Agree), new DialogInterface.OnClickListener() { // from class: du9
                @Override // android.content.DialogInterface.OnClickListener
                public final void onClick(DialogInterface dialogInterface, int i) {
            ...
            kVar.p(u.B0("Cancel", org.telegram.mdgram.R.string.Cancel), null);
            kVar.n(u.d0("TosAgeText", org.telegram.mdgram.R.string.TosAgeText, u.U("Years", this.currentTos.b, new Object[0])));
            kVar.G();
            return;
        }
        i();
