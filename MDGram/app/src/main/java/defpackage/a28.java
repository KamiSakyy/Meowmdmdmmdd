...
public class a28 extends f implements a0.d {
    ...
    public class c extends a.j {
        ...
        public void b(int i) {
            ...
            if (i != -1) {
                if (i != 0) {
                    if (i == 1) {
                        ...
                        if (a28.this.selectedItems.size() > 1) {
                            i3 = org.telegram.mdgram.R.string.ShareLinks;
                        } else {
                            i3 = org.telegram.mdgram.R.string.ShareLink;
                        }
                ...
                if (a28.this.selectedItems.size() > 1) {
                    i2 = org.telegram.mdgram.R.string.DeleteProxyMultiConfirm;
                } else {
                    i2 = org.telegram.mdgram.R.string.DeleteProxyConfirm;
                }
                kVar.n(u.z0(i2));
                kVar.p(u.B0("Cancel", org.telegram.mdgram.R.string.Cancel), null);
                kVar.x(u.z0(org.telegram.mdgram.R.string.DeleteProxyTitle));
                kVar.v(u.z0(org.telegram.mdgram.R.string.Delete), new DialogInterface.OnClickListener() { // from class: b28
    ...
    public class e extends FrameLayout {
        ...
        public e(Context context) {
            ...
            imageView.setImageResource(org.telegram.mdgram.R.drawable.msg_info);
            ...
            this.checkImageView.setContentDescription(u.B0("Edit", org.telegram.mdgram.R.string.Edit));
        ...
        public void j() {
            ...
            if (e0.f12715a == this.currentInfo && a28.this.useProxySettings) {
                if (a28.this.currentConnectionState != 3 && a28.this.currentConnectionState != 5) {
                    this.valueTextView.setText(u.B0("Connecting", org.telegram.mdgram.R.string.Connecting));
                } else {
                    if (this.currentInfo.b != 0) {
                        TextView textView = this.valueTextView;
                        textView.setText(u.B0("Connected", org.telegram.mdgram.R.string.Connected) + ", " + u.d0("Ping", org.telegram.mdgram.R.string.Ping, Long.valueOf(this.currentInfo.b)));
                    } else {
                        this.valueTextView.setText(u.B0("Connected", org.telegram.mdgram.R.string.Connected));
                    }
                ...
                if (dVar2.f12760a) {
                    this.valueTextView.setText(u.B0("Checking", org.telegram.mdgram.R.string.Checking));
                } else if (dVar2.f12762b) {
                    if (dVar2.b != 0) {
                        TextView textView2 = this.valueTextView;
                        textView2.setText(u.B0("Available", org.telegram.mdgram.R.string.Available) + ", " + u.d0("Ping", org.telegram.mdgram.R.string.Ping, Long.valueOf(this.currentInfo.b)));
                    } else {
                        this.valueTextView.setText(u.B0("Available", org.telegram.mdgram.R.string.Available));
                    }
                    str = "windowBackgroundWhiteGreenText";
                } else {
                    this.valueTextView.setText(u.B0("Unavailable", org.telegram.mdgram.R.string.Unavailable));
        ...
        public void setChecked(boolean z) {
            if (z) {
                if (this.checkDrawable == null) {
                    this.checkDrawable = getResources().getDrawable(org.telegram.mdgram.R.drawable.proxy_check).mutate();
                }
                Drawable drawable = this.checkDrawable;
                if (drawable != null) {
                    drawable.setColorFilter(new PorterDuffColorFilter(this.color, PorterDuff.Mode.MULTIPLY));
    ...
    public /* synthetic */ void S2(View view, int i) {
        ...
        if (i == this.useProxyRow) {
            ...
            e.k kVar = new e.k(E0());
            kVar.n(u.z0(org.telegram.mdgram.R.string.DeleteAllProxiesConfirm));
            kVar.p(u.B0("Cancel", org.telegram.mdgram.R.string.Cancel), null);
            kVar.x(u.z0(org.telegram.mdgram.R.string.DeleteProxyTitle));
            kVar.v(u.z0(org.telegram.mdgram.R.string.Delete), new DialogInterface.OnClickListener() { // from class: w18
                @Override // android.content.DialogInterface.OnClickListener
    ...
    public View W(Context context) {
        ...
        this.actionBar.setTitle(u.B0("ProxySettings", org.telegram.mdgram.R.string.ProxySettings));
        ...
        this.shareMenuItem = t.i(1, org.telegram.mdgram.R.drawable.msg_share, org.telegram.messenger.a.e0(54.0f));
        this.deleteMenuItem = t.i(0, org.telegram.mdgram.R.drawable.msg_delete, org.telegram.messenger.a.e0(54.0f));
    ...
    public class d extends v1.s {
        ...
        public void onBindViewHolder(RecyclerView.d0 d0Var, int i) {
            ...
            if (itemViewType == 1) {
                ...
                if (i == a28.this.proxyAddRow) {
                    uw9Var.c(u.B0("AddProxy", org.telegram.mdgram.R.string.AddProxy), a28.this.deleteAllRow != -1);
                } else if (i == a28.this.deleteAllRow) {
                    uw9Var.setTextColor(l.B1("windowBackgroundWhiteRedText4"));
                    uw9Var.c(u.z0(org.telegram.mdgram.R.string.DeleteAllProxies), false);
                }
            } else if (itemViewType == 2) {
                nu3 nu3Var = (nu3) d0Var.itemView;
                if (i == a28.this.connectionsHeaderRow) {
                    nu3Var.setText(u.B0("ProxyConnections", org.telegram.mdgram.R.string.ProxyConnections));
                }
            } else if (itemViewType == 3) {
                ru9 ru9Var = (ru9) d0Var.itemView;
                if (i == a28.this.useProxyRow) {
                    ru9Var.i(u.B0("UseProxySettings", org.telegram.mdgram.R.string.UseProxySettings), a28.this.useProxySettings, false);
                } else if (i == a28.this.callsRow) {
                    ru9Var.i(u.B0("UseProxyForCalls", org.telegram.mdgram.R.string.UseProxyForCalls), a28.this.useProxyForCalls, false);
                }
            } else if (itemViewType == 4) {
                bv9 bv9Var = (bv9) d0Var.itemView;
                if (i == a28.this.callsDetailRow) {
                    bv9Var.setText(u.B0("UseProxyForCallsInfo", org.telegram.mdgram.R.string.UseProxyForCallsInfo));
