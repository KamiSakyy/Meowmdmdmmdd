...
public class w1 extends View {
    ...
    public w1(Context context) {
        ...
        String B0 = u.B0("AcceptCall", org.telegram.mdgram.R.string.AcceptCall);
        String B02 = u.B0("DeclineCall", org.telegram.mdgram.R.string.DeclineCall);
        String B03 = u.B0("RetryCall", org.telegram.mdgram.R.string.RetryCall);
        ...
        this.f21316a = sz1.e(context, org.telegram.mdgram.R.drawable.calls_decline).mutate();
        Drawable mutate = sz1.e(context, org.telegram.mdgram.R.drawable.ic_close_white).mutate();
        this.f21325b = mutate;
        ...
        this.f21329c = j1;
        j1.setCallback(this);
        this.f21332d = sz1.e(context, org.telegram.mdgram.R.drawable.call_arrow_right);
    }
