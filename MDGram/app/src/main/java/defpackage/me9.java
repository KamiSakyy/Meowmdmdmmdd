...
public class me9 extends LinearLayout {
    ...
    public me9(Context context) {
        ...
        textView.setText(u.B0("GroupStickersInfo", org.telegram.mdgram.R.string.GroupStickersInfo));
        ...
        this.addButton.setText(u.B0("ChooseStickerSet", org.telegram.mdgram.R.string.ChooseStickerSet).toUpperCase());
