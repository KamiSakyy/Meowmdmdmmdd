...
public class d55 extends f implements a0.d {
    ...
    public class c extends v1.s {
        ...
        public void onBindViewHolder(RecyclerView.d0 d0Var, int i) {
            ...
            if (itemViewType != 1) {
                if (itemViewType != 2) {
                    if (itemViewType != 3) {
                        if (itemViewType == 4) {
                            ...
                            if (i == d55.this.b) {
                                nu3Var.setText(u.B0("StickerSize", org.telegram.mdgram.R.string.StickerSize));
                                return;
                            } else if (i == d55.this.e) {
                                nu3Var.setText(u.B0("ChatActionbarStyle", org.telegram.mdgram.R.string.ChatActionbarStyle));
                                return;
                            } else if (i == d55.this.h) {
                                nu3Var.setText(u.B0("chatEntry_header", org.telegram.mdgram.R.string.chatEntry_header));
                                return;
                            } else if (i == d55.this.s) {
                                nu3Var.setText(u.B0("bubble_header", org.telegram.mdgram.R.string.bubble_header));
                                return;
                            } else if (i == d55.this.p) {
                                nu3Var.setText(u.B0("blur_alpha_info", org.telegram.mdgram.R.string.blur_alpha_info));
                                return;
                            } else if (i == d55.this.m) {
                                nu3Var.setText(u.B0("MediaSettings", org.telegram.mdgram.R.string.MediaSettings));
                                return;
                            } else {
                                return;
                            }
                    ...
                    ru9Var.h(true, null);
                    if (i == d55.this.i) {
                        ru9Var.j(u.B0("chatEntry_hint_hide", org.telegram.mdgram.R.string.chatEntry_hint_hide), u.B0("chatEntry_hint_hide_sum", org.telegram.mdgram.R.string.chatEntry_hint_hide_sum), MDConfig.allowHint, true, false);
                        return;
                    } else if (i == d55.this.j) {
                        ru9Var.i(u.B0("hideSendAsChannel", org.telegram.mdgram.R.string.hideSendAsChannel), MDConfig.hideSendAsChannel, false);
                        return;
                    } else if (i == d55.this.o) {
                        ru9Var.j("Blur Effect", "Enable Blur in chat", e0.F, true, false);
                        return;
                    } else if (i == d55.this.r) {
                        ru9Var.i(u.B0("DisablePhotoViewerSideAction", org.telegram.mdgram.R.string.DisablePhotoViewerSideAction), MDConfig.disablePhotoSideAction, false);
                        return;
                    } else if (i == d55.this.v) {
                        ru9Var.i(u.B0("EnablemenuContextRowBlur", org.telegram.mdgram.R.string.EnablemenuContextRowBlur), MDConfig.enableBlurMenuContext, false);
                        return;
                    } else if (i == d55.this.k) {
                        ru9Var.i(u.B0("JumpToNextChannel", org.telegram.mdgram.R.string.JumpToNextChannel), MDConfig.jumpChannel, true);
                        return;
                    } else if (i == d55.this.l) {
                        ru9Var.j(u.B0("VoiceEnhancements", org.telegram.mdgram.R.string.VoiceEnhancements), u.B0("VoiceEnhancementsDesc", org.telegram.mdgram.R.string.VoiceEnhancementsDesc), MDConfig.voicesAgc, true, true);
                        return;
                    } else if (i == d55.this.n) {
                        ru9Var.i(u.B0("DisableProximityEvents", org.telegram.mdgram.R.string.DisableProximityEvents), MDConfig.disableProximityEvents, true);
                        return;
                    } else {
                        return;
                    }
                ...
                if (i == d55.this.c) {
                    uw9Var.d(u.B0("StickerSize", org.telegram.mdgram.R.string.StickerSize), String.valueOf(Math.round(MDConfig.stickerSize)), false);
                }
                if (i == d55.this.u) {
                    uw9Var.d(u.B0("MessageMenu", org.telegram.mdgram.R.string.MessageMenu), null, false);
                    return;
                }
                return;
            }
    ...
    public final void R2() {
        ...
        Activity E0 = E0();
        e.k kVar = new e.k(E0);
        kVar.x(u.B0("MessageMenu", org.telegram.mdgram.R.string.MessageMenu));
        ...
        for (int i = 0; i < 12; i++) {
            ...
            switch (i) {
                case 0:
                    ru9Var.i(u.B0("DeleteDownloadedFile", org.telegram.mdgram.R.string.DeleteDownloadedFile), MDConfig.showDeleteDownloadedFile, false);
                    break;
                case 1:
                    ru9Var.i(u.B0("AddToSavedMessages", org.telegram.mdgram.R.string.AddToSavedMessages), MDConfig.showAddToSavedMessages, false);
                    break;
                case 2:
                    ru9Var.i(u.B0("Repeat", org.telegram.mdgram.R.string.Repeat), MDConfig.showRepeat, false);
                    break;
                case 3:
                    ru9Var.i(u.B0("ViewHistory", org.telegram.mdgram.R.string.ViewHistory), MDConfig.showViewHistory, false);
                    break;
                case 4:
                    ru9Var.i(u.B0("Translate", org.telegram.mdgram.R.string.Translate), MDConfig.showTranslate, false);
                    break;
                case 5:
                    ru9Var.i(u.B0("ReportChat", org.telegram.mdgram.R.string.ReportChat), MDConfig.showReport, false);
                    break;
                case 6:
                    ru9Var.i(u.B0("EditAdminRights", org.telegram.mdgram.R.string.EditAdminRights), MDConfig.showAdminActions, false);
                    break;
                case 7:
                    ru9Var.i(u.B0("ChangePermissions", org.telegram.mdgram.R.string.ChangePermissions), MDConfig.showChangePermissions, false);
                    break;
                case 8:
                    ru9Var.i(u.B0("MessageDetails", org.telegram.mdgram.R.string.MessageDetails), MDConfig.showMessageDetails, false);
                    break;
                case 9:
                    ru9Var.i(u.B0("CopyPhoto", org.telegram.mdgram.R.string.CopyPhoto), MDConfig.showCopyPhoto, false);
                    break;
                case 10:
                    ru9Var.i(u.B0("MD_Wa", org.telegram.mdgram.R.string.MD_Wa), MDConfig.showForwardToWa, false);
                    break;
                case 11:
                    ru9Var.i(u.B0("MD_Mess", org.telegram.mdgram.R.string.MD_Mess), MDConfig.showForwardToMess, false);
                    break;
            }
    ...
    public View W(Context context) {
        ...
        this.actionBar.setTitle(u.B0("Chats", org.telegram.mdgram.R.string.Chats));
        this.actionBar.setBackgroundColor(l.B1("windowBackgroundWhite"));
        if (org.telegram.messenger.a.Y1()) {
            this.actionBar.setOccupyStatusBar(false);
        }
        org.telegram.ui.ActionBar.c b2 = this.actionBar.x().b(0, org.telegram.mdgram.R.drawable.msg_reset);
        this.f3857a = b2;
        b2.setContentDescription(u.B0("ResetStickerSize", org.telegram.mdgram.R.string.ResetStickerSize));
