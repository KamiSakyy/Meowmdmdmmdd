...
public class ska {
    ...
    public void n(final String str, String str2, final String str3, int i) {
        try {
            View inflate = ((LayoutInflater) this.f18897a.getSystemService("layout_inflater")).inflate(org.telegram.mdgram.R.layout.md_content_updater, (ViewGroup) null);
            final com.google.android.material.bottomsheet.a aVar = new com.google.android.material.bottomsheet.a(this.f18897a, org.telegram.mdgram.R.style.BottomDialog);
            Drawable e = sz1.e(this.f18897a, org.telegram.mdgram.R.drawable.rounded_background);
            ...
            Drawable e2 = sz1.e(this.f18897a, org.telegram.mdgram.R.drawable.rounded_card_button);
