...
public class ft extends qx {
    ...
    public class b extends qx.d {
        ...
        public /* synthetic */ boolean n(final ns.a aVar, final int i, w65 w65Var, boolean z) {
            if (z) {
                ...
                if ((aVar2 instanceof fm9) && ((fm9) aVar2).v) {
                    arrayList.add(u.B0("EditTopicsException", org.telegram.mdgram.R.string.EditTopicsException));
                    arrayList2.add(0);
                    arrayList3.add(Integer.valueOf(org.telegram.mdgram.R.drawable.msg_edit));
                }
                arrayList.add(u.B0("EditDeleteException", org.telegram.mdgram.R.string.EditDeleteException));
        ...
        public void h(RecyclerView.d0 d0Var, final int i, boolean z) {
            ...
            if (i2 != 1) {
                ...
                if (i == ft.this.d) {
                    nu3Var.setText(u.B0("PrivacyExceptions", org.telegram.mdgram.R.string.PrivacyExceptions));
                    return;
                }
                return;
            }
            ...
            if (i == ft.this.b) {
                ...
                u65Var.c(u.B0("PrivacyAddAnException", org.telegram.mdgram.R.string.PrivacyAddAnException), null, org.telegram.mdgram.R.drawable.msg_contact_add, false);
            }
        }
        ...
        public final void p(final int i, final ns.a aVar) {
            ...
            kVar.n(u.d0("EditRemoveExceptionText", org.telegram.mdgram.R.string.EditRemoveExceptionText, E0));
            kVar.v(u.B0("Delete", org.telegram.mdgram.R.string.Delete), new DialogInterface.OnClickListener() { // from class: ht
                @Override // android.content.DialogInterface.OnClickListener
                public final void onClick(DialogInterface dialogInterface, int i2) {
    ...
    public String l2() {
        ...
        String str;
        if (this.a) {
            i = org.telegram.mdgram.R.string.AlwaysAllow;
            str = "AlwaysAllow";
        } else {
            i = org.telegram.mdgram.R.string.NeverAllow;
            str = "NeverAllow";
        }
        return u.B0(str, i);
    }
    ...
    public void p2(View view, int i, float f, float f2) {
        ...
        if (i == this.b) {
            ...
            kVar.v(u.B0("Delete", org.telegram.mdgram.R.string.Delete), new DialogInterface.OnClickListener() { // from class: et
                @Override // android.content.DialogInterface.OnClickListener
                public final void onClick(DialogInterface dialogInterface, int i2) {
