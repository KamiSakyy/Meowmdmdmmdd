                    ...
                    if (i != 3) {
                        if (i != 4) {
                            if (i != 5) {
                                ...
                                this.f2008a.setImageResource(org.telegram.mdgram.R.drawable.stickers_empty);
                                ...
                                textView.setText(u.B0("NoStickersFound", org.telegram.mdgram.R.string.NoStickersFound));
