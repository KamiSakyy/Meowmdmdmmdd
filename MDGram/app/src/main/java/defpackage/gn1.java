...
public class gn1 extends iu2 {
    ...
    public gn1(com.google.android.material.textfield.a aVar) {
        ...
        this.a = hh6.f(aVar.getContext(), org.telegram.mdgram.R.attr.motionDurationShort3, 100);
        this.b = hh6.f(aVar.getContext(), org.telegram.mdgram.R.attr.motionDurationShort3, 150);
        this.f6275a = hh6.g(aVar.getContext(), org.telegram.mdgram.R.attr.motionEasingLinearInterpolator, ye.a);
        this.f6280b = hh6.g(aVar.getContext(), org.telegram.mdgram.R.attr.motionEasingEmphasizedInterpolator, ye.d);
    }
    ...
    @Override // defpackage.iu2
    public int c() {
        return org.telegram.mdgram.R.string.clear_text_end_icon_content_description;
    }

    @Override // defpackage.iu2
    public int d() {
        return org.telegram.mdgram.R.drawable.mtrl_ic_cancel;
    }
