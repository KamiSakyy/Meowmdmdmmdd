    ...
    public class a extends a.j {
        ...
        public void b(int i) {
            ...
            if (i == 1) {
                ...
                kVar.p(u.B0("Cancel", org.telegram.mdgram.R.string.Cancel), new DialogInterface.OnClickListener() { // from class: ap6
                    @Override // android.content.DialogInterface.OnClickListener
                    public final void onClick(DialogInterface dialogInterface, int i2) {
                        dialogInterface.dismiss();
                    }
                });
                kVar.v(u.B0("Delete", org.telegram.mdgram.R.string.Delete), new DialogInterface.OnClickListener() { // from class: bp6
                    @Override // android.content.DialogInterface.OnClickListener
                    public final void onClick(DialogInterface dialogInterface, int i2) {
            ...
            if (itemViewType != 0) {
                if (itemViewType != 1) {
                    if (itemViewType == 2) {
                        ...
                        Drawable drawable = o12Var.getContext().getResources().getDrawable(org.telegram.mdgram.R.drawable.poll_add_circle);
                        Drawable drawable2 = o12Var.getContext().getResources().getDrawable(org.telegram.mdgram.R.drawable.poll_add_plus);
                        ...
                        o12Var.a(u.B0("UploadSound", org.telegram.mdgram.R.string.UploadSound), new nq1(drawable, drawable2), false);
                        return;
                    }
                    return;
                }
                ...
                dp6 dp6Var = dp6.this;
                if (i == dp6Var.serverTonesHeaderRow) {
                    nu3Var.setText(u.B0("TelegramTones", org.telegram.mdgram.R.string.TelegramTones));
                    return;
                } else if (i == dp6Var.systemTonesHeaderRow) {
                    nu3Var.setText(u.B0("SystemTones", org.telegram.mdgram.R.string.SystemTones));
                    return;
                } else {
                    return;
                }
    ...
    */
    ...
    public static String y2(tm9 tm9Var, String str) {
        ...
        if (TextUtils.isEmpty(str) && tm9Var != null) {
            return u.d0("SoundNameEmpty", org.telegram.mdgram.R.string.SoundNameEmpty, u.J(tm9Var.b, true));
        }
        return str;
    }
    ...
    public View W(final Context context) {
        ...
        if (this.dialogId == 0) {
            ...
            if (i == 1) {
                this.actionBar.setTitle(u.B0("NotificationsSoundPrivate", org.telegram.mdgram.R.string.NotificationsSoundPrivate));
            } else if (i == 0) {
                this.actionBar.setTitle(u.B0("NotificationsSoundGroup", org.telegram.mdgram.R.string.NotificationsSoundGroup));
            } else if (i == 2) {
                this.actionBar.setTitle(u.B0("NotificationsSoundChannels", org.telegram.mdgram.R.string.NotificationsSoundChannels));
            }
        } else {
            ...
            this.avatarContainer.setSubtitle(u.B0("NotificationsSound", org.telegram.mdgram.R.string.NotificationsSound));
        }
        ...
        t.j(2, org.telegram.mdgram.R.drawable.msg_forward, org.telegram.messenger.a.e0(54.0f), u.B0("ShareFile", org.telegram.mdgram.R.string.ShareFile));
        t.j(1, org.telegram.mdgram.R.drawable.msg_delete, org.telegram.messenger.a.e0(54.0f), u.B0("Delete", org.telegram.mdgram.R.string.Delete));
    ...
    public final void x2() {
        ...
        this.stableIds = i3 + 1;
        cVar3.stableId = i3;
        cVar3.title = u.B0("NoSound", org.telegram.mdgram.R.string.NoSound);
        ...
        this.stableIds = i4 + 1;
        cVar4.stableId = i4;
        cVar4.title = u.B0("DefaultRingtone", org.telegram.mdgram.R.string.DefaultRingtone);
