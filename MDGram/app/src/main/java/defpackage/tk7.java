...
public class tk7 extends FrameLayout {
    ...
    public tk7(Context context, boolean z, View.OnClickListener onClickListener, View.OnClickListener onClickListener2) {
        ...
        this.deleteImageView.setImageResource(org.telegram.mdgram.R.drawable.poll_remove);
        ...
        this.deleteImageView.setContentDescription(u.B0("Delete", org.telegram.mdgram.R.string.Delete));
        ...
        this.checkBox.setContentDescription(u.B0("AccDescrQuizCorrectAnswer", org.telegram.mdgram.R.string.AccDescrQuizCorrectAnswer));
