...
public final class iqc implements Runnable {
    ...
    /* renamed from: a  reason: collision with other field name */
    public final /* synthetic */ mqc f7706a;

    /* renamed from: a  reason: collision with other field name */
    public final zec f7707a;

    public iqc(mqc mqcVar, String str, URL url, byte[] bArr, Map map, zec zecVar, byte[] bArr2) {
        this.f7706a = mqcVar;
        lm7.g(str);
        lm7.k(url);
        lm7.k(zecVar);
    ...
    public final /* synthetic */ void a(int i, Exception exc, byte[] bArr, Map map) {
        zec zecVar = this.f7707a;
        zecVar.a.h(this.a, i, exc, bArr, map);
    }

    public final void b(final int i, final Exception exc, final byte[] bArr, final Map map) {
        ((djc) this.f7706a).a.b().z(new Runnable() { // from class: ipc
            @Override // java.lang.Runnable
            public final void run() {
                iqc.this.a(i, exc, bArr, map);
            }
        });
    }
    ...
    /* JADX WARN: Type inference failed for: r9v0, types: [iqc] */
    @Override // java.lang.Runnable
    /*
    ...
    */
    public final void run() {
        /*
            ...
            r0 = 0
            r1 = 0
            mqc r2 = r9.f7706a     // Catch: java.lang.Throwable -> L84 java.io.IOException -> L92
            java.net.URL r3 = r9.f7705a     // Catch: java.lang.Throwable -> L84 java.io.IOException -> L92
            ...
            jfc r4 = r2.a     // Catch: java.lang.Throwable -> L84 java.io.IOException -> L92
            r4.x()     // Catch: java.lang.Throwable -> L84 java.io.IOException -> L92
            r4 = 60000(0xea60, float:8.4078E-41)
            r3.setConnectTimeout(r4)     // Catch: java.lang.Throwable -> L84 java.io.IOException -> L92
            jfc r2 = r2.a     // Catch: java.lang.Throwable -> L84 java.io.IOException -> L92
            r2.x()     // Catch: java.lang.Throwable -> L84 java.io.IOException -> L92
        ...
        L9c:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.iqc.run():void");
    }
}
