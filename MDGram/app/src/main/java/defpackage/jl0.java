...
public class jl0 extends fw implements h.d, a0.d {
    ...
    public final void C() {
            ...
            if (charSequence == null) {
                ...
                if (lo9Var != null && (qo9Var = lo9Var.f9694a) != null && qo9Var.e != 0) {
                    if (qo9Var.f17403a instanceof TLRPC$TL_photoEmpty) {
                        charSequence = u.B0("AttachPhotoExpired", org.telegram.mdgram.R.string.AttachPhotoExpired);
                    } else if (qo9Var.f17408a instanceof TLRPC$TL_documentEmpty) {
                        charSequence = u.B0("AttachVideoExpired", org.telegram.mdgram.R.string.AttachVideoExpired);
                    } else {
        ...
        if (xVar != null) {
            ...
            if (i == 11) {
                ...
                D(u.z0(org.telegram.mdgram.R.string.ActionGiftPremiumTitle), u.c0(org.telegram.mdgram.R.string.ActionGiftPremiumSubtitle, u.U("Months", xVar.f13365a.f9690a.e, new Object[0])), u.z0(org.telegram.mdgram.R.string.ActionGiftPremiumView), this.giftRectSize);
            } else if (i == 21) {
                ...
                if (R8.f10557a == tla.p(this.currentAccount).f19522a) {
                    ...
                    if (z) {
                        d0 = u.d0("ActionSuggestVideoFromYouDescription", org.telegram.mdgram.R.string.ActionSuggestVideoFromYouDescription, R82.f10558a);
                    } else {
                        d0 = u.d0("ActionSuggestPhotoFromYouDescription", org.telegram.mdgram.R.string.ActionSuggestPhotoFromYouDescription, R82.f10558a);
                    }
                } else if (z) {
                    d0 = u.d0("ActionSuggestVideoToYouDescription", org.telegram.mdgram.R.string.ActionSuggestVideoToYouDescription, R8.f10558a);
                } else {
                    d0 = u.d0("ActionSuggestPhotoToYouDescription", org.telegram.mdgram.R.string.ActionSuggestPhotoToYouDescription, R8.f10558a);
                }
                if (!((mo9) tLRPC$TL_messageActionSuggestProfilePhoto).f10515c && ((arrayList = ((mo9) tLRPC$TL_messageActionSuggestProfilePhoto).f10505a.f9004b) == null || arrayList.isEmpty())) {
                    B0 = u.B0("ViewPhotoAction", org.telegram.mdgram.R.string.ViewPhotoAction);
                } else {
                    B0 = u.B0("ViewVideoAction", org.telegram.mdgram.R.string.ViewVideoAction);
                }
    ...
    public void Q(int i, boolean z, boolean z2) {
        ...
        if (i2 != i && i2 / CacheConstants.HOUR != i / CacheConstants.HOUR) {
            if (z) {
                if (i == 2147483646) {
                    I = u.B0("MessageScheduledUntilOnline", org.telegram.mdgram.R.string.MessageScheduledUntilOnline);
                } else {
                    I = u.d0("MessageScheduledOn", org.telegram.mdgram.R.string.MessageScheduledOn, u.I(i));
                }
            } else {
                I = u.I(i);
            }
