...
public abstract class q9d {
    ...
    */
    public static int b(java.lang.CharSequence r7, byte[] r8, int r9, int r10) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.q9d.b(java.lang.CharSequence, byte[], int, int):int");
    }
        ...
        if ((i | i2 | ((length - i) - i2)) >= 0) {
            ...
            while (i < i3) {
                ...
                if (v8d.d(b2)) {
                    ...
                    if (i5 < i3 - 1) {
                        int i7 = i5 + 1;
                        v8d.b(b2, bArr[i5], bArr[i7], cArr, i4);
                        i = i7 + 1;
                        i4++;
                    } else {
                        throw k1d.c();
                    ...
                    int i8 = i5 + 1;
                    int i9 = i8 + 1;
                    v8d.a(b2, bArr[i5], bArr[i8], bArr[i9], cArr, i4);
                    i4 += 2;
                    i = i9 + 1;
                } else {
                    throw k1d.c();
