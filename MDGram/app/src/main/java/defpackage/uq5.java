...
public class uq5 extends f implements a0.d {
                    ...
                    if (i == uq5.this.b) {
                        ...
                        if (i == uq5.this.g) {
                            ...
                            if (uq5.this.f20411a.f13365a.b == 2147483646) {
                                ...
                                d0 = u.d0("formatDateAtTime", org.telegram.mdgram.R.string.formatDateAtTime, u.p0().f13211f.b(new Date(j)), u.p0().f13201b.b(new Date(j)));
                            }
                            xu9Var.a(str2, d0, z);
                            return;
                        } else if (i == uq5.this.j) {
                            long j2 = uq5.this.f20411a.f13365a.f * 1000;
                            xu9Var.a("Edited", u.d0("formatDateAtTime", org.telegram.mdgram.R.string.formatDateAtTime, u.p0().f13211f.b(new Date(j2)), u.p0().f13201b.b(new Date(j2))), z);
                            return;
    ...
    public /* synthetic */ void I2(View view, int i, float f, float f2) {
        if (i != this.p) {
            try {
                ...
                q.p0(this).n(u.d0("TextCopied", org.telegram.mdgram.R.string.TextCopied, new Object[0])).T();
            } catch (Exception e) {
    ...
    public /* synthetic */ void J2() {
        ...
        i2(Intent.createChooser(intent, u.B0("ShareFile", org.telegram.mdgram.R.string.ShareFile)), Constants.DEFAULT_WRITE_DELAY);
    }
    ...
    public View W(Context context) {
        ...
        this.actionBar.setTitle(u.B0("MessageDetails", org.telegram.mdgram.R.string.MessageDetails));
