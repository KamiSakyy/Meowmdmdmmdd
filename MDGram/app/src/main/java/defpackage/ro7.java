    ...
    public void a(ho7.j jVar, boolean z) {
        ...
        if (i != 1) {
            if (i != 6) {
                if (i != 12) {
                    ...
                    this.titleView.setText(u.z0(org.telegram.mdgram.R.string.PremiumTierAnnual));
                }
            } else {
                this.titleView.setText(u.z0(org.telegram.mdgram.R.string.PremiumTierSemiannual));
            }
        } else {
            this.titleView.setText(u.z0(org.telegram.mdgram.R.string.PremiumTierMonthly));
        }
        ...
        if (!z2) {
            if (jVar.d() <= 0) {
                ...
                this.discountView.setText(u.c0(org.telegram.mdgram.R.string.GiftPremiumOptionDiscount, Integer.valueOf(jVar.d())));
            ...
            this.pricePerYearView.setText(u.c0(org.telegram.mdgram.R.string.PricePerYear, jVar.f()));
            this.pricePerMonthView.setText(u.c0(org.telegram.mdgram.R.string.PricePerMonthMe, jVar.e()));
        } else {
            this.discountView.setText(u.c0(org.telegram.mdgram.R.string.GiftPremiumOptionDiscount, 10));
            this.discountView.setVisibility(0);
            this.pricePerYearStrikeView.setVisibility(0);
            this.pricePerYearView.setVisibility(0);
            this.pricePerYearStrikeView.setText("USD00.00");
            this.pricePerYearView.setText(u.c0(org.telegram.mdgram.R.string.PricePerYear, 1000));
            this.pricePerMonthView.setText(u.c0(org.telegram.mdgram.R.string.PricePerMonthMe, 100));
        }
        requestLayout();
    }
