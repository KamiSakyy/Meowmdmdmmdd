...
public class s94 extends LinearLayout {
    ...
    public s94(Context context, fm9 fm9Var) {
        ...
        nu3Var.setText(u.B0("ChannelSettingsJoinTitle", org.telegram.mdgram.R.string.ChannelSettingsJoinTitle));
        ...
        String B0 = u.B0("ChannelSettingsJoinToSend", org.telegram.mdgram.R.string.ChannelSettingsJoinToSend);
        ...
        this.joinRequestCell.i(u.B0("ChannelSettingsJoinRequest", org.telegram.mdgram.R.string.ChannelSettingsJoinRequest), this.isJoinRequest, false);
        ...
        bv9Var.setText(u.B0("ChannelSettingsJoinToSendInfo", org.telegram.mdgram.R.string.ChannelSettingsJoinToSendInfo));
        addView(this.joinToSendInfoCell);
        bv9 bv9Var2 = new bv9(context);
        this.joinRequestInfoCell = bv9Var2;
        bv9Var2.setText(u.B0("ChannelSettingsJoinRequestInfo", org.telegram.mdgram.R.string.ChannelSettingsJoinRequestInfo));
