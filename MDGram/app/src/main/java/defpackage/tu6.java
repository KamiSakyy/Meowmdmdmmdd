    ...
    public tu6(Context context, boolean z) {
        ...
        for (int i2 = 0; i2 < h60.a.size() + 2; i2++) {
            ...
            if (i2 == 0) {
                ...
                this.f19770a[i].setImageResource(org.telegram.mdgram.R.drawable.msg_add);
    ...
    public final void k(int i) {
        if (i >= 0) {
            ...
            if (i < e88VarArr.length) {
                ...
                if (this.f19769a) {
                    this.f19769a = false;
                    org.telegram.messenger.a.V3(this.f19770a[this.f19765a + 1], org.telegram.mdgram.R.drawable.msg_add);
                }
                this.c = i;
                this.a = 0.0f;
