...
public abstract class aj3 extends g {
    ...
    public aj3(final Context context, final f fVar) {
        ...
        e88Var.g(org.telegram.mdgram.R.raw.utyan_gigagroup, Constants.MEMORY_PAGE_DATA_OVERFLOW, Constants.MEMORY_PAGE_DATA_OVERFLOW);
        e88Var.e();
        ...
        textView.setText(u.B0("GigagroupConvertTitle", org.telegram.mdgram.R.string.GigagroupConvertTitle));
        ...
        while (true) {
            if (i2 < 3) {
                ...
                if (i2 != 0) {
                    if (i2 != 1) {
                        if (i2 == 2) {
                            textView2.setText(u.B0("GigagroupConvertInfo3", org.telegram.mdgram.R.string.GigagroupConvertInfo3));
                        }
                    } else {
                        textView2.setText(u.B0("GigagroupConvertInfo2", org.telegram.mdgram.R.string.GigagroupConvertInfo2));
                    }
                } else {
                    textView2.setText(u.B0("GigagroupConvertInfo1", org.telegram.mdgram.R.string.GigagroupConvertInfo1));
                }
                if (u.d) {
                ...
                aVar.setText(u.B0("GigagroupConvertProcessButton", org.telegram.mdgram.R.string.GigagroupConvertProcessButton));
                ...
                textView3.setText(u.B0("GigagroupConvertCancelButton", org.telegram.mdgram.R.string.GigagroupConvertCancelButton));
    ...
    public /* synthetic */ void w1(Context context, f fVar, View view) {
        ...
        kVar.x(u.B0("GigagroupConvertAlertTitle", org.telegram.mdgram.R.string.GigagroupConvertAlertTitle));
        kVar.n(org.telegram.messenger.a.b3(u.B0("GigagroupConvertAlertText", org.telegram.mdgram.R.string.GigagroupConvertAlertText)));
        kVar.v(u.B0("GigagroupConvertAlertConver", org.telegram.mdgram.R.string.GigagroupConvertAlertConver), new DialogInterface.OnClickListener() { // from class: zi3
