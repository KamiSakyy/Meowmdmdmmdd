...
public class vh7 extends FrameLayout {
    ...
    public vh7(Context context, boolean z) {
        ...
        this.doneButton.setText(u.B0("Send", org.telegram.mdgram.R.string.Send).toUpperCase());
        ...
        this.doneButtonBadgeTextView.setBackgroundResource(this.isDarkTheme ? org.telegram.mdgram.R.drawable.photobadge : org.telegram.mdgram.R.drawable.bluecounter);
