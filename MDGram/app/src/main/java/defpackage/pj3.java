    ...
    public final void w(Context context, int i, String str, PendingIntent pendingIntent) {
        ...
        if (i == 18) {
            ...
            if (ub2.c(context)) {
                ...
                if (ub2.d(context)) {
                    J.a(org.telegram.mdgram.R.drawable.common_full_open_on_phone, resources.getString(org.telegram.mdgram.R.string.common_open_on_phone), pendingIntent);
                } else {
                    J.o(pendingIntent);
                }
            } else {
                J.F(17301642).L(resources.getString(org.telegram.mdgram.R.string.common_google_play_services_notification_ticker)).O(System.currentTimeMillis()).o(pendingIntent).p(e);
            }
            if (ij7.h()) {
                lm7.n(ij7.h());
                synchronized (a) {
