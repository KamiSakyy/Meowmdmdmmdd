...
public class d95 {
    ...
    public final void K() {
        ...
        if (f2 != null) {
            ...
            if (n != null) {
                ...
                if (this.f3963a) {
                    i = g95.d(this.f3961a, org.telegram.mdgram.R.attr.colorSurface);
                } else {
                    i = 0;
                }
                n.V(f3, i);
    ...
    public void r(TypedArray typedArray) {
        ...
        this.f3970f = typedArray.getDimensionPixelSize(20, 0);
        this.f3958a = jta.f(typedArray.getInt(7, -1), PorterDuff.Mode.SRC_IN);
        this.f3957a = j95.b(this.f3961a.getContext(), typedArray, 6);
        this.f3964b = j95.b(this.f3961a.getContext(), typedArray, 19);
        this.f3966c = j95.b(this.f3961a.getContext(), typedArray, 16);
        this.f3968d = typedArray.getBoolean(5, false);
        this.f3971g = typedArray.getDimensionPixelSize(9, 0);
        this.f3969e = typedArray.getBoolean(21, true);
        int J = gqa.J(this.f3961a);
        int paddingTop = this.f3961a.getPaddingTop();
        int I = gqa.I(this.f3961a);
        int paddingBottom = this.f3961a.getPaddingBottom();
