...
public class p14 extends g implements a0.d {
    ...
    public static class a extends FrameLayout {
        ...
        public a(Context context, l.r rVar) {
            ...
            this.imageView.g(org.telegram.mdgram.R.raw.import_check, 26, 26);
    ...
    public p14(Context context, String str, j jVar, l.r rVar) {
        ...
        int i = org.telegram.mdgram.R.raw.import_finish;
        RLottieDrawable rLottieDrawable = new RLottieDrawable(i, "" + org.telegram.mdgram.R.raw.import_finish, org.telegram.messenger.a.e0(120.0f), org.telegram.messenger.a.e0(120.0f), false, null);
        this.completedDrawable = rLottieDrawable;
        rLottieDrawable.s0(true);
        e88 e88Var = new e88(context);
        this.imageView = e88Var;
        e88Var.setAutoRepeat(true);
        this.imageView.g(org.telegram.mdgram.R.raw.import_loop, Constants.MEMORY_PAGE_DATA_OVERFLOW, Constants.MEMORY_PAGE_DATA_OVERFLOW);
        this.imageView.e();
        ...
        this.cell.setText(u.B0("ImportDone", org.telegram.mdgram.R.string.ImportDone));
        ...
        for (int i2 = 0; i2 < 2; i2++) {
            ...
            if (i2 == 0) {
                this.infoTextView[i2].setText(u.B0("ImportImportingInfo", org.telegram.mdgram.R.string.ImportImportingInfo));
            } else {
        ...
        if (this.parentFragment != null) {
            textView.setText(u.B0("ImportImportingTitle", org.telegram.mdgram.R.string.ImportImportingTitle));
            ...
            this.importCountTextView[0].setText(u.d0("ImportCount", org.telegram.mdgram.R.string.ImportCount, org.telegram.messenger.a.t0(q1.i()), org.telegram.messenger.a.t0(q1.h())));
            this.infoTextView[1].setText(u.B0("ImportDoneInfo", org.telegram.mdgram.R.string.ImportDoneInfo));
            this.importCountTextView[1].setText(u.B0("ImportDoneTitle", org.telegram.mdgram.R.string.ImportDoneTitle));
            this.parentFragment.B0().d(this, a0.d1);
            return;
        }
        textView.setText(u.B0("ImportStickersImportingTitle", org.telegram.mdgram.R.string.ImportStickersImportingTitle));
        ...
        this.importCountTextView[0].setText(u.d0("ImportCount", org.telegram.mdgram.R.string.ImportCount, org.telegram.messenger.a.t0(r1.i()), org.telegram.messenger.a.t0(r1.h())));
        this.infoTextView[1].setText(u.B0("ImportStickersDoneInfo", org.telegram.mdgram.R.string.ImportStickersDoneInfo));
        this.importCountTextView[1].setText(u.B0("ImportStickersDoneTitle", org.telegram.mdgram.R.string.ImportStickersDoneTitle));
