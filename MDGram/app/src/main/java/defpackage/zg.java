...
public class zg extends MultiAutoCompleteTextView implements r3a {
    public static final int[] a = {16843126};

    /* renamed from: a  reason: collision with other field name */
    public final dg f23681a;

    /* renamed from: a  reason: collision with other field name */
    public final ei f23682a;

    /* renamed from: a  reason: collision with other field name */
    public final tg f23683a;
    ...
    public void drawableStateChanged() {
        ...
        dg dgVar = this.f23681a;
        if (dgVar != null) {
            dgVar.b();
        }
        ei eiVar = this.f23682a;
        if (eiVar != null) {
            eiVar.b();
        }
    }
    ...
    public ColorStateList getSupportCompoundDrawablesTintList() {
        return this.f23682a.j();
    }

    public PorterDuff.Mode getSupportCompoundDrawablesTintMode() {
        return this.f23682a.k();
    }

    @Override // android.widget.TextView, android.view.View
    public InputConnection onCreateInputConnection(EditorInfo editorInfo) {
        return this.f23683a.e(vg.a(super.onCreateInputConnection(editorInfo), editorInfo, this), editorInfo);
    }
    ...
    public void setKeyListener(KeyListener keyListener) {
        super.setKeyListener(this.f23683a.a(keyListener));
    }
