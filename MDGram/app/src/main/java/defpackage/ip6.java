...
public class ip6 {
    ...
    public void q(String str, final String str2, String str3, final String str4, int i) {
        try {
            View inflate = ((LayoutInflater) this.f7666a.getSystemService("layout_inflater")).inflate(org.telegram.mdgram.R.layout.md_content_ads, (ViewGroup) null);
            final com.google.android.material.bottomsheet.a aVar = new com.google.android.material.bottomsheet.a(this.f7666a, org.telegram.mdgram.R.style.BottomDialog);
            Drawable e = sz1.e(this.f7666a, org.telegram.mdgram.R.drawable.rounded_background);
            ...
            TextView textView = (TextView) inflate.findViewById(org.telegram.mdgram.R.id.mVersion);
            TextView textView2 = (TextView) inflate.findViewById(org.telegram.mdgram.R.id.mChangelog);
            ((ImageView) inflate.findViewById(org.telegram.mdgram.R.id.btn_download)).setColorFilter(l.B1("windowBackgroundWhiteBlueHeader"), PorterDuff.Mode.SRC_ATOP);
            ...
            Drawable e2 = sz1.e(this.f7666a, org.telegram.mdgram.R.drawable.rounded_card_button);
            n7b.e(e2, l.B1("windowBackgroundWhiteBlueHeader"));
            linearLayout.setBackground(e2);
            LinearLayout linearLayout2 = (LinearLayout) inflate.findViewById(org.telegram.mdgram.R.id.mUpdateButton);
            n7b.e(e2, l.B1("windowBackgroundWhiteBlueHeader"));
            ...
            WebView webView = (WebView) inflate.findViewById(org.telegram.mdgram.R.id.web);
            this.f7667a = webView;
