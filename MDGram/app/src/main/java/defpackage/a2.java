...
public class a2 {
    ...
    public static List c(View view) {
        List list = (List) view.getTag(org.telegram.mdgram.R.id.tag_accessibility_actions);
        if (list == null) {
    ...
    public boolean j(View view, int i, Bundle bundle) {
        ...
        if (!z && i == org.telegram.mdgram.R.id.accessibility_action_clickable_span && bundle != null) {
    ...
    public final boolean k(int i, View view) {
        ...
        SparseArray sparseArray = (SparseArray) view.getTag(org.telegram.mdgram.R.id.tag_accessibility_clickable_spans);
