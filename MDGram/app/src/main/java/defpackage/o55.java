...
public class o55 extends f {
            ...
            if (itemViewType != 1) {
                if (itemViewType != 2) {
                    if (itemViewType != 3) {
                        ...
                        if (i == o55.this.h) {
                            nu3Var.setText(u.B0("MD_Toolbar", org.telegram.mdgram.R.string.MD_Toolbar));
                            return;
                        } else if (i == o55.this.f) {
                            nu3Var.setText(u.B0("Folder", org.telegram.mdgram.R.string.Folder));
                            return;
                        } else if (i == o55.this.i) {
                            nu3Var.setText(u.B0("Bottom_Bar_Header", org.telegram.mdgram.R.string.Bottom_Bar_Header));
                            return;
                        } else if (i == o55.this.m) {
                            nu3Var.setText(u.B0("Floating_Header", org.telegram.mdgram.R.string.Floating_Header));
                            return;
                        } else {
                            return;
                        }
                    ...
                    ru9Var.h(true, null);
                    if (i == o55.this.g) {
                        ru9Var.i(u.B0("ShowTabsOnForward", org.telegram.mdgram.R.string.ShowTabsOnForward), MDConfig.showTabsOnForward, true);
                        return;
                    } else if (i == o55.this.c) {
                        ru9Var.j(u.B0("HomeTilte", org.telegram.mdgram.R.string.HomeTilte), u.B0("HomeTilteToName", org.telegram.mdgram.R.string.HomeTilteToName), MDConfig.allowName, true, false);
                        return;
                    } else if (i == o55.this.b) {
                        ru9Var.j(u.B0("Home_Hello_show", org.telegram.mdgram.R.string.Home_Hello_show), null, MDConfig.allowNameHello, true, false);
                        return;
                    } else if (i == o55.this.e) {
                        ru9Var.j(u.B0("HideSearchBar", org.telegram.mdgram.R.string.HideSearchBar), u.B0("HideSearchBar_Sum", org.telegram.mdgram.R.string.HideSearchBar_Sum), MDConfig.allowSearchBar, true, false);
                        return;
                    } else if (i == o55.this.k) {
                        ru9Var.j(u.B0("Bottom_show", org.telegram.mdgram.R.string.Bottom_show), null, MDConfig.mdBottomBar, true, false);
                        return;
                    } else if (i == o55.this.l) {
                        ru9Var.j(u.B0("Bottom_Bar_ios", org.telegram.mdgram.R.string.Bottom_Bar_ios), u.B0("Bottom_Bar_ios_sum", org.telegram.mdgram.R.string.Bottom_Bar_ios_sum), MDConfig.ismdBottomBarIos, true, false);
                        return;
                    } else if (i == o55.this.n) {
                        ru9Var.j(u.B0("Floating_Hide", org.telegram.mdgram.R.string.Floating_Hide), u.B0("Floating_Hide_sum", org.telegram.mdgram.R.string.Floating_Hide_sum), MDConfig.isFloatingB, true, false);
                        return;
                    } else if (i == o55.this.o) {
                        String B0 = u.B0("FolderTab_Style", org.telegram.mdgram.R.string.FolderTab_Style);
                        if (MDConfig.foldersStyle) {
                            i2 = org.telegram.mdgram.R.string.FolderTab_Style_sum_line;
                            str = "FolderTab_Style_sum_line";
                        } else {
                            i2 = org.telegram.mdgram.R.string.FolderTab_Style_sum_bubble;
    ...
    public View W(Context context) {
        ...
        this.actionBar.setTitle(u.B0("Home", org.telegram.mdgram.R.string.Home));
