...
public class g83 extends v1 {
    ...
    /* renamed from: a  reason: collision with other field name */
    public static final h[] f5958a = {new h(org.telegram.mdgram.R.drawable.search_media_filled, u.B0("SharedMediaTab2", org.telegram.mdgram.R.string.SharedMediaTab2), new TLRPC$TL_inputMessagesFilterPhotoVideo(), 0), new h(org.telegram.mdgram.R.drawable.search_links_filled, u.B0("SharedLinksTab2", org.telegram.mdgram.R.string.SharedLinksTab2), new TLRPC$TL_inputMessagesFilterUrl(), 2), new h(org.telegram.mdgram.R.drawable.search_files_filled, u.B0("SharedFilesTab2", org.telegram.mdgram.R.string.SharedFilesTab2), new TLRPC$TL_inputMessagesFilterDocument(), 1), new h(org.telegram.mdgram.R.drawable.search_music_filled, u.B0("SharedMusicTab2", org.telegram.mdgram.R.string.SharedMusicTab2), new TLRPC$TL_inputMessagesFilterMusic(), 3), new h(org.telegram.mdgram.R.drawable.search_voice_filled, u.B0("SharedVoiceTab2", org.telegram.mdgram.R.string.SharedVoiceTab2), new TLRPC$TL_inputMessagesFilterRoundVoice(), 5)};
    ...
    public static class g extends FrameLayout {
        ...
        public void setData(h hVar) {
            ...
            if (hVar.b == 7) {
                nq1 I0 = l.I0(org.telegram.messenger.a.e0(32.0f), org.telegram.mdgram.R.drawable.chats_archive);
                this.f5972a = I0;
            ...
            if (hVar.b == 4) {
                ...
                if (aVar instanceof mq9) {
                    ...
                    if (tla.p(tla.o).l().f10557a == mq9Var.f10557a) {
                        nq1 I03 = l.I0(org.telegram.messenger.a.e0(32.0f), org.telegram.mdgram.R.drawable.chats_saved);
    ...
    public static void p3(String str, ArrayList arrayList) {
        ...
        if (!u.B0("SearchTipToday", org.telegram.mdgram.R.string.SearchTipToday).toLowerCase().startsWith(trim) && !"today".startsWith(trim)) {
            if (!u.B0("SearchTipYesterday", org.telegram.mdgram.R.string.SearchTipYesterday).toLowerCase().startsWith(trim) && !"yesterday".startsWith(trim)) {
                int q3 = q3(trim);
                if (q3 >= 0) {
                    Calendar calendar = Calendar.getInstance();
            ...
            arrayList.add(new f(u.B0("SearchTipYesterday", org.telegram.mdgram.R.string.SearchTipYesterday), calendar6.getTimeInMillis() - 86400000, calendar6.getTimeInMillis() - 86400001));
            return;
        }
        ...
        arrayList.add(new f(u.B0("SearchTipToday", org.telegram.mdgram.R.string.SearchTipToday), timeInMillis8, calendar7.getTimeInMillis() - 1));
    }
    ...
    public static int s3(String str) {
        String[] strArr = {u.B0("January", org.telegram.mdgram.R.string.January).toLowerCase(), u.B0("February", org.telegram.mdgram.R.string.February).toLowerCase(), u.B0("March", org.telegram.mdgram.R.string.March).toLowerCase(), u.B0("April", org.telegram.mdgram.R.string.April).toLowerCase(), u.B0("May", org.telegram.mdgram.R.string.May).toLowerCase(), u.B0("June", org.telegram.mdgram.R.string.June).toLowerCase(), u.B0("July", org.telegram.mdgram.R.string.July).toLowerCase(), u.B0("August", org.telegram.mdgram.R.string.August).toLowerCase(), u.B0("September", org.telegram.mdgram.R.string.September).toLowerCase(), u.B0("October", org.telegram.mdgram.R.string.October).toLowerCase(), u.B0("November", org.telegram.mdgram.R.string.November).toLowerCase(), u.B0("December", org.telegram.mdgram.R.string.December).toLowerCase()};
    ...
    public void t3(ArrayList arrayList, ArrayList arrayList2, boolean z) {
        ...
        if (arrayList != null) {
            for (int i2 = 0; i2 < arrayList.size(); i2++) {
                ...
                if (obj instanceof mq9) {
                    mq9 mq9Var = (mq9) obj;
                    if (tla.p(tla.o).l().f10557a == mq9Var.f10557a) {
                        F0 = u.B0("SavedMessages", org.telegram.mdgram.R.string.SavedMessages);
                    } else {
                        F0 = org.telegram.messenger.e.F0(mq9Var.f10558a, mq9Var.f10565b, 10);
                    }
                    h hVar = new h(org.telegram.mdgram.R.drawable.search_users_filled, F0, null, 4);
                    hVar.d(mq9Var);
                    ...
                    h hVar2 = new h(org.telegram.mdgram.R.drawable.search_users_filled, str, null, 4);
                    hVar2.d(fm9Var);
        ...
        if (arrayList2 != null) {
            for (int i3 = 0; i3 < arrayList2.size(); i3++) {
                ...
                h hVar3 = new h(org.telegram.mdgram.R.drawable.search_date_filled, fVar.f5970a, null, 6);
                hVar3.c(fVar);
                this.f5961a.add(hVar3);
            }
        }
        if (z) {
            this.f5961a.add(new h(org.telegram.mdgram.R.drawable.chats_archive, u.B0("ArchiveSearchFilter", org.telegram.mdgram.R.string.ArchiveSearchFilter), null, 7));
        }
        if (getAdapter() != null) {
