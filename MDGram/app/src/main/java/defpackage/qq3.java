...
public abstract class qq3 extends FrameLayout {
    ...
    public qq3(Context context, RecyclerView recyclerView, RecyclerView recyclerView2, ArrayList arrayList, d.a aVar, final z zVar) {
        ...
        g22 g22Var = new g22(context, org.telegram.mdgram.R.drawable.msg_pin_filled, null);
        ...
        this.pinTextView.setText(u.B0("CallVideoPin", org.telegram.mdgram.R.string.CallVideoPin));
        ...
        this.unpinTextView.setText(u.B0("CallVideoUnpin", org.telegram.mdgram.R.string.CallVideoUnpin));
        ...
        this.pipView.setImageResource(org.telegram.mdgram.R.drawable.ic_goinline);
        this.pipView.setContentDescription(u.z0(org.telegram.mdgram.R.string.AccDescrPipMode));
    ...
    */
    ...
    public void setIsTablet(boolean z) {
        ...
        if (this.isTablet != z) {
            ...
            if (this.isTablet) {
                this.backButton.setImageDrawable(sz1.e(getContext(), org.telegram.mdgram.R.drawable.msg_calls_minimize));
                return;
            }
            fv fvVar = new fv(false);
            fvVar.c(-1);
