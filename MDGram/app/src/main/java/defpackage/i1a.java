...
public class i1a extends LinearLayout {
    ...
    public i1a(Context context, k kVar, int i) {
        ...
        this.shadowDrawable = l.u2(context, org.telegram.mdgram.R.drawable.greydivider_bottom, "windowBackgroundGrayShadow");
        int currentTimeMillis = ((int) (System.currentTimeMillis() / 1000)) - 3600;
        if (i == 2) {
            TLRPC$TL_message tLRPC$TL_message = new TLRPC$TL_message();
            ((lo9) tLRPC$TL_message).f9686a = u.B0("DoubleTapPreviewMessage", org.telegram.mdgram.R.string.DoubleTapPreviewMessage);
            ...
            xVar4.w4();
            xVar4.f13407e = 1L;
            xVar4.f13403d = u.B0("DoubleTapPreviewSenderName", org.telegram.mdgram.R.string.DoubleTapPreviewSenderName);
            xVar4.f13354a = sz1.e(context, org.telegram.mdgram.R.drawable.dino_pic);
            xVar = xVar4;
            i2 = i3;
            xVar2 = null;
        } else {
            ...
            if (i == 0) {
                ((lo9) tLRPC$TL_message2).f9686a = u.B0("FontSizePreviewReply", org.telegram.mdgram.R.string.FontSizePreviewReply);
            } else {
                ((lo9) tLRPC$TL_message2).f9686a = u.B0("NewThemePreviewReply", org.telegram.mdgram.R.string.NewThemePreviewReply);
            }
            ...
            if (i == 0) {
                ((lo9) tLRPC$TL_message3).f9686a = u.B0("FontSizePreviewLine2", org.telegram.mdgram.R.string.FontSizePreviewLine2);
            } else {
                String B0 = u.B0("NewThemePreviewLine3", org.telegram.mdgram.R.string.NewThemePreviewLine3);
            ...
            if (i == 0) {
                ((lo9) tLRPC$TL_message4).f9686a = u.B0("FontSizePreviewLine1", org.telegram.mdgram.R.string.FontSizePreviewLine1);
            } else {
                ((lo9) tLRPC$TL_message4).f9686a = u.B0("NewThemePreviewLine1", org.telegram.mdgram.R.string.NewThemePreviewLine1);
            }
            ...
            if (i == 0) {
                xVar7.f13420g = u.B0("FontSizePreviewName", org.telegram.mdgram.R.string.FontSizePreviewName);
            } else {
                xVar7.f13420g = u.B0("NewThemePreviewName", org.telegram.mdgram.R.string.NewThemePreviewName);
            }
            xVar7.f13407e = 1L;
            xVar7.w4();
            xVar7.f13370a = xVar5;
