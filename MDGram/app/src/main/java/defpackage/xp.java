    ...
    */
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        if (this.currentMessageObject.P2()) {
            accessibilityNodeInfo.setText(u.d0("AccDescrMusicInfo", org.telegram.mdgram.R.string.AccDescrMusicInfo, this.currentMessageObject.S0(), this.currentMessageObject.U0()));
            return;
        }
