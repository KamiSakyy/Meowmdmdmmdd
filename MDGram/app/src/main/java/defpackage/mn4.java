...
public class mn4 extends FrameLayout {
    ...
    public mn4(Context context) {
        ...
        imageView.setImageResource(org.telegram.mdgram.R.drawable.ic_chevron_right_black_18dp);
    ...
    public void e() {
        ...
        this.a = getContext().getResources().getDrawable(org.telegram.mdgram.R.drawable.stats_tooltip).mutate();
