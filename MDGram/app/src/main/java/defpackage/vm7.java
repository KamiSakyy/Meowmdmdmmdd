...
public class vm7 extends org.telegram.ui.ActionBar.g implements a0.d {
        ...
        public void a(ho7.i iVar) {
            if (iVar.type == 0) {
                ...
                if (vm7.this.f20998b == 4) {
                    this.f21014a.setText(u.B0("AdditionalReactions", org.telegram.mdgram.R.string.AdditionalReactions));
                    this.b.setText(u.B0("AdditionalReactionsDescription", org.telegram.mdgram.R.string.AdditionalReactionsDescription));
                } else if (vm7.this.f20998b == 3) {
                    this.f21014a.setText(u.B0("PremiumPreviewNoAds", org.telegram.mdgram.R.string.PremiumPreviewNoAds));
                    this.b.setText(u.B0("PremiumPreviewNoAdsDescription2", org.telegram.mdgram.R.string.PremiumPreviewNoAdsDescription2));
                } else if (vm7.this.f20998b == 10) {
                    this.f21014a.setText(u.B0("PremiumPreviewAppIcon", org.telegram.mdgram.R.string.PremiumPreviewAppIcon));
                    this.b.setText(u.B0("PremiumPreviewAppIconDescription2", org.telegram.mdgram.R.string.PremiumPreviewAppIconDescription2));
                } else if (vm7.this.f20998b == 2) {
                    this.f21014a.setText(u.z0(org.telegram.mdgram.R.string.PremiumPreviewDownloadSpeed));
                    this.b.setText(u.z0(org.telegram.mdgram.R.string.PremiumPreviewDownloadSpeedDescription2));
                } else if (vm7.this.f20998b == 9) {
                    this.f21014a.setText(u.z0(org.telegram.mdgram.R.string.PremiumPreviewAdvancedChatManagement));
                    this.b.setText(u.z0(org.telegram.mdgram.R.string.PremiumPreviewAdvancedChatManagementDescription2));
                } else if (vm7.this.f20998b == 8) {
                    this.f21014a.setText(u.z0(org.telegram.mdgram.R.string.PremiumPreviewVoiceToText));
                    this.b.setText(u.z0(org.telegram.mdgram.R.string.PremiumPreviewVoiceToTextDescription2));
                }
                this.f21017a = false;
            } else {
    ...
    public final void Q1() {
        if (this.f21003d) {
            this.f20996a.f18166a.setText(u.z0(org.telegram.mdgram.R.string.AboutTelegramPremium));
        } else if (this.f21002c) {
            int i2 = this.f20998b;
            if (i2 == 4) {
                this.f20996a.f18166a.setText(u.z0(org.telegram.mdgram.R.string.UnlockPremiumReactions));
                this.f20996a.setIcon(org.telegram.mdgram.R.raw.unlock_icon);
            } else if (i2 != 3 && i2 != 2 && i2 != 9 && i2 != 8) {
                if (i2 == 10) {
                    this.f20996a.f18166a.setText(u.z0(org.telegram.mdgram.R.string.UnlockPremiumIcons));
                    this.f20996a.setIcon(org.telegram.mdgram.R.raw.unlock_icon);
                }
            } else {
                this.f20996a.f18166a.setText(u.z0(org.telegram.mdgram.R.string.AboutTelegramPremium));
        ...
        if (i2 != a0.q3 && i2 != a0.n3) {
            if (i2 == a0.m3) {
                if (tla.p(this.currentAccount).x()) {
                    this.f20996a.j(u.B0("OK", org.telegram.mdgram.R.string.OK), false, true);
                    return;
                } else {
                    this.f20996a.e();
                    return;
    ...
    public void onCreate(Bundle bundle) {
        ...
        this.f20994a.setBackButtonImage(org.telegram.mdgram.R.drawable.ic_ab_back);
        this.f20994a.setTitle(u.B0("DoubledLimits", org.telegram.mdgram.R.string.DoubledLimits));
    ...
    public vm7(final org.telegram.ui.ActionBar.f fVar, Context context, int i2, int i3, final boolean z, ho7.j jVar) {
        ...
        if (fVar != null) {
            ...
            this.f20998b = i3;
            this.f21002c = z;
            this.f20993a = f0.s(RLottieDrawable.j0(null, org.telegram.mdgram.R.raw.star_loader));
            ...
            if (tla.p(i2).x()) {
                this.f20996a.j(u.B0("OK", org.telegram.mdgram.R.string.OK), false, false);
            }
            ...
            i iVar2 = new i(getContext(), scrollView, sz1.e(getContext(), org.telegram.mdgram.R.drawable.header_shadow).mutate());
