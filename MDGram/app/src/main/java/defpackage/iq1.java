    ...
    public static ColorStateList e(Resources resources, XmlPullParser xmlPullParser, AttributeSet attributeSet, Resources.Theme theme) {
        ...
        while (true) {
            ...
            if (next == 2 && depth <= depth2 && xmlPullParser.getName().equals("item")) {
                ...
                float f2 = 1.0f;
                if (h.hasValue(1)) {
                    f2 = h.getFloat(1, 1.0f);
                } else if (h.hasValue(3)) {
                    f2 = h.getFloat(3, 1.0f);
                }
                if (Build.VERSION.SDK_INT >= 31 && h.hasValue(2)) {
                    f = h.getFloat(2, -1.0f);
                } else {
                    f = h.getFloat(4, -1.0f);
                }
                ...
                for (int i4 = 0; i4 < attributeCount; i4++) {
                    ...
                    if (attributeNameResource != 16843173 && attributeNameResource != 16843551 && attributeNameResource != org.telegram.mdgram.R.attr.alpha && attributeNameResource != org.telegram.mdgram.R.attr.lStar) {
                        int i5 = i3 + 1;
