...
public class u21 {
    ...
    public View j() {
        if (this.f19972a == null) {
            ...
            frameLayout.setBackgroundResource(org.telegram.mdgram.R.drawable.blockpanel);
            ...
            this.f19973a.setContentDescription(u.B0("Close", org.telegram.mdgram.R.string.Close));
            this.f19973a.setImageResource(org.telegram.mdgram.R.drawable.miniplayer_close);
