...
public class s55 extends f {
        ...
        public void onBindViewHolder(RecyclerView.d0 d0Var, int i) {
            ...
            if (itemViewType != 1) {
                if (itemViewType != 2) {
                    if (itemViewType != 3) {
                        if (itemViewType != 4) {
                            if (itemViewType == 5) {
                                ...
                                if (i == s55.this.d) {
                                    tl6Var.e(u.B0("CustomEmojiTypeface", org.telegram.mdgram.R.string.CustomEmojiTypeface), new File(MDConfig.customEmojiFontPath).getName(), MDConfig.customEmojiFont, false);
                                    return;
                                }
                                return;
                            }
                        ...
                        if (i == s55.this.c) {
                            nu3Var.setText(u.B0("Emoji", org.telegram.mdgram.R.string.Emoji));
                            return;
                        }
                        return;
                    }
                    ...
                    ru9Var.h(true, null);
                    if (i == s55.this.b) {
                        ru9Var.j(u.B0("EmojiUseDefault", org.telegram.mdgram.R.string.EmojiUseDefault), u.B0("AboutEmoji", org.telegram.mdgram.R.string.AboutEmoji), MDConfig.useSystemEmoji, true, false);
                        return;
                    } else if (i == s55.this.g) {
                        ru9Var.i(u.B0("UploadloadSpeedBoost", org.telegram.mdgram.R.string.UploadloadSpeedBoost), MDConfig.uploadSpeedBoost, true);
                        return;
                    } else {
                        return;
                    }
                ...
                if (i == s55.this.d) {
                    uw9Var.c(u.B0("CustomEmojiTypeface", org.telegram.mdgram.R.string.CustomEmojiTypeface), true);
                } else if (i == s55.this.f) {
                    int i2 = MDConfig.downloadSpeedBoost;
                    if (i2 != 0) {
                        if (i2 != 2) {
                            B0 = u.B0("DownloadSpeedBoostAverage", org.telegram.mdgram.R.string.DownloadSpeedBoostAverage);
                        } else {
                            B0 = u.B0("DownloadSpeedBoostExtreme", org.telegram.mdgram.R.string.DownloadSpeedBoostExtreme);
                        }
                    } else {
                        B0 = u.B0("DownloadSpeedBoostNone", org.telegram.mdgram.R.string.DownloadSpeedBoostNone);
                    }
                    uw9Var.d(u.B0("DownloadSpeedBoost", org.telegram.mdgram.R.string.DownloadSpeedBoost), B0, true);
                }
            } else if (i == s55.this.e) {
                d0Var.itemView.setBackground(l.u2(this.a, org.telegram.mdgram.R.drawable.greydivider_bottom, "windowBackgroundGrayShadow"));
            } else {
    ...
    public /* synthetic */ void v2(View view, int i, float f, float f2) {
        if (i == this.d) {
            ...
            arrayList.add(u.B0("DownloadSpeedBoostNone", org.telegram.mdgram.R.string.DownloadSpeedBoostNone));
            arrayList2.add(0);
            arrayList.add(u.B0("DownloadSpeedBoostAverage", org.telegram.mdgram.R.string.DownloadSpeedBoostAverage));
            arrayList2.add(1);
            arrayList.add(u.B0("DownloadSpeedBoostExtreme", org.telegram.mdgram.R.string.DownloadSpeedBoostExtreme));
            arrayList2.add(2);
            ll7.e(arrayList, u.B0("DownloadSpeedBoost", org.telegram.mdgram.R.string.DownloadSpeedBoost), arrayList2.indexOf(Integer.valueOf(MDConfig.downloadSpeedBoost)), E0(), view, new e69.b() { // from class: r55
    ...
    public View W(Context context) {
        ...
        this.actionBar.setTitle(u.B0("Others", org.telegram.mdgram.R.string.Others));
        ...
        undoView.setInfoText(u.d0("AboutEmoji", org.telegram.mdgram.R.string.AboutEmoji, new Object[0]));
        ...
        undoView2.setInfoText(u.d0("RestartAppToTakeEffect", org.telegram.mdgram.R.string.RestartAppToTakeEffect, new Object[0]));
        ...
        if (i2 == -1 && i == 36654 && intent != null && (data = intent.getData()) != null) {
            try {
                ...
                if (MDConfig.f(file.toString())) {
                    ...
                    q.p0(this).C(u.B0("InvalidCustomEmojiTypeface", org.telegram.mdgram.R.string.InvalidCustomEmojiTypeface)).T();
                    file.delete();
                }
            } catch (Exception e) {
