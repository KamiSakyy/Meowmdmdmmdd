...
public abstract class ud3 {
    ...
    public static class a extends Drawable {
        ...
        public a(Context context, float f, int i) {
            this.f20167a = context.getResources().getDrawable(org.telegram.mdgram.R.drawable.msg_filled_general).mutate();
            this.a = f;
            a(i);
        }
    ...
    public static CharSequence e(TLRPC$TL_forumTopic tLRPC$TL_forumTopic, x xVar) {
        ...
        if (mo9Var instanceof TLRPC$TL_messageActionTopicCreate) {
            return org.telegram.messenger.a.X2("%s", u.z0(org.telegram.mdgram.R.string.TopicWasCreatedAction), j(tLRPC$TL_forumTopic, null));
        }
        if (mo9Var instanceof TLRPC$TL_messageActionTopicEdit) {
            ...
            if ((i3 & 8) != 0) {
                if (tLRPC$TL_messageActionTopicEdit.e) {
                    i2 = org.telegram.mdgram.R.string.TopicHidden2;
                } else {
                    i2 = org.telegram.mdgram.R.string.TopicShown2;
                }
                return org.telegram.messenger.a.X2("%s", u.z0(i2), str);
            } else if ((i3 & 4) != 0) {
                if (tLRPC$TL_messageActionTopicEdit.d) {
                    i = org.telegram.mdgram.R.string.TopicWasClosedAction;
                } else {
                    i = org.telegram.mdgram.R.string.TopicWasReopenedAction;
                }
                ...
                return org.telegram.messenger.a.X2("%1$s", org.telegram.messenger.a.X2("%2$s", u.z0(org.telegram.mdgram.R.string.TopicWasRenamedToAction2), j(tLRPC$TL_forumTopic2, null)), str);
            } else if ((i3 & 1) != 0) {
                return org.telegram.messenger.a.X2("%1$s", org.telegram.messenger.a.X2("%2$s", u.z0(org.telegram.mdgram.R.string.TopicWasRenamedToAction), ((mo9) tLRPC$TL_messageActionTopicEdit).f10503a), str);
            } else {
                if ((i3 & 2) != 0) {
                    ...
                    return org.telegram.messenger.a.X2("%1$s", org.telegram.messenger.a.X2("%2$s", u.z0(org.telegram.mdgram.R.string.TopicWasIconChangedToAction), j(tLRPC$TL_forumTopic3, null)), str);
                }
            }
        }
        return null;
