...
public class aq4 extends org.telegram.ui.ActionBar.f {
    ...
    public /* synthetic */ void O2(View view) {
        e.k kVar = new e.k(E0());
        kVar.n(u.B0("RevokeAlert", org.telegram.mdgram.R.string.RevokeAlert));
        kVar.x(u.B0("RevokeLink", org.telegram.mdgram.R.string.RevokeLink));
        kVar.v(u.B0("RevokeButton", org.telegram.mdgram.R.string.RevokeButton), new DialogInterface.OnClickListener() { // from class: op4
    ...
    public /* synthetic */ void P2() {
        ...
        if (bv9Var != null) {
            ...
            this.dividerUses.setBackgroundDrawable(l.u2(context, org.telegram.mdgram.R.drawable.greydivider_bottom, "windowBackgroundGrayShadow"));
            this.divider.setBackgroundDrawable(l.u2(context, org.telegram.mdgram.R.drawable.greydivider, "windowBackgroundGrayShadow"));
            ...
            this.dividerName.setBackground(l.u2(context, org.telegram.mdgram.R.drawable.greydivider_bottom, "windowBackgroundGrayShadow"));
    ...
    public final void G2(int i2) {
        ...
        for (int i5 = 0; i5 < size; i5++) {
            if (i5 == size - 1) {
                strArr[i5] = u.B0("NoLimit", org.telegram.mdgram.R.string.NoLimit);
                ...
                long j2 = currentTime;
                if (j2 < 86400) {
                    strArr[i5] = u.B0("MessageScheduleToday", org.telegram.mdgram.R.string.MessageScheduleToday);
                } else if (j2 < 31449600) {
    ...
    public final void H2(int i2) {
        ...
        for (int i6 = 0; i6 < size; i6++) {
            if (i6 == size - 1) {
                strArr[i6] = u.B0("NoLimit", org.telegram.mdgram.R.string.NoLimit);
            } else {
    ...
    */
    ...
    public final void V2() {
        ...
        while (true) {
            ...
            if (i2 < iArr.length) {
                ...
                this.timeChooseView.e(3, u.U("Hours", 1, new Object[0]), u.U("Days", 1, new Object[0]), u.U("Weeks", 1, new Object[0]), u.B0("NoLimit", org.telegram.mdgram.R.string.NoLimit));
                return;
            }
        }
    }
    ...
    public View W(final Context context) {
        ...
        int i3 = this.type;
        if (i3 == 0) {
            this.actionBar.setTitle(u.B0("NewLink", org.telegram.mdgram.R.string.NewLink));
        } else if (i3 == 1) {
            this.actionBar.setTitle(u.B0("EditLink", org.telegram.mdgram.R.string.EditLink));
        }
        ...
        int i4 = this.type;
        if (i4 == 0) {
            this.createTextView.setText(u.B0("CreateLinkHeader", org.telegram.mdgram.R.string.CreateLinkHeader));
        } else if (i4 == 1) {
            this.createTextView.setText(u.B0("SaveLinkHeader", org.telegram.mdgram.R.string.SaveLinkHeader));
        }
        this.createTextView.setTextColor(l.B1("actionBarDefaultTitle"));
        ...
        int i5 = this.type;
        if (i5 == 0) {
            this.buttonTextView.setText(u.B0("CreateLink", org.telegram.mdgram.R.string.CreateLink));
        } else if (i5 == 1) {
            this.buttonTextView.setText(u.B0("SaveLink", org.telegram.mdgram.R.string.SaveLink));
        }
        ...
        if (S7 != null && S7.f5611b != null) {
            ...
            this.approveCell.i(u.B0("ApproveNewMembers", org.telegram.mdgram.R.string.ApproveNewMembers), false, false);
        ...
        bv9Var.setBackground(l.u2(context, org.telegram.mdgram.R.drawable.greydivider, "windowBackgroundGrayShadow"));
        if (z) {
            bv9Var.setText(u.B0("ApproveNewMembersDescription", org.telegram.mdgram.R.string.ApproveNewMembersDescription));
        }
        cVar.addView(bv9Var);
        nu3 nu3Var = new nu3(context);
        this.timeHeaderCell = nu3Var;
        nu3Var.setText(u.B0("LimitByPeriod", org.telegram.mdgram.R.string.LimitByPeriod));
        ...
        this.timeEditText.setHint(u.B0("TimeLimitHint", org.telegram.mdgram.R.string.TimeLimitHint));
        ...
        bv9Var2.setText(u.B0("TimeLimitHelp", org.telegram.mdgram.R.string.TimeLimitHelp));
        cVar.addView(this.divider);
        nu3 nu3Var2 = new nu3(context);
        this.usesHeaderCell = nu3Var2;
        nu3Var2.setText(u.B0("LimitNumberOfUses", org.telegram.mdgram.R.string.LimitNumberOfUses));
        ...
        this.usesEditText.setHint(u.B0("UsesLimitHint", org.telegram.mdgram.R.string.UsesLimitHint));
        ...
        bv9Var3.setText(u.B0("UsesLimitHelp", org.telegram.mdgram.R.string.UsesLimitHelp));
        ...
        this.nameEditText.setHint(u.B0("LinkNameHint", org.telegram.mdgram.R.string.LinkNameHint));
        this.nameEditText.setHintTextColor(l.B1("windowBackgroundWhiteGrayText"));
        ...
        bv9Var4.setBackground(l.u2(context, org.telegram.mdgram.R.drawable.greydivider_bottom, "windowBackgroundGrayShadow"));
        this.dividerName.setText(u.B0("LinkNameHelp", org.telegram.mdgram.R.string.LinkNameHelp));
        ...
        if (this.type == 1) {
            ...
            this.revokeLink.c(u.B0("RevokeLink", org.telegram.mdgram.R.string.RevokeLink), false);
    ...
    public final void W2() {
        ...
        while (true) {
            ...
            if (i2 < iArr.length) {
                ...
                this.usesChooseView.e(3, "1", "10", "100", u.B0("NoLimit", org.telegram.mdgram.R.string.NoLimit));
                return;
            }
        }
    }
    ...
    public final void Z2(boolean z) {
        ...
        Activity E0 = E0();
        if (z) {
            i5 = org.telegram.mdgram.R.drawable.greydivider;
        } else {
            i5 = org.telegram.mdgram.R.drawable.greydivider_bottom;
        }
