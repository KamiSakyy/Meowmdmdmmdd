...
public class StringEscapeUtils {
    ...
    static {
        ...
        hashMap3.put("\\", "\\\\");
        hashMap3.put("/", "\\/");
        ESCAPE_JSON = new AggregateTranslator(new LookupTranslator(Collections.unmodifiableMap(hashMap3)), new LookupTranslator(map), JavaUnicodeEscaper.outsideOf(32, 126));
        ...
        ESCAPE_XML10 = new AggregateTranslator(new LookupTranslator(map2), new LookupTranslator(map3), new LookupTranslator(Collections.unmodifiableMap(hashMap4)), NumericEntityEscaper.between(127, 132), NumericEntityEscaper.between(134, 159), new UnicodeUnpairedSurrogateRemover());
        ...
        hashMap6.put(Constants.INTERNAL_NAME_SEPARATOR, "\\|");
        hashMap6.put("&", "\\&");
        hashMap6.put(";", "\\;");
        hashMap6.put("<", "\\<");
        hashMap6.put(">", "\\>");
        ...
        hashMap6.put("?", "\\?");
        hashMap6.put(Constants.ID_PREFIX, "\\[");
        hashMap6.put("#", "\\#");
        hashMap6.put(org.h2.engine.Constants.SERVER_PROPERTIES_DIR, "\\~");
        hashMap6.put("=", "\\=");
        hashMap6.put("%", "\\%");
