...
public class SysProperties {
    ...
    public static boolean FORCE_AUTOCOMMIT_OFF_ON_COMMIT = false;
    ...
    static {
        boolean property = Utils.getProperty("h2.preview", false);
        PREVIEW = property;
        ALLOWED_CLASSES = Utils.getProperty("h2.allowedClasses", Marker.ANY_MARKER);
        ...
        CONSOLE_MAX_TABLES_LIST_COLUMNS = Utils.getProperty("h2.consoleTableColumns", (int) Constants.DEFAULT_WRITE_DELAY);
        ...
        DELAY_WRONG_PASSWORD_MIN = Utils.getProperty("h2.delayWrongPasswordMin", (int) j.e.DEFAULT_SWIPE_ANIMATION_DURATION);
        ...
        try {
            ...
            OLD_RESULT_SET_GET_OBJECT = Utils.getProperty("h2.oldResultSetGetObject", !property);
            BIG_DECIMAL_IS_DECIMAL = Utils.getProperty("h2.bigDecimalIsDecimal", !property);
            RETURN_OFFSET_DATE_TIME = Utils.getProperty("h2.returnOffsetDateTime", property);
            ...
            SORT_UUID_UNSIGNED = Utils.getProperty("h2.sortUuidUnsigned", property);
