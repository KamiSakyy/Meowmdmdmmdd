...
public class MDGeneralActivity extends BaseFragment {
    ...
    private void fill() {
        ...
        list.addView(MDCells.check(context, "GhostMode", R.string.GhostMode,
                MDConfig.ghostMode, new BoolListener() {
                    @Override
                    public void onChange(boolean value) {
                        MDConfig.setGhostMode(value);
                    }
                }));
        list.addView(MDCells.info(context, "GhostModeInfo", R.string.GhostModeInfo));
        list.addView(MDCells.check(context, "MD_NoStickers", R.string.MD_NoStickers,
                MDConfig.noStickers, new BoolListener() {
                    @Override
                    public void onChange(boolean value) {
                        MDConfig.setNoStickers(value);
                    }
                }));
        ...
        list.addView(MDCells.button(context, "MD_fontS", R.string.MD_fontS,
                new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        presentFragment(new org.telegram.mdgram.fontStyle.FontStyleActivity());
                    }
                }));
