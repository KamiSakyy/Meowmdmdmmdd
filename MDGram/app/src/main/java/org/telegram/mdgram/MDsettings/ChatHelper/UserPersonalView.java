...
public class UserPersonalView extends FrameLayout implements View.OnClickListener {
    ...
    private void initView() {
        ...
        this.binding.tvMsg.setText(u.B0("user_personal_message", org.telegram.mdgram.R.string.user_personal_message));
        this.binding.tvVoice.setText(u.B0("user_personal_voice", org.telegram.mdgram.R.string.user_personal_voice));
        this.binding.tvMainPage.setText(u.B0("user_personal_main_page", org.telegram.mdgram.R.string.user_personal_main_page));
        this.binding.tvCommune.setText(u.B0("user_personal_secret_chat", org.telegram.mdgram.R.string.user_personal_secret_chat));
        this.binding.tvAddFriend.setText(u.B0("user_personal_add_friend", org.telegram.mdgram.R.string.user_personal_add_friend));
        ...
        this.binding.tvIntroduction.setText(u.B0("user_personal_introduction", org.telegram.mdgram.R.string.user_personal_introduction));
        this.binding.tvProfileExpand.setText(u.B0("fg_textview_expand", org.telegram.mdgram.R.string.fg_textview_expand));
        this.binding.tvLastMsgDate.setText(u.B0("user_personal_last_msg_date", org.telegram.mdgram.R.string.user_personal_last_msg_date));
        this.binding.tvOnlineTimeTitle.setText(u.B0("user_personal_online_time", org.telegram.mdgram.R.string.user_personal_online_time));
        ...
        this.binding.tvCommonChats.setText(u.B0("user_personal_common_group", org.telegram.mdgram.R.string.user_personal_common_group));
    ...
    public void onClick(View view) {
        ...
        if (id == org.telegram.mdgram.R.id.ll_profile_add_friend) {
            ...
            EventBus.getDefault().post(new MessageEvent("dismiss_dialog"));
        } else if (id != org.telegram.mdgram.R.id.ll_profile_message && id != org.telegram.mdgram.R.id.rtv_user_name) {
            if (id == org.telegram.mdgram.R.id.ll_profile_secret) {
                e.k kVar = new e.k(getContext(), null);
                kVar.x(u.B0("AreYouSureSecretChatTitle", org.telegram.mdgram.R.string.AreYouSureSecretChatTitle));
                kVar.n(u.B0("AreYouSureSecretChat", org.telegram.mdgram.R.string.AreYouSureSecretChat));
                kVar.v(u.B0("Start", org.telegram.mdgram.R.string.Start), new DialogInterface.OnClickListener() { // from class: org.telegram.mdgram.MDsettings.ChatHelper.UserPersonalView.7
            ...
            } else if (id == org.telegram.mdgram.R.id.ll_profile_voice) {
            ...
            } else if (id == org.telegram.mdgram.R.id.tv_close_dialog) {
                EventBus.getDefault().post(new MessageEvent("dismiss_dialog"));
            } else if (id == org.telegram.mdgram.R.id.tv_user_search) {
    ...
    public void setData(j jVar, mq9 mq9Var, nq9 nq9Var) {
        ...
        if (mq9Var.f10567b) {
            ...
            this.binding.tvAddFriend.setText(u.B0("user_personal_edit_friend", org.telegram.mdgram.R.string.user_personal_edit_friend));
        }
    ...
    public void setSearchData(Integer num, long j) {
        String str;
        this.binding.tvUserSearch.setText(String.format(u.B0("user_personal_msg_num", org.telegram.mdgram.R.string.user_personal_msg_num), num));
        ...
        String B0 = u.B0("user_personal_last_msg_date", org.telegram.mdgram.R.string.user_personal_last_msg_date);
