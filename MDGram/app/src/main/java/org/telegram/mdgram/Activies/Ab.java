...
public class Ab extends bg {
    ...
    public final void I() {
        try {
            AlertDialog.Builder builder = new AlertDialog.Builder(new ContextThemeWrapper(this, org.telegram.mdgram.R.style.AlertDialogCustom));
    ...
    public void d0() {
        TextView textView = (TextView) findViewById(org.telegram.mdgram.R.id.TVersion);
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView(org.telegram.mdgram.R.layout.rc_about_fragment);
        ((ScrollView) findViewById(org.telegram.mdgram.R.id.aboutContent)).setBackgroundColor(l.B1("windowBackgroundWhite"));
        c0();
        d0();
        ...
        Drawable e = sz1.e(this, org.telegram.mdgram.R.drawable.md_back);
        ...
        ((TextView) findViewById(org.telegram.mdgram.R.id.title_about)).setText(Html.fromHtml(K + " " + K2));
        findViewById(org.telegram.mdgram.R.id.rc_dev).setOnClickListener(new View.OnClickListener() { // from class: q
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                Ab.this.O(view);
            }
        });
        findViewById(org.telegram.mdgram.R.id.gabi_insta).setOnClickListener(new View.OnClickListener() { // from class: r
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                Ab.this.S(view);
            }
        });
        findViewById(org.telegram.mdgram.R.id.fran_twitter).setOnClickListener(new View.OnClickListener() { // from class: s
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                Ab.this.T(view);
            }
        });
        findViewById(org.telegram.mdgram.R.id.lu_insta).setOnClickListener(new View.OnClickListener() { // from class: t
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                Ab.this.U(view);
            }
        });
        findViewById(org.telegram.mdgram.R.id.about_donate).setOnClickListener(new View.OnClickListener() { // from class: u
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                Ab.this.V(view);
            }
        });
        findViewById(org.telegram.mdgram.R.id.about_share).setOnClickListener(new View.OnClickListener() { // from class: v
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                Ab.this.W(view);
            }
        });
        findViewById(org.telegram.mdgram.R.id.about_web).setOnClickListener(new View.OnClickListener() { // from class: i
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                Ab.this.X(view);
            }
        });
        findViewById(org.telegram.mdgram.R.id.about_twitter).setOnClickListener(new View.OnClickListener() { // from class: j
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                Ab.this.Y(view);
            }
        });
        findViewById(org.telegram.mdgram.R.id.about_facebook).setOnClickListener(new View.OnClickListener() { // from class: k
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                Ab.this.Z(view);
            }
        });
        findViewById(org.telegram.mdgram.R.id.about_telegram).setOnClickListener(new View.OnClickListener() { // from class: n
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                Ab.this.P(view);
            }
        });
        findViewById(org.telegram.mdgram.R.id.about_changelog).setOnClickListener(new View.OnClickListener() { // from class: o
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                Ab.this.Q(view);
            }
        });
        findViewById(org.telegram.mdgram.R.id.about_credits).setOnClickListener(new View.OnClickListener() { // from class: p
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                Ab.this.R(view);
            }
        });
        findViewById(org.telegram.mdgram.R.id.about_version).setOnClickListener(new a());
    }
}
