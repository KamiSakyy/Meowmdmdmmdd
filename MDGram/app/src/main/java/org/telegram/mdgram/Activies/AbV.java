...
public class AbV extends bg {
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView(org.telegram.mdgram.R.layout.about_version);
        ((RelativeLayout) findViewById(org.telegram.mdgram.R.id.aboutContent2)).setBackgroundColor(l.B1("windowBackgroundWhite"));
        lq1.a(this);
        s();
    }
