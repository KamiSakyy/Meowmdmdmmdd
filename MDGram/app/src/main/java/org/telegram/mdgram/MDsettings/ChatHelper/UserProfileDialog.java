...
public class UserProfileDialog extends BaseBottomSheetDialog implements a0.d {
    ...
    public void show() {
        ...
        ((FrameLayout) findViewById(org.telegram.mdgram.R.id.design_bottom_sheet)).setBackgroundResource(org.telegram.mdgram.R.drawable.transparent);
        getWindow().getDecorView().setBackground(sz1.e(getContext(), org.telegram.mdgram.R.drawable.transparent));
    }
}
