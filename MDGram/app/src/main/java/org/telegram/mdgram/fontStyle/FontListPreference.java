...
public class FontListPreference extends ListPreference {
    ...
    public final void c() {
        setTitle(org.telegram.mdgram.R.string.MD_fontS);
        setSummary(org.telegram.mdgram.R.string.MD_fontS_sum);
    }
    ...
    public void onPrepareDialogBuilder(AlertDialog.Builder builder) {
        ...
        builder.setTitle(org.telegram.mdgram.R.string.MD_fontS);
