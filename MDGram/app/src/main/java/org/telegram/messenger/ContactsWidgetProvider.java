    ...
    public static void b(Context context, AppWidgetManager appWidgetManager, int i) {
        ...
        if (!sharedPreferences.getBoolean("deleted" + i, false)) {
            ...
            if (a != 1 && ceil > 1) {
                if (a != 2 && ceil > 2) {
                    if (a != 3 && ceil > 3) {
                        i2 = org.telegram.mdgram.R.layout.contacts_widget_layout_4;
                    } else {
                        i2 = org.telegram.mdgram.R.layout.contacts_widget_layout_3;
                    }
                } else {
                    i2 = org.telegram.mdgram.R.layout.contacts_widget_layout_2;
                }
            } else {
                i2 = org.telegram.mdgram.R.layout.contacts_widget_layout_1;
            }
        } else {
            i2 = org.telegram.mdgram.R.layout.contacts_widget_layout_1;
        }
