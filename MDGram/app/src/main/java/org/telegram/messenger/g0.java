...
public class g0 extends ow {
    ...
    public /* synthetic */ void b0(org.telegram.ui.ActionBar.f fVar) {
        fVar.f2(new e.k(fVar.k0()).x(u.B0("LimitReached", org.telegram.mdgram.R.string.LimitReached)).n(u.d0("LimitReachedPinnedTopics", org.telegram.mdgram.R.string.LimitReachedPinnedTopics, Integer.valueOf(y.u8(((ow) this).a).s0))).v(u.B0("OK", org.telegram.mdgram.R.string.OK), null).a());
    }
