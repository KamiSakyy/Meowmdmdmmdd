...
public class d0 extends ow implements a0.d {
    ...
    */
    ...
    public static /* synthetic */ void P1(int i2, q2 q2Var) {
        try {
            if (i2 == 1) {
                a0.j().s(a0.Y2, 1, u.B0("UnsupportedAttachment", org.telegram.mdgram.R.string.UnsupportedAttachment));
            } else if (i2 == 2) {
        ...
        if (aVar != null) {
            ...
            if ("PASSWORD_HASH_INVALID".equals(tLRPC$TL_error.f14225a)) {
                if (kn9Var == null) {
                    ...
                    kVar2.x(u.B0("BotOwnershipTransfer", org.telegram.mdgram.R.string.BotOwnershipTransfer));
                    kVar2.n(org.telegram.messenger.a.b3(u.d0("BotOwnershipTransferReadyAlertText", org.telegram.mdgram.R.string.BotOwnershipTransferReadyAlertText, new Object[0])));
                    kVar2.v(u.B0("BotOwnershipTransferChangeOwner", org.telegram.mdgram.R.string.BotOwnershipTransferChangeOwner), new DialogInterface.OnClickListener() { // from class: ju8
                ...
                kVar3.x(u.B0("EditAdminTransferAlertTitle", org.telegram.mdgram.R.string.EditAdminTransferAlertTitle));
                ...
                textView.setText(org.telegram.messenger.a.b3(u.d0("BotOwnershipTransferAlertText", org.telegram.mdgram.R.string.BotOwnershipTransferAlertText, new Object[0])));
                ...
                textView2.setText(org.telegram.messenger.a.b3(u.B0("EditAdminTransferAlertText1", org.telegram.mdgram.R.string.EditAdminTransferAlertText1)));
                if (u.d) {
                ...
                textView3.setText(org.telegram.messenger.a.b3(u.B0("EditAdminTransferAlertText2", org.telegram.mdgram.R.string.EditAdminTransferAlertText2)));
                if (u.d) {
                ...
                if ("PASSWORD_MISSING".equals(tLRPC$TL_error.f14225a)) {
                    kVar3.v(u.B0("EditAdminTransferSetPassword", org.telegram.mdgram.R.string.EditAdminTransferSetPassword), new DialogInterface.OnClickListener() { // from class: ku8
                        @Override // android.content.DialogInterface.OnClickListener
                        public final void onClick(DialogInterface dialogInterface, int i2) {
                    ...
                    textView4.setText(u.B0("EditAdminTransferAlertText3", org.telegram.mdgram.R.string.EditAdminTransferAlertText3));
                    linearLayout.addView(textView4, cn4.i(-1, -2, 0.0f, 11.0f, 0.0f, 0.0f));
                    kVar3.p(u.B0("OK", org.telegram.mdgram.R.string.OK), null);
                }
                jVar.f2(kVar3.a());
            }
        }
    ...
    */
    ...
    public static /* synthetic */ void u2(z.d dVar) {
        Toast.makeText(org.telegram.messenger.b.f12514a, u.B0("ImportFileTooLarge", org.telegram.mdgram.R.string.ImportFileTooLarge), 0).show();
        dVar.run(0L);
    }
