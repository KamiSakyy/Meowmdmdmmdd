...
public final class Instance {
    ...
    public static final class Candidate {
        ...
        public String toString() {
            return "Candidate{port=" + this.port + ", protocol=" + this.protocol + ", network=" + this.network + ", generation=" + this.generation + ", id=" + this.id + ", component=" + this.component + ", foundation=" + this.foundation + ", priority=" + this.priority + ", ip=" + this.ip + ", type=" + this.type + ", tcpType=" + this.tcpType + ", relAddr=" + this.relAddr + ", relPort=" + this.relPort + MessageFormatter.DELIM_STOP;
        }
    }
    ...
    public static final class EncryptionKey {
        ...
        public String toString() {
            return "EncryptionKey{value=" + Arrays.toString(this.value) + ", isOutgoing=" + this.isOutgoing + MessageFormatter.DELIM_STOP;
        }
    }
    ...
    public static final class Endpoint {
        ...
        public String toString() {
            return "Endpoint{id=" + this.id + ", ipv4='" + this.ipv4 + "', ipv6='" + this.ipv6 + "', port=" + this.port + ", type=" + this.type + ", peerTag=" + Arrays.toString(this.peerTag) + ", turn=" + this.turn + ", stun=" + this.stun + ", username=" + this.username + ", password=" + this.password + ", tcp=" + this.tcp + MessageFormatter.DELIM_STOP;
        }
    }
    ...
    public static final class FinalState {
        ...
        public String toString() {
            return "FinalState{persistentState=" + Arrays.toString(this.persistentState) + ", debugLog='" + this.debugLog + "', trafficStats=" + this.trafficStats + ", isRatingSuggested=" + this.isRatingSuggested + MessageFormatter.DELIM_STOP;
        }
    }
    ...
    public static final class Fingerprint {
        ...
        public String toString() {
            return "Fingerprint{hash=" + this.hash + ", setup=" + this.setup + ", fingerprint=" + this.fingerprint + MessageFormatter.DELIM_STOP;
        }
    }
    ...
    public static final class Proxy {
        ...
        public String toString() {
            return "Proxy{host='" + this.host + "', port=" + this.port + ", login='" + this.login + "', password='" + this.password + '\'' + MessageFormatter.DELIM_STOP;
        }
    }
    ...
    public static final class TrafficStats {
        ...
        public String toString() {
            return "TrafficStats{bytesSentWifi=" + this.bytesSentWifi + ", bytesReceivedWifi=" + this.bytesReceivedWifi + ", bytesSentMobile=" + this.bytesSentMobile + ", bytesReceivedMobile=" + this.bytesReceivedMobile + MessageFormatter.DELIM_STOP;
        }
    }
    ...
    public static void setGlobalServerConfig(String str) {
        try {
            ...
            if (s60.f18613b) {
                l.o("failed to parse tgvoip server config", e);
            }
        }
    }
}
