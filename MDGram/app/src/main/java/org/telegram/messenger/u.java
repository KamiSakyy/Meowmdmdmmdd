...
public class u {
    ...
    public static String G(long j2, boolean z) {
        ...
        try {
            ...
            if (i4 == i2 && i3 == i5) {
                if (z) {
                    return d0("TodayAtFormatted", org.telegram.mdgram.R.string.TodayAtFormatted, p0().f13195a.b(new Date(j3)));
                }
                return d0("TodayAtFormattedWithToday", org.telegram.mdgram.R.string.TodayAtFormattedWithToday, p0().f13195a.b(new Date(j3)));
            } else if (i4 + 1 == i2 && i3 == i5) {
                return d0("YesterdayAtFormatted", org.telegram.mdgram.R.string.YesterdayAtFormatted, p0().f13195a.b(new Date(j3)));
            } else {
                if (Math.abs(System.currentTimeMillis() - j3) < 31536000000L) {
                    return d0("formatDateAtTime", org.telegram.mdgram.R.string.formatDateAtTime, p0().f13210e.b(new Date(j3)), p0().f13195a.b(new Date(j3)));
                }
                return d0("formatDateAtTime", org.telegram.mdgram.R.string.formatDateAtTime, p0().f13211f.b(new Date(j3)), p0().f13195a.b(new Date(j3)));
            }
        } catch (Exception e2) {
            org.telegram.messenger.l.p(e2);
            return "LOC_ERR";
    ...
    public static String H(long j2) {
        ...
        try {
            ...
            if (Math.abs(System.currentTimeMillis() - j3) < 31536000000L) {
                return d0("formatDateAtTime", org.telegram.mdgram.R.string.formatDateAtTime, p0().k.b(new Date(j3)), p0().f13195a.b(new Date(j3)));
            }
            return d0("formatDateAtTime", org.telegram.mdgram.R.string.formatDateAtTime, p0().l.b(new Date(j3)), p0().f13195a.b(new Date(j3)));
        } catch (Exception e2) {
            org.telegram.messenger.l.p(e2);
            return "LOC_ERR";
        }
    ...
    public static String L(long j2, boolean[] zArr) {
        ...
        try {
            ...
            if (i5 == i2 && i3 == i6) {
                return d0("LastSeenFormatted", org.telegram.mdgram.R.string.LastSeenFormatted, d0("TodayAtFormatted", org.telegram.mdgram.R.string.TodayAtFormatted, p0().f13195a.b(new Date(j3))));
            }
            if (i5 + 1 == i2 && i3 == i6) {
                if (zArr != null) {
                    zArr[0] = true;
                    if (i4 <= 6 && i7 > 18 && e) {
                        return d0("LastSeenFormatted", org.telegram.mdgram.R.string.LastSeenFormatted, p0().f13195a.b(new Date(j3)));
                    }
                    return d0("YesterdayAtFormatted", org.telegram.mdgram.R.string.YesterdayAtFormatted, p0().f13195a.b(new Date(j3)));
                }
                return d0("LastSeenFormatted", org.telegram.mdgram.R.string.LastSeenFormatted, d0("YesterdayAtFormatted", org.telegram.mdgram.R.string.YesterdayAtFormatted, p0().f13195a.b(new Date(j3))));
            } else if (Math.abs(System.currentTimeMillis() - j3) < 31536000000L) {
                return d0("LastSeenDateFormatted", org.telegram.mdgram.R.string.LastSeenDateFormatted, d0("formatDateAtTime", org.telegram.mdgram.R.string.formatDateAtTime, p0().f13210e.b(new Date(j3)), p0().f13195a.b(new Date(j3))));
            } else {
                return d0("LastSeenDateFormatted", org.telegram.mdgram.R.string.LastSeenDateFormatted, d0("formatDateAtTime", org.telegram.mdgram.R.string.formatDateAtTime, p0().f13211f.b(new Date(j3)), p0().f13195a.b(new Date(j3))));
            }
        } catch (Exception e2) {
            org.telegram.messenger.l.p(e2);
            return "LOC_ERR";
    ...
    public static String O(float f2, int i2, Boolean bool) {
        ...
        if (z) {
            ...
            if (f3 < 1000.0f) {
                if (i2 != 0) {
                    if (i2 != 1) {
                        return d0("FootsShort", org.telegram.mdgram.R.string.FootsShort, String.format("%d", Integer.valueOf((int) Math.max(1.0f, f3))));
                    }
                    return d0("FootsFromYou", org.telegram.mdgram.R.string.FootsFromYou, String.format("%d", Integer.valueOf((int) Math.max(1.0f, f3))));
                }
                return d0("FootsAway", org.telegram.mdgram.R.string.FootsAway, String.format("%d", Integer.valueOf((int) Math.max(1.0f, f3))));
            }
            if (f3 % 5280.0f == 0.0f) {
            ...
            if (i2 != 0) {
                if (i2 != 1) {
                    return d0("MilesShort", org.telegram.mdgram.R.string.MilesShort, format2);
                }
                return d0("MilesFromYou", org.telegram.mdgram.R.string.MilesFromYou, format2);
            }
            return d0("MilesAway", org.telegram.mdgram.R.string.MilesAway, format2);
        } else if (f2 < 1000.0f) {
            if (i2 != 0) {
                if (i2 != 1) {
                    return d0("MetersShort", org.telegram.mdgram.R.string.MetersShort, String.format("%d", Integer.valueOf((int) Math.max(1.0f, f2))));
                }
                return d0("MetersFromYou2", org.telegram.mdgram.R.string.MetersFromYou2, String.format("%d", Integer.valueOf((int) Math.max(1.0f, f2))));
            }
            return d0("MetersAway2", org.telegram.mdgram.R.string.MetersAway2, String.format("%d", Integer.valueOf((int) Math.max(1.0f, f2))));
        } else {
            if (f2 % 1000.0f == 0.0f) {
            ...
            if (i2 != 0) {
                if (i2 != 1) {
                    return d0("KMetersShort", org.telegram.mdgram.R.string.KMetersShort, format);
                }
                return d0("KMetersFromYou2", org.telegram.mdgram.R.string.KMetersFromYou2, format);
            }
            return d0("KMetersAway2", org.telegram.mdgram.R.string.KMetersAway2, format);
        }
    }
    ...
    public static String R(long j2) {
        ...
        try {
            if (Math.abs(System.currentTimeMillis() - j3) < 31536000000L) {
                d0 = d0("formatDateAtTime", org.telegram.mdgram.R.string.formatDateAtTime, p0().f13210e.b(new Date(j3)), p0().f13195a.b(new Date(j3)));
            } else {
                d0 = d0("formatDateAtTime", org.telegram.mdgram.R.string.formatDateAtTime, p0().f13211f.b(new Date(j3)), p0().f13195a.b(new Date(j3)));
            }
            return d0("ChannelOtherSubscriberJoined", org.telegram.mdgram.R.string.ChannelOtherSubscriberJoined, d0);
        } catch (Exception e2) {
            org.telegram.messenger.l.p(e2);
            return "LOC_ERR";
        }
    ...
    public static String T(long j2) {
        ...
        try {
            ...
            if (i4 == i2 && i3 == i5) {
                ...
                if (currentTime < 1) {
                    return B0("LocationUpdatedJustNow", org.telegram.mdgram.R.string.LocationUpdatedJustNow);
                }
                if (currentTime < 60) {
                    return U("UpdatedMinutes", currentTime, new Object[0]);
                }
                return d0("LocationUpdatedFormatted", org.telegram.mdgram.R.string.LocationUpdatedFormatted, d0("TodayAtFormatted", org.telegram.mdgram.R.string.TodayAtFormatted, p0().f13195a.b(new Date(j3))));
            } else if (i4 + 1 == i2 && i3 == i5) {
                return d0("LocationUpdatedFormatted", org.telegram.mdgram.R.string.LocationUpdatedFormatted, d0("YesterdayAtFormatted", org.telegram.mdgram.R.string.YesterdayAtFormatted, p0().f13195a.b(new Date(j3))));
            } else {
                if (Math.abs(System.currentTimeMillis() - j3) < 31536000000L) {
                    return d0("LocationUpdatedFormatted", org.telegram.mdgram.R.string.LocationUpdatedFormatted, d0("formatDateAtTime", org.telegram.mdgram.R.string.formatDateAtTime, p0().f13210e.b(new Date(j3)), p0().f13195a.b(new Date(j3))));
                }
                return d0("LocationUpdatedFormatted", org.telegram.mdgram.R.string.LocationUpdatedFormatted, d0("formatDateAtTime", org.telegram.mdgram.R.string.formatDateAtTime, p0().f13211f.b(new Date(j3)), p0().f13195a.b(new Date(j3))));
            }
        } catch (Exception e2) {
            org.telegram.messenger.l.p(e2);
            return "LOC_ERR";
    ...
    public static String j0(int i2, mq9 mq9Var, boolean[] zArr, boolean[] zArr2) {
        ...
        if (mq9Var != null && (pq9Var2 = mq9Var.f10561a) != null && pq9Var2.a <= 0 && y.u8(i2).f13609h.containsKey(Long.valueOf(mq9Var.f10557a))) {
            ...
            return B0("Online", org.telegram.mdgram.R.string.Online);
            ...
            if (i3 > currentTime) {
                ...
                return B0("Invisible", org.telegram.mdgram.R.string.Invisible);
            } else {
                if (i3 == -100) {
                    return B0("Lately", org.telegram.mdgram.R.string.Lately);
                }
                if (i3 == -101) {
                    return B0("WithinAWeek", org.telegram.mdgram.R.string.WithinAWeek);
                }
                if (i3 == -102) {
                    return B0("WithinAMonth", org.telegram.mdgram.R.string.WithinAMonth);
                }
                return L(i3, zArr2);
            }
        } else {
            return B0("ALongTimeAgo", org.telegram.mdgram.R.string.ALongTimeAgo);
        }
    }
    ...
    public static String k0(long j2, boolean z) {
        ...
        try {
            ...
            String[] strArr = {B0("January", org.telegram.mdgram.R.string.January), B0("February", org.telegram.mdgram.R.string.February), B0("March", org.telegram.mdgram.R.string.March), B0("April", org.telegram.mdgram.R.string.April), B0("May", org.telegram.mdgram.R.string.May), B0("June", org.telegram.mdgram.R.string.June), B0("July", org.telegram.mdgram.R.string.July), B0("August", org.telegram.mdgram.R.string.August), B0("September", org.telegram.mdgram.R.string.September), B0("October", org.telegram.mdgram.R.string.October), B0("November", org.telegram.mdgram.R.string.November), B0("December", org.telegram.mdgram.R.string.December)};
            if (i2 == i3 && !z) {
                return strArr[i4];
            }
            return strArr[i4] + " " + i3;
    ...
    public void h1() {
        ...
        a = i2;
        this.o = x(locale3, D0("formatterMonthYear", org.telegram.mdgram.R.string.formatterMonthYear), "MMM yyyy");
        this.f13210e = x(locale3, D0("formatterMonth", org.telegram.mdgram.R.string.formatterMonth), "dd MMM");
        this.f13211f = x(locale3, D0("formatterYear", org.telegram.mdgram.R.string.formatterYear), "dd.MM.yy");
        this.f13212g = x(locale3, D0("formatterYearMax", org.telegram.mdgram.R.string.formatterYearMax), "dd.MM.yyyy");
        this.k = x(locale3, D0("chatDate", org.telegram.mdgram.R.string.chatDate), "d MMMM");
        this.l = x(locale3, D0("chatFullDate", org.telegram.mdgram.R.string.chatFullDate), "d MMMM yyyy");
        this.f13204c = x(locale3, D0("formatterWeek", org.telegram.mdgram.R.string.formatterWeek), "EEE");
        this.f13208d = x(locale3, D0("formatterWeekLong", org.telegram.mdgram.R.string.formatterWeekLong), "EEEE");
        this.m = x(locale3, D0("formatDateSchedule", org.telegram.mdgram.R.string.formatDateSchedule), "MMM d");
        this.n = x(locale3, D0("formatDateScheduleYear", org.telegram.mdgram.R.string.formatDateScheduleYear), "MMM d yyyy");
        ...
        if (e) {
            i3 = org.telegram.mdgram.R.string.formatterDay24H;
            str = "formatterDay24H";
        } else {
            i3 = org.telegram.mdgram.R.string.formatterDay12H;
            str = "formatterDay12H";
        }
        String D0 = D0(str, i3);
        if (e) {
        ...
        if (e) {
            i4 = org.telegram.mdgram.R.string.formatterDay24HSec;
            str3 = "formatterDay24HSec";
        } else {
            i4 = org.telegram.mdgram.R.string.formatterDay12HSec;
        ...
        if (e) {
            i5 = org.telegram.mdgram.R.string.formatterStats24H;
            str5 = "formatterStats24H";
        } else {
            i5 = org.telegram.mdgram.R.string.formatterStats12H;
        ...
        if (e) {
            i6 = org.telegram.mdgram.R.string.formatterBannedUntil24H;
            str7 = "formatterBannedUntil24H";
        } else {
            i6 = org.telegram.mdgram.R.string.formatterBannedUntil12H;
        ...
        if (e) {
            i7 = org.telegram.mdgram.R.string.formatterBannedUntilThisYear24H;
            str8 = "formatterBannedUntilThisYear24H";
        } else {
            i7 = org.telegram.mdgram.R.string.formatterBannedUntilThisYear12H;
        ...
        this.f13197a[0] = x(locale3, D0("SendTodayAt", org.telegram.mdgram.R.string.SendTodayAt), "'Send today at' HH:mm");
        this.f13197a[1] = x(locale3, D0("SendDayAt", org.telegram.mdgram.R.string.SendDayAt), "'Send on' MMM d 'at' HH:mm");
        this.f13197a[2] = x(locale3, D0("SendDayYearAt", org.telegram.mdgram.R.string.SendDayYearAt), "'Send on' MMM d yyyy 'at' HH:mm");
        this.f13197a[3] = x(locale3, D0("RemindTodayAt", org.telegram.mdgram.R.string.RemindTodayAt), "'Remind today at' HH:mm");
        this.f13197a[4] = x(locale3, D0("RemindDayAt", org.telegram.mdgram.R.string.RemindDayAt), "'Remind on' MMM d 'at' HH:mm");
        this.f13197a[5] = x(locale3, D0("RemindDayYearAt", org.telegram.mdgram.R.string.RemindDayYearAt), "'Remind on' MMM d yyyy 'at' HH:mm");
        this.f13197a[6] = x(locale3, D0("StartTodayAt", org.telegram.mdgram.R.string.StartTodayAt), "'Start today at' HH:mm");
        this.f13197a[7] = x(locale3, D0("StartDayAt", org.telegram.mdgram.R.string.StartDayAt), "'Start on' MMM d 'at' HH:mm");
        this.f13197a[8] = x(locale3, D0("StartDayYearAt", org.telegram.mdgram.R.string.StartDayYearAt), "'Start on' MMM d yyyy 'at' HH:mm");
        this.f13197a[9] = x(locale3, D0("StartShortTodayAt", org.telegram.mdgram.R.string.StartShortTodayAt), "'Today,' HH:mm");
        this.f13197a[10] = x(locale3, D0("StartShortDayAt", org.telegram.mdgram.R.string.StartShortDayAt), "MMM d',' HH:mm");
        this.f13197a[11] = x(locale3, D0("StartShortDayYearAt", org.telegram.mdgram.R.string.StartShortDayYearAt), "MMM d yyyy, HH:mm");
        this.f13197a[12] = x(locale3, D0("StartsTodayAt", org.telegram.mdgram.R.string.StartsTodayAt), "'Starts today at' HH:mm");
        this.f13197a[13] = x(locale3, D0("StartsDayAt", org.telegram.mdgram.R.string.StartsDayAt), "'Starts on' MMM d 'at' HH:mm");
        this.f13197a[14] = x(locale3, D0("StartsDayYearAt", org.telegram.mdgram.R.string.StartsDayYearAt), "'Starts on' MMM d yyyy 'at' HH:mm");
    }
