...
public class a0 extends FrameLayout implements a0.d {
    ...
    public void A(Drawable drawable, Drawable drawable2) {
        ...
        if (!this.rightDrawableIsScamOrVerified) {
            if (drawable2 != null) {
                this.rightDrawableContentDescription = org.telegram.messenger.u.B0("NotificationsMuted", org.telegram.mdgram.R.string.NotificationsMuted);
            } else {
    ...
    public final void E() {
        ...
        if (i == 2) {
            str = org.telegram.messenger.u.B0("WaitingForNetwork", org.telegram.mdgram.R.string.WaitingForNetwork);
        } else if (i == 1) {
            str = org.telegram.messenger.u.B0("Connecting", org.telegram.mdgram.R.string.Connecting);
        } else if (i == 5) {
            str = org.telegram.messenger.u.B0("Updating", org.telegram.mdgram.R.string.Updating);
        } else if (i == 4) {
            str = org.telegram.messenger.u.B0("ConnectingToProxy", org.telegram.mdgram.R.string.ConnectingToProxy);
        } else {
            str = null;
        }
        if (str == null) {
            ...
            if (C8 != null && C8.length() != 0 && (!org.telegram.messenger.d.M(d2) || d2.h)) {
                ...
                if (jVar2.isTopic && d2 != null) {
                    ...
                    if (i2 > 0) {
                        ...
                        B0 = org.telegram.messenger.u.d0("TopicProfileStatus", org.telegram.mdgram.R.string.TopicProfileStatus, d2.f5602a);
                    }
                } else if (d2 != null) {
                    gm9 mk = jVar2.mk();
                    if (org.telegram.messenger.d.M(d2)) {
                        if (mk != null && (i = mk.b) != 0) {
                            ...
                            if (mk == null) {
                                B0 = org.telegram.messenger.u.B0("Loading", org.telegram.mdgram.R.string.Loading).toLowerCase();
                            } else if (d2.f5617e) {
                                B0 = org.telegram.messenger.u.B0("MegaLocation", org.telegram.mdgram.R.string.MegaLocation).toLowerCase();
                            } else if (org.telegram.messenger.d.a0(d2)) {
                                B0 = org.telegram.messenger.u.B0("MegaPublic", org.telegram.mdgram.R.string.MegaPublic).toLowerCase();
                            } else {
                                B0 = org.telegram.messenger.u.B0("MegaPrivate", org.telegram.mdgram.R.string.MegaPrivate).toLowerCase();
                            }
                        } else if (org.telegram.messenger.d.a0(d2)) {
                            B0 = org.telegram.messenger.u.B0("ChannelPublic", org.telegram.mdgram.R.string.ChannelPublic).toLowerCase();
                        } else {
                            B0 = org.telegram.messenger.u.B0("ChannelPrivate", org.telegram.mdgram.R.string.ChannelPrivate).toLowerCase();
                        }
                    } else if (org.telegram.messenger.d.S(d2)) {
                        B0 = org.telegram.messenger.u.B0("YouWereKicked", org.telegram.mdgram.R.string.YouWereKicked);
                    } else if (org.telegram.messenger.d.T(d2)) {
                        B0 = org.telegram.messenger.u.B0("YouLeft", org.telegram.mdgram.R.string.YouLeft);
                    } else {
                        int i3 = d2.d;
                    ...
                    if (!xla.k(l)) {
                        if (l.f10557a == tla.p(this.currentAccount).k()) {
                            B0 = org.telegram.messenger.u.B0("ChatYourSelf", org.telegram.mdgram.R.string.ChatYourSelf);
                        } else {
                            long j = l.f10557a;
                            if (j != 333000 && j != 777000 && j != 42777) {
                                if (org.telegram.messenger.y.r9(l)) {
                                    B0 = org.telegram.messenger.u.B0("SupportStatus", org.telegram.mdgram.R.string.SupportStatus);
                                } else if (l.f10571e) {
                                    B0 = org.telegram.messenger.u.B0("Bot", org.telegram.mdgram.R.string.Bot);
                                } else {
                                ...
                                B0 = org.telegram.messenger.u.B0("ServiceNotifications", org.telegram.mdgram.R.string.ServiceNotifications);
                            }
                        }
                    }
                }
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        if (accessibilityNodeInfo.isClickable()) {
            accessibilityNodeInfo.addAction(new AccessibilityNodeInfo.AccessibilityAction(16, org.telegram.messenger.u.B0("OpenProfile", org.telegram.mdgram.R.string.OpenProfile)));
        }
    }
    ...
    */
    ...
    public boolean w() {
        ...
        actionBarPopupWindowArr[0].setAnimationStyle(org.telegram.mdgram.R.style.PopupContextAnimation);
    ...
    public void y(CharSequence charSequence, boolean z, boolean z2, boolean z3, boolean z4, zm9 zm9Var, boolean z5) {
        ...
        if (!MDConfig.actionbarChatStyle) {
            ...
            if (!z && !z2) {
                if (z3) {
                    Drawable mutate = getResources().getDrawable(org.telegram.mdgram.R.drawable.verified_area).mutate();
                    mutate.setColorFilter(new PorterDuffColorFilter(n("profile_verifiedBackground"), PorterDuff.Mode.MULTIPLY));
                    Drawable mutate2 = getResources().getDrawable(org.telegram.mdgram.R.drawable.verified_check).mutate();
                    ...
                    this.rightDrawableContentDescription = org.telegram.messenger.u.B0("AccDescrVerified", org.telegram.mdgram.R.string.AccDescrVerified);
                    return;
                } else if (z4) {
                    ...
                    if (z6) {
                        ...
                        Drawable mutate3 = sz1.e(org.telegram.messenger.b.f12514a, org.telegram.mdgram.R.drawable.msg_premium_liststar).mutate();
                    ...
                    this.rightDrawableIsScamOrVerified = true;
                    this.rightDrawableContentDescription = org.telegram.messenger.u.B0("AccDescrPremium", org.telegram.mdgram.R.string.AccDescrPremium);
                    return;
                ...
                this.rightDrawableContentDescription = org.telegram.messenger.u.B0("ScamMessage", org.telegram.mdgram.R.string.ScamMessage);
                this.rightDrawableIsScamOrVerified = true;
                return;
            } else {
                return;
        ...
        if (!z && !z2) {
            if (z3) {
                Drawable mutate4 = getResources().getDrawable(org.telegram.mdgram.R.drawable.verified_area).mutate();
                mutate4.setColorFilter(new PorterDuffColorFilter(n("profile_verifiedBackground"), PorterDuff.Mode.MULTIPLY));
                Drawable mutate5 = getResources().getDrawable(org.telegram.mdgram.R.drawable.verified_check).mutate();
                ...
                if (z7) {
                    ...
                    Drawable mutate6 = sz1.e(org.telegram.messenger.b.f12514a, org.telegram.mdgram.R.drawable.msg_premium_liststar).mutate();
    ...
    public a0(Context context, org.telegram.ui.ActionBar.f fVar, boolean z, final l.r rVar) {
        ...
        this.avatarImageView.setContentDescription(org.telegram.messenger.u.B0("AccDescrProfilePicture", org.telegram.mdgram.R.string.AccDescrProfilePicture));
        ...
        this.backTextView.i(org.telegram.messenger.u.B0("Chats", org.telegram.mdgram.R.string.Chats));
        ...
        if (this.parentFragment != null) {
            ...
            if (this.secretChatTimer) {
                ...
                this.timeItem.setContentDescription(org.telegram.messenger.u.B0("AccAutoDeleteTimer", org.telegram.mdgram.R.string.AccAutoDeleteTimer));
            }
        }
