...
public class b0 extends ActionBarPopupWindow.ActionBarPopupWindowLayout {
    ...
    public b0(final org.telegram.ui.ActionBar.f fVar, Context context) {
        ...
        setFitItems(true);
        this.oneDay = org.telegram.ui.ActionBar.c.O(this, org.telegram.mdgram.R.drawable.msg_autodelete_1d, org.telegram.messenger.u.U("Days", 1, new Object[0]), false, null);
        this.oneWeek = org.telegram.ui.ActionBar.c.O(this, org.telegram.mdgram.R.drawable.msg_autodelete_1w, org.telegram.messenger.u.U("Weeks", 1, new Object[0]), false, null);
        this.oneMonth = org.telegram.ui.ActionBar.c.O(this, org.telegram.mdgram.R.drawable.msg_autodelete_1m, org.telegram.messenger.u.U("Months", 1, new Object[0]), false, null);
        this.forever = org.telegram.ui.ActionBar.c.O(this, org.telegram.mdgram.R.drawable.msg_cancel, org.telegram.messenger.u.B0("AutoDeleteMediaNever", org.telegram.mdgram.R.string.AutoDeleteMediaNever), false, null);
        org.telegram.ui.ActionBar.d O = org.telegram.ui.ActionBar.c.O(this, org.telegram.mdgram.R.drawable.msg_delete, org.telegram.messenger.u.B0("DeleteException", org.telegram.mdgram.R.string.DeleteException), false, null);
        this.delete = O;
        ...
        view.setBackground(org.telegram.ui.ActionBar.l.v2(context, org.telegram.mdgram.R.drawable.greydivider, "windowBackgroundGrayShadow", null));
        this.gap.addView(view, cn4.b(-1, -1.0f));
        this.gap.setTag(org.telegram.mdgram.R.id.fit_width_tag, 1);
        ...
        cVar.setText(org.telegram.messenger.u.B0("KeepMediaPopupDescription", org.telegram.mdgram.R.string.KeepMediaPopupDescription));
    ...
    public void B(int i) {
        ...
        this.exceptions = d2;
        if (d2.isEmpty()) {
            this.exceptionsView.titleView.i(org.telegram.messenger.u.B0("AddAnException", org.telegram.mdgram.R.string.AddAnException));
