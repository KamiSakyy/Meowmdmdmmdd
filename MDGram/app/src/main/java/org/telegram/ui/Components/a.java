...
public class a extends org.telegram.ui.ActionBar.g {
    ...
    public class e extends v1.s {
        ...
        public void onBindViewHolder(RecyclerView.d0 d0Var, int i) {
            ...
            if (i == 0) {
                String B0 = org.telegram.messenger.u.B0("EventLogFilterAll", org.telegram.mdgram.R.string.EventLogFilterAll);
                if (a.this.currentFilter == null) {
                    z3 = true;
                }
                pu9Var.g(B0, z3, true);
            } else if (i == a.this.restrictionsRow) {
                String B02 = org.telegram.messenger.u.B0("EventLogFilterNewRestrictions", org.telegram.mdgram.R.string.EventLogFilterNewRestrictions);
                ...
                String B03 = org.telegram.messenger.u.B0("EventLogFilterNewAdmins", org.telegram.mdgram.R.string.EventLogFilterNewAdmins);
                ...
                String B04 = org.telegram.messenger.u.B0("EventLogFilterNewMembers", org.telegram.mdgram.R.string.EventLogFilterNewMembers);
                ...
                if (a.this.isMegagroup) {
                    pu9Var.g(org.telegram.messenger.u.B0("EventLogFilterGroupInfo", org.telegram.mdgram.R.string.EventLogFilterGroupInfo), (a.this.currentFilter == null || a.this.currentFilter.j) ? true : true, true);
                } else {
                    pu9Var.g(org.telegram.messenger.u.B0("EventLogFilterChannelInfo", org.telegram.mdgram.R.string.EventLogFilterChannelInfo), (a.this.currentFilter == null || a.this.currentFilter.j) ? true : true, true);
                }
            } else if (i == a.this.deleteRow) {
                pu9Var.g(org.telegram.messenger.u.B0("EventLogFilterDeletedMessages", org.telegram.mdgram.R.string.EventLogFilterDeletedMessages), (a.this.currentFilter == null || a.this.currentFilter.n) ? true : true, true);
            } else if (i == a.this.editRow) {
                pu9Var.g(org.telegram.messenger.u.B0("EventLogFilterEditedMessages", org.telegram.mdgram.R.string.EventLogFilterEditedMessages), (a.this.currentFilter == null || a.this.currentFilter.m) ? true : true, true);
            } else if (i == a.this.pinnedRow) {
                pu9Var.g(org.telegram.messenger.u.B0("EventLogFilterPinnedMessages", org.telegram.mdgram.R.string.EventLogFilterPinnedMessages), (a.this.currentFilter == null || a.this.currentFilter.l) ? true : true, true);
            } else if (i == a.this.leavingRow) {
                String B05 = org.telegram.messenger.u.B0("EventLogFilterLeavingMembers", org.telegram.mdgram.R.string.EventLogFilterLeavingMembers);
                ...
                String B06 = org.telegram.messenger.u.B0("EventLogFilterCalls", org.telegram.mdgram.R.string.EventLogFilterCalls);
                if (a.this.currentFilter != null && !a.this.currentFilter.o) {
                    z4 = false;
                }
                pu9Var.g(B06, z4, false);
            } else if (i == a.this.invitesRow) {
                pu9Var.g(org.telegram.messenger.u.B0("EventLogFilterInvites", org.telegram.mdgram.R.string.EventLogFilterInvites), (a.this.currentFilter == null || a.this.currentFilter.p) ? true : true, true);
            } else if (i == a.this.allAdminsRow) {
                String B07 = org.telegram.messenger.u.B0("EventLogAllAdmins", org.telegram.mdgram.R.string.EventLogAllAdmins);
    ...
    public a(Context context, TLRPC$TL_channelAdminLogEventsFilter tLRPC$TL_channelAdminLogEventsFilter, j45 j45Var, boolean z) {
        ...
        this.saveButton.d(org.telegram.messenger.u.B0("Save", org.telegram.mdgram.R.string.Save).toUpperCase(), 0);
