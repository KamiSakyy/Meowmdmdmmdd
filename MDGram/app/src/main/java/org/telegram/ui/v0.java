...
public class v0 extends org.telegram.ui.ActionBar.f implements a0.d {
        ...
        public void onBindViewHolder(RecyclerView.d0 d0Var, int i) {
            ...
            if (itemViewType != 0) {
                    ...
                    if (itemViewType != 2) {
                        if (itemViewType != 3) {
                                ...
                                if (itemViewType != 5) {
                                    if (itemViewType == 7) {
                                        ...
                                        if (i == v0.this.enableRow) {
                                            ru9Var.i(org.telegram.messenger.u.B0("Notifications", org.telegram.mdgram.R.string.Notifications), v0.this.notificationsEnabled, true);
                                            return;
                                        } else if (i == v0.this.previewRow) {
                                            String n0 = rn6.n0(v0.this.dialogId, v0.this.topicId);
                                            String B0 = org.telegram.messenger.u.B0("MessagePreview", org.telegram.mdgram.R.string.MessagePreview);
                            ...
                            if (i == v0.this.popupEnabledRow) {
                                String B02 = org.telegram.messenger.u.B0("PopupEnabled", org.telegram.mdgram.R.string.PopupEnabled);
                                if (i3 == 1) {
                                    z = true;
                                }
                                y88Var.e(B02, z, true);
                                ...
                                String B03 = org.telegram.messenger.u.B0("PopupDisabled", org.telegram.mdgram.R.string.PopupDisabled);
                                if (i3 != 2) {
                                    z2 = false;
                                }
                        ...
                        textColorCell.b(org.telegram.messenger.u.B0("NotificationsLedColor", org.telegram.mdgram.R.string.NotificationsLedColor), i2, false);
                        return;
                    }
                    bv9 bv9Var = (bv9) d0Var.itemView;
                    if (i == v0.this.popupInfoRow) {
                        bv9Var.setText(org.telegram.messenger.u.B0("ProfilePopupNotificationInfo", org.telegram.mdgram.R.string.ProfilePopupNotificationInfo));
                        bv9Var.setBackground(org.telegram.ui.ActionBar.l.u2(this.context, org.telegram.mdgram.R.drawable.greydivider, "windowBackgroundGrayShadow"));
                        return;
                    } else if (i == v0.this.ledInfoRow) {
                        bv9Var.setText(org.telegram.messenger.u.B0("NotificationsLedInfo", org.telegram.mdgram.R.string.NotificationsLedInfo));
                        bv9Var.setBackground(org.telegram.ui.ActionBar.l.u2(this.context, org.telegram.mdgram.R.drawable.greydivider_bottom, "windowBackgroundGrayShadow"));
                        return;
                    } else if (i == v0.this.priorityInfoRow) {
                        if (v0.this.priorityRow == -1) {
                            bv9Var.setText("");
                        } else {
                            bv9Var.setText(org.telegram.messenger.u.B0("PriorityInfo", org.telegram.mdgram.R.string.PriorityInfo));
                        }
                        bv9Var.setBackground(org.telegram.ui.ActionBar.l.u2(this.context, org.telegram.mdgram.R.drawable.greydivider, "windowBackgroundGrayShadow"));
                        return;
                    } else if (i == v0.this.ringtoneInfoRow) {
                        bv9Var.setText(org.telegram.messenger.u.B0("VoipRingtoneInfo", org.telegram.mdgram.R.string.VoipRingtoneInfo));
                        bv9Var.setBackground(org.telegram.ui.ActionBar.l.u2(this.context, org.telegram.mdgram.R.drawable.greydivider, "windowBackgroundGrayShadow"));
                        return;
                    } else {
                        return;
                ...
                if (i == v0.this.customResetRow) {
                    uw9Var.c(org.telegram.messenger.u.z0(org.telegram.mdgram.R.string.ResetCustomNotifications), false);
                ...
                if (i == v0.this.soundRow) {
                    String string = A84.getString("sound_" + n04, org.telegram.messenger.u.B0("SoundDefault", org.telegram.mdgram.R.string.SoundDefault));
                    long j = A84.getLong("sound_document_id_" + n04, 0L);
                    if (j != 0) {
                        tm9 k = v0.this.v0().f13256a.k(j);
                        if (k == null) {
                            string = org.telegram.messenger.u.B0("CustomSound", org.telegram.mdgram.R.string.CustomSound);
                        } else {
                        ...
                        string = org.telegram.messenger.u.B0("SoundDefault", org.telegram.mdgram.R.string.SoundDefault);
                    }
                    uw9Var.d(org.telegram.messenger.u.B0("Sound", org.telegram.mdgram.R.string.Sound), string, true);
                    return;
                } else if (i == v0.this.ringtoneRow) {
                    String string2 = A84.getString("ringtone_" + n04, org.telegram.messenger.u.B0("DefaultRingtone", org.telegram.mdgram.R.string.DefaultRingtone));
                    if (string2.equals("NoSound")) {
                        string2 = org.telegram.messenger.u.B0("NoSound", org.telegram.mdgram.R.string.NoSound);
                    }
                    uw9Var.d(org.telegram.messenger.u.B0("VoipSettingsRingtone", org.telegram.mdgram.R.string.VoipSettingsRingtone), string2, false);
                    return;
                } else if (i == v0.this.vibrateRow) {
                    int i5 = A84.getInt("vibrate_" + n04, 0);
                    if (i5 != 0 && i5 != 4) {
                        if (i5 == 1) {
                            uw9Var.d(org.telegram.messenger.u.B0("Vibrate", org.telegram.mdgram.R.string.Vibrate), org.telegram.messenger.u.B0("Short", org.telegram.mdgram.R.string.Short), (v0.this.smartRow == -1 && v0.this.priorityRow == -1) ? true : true);
                            return;
                        } else if (i5 == 2) {
                            uw9Var.d(org.telegram.messenger.u.B0("Vibrate", org.telegram.mdgram.R.string.Vibrate), org.telegram.messenger.u.B0("VibrationDisabled", org.telegram.mdgram.R.string.VibrationDisabled), (v0.this.smartRow == -1 && v0.this.priorityRow == -1) ? true : true);
                            return;
                        } else if (i5 == 3) {
                            uw9Var.d(org.telegram.messenger.u.B0("Vibrate", org.telegram.mdgram.R.string.Vibrate), org.telegram.messenger.u.B0("Long", org.telegram.mdgram.R.string.Long), (v0.this.smartRow == -1 && v0.this.priorityRow == -1) ? true : true);
                            return;
                        } else {
                            return;
                        }
                    }
                    uw9Var.d(org.telegram.messenger.u.B0("Vibrate", org.telegram.mdgram.R.string.Vibrate), org.telegram.messenger.u.B0("VibrationDefault", org.telegram.mdgram.R.string.VibrationDefault), (v0.this.smartRow == -1 && v0.this.priorityRow == -1) ? true : true);
                    return;
                } else if (i == v0.this.priorityRow) {
                    int i6 = A84.getInt("priority_" + n04, 3);
                    if (i6 == 0) {
                        uw9Var.d(org.telegram.messenger.u.B0("NotificationsImportance", org.telegram.mdgram.R.string.NotificationsImportance), org.telegram.messenger.u.B0("NotificationsPriorityHigh", org.telegram.mdgram.R.string.NotificationsPriorityHigh), false);
                        return;
                    } else if (i6 != 1 && i6 != 2) {
                        if (i6 == 3) {
                            uw9Var.d(org.telegram.messenger.u.B0("NotificationsImportance", org.telegram.mdgram.R.string.NotificationsImportance), org.telegram.messenger.u.B0("NotificationsPrioritySettings", org.telegram.mdgram.R.string.NotificationsPrioritySettings), false);
                            return;
                        } else if (i6 == 4) {
                            uw9Var.d(org.telegram.messenger.u.B0("NotificationsImportance", org.telegram.mdgram.R.string.NotificationsImportance), org.telegram.messenger.u.B0("NotificationsPriorityLow", org.telegram.mdgram.R.string.NotificationsPriorityLow), false);
                            return;
                        } else if (i6 == 5) {
                            uw9Var.d(org.telegram.messenger.u.B0("NotificationsImportance", org.telegram.mdgram.R.string.NotificationsImportance), org.telegram.messenger.u.B0("NotificationsPriorityMedium", org.telegram.mdgram.R.string.NotificationsPriorityMedium), false);
                            return;
                        } else {
                            return;
                        }
                    } else {
                        uw9Var.d(org.telegram.messenger.u.B0("NotificationsImportance", org.telegram.mdgram.R.string.NotificationsImportance), org.telegram.messenger.u.B0("NotificationsPriorityUrgent", org.telegram.mdgram.R.string.NotificationsPriorityUrgent), false);
                        return;
                    }
                    ...
                    if (i7 == 0) {
                        String B04 = org.telegram.messenger.u.B0("SmartNotifications", org.telegram.mdgram.R.string.SmartNotifications);
                        String B05 = org.telegram.messenger.u.B0("SmartNotificationsDisabled", org.telegram.mdgram.R.string.SmartNotificationsDisabled);
                        if (v0.this.priorityRow != -1) {
                            z = true;
                        }
                        uw9Var.d(B04, B05, z);
                    ...
                    String B06 = org.telegram.messenger.u.B0("SmartNotifications", org.telegram.mdgram.R.string.SmartNotifications);
                    String d0 = org.telegram.messenger.u.d0("SmartNotificationsInfo", org.telegram.mdgram.R.string.SmartNotificationsInfo, Integer.valueOf(i7), U);
                    if (v0.this.priorityRow != -1) {
                        z = true;
                    }
                    uw9Var.d(B06, d0, z);
                    ...
                    if (i9 != 0 && i9 != 4) {
                        if (i9 == 1) {
                            uw9Var.d(org.telegram.messenger.u.B0("Vibrate", org.telegram.mdgram.R.string.Vibrate), org.telegram.messenger.u.B0("Short", org.telegram.mdgram.R.string.Short), true);
                            return;
                        } else if (i9 == 2) {
                            uw9Var.d(org.telegram.messenger.u.B0("Vibrate", org.telegram.mdgram.R.string.Vibrate), org.telegram.messenger.u.B0("VibrationDisabled", org.telegram.mdgram.R.string.VibrationDisabled), true);
                            return;
                        } else if (i9 == 3) {
                            uw9Var.d(org.telegram.messenger.u.B0("Vibrate", org.telegram.mdgram.R.string.Vibrate), org.telegram.messenger.u.B0("Long", org.telegram.mdgram.R.string.Long), true);
                            return;
                        } else {
                            return;
                        }
                    }
                    uw9Var.d(org.telegram.messenger.u.B0("Vibrate", org.telegram.mdgram.R.string.Vibrate), org.telegram.messenger.u.B0("VibrationDefault", org.telegram.mdgram.R.string.VibrationDefault), true);
                    return;
                } else {
                    return;
                }
            ...
            if (i == v0.this.generalRow) {
                nu3Var.setText(org.telegram.messenger.u.B0("General", org.telegram.mdgram.R.string.General));
            } else if (i == v0.this.popupRow) {
                nu3Var.setText(org.telegram.messenger.u.B0("ProfilePopupNotification", org.telegram.mdgram.R.string.ProfilePopupNotification));
            } else if (i == v0.this.ledRow) {
                nu3Var.setText(org.telegram.messenger.u.B0("NotificationsLed", org.telegram.mdgram.R.string.NotificationsLed));
    ...
    public /* synthetic */ void r3(Context context, final String str, View view, int i) {
        ...
        if (i == this.customResetRow) {
            org.telegram.ui.ActionBar.e a2 = new e.k(context, this.resourcesProvider).x(org.telegram.messenger.u.z0(org.telegram.mdgram.R.string.ResetCustomNotificationsAlertTitle)).n(org.telegram.messenger.u.z0(org.telegram.mdgram.R.string.ResetCustomNotificationsAlert)).v(org.telegram.messenger.u.z0(org.telegram.mdgram.R.string.Reset), new DialogInterface.OnClickListener() { // from class: qz7
    ...
    public View W(final Context context) {
        ...
        if (this.addingException) {
            this.avatarContainer.setSubtitle(org.telegram.messenger.u.B0("NotificationsNewException", org.telegram.mdgram.R.string.NotificationsNewException));
            this.actionBar.x().h(1, org.telegram.messenger.u.B0("Done", org.telegram.mdgram.R.string.Done).toUpperCase());
        } else {
            this.avatarContainer.setSubtitle(org.telegram.messenger.u.B0("CustomNotifications", org.telegram.mdgram.R.string.CustomNotifications));
        }
