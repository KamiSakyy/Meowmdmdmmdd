...
public class d0 extends org.telegram.ui.ActionBar.f implements a0.d {
    ...
    public class c extends du4 {
        ...
        public void notifyDataSetChanged() {
            ...
            if (d0.this.emptySubtitleTextView != null) {
                d0.this.emptySubtitleTextView.setText(org.telegram.messenger.a.b3(org.telegram.messenger.u.d0("NoPlacesFoundInfo", org.telegram.mdgram.R.string.NoPlacesFoundInfo, d0.this.searchAdapter.m())));
            }
    ...
    public class r extends FrameLayout {
        ...
        public void c(sx3.l lVar) {
            ...
            if (tVar != null && d0.this.lastPressedVenue != tVar) {
                ...
                d0.this.lastPressedMarkerView.setBackgroundResource(org.telegram.mdgram.R.drawable.venue_tooltip);
    ...
    public /* synthetic */ void G4(v.d dVar) {
        this.proximityButton.setImageResource(org.telegram.mdgram.R.drawable.msg_location_alert2);
        Z3(dVar.e);
        this.canUndo = false;
    }
    ...
    public /* synthetic */ void H4(View view) {
        if (E0() != null && this.myLocation != null && Y3() && this.map != null) {
            ...
            if (Z != null && Z.e > 0) {
                this.proximityButton.setImageResource(org.telegram.mdgram.R.drawable.msg_location_alert);
    ...
    public /* synthetic */ boolean Z4(final mq9 mq9Var, boolean z, final int i2) {
        if (t0().Z(this.dialogId) == null) {
            e.k kVar = new e.k(E0());
            kVar.x(org.telegram.messenger.u.B0("ShareLocationAlertTitle", org.telegram.mdgram.R.string.ShareLocationAlertTitle));
            kVar.n(org.telegram.messenger.u.B0("ShareLocationAlertText", org.telegram.mdgram.R.string.ShareLocationAlertText));
            kVar.v(org.telegram.messenger.u.B0("ShareLocationAlertButton", org.telegram.mdgram.R.string.ShareLocationAlertButton), new DialogInterface.OnClickListener() { // from class: nt4
    ...
    public /* synthetic */ boolean m4(Context context, View view, int i2) {
        if (this.locationType == 2) {
            ...
            if (item instanceof p) {
                ...
                dVar.f(org.telegram.messenger.u.B0("GetDirections", org.telegram.mdgram.R.string.GetDirections), org.telegram.mdgram.R.drawable.navigate);
    ...
    */
            ...
            try {
                ...
                if (b4 != null) {
                    ...
                    if (!xla.l(pVar.user)) {
                        ...
                        if (i2 != 0) {
                            o2.e(i2);
                            pVar.directionMarker.c(org.telegram.mdgram.R.drawable.map_pin_cone2);
                            pVar.hasRotation = true;
                        } else {
                            o2.e(0);
                            pVar.directionMarker.c(org.telegram.mdgram.R.drawable.map_pin_circle);
    ...
    public final p X3(TLRPC$TL_channelLocation tLRPC$TL_channelLocation) {
        ...
        try {
            ...
            if (b4 != null) {
                ...
                if (!xla.l(pVar.user)) {
                    sx3.m b2 = org.telegram.messenger.b.m().d().a(qVar).b(true);
                    b2.f(org.telegram.mdgram.R.drawable.map_pin_circle);
                    b2.e(0.5f, 0.5f);
    ...
    public final boolean Y3() {
        ...
        try {
            if (!((LocationManager) org.telegram.messenger.b.f12514a.getSystemService("location")).isProviderEnabled("gps")) {
                ...
                kVar.v(org.telegram.messenger.u.B0("ConnectingToProxyEnable", org.telegram.mdgram.R.string.ConnectingToProxyEnable), new DialogInterface.OnClickListener() { // from class: jt4
                    @Override // android.content.DialogInterface.OnClickListener
    ...
    public final Bitmap b4(p pVar) {
        ...
        try {
            ...
            Canvas canvas = new Canvas(createBitmap);
            Drawable drawable = org.telegram.messenger.b.f12514a.getResources().getDrawable(org.telegram.mdgram.R.drawable.map_pin_photo);
    ...
    public final void e5() {
        ...
        if (imageView != null && imageView.getVisibility() == 0 && !this.proximityAnimationInProgress && (i2 = (g8 = org.telegram.messenger.y.g8()).getInt("proximityhint", 0)) < 3) {
            ...
            if (ic2.k(this.dialogId)) {
                this.hintView.setOverrideText(org.telegram.messenger.u.d0("ProximityTooltioUser", org.telegram.mdgram.R.string.ProximityTooltioUser, xla.a(x0().R8(Long.valueOf(this.dialogId)))));
            } else {
                this.hintView.setOverrideText(org.telegram.messenger.u.B0("ProximityTooltioGroup", org.telegram.mdgram.R.string.ProximityTooltioGroup));
            }
        ...
        if (tLRPC$TL_channelLocation != null) {
            ...
            if (xVar != null) {
                if (xVar.E2()) {
                    ...
                    try {
                        this.map.o(org.telegram.messenger.b.m().d().a(qVar).f(org.telegram.mdgram.R.drawable.map_pin2));
                    } catch (Exception e2) {
                        org.telegram.messenger.l.p(e2);
                    }
    ...
    public final void w5(boolean z) {
        ...
        kVar.y(org.telegram.mdgram.R.raw.permission_request_location, 72, false, org.telegram.ui.ActionBar.l.B1("dialogTopBackground"));
        if (z) {
            kVar.n(org.telegram.messenger.a.b3(org.telegram.messenger.u.B0("PermissionNoLocationNavigation", org.telegram.mdgram.R.string.PermissionNoLocationNavigation)));
        } else {
            kVar.n(org.telegram.messenger.a.b3(org.telegram.messenger.u.B0("PermissionNoLocationFriends", org.telegram.mdgram.R.string.PermissionNoLocationFriends)));
        }
        kVar.p(org.telegram.messenger.u.B0("PermissionOpenSettings", org.telegram.mdgram.R.string.PermissionOpenSettings), new DialogInterface.OnClickListener() { // from class: it4
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i2) {
