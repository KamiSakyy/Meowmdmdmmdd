...
public class d extends org.telegram.ui.ActionBar.f {
    ...
    public class b extends j5 {
        ...
        public void onBindViewHolder(RecyclerView.d0 d0Var, int i) {
            ...
            if (d.this.items.get(i).viewType == 2) {
                ...
                if (U8 instanceof mq9) {
                    mq9 mq9Var = (mq9) U8;
                    if (mq9Var.f10563a) {
                        str = org.telegram.messenger.u.B0("SavedMessages", org.telegram.mdgram.R.string.SavedMessages);
                    } else {
        ...
        public RecyclerView.d0 onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            if (i != 1) {
                if (i != 2) {
                    if (i != 3) {
                        if (i == 4) {
                            ...
                            pu9Var2.f(org.telegram.messenger.u.B0("NotificationsDeleteAllException", org.telegram.mdgram.R.string.NotificationsDeleteAllException), false);
                ...
                pu9Var3.i(org.telegram.messenger.u.B0("NotificationsAddAnException", org.telegram.mdgram.R.string.NotificationsAddAnException), org.telegram.mdgram.R.drawable.msg_contact_add, true);
    ...
    public /* synthetic */ void s2(View view, int i, float f, float f2) {
        if (this.items.get(i).viewType == 1) {
            ...
            org.telegram.ui.ActionBar.e a2 = org.telegram.ui.Components.b.H2(k0(), org.telegram.messenger.u.B0("NotificationsDeleteAllExceptionTitle", org.telegram.mdgram.R.string.NotificationsDeleteAllExceptionTitle), org.telegram.messenger.u.B0("NotificationsDeleteAllExceptionAlert", org.telegram.mdgram.R.string.NotificationsDeleteAllExceptionAlert), org.telegram.messenger.u.B0("Delete", org.telegram.mdgram.R.string.Delete), new Runnable() { // from class: g90
    ...
    public View W(Context context) {
        ...
        this.actionBar.setTitle(org.telegram.messenger.u.z0(org.telegram.mdgram.R.string.NotificationsExceptions));
