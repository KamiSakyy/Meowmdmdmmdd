...
public class p3 extends View {
    ...
    public p3(Context context) {
        ...
        this.minusDrawable = context.getResources().getDrawable(org.telegram.mdgram.R.drawable.zoom_minus);
        this.plusDrawable = context.getResources().getDrawable(org.telegram.mdgram.R.drawable.zoom_plus);
        this.progressDrawable = context.getResources().getDrawable(org.telegram.mdgram.R.drawable.zoom_slide);
        this.filledProgressDrawable = context.getResources().getDrawable(org.telegram.mdgram.R.drawable.zoom_slide_a);
        this.knobDrawable = context.getResources().getDrawable(org.telegram.mdgram.R.drawable.zoom_round);
        this.pressedKnobDrawable = context.getResources().getDrawable(org.telegram.mdgram.R.drawable.zoom_round_b);
    }
