...
public class a1 extends org.telegram.ui.ActionBar.f implements a0.d {
    ...
    public class e implements h.InterfaceC0118h {
        ...
        public /* synthetic */ void j() {
            ...
            if (str2 != null && str2.equals("AUTH_TOKEN_EXCEPTION")) {
                str = org.telegram.messenger.u.B0("AccountAlreadyLoggedIn", org.telegram.mdgram.R.string.AccountAlreadyLoggedIn);
            } else {
                str = org.telegram.messenger.u.B0("ErrorOccurred", org.telegram.mdgram.R.string.ErrorOccurred) + "\n" + this.error.f14225a;
            }
            org.telegram.ui.Components.b.V5(a1.this, org.telegram.messenger.u.B0("AuthAnotherClient", org.telegram.mdgram.R.string.AuthAnotherClient), str);
        }
        ...
        public /* synthetic */ void m() {
            org.telegram.ui.Components.b.V5(a1.this, org.telegram.messenger.u.B0("AuthAnotherClient", org.telegram.mdgram.R.string.AuthAnotherClient), org.telegram.messenger.u.B0("ErrorOccurred", org.telegram.mdgram.R.string.ErrorOccurred));
        }
        ...
        public void onBindViewHolder(RecyclerView.d0 d0Var, int i) {
            ...
            if (itemViewType != 0) {
                if (itemViewType != 1) {
                    if (itemViewType != 2) {
                        if (itemViewType != 5) {
                            ...
                            uw9Var.e(org.telegram.messenger.u.B0("IfInactiveFor", org.telegram.mdgram.R.string.IfInactiveFor), U, true, false);
                            return;
                        }
                        return;
                    }
                    ...
                    if (i == a1.this.currentSessionSectionRow) {
                        nu3Var.setText(org.telegram.messenger.u.B0("CurrentSession", org.telegram.mdgram.R.string.CurrentSession));
                        return;
                    } else if (i == a1.this.otherSessionsSectionRow) {
                        if (a1.this.currentType == 0) {
                            nu3Var.setText(org.telegram.messenger.u.B0("OtherSessions", org.telegram.mdgram.R.string.OtherSessions));
                            return;
                        } else {
                            nu3Var.setText(org.telegram.messenger.u.B0("OtherWebSessions", org.telegram.mdgram.R.string.OtherWebSessions));
                            return;
                        }
                    } else if (i == a1.this.passwordSessionsSectionRow) {
                        nu3Var.setText(org.telegram.messenger.u.B0("LoginAttempts", org.telegram.mdgram.R.string.LoginAttempts));
                        return;
                    } else if (i == a1.this.ttlHeaderRow) {
                        nu3Var.setText(org.telegram.messenger.u.B0("TerminateOldSessionHeader", org.telegram.mdgram.R.string.TerminateOldSessionHeader));
                        return;
                    } else {
                        return;
                    }
                ...
                if (i == a1.this.terminateAllSessionsDetailRow) {
                    if (a1.this.currentType == 0) {
                        bv9Var.setText(org.telegram.messenger.u.B0("ClearOtherSessionsHelp", org.telegram.mdgram.R.string.ClearOtherSessionsHelp));
                    } else {
                        bv9Var.setText(org.telegram.messenger.u.B0("ClearOtherWebSessionsHelp", org.telegram.mdgram.R.string.ClearOtherWebSessionsHelp));
                    }
                    ...
                    if (a1.this.currentType == 0) {
                        if (a1.this.sessions.isEmpty()) {
                            ...
                            bv9Var.setText(org.telegram.messenger.u.B0("SessionsListInfo", org.telegram.mdgram.R.string.SessionsListInfo));
                        }
                    } else {
                        bv9Var.setText(org.telegram.messenger.u.B0("TerminateWebSessionInfo", org.telegram.mdgram.R.string.TerminateWebSessionInfo));
                    }
                    ...
                    bv9Var.setText(org.telegram.messenger.u.B0("LoginAttemptsInfo", org.telegram.mdgram.R.string.LoginAttemptsInfo));
            ...
            if (i == a1.this.terminateAllSessionsRow) {
                ...
                if (a1.this.currentType == 0) {
                    pu9Var.i(org.telegram.messenger.u.B0("TerminateAllSessions", org.telegram.mdgram.R.string.TerminateAllSessions), org.telegram.mdgram.R.drawable.msg_block2, false);
                } else {
                    pu9Var.i(org.telegram.messenger.u.B0("TerminateAllWebSessions", org.telegram.mdgram.R.string.TerminateAllWebSessions), org.telegram.mdgram.R.drawable.msg_block2, false);
                }
            } else if (i == a1.this.qrCodeRow) {
                pu9Var.c("windowBackgroundWhiteBlueText4", "windowBackgroundWhiteBlueText4");
                pu9Var.setTag("windowBackgroundWhiteBlueText4");
                pu9Var.i(org.telegram.messenger.u.B0("AuthAnotherClient", org.telegram.mdgram.R.string.AuthAnotherClient), org.telegram.mdgram.R.drawable.msg_qrcode, true ^ a1.this.sessions.isEmpty());
            }
        }
    ...
    public class h extends FrameLayout implements a0.d {
        ...
        public h(Context context) {
            ...
            String B0 = org.telegram.messenger.u.B0("AuthAnotherClientInfo4", org.telegram.mdgram.R.string.AuthAnotherClientInfo4);
            ...
            if (indexOf != -1 && indexOf2 != -1 && indexOf != indexOf2) {
                ...
                spannableStringBuilder.setSpan(new c3(org.telegram.messenger.u.B0("AuthAnotherClientDownloadClientUrl", org.telegram.mdgram.R.string.AuthAnotherClientDownloadClientUrl)), indexOf, indexOf2 - 1, 33);
            }
            ...
            if (indexOf3 != -1 && indexOf4 != -1 && indexOf3 != indexOf4) {
                ...
                spannableStringBuilder.setSpan(new c3(org.telegram.messenger.u.B0("AuthAnotherWebClientUrl", org.telegram.mdgram.R.string.AuthAnotherWebClientUrl)), indexOf3, indexOf4 - 1, 33);
            }
            ...
            spannableStringBuilder3.append((CharSequence) ".  ").append((CharSequence) org.telegram.messenger.u.B0("LinkDesktopDevice", org.telegram.mdgram.R.string.LinkDesktopDevice));
            spannableStringBuilder3.setSpan(new kq1(sz1.e(getContext(), org.telegram.mdgram.R.drawable.msg_mini_qr)), 0, 1, 0);
    ...
    public /* synthetic */ void A3(TLRPC$TL_error tLRPC$TL_error, org.telegram.tgnet.a aVar) {
        ...
        if (tLRPC$TL_error == null && (aVar instanceof TLRPC$TL_boolTrue)) {
            org.telegram.ui.Components.q.p0(this).T(org.telegram.mdgram.R.raw.contact_check, org.telegram.messenger.u.B0("AllWebSessionsTerminated", org.telegram.mdgram.R.string.AllWebSessionsTerminated)).T();
        } else {
    ...
    public /* synthetic */ void x3(View view, final int i) {
        ...
        if (i == this.ttlRow) {
            ...
            kVar.x(org.telegram.messenger.u.B0("SessionsSelfDestruct", org.telegram.mdgram.R.string.SessionsSelfDestruct));
            ...
            if (this.currentType == 0) {
                kVar2.n(org.telegram.messenger.u.B0("AreYouSureSessions", org.telegram.mdgram.R.string.AreYouSureSessions));
                kVar2.x(org.telegram.messenger.u.B0("AreYouSureSessionsTitle", org.telegram.mdgram.R.string.AreYouSureSessionsTitle));
                B0 = org.telegram.messenger.u.B0("Terminate", org.telegram.mdgram.R.string.Terminate);
            } else {
                kVar2.n(org.telegram.messenger.u.B0("AreYouSureWebSessions", org.telegram.mdgram.R.string.AreYouSureWebSessions));
                kVar2.x(org.telegram.messenger.u.B0("TerminateWebSessionsTitle", org.telegram.mdgram.R.string.TerminateWebSessionsTitle));
                B0 = org.telegram.messenger.u.B0("Disconnect", org.telegram.mdgram.R.string.Disconnect);
            }
            ...
            if (this.currentType == 0) {
                kVar3.n(org.telegram.messenger.u.B0("TerminateSessionText", org.telegram.mdgram.R.string.TerminateSessionText));
                kVar3.x(org.telegram.messenger.u.B0("AreYouSureSessionTitle", org.telegram.mdgram.R.string.AreYouSureSessionTitle));
                charSequence = org.telegram.messenger.u.B0("Terminate", org.telegram.mdgram.R.string.Terminate);
            } else {
                ...
                kVar3.n(org.telegram.messenger.u.d0("TerminateWebSessionText", org.telegram.mdgram.R.string.TerminateWebSessionText, tLRPC$TL_webAuthorization.f15452a));
                kVar3.x(org.telegram.messenger.u.B0("TerminateWebSessionTitle", org.telegram.mdgram.R.string.TerminateWebSessionTitle));
                CharSequence B02 = org.telegram.messenger.u.B0("Disconnect", org.telegram.mdgram.R.string.Disconnect);
                ...
                dl1Var.h(org.telegram.messenger.u.d0("TerminateWebSessionStop", org.telegram.mdgram.R.string.TerminateWebSessionStop, str), "", false, false);
    ...
    public /* synthetic */ void y3(TLRPC$TL_error tLRPC$TL_error, org.telegram.tgnet.a aVar) {
        if (E0() != null && tLRPC$TL_error == null && (aVar instanceof TLRPC$TL_boolTrue)) {
            org.telegram.ui.Components.q.p0(this).T(org.telegram.mdgram.R.raw.contact_check, org.telegram.messenger.u.B0("AllSessionsTerminated", org.telegram.mdgram.R.string.AllSessionsTerminated)).T();
            J3(false);
        }
    }
    ...
    public View W(Context context) {
        ...
        if (this.currentType == 0) {
            this.actionBar.setTitle(org.telegram.messenger.u.B0("Devices", org.telegram.mdgram.R.string.Devices));
        } else {
            this.actionBar.setTitle(org.telegram.messenger.u.B0("WebSessionsTitle", org.telegram.mdgram.R.string.WebSessionsTitle));
        }
