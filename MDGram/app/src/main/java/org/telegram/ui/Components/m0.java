...
public class m0 {
    ...
    public class a implements c {
        public final /* synthetic */ MediaController.y val$lastState;

        public a(MediaController.y yVar) {
            this.val$lastState = yVar;
        }

        @Override // org.telegram.ui.Components.m0.c
        public boolean a() {
            return !this.val$lastState.f12400a.b();
        }

        @Override // org.telegram.ui.Components.m0.c
        public ByteBuffer b() {
            this.val$lastState.f12400a.a();
            return this.val$lastState.f12400a.curveBuffer;
        }
        ...
        public float getBlurAngle() {
            return this.val$lastState.o;
        }

        @Override // org.telegram.ui.Components.m0.c
        public float getBlurExcludeBlurSize() {
            return this.val$lastState.n;
        }

        @Override // org.telegram.ui.Components.m0.c
        public lk7 getBlurExcludePoint() {
            return this.val$lastState.f12399a;
        }

        @Override // org.telegram.ui.Components.m0.c
        public float getBlurExcludeSize() {
            return this.val$lastState.m;
        }

        @Override // org.telegram.ui.Components.m0.c
        public int getBlurType() {
            return this.val$lastState.f12402c;
        }

        @Override // org.telegram.ui.Components.m0.c
        public float getContrastValue() {
            return ((this.val$lastState.d / 100.0f) * 0.3f) + 1.0f;
        }

        @Override // org.telegram.ui.Components.m0.c
        public float getEnhanceValue() {
            return this.val$lastState.a / 100.0f;
        }

        @Override // org.telegram.ui.Components.m0.c
        public float getExposureValue() {
            return this.val$lastState.c / 100.0f;
        }

        @Override // org.telegram.ui.Components.m0.c
        public float getFadeValue() {
            return this.val$lastState.g / 100.0f;
        }

        @Override // org.telegram.ui.Components.m0.c
        public float getGrainValue() {
            return (this.val$lastState.k / 100.0f) * 0.04f;
        }

        @Override // org.telegram.ui.Components.m0.c
        public float getHighlightsValue() {
            return ((this.val$lastState.h * 0.75f) + 100.0f) / 100.0f;
        }

        @Override // org.telegram.ui.Components.m0.c
        public float getSaturationValue() {
            float f = this.val$lastState.f / 100.0f;
            if (f > 0.0f) {
                f *= 1.05f;
            }
            return f + 1.0f;
        ...
        public float getShadowsValue() {
            return ((this.val$lastState.i * 0.55f) + 100.0f) / 100.0f;
        }

        @Override // org.telegram.ui.Components.m0.c
        public float getSharpenValue() {
            return ((this.val$lastState.l / 100.0f) * 0.6f) + 0.11f;
        }

        @Override // org.telegram.ui.Components.m0.c
        public float getSoftenSkinValue() {
            return this.val$lastState.b / 100.0f;
        }

        @Override // org.telegram.ui.Components.m0.c
        public int getTintHighlightsColor() {
            return this.val$lastState.f12401b;
        }

        @Override // org.telegram.ui.Components.m0.c
        public float getTintHighlightsIntensityValue() {
            return this.val$lastState.f12401b == 0 ? 0.0f : 0.5f;
        }

        @Override // org.telegram.ui.Components.m0.c
        public int getTintShadowsColor() {
            return this.val$lastState.f12398a;
        }

        @Override // org.telegram.ui.Components.m0.c
        public float getTintShadowsIntensityValue() {
            return this.val$lastState.f12398a == 0 ? 0.0f : 0.5f;
        }

        @Override // org.telegram.ui.Components.m0.c
        public float getVignetteValue() {
            return this.val$lastState.j / 100.0f;
        }

        @Override // org.telegram.ui.Components.m0.c
        public float getWarmthValue() {
            return this.val$lastState.e / 100.0f;
        }
    }
    ...
    public static class b {
        ...
        public b(float f, float f2, boolean z) {
            ...
            this.fragmentShaderCode = m0.j(i, f2);
            this.vertexShaderCode = m0.x(i, f2);
        }

        public boolean a() {
            int r = m0.r(35633, this.vertexShaderCode);
            int r2 = m0.r(35632, this.fragmentShaderCode);
            if (r == 0 || r2 == 0) {
                return false;
            }
            ...
            GLES20.glAttachShader(this.blurShaderProgram, r2);
    ...
    public static class d {
        ...
        public d() {
            ...
            this.rgbCompositeCurve = b(arrayList2);
            float[] b = b(arrayList);
            this.blueCurve = b;
            this.greenCurve = b;
            this.redCurve = b;
        ...
        public final float[] b(ArrayList arrayList) {
            ...
            float f = ((PointF) d.get(0)).x;
            if (f > 0.0f) {
                for (int i2 = (int) f; i2 >= 0; i2--) {
                    d.add(0, new PointF(i2, 0.0f));
                }
            }
            float f2 = ((PointF) d.get(d.size() - 1)).x;
            if (f2 < 255.0f) {
                int i3 = (int) f2;
                while (true) {
                    i3++;
                    ...
                    d.add(new PointF(i3, 255.0f));
                }
            }
            float[] fArr = new float[d.size()];
            int size2 = d.size();
            for (int i4 = 0; i4 < size2; i4++) {
                PointF pointF2 = (PointF) d.get(i4);
        ...
        public final double[] c(ArrayList arrayList) {
            int i;
            int size = arrayList.size();
            if (size > 0) {
                char c = 1;
            ...
            while (i < length - 1) {
                ...
                while (true) {
                    ...
                    if (i3 < ((int) f2)) {
                        ...
                        int i5 = i2;
                        float f5 = (float) ((pointF.y * d2) + (pointF2.y * d) + (((d3 * d3) / 6.0d) * (((((d2 * d2) * d2) - d2) * c[i]) + ((((d * d) * d) - d) * c[i5]))));
                        if (f5 > 255.0f) {
                            f5 = 255.0f;
                        } else if (f5 < 0.0f) {
                            f5 = 0.0f;
    ...
    public static String j(int i, float f) {
        ...
        while (true) {
            ...
            double d2 = f;
            float sqrt = (float) ((1.0d / Math.sqrt(Math.pow(d2, 2.0d) * 6.283185307179586d)) * Math.exp((-Math.pow(i3, 2.0d)) / (Math.pow(d2, 2.0d) * 2.0d)));
            fArr[i3] = sqrt;
            if (i3 == 0) {
                f2 += sqrt;
            } else {
                f2 = (float) (f2 + (sqrt * 2.0d));
            }
            i3++;
        }
    ...
    public static c k(MediaController.y yVar) {
        return new a(yVar);
    }
    ...
    public static int r(int i, String str) {
        ...
        if (iArr[0] == 0) {
            if (s60.f18613b) {
                ...
                org.telegram.messenger.l.n("shader code:\n " + str);
            }
    ...
    public static String x(int i, float f) {
        int i2;
        float[] fArr = new float[(i * 2) + 1];
        float f2 = 0.0f;
        int i3 = 0;
        ...
        if (r4 != 0 && r5 != 0) {
            ...
            if (r6 != 0 && r7 != 0) {
                ...
                if (r8 != 0 && r9 != 0) {
                    ...
                    int r10 = r(35633, "attribute vec4 position;attribute vec2 inputTexCoord;varying vec2 texCoord;void main() {gl_Position = position;texCoord = inputTexCoord;}");
                    int r11 = r(35632, "varying highp vec2 texCoord;uniform sampler2D sourceImage;uniform sampler2D inputImageTexture2;uniform lowp float excludeSize;uniform lowp vec2 excludePoint;uniform lowp float excludeBlurSize;uniform highp float aspectRatio;void main() {lowp vec4 sharpImageColor = texture2D(sourceImage, texCoord);lowp vec4 blurredImageColor = texture2D(inputImageTexture2, texCoord);highp vec2 texCoordToUse = vec2(texCoord.x, (texCoord.y * aspectRatio + 0.5 - 0.5 * aspectRatio));highp float distanceFromCenter = distance(excludePoint, texCoordToUse);gl_FragColor = mix(sharpImageColor, blurredImageColor, smoothstep(excludeSize - excludeBlurSize, excludeSize, distanceFromCenter));}");
                    if (r10 != 0 && r11 != 0) {
                        int glCreateProgram4 = GLES20.glCreateProgram();
                        this.radialBlurShaderProgram = glCreateProgram4;
                        GLES20.glAttachShader(glCreateProgram4, r10);
                        GLES20.glAttachShader(this.radialBlurShaderProgram, r11);
                        ...
                        while (true) {
                            ...
                            if (i3 < i) {
                                if (i3 == 1 && z2) {
                                    int r12 = r(35633, "attribute vec4 position;uniform mat4 videoMatrix;attribute vec4 inputTexCoord;varying vec2 texCoord;void main() {gl_Position = position;texCoord = vec2(videoMatrix * inputTexCoord).xy;}");
                                    Locale locale = Locale.US;
                                    str4 = str5;
                                    Object[] objArr = new Object[2];
                                    objArr[c2] = str;
                                    objArr[1] = str2;
                                    r3 = r(35632, String.format(locale, "%1$s\nprecision highp float;varying vec2 texCoord;uniform %2$s sourceImage;vec3 rgb_to_hsv(vec3 c) {vec4 K = vec4(0.0, -1.0 / 3.0, 2.0 / 3.0, -1.0);vec4 p = c.g < c.b ? vec4(c.bg, K.wz) : vec4(c.gb, K.xy);vec4 q = c.r < p.x ? vec4(p.xyw, c.r) : vec4(c.r, p.yzx);float d = q.x - min(q.w, q.y);float e = 1.0e-10;return vec3(abs(q.z + (q.w - q.y) / (6.0 * d + e)), d / (q.x + e), q.x);}void main() {vec4 texel = texture2D(sourceImage, texCoord);gl_FragColor = vec4(rgb_to_hsv(texel.rgb), texel.a);}", objArr));
                                    i2 = r12;
                                } else {
                                    str4 = str5;
                                    int r13 = r(35633, "attribute vec4 position;attribute vec2 inputTexCoord;varying vec2 texCoord;void main() {gl_Position = position;texCoord = inputTexCoord;}");
                                    r3 = r(35632, String.format(Locale.US, "%1$s\nprecision highp float;varying vec2 texCoord;uniform %2$s sourceImage;vec3 rgb_to_hsv(vec3 c) {vec4 K = vec4(0.0, -1.0 / 3.0, 2.0 / 3.0, -1.0);vec4 p = c.g < c.b ? vec4(c.bg, K.wz) : vec4(c.gb, K.xy);vec4 q = c.r < p.x ? vec4(p.xyw, c.r) : vec4(c.r, p.yzx);float d = q.x - min(q.w, q.y);float e = 1.0e-10;return vec3(abs(q.z + (q.w - q.y) / (6.0 * d + e)), d / (q.x + e), q.x);}void main() {vec4 texel = texture2D(sourceImage, texCoord);gl_FragColor = vec4(rgb_to_hsv(texel.rgb), texel.a);}", "", "sampler2D"));
                                    i2 = r13;
                                }
                                if (i2 != 0 && r3 != 0) {
                                    this.rgbToHsvShaderProgram[i3] = GLES20.glCreateProgram();
                                    GLES20.glAttachShader(this.rgbToHsvShaderProgram[i3], i2);
                                    GLES20.glAttachShader(this.rgbToHsvShaderProgram[i3], r3);
                                    ...
                                    if (iArr[0] == 0) {
                                        ...
                                        this.rgbToHsvSourceImageHandle[i3] = GLES20.glGetUniformLocation(this.rgbToHsvShaderProgram[i3], "sourceImage");
                                        if (i3 == 1) {
                                ...
                                if (r14 != 0 && r15 != 0) {
                                    ...
                                    if (iArr[0] == 0) {
                                        ...
                                        str3 = str6;
                                        this.enhanceInputImageTexture2Handle = GLES20.glGetUniformLocation(this.enhanceShaderProgram, str3);
                                    }
                                    if (this.isVideo) {
                                        r = r(35633, "attribute vec4 position;uniform mat4 videoMatrix;attribute vec4 inputTexCoord;varying vec2 texCoord;void main() {gl_Position = position;texCoord = vec2(videoMatrix * inputTexCoord).xy;}");
                                    } else {
                                        r = r(35633, "attribute vec4 position;attribute vec2 inputTexCoord;varying vec2 texCoord;void main() {gl_Position = position;texCoord = inputTexCoord;}");
                                    }
                                    Locale locale2 = Locale.US;
                                    int r16 = r(35632, String.format(locale2, "%1$s\nprecision lowp float;varying highp vec2 texCoord;uniform %2$s sourceImage;void main() {vec4 inp = texture2D(sourceImage, texCoord);vec4 image = vec4(inp.rgb * pow(2.0, -1.0), inp.w);vec4 base = vec4(image.g, image.g, image.g, 1.0);vec4 overlay = vec4(image.b, image.b, image.b, 1.0);float ba = 2.0 * overlay.b * base.b + overlay.b * (1.0 - base.a) + base.b * (1.0 - overlay.a);gl_FragColor = vec4(ba,ba,ba,image.a);}", str, str2));
                                    if (r != 0 && r16 != 0) {
                                        int glCreateProgram6 = GLES20.glCreateProgram();
                                        this.greenAndBlueChannelOverlayProgram = glCreateProgram6;
                                        GLES20.glAttachShader(glCreateProgram6, r);
                                        GLES20.glAttachShader(this.greenAndBlueChannelOverlayProgram, r16);
    ...
    public final Bitmap d(Bitmap bitmap, int i, float f) {
    ...
    public boolean e() {
        ...
        if (this.isVideo || (cVar = this.delegate) == null || cVar.c() || i == 0) {
            return false;
        }
        ...
        if (i == 1) {
            ...
            lk7 blurExcludePoint = this.delegate.getBlurExcludePoint();
            ...
            lk7 blurExcludePoint2 = this.delegate.getBlurExcludePoint();
    ...
    public void f() {
        ...
        if (cVar != null && !cVar.c()) {
            ...
            if (a2) {
                ByteBuffer b2 = this.delegate.b();
                GLES20.glActiveTexture(33985);
                GLES20.glBindTexture(3553, this.curveTextures[0]);
                GLES20.glTexImage2D(3553, 0, 6408, 200, 1, 0, 6408, 5121, b2);
        ...
        if (z) {
            if (z2 && !this.skinPassDrawn) {
                ...
                if (this.skinPassDrawn) {
                    i = this.renderTexture[1];
                } else {
                    i = this.bitmapTextre[0];
                }
            ...
            int i2 = this.rgbToHsvPositionHandle[c2];
            if (this.isVideo) {
                floatBuffer = this.vertexInvertBuffer;
            } else {
    ...
    public boolean i() {
        int i;
        c cVar = this.delegate;
        if (cVar != null && !cVar.c() && this.delegate.getSoftenSkinValue() > 0.0f && (i = this.renderBufferWidth) > 0 && this.renderBufferHeight > 0) {
            if (this.needUpdateSkinTexture || this.isVideo) {
                float f = i * 0.006f;
                if (this.skinBlurProgram == null || Math.abs(this.lastRadius - f) > 1.0E-4d) {
                    b bVar = this.skinBlurProgram;
                    if (bVar != null) {
                        bVar.b();
                    }
                    this.lastRadius = f;
                    b bVar2 = new b(f, 2.0f, true);
                    this.skinBlurProgram = bVar2;
                    bVar2.a();
                }
            ...
            GLES20.glBindTexture(3553, this.toneCurve.a());
            GLES20.glDrawArrays(5, 0, 4);
            return true;
        }
        if (this.skinPassDrawn) {
    ...
    public final void s(Bitmap bitmap, int i, int i2, int i3) {
        ...
        if (bitmap2 != null && !bitmap.isRecycled()) {
            ...
            float d1 = org.telegram.messenger.a.d1();
            int i4 = this.renderBufferWidth;
            if (i4 > d1 || this.renderBufferHeight > d1 || i % 360 != 0) {
                float f = 1.0f;
                if (i4 > d1 || this.renderBufferHeight > d1) {
                    f = d1 / bitmap.getWidth();
                    float height = d1 / bitmap.getHeight();
                    if (f < height) {
                        this.renderBufferWidth = (int) d1;
                        this.renderBufferHeight = (int) (bitmap.getHeight() * f);
                    } else {
                        this.renderBufferHeight = (int) d1;
