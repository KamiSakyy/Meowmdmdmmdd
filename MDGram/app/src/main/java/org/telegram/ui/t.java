...
public class t extends org.telegram.ui.ActionBar.f {
    ...
    public /* synthetic */ void U2(mq9 mq9Var, DialogInterface dialogInterface, int i) {
        if (org.telegram.messenger.y.r9(mq9Var)) {
            org.telegram.ui.Components.b.X5(this, org.telegram.messenger.u.B0("ErrorOccurred", org.telegram.mdgram.R.string.ErrorOccurred));
        } else {
            org.telegram.messenger.y.u8(this.currentAccount).G6(mq9Var.f10557a);
            org.telegram.ui.Components.b.X5(this, org.telegram.messenger.u.B0("UserBlocked", org.telegram.mdgram.R.string.UserBlocked));
        }
        b0();
    }
    ...
    public View W(Context context) {
        ...
        this.actionBar.setTitle(org.telegram.messenger.u.B0("BlockUserMultiTitle", org.telegram.mdgram.R.string.BlockUserMultiTitle));
        boolean z = false;
    ...
    public final void X2(final mq9 mq9Var) {
        ...
        kVar.n(org.telegram.messenger.a.b3(org.telegram.messenger.u.d0("AreYouSureBlockContact2", org.telegram.mdgram.R.string.AreYouSureBlockContact2, org.telegram.messenger.e.E0(mq9Var.f10558a, mq9Var.f10565b))));
        kVar.v(org.telegram.messenger.u.B0("BlockContact", org.telegram.mdgram.R.string.BlockContact), new DialogInterface.OnClickListener() { // from class: mc2
    ...
    public final void Z2() {
        ...
        scrollSlidingTextTabStrip.l(0, org.telegram.messenger.u.B0("BlockUserChatsTitle", org.telegram.mdgram.R.string.BlockUserChatsTitle));
        this.scrollSlidingTextTabStrip.l(1, org.telegram.messenger.u.B0("BlockUserContactsTitle", org.telegram.mdgram.R.string.BlockUserContactsTitle));
