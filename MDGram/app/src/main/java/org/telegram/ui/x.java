...
public class x extends org.telegram.ui.ActionBar.f {
    ...
    public static class c extends FrameLayout {
        ...
        public c(Context context) {
            ...
            e88Var.g(org.telegram.mdgram.R.raw.filter_new, 100, 100);
        ...
        */
        ...
        public void onViewAttachedToWindow(RecyclerView.d0 d0Var) {
            ...
            if (d0Var.getItemViewType() == 2) {
                ...
                tk7Var.o(str, org.telegram.messenger.u.B0("FilterNameHint", org.telegram.mdgram.R.string.FilterNameHint), false);
                tk7Var.setTag(null);
            }
        }
        ...
        if (i == this.includeShowMoreRow) {
            ...
            if (i != i2 && i != this.excludeAddRow) {
                if (i == this.removeRow) {
                    ...
                    kVar.v(org.telegram.messenger.u.B0("Delete", org.telegram.mdgram.R.string.Delete), new DialogInterface.OnClickListener() { // from class: o53
    ...
    public final void L3(final int i, CharSequence charSequence, Object obj, final boolean z) {
        e.k kVar = new e.k(E0());
        if (z) {
            kVar.x(org.telegram.messenger.u.B0("FilterRemoveInclusionTitle", org.telegram.mdgram.R.string.FilterRemoveInclusionTitle));
            if (obj instanceof String) {
                kVar.n(org.telegram.messenger.u.d0("FilterRemoveInclusionText", org.telegram.mdgram.R.string.FilterRemoveInclusionText, charSequence));
            } else if (obj instanceof mq9) {
                kVar.n(org.telegram.messenger.u.d0("FilterRemoveInclusionUserText", org.telegram.mdgram.R.string.FilterRemoveInclusionUserText, charSequence));
            } else {
                kVar.n(org.telegram.messenger.u.d0("FilterRemoveInclusionChatText", org.telegram.mdgram.R.string.FilterRemoveInclusionChatText, charSequence));
            }
        } else {
            kVar.x(org.telegram.messenger.u.B0("FilterRemoveExclusionTitle", org.telegram.mdgram.R.string.FilterRemoveExclusionTitle));
            if (obj instanceof String) {
                kVar.n(org.telegram.messenger.u.d0("FilterRemoveExclusionText", org.telegram.mdgram.R.string.FilterRemoveExclusionText, charSequence));
            } else if (obj instanceof mq9) {
                kVar.n(org.telegram.messenger.u.d0("FilterRemoveExclusionUserText", org.telegram.mdgram.R.string.FilterRemoveExclusionUserText, charSequence));
            } else {
                kVar.n(org.telegram.messenger.u.d0("FilterRemoveExclusionChatText", org.telegram.mdgram.R.string.FilterRemoveExclusionChatText, charSequence));
            }
        }
        kVar.p(org.telegram.messenger.u.B0("Cancel", org.telegram.mdgram.R.string.Cancel), null);
        kVar.v(org.telegram.messenger.u.B0("StickersRemove", org.telegram.mdgram.R.string.StickersRemove), new DialogInterface.OnClickListener() { // from class: q53
            @Override // android.content.DialogInterface.OnClickListener
    ...
    public View W(Context context) {
        ...
        if (this.creatingNew) {
            this.actionBar.setTitle(org.telegram.messenger.u.B0("FilterNew", org.telegram.mdgram.R.string.FilterNew));
        } else {
        ...
        this.doneItem = x.h(1, org.telegram.messenger.u.B0("Save", org.telegram.mdgram.R.string.Save).toUpperCase());
    ...
    public final boolean o3() {
        if (this.doneItem.getAlpha() == 1.0f) {
            e.k kVar = new e.k(E0());
            if (this.creatingNew) {
                kVar.x(org.telegram.messenger.u.B0("FilterDiscardNewTitle", org.telegram.mdgram.R.string.FilterDiscardNewTitle));
                kVar.n(org.telegram.messenger.u.B0("FilterDiscardNewAlert", org.telegram.mdgram.R.string.FilterDiscardNewAlert));
                kVar.v(org.telegram.messenger.u.B0("FilterDiscardNewSave", org.telegram.mdgram.R.string.FilterDiscardNewSave), new DialogInterface.OnClickListener() { // from class: y53
                    @Override // android.content.DialogInterface.OnClickListener
                ...
                kVar.x(org.telegram.messenger.u.B0("FilterDiscardTitle", org.telegram.mdgram.R.string.FilterDiscardTitle));
                kVar.n(org.telegram.messenger.u.B0("FilterDiscardAlert", org.telegram.mdgram.R.string.FilterDiscardAlert));
                kVar.v(org.telegram.messenger.u.B0("ApplyTheme", org.telegram.mdgram.R.string.ApplyTheme), new DialogInterface.OnClickListener() { // from class: z53
                    @Override // android.content.DialogInterface.OnClickListener
                    public final void onClick(DialogInterface dialogInterface, int i) {
            ...
            kVar.p(org.telegram.messenger.u.B0("PassportDiscard", org.telegram.mdgram.R.string.PassportDiscard), new DialogInterface.OnClickListener() { // from class: a63
                @Override // android.content.DialogInterface.OnClickListener
                public final void onClick(DialogInterface dialogInterface, int i) {
