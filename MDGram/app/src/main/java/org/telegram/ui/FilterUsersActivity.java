...
public class FilterUsersActivity extends org.telegram.ui.ActionBar.f implements a0.d, View.OnClickListener {
    private k adapter;
    ...
    public class b extends ViewGroup {
        ...
        public boolean drawChild(Canvas canvas, View view, long j) {
            ...
            if (view == FilterUsersActivity.this.listView || view == FilterUsersActivity.this.emptyView) {
                ...
                filterUsersActivity.parentLayout.N(canvas, filterUsersActivity.scrollView.getMeasuredHeight());
            }
            return drawChild;
        }
        ...
        public void onLayout(boolean z, int i, int i2, int i3, int i4) {
            ...
            if (FilterUsersActivity.this.floatingButton != null) {
                if (org.telegram.messenger.u.d) {
                    ...
                    e0 = ((i3 - i) - org.telegram.messenger.a.e0(14.0f)) - FilterUsersActivity.this.floatingButton.getMeasuredWidth();
                }
                int e02 = ((i4 - i2) - org.telegram.messenger.a.e0(14.0f)) - FilterUsersActivity.this.floatingButton.getMeasuredHeight();
                FilterUsersActivity.this.floatingButton.layout(e0, e02, FilterUsersActivity.this.floatingButton.getMeasuredWidth() + e0, FilterUsersActivity.this.floatingButton.getMeasuredHeight() + e02);
            }
        }
        ...
        public void onMeasure(int i, int i2) {
            ...
            FilterUsersActivity.this.scrollView.measure(View.MeasureSpec.makeMeasureSpec(size, MemoryConstants.GB), View.MeasureSpec.makeMeasureSpec(e0, Integer.MIN_VALUE));
            FilterUsersActivity.this.listView.measure(View.MeasureSpec.makeMeasureSpec(size, MemoryConstants.GB), View.MeasureSpec.makeMeasureSpec(size2 - FilterUsersActivity.this.scrollView.getMeasuredHeight(), MemoryConstants.GB));
            FilterUsersActivity.this.emptyView.measure(View.MeasureSpec.makeMeasureSpec(size, MemoryConstants.GB), View.MeasureSpec.makeMeasureSpec(size2 - FilterUsersActivity.this.scrollView.getMeasuredHeight(), MemoryConstants.GB));
            if (FilterUsersActivity.this.floatingButton != null) {
                int e02 = org.telegram.messenger.a.e0(56.0f);
                FilterUsersActivity.this.floatingButton.measure(View.MeasureSpec.makeMeasureSpec(e02, MemoryConstants.GB), View.MeasureSpec.makeMeasureSpec(e02, MemoryConstants.GB));
            }
        }
    }
    ...
    public class c extends ScrollView {
        ...
        public boolean requestChildRectangleOnScreen(View view, Rect rect, boolean z) {
            ...
            rect.top += FilterUsersActivity.this.fieldY + org.telegram.messenger.a.e0(20.0f);
            rect.bottom += FilterUsersActivity.this.fieldY + org.telegram.messenger.a.e0(50.0f);
    ...
    public class d extends EditTextBoldCursor {
        ...
        public boolean onTouchEvent(MotionEvent motionEvent) {
            if (FilterUsersActivity.this.currentDeletingSpan != null) {
                FilterUsersActivity.this.currentDeletingSpan.a();
        ...
        public boolean onKey(View view, int i, KeyEvent keyEvent) {
            if (i == 67) {
                ...
                if (keyEvent.getAction() == 0) {
                    ...
                    gs3 gs3Var = (gs3) FilterUsersActivity.this.allSpans.get(FilterUsersActivity.this.allSpans.size() - 1);
                    FilterUsersActivity.this.spansContainer.f(gs3Var);
                    if (gs3Var.getUid() == -2147483648L) {
                        FilterUsersActivity.this.filterFlags &= ~org.telegram.messenger.y.Y0;
                    } else if (gs3Var.getUid() == -2147483647L) {
                        FilterUsersActivity.this.filterFlags &= ~org.telegram.messenger.y.Z0;
                    } else if (gs3Var.getUid() == -2147483646) {
                        FilterUsersActivity.this.filterFlags &= ~org.telegram.messenger.y.a1;
                    } else if (gs3Var.getUid() == -2147483645) {
                        FilterUsersActivity.this.filterFlags &= ~org.telegram.messenger.y.b1;
                    } else if (gs3Var.getUid() == -2147483644) {
                        FilterUsersActivity.this.filterFlags &= ~org.telegram.messenger.y.c1;
                    } else if (gs3Var.getUid() == -2147483643) {
                        FilterUsersActivity.this.filterFlags &= ~org.telegram.messenger.y.d1;
                    } else if (gs3Var.getUid() == -2147483642) {
                        FilterUsersActivity.this.filterFlags &= ~org.telegram.messenger.y.e1;
                    } else if (gs3Var.getUid() == -2147483641) {
                        FilterUsersActivity.this.filterFlags &= ~org.telegram.messenger.y.f1;
                    }
        ...
        public void afterTextChanged(Editable editable) {
            if (FilterUsersActivity.this.editText.length() != 0) {
                if (!FilterUsersActivity.this.adapter.searching) {
                    ...
                    FilterUsersActivity.this.adapter.A(true);
                    ...
                    FilterUsersActivity.this.emptyView.setText(org.telegram.messenger.u.B0("NoResult", org.telegram.mdgram.R.string.NoResult));
                    FilterUsersActivity.this.emptyView.e();
                }
                FilterUsersActivity.this.adapter.z(FilterUsersActivity.this.editText.getText().toString());
                return;
            }
    ...
    public class h extends RecyclerView.t {
        ...
        public void a(RecyclerView recyclerView, int i) {
            if (i == 1) {
                org.telegram.messenger.a.B1(FilterUsersActivity.this.editText);
            }
        }
    }
    ...
    public class k extends v1.h {
        ...
        public k(Context context) {
            ...
            ArrayList K7 = FilterUsersActivity.this.x0().K7();
            int size = K7.size();
            boolean z = false;
            for (int i2 = 0; i2 < size; i2++) {
                ...
                if (!ic2.i(qm9Var.id)) {
                    if (ic2.k(qm9Var.id)) {
                        mq9 R8 = FilterUsersActivity.this.x0().R8(Long.valueOf(qm9Var.id));
                        if (R8 != null) {
                        ...
                        fm9 S7 = FilterUsersActivity.this.x0().S7(Long.valueOf(-qm9Var.id));
                        if (S7 != null) {
            ...
            if (!z) {
                this.contacts.add(0, FilterUsersActivity.this.x0().R8(Long.valueOf(FilterUsersActivity.this.M0().f19522a)));
            }
            lm8 lm8Var = new lm8(false);
            this.searchAdapterHelper = lm8Var;
            lm8Var.O(false);
            this.searchAdapterHelper.P(new lm8.b() { // from class: z63
                ...
                public final void d(int i3) {
                    FilterUsersActivity.k.this.u(i3);
                }
        ...
        public /* synthetic */ void u(int i) {
            if (this.searchRunnable == null && !this.searchAdapterHelper.u()) {
                FilterUsersActivity.this.emptyView.g();
            }
        ...
        public /* synthetic */ void v(String str) {
            ...
            while (i4 < this.contacts.size()) {
                ...
                if (z) {
                    ...
                    str2 = xla.c(mq9Var);
                    if (xla.k(mq9Var)) {
                        strArr2[2] = org.telegram.messenger.u.B0("RepliesTitle", org.telegram.mdgram.R.string.RepliesTitle).toLowerCase();
                    } else if (mq9Var.f10563a) {
                        strArr2[2] = org.telegram.messenger.u.B0("SavedMessages", org.telegram.mdgram.R.string.SavedMessages).toLowerCase();
                    }
                } else {
                    fm9 fm9Var = (fm9) aVar;
        ...
        public /* synthetic */ void w(final String str) {
            this.searchAdapterHelper.J(str, true, true, true, true, false, 0L, false, 0, 0);
            fi2 fi2Var = Utilities.d;
            Runnable runnable = new Runnable() { // from class: c73
                @Override // java.lang.Runnable
                public final void run() {
                    FilterUsersActivity.k.this.v(str);
                }
            };
        ...
        public /* synthetic */ void x(final String str) {
            org.telegram.messenger.a.m3(new Runnable() { // from class: b73
                @Override // java.lang.Runnable
                public final void run() {
        ...
        public final void B(final ArrayList arrayList, final ArrayList arrayList2) {
            org.telegram.messenger.a.m3(new Runnable() { // from class: d73
                @Override // java.lang.Runnable
                public final void run() {
                    FilterUsersActivity.k.this.y(arrayList, arrayList2);
                }
            });
        }
        ...
        */
        public void onBindViewHolder(androidx.recyclerview.widget.RecyclerView.d0 r18, int r19) {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.FilterUsersActivity.k.onBindViewHolder(androidx.recyclerview.widget.RecyclerView$d0, int):void");
        }
    ...
    public class m extends ViewGroup {
        ...
        public void e(gs3 gs3Var, boolean z) {
            FilterUsersActivity.this.allSpans.add(gs3Var);
            long uid = gs3Var.getUid();
            if (uid > -2147483641) {
                FilterUsersActivity.this.selectedCount++;
            }
            FilterUsersActivity.this.selectedContacts.q(uid, gs3Var);
        ...
        public void f(gs3 gs3Var) {
            ...
            FilterUsersActivity.this.selectedContacts.r(uid);
            FilterUsersActivity.this.allSpans.remove(gs3Var);
        ...
        public void onMeasure(int i, int i2) {
            ...
            FilterUsersActivity.this.editText.measure(View.MeasureSpec.makeMeasureSpec(e0 - i3, MemoryConstants.GB), View.MeasureSpec.makeMeasureSpec(org.telegram.messenger.a.e0(32.0f), MemoryConstants.GB));
            if (!this.animationStarted) {
                int e05 = e03 + org.telegram.messenger.a.e0(42.0f);
                int e06 = i3 + org.telegram.messenger.a.e0(16.0f);
                FilterUsersActivity.this.fieldY = e02;
                if (this.currentAnimation != null) {
                    int e07 = e02 + org.telegram.messenger.a.e0(42.0f);
                    if (FilterUsersActivity.this.containerHeight != e07) {
                        this.animators.add(ObjectAnimator.ofInt(FilterUsersActivity.this, "containerHeight", e07));
                    }
                    float f3 = e06;
                    ...
                    FilterUsersActivity.this.containerHeight = e05;
                    FilterUsersActivity.this.editText.setTranslationX(e06);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void S2(Context context, View view, int i2) {
        long j2;
        boolean z;
        int i3;
        if (view instanceof is3) {
    ...
    public ArrayList J0() {
        ArrayList arrayList = new ArrayList();
        m.a aVar = new m.a() { // from class: y63
    ...
    public View W(final Context context) {
        ...
        if (this.isInclude) {
            this.actionBar.setTitle(org.telegram.messenger.u.B0("FilterAlwaysShow", org.telegram.mdgram.R.string.FilterAlwaysShow));
        } else {
            this.actionBar.setTitle(org.telegram.messenger.u.B0("FilterNeverShow", org.telegram.mdgram.R.string.FilterNeverShow));
        }
        ...
        this.spansContainer.setOnClickListener(new View.OnClickListener() { // from class: v63
        ...
        this.editText.setHintText(org.telegram.messenger.u.B0("SearchForPeopleAndGroups", org.telegram.mdgram.R.string.SearchForPeopleAndGroups));
        ...
        this.listView.setOnItemClickListener(new v1.m() { // from class: w63
            @Override // org.telegram.ui.Components.v1.m
            public final void a(View view, int i6) {
                FilterUsersActivity.this.S2(context, view, i6);
            }
        });
        ...
        this.floatingButton.setOnClickListener(new View.OnClickListener() { // from class: x63
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                FilterUsersActivity.this.T2(view);
            }
        });
        this.floatingButton.setContentDescription(org.telegram.messenger.u.B0("Next", org.telegram.mdgram.R.string.Next));
        if (!this.isInclude) {
            i5 = 3;
        }
        ...
        if (arrayList != null && !arrayList.isEmpty()) {
            ...
            for (int i7 = 0; i7 < size; i7++) {
                Long l2 = this.initialIds.get(i7);
                if (l2.longValue() > 0) {
                    S7 = x0().R8(l2);
                } else {
    ...
    public final void W2() {
        ...
        if (i3 == 0) {
            this.actionBar.setSubtitle(org.telegram.messenger.u.d0("MembersCountZero", org.telegram.mdgram.R.string.MembersCountZero, org.telegram.messenger.u.U("Chats", i2, new Object[0])));
        } else {
            this.actionBar.setSubtitle(String.format(org.telegram.messenger.u.x0("MembersCountSelected", i3), Integer.valueOf(this.selectedCount), Integer.valueOf(i2)));
        }
    }
