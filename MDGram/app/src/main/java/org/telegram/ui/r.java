...
public class r {
            ...
            if (r.this.currentContentType == 0) {
                ...
                if (r.this.delegate != null) {
                    if (r.this.delegate.j() && !r.this.delegate.c()) {
                        arrayList.add(org.telegram.messenger.u.B0("SendStickerPreview", org.telegram.mdgram.R.string.SendStickerPreview));
                        arrayList3.add(Integer.valueOf(org.telegram.mdgram.R.drawable.msg_send));
                        arrayList2.add(0);
                    }
                    if (r.this.delegate.j() && !r.this.delegate.c()) {
                        arrayList.add(org.telegram.messenger.u.B0("SendWithoutSound", org.telegram.mdgram.R.string.SendWithoutSound));
                        arrayList3.add(Integer.valueOf(org.telegram.mdgram.R.drawable.input_notify_off));
                        arrayList2.add(6);
                    }
                    if (r.this.delegate.b()) {
                        arrayList.add(org.telegram.messenger.u.B0("Schedule", org.telegram.mdgram.R.string.Schedule));
                        arrayList3.add(Integer.valueOf(org.telegram.mdgram.R.drawable.msg_autodelete));
                        arrayList2.add(3);
                    }
                    if (r.this.currentStickerSet != null && r.this.delegate.i()) {
                        arrayList.add(org.telegram.messenger.u.d0("ViewPackPreview", org.telegram.mdgram.R.string.ViewPackPreview, new Object[0]));
                        arrayList3.add(Integer.valueOf(org.telegram.mdgram.R.drawable.msg_media));
                        arrayList2.add(1);
                    }
                    if (r.this.delegate.k()) {
                        arrayList.add(org.telegram.messenger.u.B0("ImportStickersRemoveMenu", org.telegram.mdgram.R.string.ImportStickersRemoveMenu));
                        arrayList3.add(Integer.valueOf(org.telegram.mdgram.R.drawable.msg_delete));
                        arrayList2.add(5);
                    }
                }
                if (!org.telegram.messenger.x.J2(r.this.currentDocument) && (B5 || (org.telegram.messenger.w.R4(r.this.currentAccount).H3() && org.telegram.messenger.x.y3(r.this.currentDocument)))) {
                    if (B5) {
                        i8 = org.telegram.mdgram.R.string.DeleteFromFavorites;
                        str = "DeleteFromFavorites";
                    } else {
                        i8 = org.telegram.mdgram.R.string.AddToFavorites;
                        str = "AddToFavorites";
                    }
                    arrayList.add(org.telegram.messenger.u.B0(str, i8));
                    if (B5) {
                        i9 = org.telegram.mdgram.R.drawable.msg_unfave;
                    } else {
                        i9 = org.telegram.mdgram.R.drawable.msg_fave;
                    }
                    arrayList3.add(Integer.valueOf(i9));
                    arrayList2.add(2);
                }
                if (r.this.isRecentSticker) {
                    arrayList.add(org.telegram.messenger.u.B0("DeleteFromRecent", org.telegram.mdgram.R.string.DeleteFromRecent));
                    arrayList3.add(Integer.valueOf(org.telegram.mdgram.R.drawable.msg_delete));
                    arrayList2.add(4);
                }
                ...
                ActionBarPopupWindow.ActionBarPopupWindowLayout actionBarPopupWindowLayout = new ActionBarPopupWindow.ActionBarPopupWindowLayout(r.this.containerView.getContext(), org.telegram.mdgram.R.drawable.popup_fixed_alert2, r.this.resourcesProvider);
                ...
                r.this.popupWindow.setAnimationStyle(org.telegram.mdgram.R.style.PopupContextAnimation);
                ...
                if (r.this.delegate.j() && !r.this.delegate.c()) {
                    arrayList4.add(org.telegram.messenger.u.B0("SendGifPreview", org.telegram.mdgram.R.string.SendGifPreview));
                    arrayList6.add(Integer.valueOf(org.telegram.mdgram.R.drawable.msg_send));
                    arrayList5.add(0);
                }
                if (r.this.delegate.b()) {
                    arrayList4.add(org.telegram.messenger.u.B0("Schedule", org.telegram.mdgram.R.string.Schedule));
                    arrayList6.add(Integer.valueOf(org.telegram.mdgram.R.drawable.msg_autodelete));
                    arrayList5.add(3);
                }
                if (r.this.currentDocument != null) {
                    z = org.telegram.messenger.w.R4(r.this.currentAccount).w5(r.this.currentDocument);
                    if (z) {
                        arrayList4.add(org.telegram.messenger.u.d0("Delete", org.telegram.mdgram.R.string.Delete, new Object[0]));
                        arrayList6.add(Integer.valueOf(org.telegram.mdgram.R.drawable.msg_delete));
                        arrayList5.add(1);
                    } else {
                        arrayList4.add(org.telegram.messenger.u.d0("SaveToGIFs", org.telegram.mdgram.R.string.SaveToGIFs, new Object[0]));
                        arrayList6.add(Integer.valueOf(org.telegram.mdgram.R.drawable.msg_gif_add));
                        arrayList5.add(2);
                    }
                } else {
                    z = false;
                ...
                ActionBarPopupWindow.ActionBarPopupWindowLayout actionBarPopupWindowLayout2 = new ActionBarPopupWindow.ActionBarPopupWindowLayout(r.this.containerView.getContext(), org.telegram.mdgram.R.drawable.popup_fixed_alert2, r.this.resourcesProvider);
    ...
    */
    ...
    public void l0(Activity activity) {
        ...
        this.slideUpDrawable = activity.getResources().getDrawable(org.telegram.mdgram.R.drawable.preview_arrow);
