    ...
    public class k extends View {
        ...
        */
        ...
        public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
            ...
            accessibilityNodeInfo.addAction(new AccessibilityNodeInfo.AccessibilityAction(32, org.telegram.messenger.u.B0("AccDescrOpenMenu2", org.telegram.mdgram.R.string.AccDescrOpenMenu2)));
            ...
            if (jVar.counter != this.delegate.d(jVar.id) && this.delegate.d(jVar.id) >= 0) {
                ...
                if (this.positionToWidth.get(i3) != jVar.a(true) || this.invalidated) {
                    ...
                    if (!MDConfig.hideAllTab) {
                        q0().b(org.telegram.messenger.u.B0("FilterAllChats", org.telegram.mdgram.R.string.FilterAllChats));
                    }
    ...
    */
    public void o0() {
        ...
        L3e:
            ...
            int r3 = defpackage.org.telegram.mdgram.R.string.FilterAllChats
        ...
        if (!this.tabs.isEmpty()) {
            ...
            if (!MDConfig.hideAllTab) {
                if (this.allTabsWidth > size) {
                    B0 = org.telegram.messenger.u.B0("FilterAllChatsShort", org.telegram.mdgram.R.string.FilterAllChatsShort);
                } else {
                    B0 = org.telegram.messenger.u.B0("FilterAllChats", org.telegram.mdgram.R.string.FilterAllChats);
                }
                q0.b(B0);
            }
