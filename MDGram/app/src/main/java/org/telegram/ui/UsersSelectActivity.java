        ...
        public void afterTextChanged(Editable editable) {
            if (UsersSelectActivity.this.editText.length() != 0) {
                if (!UsersSelectActivity.this.adapter.searching) {
                    ...
                    UsersSelectActivity.this.emptyView.setText(org.telegram.messenger.u.B0("NoResult", org.telegram.mdgram.R.string.NoResult));
        ...
        if (view instanceof is3) {
            ...
            if (z2) {
                ...
                if (this.type == 1 && !org.telegram.messenger.d.v(fm9Var, 13)) {
                    org.telegram.ui.Components.q.p0(this).C(org.telegram.messenger.u.B0("NeedAdminRightForSetAutoDeleteTimer", org.telegram.mdgram.R.string.NeedAdminRightForSetAutoDeleteTimer)).T();
                    return;
                }
            } else {
                return;
    ...
    public final void Z2() {
        ...
        if (i3 == 0) {
            ...
            if (this.selectedCount == 0) {
                this.animatedAvatarContainer.getTitle().f(org.telegram.messenger.u.B0("SelectChats", org.telegram.mdgram.R.string.SelectChats), true);
                if (this.ttlPeriod > 0) {
                    this.animatedAvatarContainer.getSubtitleTextView().f(org.telegram.messenger.u.B0("SelectChatsForAutoDelete", org.telegram.mdgram.R.string.SelectChatsForAutoDelete), true);
                    return;
                } else {
                    this.animatedAvatarContainer.getSubtitleTextView().f(org.telegram.messenger.u.B0("SelectChatsForDisableAutoDelete", org.telegram.mdgram.R.string.SelectChatsForDisableAutoDelete), true);
                    return;
                }
            }
