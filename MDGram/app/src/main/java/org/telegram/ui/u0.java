...
public class u0 extends org.telegram.ui.ActionBar.f implements a0.d, q.n {
        ...
        public void onBindViewHolder(RecyclerView.d0 d0Var, int i) {
            ...
            if (itemViewType != 0) {
                if (itemViewType != 1) {
                        ...
                        if (itemViewType == 3) {
                            ...
                            if (i == u0.this.usersHeaderRow) {
                                if (u0.this.currentType == 1) {
                                    ...
                                    nu3Var.setText(org.telegram.messenger.u.B0("PrivacyExceptions", org.telegram.mdgram.R.string.PrivacyExceptions));
                                    return;
                                }
                            }
                            return;
                    ...
                    if (u0.this.currentType == 1) {
                        u65Var.c(org.telegram.messenger.u.B0("BlockUser", org.telegram.mdgram.R.string.BlockUser), null, org.telegram.mdgram.R.drawable.msg_contact_add, false);
                        return;
                    }
                    String B03 = org.telegram.messenger.u.B0("PrivacyAddAnException", org.telegram.mdgram.R.string.PrivacyAddAnException);
                    int i2 = org.telegram.mdgram.R.drawable.msg_contact_add;
                ...
                if (i == u0.this.blockUserDetailRow) {
                    if (u0.this.currentType == 1) {
                        ...
                        bv9Var.setText(org.telegram.messenger.u.B0("BlockedUsersInfo", org.telegram.mdgram.R.string.BlockedUsersInfo));
                    } else {
            ...
            if (longValue > 0) {
                ...
                if (R8 != null) {
                    if (R8.f10571e) {
                        B02 = org.telegram.messenger.u.B0("Bot", org.telegram.mdgram.R.string.Bot).substring(0, 1).toUpperCase() + org.telegram.messenger.u.B0("Bot", org.telegram.mdgram.R.string.Bot).substring(1);
                    } else {
                        String str = R8.d;
                        if (str != null && str.length() != 0) {
                            B02 = z77.d().c("+" + R8.d);
                        } else {
                            B02 = org.telegram.messenger.u.B0("NumberUnknown", org.telegram.mdgram.R.string.NumberUnknown);
                        }
                    }
            ...
            if (S7 != null) {
                ...
                if (i3 != 0) {
                    ...
                    B0 = org.telegram.messenger.u.B0("MegaLocation", org.telegram.mdgram.R.string.MegaLocation);
                } else if (!org.telegram.messenger.d.a0(S7)) {
                    B0 = org.telegram.messenger.u.B0("MegaPrivate", org.telegram.mdgram.R.string.MegaPrivate);
                } else {
                    B0 = org.telegram.messenger.u.B0("MegaPublic", org.telegram.mdgram.R.string.MegaPublic);
                }
                if (i != u0.this.usersEndRow - 1) {
                    z = true;
                }
    ...
    public /* synthetic */ void D2(View view, int i) {
        ...
        if (i == this.deleteAllRow) {
            org.telegram.ui.ActionBar.e a2 = org.telegram.ui.Components.b.H2(k0(), org.telegram.messenger.u.z0(org.telegram.mdgram.R.string.NotificationsDeleteAllExceptionTitle), org.telegram.messenger.u.z0(org.telegram.mdgram.R.string.NotificationsDeleteAllExceptionAlert), org.telegram.messenger.u.z0(org.telegram.mdgram.R.string.Delete), new Runnable() { // from class: rq7
    ...
    public final void I2(final Long l) {
        ...
        e.k kVar = new e.k(E0());
        kVar.l(this.currentType == 1 ? new CharSequence[]{org.telegram.messenger.u.B0("Unblock", org.telegram.mdgram.R.string.Unblock)} : new CharSequence[]{org.telegram.messenger.u.B0("Delete", org.telegram.mdgram.R.string.Delete)}, new DialogInterface.OnClickListener() { // from class: tq7
    ...
    public View W(Context context) {
        ...
        int i2 = 2;
        if (i == 1) {
            this.actionBar.setTitle(org.telegram.messenger.u.B0("BlockedUsers", org.telegram.mdgram.R.string.BlockedUsers));
        } else if (i == 2) {
            if (this.isAlwaysShare) {
        ...
        if (this.currentType == 1) {
            tt2Var.setText(org.telegram.messenger.u.B0("NoBlocked", org.telegram.mdgram.R.string.NoBlocked));
        } else {
            tt2Var.setText(org.telegram.messenger.u.B0("NoContacts", org.telegram.mdgram.R.string.NoContacts));
        }
