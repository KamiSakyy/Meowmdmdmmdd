...
public class PopupNotificationActivity extends Activity implements a0.d {
    ...
    */
    ...
    public final void Z(int i) {
        ...
        if (fm9Var != null) {
            ...
            if (mq9Var2 != null) {
                ...
                if (ic2.i(k0)) {
                    this.nameTextView.setCompoundDrawablesWithIntrinsicBounds(org.telegram.mdgram.R.drawable.ic_lock_white, 0, 0, 0);
    ...
    public final void a0() {
        ...
        if (this.actionBar != null && (xVar = this.currentMessageObject) != null && this.currentChat == null && (mq9Var = this.currentUser) != null) {
            ...
            if (mq9Var2 != null && mq9Var2.f10557a == 777000) {
                this.onlineTextView.setText(org.telegram.messenger.u.B0("ServiceNotifications", org.telegram.mdgram.R.string.ServiceNotifications));
                return;
            }
    ...
    public void onRequestPermissionsResult(int i, String[] strArr, int[] iArr) {
        ...
        kVar.n(org.telegram.messenger.u.B0("PermissionNoAudioWithHint", org.telegram.mdgram.R.string.PermissionNoAudioWithHint));
        kVar.p(org.telegram.messenger.u.B0("PermissionOpenSettings", org.telegram.mdgram.R.string.PermissionOpenSettings), new DialogInterface.OnClickListener() { // from class: ml7
