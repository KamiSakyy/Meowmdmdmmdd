...
public class m extends org.telegram.ui.ActionBar.f {
        ...
        public void onBindViewHolder(RecyclerView.d0 d0Var, int i) {
            ...
            switch (d0Var.getItemViewType()) {
                case 0:
                    ...
                    if (m.this.currentType == 2) {
                        str = org.telegram.messenger.u.B0("Bot", org.telegram.mdgram.R.string.Bot);
                    } else {
                        str = null;
                    }
                ...
                case 1:
                    ...
                    if (i == m.this.cantEditInfoRow) {
                        bv9Var.setText(org.telegram.messenger.u.B0("EditAdminCantEdit", org.telegram.mdgram.R.string.EditAdminCantEdit));
                        return;
                        ...
                        bv9Var.setText(org.telegram.messenger.u.d0("EditAdminRankInfo", org.telegram.mdgram.R.string.EditAdminRankInfo, B0));
                        return;
                    } else {
                        return;
                    }
                case 2:
                    ...
                    if (i == m.this.removeAdminRow) {
                        ...
                        if (m.this.currentType == 0) {
                            uw9Var.c(org.telegram.messenger.u.B0("EditAdminRemoveAdmin", org.telegram.mdgram.R.string.EditAdminRemoveAdmin), false);
                            return;
                        } else if (m.this.currentType == 1) {
                            uw9Var.c(org.telegram.messenger.u.B0("UserRestrictionsBlock", org.telegram.mdgram.R.string.UserRestrictionsBlock), false);
                            return;
                        } else {
                            return;
                        }
                        ...
                        if (m.this.isChannel) {
                            uw9Var.c(org.telegram.messenger.u.B0("EditAdminChannelTransfer", org.telegram.mdgram.R.string.EditAdminChannelTransfer), false);
                            return;
                        } else {
                            uw9Var.c(org.telegram.messenger.u.B0("EditAdminGroupTransfer", org.telegram.mdgram.R.string.EditAdminGroupTransfer), false);
                            return;
                        }
                    } else {
                        return;
                ...
                case 3:
                    ...
                    if (i == 2) {
                        if (m.this.currentType != 2 && (m.this.currentUser == null || !m.this.currentUser.f10571e)) {
                            if (m.this.currentType == 0) {
                                nu3Var.setText(org.telegram.messenger.u.B0("EditAdminWhatCanDo", org.telegram.mdgram.R.string.EditAdminWhatCanDo));
                                return;
                            } else if (m.this.currentType == 1) {
                                nu3Var.setText(org.telegram.messenger.u.B0("UserRestrictionsCanDo", org.telegram.mdgram.R.string.UserRestrictionsCanDo));
                                return;
                            } else {
                                return;
                            }
                        }
                        nu3Var.setText(org.telegram.messenger.u.B0("BotRestrictionsCanDo", org.telegram.mdgram.R.string.BotRestrictionsCanDo));
                        return;
                    } else if (i == m.this.rankHeaderRow) {
                        nu3Var.setText(org.telegram.messenger.u.B0("EditAdminRank", org.telegram.mdgram.R.string.EditAdminRank));
                        return;
                    } else {
                        return;
                    }
                case 4:
                    ...
                    if (i == m.this.manageRow) {
                        su9Var.d(org.telegram.messenger.u.B0("ManageGroup", org.telegram.mdgram.R.string.ManageGroup), m.this.asAdmin, true);
                        if (!m.this.myAdminRights.h && !z2) {
                            i22 = org.telegram.mdgram.R.drawable.permission_locked;
                        } else {
                            i22 = 0;
                        }
                        su9Var.setIcon(i22);
                        ...
                        if (m.this.currentType != 0 && m.this.currentType != 2) {
                            if (m.this.currentType == 1) {
                                String B04 = org.telegram.messenger.u.B0("UserRestrictionsChangeInfo", org.telegram.mdgram.R.string.UserRestrictionsChangeInfo);
                                ...
                                if (m.this.defaultBannedRights.j) {
                                    i21 = org.telegram.mdgram.R.drawable.permission_locked;
                                } else {
                                    i21 = 0;
                                }
                                su9Var.setIcon(i21);
                            ...
                            if (m.this.isChannel) {
                                String B05 = org.telegram.messenger.u.B0("EditAdminChangeChannelInfo", org.telegram.mdgram.R.string.EditAdminChangeChannelInfo);
                                ...
                                String B06 = org.telegram.messenger.u.B0("EditAdminChangeGroupInfo", org.telegram.mdgram.R.string.EditAdminChangeGroupInfo);
                                if ((z && m.this.adminRights.f14119a) || !m.this.defaultBannedRights.j) {
                                    z25 = true;
                                } else {
                                    z25 = false;
                            ...
                            if (m.this.currentType == 2) {
                                if (!m.this.myAdminRights.f14119a && !z2) {
                                    i20 = org.telegram.mdgram.R.drawable.permission_locked;
                                } else {
                                    i20 = 0;
                                }
                                su9Var.setIcon(i20);
                        ...
                        String B07 = org.telegram.messenger.u.B0("EditAdminPostMessages", org.telegram.mdgram.R.string.EditAdminPostMessages);
                        ...
                        if (m.this.currentType == 2) {
                            if (!m.this.myAdminRights.f14120b && !z2) {
                                i19 = org.telegram.mdgram.R.drawable.permission_locked;
                            } else {
                                i19 = 0;
                            }
                            su9Var.setIcon(i19);
                        ...
                        String B08 = org.telegram.messenger.u.B0("EditAdminEditMessages", org.telegram.mdgram.R.string.EditAdminEditMessages);
                        ...
                        if (m.this.currentType == 2) {
                            if (!m.this.myAdminRights.c && !z2) {
                                i18 = org.telegram.mdgram.R.drawable.permission_locked;
                            } else {
                                i18 = 0;
                            }
                            su9Var.setIcon(i18);
                        ...
                        if (m.this.isChannel) {
                            String B09 = org.telegram.messenger.u.B0("EditAdminDeleteMessages", org.telegram.mdgram.R.string.EditAdminDeleteMessages);
                            ...
                            String B010 = org.telegram.messenger.u.B0("EditAdminGroupDeleteMessages", org.telegram.mdgram.R.string.EditAdminGroupDeleteMessages);
                            if (z && m.this.adminRights.d) {
                                z21 = true;
                            } else {
                                z21 = false;
                        ...
                        if (m.this.currentType == 2) {
                            if (!m.this.myAdminRights.d && !z2) {
                                i17 = org.telegram.mdgram.R.drawable.permission_locked;
                            } else {
                                i17 = 0;
                            }
                            su9Var.setIcon(i17);
                        ...
                        String B011 = org.telegram.messenger.u.B0("EditAdminAddAdmins", org.telegram.mdgram.R.string.EditAdminAddAdmins);
                        ...
                        if (m.this.currentType == 2) {
                            if (!m.this.myAdminRights.h && !z2) {
                                i16 = org.telegram.mdgram.R.drawable.permission_locked;
                            } else {
                                i16 = 0;
                            }
                            su9Var.setIcon(i16);
                        ...
                        String B012 = org.telegram.messenger.u.B0("EditAdminSendAnonymously", org.telegram.mdgram.R.string.EditAdminSendAnonymously);
                        ...
                        if (m.this.currentType == 2) {
                            if (!m.this.myAdminRights.i && !z2) {
                                i15 = org.telegram.mdgram.R.drawable.permission_locked;
                            } else {
                                i15 = 0;
                            }
                            su9Var.setIcon(i15);
                        ...
                        String B013 = org.telegram.messenger.u.B0("EditAdminBanUsers", org.telegram.mdgram.R.string.EditAdminBanUsers);
                        ...
                        if (m.this.currentType == 2) {
                            if (!m.this.myAdminRights.e && !z2) {
                                i14 = org.telegram.mdgram.R.drawable.permission_locked;
                            } else {
                                i14 = 0;
                            }
                            su9Var.setIcon(i14);
                        ...
                        String B014 = org.telegram.messenger.u.B0("StartVoipChatPermission", org.telegram.mdgram.R.string.StartVoipChatPermission);
                        ...
                        if (m.this.currentType == 2) {
                            if (!m.this.myAdminRights.j && !z2) {
                                i13 = org.telegram.mdgram.R.drawable.permission_locked;
                            } else {
                                i13 = 0;
                            }
                            su9Var.setIcon(i13);
                        ...
                        if (m.this.currentType == 0) {
                            String B015 = org.telegram.messenger.u.B0("ManageTopicsPermission", org.telegram.mdgram.R.string.ManageTopicsPermission);
                            ...
                            String B016 = org.telegram.messenger.u.B0("CreateTopicsPermission", org.telegram.mdgram.R.string.CreateTopicsPermission);
                            ...
                            if (m.this.defaultBannedRights.m) {
                                i12 = org.telegram.mdgram.R.drawable.permission_locked;
                            } else {
                                i12 = 0;
                            }
                            su9Var.setIcon(i12);
                        } else if (m.this.currentType == 2) {
                            String B017 = org.telegram.messenger.u.B0("ManageTopicsPermission", org.telegram.mdgram.R.string.ManageTopicsPermission);
                            if (z && m.this.adminRights.l) {
                                z12 = true;
                            } else {
                                z12 = false;
                            ...
                            if (!m.this.myAdminRights.l && !z2) {
                                i11 = org.telegram.mdgram.R.drawable.permission_locked;
                            } else {
                                i11 = 0;
                            }
                            su9Var.setIcon(i11);
                        ...
                        if (m.this.currentType == 0) {
                            if (org.telegram.messenger.d.H(m.this.currentChat, 3)) {
                                su9Var.d(org.telegram.messenger.u.B0("EditAdminAddUsers", org.telegram.mdgram.R.string.EditAdminAddUsers), m.this.adminRights.f, true);
                            } else {
                                su9Var.d(org.telegram.messenger.u.B0("EditAdminAddUsersViaLink", org.telegram.mdgram.R.string.EditAdminAddUsersViaLink), m.this.adminRights.f, true);
                            }
                        } else if (m.this.currentType == 1) {
                            String B018 = org.telegram.messenger.u.B0("UserRestrictionsInviteUsers", org.telegram.mdgram.R.string.UserRestrictionsInviteUsers);
                            ...
                            if (m.this.defaultBannedRights.k) {
                                i10 = org.telegram.mdgram.R.drawable.permission_locked;
                            } else {
                                i10 = 0;
                            }
                            su9Var.setIcon(i10);
                        } else if (m.this.currentType == 2) {
                            String B019 = org.telegram.messenger.u.B0("EditAdminAddUsersViaLink", org.telegram.mdgram.R.string.EditAdminAddUsersViaLink);
                            ...
                            if (!m.this.myAdminRights.f && !z2) {
                                i9 = org.telegram.mdgram.R.drawable.permission_locked;
                            } else {
                                i9 = 0;
                            }
                            su9Var.setIcon(i9);
                        ...
                        if (m.this.currentType != 0 && m.this.currentType != 2) {
                            if (m.this.currentType == 1) {
                                String B020 = org.telegram.messenger.u.B0("UserRestrictionsPinMessages", org.telegram.mdgram.R.string.UserRestrictionsPinMessages);
                                ...
                                if (m.this.defaultBannedRights.l) {
                                    i8 = org.telegram.mdgram.R.drawable.permission_locked;
                                } else {
                                    i8 = 0;
                                }
                                su9Var.setIcon(i8);
                            ...
                            String B021 = org.telegram.messenger.u.B0("EditAdminPinMessages", org.telegram.mdgram.R.string.EditAdminPinMessages);
                            ...
                            if (m.this.currentType == 2) {
                                if (!m.this.myAdminRights.g && !z2) {
                                    i7 = org.telegram.mdgram.R.drawable.permission_locked;
                                } else {
                                    i7 = 0;
                                }
                                su9Var.setIcon(i7);
                        ...
                        String B022 = org.telegram.messenger.u.B0("UserRestrictionsSend", org.telegram.mdgram.R.string.UserRestrictionsSend);
                        ...
                        if (m.this.defaultBannedRights.f14123b) {
                            i6 = org.telegram.mdgram.R.drawable.permission_locked;
                        } else {
                            i6 = 0;
                        }
                        su9Var.setIcon(i6);
                    } else if (i == m.this.sendMediaRow) {
                        String B023 = org.telegram.messenger.u.B0("UserRestrictionsSendMedia", org.telegram.mdgram.R.string.UserRestrictionsSendMedia);
                        ...
                        if (m.this.defaultBannedRights.f14124c) {
                            i5 = org.telegram.mdgram.R.drawable.permission_locked;
                        } else {
                            i5 = 0;
                        }
                        su9Var.setIcon(i5);
                    } else if (i == m.this.sendStickersRow) {
                        String B024 = org.telegram.messenger.u.B0("UserRestrictionsSendStickers", org.telegram.mdgram.R.string.UserRestrictionsSendStickers);
                        ...
                        if (m.this.defaultBannedRights.d) {
                            i4 = org.telegram.mdgram.R.drawable.permission_locked;
                        } else {
                            i4 = 0;
                        }
                        su9Var.setIcon(i4);
                    } else if (i == m.this.embedLinksRow) {
                        String B025 = org.telegram.messenger.u.B0("UserRestrictionsEmbedLinks", org.telegram.mdgram.R.string.UserRestrictionsEmbedLinks);
                        ...
                        if (m.this.defaultBannedRights.h) {
                            i3 = org.telegram.mdgram.R.drawable.permission_locked;
                        } else {
                            i3 = 0;
                        }
                        su9Var.setIcon(i3);
                    } else if (i == m.this.sendPollsRow) {
                        String B026 = org.telegram.messenger.u.B0("UserRestrictionsSendPolls", org.telegram.mdgram.R.string.UserRestrictionsSendPolls);
                        ...
                        if (m.this.defaultBannedRights.i) {
                            i2 = org.telegram.mdgram.R.drawable.permission_locked;
                        } else {
                            i2 = 0;
                        }
                        su9Var.setIcon(i2);
                ...
                case 5:
                    ...
                    if (i == m.this.rightsShadowRow) {
                        ...
                        if (m.this.removeAdminRow == -1 && m.this.rankRow == -1) {
                            i24 = org.telegram.mdgram.R.drawable.greydivider_bottom;
                        } else {
                            i24 = org.telegram.mdgram.R.drawable.greydivider;
                        }
                        ...
                        if (m.this.canEdit) {
                            i23 = org.telegram.mdgram.R.drawable.greydivider;
                        } else {
                            i23 = org.telegram.mdgram.R.drawable.greydivider_bottom;
                        }
                ...
                case 6:
                    ...
                    if (i == m.this.untilDateRow) {
                        if (m.this.bannedRights.b != 0 && Math.abs(m.this.bannedRights.b - (System.currentTimeMillis() / 1000)) <= 315360000) {
                            ...
                            B02 = org.telegram.messenger.u.B0("UserRestrictionsUntilForever", org.telegram.mdgram.R.string.UserRestrictionsUntilForever);
                        }
                        wu9Var.d(org.telegram.messenger.u.B0("UserRestrictionsDuration", org.telegram.mdgram.R.string.UserRestrictionsDuration), B02, false);
                        return;
                    }
                    return;
                case 7:
                    ...
                    if (xla.l(m.this.currentUser) && m.this.currentChat.f5609a) {
                        B03 = org.telegram.messenger.u.B0("ChannelCreator", org.telegram.mdgram.R.string.ChannelCreator);
                    } else {
                        B03 = org.telegram.messenger.u.B0("ChannelAdmin", org.telegram.mdgram.R.string.ChannelAdmin);
                    }
        ...
        public RecyclerView.d0 onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            switch (i) {
                ...
                case 8:
                    ...
                    sb.append(org.telegram.messenger.u.B0("AddBotButton", org.telegram.mdgram.R.string.AddBotButton));
                    sb.append(" ");
                    if (m.this.asAdmin) {
                        i2 = org.telegram.mdgram.R.string.AddBotButtonAsAdmin;
                        str = "AddBotButtonAsAdmin";
                    } else {
                        i2 = org.telegram.mdgram.R.string.AddBotButtonAsMember;
    ...
    public /* synthetic */ void W3(DatePicker datePicker, int i, int i2, int i3) {
        ...
        try {
            ...
            timePickerDialog.setButton(-1, org.telegram.messenger.u.B0("Set", org.telegram.mdgram.R.string.Set), timePickerDialog);
            timePickerDialog.setButton(-2, org.telegram.messenger.u.B0("Cancel", org.telegram.mdgram.R.string.Cancel), new DialogInterface.OnClickListener() { // from class: ci1
                    ...
                    if (intValue != 3) {
                        if (intValue == 4) {
                            ...
                            try {
                                ...
                                datePickerDialog.setButton(-1, org.telegram.messenger.u.B0("Set", org.telegram.mdgram.R.string.Set), datePickerDialog);
                                datePickerDialog.setButton(-2, org.telegram.messenger.u.B0("Cancel", org.telegram.mdgram.R.string.Cancel), new DialogInterface.OnClickListener() { // from class: mi1
                                    @Override // android.content.DialogInterface.OnClickListener
    ...
    public /* synthetic */ void a4(Context context, View view, int i) {
        ...
        if (i == this.removeAdminRow) {
            ...
            nu3Var.setHeight(47);
            nu3Var.setText(org.telegram.messenger.u.B0("UserRestrictionsDuration", org.telegram.mdgram.R.string.UserRestrictionsDuration));
            ...
            for (int i3 = 0; i3 < 5; i3++) {
                ...
                if (i3 != 0) {
                    if (i3 != 1) {
                        if (i3 != 2) {
                            if (i3 != 3) {
                                B0 = org.telegram.messenger.u.B0("UserRestrictionsCustom", org.telegram.mdgram.R.string.UserRestrictionsCustom);
                            } else {
                    ...
                    B0 = org.telegram.messenger.u.B0("UserRestrictionsUntilForever", org.telegram.mdgram.R.string.UserRestrictionsUntilForever);
                }
                iVarArr[i3].d(B0, 0);
            ...
            if (su9Var.a()) {
                if (this.currentType != 2) {
                    new e.k(E0()).x(org.telegram.messenger.u.B0("UserRestrictionsCantModify", org.telegram.mdgram.R.string.UserRestrictionsCantModify)).n(org.telegram.messenger.u.B0("UserRestrictionsCantModifyDisabled", org.telegram.mdgram.R.string.UserRestrictionsCantModifyDisabled)).v(org.telegram.messenger.u.B0("OK", org.telegram.mdgram.R.string.OK), null).a().show();
                }
                ...
                if (i4 == 2 || i4 == 0) {
                    if ((i == this.changeInfoRow && (tLRPC$TL_chatBannedRights2 = this.defaultBannedRights) != null && !tLRPC$TL_chatBannedRights2.j) || (i == this.pinMessagesRow && (tLRPC$TL_chatBannedRights = this.defaultBannedRights) != null && !tLRPC$TL_chatBannedRights.l)) {
                        new e.k(E0()).x(org.telegram.messenger.u.B0("UserRestrictionsCantModify", org.telegram.mdgram.R.string.UserRestrictionsCantModify)).n(org.telegram.messenger.u.B0("UserRestrictionsCantModifyEnabled", org.telegram.mdgram.R.string.UserRestrictionsCantModifyEnabled)).v(org.telegram.messenger.u.B0("OK", org.telegram.mdgram.R.string.OK), null).a().show();
                    }
                }
            } else {
                if (this.currentType != 2) {
        ...
        if (tLRPC$TL_error != null) {
            ...
            if ("PASSWORD_HASH_INVALID".equals(tLRPC$TL_error.f14225a)) {
                if (kn9Var == null) {
                    e.k kVar = new e.k(E0());
                    if (this.isChannel) {
                        kVar.x(org.telegram.messenger.u.B0("EditAdminChannelTransfer", org.telegram.mdgram.R.string.EditAdminChannelTransfer));
                    } else {
                        kVar.x(org.telegram.messenger.u.B0("EditAdminGroupTransfer", org.telegram.mdgram.R.string.EditAdminGroupTransfer));
                    }
                    kVar.n(org.telegram.messenger.a.b3(org.telegram.messenger.u.d0("EditAdminTransferReadyAlertText", org.telegram.mdgram.R.string.EditAdminTransferReadyAlertText, this.currentChat.f5602a, xla.a(this.currentUser))));
                    kVar.v(org.telegram.messenger.u.B0("EditAdminTransferChangeOwner", org.telegram.mdgram.R.string.EditAdminTransferChangeOwner), new DialogInterface.OnClickListener() { // from class: di1
                        @Override // android.content.DialogInterface.OnClickListener
                ...
                kVar2.x(org.telegram.messenger.u.B0("EditAdminTransferAlertTitle", org.telegram.mdgram.R.string.EditAdminTransferAlertTitle));
                ...
                if (this.isChannel) {
                    textView.setText(org.telegram.messenger.a.b3(org.telegram.messenger.u.d0("EditChannelAdminTransferAlertText", org.telegram.mdgram.R.string.EditChannelAdminTransferAlertText, xla.a(this.currentUser))));
                } else {
                    textView.setText(org.telegram.messenger.a.b3(org.telegram.messenger.u.d0("EditAdminTransferAlertText", org.telegram.mdgram.R.string.EditAdminTransferAlertText, xla.a(this.currentUser))));
                }
                ...
                textView2.setText(org.telegram.messenger.a.b3(org.telegram.messenger.u.B0("EditAdminTransferAlertText1", org.telegram.mdgram.R.string.EditAdminTransferAlertText1)));
                if (org.telegram.messenger.u.d) {
                ...
                imageView2.setImageResource(org.telegram.mdgram.R.drawable.list_circle);
                if (org.telegram.messenger.u.d) {
                ...
                textView3.setText(org.telegram.messenger.a.b3(org.telegram.messenger.u.B0("EditAdminTransferAlertText2", org.telegram.mdgram.R.string.EditAdminTransferAlertText2)));
                if (org.telegram.messenger.u.d) {
                ...
                if ("PASSWORD_MISSING".equals(tLRPC$TL_error.f14225a)) {
                    kVar2.v(org.telegram.messenger.u.B0("EditAdminTransferSetPassword", org.telegram.mdgram.R.string.EditAdminTransferSetPassword), new DialogInterface.OnClickListener() { // from class: ei1
                        @Override // android.content.DialogInterface.OnClickListener
                        public final void onClick(DialogInterface dialogInterface, int i7) {
                    ...
                    textView4.setText(org.telegram.messenger.u.B0("EditAdminTransferAlertText3", org.telegram.mdgram.R.string.EditAdminTransferAlertText3));
    ...
    public final boolean N3() {
        ...
        kVar.n(org.telegram.messenger.a.b3(org.telegram.messenger.u.d0("UserRestrictionsApplyChangesText", org.telegram.mdgram.R.string.UserRestrictionsApplyChangesText, org.telegram.messenger.y.u8(this.currentAccount).S7(Long.valueOf(this.chatId)).f5602a)));
        kVar.v(org.telegram.messenger.u.B0("ApplyTheme", org.telegram.mdgram.R.string.ApplyTheme), new DialogInterface.OnClickListener() { // from class: ji1
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i2) {
                org.telegram.ui.m.this.S3(dialogInterface, i2);
            }
        });
        kVar.p(org.telegram.messenger.u.B0("PassportDiscard", org.telegram.mdgram.R.string.PassportDiscard), new DialogInterface.OnClickListener() { // from class: ki1
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i2) {
    ...
    public View W(final Context context) {
        ...
        int i2 = this.currentType;
        if (i2 == 0) {
            this.actionBar.setTitle(org.telegram.messenger.u.B0("EditAdmin", org.telegram.mdgram.R.string.EditAdmin));
        } else if (i2 == 2) {
            this.actionBar.setTitle(org.telegram.messenger.u.B0("AddBot", org.telegram.mdgram.R.string.AddBot));
        } else {
            this.actionBar.setTitle(org.telegram.messenger.u.B0("UserRestrictions", org.telegram.mdgram.R.string.UserRestrictions));
        }
        ...
        if (this.canEdit || (!this.isChannel && this.currentChat.f5609a && xla.l(this.currentUser))) {
            ...
            Drawable mutate = context.getResources().getDrawable(org.telegram.mdgram.R.drawable.ic_ab_done).mutate();
            ...
            x.j(1, 0, org.telegram.messenger.a.e0(56.0f), org.telegram.messenger.u.B0("Done", org.telegram.mdgram.R.string.Done));
