    ...
    public class b extends v1.s {
        ...
        public void onBindViewHolder(RecyclerView.d0 d0Var, int i) {
            ...
            if (itemViewType != 0) {
                if (itemViewType != 1) {
                    if (itemViewType == 2) {
                        ...
                        if (i == s0.this.membersHeaderRow) {
                            fl3Var.setText(org.telegram.messenger.u.B0("ChannelOtherMembers", org.telegram.mdgram.R.string.ChannelOtherMembers));
                            return;
                        } else if (i == s0.this.contactsHeaderRow) {
                            if (s0.this.showContacts) {
                                fl3Var.setText(org.telegram.messenger.u.B0("YourContactsToInvite", org.telegram.mdgram.R.string.YourContactsToInvite));
                                return;
                            } else {
                                fl3Var.setText(org.telegram.messenger.u.B0("GroupContacts", org.telegram.mdgram.R.string.GroupContacts));
                                return;
                            }
                        } else {
                            return;
                ...
                if (i == s0.this.addNewRow) {
                    ...
                    u65Var.b(org.telegram.messenger.u.B0("VoipGroupCopyInviteLink", org.telegram.mdgram.R.string.VoipGroupCopyInviteLink), null, org.telegram.mdgram.R.drawable.msg_link, 7, z);
                    return;
                }
                return;
            }
        ...
        public RecyclerView.d0 onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            if (i != 0) {
                ...
                w65Var2.setCustomRightImage(org.telegram.mdgram.R.drawable.msg_invited);
