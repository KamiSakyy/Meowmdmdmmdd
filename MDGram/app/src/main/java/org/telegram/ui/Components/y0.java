...
public class y0 extends org.telegram.ui.ActionBar.g {
    ...
    public y0(Context context, org.telegram.tgnet.a aVar, String str, org.telegram.ui.ActionBar.f fVar, l.r rVar) {
        ...
        imageView.setImageResource(org.telegram.mdgram.R.drawable.ic_layer_close);
        ...
        if (hm9Var5 != null && !hm9Var5.e) {
            if (hm9Var5 != null) {
                ...
                uh7Var.cancelButton.setText(org.telegram.messenger.u.B0("Cancel", org.telegram.mdgram.R.string.Cancel).toUpperCase());
                ...
                if ((hm9Var6.f6960a && !hm9Var6.d) || (org.telegram.messenger.d.M(hm9Var6.f6956a) && !this.chatInvite.f6956a.h)) {
                    uh7Var.doneButtonTextView.setText(org.telegram.messenger.u.B0("ProfileJoinChannel", org.telegram.mdgram.R.string.ProfileJoinChannel).toUpperCase());
                } else {
                    uh7Var.doneButtonTextView.setText(org.telegram.messenger.u.B0("JoinGroup", org.telegram.mdgram.R.string.JoinGroup));
                }
        ...
        if (z) {
            i4 = org.telegram.mdgram.R.string.RequestToJoinChannel;
            str3 = "RequestToJoinChannel";
        } else {
            i4 = org.telegram.mdgram.R.string.RequestToJoinGroup;
        ...
        if (z) {
            i5 = org.telegram.mdgram.R.string.RequestToJoinChannelDescription;
            str4 = "RequestToJoinChannelDescription";
        } else {
            i5 = org.telegram.mdgram.R.string.RequestToJoinGroupDescription;
    ...
    public static void R1(Context context, org.telegram.ui.ActionBar.f fVar, boolean z) {
        ...
        rVar.imageView.g(org.telegram.mdgram.R.raw.timer_3, 28, 28);
        rVar.titleTextView.setText(org.telegram.messenger.u.B0("RequestToJoinSent", org.telegram.mdgram.R.string.RequestToJoinSent));
        if (z) {
            B0 = org.telegram.messenger.u.B0("RequestToJoinChannelSentDescription", org.telegram.mdgram.R.string.RequestToJoinChannelSentDescription);
        } else {
            B0 = org.telegram.messenger.u.B0("RequestToJoinGroupSentDescription", org.telegram.mdgram.R.string.RequestToJoinGroupSentDescription);
        }
