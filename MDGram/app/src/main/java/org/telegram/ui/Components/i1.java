...
public class i1 extends org.telegram.ui.ActionBar.g {
        ...
        public void d(View view, int i, int i2) {
            ...
            if (i2 == 1) {
                ...
                if (i >= i1.this.phoneStartRow && i < i1.this.phoneEndRow) {
                    ...
                    i3 = org.telegram.mdgram.R.drawable.msg_calls;
                } else {
                    iVar = (a.i) i1.this.other.get(i - i1.this.vcardStartRow);
                    int i4 = iVar.a;
                    if (i4 == 1) {
                        i3 = org.telegram.mdgram.R.drawable.msg_mention;
                    } else if (i4 == 2) {
                        i3 = org.telegram.mdgram.R.drawable.msg_location;
                    } else if (i4 == 3) {
                        i3 = org.telegram.mdgram.R.drawable.msg_link;
                    } else if (i4 == 4) {
                        i3 = org.telegram.mdgram.R.drawable.msg_info;
                    } else if (i4 == 5) {
                        i3 = org.telegram.mdgram.R.drawable.msg_calendar2;
                    } else if (i4 == 6) {
                        if ("ORG".equalsIgnoreCase(iVar.a(true))) {
                            i3 = org.telegram.mdgram.R.drawable.msg_work;
                        } else {
                            i3 = org.telegram.mdgram.R.drawable.msg_jobtitle;
                        }
                    } else if (i4 == 20) {
                        i3 = org.telegram.mdgram.R.drawable.msg_info;
                    } else {
        ...
        if (i2 == 0) {
            try {
                ...
                if (org.telegram.messenger.a.L3()) {
                    Toast.makeText(this.parentFragment.E0(), org.telegram.messenger.u.B0("TextCopied", org.telegram.mdgram.R.string.TextCopied), 0).show();
                }
            } catch (Exception e2) {
    ...
    public /* synthetic */ void t2(int i2, View view, View view2) {
        ...
        if (this.isImport) {
            ...
            if (i5 == 0) {
                ...
                kVar.l(new CharSequence[]{org.telegram.messenger.u.B0("Copy", org.telegram.mdgram.R.string.Copy)}, new DialogInterface.OnClickListener() { // from class: l87
                    @Override // android.content.DialogInterface.OnClickListener
    ...
    public /* synthetic */ boolean u2(int i2, l.r rVar, Context context, View view) {
        ...
        if (q.h(this.parentFragment)) {
            if (iVar.a == 3) {
                ...
                int i5 = iVar.a;
                if (i5 == 0) {
                    oVar.textView.setText(org.telegram.messenger.u.B0("PhoneCopied", org.telegram.mdgram.R.string.PhoneCopied));
                    oVar.imageView.setImageResource(org.telegram.mdgram.R.drawable.msg_calls);
                } else if (i5 == 1) {
                    oVar.textView.setText(org.telegram.messenger.u.B0("EmailCopied", org.telegram.mdgram.R.string.EmailCopied));
                    oVar.imageView.setImageResource(org.telegram.mdgram.R.drawable.msg_mention);
                } else {
                    oVar.textView.setText(org.telegram.messenger.u.B0("TextCopied", org.telegram.mdgram.R.string.TextCopied));
                    oVar.imageView.setImageResource(org.telegram.mdgram.R.drawable.msg_info);
                }
                if (org.telegram.messenger.a.L3()) {
    ...
    public /* synthetic */ void w2(l.r rVar, View view) {
        ...
        if (this.isImport) {
            ...
            kVar.x(org.telegram.messenger.u.B0("AddContactTitle", org.telegram.mdgram.R.string.AddContactTitle));
            kVar.p(org.telegram.messenger.u.B0("Cancel", org.telegram.mdgram.R.string.Cancel), null);
            kVar.l(new CharSequence[]{org.telegram.messenger.u.B0("CreateNewContact", org.telegram.mdgram.R.string.CreateNewContact), org.telegram.messenger.u.B0("AddToExistingContact", org.telegram.mdgram.R.string.AddToExistingContact)}, new e());
            kVar.G();
            return;
        }
