...
public abstract class a2 extends k3 implements y.p {
    ...
    public class h extends k3.f {
        ...
        public String e(int i) {
            if (this.items.get(i).type == 0) {
                return org.telegram.messenger.u.B0("SearchAllChatsShort", org.telegram.mdgram.R.string.SearchAllChatsShort);
            }
    ...
    public a2(Context context, org.telegram.ui.u uVar, int i, int i2, int i3, g gVar) {
        ...
        this.emptyView = dVar;
        dVar.title.setText(org.telegram.messenger.u.B0("NoResult", org.telegram.mdgram.R.string.NoResult));
    ...
    */
    ...
    public void p0(final int i) {
        if (i == 202) {
            ...
            if (fVar != null && fVar.E0() != null) {
                ...
                spannableStringBuilder.append((CharSequence) org.telegram.messenger.a.b3(org.telegram.messenger.u.U("RemoveDocumentsMessage", this.selectedFiles.size(), new Object[0]))).append((CharSequence) "\n\n").append((CharSequence) org.telegram.messenger.u.B0("RemoveDocumentsAlertMessage", org.telegram.mdgram.R.string.RemoveDocumentsAlertMessage));
                kVar.n(spannableStringBuilder);
                kVar.p(org.telegram.messenger.u.B0("Cancel", org.telegram.mdgram.R.string.Cancel), new DialogInterface.OnClickListener() { // from class: fn8
                    @Override // android.content.DialogInterface.OnClickListener
                    public final void onClick(DialogInterface dialogInterface, int i2) {
                        dialogInterface.dismiss();
                    }
                });
                kVar.v(org.telegram.messenger.u.B0("Delete", org.telegram.mdgram.R.string.Delete), new DialogInterface.OnClickListener() { // from class: gn8
                    @Override // android.content.DialogInterface.OnClickListener
                    public final void onClick(DialogInterface dialogInterface, int i2) {
    ...
    public final void w0(boolean z) {
        ...
        if (z && !this.parent.y().p("search_view_pager")) {
            ...
            org.telegram.ui.ActionBar.c j = this.actionMode.j(203, org.telegram.mdgram.R.drawable.avd_speed, org.telegram.messenger.a.e0(54.0f), org.telegram.messenger.u.B0("AccDescrPremiumSpeed", org.telegram.mdgram.R.string.AccDescrPremiumSpeed));
            this.speedItem = j;
            ...
            this.gotoItem = this.actionMode.j(200, org.telegram.mdgram.R.drawable.msg_message, org.telegram.messenger.a.e0(54.0f), org.telegram.messenger.u.B0("AccDescrGoToMessage", org.telegram.mdgram.R.string.AccDescrGoToMessage));
            this.forwardNoQuoteItem = this.actionMode.j(203, org.telegram.mdgram.R.drawable.md_fordwno_mention, org.telegram.messenger.a.e0(54.0f), org.telegram.messenger.u.B0("NoQuoteForward", org.telegram.mdgram.R.string.NoQuoteForward));
            this.forwardItem = this.actionMode.j(201, org.telegram.mdgram.R.drawable.msg_forward, org.telegram.messenger.a.e0(54.0f), org.telegram.messenger.u.B0("Forward", org.telegram.mdgram.R.string.Forward));
            this.deleteItem = this.actionMode.j(202, org.telegram.mdgram.R.drawable.msg_delete, org.telegram.messenger.a.e0(54.0f), org.telegram.messenger.u.B0("Delete", org.telegram.mdgram.R.string.Delete));
        }
