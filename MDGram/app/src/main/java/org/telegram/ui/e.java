...
public class e extends org.telegram.ui.ActionBar.f implements a0.d {
    ...
    public class g extends FrameLayout {
        ...
        public g(Context context) {
            ...
            this.title.setText(org.telegram.messenger.u.B0("StorageUsage", org.telegram.mdgram.R.string.StorageUsage));
            ...
            for (int i = 0; i < 3; i++) {
                ...
                if (i == 0) {
                    this.subtitle[i].setText(org.telegram.messenger.u.B0("StorageUsageCalculating", org.telegram.mdgram.R.string.StorageUsageCalculating));
                } else if (i == 1) {
                    this.subtitle[i].setAlpha(0.0f);
                    this.subtitle[i].setText(org.telegram.messenger.u.B0("StorageUsageTelegram", org.telegram.mdgram.R.string.StorageUsageTelegram));
                    this.subtitle[i].setVisibility(4);
                } else if (i == 2) {
                    this.subtitle[i].setText(org.telegram.messenger.u.B0("StorageCleared2", org.telegram.mdgram.R.string.StorageCleared2));
                    this.subtitle[i].setAlpha(0.0f);
                    this.subtitle[i].setVisibility(4);
                }
            ...
            Drawable mutate = getContext().getResources().getDrawable(org.telegram.mdgram.R.drawable.popup_fixed_alert2).mutate();
        ...
        public void f(boolean z, float f, float f2) {
            ...
            te teVar = this.title;
            if (z) {
                B0 = org.telegram.messenger.u.B0("StorageUsage", org.telegram.mdgram.R.string.StorageUsage);
            } else {
                B0 = org.telegram.messenger.u.B0("StorageCleared", org.telegram.mdgram.R.string.StorageCleared);
            }
            teVar.setText(B0);
            if (z) {
                if (f < 0.1f) {
                    this.subtitle[1].setText(org.telegram.messenger.u.d0("StorageUsageTelegramLess", org.telegram.mdgram.R.string.StorageUsageTelegramLess, e.this.J3(f)));
                } else {
                    this.subtitle[1].setText(org.telegram.messenger.u.d0("StorageUsageTelegram", org.telegram.mdgram.R.string.StorageUsageTelegram, e.this.J3(f)));
                }
                g(1);
            } else {
                g(2);
    ...
    public static class h extends FrameLayout {
        ...
        public h(Context context) {
            ...
            if (org.telegram.messenger.u.d) {
                ...
                textView.setText(org.telegram.messenger.u.B0("ClearCache", org.telegram.mdgram.R.string.ClearCache));
            ...
            this.textView.K(org.telegram.messenger.u.B0("ClearCache", org.telegram.mdgram.R.string.ClearCache));
            this.textView.I(5);
        ...
        public void a(boolean z, long j) {
            ...
            if (z) {
                B0 = org.telegram.messenger.u.B0("ClearCache", org.telegram.mdgram.R.string.ClearCache);
            } else {
                B0 = org.telegram.messenger.u.B0("ClearSelectedCache", org.telegram.mdgram.R.string.ClearSelectedCache);
            }
            aVar.K(B0);
    ...
    public class m extends j5 {
        ...
        public void onBindViewHolder(RecyclerView.d0 d0Var, int i) {
                    ...
                    if (itemViewType != 2) {
                        if (itemViewType != 3) {
                            ...
                            if (((l) e.this.itemInners.get(i)).keepMediaType == 0) {
                                pu9Var.k(org.telegram.messenger.u.B0("PrivateChats", org.telegram.mdgram.R.string.PrivateChats), f3, true, true);
                                pu9Var.b(e.this.K0("statisticChartLine_lightblue"), org.telegram.mdgram.R.drawable.msg_filled_menu_users);
                            } else if (((l) e.this.itemInners.get(i)).keepMediaType == 1) {
                                pu9Var.k(org.telegram.messenger.u.B0("GroupChats", org.telegram.mdgram.R.string.GroupChats), f3, true, true);
                                pu9Var.b(e.this.K0("statisticChartLine_green"), org.telegram.mdgram.R.drawable.msg_filled_menu_groups);
                            } else if (((l) e.this.itemInners.get(i)).keepMediaType == 2) {
                                pu9Var.k(org.telegram.messenger.u.B0("CacheChannels", org.telegram.mdgram.R.string.CacheChannels), f3, true, false);
                                pu9Var.b(e.this.K0("statisticChartLine_golden"), org.telegram.mdgram.R.drawable.msg_filled_menu_channels);
                            }
            ...
            if (i == e.this.migrateOldFolderRow) {
                uw9Var.d(org.telegram.messenger.u.B0("MigrateOldFolder", org.telegram.mdgram.R.string.MigrateOldFolder), null, false);
            }
        }
            ...
            if (i != 0) {
                switch (i) {
                    ...
                    case 4:
                        ...
                        h79Var.e(i2, org.telegram.messenger.u.U("Days", 3, new Object[0]), org.telegram.messenger.u.U("Weeks", 1, new Object[0]), org.telegram.messenger.u.U("Months", 1, new Object[0]), org.telegram.messenger.u.B0("KeepMediaForever", org.telegram.mdgram.R.string.KeepMediaForever));
                        iVar = h79Var;
                        break;
                    case 5:
                    ...
                    case 14:
                        ...
                        for (int i4 = 0; i4 < arrayList.size(); i4++) {
                            if (((Integer) arrayList.get(i4)).intValue() == 1) {
                                ...
                                strArr[i4] = org.telegram.messenger.u.B0("NoLimit", org.telegram.mdgram.R.string.NoLimit);
                            } else {
    ...
    public /* synthetic */ void T3(boolean z, long j2) {
        ...
        v0().f13256a.i();
        this.cacheRemovedTooltip.setInfoText(org.telegram.messenger.u.d0("CacheWasCleared", org.telegram.mdgram.R.string.CacheWasCleared, org.telegram.messenger.a.t0(j2)));
    ...
    public final void D3(j jVar, gh9.c[] cVarArr, oa0 oa0Var) {
        ...
        this.cacheRemovedTooltip.setInfoText(org.telegram.messenger.u.d0("CacheWasCleared", org.telegram.mdgram.R.string.CacheWasCleared, org.telegram.messenger.a.t0(j2 - this.totalSize)));
        this.cacheRemovedTooltip.H(0L, 19, null, null);
    ...
    public final void G3() {
        e.k kVar = new e.k(E0());
        kVar.x(org.telegram.messenger.u.B0("LocalDatabaseClearTextTitle", org.telegram.mdgram.R.string.LocalDatabaseClearTextTitle));
        SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder();
        spannableStringBuilder.append((CharSequence) org.telegram.messenger.u.B0("LocalDatabaseClearText", org.telegram.mdgram.R.string.LocalDatabaseClearText));
        spannableStringBuilder.append((CharSequence) "\n\n");
        spannableStringBuilder.append((CharSequence) org.telegram.messenger.a.b3(org.telegram.messenger.u.d0("LocalDatabaseClearText2", org.telegram.mdgram.R.string.LocalDatabaseClearText2, org.telegram.messenger.a.t0(this.databaseSize))));
        kVar.n(spannableStringBuilder);
        kVar.p(org.telegram.messenger.u.B0("Cancel", org.telegram.mdgram.R.string.Cancel), null);
        kVar.v(org.telegram.messenger.u.B0("CacheClear", org.telegram.mdgram.R.string.CacheClear), new DialogInterface.OnClickListener() { // from class: ba0
    ...
    public final void H3() {
        if (this.cacheModel.h() != 0 && E0() != null) {
            ...
            kVar.n(org.telegram.messenger.u.B0("ClearCacheForChats", org.telegram.mdgram.R.string.ClearCacheForChats));
            kVar.v(org.telegram.messenger.u.B0("Clear", org.telegram.mdgram.R.string.Clear), new DialogInterface.OnClickListener() { // from class: z90
                @Override // android.content.DialogInterface.OnClickListener
                public final void onClick(DialogInterface dialogInterface, int i2) {
    ...
    public View W(Context context) {
        ...
        this.actionBar.setTitle(org.telegram.messenger.u.B0("StorageUsage", org.telegram.mdgram.R.string.StorageUsage));
        ...
        this.actionModeClearButton.setText(org.telegram.messenger.u.B0("CacheClear", org.telegram.mdgram.R.string.CacheClear));
        ...
        org.telegram.ui.ActionBar.d U = this.actionBar.x().b(2, org.telegram.mdgram.R.drawable.ic_ab_other).U(3, org.telegram.mdgram.R.drawable.msg_delete, org.telegram.messenger.u.B0("ClearLocalDatabase", org.telegram.mdgram.R.string.ClearLocalDatabase));
    ...
    public final void t4() {
        if (this.clearDatabaseItem != null) {
            SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder();
            spannableStringBuilder.append((CharSequence) org.telegram.messenger.u.B0("ClearLocalDatabase", org.telegram.mdgram.R.string.ClearLocalDatabase));
