...
public class e extends Dialog implements Drawable.Callback, a0.d {
    ...
    public final void i1() {
        if (this.f15619c && this.f15595a == null) {
            ...
            kVar.p(u.B0("Stop", org.telegram.mdgram.R.string.Stop), new DialogInterface.OnClickListener() { // from class: i6
    ...
    public void onCreate(Bundle bundle) {
        ...
        if (this.i == 0) {
            this.f15601a[0] = (BitmapDrawable) getContext().getResources().getDrawable(org.telegram.mdgram.R.drawable.header_shadow).mutate();
            this.f15601a[1] = (BitmapDrawable) getContext().getResources().getDrawable(org.telegram.mdgram.R.drawable.header_shadow_reverse).mutate();
    ...
    public e(Context context, int i2, l.r rVar) {
        ...
        if (i2 != 3 || this.m) {
            this.f15607b = context.getResources().getDrawable(org.telegram.mdgram.R.drawable.popup_fixed_alert3).mutate();
