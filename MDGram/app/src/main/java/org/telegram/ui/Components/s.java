...
public class s extends e88 {
    ...
    public static final class d {
        ...
        static {
            c cVar = c.VOICE;
            c cVar2 = c.VIDEO;
            d dVar = new d("VOICE_TO_VIDEO", 0, cVar, cVar2, org.telegram.mdgram.R.raw.voice_to_video);
            VOICE_TO_VIDEO = dVar;
            c cVar3 = c.STICKER;
            c cVar4 = c.KEYBOARD;
            d dVar2 = new d("STICKER_TO_KEYBOARD", 1, cVar3, cVar4, org.telegram.mdgram.R.raw.sticker_to_keyboard);
            STICKER_TO_KEYBOARD = dVar2;
            c cVar5 = c.SMILE;
            d dVar3 = new d("SMILE_TO_KEYBOARD", 2, cVar5, cVar4, org.telegram.mdgram.R.raw.smile_to_keyboard);
            SMILE_TO_KEYBOARD = dVar3;
            d dVar4 = new d("VIDEO_TO_VOICE", 3, cVar2, cVar, org.telegram.mdgram.R.raw.video_to_voice);
            VIDEO_TO_VOICE = dVar4;
            d dVar5 = new d("KEYBOARD_TO_STICKER", 4, cVar4, cVar3, org.telegram.mdgram.R.raw.keyboard_to_sticker);
            KEYBOARD_TO_STICKER = dVar5;
            c cVar6 = c.GIF;
            d dVar6 = new d("KEYBOARD_TO_GIF", 5, cVar4, cVar6, org.telegram.mdgram.R.raw.keyboard_to_gif);
            KEYBOARD_TO_GIF = dVar6;
            d dVar7 = new d("KEYBOARD_TO_SMILE", 6, cVar4, cVar5, org.telegram.mdgram.R.raw.keyboard_to_smile);
            KEYBOARD_TO_SMILE = dVar7;
            d dVar8 = new d("GIF_TO_KEYBOARD", 7, cVar6, cVar4, org.telegram.mdgram.R.raw.gif_to_keyboard);
            GIF_TO_KEYBOARD = dVar8;
            d dVar9 = new d("GIF_TO_SMILE", 8, cVar6, cVar5, org.telegram.mdgram.R.raw.gif_to_smile);
            GIF_TO_SMILE = dVar9;
            d dVar10 = new d("SMILE_TO_GIF", 9, cVar5, cVar6, org.telegram.mdgram.R.raw.smile_to_gif);
            SMILE_TO_GIF = dVar10;
            d dVar11 = new d("SMILE_TO_STICKER", 10, cVar5, cVar3, org.telegram.mdgram.R.raw.smile_to_sticker);
            SMILE_TO_STICKER = dVar11;
            d dVar12 = new d("STICKER_TO_SMILE", 11, cVar3, cVar5, org.telegram.mdgram.R.raw.sticker_to_smile);
    ...
    public void p(c cVar, boolean z) {
        ...
        if (i != 1) {
            if (i == 2) {
                setContentDescription(org.telegram.messenger.u.B0("AccDescrVideoMessage", org.telegram.mdgram.R.string.AccDescrVideoMessage));
                return;
            }
            return;
        }
        setContentDescription(org.telegram.messenger.u.B0("AccDescrVoiceMessage", org.telegram.mdgram.R.string.AccDescrVoiceMessage));
    }
}
