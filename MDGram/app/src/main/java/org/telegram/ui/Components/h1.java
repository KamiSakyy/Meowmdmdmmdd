...
public class h1 extends org.telegram.ui.ActionBar.g {
    ...
    public h1(Context context, boolean z, final org.telegram.ui.ActionBar.f fVar, final gm9 gm9Var, long j, boolean z2) {
        ...
        int i2 = org.telegram.mdgram.R.raw.shared_link_enter;
        RLottieDrawable rLottieDrawable = new RLottieDrawable(i2, "" + org.telegram.mdgram.R.raw.shared_link_enter, org.telegram.messenger.a.e0(90.0f), org.telegram.messenger.a.e0(90.0f), false, null);
        ...
        textView.setText(org.telegram.messenger.u.B0("InviteLink", org.telegram.mdgram.R.string.InviteLink));
        ...
        if (z2) {
            i = org.telegram.mdgram.R.string.LinkInfoChannel;
            str = "LinkInfoChannel";
        } else {
            i = org.telegram.mdgram.R.string.LinkInfo;
            str = "LinkInfo";
        }
        ...
        textView3.setText(org.telegram.messenger.u.B0("ManageInviteLinks", org.telegram.mdgram.R.string.ManageInviteLinks));
    ...
    public /* synthetic */ void z1(TLRPC$TL_error tLRPC$TL_error, org.telegram.tgnet.a aVar, boolean z) {
        if (tLRPC$TL_error == null) {
            ...
            if (z && this.fragment != null) {
                ...
                kVar.n(org.telegram.messenger.u.B0("RevokeAlertNewLink", org.telegram.mdgram.R.string.RevokeAlertNewLink));
