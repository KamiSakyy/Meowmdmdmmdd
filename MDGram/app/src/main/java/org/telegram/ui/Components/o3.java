...
public class o3 extends ViewGroup implements i3.d, AudioManager.OnAudioFocusChangeListener {
    ...
    public o3(Context context, boolean z, boolean z2, o oVar) {
        ...
        if (z2) {
            ...
            this.shareButton.setImageResource(org.telegram.mdgram.R.drawable.ic_share_video);
    ...
    */
    ...
    public final void S0() {
        if (this.videoPlayer.p0() && !this.isInline) {
            ...
            if (!this.inFullscreen) {
                this.fullscreenButton.setImageResource(org.telegram.mdgram.R.drawable.ic_gofullscreen);
                this.fullscreenButton.setLayoutParams(cn4.c(56, 56.0f, 85, 0.0f, 0.0f, 0.0f, 5.0f));
                return;
            }
            this.fullscreenButton.setImageResource(org.telegram.mdgram.R.drawable.ic_outfullscreen);
    ...
    public final void U0() {
        ...
        if (this.isInline) {
            i2 = org.telegram.mdgram.R.drawable.ic_goinline;
        } else {
            i2 = org.telegram.mdgram.R.drawable.ic_outinline;
        }
    ...
    public final void V0() {
        ...
        if (!this.videoPlayer.q0()) {
            if (this.isCompleted) {
                ...
                if (this.isInline) {
                    i4 = org.telegram.mdgram.R.drawable.ic_againinline;
                } else {
                    i4 = org.telegram.mdgram.R.drawable.ic_again;
                }
            ...
            if (this.isInline) {
                i3 = org.telegram.mdgram.R.drawable.ic_playinline;
            } else {
                i3 = org.telegram.mdgram.R.drawable.ic_play;
            }
        ...
        if (this.isInline) {
            i2 = org.telegram.mdgram.R.drawable.ic_pauseinline;
        } else {
            i2 = org.telegram.mdgram.R.drawable.ic_pause;
        }
