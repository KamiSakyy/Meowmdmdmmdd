...
public class h extends org.telegram.ui.ActionBar.g implements a0.d, h.d {
    ...
    public class b implements c2.b {
        ...
        public CharSequence getContentDescription() {
            return org.telegram.messenger.u.d0("AccDescrPlayerDuration", org.telegram.mdgram.R.string.AccDescrPlayerDuration, org.telegram.messenger.u.U("Minutes", h.this.lastTime / 60, new Object[0]) + ' ' + org.telegram.messenger.u.U("Seconds", h.this.lastTime % 60, new Object[0]), org.telegram.messenger.u.U("Minutes", h.this.lastDuration / 60, new Object[0]) + ' ' + org.telegram.messenger.u.U("Seconds", h.this.lastDuration % 60, new Object[0]));
        }
    }
    ...
    public class w extends v1.s {
        ...
        public /* synthetic */ void m(ArrayList arrayList, String str) {
            ...
            h.this.emptySubtitleTextView.setText(org.telegram.messenger.a.b3(org.telegram.messenger.u.d0("NoAudioFoundPlayerInfo", org.telegram.mdgram.R.string.NoAudioFoundPlayerInfo, str)));
        }
    ...
    public h(Context context, l.r rVar) {
        ...
        this.actionBar.setTitle(org.telegram.messenger.u.B0("AttachMusic", org.telegram.mdgram.R.string.AttachMusic));
        ...
        org.telegram.ui.ActionBar.c P0 = this.actionBar.x().b(0, org.telegram.mdgram.R.drawable.ic_ab_search).R0(true).P0(new o());
        this.searchItem = P0;
        P0.setContentDescription(org.telegram.messenger.u.B0("Search", org.telegram.mdgram.R.string.Search));
        EditTextBoldCursor searchField = this.searchItem.getSearchField();
        searchField.setHint(org.telegram.messenger.u.B0("Search", org.telegram.mdgram.R.string.Search));
        ...
        view.setAlpha(0.0f);
        this.actionBarShadow.setBackgroundResource(org.telegram.mdgram.R.drawable.header_shadow);
        ...
        this.playbackSpeedButton.setContentDescription(org.telegram.messenger.u.B0("AccDescrPlayerSpeed", org.telegram.mdgram.R.string.AccDescrPlayerSpeed));
        ...
        this.speedItems[0] = this.playbackSpeedButton.U(1, org.telegram.mdgram.R.drawable.msg_speed_0_5, org.telegram.messenger.u.B0("SpeedSlow", org.telegram.mdgram.R.string.SpeedSlow));
        this.speedItems[1] = this.playbackSpeedButton.U(2, org.telegram.mdgram.R.drawable.msg_speed_1, org.telegram.messenger.u.B0("SpeedNormal", org.telegram.mdgram.R.string.SpeedNormal));
        this.speedItems[2] = this.playbackSpeedButton.U(3, org.telegram.mdgram.R.drawable.msg_speed_1_5, org.telegram.messenger.u.B0("SpeedFast", org.telegram.mdgram.R.string.SpeedFast));
        this.speedItems[3] = this.playbackSpeedButton.U(4, org.telegram.mdgram.R.drawable.msg_speed_2, org.telegram.messenger.u.B0("SpeedVeryFast", org.telegram.mdgram.R.string.SpeedVeryFast));
        ...
        this.repeatSongItem = this.repeatButton.U(3, org.telegram.mdgram.R.drawable.player_new_repeatone, org.telegram.messenger.u.B0("RepeatSong", org.telegram.mdgram.R.string.RepeatSong));
        this.repeatListItem = this.repeatButton.U(4, org.telegram.mdgram.R.drawable.player_new_repeatall, org.telegram.messenger.u.B0("RepeatList", org.telegram.mdgram.R.string.RepeatList));
        this.shuffleListItem = this.repeatButton.U(2, org.telegram.mdgram.R.drawable.player_new_shuffle, org.telegram.messenger.u.B0("ShuffleList", org.telegram.mdgram.R.string.ShuffleList));
        this.reverseOrderItem = this.repeatButton.U(1, org.telegram.mdgram.R.drawable.player_new_order, org.telegram.messenger.u.B0("ReverseOrder", org.telegram.mdgram.R.string.ReverseOrder));
        ...
        this.prevButton.g(org.telegram.mdgram.R.raw.player_prev, 20, 20);
        ...
        this.prevButton.setContentDescription(org.telegram.messenger.u.B0("AccDescrPrevious", org.telegram.mdgram.R.string.AccDescrPrevious));
        ...
        this.nextButton.g(org.telegram.mdgram.R.raw.player_prev, 20, 20);
        ...
        this.nextButton.setContentDescription(org.telegram.messenger.u.B0("Next", org.telegram.mdgram.R.string.Next));
        ...
        this.optionsButton.U(1, org.telegram.mdgram.R.drawable.msg_forward, org.telegram.messenger.u.B0("Forward", org.telegram.mdgram.R.string.Forward));
        this.optionsButton.U(2, org.telegram.mdgram.R.drawable.msg_shareout, org.telegram.messenger.u.B0("ShareFile", org.telegram.mdgram.R.string.ShareFile));
        this.optionsButton.U(5, org.telegram.mdgram.R.drawable.msg_download, org.telegram.messenger.u.B0("SaveToMusic", org.telegram.mdgram.R.string.SaveToMusic));
        this.optionsButton.U(4, org.telegram.mdgram.R.drawable.msg_message, org.telegram.messenger.u.B0("ShowInChat", org.telegram.mdgram.R.string.ShowInChat));
        ...
        imageView3.setImageResource(org.telegram.mdgram.R.drawable.music_empty);
        ...
        this.emptyTitleTextView.setText(org.telegram.messenger.u.B0("NoAudioFound", org.telegram.mdgram.R.string.NoAudioFound));
    ...
    public final void A3() {
        ...
        if (Math.abs(F1 - 1.8f) < 0.001f) {
            this.playbackSpeedButton.setIcon(org.telegram.mdgram.R.drawable.voice_mini_2_0);
        } else if (Math.abs(F1 - 1.5f) < 0.001f) {
            this.playbackSpeedButton.setIcon(org.telegram.mdgram.R.drawable.voice_mini_1_5);
        } else {
            this.playbackSpeedButton.setIcon(org.telegram.mdgram.R.drawable.voice_mini_0_5);
        }
    ...
    public final void D3() {
        ...
        if (i2 != 0 && i2 != 1) {
            if (i2 == 2) {
                this.repeatButton.setIcon(org.telegram.mdgram.R.drawable.player_new_repeatone);
                ...
                this.repeatButton.setContentDescription(org.telegram.messenger.u.B0("AccDescrRepeatOne", org.telegram.mdgram.R.string.AccDescrRepeatOne));
                return;
            }
            return;
        }
        if (org.telegram.messenger.e0.M) {
            if (i2 == 0) {
                this.repeatButton.setIcon(org.telegram.mdgram.R.drawable.player_new_shuffle);
            } else {
                this.repeatButton.setIcon(org.telegram.mdgram.R.drawable.player_new_repeat_shuffle);
            }
        } else if (org.telegram.messenger.e0.N) {
            if (i2 == 0) {
                this.repeatButton.setIcon(org.telegram.mdgram.R.drawable.player_new_order);
            } else {
                this.repeatButton.setIcon(org.telegram.mdgram.R.drawable.player_new_repeat_reverse);
            }
        } else {
            this.repeatButton.setIcon(org.telegram.mdgram.R.drawable.player_new_repeatall);
        }
        if (i2 == 0 && !org.telegram.messenger.e0.M && !org.telegram.messenger.e0.N) {
            ...
            org.telegram.ui.ActionBar.l.H3(this.repeatButton.getBackground(), w0("listSelectorSDK21"), true);
            this.repeatButton.setContentDescription(org.telegram.messenger.u.B0("AccDescrRepeatOff", org.telegram.mdgram.R.string.AccDescrRepeatOff));
            return;
        }
        this.repeatButton.setTag("player_buttonActive");
        this.repeatButton.setIconColor(w0("player_buttonActive"));
        ...
        if (i2 == 0) {
            if (org.telegram.messenger.e0.M) {
                this.repeatButton.setContentDescription(org.telegram.messenger.u.B0("ShuffleList", org.telegram.mdgram.R.string.ShuffleList));
                return;
            } else {
                this.repeatButton.setContentDescription(org.telegram.messenger.u.B0("ReverseOrder", org.telegram.mdgram.R.string.ReverseOrder));
                return;
            }
        }
        this.repeatButton.setContentDescription(org.telegram.messenger.u.B0("AccDescrRepeatList", org.telegram.mdgram.R.string.AccDescrRepeatList));
    }
    ...
    public final void F3(boolean z) {
        ...
        if ((J1 == null && z) || (J1 != null && !J1.P2())) {
            ...
            if (MediaController.H1().V1()) {
                ...
                this.playButton.setContentDescription(org.telegram.messenger.u.B0("AccActionPlay", org.telegram.mdgram.R.string.AccActionPlay));
            } else {
                this.playPauseDrawable.c(true);
                this.playButton.setContentDescription(org.telegram.messenger.u.B0("AccActionPause", org.telegram.mdgram.R.string.AccActionPause));
            }
            String U0 = J1.U0();
            String S0 = J1.S0();
