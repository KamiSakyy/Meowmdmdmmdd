...
public class x0 extends org.telegram.ui.ActionBar.g {
    ...
    public class g extends v1.s {
        ...
        public void onBindViewHolder(RecyclerView.d0 d0Var, int i) {
            ...
            if (X0 > 0) {
                ...
                str = org.telegram.messenger.u.B0("VoipGroupPersonalAccount", org.telegram.mdgram.R.string.VoipGroupPersonalAccount);
            } else {
    ...
    public x0(Context context, long j, ArrayList arrayList, int i, dp9 dp9Var, final f fVar) {
        ...
        if (i == 0) {
            ...
            e88Var.g(org.telegram.mdgram.R.raw.utyan_schedule, Constants.MEMORY_PAGE_DATA_OVERFLOW, Constants.MEMORY_PAGE_DATA_OVERFLOW);
            e88Var.e();
        ...
        if (i == 0) {
            if (org.telegram.messenger.d.P(S7)) {
                this.textView.setText(org.telegram.messenger.u.B0("StartVoipChannelTitle", org.telegram.mdgram.R.string.StartVoipChannelTitle));
            } else {
                this.textView.setText(org.telegram.messenger.u.B0("StartVoipChatTitle", org.telegram.mdgram.R.string.StartVoipChatTitle));
            }
            bVar.addView(this.textView, cn4.n(-2, -2, 49, 23, 16, 23, 0));
        } else {
            if (i == 2) {
                this.textView.setText(org.telegram.messenger.u.B0("VoipGroupDisplayAs", org.telegram.mdgram.R.string.VoipGroupDisplayAs));
            } else if (org.telegram.messenger.d.P(S7)) {
                this.textView.setText(org.telegram.messenger.u.B0("VoipChannelJoinAs", org.telegram.mdgram.R.string.VoipChannelJoinAs));
            } else {
                this.textView.setText(org.telegram.messenger.u.B0("VoipGroupJoinAs", org.telegram.mdgram.R.string.VoipGroupJoinAs));
            }
        ...
        if (i == 0) {
            ...
            if (org.telegram.messenger.d.M(S7) && !S7.h) {
                sb.append(org.telegram.messenger.u.B0("VoipChannelStart2", org.telegram.mdgram.R.string.VoipChannelStart2));
            } else {
                sb.append(org.telegram.messenger.u.B0("VoipGroupStart2", org.telegram.mdgram.R.string.VoipGroupStart2));
            }
            if (this.chats.size() > 1) {
                sb.append("\n\n");
                sb.append(org.telegram.messenger.u.B0("VoipChatDisplayedAs", org.telegram.mdgram.R.string.VoipChatDisplayedAs));
            } else {
            ...
            if (z) {
                this.messageTextView.setText(org.telegram.messenger.u.B0("VoipGroupStartAsInfoGroup", org.telegram.mdgram.R.string.VoipGroupStartAsInfoGroup));
            } else {
                this.messageTextView.setText(org.telegram.messenger.u.B0("VoipGroupStartAsInfo", org.telegram.mdgram.R.string.VoipGroupStartAsInfo));
            }
        ...
        if (this.currentType == 0) {
            ...
            if (org.telegram.messenger.d.P(S7)) {
                eVar2.c(org.telegram.messenger.u.B0("VoipChannelScheduleVoiceChat", org.telegram.mdgram.R.string.VoipChannelScheduleVoiceChat), false);
            } else {
                eVar2.c(org.telegram.messenger.u.B0("VoipGroupScheduleVoiceChat", org.telegram.mdgram.R.string.VoipGroupScheduleVoiceChat), false);
            }
    ...
    public final void e2(boolean z, fm9 fm9Var) {
        ...
        if (this.currentType == 0) {
            if (org.telegram.messenger.d.P(fm9Var)) {
                this.doneButton.c(org.telegram.messenger.u.d0("VoipChannelStartVoiceChat", org.telegram.mdgram.R.string.VoipChannelStartVoiceChat, new Object[0]), z);
                return;
            } else {
                this.doneButton.c(org.telegram.messenger.u.d0("VoipGroupStartVoiceChat", org.telegram.mdgram.R.string.VoipGroupStartVoiceChat, new Object[0]), z);
                return;
            }
        }
        long X0 = org.telegram.messenger.x.X0(this.selectedPeer);
        if (ic2.k(X0)) {
            this.doneButton.c(org.telegram.messenger.u.d0("VoipGroupContinueAs", org.telegram.mdgram.R.string.VoipGroupContinueAs, xla.a(org.telegram.messenger.y.u8(this.currentAccount).R8(Long.valueOf(X0)))), z);
            return;
        }
        fm9 S7 = org.telegram.messenger.y.u8(this.currentAccount).S7(Long.valueOf(-X0));
        e eVar = this.doneButton;
        int i = org.telegram.mdgram.R.string.VoipGroupContinueAs;
