...
public class ChatActivityEnterView extends p10 implements a0.d, l2.d, p2.r {
    ...
    public class RecordCircle extends View {
        ...
        public class a extends dy2 {
            ...
            public void N(int i, defpackage.l2 l2Var) {
                if (i == 1) {
                    ...
                    l2Var.x0(org.telegram.messenger.u.B0("Send", org.telegram.mdgram.R.string.Send));
                } else if (i == 2) {
                    ...
                    l2Var.x0(org.telegram.messenger.u.B0("Stop", org.telegram.mdgram.R.string.Stop));
                } else if (i == 3) {
                    if (ChatActivityEnterView.this.slideText != null && ChatActivityEnterView.this.slideText.cancelRect != null) {
                    ...
                    l2Var.x0(org.telegram.messenger.u.B0("Cancel", org.telegram.mdgram.R.string.Cancel));
                }
            }
        }
        ...
        public RecordCircle(Context context) {
            ...
            this.showWaves = true;
            this.p = new Paint(1);
            ChatActivityEnterView.this.micDrawable = getResources().getDrawable(org.telegram.mdgram.R.drawable.input_mic_pressed).mutate();
            ...
            ChatActivityEnterView.this.cameraDrawable = getResources().getDrawable(org.telegram.mdgram.R.drawable.input_video_pressed).mutate();
            ...
            ChatActivityEnterView.this.sendDrawable = getResources().getDrawable(org.telegram.mdgram.R.drawable.attach_send).mutate();
            ...
            ChatActivityEnterView.this.micOutline = getResources().getDrawable(org.telegram.mdgram.R.drawable.input_mic).mutate();
            ...
            ChatActivityEnterView.this.cameraOutline = getResources().getDrawable(org.telegram.mdgram.R.drawable.input_video).mutate();
            ...
            ChatActivityEnterView.this.lockShadowDrawable = getResources().getDrawable(org.telegram.mdgram.R.drawable.lock_round_shadow);
            ...
            this.tooltipBackgroundArrow = sz1.e(context, org.telegram.mdgram.R.drawable.tooltip_arrow);
            this.tooltipMessage = org.telegram.messenger.u.B0("SlideUpToLock", org.telegram.mdgram.R.string.SlideUpToLock);
            this.iconScale = 1.0f;
    ...
    public class SlideTextView extends View {
        ...
        public SlideTextView(Context context) {
            ...
            this.slideToCancelString = org.telegram.messenger.u.B0("SlideToCancel", org.telegram.mdgram.R.string.SlideToCancel);
            this.slideToCancelString = this.slideToCancelString.charAt(0) + this.slideToCancelString.substring(1).toLowerCase();
            String upperCase = org.telegram.messenger.u.B0("Cancel", org.telegram.mdgram.R.string.Cancel).toUpperCase();
    ...
    public class b1 implements k0.a1 {
        ...
        public void n() {
            if (ChatActivityEnterView.this.parentFragment != null && ChatActivityEnterView.this.parentActivity != null) {
                ...
                kVar.v(org.telegram.messenger.u.B0("ClearButton", org.telegram.mdgram.R.string.ClearForAll), new DialogInterface.OnClickListener() { // from class: k21
    ...
    public class m implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            if (ChatActivityEnterView.this.notifySilentDrawable == null) {
                ChatActivityEnterView.this.notifySilentDrawable = new g22(this.val$context, org.telegram.mdgram.R.drawable.input_notify_on, "chat_messagePanelIcons");
            }
            ...
            if (ChatActivityEnterView.this.silent) {
                i2 = org.telegram.mdgram.R.string.AccDescrChanSilentOn;
                str = "AccDescrChanSilentOn";
            } else {
                i2 = org.telegram.mdgram.R.string.AccDescrChanSilentOff;
    ...
    public class t1 extends View {
        ...
        public t1(Context context) {
            super(context);
            int i = org.telegram.mdgram.R.raw.chat_audio_record_delete;
    ...
    public /* synthetic */ void K4(final n59 n59Var, int[] iArr, f2.i iVar) {
        ...
        final Dialog dialog = new Dialog(getContext(), org.telegram.mdgram.R.style.TransparentDialogNoAnimation);
    ...
    public /* synthetic */ void O4(View view) {
        ...
        if (MediaController.H1().Y1(this.audioToSendMessageObject) && !MediaController.H1().V1()) {
            ...
            this.recordedAudioPlayButton.setContentDescription(org.telegram.messenger.u.B0("AccActionPlay", org.telegram.mdgram.R.string.AccActionPlay));
            return;
        }
        this.playPauseDrawable.m(1, true);
        MediaController.H1().e3(this.audioToSendMessageObject);
        this.recordedAudioPlayButton.setContentDescription(org.telegram.messenger.u.B0("AccActionPause", org.telegram.mdgram.R.string.AccActionPause));
    }
                ...
                for (org.telegram.ui.Components.d dVar : dVarArr) {
                    if (dVar != null) {
                        ...
                        if (tm9Var != null && !org.telegram.messenger.x.o2(tm9Var)) {
                            org.telegram.ui.Components.q.o0(frameLayout, fVar.j()).A(tm9Var, org.telegram.messenger.a.b3(org.telegram.messenger.u.B0("UnlockPremiumEmojiHint", org.telegram.mdgram.R.string.UnlockPremiumEmojiHint)), org.telegram.messenger.u.B0("PremiumMore", org.telegram.mdgram.R.string.PremiumMore), new Runnable() { // from class: m11
                                @Override // java.lang.Runnable
                                public final void run() {
    ...
    public /* synthetic */ void r5(org.telegram.ui.ActionBar.d dVar) {
        ...
        dVar.f(org.telegram.messenger.u.B0("TranslateMessage", org.telegram.mdgram.R.string.TranslateMessage) + " (" + upperCase + ")", org.telegram.mdgram.R.drawable.msg_translate);
        L6();
    }
    ...
    public final void M6(boolean z2) {
        ...
        if (!f4 && !this.hasBotCommands && this.botReplyMarkup == null) {
            ...
            if (s4() && this.currentPopupContentType == 1) {
                ...
                this.botButtonDrawable.d(org.telegram.mdgram.R.drawable.input_bot2, true);
                this.botButton.setContentDescription(org.telegram.messenger.u.B0("AccDescrBotKeyboard", org.telegram.mdgram.R.string.AccDescrBotKeyboard));
            }
        } else if (!z3) {
            this.botButtonDrawable.d(org.telegram.mdgram.R.drawable.input_bot1, true);
            this.botButton.setContentDescription(org.telegram.messenger.u.B0("AccDescrBotCommands", org.telegram.mdgram.R.string.AccDescrBotCommands));
            this.botButton.setVisibility(0);
        } else {
            this.botButton.setVisibility(8);
        }
        ...
        if (this.botMenuButtonType == r1.COMMANDS) {
            str = org.telegram.messenger.u.z0(org.telegram.mdgram.R.string.BotsMenuTitle);
        } else {
    ...
    public void P6(boolean z2) {
        ...
        if (this.editingMessageObject != null) {
            ...
            if (this.editingCaption) {
                i2 = org.telegram.mdgram.R.string.Caption;
                str = "Caption";
            } else {
                i2 = org.telegram.mdgram.R.string.TypeMessage;
            }
            ...
            if (z4) {
                this.messageEditText.setHintText(org.telegram.messenger.u.B0("TypeMessage", org.telegram.mdgram.R.string.TypeMessage));
                return;
            }
            org.telegram.ui.j jVar = this.parentFragment;
            if (jVar != null && jVar.nl()) {
                ...
                if (!jVar2.isTopic) {
                    if (jVar2.jl()) {
                        this.messageEditText.setHintText(org.telegram.messenger.u.B0("Comment", org.telegram.mdgram.R.string.Comment));
                        return;
                    } else {
                        this.messageEditText.setHintText(org.telegram.messenger.u.B0("Reply", org.telegram.mdgram.R.string.Reply));
                        return;
                    }
                }
            }
            if (z3) {
                if (this.silent) {
                    this.messageEditText.L(org.telegram.messenger.u.B0("ChannelSilentBroadcast", org.telegram.mdgram.R.string.ChannelSilentBroadcast), z2);
                    return;
                } else {
                    this.messageEditText.L(org.telegram.messenger.u.B0("ChannelBroadcast", org.telegram.mdgram.R.string.ChannelBroadcast), z2);
                    return;
                }
            }
            this.messageEditText.setHintText(org.telegram.messenger.u.B0("TypeMessage", org.telegram.mdgram.R.string.TypeMessage));
        ...
        if (ic2.h(this.dialog_id)) {
            ...
            if (this.notifyButton != null) {
                if (this.notifySilentDrawable == null) {
                    this.notifySilentDrawable = new g22(getContext(), org.telegram.mdgram.R.drawable.input_notify_on, "chat_messagePanelIcons");
                }
    ...
    */
        ...
        if (dp9Var != null) {
            if (dp9Var.c != 0) {
                ...
                if (S7 != null) {
                    ...
                    this.senderSelectView.setContentDescription(org.telegram.messenger.u.c0(org.telegram.mdgram.R.string.AccDescrSendAs, S7.f5602a));
                }
            } else {
                mq9 R8 = org.telegram.messenger.y.u8(this.currentAccount).R8(Long.valueOf(dp9Var.a));
                if (R8 != null) {
                    this.senderSelectView.setAvatar(R8);
                    this.senderSelectView.setContentDescription(org.telegram.messenger.u.c0(org.telegram.mdgram.R.string.AccDescrSendAs, org.telegram.messenger.e.E0(R8.f10558a, R8.f10565b)));
                }
            }
        }
    ...
    public final void Y5() {
        ...
        if (b49.c(this.currentAccount, this.dialog_id)) {
            ...
            new e.k(this.parentFragment.E0()).x(org.telegram.messenger.u.z0(org.telegram.mdgram.R.string.BotOpenPageTitle)).n(org.telegram.messenger.a.b3(org.telegram.messenger.u.c0(org.telegram.mdgram.R.string.BotOpenPageMessage, xla.e(org.telegram.messenger.y.u8(this.currentAccount).R8(Long.valueOf(this.dialog_id)))))).v(org.telegram.messenger.u.z0(org.telegram.mdgram.R.string.OK), new DialogInterface.OnClickListener() { // from class: k11
                @Override // android.content.DialogInterface.OnClickListener
                public final void onClick(DialogInterface dialogInterface, int i2) {
                    ChatActivityEnterView.this.v5(runnable, dialogInterface, i2);
                }
            }).p(org.telegram.messenger.u.z0(org.telegram.mdgram.R.string.Cancel), null).t(new DialogInterface.OnDismissListener() { // from class: l11
        ...
        if (jo9Var instanceof TLRPC$TL_keyboardButton) {
            ...
            if (jo9Var instanceof TLRPC$TL_keyboardButtonRequestPoll) {
                ...
                if (jo9Var instanceof TLRPC$TL_keyboardButtonRequestGeoLocation) {
                    ...
                    kVar.x(org.telegram.messenger.u.B0("ShareYouLocationTitle", org.telegram.mdgram.R.string.ShareYouLocationTitle));
                    kVar.n(org.telegram.messenger.u.B0("ShareYouLocationInfo", org.telegram.mdgram.R.string.ShareYouLocationInfo));
                    kVar.v(org.telegram.messenger.u.B0("OK", org.telegram.mdgram.R.string.OK), new DialogInterface.OnClickListener() { // from class: g11
                        @Override // android.content.DialogInterface.OnClickListener
                        public final void onClick(DialogInterface dialogInterface, int i2) {
                ...
                if (b49.c(this.currentAccount, j4)) {
                    ...
                    new e.k(this.parentFragment.E0()).x(org.telegram.messenger.u.z0(org.telegram.mdgram.R.string.BotOpenPageTitle)).n(org.telegram.messenger.a.b3(org.telegram.messenger.u.d0("BotOpenPageMessage", org.telegram.mdgram.R.string.BotOpenPageMessage, xla.e(R82)))).v(org.telegram.messenger.u.z0(org.telegram.mdgram.R.string.OK), new DialogInterface.OnClickListener() { // from class: f11
                        @Override // android.content.DialogInterface.OnClickListener
                        public final void onClick(DialogInterface dialogInterface, int i2) {
        ...
        if (this.videoToSendMessageObject != null) {
            ...
            if (jVar2 != null && (d2 = jVar2.d()) != null && d2.f5618f && !org.telegram.messenger.d.E(d2)) {
                if (text.length() > this.accountInstance.l().N) {
                    org.telegram.ui.Components.b.W5(this.parentFragment, org.telegram.messenger.u.B0("Slowmode", org.telegram.mdgram.R.string.Slowmode), org.telegram.messenger.u.B0("SlowmodeSendErrorTooLong", org.telegram.mdgram.R.string.SlowmodeSendErrorTooLong), this.resourcesProvider);
                    return;
                } else if (this.forceShowSendButton && text.length() > 0) {
                    org.telegram.ui.Components.b.W5(this.parentFragment, org.telegram.messenger.u.B0("Slowmode", org.telegram.mdgram.R.string.Slowmode), org.telegram.messenger.u.B0("SlowmodeSendError", org.telegram.mdgram.R.string.SlowmodeSendError), this.resourcesProvider);
                    return;
                }
            }
    ...
    */
    ...
    public final void u6(boolean z2, boolean z3) {
        ...
        if (p4()) {
            i2 = org.telegram.mdgram.R.string.AccDescrVideoMessage;
        } else {
            i2 = org.telegram.mdgram.R.string.AccDescrVoiceMessage;
        }
        sVar2.setContentDescription(org.telegram.messenger.u.z0(i2));
        FrameLayout frameLayout = this.audioVideoButtonContainer;
        if (p4()) {
            i3 = org.telegram.mdgram.R.string.AccDescrVideoMessage;
        } else {
            i3 = org.telegram.mdgram.R.string.AccDescrVoiceMessage;
        }
    ...
    public void x6(boolean z2, boolean z3, boolean z4, boolean z5) {
        ...
        if ((p5Var == null || !p5Var.i()) && !this.waitingForKeyboardOpenAfterAnimation && this.emojiView != null) {
            if (z4 || this.stickersExpanded != z2) {
                ...
                if (z2) {
                    this.expandStickersButton.setContentDescription(org.telegram.messenger.u.B0("AccDescrCollapsePanel", org.telegram.mdgram.R.string.AccDescrCollapsePanel));
                } else {
                    this.expandStickersButton.setContentDescription(org.telegram.messenger.u.B0("AccDescrExpandPanel", org.telegram.mdgram.R.string.AccDescrExpandPanel));
                }
            }
        }
    }
    ...
    public ChatActivityEnterView(final Activity activity, l2 l2Var, org.telegram.ui.j jVar, boolean z2, final l.r rVar) {
        ...
        gVar.setContentDescription(org.telegram.messenger.u.z0(org.telegram.mdgram.R.string.AccDescrEmojiButton));
        ...
        if (MDConfig.actionbarChatStyle) {
            ...
            this.attachButton.setImageResource(org.telegram.mdgram.R.drawable.msg_add);
        } else {
            imageView.setColorFilter(new PorterDuffColorFilter(c4("chat_messagePanelIcons"), PorterDuff.Mode.MULTIPLY));
            this.attachButton.setImageResource(org.telegram.mdgram.R.drawable.input_attach);
        }
        ...
        this.attachButton.setContentDescription(org.telegram.messenger.u.B0("AccDescrAttachButton", org.telegram.mdgram.R.string.AccDescrAttachButton));
        p6(false, false);
        ...
        if (z2) {
            if (this.parentFragment != null) {
                Drawable mutate = activity.getResources().getDrawable(org.telegram.mdgram.R.drawable.input_calendar1).mutate();
                Drawable mutate2 = activity.getResources().getDrawable(org.telegram.mdgram.R.drawable.input_calendar2).mutate();
                ...
                this.scheduledButton.setVisibility(8);
                this.scheduledButton.setContentDescription(org.telegram.messenger.u.B0("ScheduledMessages", org.telegram.mdgram.R.string.ScheduledMessages));
            ...
            this.botButtonDrawable.d(org.telegram.mdgram.R.drawable.input_bot2, false);
            ...
            g22 g22Var = new g22(activity, org.telegram.mdgram.R.drawable.input_notify_on, "chat_messagePanelIcons");
            this.notifySilentDrawable = g22Var;
            this.notifyButton.setImageDrawable(g22Var);
            this.notifySilentDrawable.b(this.silent, false);
            ImageView imageView4 = this.notifyButton;
            if (this.silent) {
                i3 = org.telegram.mdgram.R.string.AccDescrChanSilentOn;
                str = "AccDescrChanSilentOn";
            } else {
                i3 = org.telegram.mdgram.R.string.AccDescrChanSilentOff;
                str = "AccDescrChanSilentOff";
            }
        ...
        this.recordDeleteImageView.g(org.telegram.mdgram.R.raw.chat_audio_record_delete_2, 28, 28);
        this.recordDeleteImageView.getAnimatedDrawable().F0(true);
        S6();
        this.recordDeleteImageView.setContentDescription(org.telegram.messenger.u.B0("Delete", org.telegram.mdgram.R.string.Delete));
        ...
        this.cancelBotButton.setContentDescription(org.telegram.messenger.u.B0("Cancel", org.telegram.mdgram.R.string.Cancel));
        ...
        if (c()) {
            this.sendButtonDrawable = activity.getResources().getDrawable(org.telegram.mdgram.R.drawable.input_schedule).mutate();
            this.sendButtonInverseDrawable = activity.getResources().getDrawable(org.telegram.mdgram.R.drawable.input_schedule).mutate();
            this.inactinveSendButtonDrawable = activity.getResources().getDrawable(org.telegram.mdgram.R.drawable.input_schedule).mutate();
        } else if (MDConfig.actionbarChatStyle) {
            this.sendButtonDrawable = activity.getResources().getDrawable(org.telegram.mdgram.R.drawable.ic_send).mutate();
            this.sendButtonInverseDrawable = activity.getResources().getDrawable(org.telegram.mdgram.R.drawable.ic_send).mutate();
            this.inactinveSendButtonDrawable = activity.getResources().getDrawable(org.telegram.mdgram.R.drawable.ic_send).mutate();
        } else {
            this.sendButtonDrawable = activity.getResources().getDrawable(org.telegram.mdgram.R.drawable.ic_send_up).mutate();
            this.sendButtonInverseDrawable = activity.getResources().getDrawable(org.telegram.mdgram.R.drawable.ic_send_up).mutate();
            this.inactinveSendButtonDrawable = activity.getResources().getDrawable(org.telegram.mdgram.R.drawable.ic_send_up).mutate();
        }
        x xVar = new x(activity);
        this.sendButton = xVar;
        xVar.setVisibility(4);
        int c4 = c4("chat_messagePanelSend");
        this.sendButton.setContentDescription(org.telegram.messenger.u.B0("Send", org.telegram.mdgram.R.string.Send));
        ...
        Drawable mutate3 = activity.getResources().getDrawable(org.telegram.mdgram.R.drawable.input_done).mutate();
        ...
        this.doneButtonImage.setContentDescription(org.telegram.messenger.u.B0("Done", org.telegram.mdgram.R.string.Done));
