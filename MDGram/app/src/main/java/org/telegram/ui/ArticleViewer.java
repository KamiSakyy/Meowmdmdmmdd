...
public class ArticleViewer implements a0.d {
        ...
        public void onMeasure(int i, int i2) {
            ...
            if (tLRPC$TL_pageBlockAuthorDate != null) {
                ...
                if (this.currentBlock.a != 0 && !TextUtils.isEmpty(V2)) {
                    r15 = org.telegram.messenger.u.d0("ArticleDateByAuthor", org.telegram.mdgram.R.string.ArticleDateByAuthor, org.telegram.messenger.u.p0().l.a(this.currentBlock.a * 1000), V2);
                } else if (!TextUtils.isEmpty(V2)) {
                    r15 = org.telegram.messenger.u.d0("ArticleByAuthor", org.telegram.mdgram.R.string.ArticleByAuthor, V2);
                } else {
    ...
    public class a1 extends View implements dw9.f {
        ...
        public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
            ...
            accessibilityNodeInfo.setText(((Object) this.textLayout.l()) + ", " + org.telegram.messenger.u.B0("AccDescrIVTitle", org.telegram.mdgram.R.string.AccDescrIVTitle));
        }
    ...
    public class b1 extends FrameLayout implements h.d, dw9.f {
        ...
        public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
            super.onInitializeAccessibilityNodeInfo(accessibilityNodeInfo);
            accessibilityNodeInfo.setEnabled(true);
            StringBuilder sb = new StringBuilder(org.telegram.messenger.u.B0("AttachVideo", org.telegram.mdgram.R.string.AttachVideo));
            if (this.captionLayout != null) {
                sb.append(", ");
    ...
    public class c0 extends FrameLayout implements dw9.f {
        ...
        public c0(Context context, u1 u1Var, int i) {
            ...
            this.textView.setText(org.telegram.messenger.u.B0("ChannelJoin", org.telegram.mdgram.R.string.ChannelJoin));
            ...
            imageView.setImageResource(org.telegram.mdgram.R.drawable.list_check);
    ...
    public class i extends dw9.h {
        ...
        public void b() {
            if (org.telegram.messenger.a.L3()) {
                org.telegram.ui.Components.q.o0(ArticleViewer.this.containerView, null).n(org.telegram.messenger.u.B0("TextCopied", org.telegram.mdgram.R.string.TextCopied)).T();
            }
        }
    ...
    public static class i1 extends FrameLayout {
        ...
        public i1(Context context) {
            ...
            TextView textView = new TextView(context);
            this.textView = textView;
            textView.setText(org.telegram.messenger.u.B0("PreviewFeedback2", org.telegram.mdgram.R.string.PreviewFeedback2));
    ...
    public class k0 extends View implements dw9.f {
        ...
        public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
            ...
            accessibilityNodeInfo.setText(((Object) this.textLayout.l()) + ", " + org.telegram.messenger.u.B0("AccDescrIVHeading", org.telegram.mdgram.R.string.AccDescrIVHeading));
        }
    ...
    public class n0 extends FrameLayout implements dw9.f {
        ...
        public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
            super.onInitializeAccessibilityNodeInfo(accessibilityNodeInfo);
            accessibilityNodeInfo.setEnabled(true);
            StringBuilder sb = new StringBuilder(org.telegram.messenger.u.B0("Map", org.telegram.mdgram.R.string.Map));
            if (this.captionLayout != null) {
                sb.append(", ");
                sb.append(this.captionLayout.l());
            }
    ...
    public class q0 extends FrameLayout implements h.d, dw9.f {
        ...
        public void g(TLRPC$TL_pageBlockPhoto tLRPC$TL_pageBlockPhoto, boolean z, boolean z2) {
            ...
            if (!TextUtils.isEmpty(this.currentBlock.f14911a)) {
                this.linkDrawable = getResources().getDrawable(org.telegram.mdgram.R.drawable.msg_instant_link);
            }
        ...
        public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
            super.onInitializeAccessibilityNodeInfo(accessibilityNodeInfo);
            accessibilityNodeInfo.setEnabled(true);
            StringBuilder sb = new StringBuilder(org.telegram.messenger.u.B0("AttachPhoto", org.telegram.mdgram.R.string.AttachPhoto));
            if (this.captionLayout != null) {
                sb.append(", ");
                sb.append(this.captionLayout.l());
            }
    ...
    public class t0 extends View implements dw9.f {
        ...
        public void onMeasure(int i, int i2) {
            ...
            if (tLRPC$TL_pageRelatedArticle.b != 0 && !TextUtils.isEmpty(tLRPC$TL_pageRelatedArticle.d)) {
                str = org.telegram.messenger.u.d0("ArticleDateByAuthor", org.telegram.mdgram.R.string.ArticleDateByAuthor, org.telegram.messenger.u.p0().l.a(tLRPC$TL_pageRelatedArticle.b * 1000), tLRPC$TL_pageRelatedArticle.d);
            } else if (!TextUtils.isEmpty(tLRPC$TL_pageRelatedArticle.d)) {
                str = org.telegram.messenger.u.d0("ArticleByAuthor", org.telegram.mdgram.R.string.ArticleByAuthor, tLRPC$TL_pageRelatedArticle.d);
    ...
    public static class v0 extends View {
        ...
        public v0(Context context) {
            super(context);
            nq1 nq1Var = new nq1(new ColorDrawable(org.telegram.ui.ActionBar.l.B1("windowBackgroundGray")), org.telegram.ui.ActionBar.l.t2(context, org.telegram.mdgram.R.drawable.greydivider_bottom, -16777216));
    ...
    public /* synthetic */ void G3(int i2) {
        ...
        if (this.adapter[0].currentPage != null && (activity = this.parentActivity) != null) {
            if (i2 == 1) {
                ...
                nu3Var.setText(org.telegram.messenger.u.B0("FontSize", org.telegram.mdgram.R.string.FontSize));
                ...
                nu3Var2.setText(org.telegram.messenger.u.B0("FontType", org.telegram.mdgram.R.string.FontType));
                ...
                for (int i3 = 0; i3 < 2; i3++) {
                    ...
                    if (i3 != 0) {
                        ...
                        this.fontCells[i3].b(org.telegram.messenger.u.B0("Default", org.telegram.mdgram.R.string.Default), org.telegram.messenger.a.s1("fonts/rmedium.ttf"));
                    }
    ...
    public /* synthetic */ void R3(View view) {
        ...
        if (e1Var != null) {
            ...
            if (org.telegram.messenger.a.L3()) {
                Toast.makeText(this.parentActivity, org.telegram.messenger.u.B0("TextCopied", org.telegram.mdgram.R.string.TextCopied), 0).show();
            }
        }
    ...
    public final boolean i4(String str) {
        ...
        if (num2 != null) {
            ...
            if (tLRPC$TL_textAnchor != null) {
                ...
                tVar.setText(org.telegram.messenger.u.B0("InstantViewReference", org.telegram.mdgram.R.string.InstantViewReference));
    ...
    */
    ...
    public final void n4(final String str) {
        ...
        g.l lVar = new g.l(this.parentActivity);
        lVar.k(str);
        lVar.h(new CharSequence[]{org.telegram.messenger.u.B0("Open", org.telegram.mdgram.R.string.Open), org.telegram.messenger.u.B0("Copy", org.telegram.mdgram.R.string.Copy)}, new DialogInterface.OnClickListener() { // from class: ml
    ...
    public final void p4(View view, int i2, int i3, int i4) {
        ...
        if (this.popupLayout == null) {
            ...
            this.popupLayout.setBackgroundDrawable(this.parentActivity.getResources().getDrawable(org.telegram.mdgram.R.drawable.menu_copy));
            ...
            this.deleteView.setText(org.telegram.messenger.u.B0("Copy", org.telegram.mdgram.R.string.Copy).toUpperCase());
    ...
    public final void y4() {
        ...
        if (size < 0) {
            ...
            this.searchCountText.i(org.telegram.messenger.u.B0("NoResult", org.telegram.mdgram.R.string.NoResult));
        } else if (size == 1) {
            this.searchCountText.i(org.telegram.messenger.u.B0("OneResult", org.telegram.mdgram.R.string.OneResult));
        } else {
