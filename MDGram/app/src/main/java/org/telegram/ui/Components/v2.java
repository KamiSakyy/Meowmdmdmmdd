...
public class v2 extends FrameLayout implements a0.d {
    ...
    public /* synthetic */ void D(final c0.j jVar, final int i) {
        final Bitmap m = org.telegram.messenger.f0.m(org.telegram.mdgram.R.raw.default_pattern, org.telegram.messenger.a.e0(120.0f), org.telegram.messenger.a.e0(140.0f), -16777216, org.telegram.messenger.a.b);
    ...
    public StaticLayout getNoThemeStaticLayout() {
        ...
        StaticLayout f = jb9.f(org.telegram.messenger.u.B0("ChatNoTheme", org.telegram.mdgram.R.string.ChatNoTheme), this.noThemeTextPaint, org.telegram.messenger.a.e0(52.0f), Layout.Alignment.ALIGN_CENTER, 1.0f, 0.0f, true, TextUtils.TruncateAt.END, org.telegram.messenger.a.e0(52.0f), 3);
        this.textLayout = f;
        return f;
    }
    ...
    public void H(final c0.j jVar, boolean z) {
        ...
        if (iVar != null && !iVar.f15665a) {
            ...
            setContentDescription(org.telegram.messenger.u.B0("ChatNoTheme", org.telegram.mdgram.R.string.ChatNoTheme));
        }
    }
