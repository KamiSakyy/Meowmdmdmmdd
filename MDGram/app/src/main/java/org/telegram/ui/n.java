...
public class n extends org.telegram.ui.ActionBar.f implements a0.d {
    ...
    public class r implements GroupCreateActivity.l {
        ...
        public static /* synthetic */ void f(ArrayList arrayList, int i, Context context) {
            ...
            if (arrayList.size() == 1) {
                if (i > 1) {
                    B0 = org.telegram.messenger.u.B0("InviteToGroupErrorTitleAUser", org.telegram.mdgram.R.string.InviteToGroupErrorTitleAUser);
                } else {
                    B0 = org.telegram.messenger.u.B0("InviteToGroupErrorTitleThisUser", org.telegram.mdgram.R.string.InviteToGroupErrorTitleThisUser);
                }
                B02 = org.telegram.messenger.a.b3(org.telegram.messenger.u.d0("InviteToGroupErrorMessageSingle", org.telegram.mdgram.R.string.InviteToGroupErrorMessageSingle, xla.a((mq9) arrayList.get(0))));
            } else if (arrayList.size() == 2) {
                B0 = org.telegram.messenger.u.B0("InviteToGroupErrorTitleSomeUsers", org.telegram.mdgram.R.string.InviteToGroupErrorTitleSomeUsers);
                B02 = org.telegram.messenger.a.b3(org.telegram.messenger.u.d0("InviteToGroupErrorMessageDouble", org.telegram.mdgram.R.string.InviteToGroupErrorMessageDouble, xla.a((mq9) arrayList.get(0)), xla.a((mq9) arrayList.get(1))));
            } else if (arrayList.size() == i) {
                B0 = org.telegram.messenger.u.B0("InviteToGroupErrorTitleTheseUsers", org.telegram.mdgram.R.string.InviteToGroupErrorTitleTheseUsers);
                B02 = org.telegram.messenger.u.B0("InviteToGroupErrorMessageMultipleAll", org.telegram.mdgram.R.string.InviteToGroupErrorMessageMultipleAll);
            } else {
                B0 = org.telegram.messenger.u.B0("InviteToGroupErrorTitleSomeUsers", org.telegram.mdgram.R.string.InviteToGroupErrorTitleSomeUsers);
                B02 = org.telegram.messenger.u.B0("InviteToGroupErrorMessageMultipleSome", org.telegram.mdgram.R.string.InviteToGroupErrorMessageMultipleSome);
            }
            new e.k(context).x(B0).n(B02).v(org.telegram.messenger.u.B0("OK", org.telegram.mdgram.R.string.OK), null).G();
        }
        ...
        public RecyclerView.d0 onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            switch (i) {
                ...
                case 4:
                    ...
                    if (n.this.isChannel) {
                        bv9Var.setText(org.telegram.messenger.u.z0(org.telegram.mdgram.R.string.NoBlockedChannel2));
                    } else {
                        bv9Var.setText(org.telegram.messenger.u.z0(org.telegram.mdgram.R.string.NoBlockedGroup2));
                    }
                ...
                default:
                    ...
                    h79Var2.e(n.this.selectedSlowmode, org.telegram.messenger.u.B0("SlowmodeOff", org.telegram.mdgram.R.string.SlowmodeOff), org.telegram.messenger.u.d0("SlowmodeSeconds", org.telegram.mdgram.R.string.SlowmodeSeconds, 10), org.telegram.messenger.u.d0("SlowmodeSeconds", org.telegram.mdgram.R.string.SlowmodeSeconds, 30), org.telegram.messenger.u.d0("SlowmodeMinutes", org.telegram.mdgram.R.string.SlowmodeMinutes, 1), org.telegram.messenger.u.d0("SlowmodeMinutes", org.telegram.mdgram.R.string.SlowmodeMinutes, 5), org.telegram.messenger.u.d0("SlowmodeMinutes", org.telegram.mdgram.R.string.SlowmodeMinutes, 15), org.telegram.messenger.u.d0("SlowmodeHours", org.telegram.mdgram.R.string.SlowmodeHours, 1));
    ...
    public /* synthetic */ void A4(final ArrayList arrayList, mq9 mq9Var, final long j2, final boolean z, final org.telegram.tgnet.a aVar, final int i2, final TLRPC$TL_chatAdminRights tLRPC$TL_chatAdminRights, final TLRPC$TL_chatBannedRights tLRPC$TL_chatBannedRights, final String str, DialogInterface dialogInterface, final int i3) {
        if (((Integer) arrayList.get(i3)).intValue() == 2) {
            ...
            kVar.n(org.telegram.messenger.u.d0("AdminWillBeRemoved", org.telegram.mdgram.R.string.AdminWillBeRemoved, xla.e(mq9Var)));
            kVar.v(org.telegram.messenger.u.B0("OK", org.telegram.mdgram.R.string.OK), new DialogInterface.OnClickListener() { // from class: xj1
    ...
    */
    ...
    public View W(final Context context) {
        ...
        int i4 = this.type;
        if (i4 == 3) {
            this.actionBar.setTitle(org.telegram.messenger.u.B0("ChannelPermissions", org.telegram.mdgram.R.string.ChannelPermissions));
        } else if (i4 == 0) {
            this.actionBar.setTitle(org.telegram.messenger.u.B0("ChannelBlacklist", org.telegram.mdgram.R.string.ChannelBlacklist));
        } else if (i4 == 1) {
            this.actionBar.setTitle(org.telegram.messenger.u.B0("ChannelAdministrators", org.telegram.mdgram.R.string.ChannelAdministrators));
        } else if (i4 == 2) {
            int i5 = this.selectType;
            if (i5 == 0) {
                if (this.isChannel) {
                    this.actionBar.setTitle(org.telegram.messenger.u.B0("ChannelSubscribers", org.telegram.mdgram.R.string.ChannelSubscribers));
                } else {
                    this.actionBar.setTitle(org.telegram.messenger.u.B0("ChannelMembers", org.telegram.mdgram.R.string.ChannelMembers));
                }
            } else if (i5 == 1) {
                this.actionBar.setTitle(org.telegram.messenger.u.B0("ChannelAddAdmin", org.telegram.mdgram.R.string.ChannelAddAdmin));
            } else if (i5 == 2) {
                this.actionBar.setTitle(org.telegram.messenger.u.B0("ChannelBlockUser", org.telegram.mdgram.R.string.ChannelBlockUser));
            } else if (i5 == 3) {
                this.actionBar.setTitle(org.telegram.messenger.u.B0("ChannelAddException", org.telegram.mdgram.R.string.ChannelAddException));
            }
        }
        ...
        if (this.selectType != 0 || (i2 = this.type) == 2 || i2 == 0 || i2 == 3) {
            ...
            org.telegram.ui.ActionBar.c P0 = x.b(0, org.telegram.mdgram.R.drawable.ic_ab_search).R0(true).P0(new k());
            this.searchItem = P0;
            if (this.type == 0 && !this.firstLoaded) {
                P0.setVisibility(8);
            }
            if (this.type == 3) {
                this.searchItem.setSearchFieldHint(org.telegram.messenger.u.B0("ChannelSearchException", org.telegram.mdgram.R.string.ChannelSearchException));
            } else {
            ...
            if (this.type == 3) {
                this.doneItem = x.j(1, org.telegram.mdgram.R.drawable.ic_ab_done, org.telegram.messenger.a.e0(56.0f), org.telegram.messenger.u.B0("Done", org.telegram.mdgram.R.string.Done));
            }
        }
    ...
    */
    ...
    public final boolean p4() {
        ...
        kVar.v(org.telegram.messenger.u.B0("ApplyTheme", org.telegram.mdgram.R.string.ApplyTheme), new DialogInterface.OnClickListener() { // from class: hk1
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i2) {
                n.this.y4(dialogInterface, i2);
            }
        });
        kVar.p(org.telegram.messenger.u.B0("PassportDiscard", org.telegram.mdgram.R.string.PassportDiscard), new DialogInterface.OnClickListener() { // from class: ik1
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i2) {
    ...
    */
    ...
    public final String s4(TLRPC$TL_chatBannedRights tLRPC$TL_chatBannedRights) {
        ...
        if (z && this.defaultBannedRights.f14122a != z) {
            sb.append(org.telegram.messenger.u.B0("UserRestrictionsNoRead", org.telegram.mdgram.R.string.UserRestrictionsNoRead));
        }
        ...
        if (z2 && this.defaultBannedRights.f14123b != z2) {
            ...
            sb.append(org.telegram.messenger.u.B0("UserRestrictionsNoSend", org.telegram.mdgram.R.string.UserRestrictionsNoSend));
        }
        ...
        if (z3 && this.defaultBannedRights.f14124c != z3) {
            ...
            sb.append(org.telegram.messenger.u.B0("UserRestrictionsNoSendMedia", org.telegram.mdgram.R.string.UserRestrictionsNoSendMedia));
        }
        ...
        if (z4 && this.defaultBannedRights.d != z4) {
            ...
            sb.append(org.telegram.messenger.u.B0("UserRestrictionsNoSendStickers", org.telegram.mdgram.R.string.UserRestrictionsNoSendStickers));
        }
        ...
        if (z5 && this.defaultBannedRights.i != z5) {
            ...
            sb.append(org.telegram.messenger.u.B0("UserRestrictionsNoSendPolls", org.telegram.mdgram.R.string.UserRestrictionsNoSendPolls));
        }
        ...
        if (z6 && this.defaultBannedRights.h != z6) {
            ...
            sb.append(org.telegram.messenger.u.B0("UserRestrictionsNoEmbedLinks", org.telegram.mdgram.R.string.UserRestrictionsNoEmbedLinks));
        }
        ...
        if (z7 && this.defaultBannedRights.k != z7) {
            ...
            sb.append(org.telegram.messenger.u.B0("UserRestrictionsNoInviteUsers", org.telegram.mdgram.R.string.UserRestrictionsNoInviteUsers));
        }
        ...
        if (z8 && this.defaultBannedRights.l != z8) {
            ...
            sb.append(org.telegram.messenger.u.B0("UserRestrictionsNoPinMessages", org.telegram.mdgram.R.string.UserRestrictionsNoPinMessages));
        }
        ...
        if (z9 && this.defaultBannedRights.j != z9) {
            ...
            sb.append(org.telegram.messenger.u.B0("UserRestrictionsNoChangeInfo", org.telegram.mdgram.R.string.UserRestrictionsNoChangeInfo));
        }
        if (sb.length() != 0) {
