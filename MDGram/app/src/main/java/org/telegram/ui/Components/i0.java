            ...
            if (itemViewType != 1) {
                if (itemViewType != 2) {
                    if (itemViewType == 3) {
                        ...
                        textView.setText(org.telegram.messenger.a.b3(org.telegram.messenger.u.B0("PremiumPreviewEmojiPack", org.telegram.mdgram.R.string.PremiumPreviewEmojiPack)));
        ...
        public k(Context context, boolean z) {
            ...
            if (!z) {
                if (!tla.p(i0.this.currentAccount).x()) {
                    ...
                    rm7Var.h(org.telegram.messenger.u.B0("Unlock", org.telegram.mdgram.R.string.Unlock), new View.OnClickListener() { // from class: aq2
                        @Override // android.view.View.OnClickListener
                        public final void onClick(View view) {
                            i0.k.this.j(view);
                        }
                    });
                    this.unlockButtonView.setIcon(org.telegram.mdgram.R.raw.unlock_icon);
    ...
    public class l implements a0.d {
        ...
        public /* synthetic */ void i(TLRPC$TL_error tLRPC$TL_error, org.telegram.tgnet.a aVar) {
            ...
            if (i0.this.fragment != null && i0.this.fragment.E0() != null) {
                q.p0(i0.this.fragment).C(org.telegram.messenger.u.B0("UnknownError", org.telegram.mdgram.R.string.UnknownError)).T();
            }
        }
        ...
        public /* synthetic */ void k() {
            i0.this.dismiss();
            if (i0.this.fragment != null && i0.this.fragment.E0() != null) {
                q.p0(i0.this.fragment).C(org.telegram.messenger.u.B0("AddEmojiNotFound", org.telegram.mdgram.R.string.AddEmojiNotFound)).T();
            }
        }
    ...
    */
    ...
    public static /* synthetic */ void M2(eq9 eq9Var, TLRPC$TL_error tLRPC$TL_error, boolean z, View view, org.telegram.ui.ActionBar.f fVar, TLRPC$TL_messages_stickerSet tLRPC$TL_messages_stickerSet, org.telegram.tgnet.a aVar, int i2, Utilities.b bVar, final Runnable runnable) {
        ...
        try {
            if (tLRPC$TL_error == null) {
                ...
                Toast.makeText(fVar.r0().getContext(), org.telegram.messenger.u.B0("ErrorOccurred", org.telegram.mdgram.R.string.ErrorOccurred), 0).show();
                if (bVar != null) {
    ...
    public /* synthetic */ void Q2(org.telegram.ui.Components.d dVar, View view) {
        ...
        if (org.telegram.messenger.a.B(spannableString)) {
            q.o0((FrameLayout) this.containerView, this.resourcesProvider).n(org.telegram.messenger.u.B0("EmojiCopied", org.telegram.mdgram.R.string.EmojiCopied)).T();
        }
    }
    ...
    public /* synthetic */ boolean R2(Context context, View view, int i2) {
        ...
        dVar2.setText(org.telegram.messenger.u.B0("Copy", org.telegram.mdgram.R.string.Copy));
        ...
        Drawable mutate = sz1.e(getContext(), org.telegram.mdgram.R.drawable.popup_fixed_alert).mutate();
    ...
    public i0(final org.telegram.ui.ActionBar.f fVar, final Context context, final l.r rVar, final ArrayList arrayList, org.telegram.tgnet.a aVar) {
        ...
        rm7Var.h(org.telegram.messenger.u.B0("UnlockPremiumEmoji", org.telegram.mdgram.R.string.UnlockPremiumEmoji), new View.OnClickListener() { // from class: op2
            @Override // android.view.View.OnClickListener
            public final void onClick(View view2) {
                i0.this.S2(view2);
            }
        });
        this.premiumButtonView.setIcon(org.telegram.mdgram.R.raw.unlock_icon);
