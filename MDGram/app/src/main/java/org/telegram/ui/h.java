...
public class h extends org.telegram.ui.ActionBar.f {
    ...
    public View W(Context context) {
        ...
        if (i2 == 2 || i2 == 3) {
            this.actionBar.setTitle(org.telegram.messenger.u.B0("AuthAnotherClientScan", org.telegram.mdgram.R.string.AuthAnotherClientScan));
        }
        ...
        if (i3 == 0) {
            this.titleTextView.setText(org.telegram.messenger.u.B0("PassportScanPassport", org.telegram.mdgram.R.string.PassportScanPassport));
            this.descriptionText.setText(org.telegram.messenger.u.B0("PassportScanPassportInfo", org.telegram.mdgram.R.string.PassportScanPassportInfo));
            ...
            if (!this.needGalleryButton) {
                if (i3 != 1 && i3 != 3) {
                    SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder(org.telegram.messenger.u.B0("AuthAnotherClientInfo5", org.telegram.mdgram.R.string.AuthAnotherClientInfo5));
                    String[] strArr = {org.telegram.messenger.u.B0("AuthAnotherClientDownloadClientUrl", org.telegram.mdgram.R.string.AuthAnotherClientDownloadClientUrl), org.telegram.messenger.u.B0("AuthAnotherWebClientUrl", org.telegram.mdgram.R.string.AuthAnotherWebClientUrl)};
                    int i4 = 0;
                    ...
                    this.titleTextView.setText(org.telegram.messenger.u.B0("AuthAnotherClientScan", org.telegram.mdgram.R.string.AuthAnotherClientScan));
                }
            }
            ...
            if (!this.needGalleryButton) {
                this.recognizedMrzView.setText(org.telegram.messenger.u.B0("AuthAnotherClientNotFound", org.telegram.mdgram.R.string.AuthAnotherClientNotFound));
            }
            ...
            if (this.needGalleryButton) {
                ...
                this.galleryButton.setImageResource(org.telegram.mdgram.R.drawable.qr_gallery);
            ...
            this.flashButton.setImageResource(org.telegram.mdgram.R.drawable.qr_flashlight);
