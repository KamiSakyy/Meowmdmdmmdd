...
public class b1 extends org.telegram.ui.ActionBar.f implements a0.d {
        ...
        public void onBindViewHolder(RecyclerView.d0 d0Var, int i) {
            ...
            if (itemViewType >= 0 && itemViewType <= 4) {
                ...
                if (i == this.overviewHeaderCell) {
                    yk0Var.setTitle(org.telegram.messenger.u.B0("StatisticOverview", org.telegram.mdgram.R.string.StatisticOverview));
                } else if (i == this.topAdminsHeaderCell) {
                    yk0Var.setTitle(org.telegram.messenger.u.B0("TopAdmins", org.telegram.mdgram.R.string.TopAdmins));
                } else if (i == this.topInviterHeaderCell) {
                    yk0Var.setTitle(org.telegram.messenger.u.B0("TopInviters", org.telegram.mdgram.R.string.TopInviters));
                } else if (i == this.topMembersHeaderCell) {
                    yk0Var.setTitle(org.telegram.messenger.u.B0("TopMembers", org.telegram.mdgram.R.string.TopMembers));
                } else {
                    yk0Var.setTitle(org.telegram.messenger.u.B0("RecentPosts", org.telegram.mdgram.R.string.RecentPosts));
                }
                ...
                ((u65) d0Var.itemView).c(org.telegram.messenger.u.U("ShowVotes", b1.this.topMembersAll.size() - b1.this.topMembersVisible.size(), new Object[0]), null, org.telegram.mdgram.R.drawable.arrow_more, false);
            }
        }
    ...
    public static class l {
        ...
        public static l i(TLRPC$TL_statsGroupTopPoster tLRPC$TL_statsGroupTopPoster, ArrayList arrayList) {
            ...
            if (tLRPC$TL_statsGroupTopPoster.b > 0) {
                ...
                sb.append(org.telegram.messenger.u.d0("CharactersPerMessage", org.telegram.mdgram.R.string.CharactersPerMessage, org.telegram.messenger.u.U("Characters", tLRPC$TL_statsGroupTopPoster.b, new Object[0])));
            }
            lVar.description = sb.toString();
            return lVar;
        }
        ...
        public final void q(final gm9 gm9Var, final b1 b1Var, final org.telegram.ui.ActionBar.e[] eVarArr, boolean z) {
            ...
            arrayList3.add(org.telegram.messenger.u.B0("StatisticOpenProfile", org.telegram.mdgram.R.string.StatisticOpenProfile));
            ArrayList arrayList7 = arrayList;
            arrayList7.add(Integer.valueOf(org.telegram.mdgram.R.drawable.msg_openprofile));
            arrayList4.add(2);
            arrayList3.add(org.telegram.messenger.u.B0("StatisticSearchUserHistory", org.telegram.mdgram.R.string.StatisticSearchUserHistory));
            arrayList7.add(Integer.valueOf(org.telegram.mdgram.R.drawable.msg_msgbubble3));
            ...
            if (z && tLRPC$TL_chatChannelParticipant == null) {
                ...
                if (tLRPC$TL_chatChannelParticipant2 != null && tLRPC$TL_chatChannelParticipant != null && ((im9) tLRPC$TL_chatChannelParticipant2).f7641a != ((im9) tLRPC$TL_chatChannelParticipant).f7641a) {
                    ...
                    if (z2) {
                        ...
                        if (z3) {
                            i = org.telegram.mdgram.R.string.SetAsAdmin;
                            str = "SetAsAdmin";
                        } else {
                            i = org.telegram.mdgram.R.string.EditAdminRights;
                            str = "EditAdminRights";
                        }
                        arrayList3.add(org.telegram.messenger.u.B0(str, i));
                        if (z3) {
                            i2 = org.telegram.mdgram.R.drawable.msg_admins;
                        } else {
    ...
    public static class n {
        ...
        public n(TLRPC$TL_stats_broadcastStats tLRPC$TL_stats_broadcastStats) {
            ...
            this.followersTitle = org.telegram.messenger.u.B0("FollowersChartTitle", org.telegram.mdgram.R.string.FollowersChartTitle);
            ...
            this.sharesTitle = org.telegram.messenger.u.B0("SharesPerPost", org.telegram.mdgram.R.string.SharesPerPost);
            ...
            this.viewsTitle = org.telegram.messenger.u.B0("ViewsPerPost", org.telegram.mdgram.R.string.ViewsPerPost);
            ...
            this.notificationsTitle = org.telegram.messenger.u.B0("EnabledNotifications", org.telegram.mdgram.R.string.EnabledNotifications);
            int i7 = (int) f;
            if (f == i7) {
    ...
    public static class o {
        ...
        public o(TLRPC$TL_stats_megagroupStats tLRPC$TL_stats_megagroupStats) {
            ...
            this.membersTitle = org.telegram.messenger.u.B0("MembersOverviewTitle", org.telegram.mdgram.R.string.MembersOverviewTitle);
            ...
            this.viewingMembersTitle = org.telegram.messenger.u.B0("ViewingMembers", org.telegram.mdgram.R.string.ViewingMembers);
            ...
            this.postingMembersTitle = org.telegram.messenger.u.B0("PostingMembers", org.telegram.mdgram.R.string.PostingMembers);
            ...
            this.messagesTitle = org.telegram.messenger.u.B0("MessagesOverview", org.telegram.mdgram.R.string.MessagesOverview);
    ...
    public /* synthetic */ boolean s3(View view, int i2) {
        ...
        if (i2 >= i3 && i2 <= gVar.recentPostsEndRow) {
            ...
            ArrayList arrayList3 = new ArrayList();
            arrayList.add(org.telegram.messenger.u.B0("ViewMessageStatistic", org.telegram.mdgram.R.string.ViewMessageStatistic));
            arrayList2.add(0);
            arrayList3.add(Integer.valueOf(org.telegram.mdgram.R.drawable.msg_stats));
            arrayList.add(org.telegram.messenger.u.B0("ViewMessage", org.telegram.mdgram.R.string.ViewMessage));
            arrayList2.add(1);
            arrayList3.add(Integer.valueOf(org.telegram.mdgram.R.drawable.msg_msgbubble3));
            e.k kVar = new e.k(E0());
    ...
    public /* synthetic */ void y3(org.telegram.tgnet.a aVar, TLRPC$TL_error tLRPC$TL_error) {
        ...
        if (!(aVar instanceof TLRPC$TL_stats_broadcastStats)) {
            ...
            final j[] jVarArr = {n3(tLRPC$TL_stats_broadcastStats.f, org.telegram.messenger.u.B0("IVInteractionsChartTitle", org.telegram.mdgram.R.string.IVInteractionsChartTitle), 1), n3(tLRPC$TL_stats_broadcastStats.b, org.telegram.messenger.u.B0("FollowersChartTitle", org.telegram.mdgram.R.string.FollowersChartTitle), 0), n3(tLRPC$TL_stats_broadcastStats.d, org.telegram.messenger.u.B0("TopHoursChartTitle", org.telegram.mdgram.R.string.TopHoursChartTitle), 0), n3(tLRPC$TL_stats_broadcastStats.e, org.telegram.messenger.u.B0("InteractionsChartTitle", org.telegram.mdgram.R.string.InteractionsChartTitle), 1), n3(tLRPC$TL_stats_broadcastStats.f15211a, org.telegram.messenger.u.B0("GrowthChartTitle", org.telegram.mdgram.R.string.GrowthChartTitle), 0), n3(tLRPC$TL_stats_broadcastStats.g, org.telegram.messenger.u.B0("ViewsBySourceChartTitle", org.telegram.mdgram.R.string.ViewsBySourceChartTitle), 2), n3(tLRPC$TL_stats_broadcastStats.h, org.telegram.messenger.u.B0("NewFollowersBySourceChartTitle", org.telegram.mdgram.R.string.NewFollowersBySourceChartTitle), 2), o3(tLRPC$TL_stats_broadcastStats.i, org.telegram.messenger.u.B0("LanguagesChartTitle", org.telegram.mdgram.R.string.LanguagesChartTitle), 4, true), n3(tLRPC$TL_stats_broadcastStats.c, org.telegram.messenger.u.B0("NotificationsChartTitle", org.telegram.mdgram.R.string.NotificationsChartTitle), 0)};
            j jVar = jVarArr[2];
            if (jVar != null) {
        ...
        if (aVar instanceof TLRPC$TL_stats_megagroupStats) {
            ...
            j n3 = n3(tLRPC$TL_stats_megagroupStats.h, org.telegram.messenger.u.B0("TopDaysOfWeekChartTitle", org.telegram.mdgram.R.string.TopDaysOfWeekChartTitle), 4);
            final j[] jVarArr2 = {n3(tLRPC$TL_stats_megagroupStats.f15228a, org.telegram.messenger.u.B0("GrowthChartTitle", org.telegram.mdgram.R.string.GrowthChartTitle), 0), n3(tLRPC$TL_stats_megagroupStats.b, org.telegram.messenger.u.B0("GroupMembersChartTitle", org.telegram.mdgram.R.string.GroupMembersChartTitle), 0), n3(tLRPC$TL_stats_megagroupStats.c, org.telegram.messenger.u.B0("NewMembersBySourceChartTitle", org.telegram.mdgram.R.string.NewMembersBySourceChartTitle), 2), o3(tLRPC$TL_stats_megagroupStats.d, org.telegram.messenger.u.B0("MembersLanguageChartTitle", org.telegram.mdgram.R.string.MembersLanguageChartTitle), 4, true), n3(tLRPC$TL_stats_megagroupStats.e, org.telegram.messenger.u.B0("MessagesChartTitle", org.telegram.mdgram.R.string.MessagesChartTitle), 2), n3(tLRPC$TL_stats_megagroupStats.f, org.telegram.messenger.u.B0("ActionsChartTitle", org.telegram.mdgram.R.string.ActionsChartTitle), 1), n3(tLRPC$TL_stats_megagroupStats.g, org.telegram.messenger.u.B0(str, org.telegram.mdgram.R.string.TopHoursChartTitle), 0), n3};
            j jVar2 = jVarArr2[6];
            if (jVar2 != null) {
    ...
    public final void B3(View view) {
        if (view instanceof i) {
            ...
            nq1 nq1Var = new nq1(new ColorDrawable(org.telegram.ui.ActionBar.l.B1("windowBackgroundGray")), org.telegram.ui.ActionBar.l.u2(org.telegram.messenger.b.f12514a, org.telegram.mdgram.R.drawable.greydivider, "windowBackgroundGrayShadow"), 0, 0);
            nq1Var.e(true);
    ...
    public View W(Context context) {
        ...
        this.imageView.g(org.telegram.mdgram.R.raw.statistic_preload, Constants.MEMORY_PAGE_DATA_OVERFLOW, Constants.MEMORY_PAGE_DATA_OVERFLOW);
        this.imageView.e();
        TextView textView = new TextView(context);
        ...
        textView.setText(org.telegram.messenger.u.B0("LoadingStats", org.telegram.mdgram.R.string.LoadingStats));
        ...
        textView2.setText(org.telegram.messenger.u.B0("LoadingStatsDescription", org.telegram.mdgram.R.string.LoadingStatsDescription));
        ...
        this.avatarContainer.setSubtitle(org.telegram.messenger.u.B0("Statistics", org.telegram.mdgram.R.string.Statistics));
