...
public abstract class i2 extends FrameLayout implements a0.d {
        ...
        public void onBindViewHolder(RecyclerView.d0 d0Var, int i) {
            ...
            if (im9Var != null) {
                ...
                if (im9Var instanceof TLRPC$TL_chatChannelParticipant) {
                    ...
                    str = org.telegram.messenger.u.B0("ChannelCreator", org.telegram.mdgram.R.string.ChannelCreator);
                } else if (im9Var instanceof TLRPC$TL_chatParticipantAdmin) {
                    str = org.telegram.messenger.u.B0("ChannelAdmin", org.telegram.mdgram.R.string.ChannelAdmin);
                }
                ...
                if (i == this.lastReqId) {
                    ...
                    for (int i2 = 0; i2 < i2.this.mediaPages.length; i2++) {
                        if (i2.this.mediaPages[i2].selectedType == this.currentType) {
                            if (this.searchesInProgress == 0 && itemCount2 == 0) {
                                i2.this.mediaPages[i2].emptyView.title.setText(org.telegram.messenger.u.d0("NoResultFoundFor", org.telegram.mdgram.R.string.NoResultFoundFor, str));
        ...
        public /* synthetic */ void r(ArrayList arrayList) {
            ...
            for (int i = 0; i < i2.this.mediaPages.length; i++) {
                if (i2.this.mediaPages[i].selectedType == this.currentType) {
                    if (this.searchesInProgress == 0 && itemCount2 == 0) {
                        i2.this.mediaPages[i].emptyView.title.setText(org.telegram.messenger.u.B0("NoResult", org.telegram.mdgram.R.string.NoResult));
                        i2.this.mediaPages[i].emptyView.j(false, true);
                    } else if (itemCount == 0) {
                        i2 i2Var = i2.this;
                        i2Var.R0(i2Var.mediaPages[i].listView, 0, null);
    ...
    public class w implements f29.c {
        ...
        public void b(final String str, boolean z) {
            if (z) {
                ...
                lVar.k(str);
                lVar.h(new CharSequence[]{org.telegram.messenger.u.B0("Open", org.telegram.mdgram.R.string.Open), org.telegram.messenger.u.B0("Copy", org.telegram.mdgram.R.string.Copy)}, new DialogInterface.OnClickListener() { // from class: b39
    ...
    public class z implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            dVar.f(org.telegram.messenger.u.B0("MediaZoomIn", org.telegram.mdgram.R.string.MediaZoomIn), org.telegram.mdgram.R.drawable.msg_zoomin);
            ...
            aVar.addView(dVar);
            dVar2.f(org.telegram.messenger.u.B0("MediaZoomOut", org.telegram.mdgram.R.string.MediaZoomOut), org.telegram.mdgram.R.drawable.msg_zoomout);
            ...
            if (!ic2.i(i2.this.dialog_id)) {
                ...
                dVar3.f(org.telegram.messenger.u.B0("Calendar", org.telegram.mdgram.R.string.Calendar), org.telegram.mdgram.R.drawable.msg_calendar2);
                aVar.addView(dVar3);
                ...
                if (z) {
                    ...
                    dVar4.f(org.telegram.messenger.u.B0("MediaShowPhotos", org.telegram.mdgram.R.string.MediaShowPhotos), 0);
                    ...
                    aVar.addView(dVar4);
                    dVar5.f(org.telegram.messenger.u.B0("MediaShowVideos", org.telegram.mdgram.R.string.MediaShowVideos), 0);
    ...
    public i2(Context context, long j2, r0 r0Var, int i2, ArrayList arrayList, gm9 gm9Var, boolean z2, org.telegram.ui.ActionBar.f fVar, g0 g0Var, int i3, l.r rVar) {
        ...
        Drawable drawable = context.getResources().getDrawable(org.telegram.mdgram.R.drawable.photos_header_shadow);
        ...
        org.telegram.ui.ActionBar.c P0 = x2.b(0, org.telegram.mdgram.R.drawable.ic_ab_search).R0(true).P0(new y());
        this.searchItem = P0;
        ...
        imageView.setContentDescription(org.telegram.messenger.u.B0("AccDescrMoreOptions", org.telegram.mdgram.R.string.AccDescrMoreOptions));
        this.photoVideoOptionsItem.setTranslationY(org.telegram.messenger.a.e0(10.0f));
        this.photoVideoOptionsItem.setVisibility(4);
        Drawable mutate = sz1.e(context, org.telegram.mdgram.R.drawable.ic_ab_other).mutate();
        ...
        this.closeButton.setContentDescription(org.telegram.messenger.u.B0("Close", org.telegram.mdgram.R.string.Close));
        ...
        if (ic2.i(this.dialog_id)) {
            ...
            this.gotoItem = cVar;
            cVar.setIcon(org.telegram.mdgram.R.drawable.msg_message);
            this.gotoItem.setContentDescription(org.telegram.messenger.u.B0("AccDescrGoToMessage", org.telegram.mdgram.R.string.AccDescrGoToMessage));
            ...
            cVar2.setIcon(org.telegram.mdgram.R.drawable.msg_forward);
            this.forwardItem.setContentDescription(org.telegram.messenger.u.B0("Forward", org.telegram.mdgram.R.string.Forward));
        ...
        cVar3.setIcon(org.telegram.mdgram.R.drawable.msg_delete);
        this.deleteItem.setContentDescription(org.telegram.messenger.u.B0("Delete", org.telegram.mdgram.R.string.Delete));
        ...
        while (true) {
            ...
            this.mediaPages[i10].emptyView.title.setText(org.telegram.messenger.u.B0("NoResult", org.telegram.mdgram.R.string.NoResult));
            this.mediaPages[i10].emptyView.subtitle.setText(org.telegram.messenger.u.B0("SearchEmptyViewFilteredSubtitle2", org.telegram.mdgram.R.string.SearchEmptyViewFilteredSubtitle2));
    ...
    public static View b1(Context context, int i2, long j2, l.r rVar) {
        ...
        if (i2 == 0) {
            if (ic2.i(j2)) {
                h0Var.emptyTextView.setText(org.telegram.messenger.u.B0("NoMediaSecret", org.telegram.mdgram.R.string.NoMediaSecret));
            } else {
                h0Var.emptyTextView.setText(org.telegram.messenger.u.B0("NoMedia", org.telegram.mdgram.R.string.NoMedia));
            }
        } else if (i2 == 1) {
            if (ic2.i(j2)) {
                h0Var.emptyTextView.setText(org.telegram.messenger.u.B0("NoSharedFilesSecret", org.telegram.mdgram.R.string.NoSharedFilesSecret));
            } else {
                h0Var.emptyTextView.setText(org.telegram.messenger.u.B0("NoSharedFiles", org.telegram.mdgram.R.string.NoSharedFiles));
            }
        } else if (i2 == 2) {
            if (ic2.i(j2)) {
                h0Var.emptyTextView.setText(org.telegram.messenger.u.B0("NoSharedVoiceSecret", org.telegram.mdgram.R.string.NoSharedVoiceSecret));
            } else {
                h0Var.emptyTextView.setText(org.telegram.messenger.u.B0("NoSharedVoice", org.telegram.mdgram.R.string.NoSharedVoice));
            }
        } else if (i2 == 3) {
            if (ic2.i(j2)) {
                h0Var.emptyTextView.setText(org.telegram.messenger.u.B0("NoSharedLinksSecret", org.telegram.mdgram.R.string.NoSharedLinksSecret));
            } else {
                h0Var.emptyTextView.setText(org.telegram.messenger.u.B0("NoSharedLinks", org.telegram.mdgram.R.string.NoSharedLinks));
            }
        } else if (i2 == 4) {
            if (ic2.i(j2)) {
                h0Var.emptyTextView.setText(org.telegram.messenger.u.B0("NoSharedAudioSecret", org.telegram.mdgram.R.string.NoSharedAudioSecret));
            } else {
                h0Var.emptyTextView.setText(org.telegram.messenger.u.B0("NoSharedAudio", org.telegram.mdgram.R.string.NoSharedAudio));
            }
        } else if (i2 == 5) {
            if (ic2.i(j2)) {
                h0Var.emptyTextView.setText(org.telegram.messenger.u.B0("NoSharedGifSecret", org.telegram.mdgram.R.string.NoSharedGifSecret));
            } else {
                h0Var.emptyTextView.setText(org.telegram.messenger.u.B0("NoGIFs", org.telegram.mdgram.R.string.NoGIFs));
            }
        } else if (i2 == 6) {
            h0Var.emptyImageView.setImageDrawable(null);
            h0Var.emptyTextView.setText(org.telegram.messenger.u.B0("NoGroupsInCommon", org.telegram.mdgram.R.string.NoGroupsInCommon));
        } else if (i2 == 7) {
            h0Var.emptyImageView.setImageDrawable(null);
    ...
    public void S1(View view, int i2) {
        ...
        if (i2 == 100) {
                ...
                if (this.profileActivity.x0().d9(S72)) {
                    ...
                    if (iv3Var != null) {
                        if (org.telegram.messenger.d.M(S72) && !S72.h) {
                            B0 = org.telegram.messenger.u.B0("ForwardsRestrictedInfoChannel", org.telegram.mdgram.R.string.ForwardsRestrictedInfoChannel);
                        } else {
                            B0 = org.telegram.messenger.u.B0("ForwardsRestrictedInfoGroup", org.telegram.mdgram.R.string.ForwardsRestrictedInfoGroup);
                        }
                        iv3Var.setText(B0);
            ...
            if (o1()) {
                ...
                if (iv3Var2 != null) {
                    iv3Var2.setText(org.telegram.messenger.u.B0("ForwardsRestrictedInfoBot", org.telegram.mdgram.R.string.ForwardsRestrictedInfoBot));
                    this.fwdRestrictedHint.m(view, true);
                    return;
                }
                return;
