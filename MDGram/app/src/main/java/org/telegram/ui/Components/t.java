...
public class t extends ChatAttachAlert.y implements a0.d {
    ...
    public class h extends v1.s {
        ...
        public /* synthetic */ void l(int i, String str, ArrayList arrayList) {
            ...
            if (t.this.listView.getAdapter() == t.this.searchAdapter) {
                t.this.emptySubtitleTextView.setText(org.telegram.messenger.a.b3(org.telegram.messenger.u.d0("NoAudioFoundInfo", org.telegram.mdgram.R.string.NoAudioFoundInfo, str)));
            }
    ...
    public t(ChatAttachAlert chatAttachAlert, Context context, l.r rVar) {
        ...
        aVar.setHint(org.telegram.messenger.u.B0("SearchMusic", org.telegram.mdgram.R.string.SearchMusic));
        ...
        imageView.setImageResource(org.telegram.mdgram.R.drawable.music_empty);
    ...
    public final void d0(View view) {
        ...
        if (this.selectedAudios.indexOfKey(oVar.f12352a) >= 0) {
            ...
            if (this.maxSelectedFiles >= 0) {
                ...
                if (size >= i2) {
                    f0(org.telegram.messenger.u.d0("PassportUploadMaxReached", org.telegram.mdgram.R.string.PassportUploadMaxReached, org.telegram.messenger.u.U("Files", i2, new Object[0])));
                    return;
                }
            }
    ...
    public final void g0() {
        ...
        if (this.loadingAudio) {
            ...
            if (this.listView.getAdapter() == this.searchAdapter) {
                ...
                this.emptyTitleTextView.setText(org.telegram.messenger.u.B0("NoAudioFiles", org.telegram.mdgram.R.string.NoAudioFiles));
                this.emptySubtitleTextView.setText(org.telegram.messenger.u.B0("NoAudioFilesInfo", org.telegram.mdgram.R.string.NoAudioFilesInfo));
            }
