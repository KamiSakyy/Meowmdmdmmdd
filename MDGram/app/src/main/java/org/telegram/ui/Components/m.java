...
public abstract class m extends FrameLayout implements a0.d {
        ...
        public void e(boolean z) {
            if (m.this.actionBarTransitionProgress == 1.0f) {
                if (z) {
                    ...
                    org.telegram.messenger.a.V3(this.val$actionBar.getBackButton(), org.telegram.mdgram.R.drawable.ic_close_white);
                }
            }
        }
    ...
    public m(Context context, final ChatActivityEnterView chatActivityEnterView) {
        ...
        org.telegram.ui.ActionBar.c b2 = y.x().b(1000, org.telegram.mdgram.R.drawable.ic_ab_other);
        this.botMenuItem = b2;
        b2.setVisibility(8);
        this.botMenuItem.U(org.telegram.mdgram.R.id.menu_reload_page, org.telegram.mdgram.R.drawable.msg_retry, org.telegram.messenger.u.z0(org.telegram.mdgram.R.string.BotWebViewReloadPage));
        ...
        if (this.springAnimation != null) {
            ...
            if (this.springAnimation.v().a() != f3) {
                ...
                if (!this.webViewContainer.X()) {
                    if (f3 == 100.0f) {
                        org.telegram.messenger.a.V3(aVar.getBackButton(), org.telegram.mdgram.R.drawable.ic_close_white);
                    } else {
    ...
    public boolean y0() {
        ...
        if (this.needCloseConfirmation) {
            ...
            org.telegram.ui.ActionBar.e a2 = new e.k(getContext()).x(str).n(org.telegram.messenger.u.z0(org.telegram.mdgram.R.string.BotWebViewChangesMayNotBeSaved)).v(org.telegram.messenger.u.z0(org.telegram.mdgram.R.string.BotWebViewCloseAnyway), new DialogInterface.OnClickListener() { // from class: y20
