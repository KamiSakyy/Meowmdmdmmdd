...
public class TLRPC$TL_messages_chatAdminsWithInvites extends a {
    public static int a = -1231326505;

    /* renamed from: a  reason: collision with other field name */
    public ArrayList f14473a = new ArrayList();
    public ArrayList b = new ArrayList();

    public static TLRPC$TL_messages_chatAdminsWithInvites f(b1 b1Var, int i, boolean z) {
        if (a != i) {
            if (!z) {
                return null;
            }
        ...
        tLRPC$TL_messages_chatAdminsWithInvites.d(b1Var, z);
    ...
    public void d(b1 b1Var, boolean z) {
        ...
        for (int i = 0; i < readInt322; i++) {
            TLRPC$TL_chatAdminWithInvites f = TLRPC$TL_chatAdminWithInvites.f(b1Var, b1Var.readInt32(z), z);
            if (f == null) {
                return;
            }
            this.f14473a.add(f);
    ...
    public void e(b1 b1Var) {
        ...
        for (int i = 0; i < size; i++) {
            ((TLRPC$TL_chatAdminWithInvites) this.f14473a.get(i)).e(b1Var);
        }
        b1Var.writeInt32(481674261);
