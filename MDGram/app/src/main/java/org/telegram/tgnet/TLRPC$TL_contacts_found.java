...
public class TLRPC$TL_contacts_found extends a {
    public static int a = -1290580579;

    /* renamed from: a  reason: collision with other field name */
    public ArrayList f14175a = new ArrayList();
    public ArrayList b = new ArrayList();
    public ArrayList c = new ArrayList();
    public ArrayList d = new ArrayList();

    public static TLRPC$TL_contacts_found f(b1 b1Var, int i, boolean z) {
        if (a != i) {
            if (!z) {
                return null;
            }
        ...
        tLRPC$TL_contacts_found.d(b1Var, z);
    ...
    public void d(b1 b1Var, boolean z) {
        ...
        for (int i = 0; i < readInt322; i++) {
            dp9 f = dp9.f(b1Var, b1Var.readInt32(z), z);
            if (f == null) {
                return;
            }
            this.f14175a.add(f);
    ...
    public void e(b1 b1Var) {
        ...
        for (int i = 0; i < size; i++) {
            ((dp9) this.f14175a.get(i)).e(b1Var);
        }
        b1Var.writeInt32(481674261);
        int size2 = this.b.size();
        b1Var.writeInt32(size2);
        for (int i2 = 0; i2 < size2; i2++) {
            ((dp9) this.b.get(i2)).e(b1Var);
        }
        b1Var.writeInt32(481674261);
