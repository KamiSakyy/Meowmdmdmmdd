...
public class TLRPC$TL_paymentFormMethod extends a {
    public static int a = -1996951013;

    /* renamed from: a  reason: collision with other field name */
    public String f14952a;
    public String b;

    public static TLRPC$TL_paymentFormMethod f(b1 b1Var, int i, boolean z) {
        if (a != i) {
            if (!z) {
                return null;
            }
        ...
        tLRPC$TL_paymentFormMethod.d(b1Var, z);
        return tLRPC$TL_paymentFormMethod;
    }

    @Override // org.telegram.tgnet.a
    public void d(b1 b1Var, boolean z) {
        this.f14952a = b1Var.readString(z);
    ...
    public void e(b1 b1Var) {
        b1Var.writeInt32(a);
        b1Var.writeString(this.f14952a);
