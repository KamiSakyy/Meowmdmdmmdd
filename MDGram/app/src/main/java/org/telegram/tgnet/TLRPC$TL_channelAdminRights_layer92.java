...
public class TLRPC$TL_channelAdminRights_layer92 extends a {
    public static int b = 1568467877;
    public int a;
    ...
    public static TLRPC$TL_channelAdminRights_layer92 f(b1 b1Var, int i, boolean z) {
        if (b != i) {
            if (!z) {
                return null;
            }
        ...
        tLRPC$TL_channelAdminRights_layer92.d(b1Var, z);
