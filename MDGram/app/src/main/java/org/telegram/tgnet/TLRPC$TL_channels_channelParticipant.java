...
public class TLRPC$TL_channels_channelParticipant extends a {
    public static int a = -541588713;

    /* renamed from: a  reason: collision with other field name */
    public dm9 f14002a;

    /* renamed from: a  reason: collision with other field name */
    public ArrayList f14003a = new ArrayList();
    public ArrayList b = new ArrayList();

    public static TLRPC$TL_channels_channelParticipant f(b1 b1Var, int i, boolean z) {
        if (a != i) {
            if (!z) {
                return null;
            }
        ...
        tLRPC$TL_channels_channelParticipant.d(b1Var, z);
        return tLRPC$TL_channels_channelParticipant;
    }

    @Override // org.telegram.tgnet.a
    public void d(b1 b1Var, boolean z) {
        this.f14002a = dm9.f(b1Var, b1Var.readInt32(z), z);
    ...
    public void e(b1 b1Var) {
        b1Var.writeInt32(a);
        this.f14002a.e(b1Var);
        b1Var.writeInt32(481674261);
        int size = this.f14003a.size();
        b1Var.writeInt32(size);
        for (int i = 0; i < size; i++) {
            ((fm9) this.f14003a.get(i)).e(b1Var);
        }
        b1Var.writeInt32(481674261);
