...
public class TLRPC$TL_phone_joinAsPeers extends a {
    public static int a = -1343921601;

    /* renamed from: a  reason: collision with other field name */
    public ArrayList f15057a = new ArrayList();
    public ArrayList b = new ArrayList();
    public ArrayList c = new ArrayList();

    public static TLRPC$TL_phone_joinAsPeers f(b1 b1Var, int i, boolean z) {
        if (a != i) {
            if (!z) {
                return null;
            }
        ...
        tLRPC$TL_phone_joinAsPeers.d(b1Var, z);
    ...
    public void e(b1 b1Var) {
        ...
        for (int i = 0; i < size; i++) {
            ((dp9) this.f15057a.get(i)).e(b1Var);
        }
        b1Var.writeInt32(481674261);
