    ...
    public VideoFrame.I420Buffer convert(VideoFrame.TextureBuffer textureBuffer) {
        ...
        try {
            ...
            try {
                ...
                return JavaI420Buffer.wrap(width, height, slice, i2, slice2, i2, slice3, i2, new Runnable() { // from class: f7b
            ...
            textureBuffer2.release();
            return JavaI420Buffer.wrap(width, height, slice4, i2, slice22, i2, slice32, i2, new Runnable() { // from class: f7b
                @Override // java.lang.Runnable
                public final void run() {
        ...
        textureBuffer2.release();
        return JavaI420Buffer.wrap(width, height, slice42, i2, slice222, i2, slice322, i2, new Runnable() { // from class: f7b
            @Override // java.lang.Runnable
            public final void run() {
