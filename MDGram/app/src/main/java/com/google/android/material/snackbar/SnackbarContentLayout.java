...
public class SnackbarContentLayout extends LinearLayout implements pz1 {
    ...
    public SnackbarContentLayout(Context context, AttributeSet attributeSet) {
        ...
        this.f3357a = hh6.g(context, org.telegram.mdgram.R.attr.motionEasingEmphasizedInterpolator, ye.b);
    }
    ...
    public void c(float f) {
        if (f != 1.0f) {
            this.f3358a.setTextColor(g95.j(g95.d(this, org.telegram.mdgram.R.attr.colorSurface), this.f3358a.getCurrentTextColor(), f));
        }
    }
    ...
    public void onFinishInflate() {
        ...
        this.f3359a = (TextView) findViewById(org.telegram.mdgram.R.id.snackbar_text);
        this.f3358a = (Button) findViewById(org.telegram.mdgram.R.id.snackbar_action);
    }
    ...
    */
    public void onMeasure(int r8, int r9) {
        ...
        Lb:
            ...
            int r2 = defpackage.org.telegram.mdgram.R.dimen.design_snackbar_padding_vertical_2lines
            int r0 = r0.getDimensionPixelSize(r2)
            android.content.res.Resources r2 = r7.getResources()
            int r3 = defpackage.org.telegram.mdgram.R.dimen.design_snackbar_padding_vertical
