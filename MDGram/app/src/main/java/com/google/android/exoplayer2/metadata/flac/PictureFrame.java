...
public final class PictureFrame implements mf6.b {
    ...
    @Override // defpackage.mf6.b
    public /* bridge */ /* synthetic */ jd3 getWrappedMetadataFormat() {
        return nf6.b(this);
    }
    ...
    public PictureFrame(Parcel parcel) {
        ...
        this.mimeType = (String) tma.h(parcel.readString());
        this.description = (String) tma.h(parcel.readString());
        this.width = parcel.readInt();
        this.height = parcel.readInt();
        this.depth = parcel.readInt();
        this.colors = parcel.readInt();
        this.pictureData = (byte[]) tma.h(parcel.createByteArray());
    }
}
