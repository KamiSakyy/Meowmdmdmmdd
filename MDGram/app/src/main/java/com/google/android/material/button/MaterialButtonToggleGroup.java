...
public class MaterialButtonToggleGroup extends LinearLayout {
    public static final int b = org.telegram.mdgram.R.style.Widget.MaterialComponents.MaterialButtonToggleGroup;
    public final int a;
    ...
    public MaterialButtonToggleGroup(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, org.telegram.mdgram.R.attr.materialButtonToggleGroupStyle);
    }
