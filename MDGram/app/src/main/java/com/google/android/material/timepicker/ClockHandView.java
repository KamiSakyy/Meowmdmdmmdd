...
public class ClockHandView extends View {
    ...
    public ClockHandView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.f = 1;
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, r78.f17769G, i, org.telegram.mdgram.R.style.Widget.MaterialComponents.TimePicker.Clock);
        this.f3453a = hh6.f(context, org.telegram.mdgram.R.attr.motionDurationLong2, 200);
        this.f3454a = hh6.g(context, org.telegram.mdgram.R.attr.motionEasingEmphasizedInterpolator, ye.b);
        this.e = obtainStyledAttributes.getDimensionPixelSize(1, 0);
        this.f3463c = obtainStyledAttributes.getDimensionPixelSize(2, 0);
        Resources resources = getResources();
        this.f3465d = resources.getDimensionPixelSize(org.telegram.mdgram.R.dimen.material_clock_hand_stroke_width);
        this.c = resources.getDimensionPixelSize(org.telegram.mdgram.R.dimen.material_clock_hand_center_dot_radius);
