...
public class a extends k95 implements Drawable.Callback, av9.b {
    ...
    public final void m1(AttributeSet attributeSet, int i, int i2) {
        ...
        this.f3241k = i3.hasValue(37);
        T1(j95.b(this.f3192a, i3, 24));
        x1(j95.b(this.f3192a, i3, 11));
        L1(i3.getDimension(19, 0.0f));
        if (i3.hasValue(12)) {
            z1(i3.getDimension(12, 0.0f));
        }
        P1(j95.b(this.f3192a, i3, 22));
        R1(i3.getDimension(23, 0.0f));
        q2(j95.b(this.f3192a, i3, 36));
        v2(i3.getText(5));
        ku9 f = j95.f(this.f3192a, i3, 0);
        f.l(i3.getDimension(1, f.j()));
        if (Build.VERSION.SDK_INT < 23) {
            f.k(j95.b(this.f3192a, i3, 2));
        }
        w2(f);
        ...
        K1(i3.getBoolean(18, false));
        if (attributeSet != null && attributeSet.getAttributeValue("http://schemas.android.com/apk/res-auto", "chipIconEnabled") != null && attributeSet.getAttributeValue("http://schemas.android.com/apk/res-auto", "chipIconVisible") == null) {
            K1(i3.getBoolean(15, false));
        }
        D1(j95.d(this.f3192a, i3, 14));
        if (i3.hasValue(17)) {
            H1(j95.b(this.f3192a, i3, 17));
        }
        F1(i3.getDimension(16, -1.0f));
        g2(i3.getBoolean(31, false));
        if (attributeSet != null && attributeSet.getAttributeValue("http://schemas.android.com/apk/res-auto", "closeIconEnabled") != null && attributeSet.getAttributeValue("http://schemas.android.com/apk/res-auto", "closeIconVisible") == null) {
            g2(i3.getBoolean(26, false));
        }
        U1(j95.d(this.f3192a, i3, 25));
        e2(j95.b(this.f3192a, i3, 30));
        Z1(i3.getDimension(28, 0.0f));
        p1(i3.getBoolean(6, false));
        w1(i3.getBoolean(10, false));
        if (attributeSet != null && attributeSet.getAttributeValue("http://schemas.android.com/apk/res-auto", "checkedIconEnabled") != null && attributeSet.getAttributeValue("http://schemas.android.com/apk/res-auto", "checkedIconVisible") == null) {
            w1(i3.getBoolean(8, false));
        }
        r1(j95.d(this.f3192a, i3, 7));
        if (i3.hasValue(9)) {
            t1(j95.b(this.f3192a, i3, 9));
        }
        t2(fh6.b(this.f3192a, i3, 39));
        j2(fh6.b(this.f3192a, i3, 33));
        N1(i3.getDimension(21, 0.0f));
        n2(i3.getDimension(35, 0.0f));
        l2(i3.getDimension(34, 0.0f));
        B2(i3.getDimension(41, 0.0f));
        y2(i3.getDimension(40, 0.0f));
        b2(i3.getDimension(29, 0.0f));
        W1(i3.getDimension(27, 0.0f));
        B1(i3.getDimension(13, 0.0f));
        p2(i3.getDimensionPixelSize(4, Integer.MAX_VALUE));
        i3.recycle();
    }
