...
public class Snackbar extends BaseTransientBottomBar {
    ...
    static {
        int i = org.telegram.mdgram.R.attr.snackbarButtonStyle;
        b = new int[]{i};
        c = new int[]{i, org.telegram.mdgram.R.attr.snackbarTextViewStyle};
    }
    ...
    public static Snackbar n0(Context context, View view, CharSequence charSequence, int i) {
        ...
        if (g0 != null) {
            ...
            if (k0(context)) {
                i2 = org.telegram.mdgram.R.layout.mtrl_layout_snackbar_include;
            } else {
                i2 = org.telegram.mdgram.R.layout.design_layout_snackbar_include;
            }
