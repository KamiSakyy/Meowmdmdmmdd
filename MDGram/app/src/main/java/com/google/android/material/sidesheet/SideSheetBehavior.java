...
public class SideSheetBehavior<V extends View> extends CoordinatorLayout.b {
    public static final int g = org.telegram.mdgram.R.string.side_sheet_accessibility_pane_title;
    public static final int h = org.telegram.mdgram.R.style.Widget.Material3.SideSheet;
    public float a;
    ...
    public SideSheetBehavior(Context context, AttributeSet attributeSet) {
        ...
        if (obtainStyledAttributes.hasValue(3)) {
            this.f3303a = j95.b(context, obtainStyledAttributes, 3);
        }
        if (obtainStyledAttributes.hasValue(6)) {
            this.f3310a = uz8.e(context, attributeSet, 0, h).m();
        }
        if (obtainStyledAttributes.hasValue(5)) {
            o0(obtainStyledAttributes.getResourceId(5, -1));
        }
        S(context);
