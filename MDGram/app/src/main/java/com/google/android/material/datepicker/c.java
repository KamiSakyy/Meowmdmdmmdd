...
public final class c<S> extends wh7 {
    ...
    public class h extends a2 {
        ...
        public void g(View view, l2 l2Var) {
            ...
            if (c.this.f3259e.getVisibility() == 0) {
                Q = c.this.Q(org.telegram.mdgram.R.string.mtrl_picker_toggle_to_year_selection);
            } else {
                Q = c.this.Q(org.telegram.mdgram.R.string.mtrl_picker_toggle_to_day_selection);
            }
            l2Var.k0(Q);
        }
    }
    ...
    public static int a2(Context context) {
        return context.getResources().getDimensionPixelSize(org.telegram.mdgram.R.dimen.mtrl_calendar_day_height);
    }

    public static int b2(Context context) {
        Resources resources = context.getResources();
        int dimensionPixelSize = resources.getDimensionPixelSize(org.telegram.mdgram.R.dimen.mtrl_calendar_navigation_height) + resources.getDimensionPixelOffset(org.telegram.mdgram.R.dimen.mtrl_calendar_navigation_top_padding) + resources.getDimensionPixelOffset(org.telegram.mdgram.R.dimen.mtrl_calendar_navigation_bottom_padding);
        int dimensionPixelSize2 = resources.getDimensionPixelSize(org.telegram.mdgram.R.dimen.mtrl_calendar_days_of_week_height);
        int i2 = com.google.android.material.datepicker.e.a;
        return dimensionPixelSize + dimensionPixelSize2 + (resources.getDimensionPixelSize(org.telegram.mdgram.R.dimen.mtrl_calendar_day_height) * i2) + ((i2 - 1) * resources.getDimensionPixelOffset(org.telegram.mdgram.R.dimen.mtrl_calendar_month_vertical_padding)) + resources.getDimensionPixelOffset(org.telegram.mdgram.R.dimen.mtrl_calendar_bottom_padding);
    }
    ...
    public final void U1(View view, com.google.android.material.datepicker.f fVar) {
        MaterialButton materialButton = (MaterialButton) view.findViewById(org.telegram.mdgram.R.id.month_navigation_fragment_toggle);
        materialButton.setTag(e);
        gqa.r0(materialButton, new h());
        View findViewById = view.findViewById(org.telegram.mdgram.R.id.month_navigation_previous);
        this.f3255b = findViewById;
        findViewById.setTag(c);
        View findViewById2 = view.findViewById(org.telegram.mdgram.R.id.month_navigation_next);
        this.f3257c = findViewById2;
        findViewById2.setTag(d);
        this.f3258d = view.findViewById(org.telegram.mdgram.R.id.mtrl_calendar_year_selector_frame);
        this.f3259e = view.findViewById(org.telegram.mdgram.R.id.mtrl_calendar_day_selector_frame);
        g2(l.DAY);
    ...
    public View u0(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        if (com.google.android.material.datepicker.d.r2(contextThemeWrapper)) {
            i2 = org.telegram.mdgram.R.layout.mtrl_calendar_vertical;
            i3 = 1;
        } else {
            i2 = org.telegram.mdgram.R.layout.mtrl_calendar_horizontal;
            i3 = 0;
        }
        View inflate = cloneInContext.inflate(i2, viewGroup, false);
        inflate.setMinimumHeight(b2(q1()));
        GridView gridView = (GridView) inflate.findViewById(org.telegram.mdgram.R.id.mtrl_calendar_days_of_week);
        ...
        this.f3256b = (RecyclerView) inflate.findViewById(org.telegram.mdgram.R.id.mtrl_calendar_months);
        ...
        int integer = contextThemeWrapper.getResources().getInteger(org.telegram.mdgram.R.integer.mtrl_calendar_year_selector_span);
        RecyclerView recyclerView = (RecyclerView) inflate.findViewById(org.telegram.mdgram.R.id.mtrl_calendar_year_selector_frame);
        this.a = recyclerView;
        ...
        if (inflate.findViewById(org.telegram.mdgram.R.id.month_navigation_fragment_toggle) != null) {
            U1(inflate, fVar);
        }
        if (!com.google.android.material.datepicker.d.r2(contextThemeWrapper)) {
            new q().b(this.f3256b);
