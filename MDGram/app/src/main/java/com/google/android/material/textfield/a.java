...
public class a extends LinearLayout {
    ...
    public static class d {
        ...
        public d(a aVar, p3a p3aVar) {
            this.f3437a = aVar;
            this.a = p3aVar.n(26, 0);
            this.b = p3aVar.n(50, 0);
        }
    ...
    public a(TextInputLayout textInputLayout, p3a p3aVar) {
        ...
        CheckableImageButton i = i(this, from, org.telegram.mdgram.R.id.text_input_error_icon);
        this.f3425a = i;
        CheckableImageButton i2 = i(frameLayout, from, org.telegram.mdgram.R.id.text_input_end_icon);
        this.f3435b = i2;
    ...
    public final void A(p3a p3aVar) {
        if (!p3aVar.s(51)) {
            if (p3aVar.s(30)) {
                this.f3432b = j95.a(getContext(), p3aVar, 30);
            }
            if (p3aVar.s(31)) {
                this.f3433b = jta.f(p3aVar.k(31, -1), null);
            }
        }
        if (p3aVar.s(28)) {
            T(p3aVar.k(28, 0));
            ...
            if (p3aVar.s(52)) {
                this.f3432b = j95.a(getContext(), p3aVar, 52);
            }
            if (p3aVar.s(53)) {
                this.f3433b = jta.f(p3aVar.k(53, -1), null);
            }
            T(p3aVar.a(51, false) ? 1 : 0);
            P(p3aVar.p(49));
        }
        S(p3aVar.f(27, getResources().getDimensionPixelSize(org.telegram.mdgram.R.dimen.mtrl_min_touch_target_size)));
        if (p3aVar.s(29)) {
            W(qy3.b(p3aVar.k(29, -1)));
        }
    }

    public final void B(p3a p3aVar) {
        if (p3aVar.s(36)) {
            this.f3415a = j95.a(getContext(), p3aVar, 36);
        }
        if (p3aVar.s(37)) {
            this.f3416a = jta.f(p3aVar.k(37, -1), null);
        }
        if (p3aVar.s(35)) {
            b0(p3aVar.g(35));
        }
        this.f3425a.setContentDescription(getResources().getText(org.telegram.mdgram.R.string.error_icon_content_description));
    ...
    public final void C(p3a p3aVar) {
        ...
        this.f3423a.setId(org.telegram.mdgram.R.id.textinput_suffix_text);
    ...
    public final CheckableImageButton i(ViewGroup viewGroup, LayoutInflater layoutInflater, int i) {
        CheckableImageButton checkableImageButton = (CheckableImageButton) layoutInflater.inflate(org.telegram.mdgram.R.layout.design_text_input_end_icon, viewGroup, false);
    ...
    public void w0() {
        ...
        gqa.G0(this.f3423a, getContext().getResources().getDimensionPixelSize(org.telegram.mdgram.R.dimen.material_input_text_to_prefix_suffix_padding), this.f3427a.f3374a.getPaddingTop(), i, this.f3427a.f3374a.getPaddingBottom());
    }
