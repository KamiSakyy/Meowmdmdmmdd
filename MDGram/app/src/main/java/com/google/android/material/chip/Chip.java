...
public class Chip extends gg implements a.InterfaceC0036a, e09 {
    ...
    public boolean e;
    public boolean f;
    public static final int c = org.telegram.mdgram.R.style.Widget.MaterialComponents.Chip.Action;
        ...
        public void N(int i, l2 l2Var) {
            ...
            if (i == 1) {
                ...
                if (closeIconContentDescription != null) {
                    ...
                    int i2 = org.telegram.mdgram.R.string.mtrl_chip_close_icon_content_description;
    ...
    public Chip(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, org.telegram.mdgram.R.attr.chipStyle);
    }
    ...
    public final void o(Context context, AttributeSet attributeSet, int i) {
        ...
        this.e = i2.getBoolean(32, false);
        this.f3188b = (int) Math.ceil(i2.getDimension(20, (float) Math.ceil(jta.b(getContext(), 48))));
        i2.recycle();
    }
