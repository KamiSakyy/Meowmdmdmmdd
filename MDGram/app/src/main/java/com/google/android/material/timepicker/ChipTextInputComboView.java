...
public class ChipTextInputComboView extends FrameLayout implements Checkable {
    ...
    public ChipTextInputComboView(Context context, AttributeSet attributeSet, int i) {
        ...
        Chip chip = (Chip) from.inflate(org.telegram.mdgram.R.layout.material_time_chip, (ViewGroup) this, false);
        this.f3440a = chip;
        chip.setAccessibilityClassName("android.view.View");
        TextInputLayout textInputLayout = (TextInputLayout) from.inflate(org.telegram.mdgram.R.layout.material_time_input, (ViewGroup) this, false);
        ...
        this.f3439a = (TextView) findViewById(org.telegram.mdgram.R.id.material_label);
