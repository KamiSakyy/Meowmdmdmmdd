...
public abstract class BaseTransientBottomBar {
    ...
    /* renamed from: a  reason: collision with other field name */
    public static final int[] f3322a = {org.telegram.mdgram.R.attr.snackbarStyle};
    ...
    public static class r extends FrameLayout {
        ...
        public r(Context context, AttributeSet attributeSet) {
            ...
            if (obtainStyledAttributes.hasValue(6)) {
                gqa.z0(this, obtainStyledAttributes.getDimensionPixelSize(6, 0));
            }
            this.f3348a = obtainStyledAttributes.getInt(2, 0);
            if (obtainStyledAttributes.hasValue(8) || obtainStyledAttributes.hasValue(9)) {
                this.f3353a = uz8.e(context2, attributeSet, 0, 0).m();
            }
            this.f3347a = obtainStyledAttributes.getFloat(3, 1.0f);
            setBackgroundTintList(j95.b(context2, obtainStyledAttributes, 4));
            setBackgroundTintMode(jta.f(obtainStyledAttributes.getInt(5, -1), PorterDuff.Mode.SRC_IN));
            this.b = obtainStyledAttributes.getFloat(1, 1.0f);
            this.f3355b = obtainStyledAttributes.getDimensionPixelSize(0, -1);
        ...
        public final Drawable d() {
            Drawable v;
            int k = g95.k(this, org.telegram.mdgram.R.attr.colorSurface, org.telegram.mdgram.R.attr.colorOnSurface, getBackgroundOverlayColorAlpha());
        ...
        if (viewGroup != null) {
            if (view != null) {
                if (pz1Var != null) {
                    ...
                    this.c = hh6.f(context, org.telegram.mdgram.R.attr.motionDurationLong2, j.e.DEFAULT_SWIPE_ANIMATION_DURATION);
                    this.f3324a = hh6.f(context, org.telegram.mdgram.R.attr.motionDurationLong2, 150);
                    this.b = hh6.f(context, org.telegram.mdgram.R.attr.motionDurationMedium1, 75);
                    this.f3325a = hh6.g(context, org.telegram.mdgram.R.attr.motionEasingEmphasizedInterpolator, e);
                    this.f3338c = hh6.g(context, org.telegram.mdgram.R.attr.motionEasingEmphasizedInterpolator, f);
                    this.f3336b = hh6.g(context, org.telegram.mdgram.R.attr.motionEasingEmphasizedInterpolator, d);
                    return;
                }
    ...
    public static GradientDrawable v(int i2, Resources resources) {
        float dimension = resources.getDimension(org.telegram.mdgram.R.dimen.mtrl_snackbar_background_corner_radius);
    ...
    public int F() {
        return J() ? org.telegram.mdgram.R.layout.mtrl_layout_snackbar : org.telegram.mdgram.R.layout.design_layout_snackbar;
    }
