...
public abstract class BaseQuickAdapter<T, K extends BaseViewHolder> extends RecyclerView.g {
    ...
    public class AnonymousClass2 implements Runnable {
        public final /* synthetic */ v val$staggeredGridLayoutManager;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public boolean isFullScreen(k kVar) {
        if (kVar.e2() + 1 != getItemCount() || kVar.Y1() != 0) {
            return true;
        }
        return false;
    }
    ...
    public void onAttachedToRecyclerView(RecyclerView recyclerView) {
        ...
        if (layoutManager instanceof h) {
            final h hVar = (h) layoutManager;
            hVar.t3(new h.c() { // from class: com.chad.library.adapter.base.BaseQuickAdapter.4
                ...
                public int getSpanSize(int i) {
                    ...
                    if (BaseQuickAdapter.this.mSpanSizeLookup == null) {
                        ...
                        return BaseQuickAdapter.this.mSpanSizeLookup.getSpanSize(hVar, i - BaseQuickAdapter.this.getHeaderLayoutCount());
                    }
                }
            });
        }
    ...
    public /* bridge */ /* synthetic */ void onBindViewHolder(RecyclerView.d0 d0Var, int i) {
        onBindViewHolder((BaseQuickAdapter<T, K>) ((BaseViewHolder) d0Var), i);
    }
    ...
    public /* bridge */ /* synthetic */ void onViewAttachedToWindow(RecyclerView.d0 d0Var) {
        onViewAttachedToWindow((BaseQuickAdapter<T, K>) ((BaseViewHolder) d0Var));
    }
    ...
    public void onViewAttachedToWindow(K k) {
        super.onViewAttachedToWindow((RecyclerView.d0) k);
        int itemViewType = k.getItemViewType();
    ...
    public void disableLoadMoreIfNotFullPage(RecyclerView recyclerView) {
        ...
        if (recyclerView == null || (layoutManager = recyclerView.getLayoutManager()) == null || !(layoutManager instanceof k)) {
            return;
        }
        ...
        recyclerView.postDelayed(new Runnable() { // from class: com.chad.library.adapter.base.BaseQuickAdapter.1
            @Override // java.lang.Runnable
            public void run() {
                if (BaseQuickAdapter.this.isFullScreen(kVar)) {
